...
description: "System::Security::Cryptography::X509Certificates::PublicKey::get_Oid yöntemi. C++'da genel anahtarın tanımlayıcısını (OID) alır."
type: docs
weight: 500
url: /tr/cpp/system.security.cryptography.x509certificates/publickey/get_oid/
---
## PublicKey::get_Oid method


Genel anahtarın tanımlayıcısını (OID) alır.
