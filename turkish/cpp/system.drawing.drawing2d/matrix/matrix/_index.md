---
title: "System::Drawing::Drawing2D::Matrix::Matrix yapıcısı"
linktitle: "Matrix"
second_title: "Aspose.Page için C++"
description: "System::Drawing::Drawing2D::Matrix::Matrix yapıcısı. C++'ta bir birim matris temsil eden Matrix sınıfının yeni bir örneğini oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.drawing.drawing2d/matrix/matrix/
---
## Matrix::Matrix() constructor


Bir birim matris temsil eden yeni bir [Matrix](../) sınıf örneği oluşturur.
...
Belirtilen dikdörtgen ve nokta dizisi tarafından tanımlanan geometrik dönüşüme yeni bir [Matrix](../) sınıf örneği oluşturur.
...
Belirtilen değerlerle başlatılan yeni bir [Matrix](../) sınıf örneği oluşturur.
