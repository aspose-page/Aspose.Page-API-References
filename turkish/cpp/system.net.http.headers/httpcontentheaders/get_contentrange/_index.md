...
description: "System::Net::Http::Headers::HttpContentHeaders::get_ContentRange method. C++'de ''Content-Range'' başlığının bir değerini alır."
type: docs
weight: 900
url: /tr/cpp/system.net.http.headers/httpcontentheaders/get_contentrange/
---
## HttpContentHeaders::get_ContentRange method


'Content-Range' başlığının bir değerini alır.
...
'Content-Range' başlığının bir değeri.
