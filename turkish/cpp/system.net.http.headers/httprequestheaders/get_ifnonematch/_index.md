...
description: "System::Net::Http::Headers::HttpRequestHeaders::get_IfNoneMatch method. C++'da ''If-None-Match'' başlığının bir değerini döndürür."
type: docs
weight: 1800
url: /tr/cpp/system.net.http.headers/httprequestheaders/get_ifnonematch/
---
## HttpRequestHeaders::get_IfNoneMatch method


'If-None-Match' başlığının bir değerini döndürür.
...
'If-None-Match' başlığının bir değeri.
