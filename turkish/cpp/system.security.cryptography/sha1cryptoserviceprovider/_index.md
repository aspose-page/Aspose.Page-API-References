---
title: "System::Security::Cryptography::SHA1CryptoServiceProvider sınıfı"
linktitle: "SHA1CryptoServiceProvider"
second_title: "Aspose.Page için C++"
description: "System::Security::Cryptography::SHA1CryptoServiceProvider sınıfı. SHA1 CSP uygulaması. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığına (stack) ya da new operatörüyle oluşturmaktan kaçının, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisiyle sarmalayın ve bu işaretçiyi C++'ta fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 4100
url: /tr/cpp/system.security.cryptography/sha1cryptoserviceprovider/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [SHA1CryptoServiceProvider](./sha1cryptoserviceprovider/)() | Yapıcı. |
## Ayrıca Bakınız
