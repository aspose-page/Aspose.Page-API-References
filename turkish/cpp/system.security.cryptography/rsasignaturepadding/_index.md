---
title: "System::Security::Cryptography::RSASignaturePadding sınıfı"
linktitle: "RSASignaturePadding"
second_title: "Aspose.Page için C++"
description: "System::Security::Cryptography::RSASignaturePadding sınıfı. C++'ta RSA imzası oluşturma veya doğrulama işlemleri için dolgu modu ve parametreleri."
type: docs
weight: 3900
url: /tr/cpp/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding class


[RSA](../rsa/) imzası oluşturma veya doğrulama işlemleri için dolgu modu ve parametreleri.
...
| static [get_Pss](./get_pss/)() | PSS modunu alır. |
