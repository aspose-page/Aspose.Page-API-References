---
title: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider yapıcı"
linktitle: "DSACryptoServiceProvider"
second_title: "Aspose.Page için C++"
description: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider yapıcı. Yapıcı. C++'ta varsayılan parametreleri kullanır."
type: docs
weight: 100
url: /tr/cpp/system.security.cryptography/dsacryptoserviceprovider/dsacryptoserviceprovider/
---
## DSACryptoServiceProvider::DSACryptoServiceProvider() constructor


Yapıcı. Varsayılan parametreleri kullanır.
...
| --- | --- | --- |
| parametreler | const DSAParameters\& | Algoritma parametreleri. |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| parametreler | const SharedPtr\<CspParameters\>\& | Algoritma parametreleri. |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| key_size | int32_t | Bit cinsinden anahtar boyutu. |
