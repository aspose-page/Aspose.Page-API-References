---
title: "System::TimeSpan::TryParseExact metodu"
linktitle: "TryParseExact"
second_title: "Aspose.Page için C++"
description: "C++'ta System::TimeSpan sınıfının TryParseExact yönteminin nasıl kullanılacağını."
type: docs
weight: 4500
url: /tr/cpp/system/timespan/tryparseexact/
---
...
Belirtilen biçimler, biçim sağlayıcı ve stiller kullanılarak dizeyi eşdeğer [TimeSpan](../) nesnesine dönüştürür ve dönüşüm sonucunu döndürür.
...
| sağlayıcı | const SharedPtr\<IFormatProvider\>\& | Kültüre özgü biçimlendirme bilgilerini sağlayan biçim sağlayıcı. |
| styles | Globalization::TimeSpanStyles | Girdi dizesinde bulunabilecek öğeleri tanımlar. |
| sonuç | TimeSpan\& | Dizeye karşılık gelen zaman aralığı. |

### ReturnValue

Dize başarıyla dönüştürüldüyse true; aksi takdirde false.
...
Belirtilen biçimler ve biçim sağlayıcı kullanılarak dizeyi eşdeğer [TimeSpan](../) nesnesine dönüştürür ve dönüşüm sonucunu döndürür.
...
Belirtilen biçim, biçim sağlayıcı ve stiller kullanılarak dizeyi eşdeğer [TimeSpan](../) nesnesine dönüştürür ve dönüşüm sonucunu döndürür.
...
| --- | --- | --- |
| girdi | const String\& | Girdi dizesi. |
| biçim | const String\& | Standart veya özel biçim dizesi. |
| sağlayıcı | const SharedPtr\<IFormatProvider\>\& | Kültüre özgü biçimlendirme bilgilerini sağlayan biçim sağlayıcı. |
| styles | Globalization::TimeSpanStyles | Girdi dizesinde bulunabilecek öğeleri tanımlar. |
| sonuç | TimeSpan\& | Dizeye karşılık gelen zaman aralığı. |
...
Belirtilen biçim ve biçim sağlayıcı kullanılarak dizeyi eşdeğer [TimeSpan](../) nesnesine dönüştürür ve dönüşüm sonucunu döndürür.
