...
description: "System::setter_post_decrement_wrap yöntemi. Çevirmen, ayarlayıcı ve alıcı tanımlı örnek özelliğine yönelik C#''s post-azaltma ifadelerini, C++'da bu işlevin (const alıcı için aşırı yükleme) çağrısına dönüştürür."
type: docs
weight: 37600
...
Çevirmen, ayarlayıcı ve alıcı tanımlı örnek özelliğine yönelik C#'s post-azaltma ifadelerini, bu işlevin (const alıcı için aşırı yükleme) çağrısına dönüştürür.
...
Çevirmen, ayarlayıcı ve alıcı tanımlı örnek özelliğine yönelik C#'s post-azaltma ifadelerini, bu işlevin (non-const alıcı için aşırı yükleme) çağrısına dönüştürür.
...
Çevirmen, ayarlayıcı ve alıcı tanımlı sınıf özelliğine yönelik C#'s post-azaltma ifadelerini, bu işlevin çağrısına dönüştürür.
