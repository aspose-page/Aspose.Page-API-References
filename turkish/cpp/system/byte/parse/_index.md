...
description: "System::Byte::Parse yöntemi. Belirtilen sayının dize temsili içeren dizeyi C++'ta eşdeğer 8-bit işaretsiz tam sayıya dönüştürür."
type: docs
weight: 100
...
Belirtilen sayının dize temsilini içeren dizeyi, sağlanan biçimlendirme bilgilerini kullanarak eşdeğer 8-bit işaretsiz tam sayıya dönüştürür.
