---
title: "Aspose::Page::EPS::PsDocument::FillAndStrokeText metodu"
linktitle: "FillAndStrokeText"
second_title: "Aspose.Page için C++"
description: "Aspose::Page::EPS::PsDocument::FillAndStrokeText metodu. C++'da gliflerin içini doldurarak ve glif konturlarını çizerek bir metin dizesi ekler."
type: docs
weight: 2500
url: /tr/cpp/aspose.page.eps/psdocument/fillandstroketext/
---
...
| --- | --- | --- |
| text | System::String | Eklenecek metin. |
| ilerlemeler | System::ArrayPtr\<float\> | Glif genişliklerinin bir dizisi. Uzunluğu, dizedeki glif sayısıyla uyumlu olmalıdır. |
| drFont | System::SharedPtr\<Aspose::Page::Font::DrFont\> | [DrFont](../) metni çizmeye kullanılacak. Özel klasörde bulunan özel bir yazı tipiyle kullanılabilir. |
| x | float | Metin başlangıcı için X koordinatı. |
| y | float | Metin başlangıcı için Y koordinatı. |
| fillPaint | System::SharedPtr\<System::Drawing::Brush\> | Gliflerin içini boyamak için kullanılan dolgu. |
| çizgi | System::SharedPtr\<System::Drawing::Pen\> | Glif konturlarını çizmek için kullanılan çizgi. |
...
| text | System::String | Eklenecek metin. |
| ilerlemeler | System::ArrayPtr\<float\> | Glif genişliklerinin bir dizisi. Uzunluğu, dizedeki glif sayısıyla uyumlu olmalıdır. |
| font | System::SharedPtr\<System::Drawing::Font\> | [System](../../../system/) metni çizmeye kullanılacak yazı tipi. |
| x | float | Metin başlangıcı için X koordinatı. |
| y | float | Metin başlangıcı için Y koordinatı. |
| fillPaint | System::SharedPtr\<System::Drawing::Brush\> | Gliflerin içini boyamak için kullanılan dolgu. |
| çizgi | System::SharedPtr\<System::Drawing::Pen\> | Glif konturlarını çizmek için kullanılan çizgi. |
