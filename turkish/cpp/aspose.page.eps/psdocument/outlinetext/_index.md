---
title: "Aspose::Page::EPS::PsDocument::OutlineText yöntemi"
linktitle: "OutlineText"
second_title: "Aspose.Page için C++"
description: "Aspose::Page::EPS::PsDocument::OutlineText yöntemi. C++'ta glif konturlarını çizerek bir metin dizesi ekler."
type: docs
weight: 3900
url: /tr/cpp/aspose.page.eps/psdocument/outlinetext/
---
...
| x | float | Metin başlangıcı için X koordinatı. |
| y | float | Metin başlangıcı için Y koordinatı. |
| çizgi | System::SharedPtr\<System::Drawing::Pen\> | Glif konturlarını çizerken kullanılan çizgi. |
...
| text | System::String | Eklenecek metin. |
| ilerlemeler | System::ArrayPtr\<float\> | Glif genişliklerinin bir dizisi. Uzunluğu, dizedeki glif sayısıyla uyumlu olmalıdır. |
| yazı tipi | System::SharedPtr\<System::Drawing::Font\> | Metni çizmek için kullanılacak yazı tipi. |
| x | float | Metin başlangıcı için X koordinatı. |
| y | float | Metin başlangıcı için Y koordinatı. |
