...
description: "System::Collections::Specialized::NameValueCollection::NameValueCollection yapıcı. Boş bir NameValueCollection sınıfının yeni bir örneğini başlatır (C++ içinde)."
type: docs
weight: 100
url: /tr/cpp/system.collections.specialized/namevaluecollection/namevaluecollection/
---
## NameValueCollection::NameValueCollection() constructor


Boş bir [NameValueCollection](../) sınıfının yeni bir örneğini başlatır.
...
Belirtilen [NameValueCollection](../) içindeki girişleri yeni bir [NameValueCollection](../) içine kopyalar.
