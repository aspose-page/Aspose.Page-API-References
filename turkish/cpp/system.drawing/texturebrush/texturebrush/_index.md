---
title: "System::Drawing::TextureBrush::TextureBrush yapıcı"
linktitle: "TextureBrush"
second_title: "Aspose.Page için C++"
description: "System::Drawing::TextureBrush::TextureBrush yapıcı. Belirtilen görüntüyü kullanan TextureBrush sınıfının yeni bir örneğini C++ içinde oluşturur."
type: docs
weight: 100
url: /tr/cpp/system.drawing/texturebrush/texturebrush/
---
## TextureBrush::TextureBrush(const SharedPtr\<Image\>\&, Drawing2D::WrapMode, Rectangle) constructor


Belirtilen görüntüyü kullanan [TextureBrush](../) sınıfının yeni bir örneğini oluşturur.
...
| --- | --- | --- |
| görüntü | const SharedPtr\<Image\>\& | Bir şeklin içini doldurmak için fırça tarafından kullanılan bir görüntü |
| wrap_mode | Drawing2D::WrapMode | Fırça nesnesinin nasıl döşendiğini belirtir |
| dst_rect | Dikdörtgen | Fırça için sınırlayıcı dikdörtgeni belirtir |
...
| görüntü | const SharedPtr\<Image\>\& | Bir şeklin içini doldurmak için fırça tarafından kullanılan bir görüntü |
| wrap_mode | Drawing2D::WrapMode | Fırça nesnesinin nasıl döşendiğini belirtir |
| dst_rect | RectangleF | Fırça için sınırlayıcı dikdörtgeni belirtir |
...
| görüntü | const SharedPtr\<Image\>\& | Bir şeklin içini doldurmak için fırça tarafından kullanılan bir görüntü |
| dst_rect | Dikdörtgen | Fırça için sınırlayıcı dikdörtgeni belirtir |
| image_attrs | const SharedPtr\<Imaging::ImageAttributes\>\& | Görüntü öznitelikleri |
