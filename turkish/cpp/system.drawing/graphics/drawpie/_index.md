---
title: "System::Drawing::Graphics::DrawPie yöntemi"
linktitle: "DrawPie"
second_title: "Aspose.Page için C++"
description: "System::Drawing::Graphics::DrawPie yöntemi. C++'ta mevcut nesne tarafından temsil edilen yüzeyde belirtilen kalemi kullanarak belirtilen dilimi çizer."
type: docs
weight: 2400
url: /tr/cpp/system.drawing/graphics/drawpie/
---
## Graphics::DrawPie(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Mevcut nesne tarafından temsil edilen yüzeyde belirtilen kalemi kullanarak belirtilen dilimi çizer.
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Dilim çizerken kullanılacak bir kalem |
...
| genişlik | float | Elipsi tanımlayan dikdörtgenin genişliği |
| yükseklik | float | Elipsi tanımlayan dikdörtgenin yüksekliği |
| startAngle | float | X ekseninden saat yönünde ölçülen, dilimin başlangıç noktasına kadar olan açı (derece cinsinden) |
| sweepAngle | float | Dilim son noktasına kadar **startAngle**'den saat yönünde ölçülen açı (derece cinsinden) |
...
| genişlik | int32_t | Elipsi tanımlayan dikdörtgenin genişliği |
| yükseklik | int32_t | Elipsi tanımlayan dikdörtgenin yüksekliği |
| startAngle | int32_t | X ekseninden saat yönünde ölçülen, dilimin başlangıç noktasına kadar olan açı (derece cinsinden) |
| sweepAngle | int32_t | Dilim son noktasına kadar **startAngle**'den saat yönünde ölçülen açı (derece cinsinden) |
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Dilim çizerken kullanılacak bir kalem |
| rect | Dikdörtgen | Elipsi tanımlayan dikdörtgen |
| startAngle | float | X ekseninden saat yönünde ölçülen, dilimin başlangıç noktasına kadar olan açı (derece cinsinden) |
| sweepAngle | float | Dilim son noktasına kadar **startAngle**'den saat yönünde ölçülen açı (derece cinsinden) |
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Dilim çizerken kullanılacak bir kalem |
| rect | RectangleF | Elipsi tanımlayan dikdörtgen |
| startAngle | float | X ekseninden saat yönünde ölçülen, dilimin başlangıç noktasına kadar olan açı (derece cinsinden) |
| sweepAngle | float | Dilim son noktasına kadar **startAngle**'den saat yönünde ölçülen açı (derece cinsinden) |
