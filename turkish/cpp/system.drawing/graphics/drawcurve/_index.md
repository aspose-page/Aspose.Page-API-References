---
title: "System::Drawing::Graphics::DrawCurve yöntemi"
linktitle: "DrawCurve"
second_title: "Aspose.Page için C++"
description: "System::Drawing::Graphics::DrawCurve yöntemi. Belirtilen kalem kullanılarak bir spline çizer C++'da."
type: docs
weight: 1400
url: /tr/cpp/system.drawing/graphics/drawcurve/
---
## Graphics::DrawCurve(const SharedPtr\<Pen\>\&, const ArrayPtr\<Point\>\&, float) method


Belirtilen kalemi kullanarak bir eğri çizer.
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Spline çizerken kullanılacak bir kalem |
| points | const ArrayPtr\<Point\>\& | [Array](../../../system/array/) spline'i belirleyen noktalardan oluşan dizi |
| gerilim | float | Spline'in gerilimini belirten değer |
...
| kalem | const SharedPtr\<Pen\>\& | Spline çizerken kullanılacak bir kalem |
| points | const ArrayPtr\<Point\>\& | [Array](../../../system/array/) spline'i belirleyen noktalardan oluşan dizi |
| offset | int32_t | **points** dizisindeki 1. öğeden ofset |
...
| --- | --- | --- |
| kalem | const SharedPtr\<Pen\>\& | Spline çizerken kullanılacak bir kalem |
| points | const ArrayPtr\<PointF\>\& | [Array](../../../system/array/) spline'i belirleyen noktalardan oluşan dizi |
| gerilim | float | Spline'in gerilimini belirten değer |
