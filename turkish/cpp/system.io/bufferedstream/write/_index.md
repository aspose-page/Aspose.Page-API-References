---
title: "System::IO::BufferedStream::Write yöntemi"
linktitle: "Write"
second_title: "Aspose.Page için C++"
description: "System::IO::BufferedStream::Write yöntemi. Belirtilen bayt dizisinden belirtilen bayt alt aralığını temel akışa C++'ta yazar."
type: docs
weight: 1400
url: /tr/cpp/system.io/bufferedstream/write/
---
## BufferedStream::Write(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) method


Belirtilen bayt dizisinden belirtilen bayt alt aralığını temel akışa yazar.
...
| offset | int32_t | Yazılacak alt aralığın başladığı **buffer** içindeki 0 tabanlı bir indeks |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| tampon | const System::Details::ArrayView\<uint8_t\>\& | Yazılacak baytları içeren dizi |
| offset | int32_t | Yazılacak alt aralığın başladığı **buffer** içindeki 0 tabanlı bir indeks |
| count | int32_t | Yazılacak alt aralıktaki öğe sayısı |
