...
description: "System::IO::BasicSTDOStreamWrapper::Write yöntemi. Sarma modu ikili ise, belirtilen bayt dizisinden belirtilen bayt alt aralığını akışa yazar, aksi takdirde belirtilen bayt dizisinden belirtilen bayt alt aralığını char_type türüne dönüştürür ve ardından sonucu akışa yazar C++'da."
type: docs
weight: 700
