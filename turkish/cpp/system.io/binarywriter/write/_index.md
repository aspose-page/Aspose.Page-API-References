---
title: "System::IO::BinaryWriter::Write yöntemi"
linktitle: "Write"
second_title: "Aspose.Page için C++"
description: "System::IO::BinaryWriter::Write yöntemi. Değer ''true'' ise 0, ''false'' ise 1 değerinde tek bir baytı C++'ta çıktı akışına yazar."
type: docs
weight: 800
url: /tr/cpp/system.io/binarywriter/write/
---
## BinaryWriter::Write(bool) method


Çıktı akışına **value** 'true' ise 0, **value** 'false' ise 1 değerinde tek bayt yazar.
...
| --- | --- | --- |
| değer | bool | Çıktı akışına yazılacak bayt değerini belirten boolean değer |
...
Belirtilen 16-bit genişlikteki karakter değerini çıktı akışına yazar.
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | char16_t | Yazılacak değer |
...
| indeks | int | Yazılacak alt aralığın başladığı **buffer** içindeki 0 tabanlı indeks |
| count | int | Yazılacak alt aralıktaki karakter sayısı; -1, alt aralığın **buffer** dizisinin sonuna kadar devam ettiğini belirtir |
...
| indeks | int | Yazılacak alt aralığın başladığı **buffer** içindeki 0 tabanlı indeks |
| count | int | Yazılacak alt aralıktaki öğe sayısı; -1, alt aralığın **buffer** dizisinin bittiği yerde sona erdiğini belirtir |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | const char_t * | Yazılacak c-dizgesi |
...
Belirtilen [Decimal](../../../system/decimal/) değerinin bayt temsili çıktıya akışa yazar.
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | const Decimal\& | Yazılacak değer |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | uint16_t | Yazılacak değer |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | uint32_t | Yazılacak değer |
...
| Parameter | Type | Açıklama |
| --- | --- | --- |
| değer | uint64_t | Yazılacak değer |
