---
title: "System::Globalization::CompareInfo::IndexOf metodu"
linktitle: "IndexOf"
second_title: "Aspose.Page için C++"
description: "System::Globalization::CompareInfo::IndexOf metodu. Belirtilen karakteri C++'da arar."
type: docs
weight: 900
url: /tr/cpp/system.globalization/compareinfo/indexof/
---
## CompareInfo::IndexOf(const String\&, char16_t) const method


Belirtilen karakteri arar.
...
| --- | --- | --- |
| kaynak | const String\& | Kaynak dize. |
| değer | char16_t | Karakter. |

### ReturnValue

Kaynak dizede arama değerinin indeksi veya bulunamazsa -1.
...
Belirtilen karakteri arar. Yalnızca Sıralı (Ordinal) modu desteklenir.
...
| kaynak | const String\& | Kaynak dize. |
| değer | char16_t | Karakter. |
| seçenekler | CompareOptions | Arama seçenekleri. |
...
| kaynak | const String\& | Kaynak dize. |
| değer | char16_t | Karakter. |
| start_index | int | Kaynak dizede arama başlangıç indeksi. |
...
| değer | char16_t | Karakter. |
| start_index | int | Kaynak dizede arama başlangıç indeksi. |
| count | int | Kaynak dizedeki karakter sayısı. |
...
| --- | --- | --- |
| kaynak | const String\& | Kaynak dize. |
| değer | const String\& | Arama değeri. |
...
Alt dizeyi arar. Yalnızca Sıralı (Ordinal) modu desteklenir.
