...
description: "İşlem sonucunu bayt dizisi biçiminde temsil eder."
type: docs
weight: 11
url: /tr/java/com.aspose.page.plugins/bytearrayresult/
---
**Inheritance:**
java.lang.Object
...
İşlem sonucunu bayt dizisi biçiminde temsil eder.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ByteArrayResult(byte[][] data)](#ByteArrayResult-byte-----) | Yeni bir örnek, bayt dizisi dizisiyle başlatılır. |
## Yöntemler
...
Yeni bir örnek, bayt dizisi dizisiyle başlatılır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| veri | byte[][] | Bayt dizilerinin dizisi. Belgenin görüntüye dönüştürülmesinde kullanılır. Bir bayt dizisi bir sayfa görüntüsünün baytlarını içerir. |
