...
description: "Akış biçiminde işlem sonucunu temsil eder."
type: docs
weight: 18
url: /tr/java/com.aspose.page.plugins/streamresult/
---
**Inheritance:**
java.lang.Object
...
Akış biçiminde işlem sonucunu temsil eder.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [StreamResult(OutputStream stream)](#StreamResult-java.io.OutputStream-) | Belirtilen akış nesnesiyle yeni bir örnek başlatır. |
## Yöntemler
...
Belirtilen akış nesnesiyle yeni bir örnek başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| akış | java.io.OutputStream | Akış nesnesi |
