...
description: "Matris işlemlerinin sırasını tanımlayan enum."
type: docs
weight: 10
url: /tr/java/com.aspose.xps/xpsmatrix.matrixorder/
---
**Inheritance:**
...
Matris işlemlerinin sırasını tanımlayan enum.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Append](#Append) | Ekleme sırası. |
| [Prepend](#Prepend) | Ön ekleme sırası. |
## Yöntemler
