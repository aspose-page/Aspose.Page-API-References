...
description: "XPS belgesi yükleme seçenekleri."
type: docs
weight: 35
url: /tr/java/com.aspose.xps/xpsloadoptions/
---
**Inheritance:**
...
XPS belgesi yükleme seçenekleri.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [XpsLoadOptions()](#XpsLoadOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
