...
description: "PolyQuadraticBezierSegment öğesi özelliklerini kapsayan sınıf."
type: docs
weight: 47
url: /tr/java/com.aspose.xps/xpspolyquadraticbeziersegment/
---
**Inheritance:**
...
PolyQuadraticBezierSegment öğesinin özelliklerini kapsayan sınıf. Bu öğe, belirtilen kontrol noktalarını kullanarak yol şeklinin önceki noktasından bir dizi köşe üzerinden geçen bir dizi ikinci dereceden B?zier eğrisi tanımlar.
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [deepClone()](#deepClone--) | Bu ikinci dereceden B?zier eğrileri kümesini kopyalar. |
...
Bu ikinci dereceden B?zier eğrileri kümesini kopyalar.
