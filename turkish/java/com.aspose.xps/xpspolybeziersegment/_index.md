...
description: "PolyBezierSegment öğesi özelliklerini kapsayan sınıf."
type: docs
weight: 45
url: /tr/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
PolyBezierSegment öğesi özelliklerini kapsayan sınıf. Bu öğe bir dizi kübik B?zier eğrisini tanımlar.
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [deepClone()](#deepClone--) | Bu kübik B?zier eğrileri kümesini klonlar. |
...
Bu kübik B?zier eğrileri kümesini klonlar.
