...
description: "Size2D sınıfı w x h boyutlarını tanımlar."
type: docs
weight: 12
url: /tr/java/com.aspose.xps/size2d/
---
**Inheritance:**
...
The `Size2D` class, boyutları (w x h) tanımlar.

Bu sınıf, 2D boyutları depolayan tüm nesneler için yalnızca soyut üst sınıftır. Boyutların gerçek depolama temsili alt sınıfa bırakılmıştır.
## Yapıcılar
