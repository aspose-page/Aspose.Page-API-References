...
description: "VisualBrush özellik öğesi özelliklerini kapsayan sınıf."
type: docs
weight: 54
url: /tr/java/com.aspose.xps/xpsvisualbrush/
---
**Inheritance:**
...
VisualBrush özelliği öğesinin özelliklerini kapsayan sınıf. Bu öğe, bir bölgeyi bir çizimle doldurmak için kullanılır.
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [deepClone()](#deepClone--) | Bu görsel fırçayı kopyalar. |
...
| [getVisual()](#getVisual--) | Fırçanın kaynak içeriğini çizmeye kullanılan bir Path, Glyphs veya Canvas öğesini döndürür. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setVisual(XpsContentElement visual)](#setVisual-com.aspose.xps.XpsContentElement-) | Görseli, görsel fırçanın Visual öğesi olarak ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Fırçanın kaynak içeriğini çizmeye kullanılan bir Path, Glyphs veya Canvas öğesini döndürür.
...
Görseli, görsel fırçanın Visual öğesi olarak ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| visual | [XpsContentElement](../../com.aspose.xps/xpscontentelement) | Eleman. |
