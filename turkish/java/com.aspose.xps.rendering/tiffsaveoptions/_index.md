...
description: "XPS-as-TIFF kaydetme seçenekleri için sınıf."
type: docs
weight: 16
url: /tr/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
XPS-as-TIFF kaydetme seçenekleri için sınıf.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
...
| [multipage()](#multipage--) | Birden çok görüntünün tek bir çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrağı alır. |
| [multipage(boolean value)](#multipage-boolean-) | Birden çok görüntünün tek bir çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrağı ayarlar. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Birden çok görüntünün tek bir çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrağı alır.

**Returns:**
boolean - Birden fazla görüntünün tek çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrak.
...
Birden çok görüntünün tek bir çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrağı ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Birden fazla görüntünün tek çok sayfalı TIFF dosyasında kaydedilip kaydedilmeyeceğini tanımlayan bayrak. |
