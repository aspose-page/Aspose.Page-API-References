...
description: "PDF dosyasındaki görüntüler dışındaki tüm içeriklere uygulanan sıkıştırma türünü belirtir."
type: docs
weight: 23
url: /tr/java/com.aspose.xps.rendering/pdftextcompression/
---
**Inheritance:**
...
PDF dosyasındaki görüntüler dışındaki tüm içeriklere uygulanan sıkıştırma türünü belirtir.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Flate](#Flate) | Flate sıkıştırma türü |
| [Lzw](#Lzw) | Lzw sıkıştırma türü |
| [None](#None) | None sıkıştırma türü |
| [Rle](#Rle) | Rle sıkıştırma türü |
## Yöntemler
