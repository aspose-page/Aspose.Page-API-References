...
description: "XPS-as-JPEG kaydetme seçenekleri için sınıf."
type: docs
weight: 12
url: /tr/java/com.aspose.xps.rendering/jpegsaveoptions/
---
**Inheritance:**
...
XPS-as-JPEG kaydetme seçenekleri için sınıf.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JpegSaveOptions()](#JpegSaveOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
