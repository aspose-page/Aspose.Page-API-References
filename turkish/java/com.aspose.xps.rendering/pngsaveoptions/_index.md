...
description: "XPS-as-PNG kaydetme seçenekleri için sınıf."
type: docs
weight: 15
url: /tr/java/com.aspose.xps.rendering/pngsaveoptions/
---
**Inheritance:**
...
XPS-as-PNG kaydetme seçenekleri için sınıf.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PngSaveOptions()](#PngSaveOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
