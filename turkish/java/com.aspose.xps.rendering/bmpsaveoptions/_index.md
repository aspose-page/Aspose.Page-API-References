...
description: "XPS-as-BMP kaydetme seçenekleri için sınıf."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.rendering/bmpsaveoptions/
---
**Inheritance:**
...
XPS-as-BMP kaydetme seçenekleri için sınıf.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [BmpSaveOptions()](#BmpSaveOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
