...
description: "PageSourceColorProfile özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pagesourcecolorprofile.pagesourcecolorprofileoption/
---
**Inheritance:**
...
PageSourceColorProfile özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [CMYK](#CMYK) | Etiketlenmemiş CMYK verileri için renk yönetimi yapmakta kullanılan kaynak profil. |
| [None](#None) | Kaynak profil yok. |
| [RGB](#RGB) | Etiketlenmemiş RGB verileri için renk yönetimi yapmakta kullanılan kaynak profil. |
## Yöntemler
...
Etiketlenmemiş CMYK verileri için renk yönetimi yapmakta kullanılan kaynak profil.
...
Etiketlenmemiş RGB verileri için renk yönetimi yapmakta kullanılan kaynak profil.
