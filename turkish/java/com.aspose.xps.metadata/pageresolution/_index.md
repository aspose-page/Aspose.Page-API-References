...
description: "Yazdırılan çıktının sayfa çözünürlüğünü niteliksel bir değer, inç başına nokta olarak veya her ikisi olarak tanımlar."
type: docs
weight: 120
url: /tr/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
Yazdırılan çıktının sayfa çözünürlüğünü niteliksel bir değer, inç başına nokta olarak veya her ikisi olarak tanımlar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | Özellik için özel öğeler içeren bir dizi. |
