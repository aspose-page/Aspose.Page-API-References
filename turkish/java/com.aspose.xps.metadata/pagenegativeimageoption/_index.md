...
description: "PageNegativeImage özellik seçeneklerini tanımlar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
PageNegativeImage özelliği seçeneklerini tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Negative](#Negative) | Çıktının negatif görüntü olmasını belirtir. |
| [None](#None) | Çıktının negatif olmayan görüntü olmasını belirtir. |
## Yöntemler
...
Çıktının negatif görüntü olmasını belirtir.
...
Çıktının negatif olmayan görüntü olmasını belirtir.
