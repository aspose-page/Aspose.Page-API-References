...
description: "DocumentCollate ve JobCollateAllDocuments özellik seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
DocumentCollate ve JobCollateAllDocuments özellik seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Collated](#Collated) | Sıralamayı belirtir. |
| [Uncollated](#Uncollated) | Sıralama olmadığını belirtir. |
## Yöntemler
