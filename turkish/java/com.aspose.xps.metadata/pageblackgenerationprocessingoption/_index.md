...
description: "PageBlackGenerationProcessing özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pageblackgenerationprocessing.pageblackgenerationprocessingoption/
---
**Inheritance:**
...
PageBlackGenerationProcessing özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Automatic](#Automatic) | Otomatik seçenek. |
| [Custom](#Custom) | Özel seçenek. |
## Yöntemler
