...
description: "Bağlama yöntemini açıklar."
type: docs
weight: 45
url: /tr/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Bağlama yöntemini açıklar. İşteki tüm belgeler birlikte bağlanır.  JobBindAllDocuments  ve  DocumentBinding  birbirini dışlar. Bu anahtar kelimeler arasındaki kısıtlama işleyişini belirlemek sürücünün sorumluluğundadır. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Özelliğe özgü seçeneklerin bir dizisi. |
