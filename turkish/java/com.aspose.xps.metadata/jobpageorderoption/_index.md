...
description: "JobPageOrder özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
JobPageOrder özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Reverse](#Reverse) | Arka ön sayfa sırasını belirtir. |
| [Standard](#Standard) | Ön arka sayfa sırasını belirtir. |
## Yöntemler
...
Arka ön sayfa sırasını belirtir.
...
Ön arka sayfa sırasını belirtir.
