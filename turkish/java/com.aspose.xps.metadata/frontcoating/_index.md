...
description: "FrontCoating puanlı özellik değeri için sabitleri tanımlar."
type: docs
weight: 11
url: /tr/java/com.aspose.xps.metadata/pagemediatype.frontcoating/
---
**Inheritance:**
...
FrontCoating puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Glossy](#Glossy) | Parlak değer. |
| [HighGloss](#HighGloss) | YüksekParlak değer. |
| [Matte](#Matte) | Mat değer. |
| [None](#None) | None değeri. |
| [Satin](#Satin) | Saten değer. |
| [SemiGloss](#SemiGloss) | YarıParlak değer. |
## Yöntemler
