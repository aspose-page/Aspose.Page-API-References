...
description: "FeedFace puanlanmış özelliği değeri için sabitleri tanımlar."
type: docs
weight: 12
url: /tr/java/com.aspose.xps.metadata/inputbin.feedface/
---
**Inheritance:**
...
FeedFace puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [FaceDown](#FaceDown) | FaceDown değeri. |
| [FaceUp](#FaceUp) | FaceUp değeri. |
## Yöntemler
