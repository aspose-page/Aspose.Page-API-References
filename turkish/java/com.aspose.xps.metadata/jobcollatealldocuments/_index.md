...
description: "Çıktının birleştirme özelliklerini açıklar."
type: docs
weight: 47
url: /tr/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Çıktının birleştirme özelliklerini açıklar. Her ayrı işteki tüm belgeler birleştirilir.  DocumentCollate  ve  JobCollateAllDocuments  karşılıklı olarak birbirini dışlar. Bu anahtar kelimelerden ikisinin ya da sadece birinin uygulanıp uygulanmayacağı davranışı ve uygulaması sürücüye bırakılmıştır. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | Özelliğe özgü seçeneklerin bir dizisi. |
