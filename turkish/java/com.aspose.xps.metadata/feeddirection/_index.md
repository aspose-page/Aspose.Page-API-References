...
description: "FeedDirection puanlanmış özelliği değeri için sabitleri tanımlar."
type: docs
weight: 11
url: /tr/java/com.aspose.xps.metadata/inputbin.feeddirection/
---
**Inheritance:**
...
FeedDirection puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [LongEdgeFirst](#LongEdgeFirst) | LongEdgeFirst değeri. |
| [ShortEdgeFirst](#ShortEdgeFirst) | LongEdgeFirst değeri. |
## Yöntemler
