...
description: "PageResolution özellik seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pageresolution.pageresolutionoption/
---
**Inheritance:**
...
PageResolution özellik seçeneklerini açıklar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageResolutionOption(String optionName, PageResolution.IPageResolutionOptionItem[] items)](#PageResolutionOption-java.lang.String-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [add(IOptionItem[] items)](#add-com.aspose.xps.metadata.IOptionItem...-) | Bu seçeneğin öğe listesine bir öğe listesi ekler. |
| [add(PageResolution.IPageResolutionOptionItem[] items)](#add-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | IPageResolutionOptionItem örneklerinden bir dizi seçeneğe ekler. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setResolutionX(int resolutionX)](#setResolutionX-int-) | ResolutionX puanlı bir özellik değerini ayarlar. |
| [setResolutionY(int resolutionY)](#setResolutionY-int-) | ResolutionY puanlı bir özellik değerini ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| items | [IPageResolutionOptionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionoptionitem) | IPageResolutionOptionItem örneklerinden rastgele bir dizi. |
...
IPageResolutionOptionItem örneklerinden bir dizi seçeneğe ekler.
...
ResolutionX puanlı bir özellik değerini ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| resolutionX | int | ResolutionX puanlı bir özellik değeri. |
...
ResolutionY puanlı bir özellik değerini ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| resolutionY | int | Bir  ResolutionY  puanlı özellik değeri. |
