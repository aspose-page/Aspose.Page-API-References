...
description: "Tek bir sayfanın birden fazla fiziksel medya sayfasına çıktısını açıklar."
type: docs
weight: 118
url: /tr/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Tek bir sayfanın birden fazla fiziksel medya sayfasına çıktısını açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PagePoster()](#PagePoster--) | Yeni bir örnek oluşturur. |
## Yöntemler
...
PagesPerSheet puanlı özellik değerine sahip bir seçenek ekler. Mantıksal sayfa başına fiziksel sayfa sayısını belirtir.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | int | PagesPerSheet puanlı bir özellik değeri. |
