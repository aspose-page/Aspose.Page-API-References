...
description: "Cihaz için desteklenen bölmelerin tam listesini açıklar."
type: docs
weight: 30
url: /tr/java/com.aspose.xps.metadata/documentoutputbin/
---
**Inheritance:**
...
Cihaz için desteklenen tüm bölmelerin tam listesini açıklar. Çıktı bölmesi, belge başına belirtmeye izin verir.  JobOutputBin ,  DocumentOutputBin  ve  PageOutputBin  anahtar sözcükleri birbirini dışlar; bir PrintTicket veya Print Capabilities belgesinde yalnızca biri belirtilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentoutputbin
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentOutputBin(OutputBin.IOutputBinItem[] items)](#DocumentOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler
