...
description: "PrePunched puanlı özellik değeri için sabitleri tanımlar."
type: docs
weight: 15
url: /tr/java/com.aspose.xps.metadata/pagemediatype.prepunched/
---
**Inheritance:**
...
PrePunched puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [None](#None) | None değeri. |
| [PrePunchedValue](#PrePunchedValue) | PrePunched değeri. |
## Yöntemler
