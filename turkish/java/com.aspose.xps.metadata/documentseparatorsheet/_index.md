...
description: "Bir belge için ayırıcı sayfa kullanımını açıklar."
type: docs
weight: 34
url: /tr/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Bir belge için ayırıcı sayfa kullanımını açıklar. Ayırıcı sayfalar, aşağıda belirtilen Seçenek tarafından gösterildiği gibi çıktıda görünmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | Özelliğe özgü seçeneklerin bir dizisi. |
