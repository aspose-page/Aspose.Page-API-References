...
description: "Bir cihazdaki kurulu çıktı kutusunu veya cihaz için desteklenen kutuların tam listesini açıklar."
type: docs
weight: 61
url: /tr/java/com.aspose.xps.metadata/joboutputbin/
---
**Inheritance:**
...
Bir cihazda kurulu çıkış kutusunu veya bir cihaz için desteklenen kutuların tam listesini tanımlar. JobOutputBin, DocumentOutputBin ve PageOutputBin anahtar sözcükleri birbirini dışlar; yalnızca biri bir PrintTicket veya Print Capabilities belgesinde belirtilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputbin
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobOutputBin(OutputBin.IOutputBinItem[] items)](#JobOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| items | [IOutputBinItem\[\]](../../com.aspose.xps.metadata/ioutputbinitem) | Özellik için özel öğeler içeren bir dizi. |
