...
description: "DocumentSeparatorSheet özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/documentseparatorsheet.documentseparatorsheetoption/
---
**Inheritance:**
...
DocumentSeparatorSheet özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [BothSheets](#BothSheets) | Belge başlangıcında ve sonunda bir ayırıcı sayfa belirtir. |
| [EndSheet](#EndSheet) | Belge sonunda bir ayırıcı sayfa belirtir. |
| [None](#None) | Ayırıcı sayfa(lar) belirtilmez. |
| [StartSheet](#StartSheet) | Belge başlangıcında bir ayırıcı sayfa belirtir. |
## Yöntemler
...
Belge başlangıcında ve sonunda bir ayırıcı sayfa belirtir.
...
Belge sonunda bir ayırıcı sayfa belirtir.
...
Belge başlangıcında bir ayırıcı sayfa belirtir.
