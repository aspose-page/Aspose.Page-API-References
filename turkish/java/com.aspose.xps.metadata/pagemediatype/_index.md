...
description: "MediaType seçeneklerini ve her seçeneğin özelliklerini açıklar."
type: docs
weight: 110
url: /tr/java/com.aspose.xps.metadata/pagemediatype/
---
**Inheritance:**
...
MediaType seçeneklerini ve her seçeneğin özelliklerini açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediatype
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageMediaType(PageMediaType.IPageMediaTypeItem[] items)](#PageMediaType-com.aspose.xps.metadata.PageMediaType.IPageMediaTypeItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| items | [IPageMediaTypeItem\[\]](../../com.aspose.xps.metadata/ipagemediatypeitem) | Özellik için özel öğeler içeren bir dizi. |
