...
description: "JobNUpAllDocumentsContiguously ve DocumentNUp özellik sınıfları için temel sınıf."
type: docs
weight: 74
url: /tr/java/com.aspose.xps.metadata/nup/
---
**Inheritance:**
...
JobNUpAllDocumentsContiguously ve DocumentNUp özellik sınıfları için temel sınıf.
## Yöntemler
