...
description: "MediaCapacity puanlı özellik değeri için, kutunun yüksek kapasiteli bir kutu olup olmadığını belirten sabitler tanımlayın."
type: docs
weight: 15
url: /tr/java/com.aspose.xps.metadata/inputbin.mediacapacity/
---
**Inheritance:**
...
MediaCapacity puanlı özellik değeri için, kutunun yüksek kapasiteli bir kutu olup olmadığını (niteliksel) belirten sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [High](#High) | Yüksek değer. |
| [Standard](#Standard) | Standart değer. |
## Yöntemler
