...
description: "Çıktının delik delme özelliklerini açıklar."
type: docs
weight: 55
url: /tr/java/com.aspose.xps.metadata/jobholepunch/
---
**Inheritance:**
...
Çıktının delme özelliklerini açıklar. Tüm belgeler birlikte delinmiştir. JobHolePunch ve DocumentHolePunch anahtar sözcükleri birbirini dışlar. Her ikisi de bir PrintTicket veya Print Capabilities belgesinde aynı anda belirtilmemelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobHolePunch(HolePunch.HolePunchOption[] options)](#JobHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [HolePunchOption\[\]](../../com.aspose.xps.metadata/holepunchoption) | Özelliğe özgü seçeneklerin bir dizisi. |
