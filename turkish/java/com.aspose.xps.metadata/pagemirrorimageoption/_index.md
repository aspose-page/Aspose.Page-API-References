...
description: "PageMirrorImage özelliği seçeneklerini tanımlar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pagemirrorimage.pagemirrorimageoption/
---
**Inheritance:**
...
PageMirrorImage özelliği seçeneklerini tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [MirrorImageHeight](#MirrorImageHeight) | Çıktının MediaSizeHeight yönüne paralel olarak yansıtılması gerektiğini belirtir. |
| [MirrorImageWidth](#MirrorImageWidth) | Çıktının MediaSizeWidth yönüne paralel olarak yansıtılması gerektiğini belirtir. |
| [None](#None) | Çıktının yansıtılmaması gerektiğini belirtir. |
## Yöntemler
