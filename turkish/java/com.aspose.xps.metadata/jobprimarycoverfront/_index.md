...
type: docs
weight: 68
url: /tr/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Ön (başlangıç) kapak sayfasını açıklar. Tüm iş tek bir birincil sayfaya sahip olacaktır. Kapak sayfası, işin ilk sayfası için kullanılan  PageMediaSize  ve  PageMediaType  üzerine basılmalıdır. Kapak sayfası, belirtilen Seçenek tarafından gösterildiği gibi işleme seçeneklerine (örneğin  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) entegre edilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Yöntemler
