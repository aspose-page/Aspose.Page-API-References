...
description: "JobRollCutAtEndOfJob ve DocumentRollCut özellik sınıfları için temel sınıf."
type: docs
weight: 145
url: /tr/java/com.aspose.xps.metadata/rollcut/
---
**Inheritance:**
...
JobRollCutAtEndOfJob ve DocumentRollCut özellik sınıfları için temel sınıf.
## Yöntemler
