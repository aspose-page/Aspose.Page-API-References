...
description: "Tüm iş için dijital imza işleme yapılandırmasını açıklar."
type: docs
weight: 51
url: /tr/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing/
---
**Inheritance:**
...
Tüm iş için dijital imza işlemini yapılandırmayı açıklar. Yalnızca dijital imzalar içeren içeriklerde uygulanır. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobDigitalSignatureProcessing(JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption[] options)](#JobDigitalSignatureProcessing-com.aspose.xps.metadata.JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [JobDigitalSignatureProcessingOption\[\]](../../com.aspose.xps.metadata/jobdigitalsignatureprocessingoption) | Özelliğe özgü seçeneklerin bir dizisi. |
