...
type: docs
weight: 71
url: /tr/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Rulo kağıdı için kesme yöntemini tanımlar. Rulo işin sonunda kesilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
