...
description: "Fiziksel medya sayfasının yönünü açıklar."
type: docs
weight: 113
url: /tr/java/com.aspose.xps.metadata/pageorientation/
---
**Inheritance:**
...
Fiziksel medya sayfasının yönünü açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageOrientation(PageOrientation.PageOrientationOption[] options)](#PageOrientation-com.aspose.xps.metadata.PageOrientation.PageOrientationOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageOrientationOption\[\]](../../com.aspose.xps.metadata/pageorientationoption) | Özelliğe özgü seçeneklerin bir dizisi. |
