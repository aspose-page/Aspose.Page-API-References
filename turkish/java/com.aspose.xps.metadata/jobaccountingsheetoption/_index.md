...
description: "JobAccountingSheet özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
JobAccountingSheet özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [None](#None) | Hiçbir muhasebe sayfasının çıktılanmayacağını belirtir. |
| [Standard](#Standard) | Standart (cihaz tanımlı) muhasebe sayfasının çıktılanması gerektiğini belirtir. |
## Yöntemler
...
Hiçbir muhasebe sayfasının çıktılanmayacağını belirtir.
...
Standart (cihaz tanımlı) muhasebe sayfasının çıktılanması gerektiğini belirtir.
