...
description: "Özel bir afiş sayfası için kaynağı belirtir."
type: docs
weight: 14
url: /tr/java/com.aspose.xps.metadata/documentbannersheetsource/
---
**Inheritance:**
...
Özel bir banner sayfası için kaynağı belirtir. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbannersheetsource
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentBannerSheetSource(String value)](#DocumentBannerSheetSource-java.lang.String-) | Yeni bir örnek oluşturur. |
## Yöntemler
