...
description: "JobDuplexAllDocumentsContiguously ve DocumentDuplex özellik seçeneklerini açıklar."
type: docs
weight: 11
url: /tr/java/com.aspose.xps.metadata/duplex.duplexoption/
---
**Inheritance:**
...
JobDuplexAllDocumentsContiguously ve DocumentDuplex özellik seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [OneSided](#OneSided) | Tek taraflı baskıyı belirtir. |
## Yöntemler
...
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
| [twoSidedLongEdge(Duplex.DuplexMode duplexMode)](#twoSidedLongEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Sayfanın  MediaSizeHeight  yönüne paralel olarak çevrildiği iki taraflı baskıyı belirtir. |
| [twoSidedShortEdge(Duplex.DuplexMode duplexMode)](#twoSidedShortEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Sayfanın  MediaSizeWidth  yönüne paralel olarak çevrildiği iki taraflı baskıyı belirtir. |
| [wait()](#wait--) |  |
...
Sayfanın  MediaSizeHeight  yönüne paralel olarak çevrildiği iki taraflı baskıyı belirtir.
...
Sayfanın  MediaSizeWidth  yönüne paralel olarak çevrildiği iki taraflı baskıyı belirtir.
