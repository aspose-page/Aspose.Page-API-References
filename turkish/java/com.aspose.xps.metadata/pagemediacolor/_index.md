...
description: "Media Color seçeneklerini ve her seçeneğin özelliklerini açıklar."
type: docs
weight: 101
url: /tr/java/com.aspose.xps.metadata/pagemediacolor/
---
**Inheritance:**
...
Medya Rengi seçeneklerini ve her seçeneğin özelliklerini açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageMediaColor(PageMediaColor.PageMediaColorOption[] options)](#PageMediaColor-com.aspose.xps.metadata.PageMediaColor.PageMediaColorOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageMediaColorOption\[\]](../../com.aspose.xps.metadata/pagemediacoloroption) | Özelliğe özgü seçeneklerin bir dizisi. |
