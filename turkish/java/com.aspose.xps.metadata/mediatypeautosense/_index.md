...
description: "MediaTypeAutoSense puanlı özellik değeri için sabitleri tanımlar."
type: docs
weight: 19
url: /tr/java/com.aspose.xps.metadata/inputbin.mediatypeautosense/
---
**Inheritance:**
...
MediaTypeAutoSense puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [None](#None) | None değeri. |
| [Supported](#Supported) | Desteklenen değer. |
## Yöntemler
