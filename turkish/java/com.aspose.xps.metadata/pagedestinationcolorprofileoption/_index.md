...
description: "PageDestinationColorProfile özellik seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
PageDestinationColorProfile özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Application](#Application) | Uygulama kullanılacak hedef profili belirtir. |
| [DriverConfiguration](#DriverConfiguration) | Renk yönetimini gerçekleştirmek için kullanılan hedef profil. |
## Yöntemler
