...
description: "PageForceFrontSide özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
PageForceFrontSide özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Çıktının sayfanın ön tarafıyla sınırlı olduğunu belirtir. |
| [None](#None) | Çıktı kısıtlaması belirtilmez. |
## Yöntemler
