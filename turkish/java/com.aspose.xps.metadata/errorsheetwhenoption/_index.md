...
description: "ErrorSheetWhen özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
ErrorSheetWhen özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Always](#Always) | Her iş için bir hata sayfasının çıktılanacağını belirtir. |
| [OnError](#OnError) | Yalnızca hata durumunda bir hata sayfasının çıktılanacağını belirtir. |
## Yöntemler
...
Her iş için bir hata sayfasının çıktılanacağını belirtir.
...
Yalnızca hata durumunda bir hata sayfasının çıktılanacağını belirtir.
