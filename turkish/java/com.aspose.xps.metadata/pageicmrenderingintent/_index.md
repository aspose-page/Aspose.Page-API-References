...
description: "ICC v2 Spesifikasyonu tarafından tanımlanan renderleme amacını açıklar."
type: docs
weight: 98
url: /tr/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
ICC v2 Spesifikasyonu tarafından tanımlanan renderleme amacını açıklar. Bu değer, bir görüntü veya grafik öğesi, Rendering amacını belirten gömülü bir profile sahipse göz ardı edilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageicmrenderingintent
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | Özelliğe özgü seçeneklerin bir dizisi. |
