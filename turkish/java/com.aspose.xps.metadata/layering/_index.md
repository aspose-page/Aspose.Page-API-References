...
description: "İç Layering özelliğini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pagewatermark.layering/
---
**Inheritance:**
...
İç  Layering  özelliğini açıklar. Watermark'ın katman davranışını tanımlar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Layering(PageWatermark.LayeringOption[] options)](#Layering-com.aspose.xps.metadata.PageWatermark.LayeringOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [LayeringOption\[\]](../../com.aspose.xps.metadata/layeringoption) | Özelliğe özgü seçeneklerin bir dizisi. |
