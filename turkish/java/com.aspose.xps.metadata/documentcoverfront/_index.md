...
description: "Ön başlangıç kapak sayfasını açıklar."
type: docs
weight: 21
url: /tr/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
Ön (başlangıç) kapak sayfasını açıklar. Her belge ayrı bir sayfaya sahip olacaktır. Kapak sayfası, belgenin ilk sayfası için kullanılan  PageMediaSize  ve  PageMediaType  üzerine basılmalıdır. Kapak sayfası, belirtilen Seçenek tarafından gösterildiği gibi işleme seçeneklerine (örneğin  DocumentDuplex ,  DocumentNUp ) entegre edilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | Özelliğe özgü seçeneklerin bir dizisi. |
