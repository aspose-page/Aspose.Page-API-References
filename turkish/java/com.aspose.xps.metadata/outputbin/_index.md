...
description: "JobOutputBin, DocumentOutputBin ve PageOutputBin özellik sınıfları için temel sınıftır."
type: docs
weight: 77
url: /tr/java/com.aspose.xps.metadata/outputbin/
---
**Inheritance:**
...
JobOutputBin, DocumentOutputBin ve PageOutputBin özellik sınıfları için temel sınıf.
## Yöntemler
