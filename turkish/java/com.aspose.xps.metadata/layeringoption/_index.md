...
description: "Katmanlama özelliği seçeneklerini açıklar."
type: docs
weight: 11
url: /tr/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Layering özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Overlay](#Overlay) | Filigran sayfa içeriğinin üzerinde görünür. |
| [Underlay](#Underlay) | Filigran sayfa içeriğinin altında görünür. |
## Yöntemler
...
Filigran sayfa içeriğinin üzerinde görünür.
...
Filigran sayfa içeriğinin altında görünür.
