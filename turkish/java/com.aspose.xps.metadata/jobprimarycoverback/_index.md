...
type: docs
weight: 66
url: /tr/java/com.aspose.xps.metadata/jobprimarycoverback/
---
**Inheritance:**
...
Arka (bitiş) kapak sayfasını açıklar. Her iş ayrı bir birincil sayfaya sahip olacaktır. Kapak sayfası, işin son sayfası için kullanılan  PageMediaSize  ve  PageMediaType  üzerine basılmalıdır. Kapak sayfası, belirtilen Seçenek tarafından gösterildiği gibi işleme seçeneklerine (örneğin  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) entegre edilmelidir. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverback
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobPrimaryCoverBack(JobPrimaryCoverBack.CoverBackOption[] options)](#JobPrimaryCoverBack-com.aspose.xps.metadata.JobPrimaryCoverBack.CoverBackOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
