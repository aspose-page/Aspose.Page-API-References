...
description: "JobDigitalSignatureProcessing özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/
---
**Inheritance:**
...
JobDigitalSignatureProcessing özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [PrintInvalidSignatures](#PrintInvalidSignatures) | Dijital imzaların geçerliliği ne olursa olsun işi yazdır. |
| [PrintInvalidSignaturesWithErrorReport](#PrintInvalidSignaturesWithErrorReport) | Dijital imzaların geçerliliği ne olursa olsun işi yazdır. |
| [PrintOnlyValidSignatures](#PrintOnlyValidSignatures) | Tüm dijital imzalar geçerli olduğunda yalnızca işi yazdır. |
## Yöntemler
...
Dijital imzaların geçerliliği ne olursa olsun işi yazdır. Dijital imzalar göz ardı edilebilir.
...
Dijital imzaların geçerliliği ne olursa olsun işi yazdır. Geçersiz bir imza bulunması durumunda, bir hata sayfası işin sonunda yazdırılmalıdır. Dijital imzalar göz ardı edilmemelidir.
...
Tüm dijital imzalar geçerli olduğunda işi yalnızca yazdır. Dijital imzalar göz ardı edilmemelidir.
