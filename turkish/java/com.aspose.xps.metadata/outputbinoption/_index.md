...
description: "JobOutputBin, DocumentOutputBin ve PageOutputBin özellik seçeneklerini açıklar."
type: docs
weight: 12
url: /tr/java/com.aspose.xps.metadata/outputbin.outputbinoption/
---
**Inheritance:**
...
JobOutputBin, DocumentOutputBin ve PageOutputBin özellik seçeneklerini açıklar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [OutputBinOption(OutputBin.IOutputBinOptionItem[] items)](#OutputBinOption-com.aspose.xps.metadata.OutputBin.IOutputBinOptionItem...-) | Yeni bir örnek oluşturur. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [add(IOptionItem[] items)](#add-com.aspose.xps.metadata.IOptionItem...-) | Bu seçeneğin öğe listesine bir öğe listesi ekler. |
| [add(OutputBin.IOutputBinOptionItem[] items)](#add-com.aspose.xps.metadata.OutputBin.IOutputBinOptionItem...-) | Özelliğe  IOutputBinOptionItem  örneklerinden oluşan bir dizi ekler. |
...
| --- | --- | --- |
| items | [IOutputBinOptionItem\[\]](../../com.aspose.xps.metadata/ioutputbinoptionitem) | İsteğe bağlı bir dizi  IOutputBinOptionItem  örnekleri. |
...
Özelliğe  IOutputBinOptionItem  örneklerinden oluşan bir dizi ekler.
