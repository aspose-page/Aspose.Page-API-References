...
description: "Mevcut sayfa için renk yönetimini yapılandırır."
type: docs
weight: 89
url: /tr/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
Mevcut sayfa için renk yönetimini yapılandırır. Bu, SHIM - DM\_ICMMethod Add System içinde otomatik olarak kabul edilir. Hangi bileşenin renk yönetimini gerçekleştirmesi gerektiğini (ör. Sürücü) açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | Özelliğe özgü seçeneklerin bir dizisi. |
