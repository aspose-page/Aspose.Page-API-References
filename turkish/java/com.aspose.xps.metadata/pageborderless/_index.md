...
description: "Görüntü içeriğinin medyanın fiziksel kenarlarına ne zaman basılması gerektiğini açıklar."
type: docs
weight: 88
url: /tr/java/com.aspose.xps.metadata/pageborderless/
---
**Inheritance:**
...
Görüntü içeriğinin medyanın fiziksel kenarlarına ne zaman basılması gerektiğini açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageBorderless(PageBorderless.PageBorderlessOption[] options)](#PageBorderless-com.aspose.xps.metadata.PageBorderless.PageBorderlessOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageBorderlessOption\[\]](../../com.aspose.xps.metadata/pageborderlessoption) | Özelliğe özgü seçeneklerin bir dizisi. |
