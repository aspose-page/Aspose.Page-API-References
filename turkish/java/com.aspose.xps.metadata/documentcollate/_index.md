...
type: docs
weight: 17
url: /tr/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Çıktının sıralama özelliklerini açıklar. Her bireysel belgedeki tüm sayfalar sıralanır. DocumentCollate ve JobCollateAlldocuments birbirini dışlar. Bu anahtar kelimelerden birinin ya da her ikisinin uygulanması davranışı ve uygulaması sürücüye bırakılmıştır. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
