...
description: "Çıktının bir ortam sayfasının ön yüzünde görünmesini zorlar."
type: docs
weight: 97
url: /tr/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Çıktının bir medya sayfasının ön tarafında görünmesini zorlar. Her iki tarafı farklı yüzeylere sahip medya sayfaları için geçerlidir. Bu özelliğin işleme seçenekleriyle (örneğin  DocumentDuplex ) çakıştığı durumlarda,  PageForceFrontSide  özelliğinin uygulandığı belirli sayfa için öncelik kazanır.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | Özelliğe özgü seçeneklerin bir dizisi. |
