...
description: "JobOutputOptimization özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/joboutputoptimization.joboutputoptimizationoption/
---
**Inheritance:**
...
JobOutputOptimization özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [ArchiveFormat](#ArchiveFormat) | İş işleme, arşiv çıktısı için optimize edilmelidir. |
| [None](#None) | İş işleme, belirli bir senaryo için optimize edilmemelidir. |
| [OptimizeForPortability](#OptimizeForPortability) | İş işleme, çıktının taşınabilirliği (çapraz cihaz) için optimize edilmelidir. |
| [OptimizeForQuality](#OptimizeForQuality) | İş işleme, çıktının kalitesi için optimize edilmelidir. |
| [OptimizeForSpeed](#OptimizeForSpeed) | İş işleme, çıktının hızı için optimize edilmelidir. |
## Yöntemler
...
İş işleme, arşiv çıktısı için optimize edilmelidir.
...
İş işleme, belirli bir senaryo için optimize edilmemelidir.
...
İş işleme, çıktının taşınabilirliği (çapraz cihaz) için optimize edilmelidir.
...
İş işleme, çıktının kalitesi için optimize edilmelidir.
...
İş işleme, çıktının hızı için optimize edilmelidir.
