...
description: "FeedType puanlanmış özelliği değeri için sabitleri tanımlar."
type: docs
weight: 13
url: /tr/java/com.aspose.xps.metadata/inputbin.feedtype/
---
**Inheritance:**
...
FeedType puanlı özellik değeri için sabitleri tanımlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Automatic](#Automatic) | Otomatik değer. |
| [Manual](#Manual) | Manuel değer. |
## Yöntemler
