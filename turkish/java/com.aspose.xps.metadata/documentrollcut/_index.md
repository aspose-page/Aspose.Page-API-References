...
description: "Rulo kağıt için kesme yöntemini açıklar."
type: docs
weight: 33
url: /tr/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Rulo kağıdı kesme yöntemini açıklar. Her belge ayrı ayrı işlenir. Belirtilen seçenekler rulo kesimi için farklı yöntemleri açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Özelliğe özgü seçeneklerin bir dizisi. |
