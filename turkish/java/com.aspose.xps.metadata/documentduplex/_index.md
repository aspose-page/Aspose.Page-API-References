...
type: docs
weight: 23
url: /tr/java/com.aspose.xps.metadata/documentduplex/
---
**Inheritance:**
...
Çıktının çift taraflı özelliklerini açıklar. Çift taraflı özellik, medyanın her iki yüzüne de yazdırmaya izin verir. Her belge ayrı ayrı çift taraflıdır. DocumentDuplex ve JobDuplexAllDocumentsContiguously birbirini dışlar. Bu anahtar kelimeler arasındaki kısıtlama işleyişini belirlemek sürücünün sorumluluğundadır. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentduplex
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentDuplex(Duplex.DuplexOption[] options)](#DocumentDuplex-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
