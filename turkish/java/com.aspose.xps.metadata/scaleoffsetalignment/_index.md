...
description: "İç ScaleOffsetAlignment özelliğini açıklar."
type: docs
weight: 11
url: /tr/java/com.aspose.xps.metadata/pagescaling.scaleoffsetalignment/
---
**Inheritance:**
...
İç ScaleOffsetAlignment özelliğini açıklar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ScaleOffsetAlignment(PageScaling.ScaleOffsetAlignmentOption[] options)](#ScaleOffsetAlignment-com.aspose.xps.metadata.PageScaling.ScaleOffsetAlignmentOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [ScaleOffsetAlignmentOption\[\]](../../com.aspose.xps.metadata/scaleoffsetalignmentoption) | Özelliğe özgü seçeneklerin bir dizisi. |
