...
description: "JobErrorSheet özelliği seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/joberrorsheet.errorsheetoption/
---
**Inheritance:**
...
JobErrorSheet özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Custom](#Custom) | Özel bir hata sayfasının çıktılanması gerektiğini belirtir. |
| [None](#None) | Hata sayfasının çıktılanmaması gerektiğini belirtir. |
| [Standard](#Standard) | Standart (cihaz tanımlı) hata sayfasının çıktılanması gerektiğini belirtir. |
## Yöntemler
...
Özel bir hata sayfasının çıktılanması gerektiğini belirtir. Eğer bir JobErrorSheetSource ParameterInit öğesi belirtilmemişse, bu Option göz ardı edilmelidir.
...
Hata sayfasının çıktılanmaması gerektiğini belirtir.
...
Standart (cihaz tanımlı) hata sayfasının çıktılanması gerektiğini belirtir.
