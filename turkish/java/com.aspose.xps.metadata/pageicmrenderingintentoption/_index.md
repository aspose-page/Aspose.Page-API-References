...
description: "PageICMRenderingIntent özellik seçeneklerini açıklar."
type: docs
weight: 10
url: /tr/java/com.aspose.xps.metadata/pageicmrenderingintent.pageicmrenderingintentoption/
---
**Inheritance:**
...
PageICMRenderingIntent özelliği seçeneklerini açıklar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [AbsoluteColorimetric](#AbsoluteColorimetric) | Mutlak Renk Ölçümsel İşleme niyeti. |
| [BusinessGraphics](#BusinessGraphics) | İş Grafikleri İşleme niyeti. |
| [Photographs](#Photographs) | Fotoğraflar İşleme niyeti. |
| [RelativeColorimetric](#RelativeColorimetric) | Göreceli Renkimetri İşleme amacı. |
## Yöntemler
...
Mutlak Renk Ölçümsel İşleme niyeti.
...
Göreceli Renkimetri İşleme amacı.
