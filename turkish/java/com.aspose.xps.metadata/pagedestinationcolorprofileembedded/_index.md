...
description: "Gömülü hedef renk profilini belirtir."
type: docs
weight: 92
url: /tr/java/com.aspose.xps.metadata/pagedestinationcolorprofileembedded/
---
**Inheritance:**
...
Gömülü hedef renk profilini belirtir. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PageDestinationColorProfileEmbedded(String value)](#PageDestinationColorProfileEmbedded-java.lang.String-) | Yeni bir örnek oluşturur. |
## Yöntemler
