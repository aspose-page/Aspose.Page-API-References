...
description: "Çıktının zımba özelliklerini açıklar."
type: docs
weight: 72
url: /tr/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Çıktının zımbalama özelliklerini açıklar. İşteki tüm belgeler birlikte zımbalanır.  JobStapleAllDocuments  ve  DocumentStaple  anahtar sözcükleri birbirini dışlar. Bu anahtar sözcükler arasındaki kısıtlama işleyişini sürücü belirler. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Yeni bir örnek oluşturur. |
## Yöntemler
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | Özelliğe özgü seçeneklerin bir dizisi. |
