...
description: "PS belge yükleme seçenekleri."
type: docs
weight: 18
url: /tr/java/com.aspose.eps/psloadoptions/
---
**Inheritance:**
...
PS belge yükleme seçenekleri.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PsLoadOptions()](#PsLoadOptions--) | Seçeneklerin yeni bir örneğini oluşturur. |
## Yöntemler
