...
description: Aspose.Page.XPS.XpsModel.XpsContentElement sınıf. XPS içerik öğelerinin özelliklerini kapsar Canvas Path ve Glyphs.
type: docs
weight: 3010
...
XPS içerik öğelerinin özelliklerini kapsar: Canvas, Path ve Glyphs.
