...
LinearGradientBrush özellik öğesi özelliklerini kapsayan sınıf. Bu öğe, bir vektör boyunca doğrusal bir degrade fırça belirtmek için kullanılır.
...
| İsim | Tanım |
| --- | --- |
| [Clone](../../aspose.page.xps.xpsmodel/xpslineargradientbrush/clone/)() | Bu doğrusal degrade fırçayı kopyalar. |
