...
description: XpsElementLinkTarget inşaatçı. Yeni örneği oluşturur.
type: docs
weight: 10
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| targetCanvas | XpsCanvas | Etkin sabit belgedeki tuval öğesi. |
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| targetGlyphs | XpsGlyphs | Etkin sabit belgedeki glifler öğesi. |
