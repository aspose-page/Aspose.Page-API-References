...
description: Herhangi bir XPS öğesi için manipülasyon yöntemleri sağlayan XPS belgesinin ana varlığını içine alan sınıf.
type: docs
weight: 410
...
Herhangi bir XPS öğesi için manipülasyon yöntemleri sağlayan XPS belgesinin ana varlığını içine alan sınıf.
...
| İsim | Tanım |
| --- | --- |
| [XpsDocument](xpsdocument#constructor)() | Varsayılan sayfa boyutuyla boş XPS belgesi oluşturur. |
| [XpsDocument](xpsdocument#constructor_2)(string) | Adresinde bulunan mevcut bir XPS belgesini açar.*path* . |
| [XpsDocument](xpsdocument#constructor_1)(Stream, LoadOptions) | İçinde depolanan mevcut bir belgeyi yükler.*stream* XPS belgesi olarak. |
| [XpsDocument](xpsdocument#constructor_3)(string, LoadOptions) | Şurada bulunan mevcut bir belgeyi açar:*path* XPS belgesi olarak. |
...
| [ActivePage](../../aspose.page.xps/xpsdocument/activepage) { get; } | Etkin belge içindeki etkin sayfa numarasını alır. |
| [DocumentCount](../../aspose.page.xps/xpsdocument/documentcount) { get; } | XPS paketi içindeki belge sayısını verir. |
| [JobPrintTicket](../../aspose.page.xps/xpsdocument/jobprintticket) { get; set; } | Belgenin işi yazdırma biletini döndürür/ayarlar |
| [Page](../../aspose.page.xps/xpsdocument/page) { get; } | Bir[`XpsPage`](../../aspose.page.xps.xpsmodel/xpspage) aktif sayfa örneği. |
| [PageCount](../../aspose.page.xps/xpsdocument/pagecount) { get; } | Etkin belgedeki sayfa sayısını verir. |
| [TotalPageCount](../../aspose.page.xps/xpsdocument/totalpagecount) { get; } | XPS belgesi içindeki tüm belgelerdeki toplam sayfa sayısını verir. |
...
| [AddDocument](../../aspose.page.xps/xpsdocument/adddocument#adddocument_1)(float, float, bool) | İlk sayfa boyutlarına sahip boş bir belge ekler *width* ve*height* . |
...
| [AddPage](../../aspose.page.xps/xpsdocument/addpage#addpage_1)(bool) | Belgeye varsayılan sayfa boyutuyla boş bir sayfa ekler. |
...
| [CreateIccProfile](../../aspose.page.xps/xpsdocument/createiccprofile#createiccprofile)(Stream) | Yeni bir ICC profili kaynağı oluşturur.*stream* . |
...
| [CreateImage](../../aspose.page.xps/xpsdocument/createimage#createimage)(Stream) | Şunlardan yeni bir görüntü kaynağı oluşturur:*stream* . |
...
| [CreatePathGeometry](../../aspose.page.xps/xpsdocument/createpathgeometry#createpathgeometry_1)(List&lt;XpsPathFigure&gt;) | Belirtilen yol şekilleri listesiyle yeni bir yol geometrisi oluşturur. |
...
| [CreatePolyLineSegment](../../aspose.page.xps/xpsdocument/createpolylinesegment)(PointF[], bool) | İsteğe bağlı sayıda bağımsız köşe içeren yeni bir çokgen çizim oluşturur. |
| [CreatePolyQuadraticBezierSegment](../../aspose.page.xps/xpsdocument/createpolyquadraticbeziersegment)(PointF[], bool) | Belirtilen kontrol noktalarını kullanarak bir set köşe boyunca yol şeklindeki önceki noktadan yeni bir ikinci dereceden Bézier eğrileri seti oluşturur. |
...
| [Dispose](../../aspose.page.xps/xpsdocument/dispose)() | Örneği atar. |
| [GetDocumentPrintTicket](../../aspose.page.xps/xpsdocument/getdocumentprintticket)(int) | tarafından dizine eklenen belgenin yazdırma biletini döndürür.*documentIndex* . |
| [GetPagePrintTicket](../../aspose.page.xps/xpsdocument/getpageprintticket)(int, int) | tarafından indekslenen sayfanın yazdırma biletini döndürür.*pageIndex* tarafından dizine eklenen belgede*documentIndex* . |
| [Insert&lt;T&gt;](../../aspose.page.xps/xpsdocument/insert)(int, T) | adresindeki etkin page sayfasına bir öğe (Tuval, Yol veya Glifler) ekler.*index* pozisyon. |
| [InsertCanvas](../../aspose.page.xps/xpsdocument/insertcanvas)(int) | adresindeki etkin sayfaya yeni bir tuval ekler.*index* pozisyon. |
| [InsertDocument](../../aspose.page.xps/xpsdocument/insertdocument#insertdocument)(int, bool) | Varsayılan sayfa boyutu olan boş bir belge ekler*index* pozisyon. |
...
| [InsertGlyphs](../../aspose.page.xps/xpsdocument/insertglyphs#insertglyphs)(int, XpsFont, float, float, float, string) | adresindeki etkin sayfaya yeni glifler ekler.*index* pozisyon. |
| [InsertGlyphs](../../aspose.page.xps/xpsdocument/insertglyphs#insertglyphs_1)(int, string, float, FontStyle, float, float, string) | adresindeki etkin sayfaya yeni glifler ekler.*index* pozisyon. |
| [InsertPage](../../aspose.page.xps/xpsdocument/insertpage#insertpage_1)(int, bool) | Varsayılan sayfa boyutu olan belgeye boş bir sayfa ekler*index* pozisyon. |
...
| [Merge](../../aspose.page.xps/xpsdocument/merge#merge)(string[], Device, SaveOptions) | Aşağıdakileri kullanarak XPS belgelerini PDF'ye birleştirme[`Device`](../../aspose.page/device) örnek. |
| [Remove&lt;T&gt;](../../aspose.page.xps/xpsdocument/remove)(T) | Etkin sayfadan bir öğeyi kaldırır. |
| [RemoveAt](../../aspose.page.xps/xpsdocument/removeat)(int) | konumunda bir öğeyi kaldırır*index* aktif sayfadan konum. |
...
| [RemovePageAt](../../aspose.page.xps/xpsdocument/removepageat)(int) | adresindeki belgeden bir sayfayı kaldırır.*index* pozisyon. |
| [Save](../../aspose.page.xps/xpsdocument/save#save_1)(Stream) | XPS belgesini akışa kaydeder. |
| [Save](../../aspose.page.xps/xpsdocument/save#save_2)(string) | XPS belgesini şurada bulunan XPS dosyasına kaydeder.*path* . |
| override [Save](../../aspose.page.xps/xpsdocument/save#save)(Device, SaveOptions) | Belgeyi kullanarak kaydeder.[`Device`](../../aspose.page/device) örnek. |
| [SelectActiveDocument](../../aspose.page.xps/xpsdocument/selectactivedocument)(int) | Düzenlemek için etkin bir belge seçer. |
| [SelectActivePage](../../aspose.page.xps/xpsdocument/selectactivepage)(int) | Düzenlemek için etkin bir belge sayfası seçer. |
...
| [SetPagePrintTicket](../../aspose.page.xps/xpsdocument/setpageprintticket)(int, int, PagePrintTicket) | Bağlantılar*printTicket* tarafından indekslenen sayfaya*pageIndex* tarafından dizine eklenen belgede*documentIndex* . |
