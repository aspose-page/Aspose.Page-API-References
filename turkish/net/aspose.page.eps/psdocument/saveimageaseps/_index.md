...
description: PNG/JPEG/TIFF/BMP/GIF/EMF görüntüsünü giriş akışından EPS çıkış akışına kaydeder.
type: docs
weight: 60
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| imageStream | Stream | Görüntü girişi akışı. |
| epsStream | Stream | EPS çıktı akışı. |
