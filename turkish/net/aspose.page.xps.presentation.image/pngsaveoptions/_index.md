...
description: Aspose.Page.XPS.Presentation.Image.PngSaveOptions sınıf. PNG olarak XPS kaydetme seçenekleri için sınıf.
type: docs
weight: 380
url: /tr/net/aspose.page.xps.presentation.image/pngsaveoptions/
---
## PngSaveOptions class

PNG olarak XPS kaydetme seçenekleri için sınıf.
...
| İsim | Tanım |
| --- | --- |
| [PngSaveOptions](pngsaveoptions/)() | Yeni seçenekler örneği oluşturur. |
...
| [SmoothingMode](../../aspose.page.xps.presentation.image/imagesaveoptions/smoothingmode/) { get; set; } | Yumuşatma modunu alır/ayarlar. |
...
| [TextRenderingHint](../../aspose.page.xps.presentation.image/imagesaveoptions/textrenderinghint/) { get; set; } | Metin işleme ipucunu alır/ayarlar. |
