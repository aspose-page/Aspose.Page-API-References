...
| İsim | Tanım |
| --- | --- |
| [DocumentCoverBack](documentcoverback/)(params CoverBackOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [CoverBackOption](documentcoverback.coverbackoption/) | `DocumentCoverBack` özellik seçenekleri. |
