...
ile birlikte[`PageDeviceColorSpaceProfileURI`](../pagedevicecolorspaceprofileuri/) parametresi, bu parametre, bir aygıt renk uzayında sunulan öğeler için işleme davranışını tanımlar. https://docs.Microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
...
| İsim | Tanım |
| --- | --- |
| class [PageDeviceColorSpaceUsageOption](pagedevicecolorspaceusage.pagedevicecolorspaceusageoption/) | `PageDeviceColorSpaceUsage` özellik seçenekleri. |
