...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation sınıf. Fiziksel ortam sayfasının yönünü açıklar. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
url: /tr/net/aspose.page.xps.xpsmetadata/pageorientation/
---
## PageOrientation class

Fiziksel ortam sayfasının yönünü açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| İsim | Tanım |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | `PageOrientation` özellik seçenekleri. |
