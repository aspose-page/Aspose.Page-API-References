...
ICC v2 Belirtimi tarafından tanımlandığı şekliyle işleme amacını tanımlar. Bir görüntü veya grafik öğesi, İşleme amacını belirten katıştırılmış bir profile sahipse, bu değer göz ardı edilmelidir. https://docs.microsoft.com/en-us/ windows/win32/printdocs/pageicmrenderingintent
...
| İsim | Tanım |
| --- | --- |
| [PageICMRenderingIntent](pageicmrenderingintent/)(params PageICMRenderingIntentOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [PageICMRenderingIntentOption](pageicmrenderingintent.pageicmrenderingintentoption/) | `PageICMRenderingIntent` özellik seçenekleri. |
