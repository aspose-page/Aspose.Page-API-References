...
[`DocumentSeparatorSheet`](../documentseparatorsheet/) özellik seçenekleri.
...
| İsim | Tanım |
| --- | --- |
| static [BothSheets](../../aspose.page.xps.xpsmetadata/documentseparatorsheetoption/bothsheets/) | Belgenin başında ve sonunda bir ayırıcı sayfa belirtir. |
| static [EndSheet](../../aspose.page.xps.xpsmetadata/documentseparatorsheetoption/endsheet/) | Belgenin sonunda bir ayırıcı sayfa belirtir. |
| static [None](../../aspose.page.xps.xpsmetadata/documentseparatorsheetoption/none/) | Ayırıcı sayfa(lar) belirtmez. |
| static [StartSheet](../../aspose.page.xps.xpsmetadata/documentseparatorsheetoption/startsheet/) | Belgenin başında bir ayırıcı sayfa belirtir. |
