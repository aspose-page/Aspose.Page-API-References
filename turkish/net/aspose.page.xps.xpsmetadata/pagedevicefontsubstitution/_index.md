...
Aygıt yazı tipi değiştirmenin etkin/devre dışı durumunu açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicefontsubstitution
...
| İsim | Tanım |
| --- | --- |
| [PageDeviceFontSubstitution](pagedevicefontsubstitution/)(params PageDeviceFontSubstitutionOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [PageDeviceFontSubstitutionOption](pagedevicefontsubstitution.pagedevicefontsubstitutionoption/) | `PageDeviceFontSubstitution` özellik seçenekleri. |
