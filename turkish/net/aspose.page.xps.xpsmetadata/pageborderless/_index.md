...
Görüntü içeriğinin ortamın fiziksel kenarlarına ne zaman yazdırılması gerektiğini açıklar. https://docs.Microsoft.com/en-us/windows/win32/printdocs/pageborderless
...
| İsim | Tanım |
| --- | --- |
| [PageBorderless](pageborderless/)(params PageBorderlessOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption/) | `PageBorderless` özellik seçenekleri. |
