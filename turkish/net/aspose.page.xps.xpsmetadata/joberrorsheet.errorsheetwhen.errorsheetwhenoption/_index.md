...
| İsim | Tanım |
| --- | --- |
| static [Always](../../aspose.page.xps.xpsmetadata/errorsheetwhenoption/always/) | Her iş için bir hata sayfası çıkarılacağını belirtir. |
| static [OnError](../../aspose.page.xps.xpsmetadata/errorsheetwhenoption/onerror/) | Yalnızca hata durumunda bir hata sayfasının çıkarılacağını belirtir. |
