...
Ortam Rengi seçeneklerini ve her seçeneğin özelliklerini açıklar. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
...
| İsim | Tanım |
| --- | --- |
| [PageMediaColor](pagemediacolor/)(params PageMediaColorOption[]) | Yeni bir örnek oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| class [PageMediaColorOption](pagemediacolor.pagemediacoloroption/) | `PageMediaColor` özellik seçenekleri. |
