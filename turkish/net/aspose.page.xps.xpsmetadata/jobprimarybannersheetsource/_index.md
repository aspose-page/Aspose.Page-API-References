...
İş için birincil özel başlık sayfasının kaynağını belirtir. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
...
| İsim | Tanım |
| --- | --- |
| [JobPrimaryBannerSheetSource](jobprimarybannersheetsource/)(string) | Yeni bir örnek oluşturur. |
