...
Çıktının zımbalama özelliklerini açıklar. İşteki tüm belgeler birlikte zımbalanır. `JobStapleAllDocuments` Ve[`DocumentStaple`](../documentstaple/) anahtar kelimeler karşılıklı olarak birbirini dışlar. Bu anahtar kelimeler arasındaki kısıtlama işlemeyi belirlemek sürücüye bağlıdır. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealdocuments
