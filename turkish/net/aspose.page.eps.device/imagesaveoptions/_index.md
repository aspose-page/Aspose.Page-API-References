...
description: Bu sınıf görüntü kaydetme sürecini yönetmek için gerekli seçenekleri içerir.
type: docs
weight: 50
...
| İsim | Tanım |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | Yeni bir örneğini başlatır[`ImageSaveOptions`](../imagesaveoptions) bayraklar için varsayılan değerler olan sınıf!:SuppressErrors (doğru) ve!:Debug (yanlış). |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(bool) | Yeni bir örneğini başlatır[`ImageSaveOptions`](../imagesaveoptions) bayrak için with varsayılan değeri!:Debug (yanlış). |
