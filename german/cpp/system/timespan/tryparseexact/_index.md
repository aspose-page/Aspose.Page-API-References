---
title: "System::TimeSpan::TryParseExact Methode"
linktitle: "TryParseExact"
second_title: "Aspose.Page für C++"
description: "Wie man die TryParseExact-Methode der System::TimeSpan-Klasse in C++ verwendet."
type: docs
weight: 4500
url: /de/cpp/system/timespan/tryparseexact/
---
...
Konvertiert eine Zeichenkette in ein entsprechendes [TimeSpan](../)-Objekt unter Verwendung der angegebenen Formate, des Formatproviders und der Stile und gibt das Ergebnis der Konvertierung zurück.
...
| Anbieter | const SharedPtr\<IFormatProvider\>\& | Formatprovider, der kulturspezifische Formatierungsinformationen bereitstellt. |
| styles | Globalization::TimeSpanStyles | Definiert Elemente, die im Eingabestring vorhanden sein können. |
| result | TimeSpan\& | Zeitintervall, das dem String entspricht. |
...
Konvertiert eine Zeichenkette in ein entsprechendes [TimeSpan](../)-Objekt unter Verwendung der angegebenen Formate und des Formatproviders und gibt das Ergebnis der Konvertierung zurück.
...
Konvertiert eine Zeichenkette in ein entsprechendes [TimeSpan](../)-Objekt unter Verwendung des angegebenen Formats, des Formatproviders und der Stile und gibt das Ergebnis der Konvertierung zurück.
...
| --- | --- | --- |
| Eingabe | const String\& | Eingabezeichenkette. |
| Format | const String\& | Standard- oder benutzerdefinierte Formatzeichenfolge. |
| Anbieter | const SharedPtr\<IFormatProvider\>\& | Formatprovider, der kulturspezifische Formatierungsinformationen bereitstellt. |
| styles | Globalization::TimeSpanStyles | Definiert Elemente, die im Eingabestring vorhanden sein können. |
| result | TimeSpan\& | Zeitintervall, das dem String entspricht. |
...
Konvertiert eine Zeichenkette in ein entsprechendes [TimeSpan](../)-Objekt unter Verwendung des angegebenen Formats und des Formatproviders und gibt das Ergebnis der Konvertierung zurück.
