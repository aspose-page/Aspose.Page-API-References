...
description: "System::Guid::Guid Konstruktor. Erstellt ein Objekt, das eine GUID darstellt, die aus ausschließlich Nullen besteht, in C++."
type: docs
weight: 100
...
Konstruiert ein Objekt, das eine GUID darstellt, die ausschließlich aus Nullen besteht.
...
| --- | --- | --- |
| b | const ArrayPtr\<uint8_t\>\& | Ein Byte-Array, das die einzelnen Bytes der GUID enthält |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| guid | const Guid\& | Das [Guid](../)-Objekt, von dem der GUID-Wert kopiert werden soll |
