...
description: "System::setter_post_increment_wrap Methode. Der Übersetzer übersetzt C#''s Post-Inkrement‑Ausdrücke, die auf die Eigenschaft einer Instanz abzielen, für die Setter und Getter definiert sind, in den Aufruf dieser Funktion (Überladung für const‑Getter) in C++."
type: docs
weight: 37900
...
Der Übersetzer übersetzt C#'s Post-Inkrement‑Ausdrücke, die auf die Eigenschaft einer Instanz abzielen, für die Setter und Getter definiert sind, in den Aufruf dieser Funktion (Überladung für const‑Getter).
...
Der Übersetzer wandelt C#-Postinkrement-Ausdrücke, die auf die Eigenschaft einer Instanz abzielen und für Setter und Getter definiert sind, in einen Aufruf dieser Funktion um (Überladung für nicht-konstanten Getter).
...
Der Übersetzer wandelt C#-Postinkrement-Ausdrücke, die auf die Eigenschaft einer Klasse abzielen und für Setter und Getter definiert sind, in einen Aufruf dieser Funktion um.
