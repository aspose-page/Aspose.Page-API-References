---
title: "System::Threading::Thread::Thread Konstruktor"
linktitle: "Thread"
second_title: "Aspose.Page für C++"
description: "System::Threading::Thread::Thread Konstruktor. Konstruktor in C++."
type: docs
weight: 100
url: /de/cpp/system.threading/thread/thread/
---
...
| --- | --- | --- |
| thread_function | ParameterizedThreadStart | Funktion, die vom Thread ausgeführt werden soll. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| t | Thread\& | von dem [Thread](../) Daten kopiert werden sollen. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| thread_function | ThreadStart | Funktion, die vom Thread ausgeführt werden soll. |
