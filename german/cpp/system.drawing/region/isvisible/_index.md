---
title: "System::Drawing::Region::IsVisible-Methode"
linktitle: "IsVisible"
second_title: "Aspose.Page für C++"
description: "System::Drawing::Region::IsVisible-Methode. Bestimmt, ob der angegebene Punkt innerhalb des von dem aktuellen Objekt dargestellten Bereichs in C++ enthalten ist."
type: docs
weight: 1400
url: /de/cpp/system.drawing/region/isvisible/
---
## Region::IsVisible(const Point\&) const method


Bestimmt, ob der angegebene Punkt innerhalb der durch das aktuelle Objekt dargestellten Region liegt.
...
| --- | --- | --- |
| Punkt | const Point\& | Der zu prüfende Punkt |
...
Bestimmt, ob der angegebene Punkt unter Verwendung der angegebenen Grafik innerhalb der durch das aktuelle Objekt dargestellten Region liegt.
...
| --- | --- | --- |
| Punkt | const Point\& | Der zu prüfende Punkt |
| Grafik | const SharedPtr\<Graphics\>\& | Der Grafik-Kontext |
...
Bestimmt, ob ein Teil des angegebenen Rechtecks innerhalb der durch das aktuelle Objekt dargestellten Region liegt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| rect | const Rectangle\& | Das zu prüfende Rechteck |
...
Bestimmt, ob ein Teil des angegebenen Rechtecks unter Verwendung der angegebenen Grafik innerhalb der durch das aktuelle Objekt dargestellten Region liegt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| rect | const RectangleF\& | Das zu prüfende Rechteck |
