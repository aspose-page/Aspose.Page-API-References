---
title: "System::Drawing::Graphics::FillRectangle-Methode"
linktitle: "FillRectangle"
second_title: "Aspose.Page für C++"
description: "System::Drawing::Graphics::FillRectangle-Methode. Füllt das angegebene Rechteck mit dem angegebenen Brush in C++."
type: docs
weight: 3700
url: /de/cpp/system.drawing/graphics/fillrectangle/
---
## Graphics::FillRectangle(const SharedPtr\<Brush\>\&, float, float, float, float) method


Füllt das angegebene Rechteck mit dem angegebenen Pinsel.
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Ein [Brush](../../brush/) Objekt zum Füllen |
...
| width | float | Die Breite des auszufüllenden Rechtecks |
| height | float | Die Höhe des auszufüllenden Rechtecks |
...
| width | int | Die Breite des auszufüllenden Rechtecks |
| height | int | Die Höhe des auszufüllenden Rechtecks |
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Ein [Brush](../../brush/) Objekt zum Füllen |
| rect | Rectangle | Ein [Rectangle](../../rectangle/) Objekt, das den Ort und die Größe des auszufüllenden Rechtecks angibt |
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Ein [Brush](../../brush/) Objekt zum Füllen |
| rect | RectangleF | Ein [RectangleF](../../rectanglef/) Objekt, das den Ort und die Größe des auszufüllenden Rechtecks angibt |
