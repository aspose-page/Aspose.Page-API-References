---
title: "System::Drawing::Graphics::DrawArc-Methode"
linktitle: "DrawArc"
second_title: "Aspose.Page für C++"
description: "System::Drawing::Graphics::DrawArc-Methode. Zeichnet den angegebenen Bogen mit dem angegebenen Stift auf der von dem aktuellen Objekt dargestellten Oberfläche in C++."
type: docs
weight: 1000
url: /de/cpp/system.drawing/graphics/drawarc/
---
## Graphics::DrawArc(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Zeichnet den angegebenen Bogen mit dem angegebenen Stift auf der von dem aktuellen Objekt dargestellten Fläche.
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen des Bogens verwendet wird |
...
| startAngle | int32_t | Winkel in Grad, gemessen im Uhrzeigersinn von der X-Achse zum Startpunkt des Bogens |
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen des Bogens verwendet wird |
| rect | Rechteck | Das Rechteck, das die Ellipse definiert |
| startAngle | float | Winkel in Grad, gemessen im Uhrzeigersinn von der X-Achse zum Startpunkt des Bogens |
| sweepAngle | float | Winkel in Grad, gemessen im Uhrzeigersinn vom **startAngle** zum Endpunkt des Bogens |
...
| --- | --- | --- |
| Stift | const SharedPtr\<Pen\>\& | Ein Stift, der beim Zeichnen des Bogens verwendet wird |
| rect | RectangleF | Das Rechteck, das die Ellipse definiert |
| startAngle | float | Winkel in Grad, gemessen im Uhrzeigersinn von der X-Achse zum Startpunkt des Bogens |
| sweepAngle | float | Winkel in Grad, gemessen im Uhrzeigersinn vom **startAngle** zum Endpunkt des Bogens |
