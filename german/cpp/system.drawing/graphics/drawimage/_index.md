---
title: "System::Drawing::Graphics::DrawImage-Methode"
linktitle: "DrawImage"
second_title: "Aspose.Page für C++"
description: "System::Drawing::Graphics::DrawImage-Methode. NICHT IMPLEMENTIERT in C++."
type: docs
weight: 1800
url: /de/cpp/system.drawing/graphics/drawimage/
---
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const ArrayPtr\\<Point\\>\\& | Ein Array, das drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, auf das das Bild gezeichnet werden soll |
| srcRect | Rechteck | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imageAttr | const SharedPtr\<Imaging::ImageAttributes\>\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| rect | const Rectangle\& | Ein Rechteck, in das das Bild gezeichnet wird |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| rect | const RectangleF\& | Ein Rechteck, in das das Bild gezeichnet wird |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | IGNORED |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const System::ArrayPtr\<PointF\>\& | Ein Array, das drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, auf das das Bild gezeichnet werden soll |
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Eine Array-Ansicht, die drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, in das das Bild gezeichnet wird |
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destPoints | const System::Details::StackArray\<PointF, N\>\& | Ein Stack-Array, das drei Punkte enthält, die ein Parallelogramm auf der Zeichenfläche definieren, in das das Bild gezeichnet wird |
| srcRect | const RectangleF\& | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Gibt Farb- und Gamma-Informationen für das Bild an |
...
| width | float | Die Breite der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| height | float | Die Höhe der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
...
| x | float | Die X-Koordinate der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| y | float | Die Y-Koordinate der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| srcRect | RectangleF | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
...
| width | int | Die Breite der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
| height | int | Die Höhe der oberen linken Ecke des Rechtecks, in das das Bild gezeichnet wird |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| pt | Point | Der Ort der oberen linken Ecke des gezeichneten Bildes |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| pt | PointF | Der Ort der oberen linken Ecke des gezeichneten Bildes |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destRect | Rechteck | Ein Rechteck, in das das Bild gezeichnet wird |
| srcX | float | Die X-Koordinate der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcY | float | Die Y-Koordinate der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcWidth | float | Die Breite der oberen linken Ecke des Rechtecks, das den zu zeichnenden Bildausschnitt angibt |
| srcHeight | float | Die Höhe der oberen linken Ecke des Rechtecks, das den zu zeichnenden Bildausschnitt angibt |
| srcUnit | GraphicsUnit | Die Maßeinheiten, in denen die Parameter **srcX**, **srcY**, **srcWidth** und **srcHeight** angegeben sind |
...
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destRect | Rechteck | Ein Rechteck, in das das Bild gezeichnet wird |
| srcX | int | Die X-Koordinate der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcY | int | Die Y-Koordinate der oberen linken Ecke des Rechtecks, das den Teil des Bildes angibt, der gezeichnet werden soll |
| srcWidth | int | Die Breite der oberen linken Ecke des Rechtecks, das den zu zeichnenden Bildausschnitt angibt |
| srcHeight | int | Die Höhe der oberen linken Ecke des Rechtecks, das den zu zeichnenden Bildausschnitt angibt |
| srcUnit | GraphicsUnit | Die Maßeinheiten, in denen die Parameter **srcX**, **srcY**, **srcWidth** und **srcHeight** angegeben sind |
...
| --- | --- | --- |
| Bild | const SharedPtr\<Image\>\& | Das zu zeichnende Bild |
| destRect | RectangleF | Ein Rechteck, in das das Bild gezeichnet wird |
| srcRect | RectangleF | Ein Rechteck, das den Bereich des angegebenen Bildes zum Zeichnen definiert |
| srcUnit | GraphicsUnit | Die Maßeinheiten, die vom Parameter **srcRect** verwendet werden |
