...
description: "System::Globalization::GregorianCalendar Klasse. Gregorianischer Kalender. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen in C++ zu übergeben."
type: docs
weight: 1000
url: /de/cpp/system.globalization/gregoriancalendar/
---
...
| virtual [get_CalendarType](./get_calendartype/)() const | Liefert den Typ des Gregorianischen Kalenders. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | Liefert die Standardinstanz des Gregorianischen Kalenders. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | Konstruiert einen spezifischen Gregorianischen Kalender. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | Setzt den Typ des Gregorianischen Kalenders. |
