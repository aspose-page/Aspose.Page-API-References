...
description: "System::Text::Encoding::GetEncoding-Methode. Ruft die Codierung anhand des Namens in C++ ab."
type: docs
weight: 4100
...
Liefert die Kodierung nach Namen.
...
| --- | --- | --- |
| name | const String\& | [Encoding](../) Name. |
| encoder_fallback | const EncoderFallbackPtr\& | Fallback, der für die Codierung verwendet wird. |
...
Liefert die Kodierung nach Codepage.
