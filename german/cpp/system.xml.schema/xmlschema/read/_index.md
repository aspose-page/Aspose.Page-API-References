---
title: "System::Xml::Schema::XmlSchema::Read Methode"
linktitle: "Lesen"
second_title: "Aspose.Page für C++"
description: "System::Xml::Schema::XmlSchema::Read Methode. Liest ein XML Schema aus dem bereitgestellten Stream in C++."
type: docs
weight: 2900
url: /de/cpp/system.xml.schema/xmlschema/read/
---
...
| validationEventHandler | ValidationEventHandler | Der Validierungsereignis-Handler, der Informationen über Syntaxfehler des XML [Schema](../../) erhält. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| reader | const SharedPtr\<IO::TextReader\>\& | Der [IO::TextReader](../../../system.io/textreader/), der das zu lesende XML [Schema](../../) enthält. |
| validationEventHandler | ValidationEventHandler | Der Validierungsereignis-Handler, der Informationen über Syntaxfehler des XML [Schema](../../) erhält. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | Der [XmlReader](../../../system.xml/xmlreader/), der das zu lesende XML [Schema](../../) enthält. |
| validationEventHandler | ValidationEventHandler | Der Validierungsereignis-Handler, der Informationen über Syntaxfehler des XML [Schema](../../) erhält. |
