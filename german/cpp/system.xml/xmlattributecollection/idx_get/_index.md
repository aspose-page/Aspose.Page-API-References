---
title: "System::Xml::XmlAttributeCollection::idx_get Methode"
linktitle: "idx_get"
second_title: "Aspose.Page für C++"
description: "System::Xml::XmlAttributeCollection::idx_get Methode. Gibt das Attribut mit dem angegebenen lokalen Namen und dem Namespace Uniform Resource Identifier (URI) in C++ zurück."
type: docs
weight: 300
url: /de/cpp/system.xml/xmlattributecollection/idx_get/
---
...
| namespaceURI | const String\& | Der Namespace-URI des Attributs. |

### ReturnValue

Das Attribut mit dem angegebenen lokalen Namen und dem Namespace-URI. Wenn das Attribut nicht existiert, gibt diese Methode **nullptr** zurück.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| name | const String\& | Der qualifizierte Name des Attributs. |
