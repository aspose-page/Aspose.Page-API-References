---
title: "System::Xml::XmlWriter::WriteAttributeString Methode"
linktitle: "WriteAttributeString"
second_title: "Aspose.Page für C++"
description: "System::Xml::XmlWriter::WriteAttributeString Methode. Wenn sie in einer abgeleiteten Klasse überschrieben wird, schreibt sie ein Attribut mit dem angegebenen lokalen Namen, dem Namespace-URI und dem Wert in C++."
type: docs
weight: 1000
url: /de/cpp/system.xml/xmlwriter/writeattributestring/
---
## XmlWriter::WriteAttributeString(const String\&, const String\&, const String\&) method


Wird in einer abgeleiteten Klasse überschrieben, schreibt ein Attribut mit dem angegebenen lokalen Namen, der Namespace‑URI und dem Wert.
...
Wird in einer abgeleiteten Klasse überschrieben, schreibt das Attribut mit dem angegebenen lokalen Namen und Wert aus.
...
Wird in einer abgeleiteten Klasse überschrieben, schreibt das Attribut mit dem angegebenen Präfix, lokalen Namen, Namespace‑URI und Wert aus.
