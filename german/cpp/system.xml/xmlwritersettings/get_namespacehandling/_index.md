...
Gibt einen Wert zurück, der angibt, ob der [XmlWriter](../../xmlwriter/) doppelte Namespace-Deklarationen beim Schreiben von XML-Inhalten entfernen soll. Das Standardverhalten ist, dass der Writer alle Namespace-Deklarationen ausgibt, die im Namespace-Resolver des Writers vorhanden sind.
...
Die [NamespaceHandling](../../namespacehandling/)-Aufzählung wird verwendet, um anzugeben, ob doppelte Namespace-Deklarationen im [XmlWriter](../../xmlwriter/) entfernt werden sollen.
