---
title: "Aspose::Page::EPS::PsDocument::FillText Methode"
linktitle: "FillText"
second_title: "Aspose.Page für C++"
description: "Aspose::Page::EPS::PsDocument::FillText Methode. Fügt eine Textzeichenfolge hinzu, indem das Innere der Glyphen in C++ gefüllt wird."
type: docs
weight: 3100
url: /de/cpp/aspose.page.eps/psdocument/filltext/
---
## PsDocument::FillText(System::String, System::ArrayPtr\<float\>, System::SharedPtr\<Aspose::Page::Font::DrFont\>, float, float) method


Fügt eine Textzeichenfolge hinzu, indem der Innenbereich von Glyphen gefüllt wird.
...
| x | float | X-Koordinate für den Textursprung. |
| y | float | Y-Koordinate für den Textursprung. |
| fill | System::SharedPtr\<System::Drawing::Brush\> | Die Füllung, die zum Malen von Glyphen verwendet wird. |
## Hinweise
...
| text | System::String | Der Text, der hinzugefügt werden soll. |
| Vorschübe | System::ArrayPtr\<float\> | Ein Array von Glyphenbreiten. Seine Länge muss mit der Anzahl der Glyphen im String übereinstimmen. |
| font | System::SharedPtr\<System::Drawing::Font\> | Die Schriftart, die zum Zeichnen von Text verwendet wird. |
| x | float | X-Koordinate für den Textursprung. |
| y | float | Y-Koordinate für den Textursprung. |
