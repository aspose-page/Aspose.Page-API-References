...
description: "System::Collections::Generic::Stack::Enumerator Klasse. Enumerator zum Durchlaufen des Stacks. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr‑Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen in C++ zu übergeben."
type: docs
weight: 2000
...
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Konstruiert einen Enumerator, der durch den angegebenen Stack iteriert. |
## Siehe auch
