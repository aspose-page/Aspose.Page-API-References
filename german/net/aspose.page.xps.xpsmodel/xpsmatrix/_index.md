...
description: Klasse die die Eigenschaften von MatrixTransformEigenschaftselementen einkapselt. Dieses Element definiert eine beliebige affine Matrixtransformation die verwendet wird um die Koordinatensysteme von Elementen zu manipulieren.
type: docs
weight: 3150
...
| override [ToString](../../aspose.page.xps.xpsmodel/xpsmatrix/tostring)() | Gibt die Zeichenfolgendarstellung davon zurück[`XpsMatrix`](../xpsmatrix) Instanz. |
