...
description: Aspose.Page.SaveOptions klas. Diese Klasse enthält Optionen die für die Verwaltung des Konvertierungsprozesses erforderlich sind.
type: docs
weight: 300
...
| Name | Beschreibung |
| --- | --- |
| [SaveOptions](saveoptions/#constructor)() | Initialisiert eine neue Instanz von`SaveOptions` Klasse mit Standardwerten für Flags!:SuppressErrors (wahr) und[`Debug`](./debug/) (falsch). |
| [SaveOptions](saveoptions/#constructor_1)(bool) | Initialisiert eine neue Instanz von`SaveOptions` Klasse mit Standardwert für Flag[`Debug`](./debug/) (falsch). |
