...
description: Aspose.Page.Device klas. Diese Klasse kapselt das Rendern des Dokuments auf einem abstrakten Gerät. Das Rendern des Dokuments erfolgt Seite für Seite.
type: docs
weight: 20
...
| Name | Beschreibung |
| --- | --- |
| [Device](device/)(Size) | Initialisiert`Device` mit einer Seitengröße. |
