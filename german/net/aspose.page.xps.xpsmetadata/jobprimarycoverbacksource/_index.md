...
Gibt die Quelle für ein benutzerdefiniertes Primärblatt für die Rückseite des Auftrags an. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
...
| Name | Beschreibung |
| --- | --- |
| [JobPrimaryCoverBackSource](jobprimarycoverbacksource/)(string) | Erstellt eine neue Instanz. |
