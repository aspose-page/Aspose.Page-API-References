...
Beschreibt die Hefteigenschaften der Ausgabe. Jedes Dokument wird separat geheftet. Die[`JobStapleAllDocuments`](../jobstaplealldocuments/) Und`DocumentStaple`Schlüsselwörter schließen sich gegenseitig aus. Es ist Sache des Treibers, die Behandlung von Einschränkungen zwischen diesen Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
