...
Beschreibt die Hefteigenschaften der Ausgabe. Alle Dokumente im Auftrag werden zusammengeheftet. Die`JobStapleAllDocuments` Und[`DocumentStaple`](../documentstaple/) Schlüsselwörter schließen sich gegenseitig aus. Es ist Aufgabe des Treibers, die Behandlung von Einschränkungen zwischen diesen Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
...
| Name | Beschreibung |
| --- | --- |
| [JobStapleAllDocuments](jobstaplealldocuments/)(params StapleOption[]) | Erstellt eine neue Instanz. |
