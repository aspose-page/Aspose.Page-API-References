...
description: Beschreibt die Hefteigenschaften der Ausgabe. Alle Dokumente im Auftrag werden zusammengeheftet. DieJobStapleAllDocuments./jobstaplealldocuments undDocumentStaple./documentstaple Schlüsselwörter schließen sich gegenseitig aus. Es ist Aufgabe des Treibers die Behandlung von Einschränkungen zwischen diesen Schlüsselwörtern zu bestimmen. https//docs.microsoft.com/enus/windows/win32/printdocs/jobstaplealldocuments
type: docs
weight: 1520
...
Beschreibt die Hefteigenschaften der Ausgabe. Alle Dokumente im Auftrag werden zusammengeheftet. Die[`JobStapleAllDocuments`](../jobstaplealldocuments) und[`DocumentStaple`](../documentstaple) Schlüsselwörter schließen sich gegenseitig aus. Es ist Aufgabe des Treibers, die Behandlung von Einschränkungen zwischen diesen Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
