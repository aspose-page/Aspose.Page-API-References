...
Beschreibt die Verwendung von Trennblättern für ein Dokument. Trennblätter sollten in der Ausgabe erscheinen, wie durch die unten angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
...
| Name | Beschreibung |
| --- | --- |
| [DocumentSeparatorSheet](documentseparatorsheet/)(params DocumentSeparatorSheetOption[]) | Erstellt eine neue Instanz. |
...
| Name | Beschreibung |
| --- | --- |
| class [DocumentSeparatorSheetOption](documentseparatorsheet.documentseparatorsheetoption/) | Beschreibt die`DocumentSeparatorSheet` Funktionsoptionen. |
