...
description: Diese Klasse enthält Optionen die zum Verwalten des Bildspeicherprozesses erforderlich sind.
type: docs
weight: 50
...
| Name | Beschreibung |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | Initialisiert eine neue Instanz von[`ImageSaveOptions`](../imagesaveoptions) Klasse mit Standardwerten für Flags!:SuppressErrors (wahr) und!:Debug (falsch). |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(bool) | Initialisiert eine neue Instanz von[`ImageSaveOptions`](../imagesaveoptions) with Standardwert für Flag!:Debug (falsch). |
