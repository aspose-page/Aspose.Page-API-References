...
description: Diese Klasse kapselt das Rendern von Dokumenten in PDF.
type: docs
weight: 60
...
| Name | Beschreibung |
| --- | --- |
| [PdfDevice](pdfdevice#constructor)(Stream) | Initialisiert eine neue Instanz von[`PdfDevice`](../pdfdevice) mit Ausgabestrom. |
| [PdfDevice](pdfdevice#constructor_1)(Stream, Size) | Initialisiert eine neue Instanz von[`PdfDevice`](../pdfdevice) mit Ausgabestrom und vorgegebener Größe einer Seite. |
