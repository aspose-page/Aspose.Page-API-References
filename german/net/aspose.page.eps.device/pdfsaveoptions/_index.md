...
description: Diese Klasse enthält Eingabe und Ausgabestreams und andere Optionen die für die Verwaltung des Konvertierungsprozesses erforderlich sind.
type: docs
weight: 70
...
| Name | Beschreibung |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions#constructor)() | Initialisiert eine neue Instanz von[`PdfSaveOptions`](../pdfsaveoptions) Klasse mit Standardwerten für Flags!:SuppressErrors (wahr) und!:Debug (falsch). |
| [PdfSaveOptions](pdfsaveoptions#constructor_1)(bool) | Initialisiert eine neue Instanz von[`PdfSaveOptions`](../pdfsaveoptions) Klasse mit Standardwerten für Flag!:Debug (falsch). |
