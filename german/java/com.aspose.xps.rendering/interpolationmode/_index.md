...
description: "Gibt den Algorithmus an, der verwendet wird, wenn Bilder skaliert oder rotiert werden."
type: docs
weight: 20
url: /de/java/com.aspose.xps.rendering/interpolationmode/
---
**Inheritance:**
...
Gibt den Algorithmus an, der verwendet wird, wenn Bilder skaliert oder rotiert werden.
## Felder
...
| [HighQualityBicubic](#HighQualityBicubic) | Gibt hochqualitative, bikubische Interpolation an. |
| [HighQualityBilinear](#HighQualityBilinear) | Gibt hochqualitative, bilineare Interpolation an. |
| [Low](#Low) | Gibt niedrigqualitative Interpolation an. |
| [NearestNeighbor](#NearestNeighbor) | Gibt die nächstnachbar-Interpolation an. |
## Methoden
...
Gibt niedrigqualitative Interpolation an.
...
Gibt die nächstnachbar-Interpolation an.
