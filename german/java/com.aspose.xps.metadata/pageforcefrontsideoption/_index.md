...
description: "Beschreibt die Optionen der PageForceFrontSide‑Funktion."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Beschreibt die Optionen der Funktion PageForceFrontSide.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Gibt an, dass die Ausgabe auf die Vorderseite des Blattes beschränkt ist. |
| [None](#None) | Gibt an, dass keine Ausgabebeschränkungen bestehen. |
## Methoden
...
Gibt an, dass die Ausgabe auf die Vorderseite des Blattes beschränkt ist.
...
Gibt an, dass keine Ausgabebeschränkungen bestehen.
