...
description: "Beschreibt die Wasserzeichen‑Einstellung der Ausgabe und die Wasserzeichen‑Eigenschaften."
type: docs
weight: 131
url: /de/java/com.aspose.xps.metadata/pagewatermark/
---
**Inheritance:**
...
Beschreibt die Wasserzeichen‑Einstellung der Ausgabe und die Eigenschaften des Wasserzeichens. Wasserzeichen gelten für die logische Seite, nicht für die physische Seite. Zum Beispiel, wenn  DocumentDuplex  aktiviert ist, erscheint ein Wasserzeichen auf jeder  NUp  Seite jedes Blatts. Wenn  DocumentDuplex ,  PagesPerSheet =2, dann hat jedes Blatt 2 Wasserzeichen. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermark
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageWatermark(PageWatermark.IPageWatermarkItem[] items)](#PageWatermark-com.aspose.xps.metadata.PageWatermark.IPageWatermarkItem...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| items | [IPageWatermarkItem\[\]](../../com.aspose.xps.metadata/ipagewatermarkitem) | Ein Array von Elementen, die spezifisch für die Funktion sind. |
