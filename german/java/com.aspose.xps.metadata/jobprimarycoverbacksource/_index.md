...
description: "Gibt die Quelle für ein benutzerdefiniertes primäres Rückcoverblatt für den Auftrag an."
type: docs
weight: 67
url: /de/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Gibt die Quelle für ein benutzerdefiniertes Rückendeckblatt für den Auftrag an. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
