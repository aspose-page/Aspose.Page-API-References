...
description: "Die Komfortklasse für die PrintTicket‑Eigenschaft SelectionType."
type: docs
weight: 147
url: /de/java/com.aspose.xps.metadata/selectiontype/
---
**Inheritance:**
...
Die Komfortklasse für die PrintTicket‑Eigenschaft SelectionType.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [PickMany](#PickMany) | PickMany-Wert. |
| [PickOne](#PickOne) | PickOne-Wert. |
## Methoden
