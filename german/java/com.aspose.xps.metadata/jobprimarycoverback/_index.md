...
description: "Beschreibt das hintere Deckblatt."
type: docs
weight: 66
url: /de/java/com.aspose.xps.metadata/jobprimarycoverback/
---
**Inheritance:**
...
Beschreibt das hintere (abschließende) Deckblatt. Jeder Auftrag hat ein separates primäres Blatt. Das Deckblatt sollte auf der  PageMediaSize  und  PageMediaType  gedruckt werden, die für die letzte Seite des Auftrags verwendet werden. Das Deckblatt sollte in die Verarbeitungsoptionen integriert werden (wie z. B.  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ), wie durch die angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverback
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobPrimaryCoverBack(JobPrimaryCoverBack.CoverBackOption[] options)](#JobPrimaryCoverBack-com.aspose.xps.metadata.JobPrimaryCoverBack.CoverBackOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [CoverBackOption\[\]](../../com.aspose.xps.metadata/coverbackoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
