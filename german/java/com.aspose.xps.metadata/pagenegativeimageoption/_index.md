...
description: "Definiert die Optionen der PageNegativeImage‑Funktion."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
Definiert die  PageNegativeImage  Funktionsoptionen.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Negative](#Negative) | Gibt an, dass die Ausgabe das Negativbild sein soll. |
| [None](#None) | Gibt an, dass die Ausgabe das Nicht‑Negativbild sein soll. |
## Methoden
...
Gibt an, dass die Ausgabe das Nicht‑Negativbild sein soll.
