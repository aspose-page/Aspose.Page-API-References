...
description: "Gibt einen Kommentar an, der dem Auftrag zugeordnet ist."
type: docs
weight: 48
url: /de/java/com.aspose.xps.metadata/jobcomment/
---
**Inheritance:**
...
Gibt einen Kommentar an, der dem Auftrag zugeordnet ist. Beispiel: "Please deliver to room 1234 when completed". https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobComment(String value)](#JobComment-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
