...
type: docs
weight: 71
url: /de/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Beschreibt die Schneidemethode für Rollenpapier. Die Rolle sollte am Ende des Auftrags geschnitten werden. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Erstellt eine neue Instanz. |
## Methoden
