...
description: "Beschreibt die Optionen der Funktionen DocumentCollate und JobCollateAllDocuments."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
Beschreibt die Optionsmöglichkeiten der Funktionen DocumentCollate und JobCollateAllDocuments.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Collated](#Collated) | Gibt an, dass sortiert wird. |
| [Uncollated](#Uncollated) | Gibt an, dass nicht sortiert wird. |
## Methoden
...
Gibt an, dass nicht sortiert wird.
