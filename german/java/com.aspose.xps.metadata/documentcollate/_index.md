...
type: docs
weight: 17
url: /de/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Beschreibt die Sortierungseigenschaften der Ausgabe. Alle Seiten in jedem einzelnen Dokument werden sortiert. DocumentCollate und JobCollateAlldocuments schließen sich gegenseitig aus. Das Verhalten und die Implementierung, ob beide oder nur eines dieser Schlüsselwörter implementiert werden, liegt beim Treiber. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Erstellt eine neue Instanz. |
## Methoden
