...
description: "Beschreibt die Optionen des PageSourceColorProfile-Features."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/pagesourcecolorprofile.pagesourcecolorprofileoption/
---
**Inheritance:**
...
Beschreibt die Feature-Optionen für  PageSourceColorProfile .
## Felder

| Feld | Beschreibung |
| --- | --- |
| [CMYK](#CMYK) | Quellprofil, das zur Farbverwaltung für nicht markierte CMYK-Daten verwendet wird. |
| [None](#None) | Kein Quellprofil. |
| [RGB](#RGB) | Quellprofil, das zur Farbverwaltung für nicht markierte RGB-Daten verwendet wird. |
## Methoden
...
Quellprofil, das zur Farbverwaltung für nicht markierte CMYK-Daten verwendet wird.
...
Quellprofil, das zur Farbverwaltung für nicht markierte RGB-Daten verwendet wird.
