...
type: docs
weight: 68
url: /de/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Beschreibt das vordere (anfangende) Deckblatt. Der gesamte Auftrag hat ein einzelnes primäres Blatt. Das Deckblatt sollte auf der  PageMediaSize  und  PageMediaType  gedruckt werden, die für die erste Seite des Auftrags verwendet werden. Das Deckblatt sollte in die Verarbeitungsoptionen integriert werden (wie z. B.  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ), wie durch die angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Methoden
