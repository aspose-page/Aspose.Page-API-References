...
type: docs
weight: 19
url: /de/java/com.aspose.xps.metadata/documentcoverback/
---
**Inheritance:**
...
Beschreibt das hintere (abschließende) Deckblatt. Jeder Auftrag erhält ein separates Blatt. Das Deckblatt sollte auf dem  PageMediaSize  und  PageMediaType  gedruckt werden, die für die letzte Seite des Dokuments verwendet werden. Das Deckblatt sollte in Verarbeitungsoptionen (wie  DocumentDuplex ,  DocumentNUp ) integriert werden, wie durch die angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentCoverBack(DocumentCoverBack.CoverBackOption[] options)](#DocumentCoverBack-com.aspose.xps.metadata.DocumentCoverBack.CoverBackOption...-) | Erstellt eine neue Instanz. |
## Methoden
