...
description: "Konfiguriert das Farbmanagement für die aktuelle Seite."
type: docs
weight: 89
url: /de/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
Konfiguriert die Farbverwaltung für die aktuelle Seite. Dies wird in SHIM als automatisch betrachtet – DM\_ICMMethod Add System. Beschreibt, welche Komponente die Farbverwaltung durchführen soll (z. B. Treiber). https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
