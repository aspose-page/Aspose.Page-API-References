...
description: "Beschreibt die Ausgabe einer einzelnen Seite auf mehrere physische Medienträger."
type: docs
weight: 118
url: /de/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Beschreibt die Ausgabe einer einzelnen Seite auf mehrere physische Medienträger. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Konstruktoren
...
Fügt eine Option mit einem  PagesPerSheet  bewerteten Eigenschaftswert hinzu. Gibt die Anzahl physischer Blätter pro logischer Seite an.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | Ein  PagesPerSheet  bewerteter Eigenschaftswert. |
