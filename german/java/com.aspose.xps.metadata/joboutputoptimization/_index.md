...
description: "Beschreibt die Auftragsverarbeitung, die darauf abzielt, die Ausgabe für bestimmte Anwendungsszenarien zu optimieren, wie durch die angegebene Option angegeben."
type: docs
weight: 62
url: /de/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
Beschreibt die Auftragsverarbeitung, die darauf abzielt, die Ausgabe für bestimmte Anwendungsszenarien zu optimieren, wie durch die angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
