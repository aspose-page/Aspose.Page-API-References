...
description: "Beschreibt die Optionen der Funktionen JobRollCutAtEndOfJob und DocumentRollCut."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Beschreibt die Optionen der Features  JobRollCutAtEndOfJob  und  DocumentRollCut .
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Banner](#Banner) | Gibt die Schneidemethode für das Banner an (nur DocumentRollCut). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Gibt das Schneiden am Rand des Bildes an. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Gibt das Schneiden für Standard‑Mediengröße an. |
| [None](#None) | Gibt an, dass kein Rollschnitt für den Auftrag erfolgt. |
## Methoden
...
Gibt die Schneidemethode für das Banner an (nur DocumentRollCut).
...
Gibt das Schneiden für Standard‑Mediengröße an.
...
Gibt an, dass kein Rollschnitt für den Auftrag erfolgt.
