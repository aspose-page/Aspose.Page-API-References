...
description: "Beschreibt das installierte Eingabefach in einem Gerät oder die vollständige Liste der unterstützten Fächer für ein Gerät."
type: docs
weight: 100
url: /de/java/com.aspose.xps.metadata/pageinputbin/
---
**Inheritance:**
...
Beschreibt das installierte Eingabefach in einem Gerät oder die vollständige Liste der unterstützten Fächer für ein Gerät. Ermöglicht die Angabe des Eingabefachs pro Seite. Die Schlüsselwörter  JobInputBin ,  DocumentInputBin  und  PageInputBin  schließen sich gegenseitig aus. Beide sollten nicht gleichzeitig in einem PrintTicket‑ oder Print‑Capabilities‑Dokument angegeben werden. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageinputbin
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageInputBin(InputBin.IInputBinItem[] items)](#PageInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| items | [IInputBinItem\[\]](../../com.aspose.xps.metadata/iinputbinitem) | Ein Array von Elementen, die spezifisch für die Funktion sind. |
