...
description: "Gibt einen relativen URI zum Paketstamm zu einem ICC-Profil an, das in einem XPS-Dokument enthalten ist."
type: docs
weight: 94
url: /de/java/com.aspose.xps.metadata/pagedevicecolorspaceprofileuri/
---
**Inheritance:**
...
Gibt einen relativen URI zum Paketstamm zu einem in einem XPS-Dokument enthaltenen ICC-Profil an. Die Verarbeitung dieser Option hängt von der Einstellung des Features PageDeviceColorSpaceUsage ab. Alle Elemente, die dieses Profil verwenden, werden als bereits im entsprechenden Gerätefarbraum befindlich angenommen und werden im Treiber oder Gerät nicht farblich verwaltet. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceprofileuri
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageDeviceColorSpaceProfileURI(String value)](#PageDeviceColorSpaceProfileURI-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
