...
description: "Beschreibt die Optionen des JobPageOrder-Features."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Beschreibt die  JobPageOrder  Funktionsoptionen.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Reverse](#Reverse) | Gibt die Reihenfolge von hinten nach vorne an. |
| [Standard](#Standard) | Gibt die Reihenfolge von vorne nach hinten an. |
## Methoden
...
Gibt die Reihenfolge von hinten nach vorne an.
...
Gibt die Reihenfolge von vorne nach hinten an.
