...
description: "Beschreibt die Optionen des JobAccountingSheet-Features."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Beschreibt die Optionen des Features JobAccountingSheet.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [None](#None) | Gibt an, dass kein Abrechnungsblatt ausgegeben wird. |
| [Standard](#Standard) | Gibt an, dass das Standard‑ (gerätespezifische) Abrechnungsblatt ausgegeben werden soll. |
## Methoden
...
Gibt an, dass kein Abrechnungsblatt ausgegeben wird.
...
Gibt an, dass das Standard‑ (gerätespezifische) Abrechnungsblatt ausgegeben werden soll.
