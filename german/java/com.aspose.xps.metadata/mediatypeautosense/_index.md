...
description: "Definiert Konstanten für den Wert der bewerteten Eigenschaft MediaTypeAutoSense."
type: docs
weight: 19
url: /de/java/com.aspose.xps.metadata/inputbin.mediatypeautosense/
---
**Inheritance:**
...
Definiert Konstanten für den MediaTypeAutoSense‑bewerteten Eigenschaftswert.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [None](#None) | Kein Wert. |
| [Supported](#Supported) | Unterstützter Wert. |
## Methoden
