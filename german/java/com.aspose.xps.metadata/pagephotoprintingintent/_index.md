...
description: "Zeigt eine hochrangige Absicht gegenüber dem Treiber für die Befüllung der Foto‑Druckeinstellungen an."
type: docs
weight: 117
url: /de/java/com.aspose.xps.metadata/pagephotoprintingintent/
---
**Inheritance:**
...
Gibt eine hochrangige Absicht an den Treiber für die Befüllung der Foto‑Druckeinstellungen an. Diese Einstellungen betreffen die erwartete Ausgabqualität, die ein Benutzer beim Drucken von Fotos festlegen kann. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagephotoprintingintent
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PagePhotoPrintingIntent(PagePhotoPrintingIntent.PagePhotoPrintingIntentOption[] options)](#PagePhotoPrintingIntent-com.aspose.xps.metadata.PagePhotoPrintingIntent.PagePhotoPrintingIntentOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [PagePhotoPrintingIntentOption\[\]](../../com.aspose.xps.metadata/pagephotoprintingintentoption) | Ein Array oder Feature-Option. |
