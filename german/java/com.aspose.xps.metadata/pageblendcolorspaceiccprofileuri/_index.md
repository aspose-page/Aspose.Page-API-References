...
description: "Gibt einen relativen URI-Verweis auf ein ICC-Profil an, das den Farbraum definiert, der FÜR das Mischen VERWENDET werden SOLLTE."
type: docs
weight: 87
url: /de/java/com.aspose.xps.metadata/pageblendcolorspaceiccprofileuri/
---
**Inheritance:**
...
Gibt einen relativen URI-Verweis auf ein ICC-Profil an, das den Farbraum definiert, der FÜR das Mischen verwendet werden SOLLTE. Der <Uri> ist ein absoluter part\_name relativ zum Paketstamm. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspaceiccprofileuri
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI(String value)](#PageBlendColorSpaceICCProfileURI-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
