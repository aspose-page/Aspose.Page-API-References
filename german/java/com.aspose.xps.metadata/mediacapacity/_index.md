...
description: "Definiert Konstanten für den MediaCapacity‑bewerteten Eigenschaftswert, die angeben, ob das Fach qualitativ ein Hochkapazitätsfach ist."
type: docs
weight: 15
url: /de/java/com.aspose.xps.metadata/inputbin.mediacapacity/
---
**Inheritance:**
...
Definiert Konstanten für den  MediaCapacity  bewerteten Eigenschaftswert, der angibt, ob der Behälter ein Hochkapazitätsbehälter ist (qualitativ).
## Felder

| Feld | Beschreibung |
| --- | --- |
| [High](#High) | Hoher Wert. |
| [Standard](#Standard) | Standardwert. |
## Methoden
