...
description: "Gibt die Quelle für ein benutzerdefiniertes Rückdeckblatt an."
type: docs
weight: 20
url: /de/java/com.aspose.xps.metadata/documentcoverbacksource/
---
**Inheritance:**
...
Gibt die Quelle für ein benutzerdefiniertes Rückcoverblatt an. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverbacksource
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentCoverBackSource(String value)](#DocumentCoverBackSource-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
