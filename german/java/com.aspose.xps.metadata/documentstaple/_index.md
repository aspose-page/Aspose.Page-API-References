...
type: docs
weight: 35
url: /de/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
Beschreibt die Heftcharakteristika der Ausgabe. Jedes Dokument wird separat geheftet. Die Schlüsselwörter JobStapleAllDocuments und DocumentStaple schließen sich gegenseitig aus. Es liegt am Treiber, die Einschränkungsbehandlung zwischen diesen Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | Erstellt eine neue Instanz. |
## Methoden
