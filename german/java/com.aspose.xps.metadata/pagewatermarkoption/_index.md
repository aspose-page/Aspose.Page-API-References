...
description: "Beschreibt die Optionen der PageWatermark‑Funktionen."
type: docs
weight: 12
url: /de/java/com.aspose.xps.metadata/pagewatermark.pagewatermarkoption/
---
**Inheritance:**
...
Beschreibt die  PageWatermark  Funktionsoptionen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageWatermarkOption(String optionName, PageWatermark.IPageWatermarkOptionItem[] items)](#PageWatermarkOption-java.lang.String-com.aspose.xps.metadata.PageWatermark.IPageWatermarkOptionItem...-) | Erstellt eine neue Instanz. |
| [PageWatermarkOption(PageWatermark.PageWatermarkOption option)](#PageWatermarkOption-com.aspose.xps.metadata.PageWatermark.PageWatermarkOption-) | Klont diese Optionsinstanz. |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Text](#Text) | Gibt ein rein textbasiertes Wasserzeichen an. |
## Methoden
...
| [add(PageWatermark.IPageWatermarkOptionItem[] items)](#add-com.aspose.xps.metadata.PageWatermark.IPageWatermarkOptionItem...-) | Fügt der Option ein Array von  IPageWatermarkOptionItem  Instanzen hinzu. |
...
| items | [IPageWatermarkOptionItem\[\]](../../com.aspose.xps.metadata/ipagewatermarkoptionitem) | Ein beliebiges Array von  IPageWatermarkOptionItem  Instanzen. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| option | [PageWatermarkOption](../../com.aspose.xps.metadata/pagewatermarkoption) | Eine Instanz zum Klonen. |
...
Gibt ein rein textbasiertes Wasserzeichen an.
...
Fügt der Option ein Array von  IPageWatermarkOptionItem  Instanzen hinzu.
