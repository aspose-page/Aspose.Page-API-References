...
description: "Definiert die Seitenauflösung der Druckausgabe entweder als qualitativen Wert, als Punkte pro Zoll oder beides."
type: docs
weight: 120
url: /de/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
Definiert die Seitenauflösung der Druckausgabe entweder als qualitativen Wert, als Punkte pro Zoll oder beides. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | Ein Array von Elementen, die spezifisch für die Funktion sind. |
