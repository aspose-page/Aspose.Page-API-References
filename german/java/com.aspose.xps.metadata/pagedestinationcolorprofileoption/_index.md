...
description: "Beschreibt die Funktionsoptionen von PageDestinationColorProfile."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Beschreibt die Optionen der Funktion PageDestinationColorProfile.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Application](#Application) | Die Anwendung gibt das zu verwendende Zielprofil an. |
| [DriverConfiguration](#DriverConfiguration) | Zielprofil, das für die Farbverwaltung verwendet wird. |
## Methoden
...
Die Anwendung gibt das zu verwendende Zielprofil an.
...
Zielprofil, das für die Farbverwaltung verwendet wird.
