...
type: docs
weight: 114
url: /de/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Beschreibt die vollständige Liste der vom Gerät unterstützten Behälter. Ermöglicht die Angabe des Ausgabebehälters pro Seite. Die Schlüsselwörter JobOutputBin, DocumentOutputBin und PageOutputBin schließen sich gegenseitig aus; es sollte nur eines in einem PrintTicket- oder Print‑Capabilities-Dokument angegeben werden. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Erstellt eine neue Instanz. |
## Methoden
