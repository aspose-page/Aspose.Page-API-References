...
description: "Beschreibt die vollständige Liste der vom Gerät unterstützten Behälter."
type: docs
weight: 30
url: /de/java/com.aspose.xps.metadata/documentoutputbin/
---
**Inheritance:**
...
Beschreibt die vollständige Liste der für das Gerät unterstützten Behälter. Ermöglicht die Angabe des Ausgabebehälters pro Dokument. Die  JobOutputBin ,  DocumentOutputBin  und  PageOutputBin  Schlüsselwörter sind gegenseitig exklusiv; es sollte nur eines in einem PrintTicket‑ oder Print‑Capabilities‑Dokument angegeben werden. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentoutputbin
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentOutputBin(OutputBin.IOutputBinItem[] items)](#DocumentOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| items | [IOutputBinItem\[\]](../../com.aspose.xps.metadata/ioutputbinitem) | Ein Array von Elementen, die spezifisch für die Funktion sind. |
