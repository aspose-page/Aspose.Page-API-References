...
description: "Gibt die Quelle für ein benutzerdefiniertes Vorderdeckblatt an."
type: docs
weight: 22
url: /de/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
Gibt die Quelle für ein benutzerdefiniertes Vorderdeckblatt an. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
