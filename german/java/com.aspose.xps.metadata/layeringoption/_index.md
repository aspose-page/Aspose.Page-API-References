...
description: "Beschreibt die Optionen der Layering-Funktion."
type: docs
weight: 11
url: /de/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Beschreibt die Feature-Optionen für  Layering .
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Overlay](#Overlay) | Wasserzeichen erscheint über dem Seiteninhalt. |
| [Underlay](#Underlay) | Wasserzeichen erscheint unter dem Seiteninhalt. |
## Methoden
...
Wasserzeichen erscheint über dem Seiteninhalt.
...
Wasserzeichen erscheint unter dem Seiteninhalt.
