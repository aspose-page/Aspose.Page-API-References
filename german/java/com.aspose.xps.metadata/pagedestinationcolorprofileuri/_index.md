...
description: "Gibt einen relativen URI-Verweis auf ein ICC-Profil an, das in einem XPS-Dokument enthalten ist."
type: docs
weight: 93
url: /de/java/com.aspose.xps.metadata/pagedestinationcolorprofileuri/
---
**Inheritance:**
...
Gibt einen relativen URI‑Verweis auf ein im XPS‑Dokument enthaltenes ICC‑Profil an. Die Verarbeitung dieser Option hängt von der Einstellung des Features PageDeviceColorSpaceUsage ab. Alle Elemente, die dieses Profil verwenden, werden als bereits im entsprechenden Gerätes Farbraum befindlich angenommen und werden im Treiber oder Gerät nicht farbverwaltet. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileuri
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PageDestinationColorProfileURI(String value)](#PageDestinationColorProfileURI-java.lang.String-) | Erstellt eine neue Instanz. |
## Methoden
