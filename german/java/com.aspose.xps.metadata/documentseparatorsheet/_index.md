...
description: "Beschreibt die Verwendung des Trennblatts für ein Dokument."
type: docs
weight: 34
url: /de/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Beschreibt die Verwendung des Trennblatts für ein Dokument. Trennblätter sollten in der Ausgabe erscheinen, wie durch die unten angegebene Option angegeben. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
