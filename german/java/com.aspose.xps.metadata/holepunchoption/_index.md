...
description: "Beschreibt die Optionen des HolePunch-Features."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/holepunch.holepunchoption/
---
**Inheritance:**
...
Beschreibt die  HolePunch  Funktionsoptionen.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [BottomEdge](#BottomEdge) | Gibt Loch(e) entlang der unteren Kante an. |
| [LeftEdge](#LeftEdge) | Gibt Loch(e) entlang der linken Kante an. |
| [None](#None) | Gibt an, dass keine Lochung erfolgt. |
| [RightEdge](#RightEdge) | Gibt Loch(e) entlang der rechten Kante an. |
| [TopEdge](#TopEdge) | Gibt Loch(e) entlang der oberen Kante an. |
## Methoden
...
Gibt Loch(e) entlang der unteren Kante an.
...
Gibt Loch(e) entlang der linken Kante an.
...
Gibt an, dass keine Lochung erfolgt.
...
Gibt Loch(e) entlang der rechten Kante an.
...
Gibt Loch(e) entlang der oberen Kante an.
