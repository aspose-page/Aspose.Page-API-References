...
description: "Beschreibt die Bindemethode."
type: docs
weight: 15
url: /de/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Beschreibt die Bindemethode. Jedes Dokument wird separat gebunden. DocumentBinding und JobBindAllDocuments schließen sich gegenseitig aus. Es liegt am Treiber, die Einschränkungsbehandlung zwischen den Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
