...
description: "Beschreibt die Heftcharakteristika der Ausgabe."
type: docs
weight: 72
url: /de/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Beschreibt die Heft‑Eigenschaften der Ausgabe. Alle Dokumente im Auftrag werden zusammengeheftet. Die Schlüsselwörter  JobStapleAllDocuments  und  DocumentStaple  schließen einander aus. Es liegt am Treiber, die Einschränkungsbehandlung zwischen diesen Schlüsselwörtern zu bestimmen. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Erstellt eine neue Instanz. |
## Methoden
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | Ein Array von Optionen, das spezifisch für das Feature ist. |
