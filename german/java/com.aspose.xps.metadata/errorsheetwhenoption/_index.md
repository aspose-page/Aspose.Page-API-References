...
description: "Beschreibt die Optionen des Features ErrorSheetWhen."
type: docs
weight: 10
url: /de/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Beschreibt die Optionen des Features ErrorSheetWhen.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Always](#Always) | Gibt an, dass für jeden Auftrag ein Fehlblatt ausgegeben wird. |
| [OnError](#OnError) | Gibt an, dass ein Fehlblatt nur bei einem Fehler ausgegeben wird. |
## Methoden
...
Gibt an, dass für jeden Auftrag ein Fehlblatt ausgegeben wird.
...
Gibt an, dass ein Fehlblatt nur bei einem Fehler ausgegeben wird.
