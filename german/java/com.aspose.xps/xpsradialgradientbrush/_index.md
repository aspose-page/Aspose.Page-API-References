...
description: "Klasse, die RadialGradientBrush-Property-Element-Merkmale kapselt."
type: docs
weight: 48
url: /de/java/com.aspose.xps/xpsradialgradientbrush/
---
**Inheritance:**
...
Klasse, die die Eigenschaften des RadialGradientBrush-Elementes kapselt. Dieses Element wird verwendet, um einen radialen Farbverlaufspinsel anzugeben.
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [deepClone()](#deepClone--) | Klonen Sie diesen radialen Farbverlaufspinsel. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getCenter()](#getCenter--) | Gibt den Mittelpunkt des radialen Farbverlaufs zurück (das ist der Mittelpunkt der Ellipse). |
| [getClass()](#getClass--) |  |
...
| [getGradientOrigin()](#getGradientOrigin--) | Gibt den Ursprungspunkt des radialen Farbverlaufs zurück. |
...
| [getRadiusX()](#getRadiusX--) | Gibt den Radius in X‑Richtung der Ellipse zurück, die den radialen Farbverlauf definiert. |
| [getRadiusY()](#getRadiusY--) | Gibt den Radius in Y‑Richtung der Ellipse zurück, die den radialen Farbverlauf definiert. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCenter(Point2D value)](#setCenter-java.awt.geom.Point2D-) | Setzt den Mittelpunkt des radialen Farbverlaufs (das ist der Mittelpunkt der Ellipse). |
...
| [setGradientOrigin(Point2D value)](#setGradientOrigin-java.awt.geom.Point2D-) | Setzt den Ursprungspunkt des radialen Farbverlaufs. |
...
| [setRadiusX(float value)](#setRadiusX-float-) | Setzt den Radius in X‑Richtung der Ellipse, die den radialen Farbverlauf definiert. |
| [setRadiusY(float value)](#setRadiusY-float-) | Setzt den Radius in Y‑Richtung der Ellipse, die den radialen Farbverlauf definiert. |
...
Klonen Sie diesen radialen Farbverlaufspinsel.
...
Gibt den Mittelpunkt des radialen Farbverlaufs zurück (das ist der Mittelpunkt der Ellipse).

**Returns:**
java.awt.geom.Point2D - Der Mittelpunkt des radialen Farbverlaufs.
### getClass() {#getClass--}
```
...
Gibt den Ursprungspunkt des radialen Farbverlaufs zurück.

**Returns:**
java.awt.geom.Point2D - Der Ursprungspunkt des radialen Farbverlaufs.
...
Gibt den Radius in X‑Richtung der Ellipse zurück, die den radialen Farbverlauf definiert.

**Returns:**
float - Der Radius in X‑Richtung der Ellipse, die den radialen Farbverlauf definiert.
...
Gibt den Radius in Y‑Richtung der Ellipse zurück, die den radialen Farbverlauf definiert.

**Returns:**
float - Der Radius in Y‑Richtung der Ellipse, die den radialen Farbverlauf definiert.
...
Setzt den Mittelpunkt des radialen Farbverlaufs (das ist der Mittelpunkt der Ellipse).

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.awt.geom.Point2D | Der Mittelpunkt des radialen Farbverlaufs. |
...
Setzt den Ursprungspunkt des radialen Farbverlaufs.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.awt.geom.Point2D | Der Ursprungspunkt des radialen Farbverlaufs. |
...
Setzt den Radius in X‑Richtung der Ellipse, die den radialen Farbverlauf definiert.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | float | Der Radius in der x‑Dimension der Ellipse, die den radialen Farbverlauf definiert. |
...
Setzt den Radius in Y‑Richtung der Ellipse, die den radialen Farbverlauf definiert.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | float | Der Radius in der y‑Dimension der Ellipse, die den radialen Farbverlauf definiert. |
