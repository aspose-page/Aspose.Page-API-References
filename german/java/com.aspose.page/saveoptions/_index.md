...
type: docs
weight: 16
url: /de/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [SaveOptions()](#SaveOptions--) | Initialisiere eine neue SaveOptions-Instanz mit Standardwerten für die Flags suppressErrors (true) und debug (false). |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | Initialisiere eine neue SaveOptions-Instanz mit dem Standardwert für das Flag debug (false). |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | Initialisiert eine neue Instanz von SaveOptions mit angegebener Größe. |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | Initialisiere eine neue SaveOptions-Instanz mit dem Standardwert für das Flag debug (false) und mit angegebener Größe. |
## Methoden
...
Initialisiere eine neue SaveOptions-Instanz mit Standardwerten für die Flags suppressErrors (true) und debug (false).
...
Initialisiere eine neue SaveOptions-Instanz mit dem Standardwert für das Flag debug (false).
...
Initialisiert eine neue Instanz von SaveOptions mit angegebener Größe.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Größe | java.awt.Dimension | Die Größe. |
...
Initialisiere eine neue SaveOptions-Instanz mit dem Standardwert für das Flag debug (false) und mit angegebener Größe.
