---
title: "System::Xml::Schema::XmlSchemaPatternFacet 클래스"
linktitle: "XmlSchemaPatternFacet"
second_title: "C++용 Aspose.Page"
description: "System::Xml::Schema::XmlSchemaPatternFacet 클래스. World Wide Web Consortium (W3C)에서 정의한 XML Schema의 pattern 요소를 나타냅니다. 이 클래스는 C++에서 simpleType 요소에 입력된 값에 대한 제한을 지정하는 데 사용할 수 있습니다."
type: docs
weight: 5500
url: /ko/cpp/system.xml.schema/xmlschemapatternfacet/
---
