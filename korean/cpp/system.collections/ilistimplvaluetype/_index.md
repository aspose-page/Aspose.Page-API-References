---
title: "System::Collections::IListImplValueType 클래스"
linktitle: "IListImplValueType"
second_title: "C++용 Aspose.Page"
description: "System::Collections::IListImplValueType 클래스. System::Collections::IList 인터페이스를 System::Collections::Generic::List 객체에 구현하는 스텁이며, C++에서 값 형식에 대한 구현입니다."
type: docs
weight: 1200
url: /ko/cpp/system.collections/ilistimplvaluetype/
---
## IListImplValueType class


값 형식에 대한 구현을 위한 스텁으로, [System::Collections::IList](../ilist/) 인터페이스를 [System::Collections::Generic::List](../../system.collections.generic/list/) 객체에 구현합니다.
...
| [IListImplValueType](./ilistimplvaluetype/)(System::SharedPtr\<System::Collections::Generic::IList\<T\>\>) | 새 객체 인스턴스를 생성합니다. |
