---
title: "System::Net::Dns::BeginGetHostEntry 메서드"
linktitle: "BeginGetHostEntry"
second_title: "C++용 Aspose.Page"
description: "System::Net::Dns::BeginGetHostEntry 메서드. 호스트 이름 또는 IP 주소를 포함하는 지정된 문자열을 사용하여 새로운 IPHostEntry-클래스 인스턴스를 생성하는 비동기 작업을 시작합니다(C++)."
type: docs
weight: 300
url: /ko/cpp/system.net/dns/begingethostentry/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 주소 | System::SharedPtr\<IPAddress\> | IP 주소입니다. |
| requestCallback | AsyncCallback | 작업이 완료될 때 호출되는 콜백입니다. |
| stateObject | System::SharedPtr\<Object\> | 각 비동기 작업을 고유하게 식별하는 데 사용되는 사용자 제공 데이터입니다. |
