---
title: "System::Xml::XmlTextWriter::WriteRaw 메서드"
linktitle: "WriteRaw"
second_title: "C++용 Aspose.Page"
description: "System::Xml::XmlTextWriter::WriteRaw 메서드. C++에서 문자 버퍼에서 원시 마크업을 수동으로 씁니다."
type: docs
weight: 3500
url: /ko/cpp/system.xml/xmltextwriter/writeraw/
---
## XmlTextWriter::WriteRaw(ArrayPtr\<char16_t\>, int32_t, int32_t) method


문자 버퍼에서 원시 마크업을 수동으로 기록합니다.
