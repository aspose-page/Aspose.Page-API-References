...
description: "System::Xml::XmlComment class. C++에서 XML 주석의 내용을 나타냅니다."
type: docs
weight: 1100
url: /ko/cpp/system.xml/xmlcomment/
---
## XmlComment class
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | 노드의 모든 자식을 지정된 [XmlWriter](../xmlwriter/)에 저장합니다. 주석 노드는 자식이 없으므로 이 메서드는 아무 효과가 없습니다. |
