---
title: "System::Net::Sockets::Socket::BeginSend 메서드"
linktitle: "BeginSend"
second_title: "C++용 Aspose.Page"
description: "System::Net::Sockets::Socket::BeginSend 메서드. C++에서 비동기 전송 작업을 시작합니다."
type: docs
weight: 900
url: /ko/cpp/system.net.sockets/socket/beginsend/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 버퍼 | System::ArrayPtr\<uint8_t\> | 데이터를 읽을 버퍼. |
...
| 상태 | System::SharedPtr\<Object\> | 각 비동기 전송 작업을 고유하게 식별하는 데 사용되는 사용자 제공 데이터. |

### ReturnValue

시작된 비동기 전송 작업을 나타내는 [IAsyncResult](../../../system/iasyncresult/) 객체.
