---
title: "System::Net::Http::Headers::WarningHeaderValue::GetWarningLength 메서드"
linktitle: "GetWarningLength"
second_title: "C++용 Aspose.Page"
description: "System::Net::Http::Headers::WarningHeaderValue::GetWarningLength 메서드. 지정된 인덱스부터 전달된 문자열을 C++에서 WarningHeaderValue 클래스의 인스턴스로 변환합니다."
type: docs
weight: 900
url: /ko/cpp/system.net.http.headers/warningheadervalue/getwarninglength/
---
## WarningHeaderValue::GetWarningLength method


지정된 인덱스부터 전달된 문자열을 [WarningHeaderValue](../) 클래스의 인스턴스로 변환합니다.
