---
title: "System::Net::Http::Headers::StringWithQualityHeaderValue::GetStringWithQualityLength 메서드"
linktitle: "GetStringWithQualityLength"
second_title: "C++용 Aspose.Page"
description: "System::Net::Http::Headers::StringWithQualityHeaderValue::GetStringWithQualityLength 메서드. 지정된 인덱스에서 전달된 문자열을 C++의 StringWithQualityHeaderValue 클래스 인스턴스로 변환합니다."
type: docs
weight: 700
url: /ko/cpp/system.net.http.headers/stringwithqualityheadervalue/getstringwithqualitylength/
---
## StringWithQualityHeaderValue::GetStringWithQualityLength method


지정된 인덱스에서 전달된 문자열을 [StringWithQualityHeaderValue](../) 클래스의 인스턴스로 변환합니다.
