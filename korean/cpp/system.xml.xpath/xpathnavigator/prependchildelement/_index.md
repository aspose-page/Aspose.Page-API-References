---
title: "System::Xml::XPath::XPathNavigator::PrependChildElement 메서드"
linktitle: "PrependChildElement"
second_title: "C++용 Aspose.Page"
description: "System::Xml::XPath::XPathNavigator::PrependChildElement 메서드. C++에서 지정된 네임스페이스 접두사, 로컬 이름 및 네임스페이스 URI 값을 사용하여 현재 노드의 자식 노드 목록 앞에 새 자식 요소를 생성합니다."
type: docs
weight: 6700
url: /ko/cpp/system.xml.xpath/xpathnavigator/prependchildelement/
---
## XPathNavigator::PrependChildElement method


지정된 네임스페이스 접두사, 로컬 이름 및 네임스페이스 URI와 지정된 값을 사용하여 현재 노드의 자식 노드 목록 시작 부분에 새 자식 요소를 생성합니다.
