...
description: "System::Xml::XPath::XPathNavigator::InsertElementAfter method. 지정된 네임스페이스 접두사, 로컬 이름 및 네임스페이스 URI를 사용하여 현재 노드 뒤에 새로운 형제 요소를 생성하고, 값은 C++에서 지정됩니다."
type: docs
weight: 4300
url: /ko/cpp/system.xml.xpath/xpathnavigator/insertelementafter/
---
## XPathNavigator::InsertElementAfter method


지정된 네임스페이스 접두사, 로컬 이름 및 네임스페이스 URI와 지정된 값을 사용하여 현재 노드 뒤에 새로운 형제 요소를 생성합니다.
