...
description: "System::IO::Directory::SetLastWriteTimeUtc 메서드. 지정된 엔터티의 마지막 쓰기 시간을 C++에서 UTC 시간으로 설정합니다."
type: docs
weight: 2700
url: /ko/cpp/system.io/directory/setlastwritetimeutc/
---
...
| date | DateTime | UTC 시간으로 설정할 시간을 나타내는 [DateTime](../../../system/datetime/) 객체 |
