...
description: "System::IO::Directory::EnumerateFiles 메서드. 지정된 디렉터리 또는 지정된 디렉터리를 루트로 하는 전체 디렉터리 트리에서 지정된 검색 기준을 만족하는 파일을 C++에서 검색합니다."
type: docs
weight: 400
url: /ko/cpp/system.io/directory/enumeratefiles/
---
...
이름이 **searchPattern**와 일치하는 찾은 파일들의 전체 경로를 포함하는 열거 가능한 컬렉션
