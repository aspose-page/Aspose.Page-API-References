---
title: "System::IO::Directory::GetFileSystemEntries 메서드"
linktitle: "GetFileSystemEntries"
second_title: "C++용 Aspose.Page"
description: "System::IO::Directory::GetFileSystemEntries 메서드. 지정된 디렉터리 또는 지정된 디렉터리를 루트로 하는 전체 디렉터리 트리에서 지정된 검색 기준을 만족하는 파일 및 디렉터리를 C++에서 검색합니다."
type: docs
weight: 1300
url: /ko/cpp/system.io/directory/getfilesystementries/
---
...
이름이 **searchPattern**와 일치하는 찾은 파일 및 디렉터리의 전체 경로 배열
