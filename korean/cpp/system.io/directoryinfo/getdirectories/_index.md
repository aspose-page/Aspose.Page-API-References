---
title: "System::IO::DirectoryInfo::GetDirectories 메서드"
linktitle: "GetDirectories"
second_title: "C++용 Aspose.Page"
description: "System::IO::DirectoryInfo::GetDirectories 메서드. 현재 객체가 나타내는 디렉터리 내에 위치한 모든 디렉터리를 나타내는 DirectoryInfo 객체에 대한 공유 포인터를 포함하는 배열을 반환합니다 (C++)."
type: docs
weight: 1200
url: /ko/cpp/system.io/directoryinfo/getdirectories/
---
...
이름이 **searchPattern**와 일치하는 찾은 디렉터리를 나타내는 [DirectoryInfo](../) 객체에 대한 공유 포인터 배열
