---
title: "System::IO::DirectoryInfo::EnumerateFiles 메서드"
linktitle: "EnumerateFiles"
second_title: "C++용 Aspose.Page"
description: "System::IO::DirectoryInfo::EnumerateFiles 메서드. 현재 객체가 나타내는 디렉터리 내에 위치한 모든 파일을 포함하는 열거 가능한 컬렉션을 반환합니다 (C++)."
type: docs
weight: 600
url: /ko/cpp/system.io/directoryinfo/enumeratefiles/
---
## DirectoryInfo::EnumerateFiles() method


현재 객체가 나타내는 디렉터리에 위치한 모든 파일을 포함하는 열거 가능한 컬렉션을 반환합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| searchPattern | const String\& | 검색할 파일의 이름 패턴 |

### ReturnValue

이름이 **searchPattern**와 일치하는 찾은 파일을 나타내는 [FileInfo](../../fileinfo/) 객체에 대한 공유 포인터의 열거 가능한 컬렉션
