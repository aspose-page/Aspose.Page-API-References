---
title: "System::IO::BasicSTDIOStreamWrapper::Write 메서드"
linktitle: "Write"
second_title: "C++용 Aspose.Page"
description: "System::IO::BasicSTDIOStreamWrapper::Write 메서드. 래핑 모드가 바이너리인 경우 지정된 바이트 배열에서 지정된 바이트 하위 범위를 스트림에 기록하고, 그렇지 않으면 지정된 바이트 배열의 하위 범위를 char_type 형식으로 변환한 후 결과를 C++에서 스트림에 기록합니다."
type: docs
weight: 700
url: /ko/cpp/system.io/basicstdiostreamwrapper/write/
---
