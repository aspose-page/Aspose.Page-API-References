...
description: "System::Security::Cryptography::ECDsaBotan::VerifyData 메서드. 지정된 데이터의 서명이 C++에서 유효한지 확인합니다."
type: docs
weight: 1400
url: /ko/cpp/system.security.cryptography/ecdsabotan/verifydata/
---
...
| signature | const ByteArrayPtr\& | 서명 데이터. 서명이 유효하면 true를 반환하고, 그렇지 않으면 false를 반환합니다. |
