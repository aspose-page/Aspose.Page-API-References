---
title: "System::Text::EncoderFallbackBuffer 클래스"
linktitle: "EncoderFallbackBuffer"
second_title: "C++용 Aspose.Page"
description: "System::Text::EncoderFallbackBuffer 클래스. 폴백 구현을 위한 버퍼를 제공합니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, C++에서 함수 인수로 전달할 때 해당 포인터를 사용하십시오."
type: docs
weight: 1300
url: /ko/cpp/system.text/encoderfallbackbuffer/
---
...
| 메서드 | 설명 |
| --- | --- |
| virtual [Fallback](./fallback/)(char_t, int) | 실제 폴백 절차를 구현합니다. |
| virtual [Fallback](./fallback/)(char_t, char_t, int) | 실제 폴백 절차를 구현합니다. |
