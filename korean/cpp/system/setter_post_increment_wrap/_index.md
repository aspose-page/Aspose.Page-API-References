---
title: "System::setter_post_increment_wrap 메서드"
linktitle: "setter_post_increment_wrap"
second_title: "C++용 Aspose.Page"
description: "System::setter_post_increment_wrap 메서드. Translator는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 증가 표현식을 C++에서 이 함수( const getter에 대한 오버로드) 호출로 변환합니다."
type: docs
weight: 37900
url: /ko/cpp/system/setter_post_increment_wrap/
---
## System::setter_post_increment_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Translator는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 증가 표현식을 이 함수( const getter에 대한 오버로드) 호출로 변환합니다.
...
번역기는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 증가 표현식을 이 함수 호출(비-const getter에 대한 오버로드)로 변환합니다.
...
번역기는 setter와 getter가 정의된 클래스의 속성을 대상으로 하는 C#의 후위 증가 표현식을 이 함수 호출로 변환합니다.
