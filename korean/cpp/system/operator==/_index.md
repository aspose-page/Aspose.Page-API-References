...
지정된 값을, 지정된 [Nullable](../nullable/) 객체가 나타내는 값과 [operator==()](./)을 적용하여 비교하여 동일한지 판단합니다.
...
지정된 [Nullable](../nullable/) 객체가 null과 같은 값을 나타내는지 확인합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| x | std::nullptr_t | [Object](../object/) 확인용. |
