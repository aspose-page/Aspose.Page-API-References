---
title: "System::String::TrimStart 메서드"
linktitle: "TrimStart"
second_title: "C++용 Aspose.Page"
description: "System::String::TrimStart 메서드. C++에서 문자열 시작 부분의 모든 공백 문자를 제거합니다."
type: docs
weight: 6000
url: /ko/cpp/system/string/trimstart/
---
## String::TrimStart() const method


문자열의 시작에서 모든 공백 문자를 제거합니다.
...
전달된 문자에 대한 모든 발생을 문자열의 시작에서 제거합니다.
...
전달된 문자들에 대한 모든 발생을 문자열의 시작에서 제거합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| anyOf | const ArrayPtr\<char_t\>\& | [Array](../../array/) 제거할 문자 배열. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| anyOf | const String\& | [String](../) 제거할 문자 문자열. |
