...
description: "C++에서 System::Int64 클래스의 TryParse 메서드를 사용하는 방법."
type: docs
weight: 200
url: /ko/cpp/system/int64/tryparse/
---
...
제공된 서식 정보와 숫자 스타일을 사용하여 지정된 문자열(숫자의 문자열 표현 포함)을 동일한 64비트 부호 있는 정수로 변환합니다.
...
| result | int64_t\& | 변환 결과가 저장되는 64비트 부호 있는 정수 변수에 대한 참조입니다. |
...
지정된 문자열(숫자의 문자열 표현 포함)을 동일한 64비트 부호 있는 정수로 변환합니다.
