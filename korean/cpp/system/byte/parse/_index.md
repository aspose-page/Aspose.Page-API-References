---
title: "System::Byte::Parse 메서드"
linktitle: "Parse"
second_title: "C++용 Aspose.Page"
description: "System::Byte::Parse 메서드. 지정된 문자열(숫자의 문자열 표현)을 C++에서 동등한 8비트 부호 없는 정수로 변환합니다."
type: docs
weight: 100
url: /ko/cpp/system/byte/parse/
---
...
지정된 문자열이 나타내는 숫자와 같은 8비트 부호 없는 정수입니다.
...
제공된 서식 정보를 사용하여 숫자의 문자열 표현을 포함하는 지정된 문자열을 동등한 8비트 부호 없는 정수로 변환합니다.
