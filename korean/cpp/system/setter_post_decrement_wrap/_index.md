---
title: "System::setter_post_decrement_wrap 메서드"
linktitle: "setter_post_decrement_wrap"
second_title: "C++용 Aspose.Page"
description: "System::setter_post_decrement_wrap 메서드. 번역기는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 감소 표현식을 C++에서 const getter에 대한 오버로드인 이 함수 호출로 변환합니다."
type: docs
weight: 37600
url: /ko/cpp/system/setter_post_decrement_wrap/
---
## System::setter_post_decrement_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


번역기는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 감소 표현식을 이 함수 호출( const getter에 대한 오버로드)로 변환합니다.
...
번역기는 setter와 getter가 정의된 인스턴스의 속성을 대상으로 하는 C#의 후위 감소 표현식을 이 함수 호출( non-const getter에 대한 오버로드)로 변환합니다.
...
번역기는 setter와 getter가 정의된 클래스의 속성을 대상으로 하는 C#의 후위 감소 표현식을 이 함수 호출로 변환합니다.
