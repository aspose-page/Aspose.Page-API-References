---
title: "System::BitConverter::ToInt32 메서드"
linktitle: "ToInt32"
second_title: "C++용 Aspose.Page"
description: "System::BitConverter::ToInt32 메서드. 지정된 인덱스에서 시작하는 지정된 배열의 네 바이트를 C++에서 32비트 정수 값으로 변환합니다."
type: docs
weight: 900
url: /ko/cpp/system/bitconverter/toint32/
---
## BitConverter::ToInt32(const System::ArrayPtr\<uint8_t\>\&, int) method


지정된 인덱스에서 시작하는 지정된 배열의 4바이트를 변환하여 32비트 정수 값으로 변환합니다.
