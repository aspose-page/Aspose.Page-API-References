---
title: "System::BitConverter::ToInt16 메서드"
linktitle: "ToInt16"
second_title: "C++용 Aspose.Page"
description: "System::BitConverter::ToInt16 메서드. 지정된 인덱스에서 시작하는 지정된 배열의 두 바이트를 16비트 정수 값으로 변환합니다(C++)."
type: docs
weight: 800
url: /ko/cpp/system/bitconverter/toint16/
---
## BitConverter::ToInt16(const System::ArrayPtr\<uint8_t\>\&, int) method


지정된 인덱스에서 시작하는 지정된 배열의 2바이트를 변환하여 16비트 정수 값으로 변환합니다.
