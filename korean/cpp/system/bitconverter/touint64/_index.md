---
title: "System::BitConverter::ToUInt64 메서드"
linktitle: "ToUInt64"
second_title: "C++용 Aspose.Page"
description: "System::BitConverter::ToUInt64 메서드. 지정된 인덱스에서 시작하는 지정된 배열의 8바이트를 C++에서 부호 없는 64비트 정수 값으로 변환합니다."
type: docs
weight: 1500
url: /ko/cpp/system/bitconverter/touint64/
---
## BitConverter::ToUInt64(const System::ArrayPtr\<uint8_t\>\&, int) method


지정된 인덱스에서 시작하는 지정된 배열의 8바이트를 변환하여 부호 없는 64비트 정수 값으로 변환합니다.
