---
title: "System::Globalization::GregorianCalendar 클래스"
linktitle: "GregorianCalendar"
second_title: "C++용 Aspose.Page"
description: "System::Globalization::GregorianCalendar 클래스. 그레고리력. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 인스턴스를 만들면 런타임 오류 또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 사용하여 C++에서 함수 인수로 전달하십시오."
type: docs
weight: 1000
url: /ko/cpp/system.globalization/gregoriancalendar/
---
## GregorianCalendar class


그레고리력. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 인스턴스를 만들면 런타임 오류 또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 사용하여 함수 인수로 전달하십시오.
...
| virtual [get_CalendarType](./get_calendartype/)() const | 그레고리력 유형을 가져옵니다. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | 기본 그레고리력 인스턴스를 가져옵니다. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | 특정 그레고리력을 생성합니다. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | 그레고리력 유형을 설정합니다. |
...
| 필드 | 설명 |
| --- | --- |
| static constexpr [ADEra](./adera/) | 현재 연호. |
## 또 보기
