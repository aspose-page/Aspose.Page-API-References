...
CMYK 분판에 대한 검정색 생성 동작을 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessing
...
| 이름 | 설명 |
| --- | --- |
| [PageBlackGenerationProcessing](pageblackgenerationprocessing/)(params PageBlackGenerationProcessingOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageBlackGenerationProcessingOption](pageblackgenerationprocessing.pageblackgenerationprocessingoption/) | 설명`PageBlackGenerationProcessing` 기능 옵션. |
