...
출력에 대한 물리적 페이지의 순서를 정의합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobpageorder
...
| 이름 | 설명 |
| --- | --- |
| [JobPageOrder](jobpageorder/)(params JobPageOrderOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [JobPageOrderOption](jobpageorder.jobpageorderoption/) | 설명`JobPageOrder` 기능 옵션. |
