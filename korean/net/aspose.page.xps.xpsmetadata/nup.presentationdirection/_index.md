...
| 이름 | 설명 |
| --- | --- |
| [PresentationDirection](presentationdirection/)(params PresentationDirectionOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PresentationDirectionOption](nup.presentationdirection.presentationdirectionoption/) | 설명`PresentationDirection` 기능 옵션. |
