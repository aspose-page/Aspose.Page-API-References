...
작업에 대한 기본 사용자 정의 배너 시트의 소스를 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
...
| 이름 | 설명 |
| --- | --- |
| [JobPrimaryBannerSheetSource](jobprimarybannersheetsource/)(string) | 새 인스턴스를 만듭니다. |
