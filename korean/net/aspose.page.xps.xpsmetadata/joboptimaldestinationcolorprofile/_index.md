...
주어진 현재 장치 구성에 따라 최적의 색상 프로필을 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboptimaldestinationcolorprofile
...
| 이름 | 설명 |
| --- | --- |
| [JobOptimalDestinationColorProfile](joboptimaldestinationcolorprofile/)(Profile, string, string) | 새 인스턴스를 만듭니다. |
