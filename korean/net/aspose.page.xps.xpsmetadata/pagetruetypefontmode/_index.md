...
| 이름 | 설명 |
| --- | --- |
| [PageTrueTypeFontMode](pagetruetypefontmode/)(params PageTrueTypeFontModeOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageTrueTypeFontModeOption](pagetruetypefontmode.pagetruetypefontmodeoption/) | 설명`PageTrueTypeFontMode` 기능 옵션. |
