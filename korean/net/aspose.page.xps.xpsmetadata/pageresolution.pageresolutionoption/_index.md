...
설명[`PageResolution`](../pageresolution/) 기능 옵션.
...
| 이름 | 설명 |
| --- | --- |
| [PageResolutionOption](pageresolutionoption/)(string, params IPageResolutionOptionItem[]) | 새 인스턴스를 만듭니다. |
...
| [Add](../../aspose.page.xps.xpsmetadata/pageresolutionoption/add/#add)(params IPageResolutionOptionItem[]) | 배열을 추가합니다.[`IPageResolutionOptionItem`](../pageresolution.ipageresolutionoptionitem/) 옵션에 대한 인스턴스. |
| [SetResolutionX](../../aspose.page.xps.xpsmetadata/pageresolutionoption/setresolutionx/)(int) | 설정 스코어링된 속성 값. |
| [SetResolutionY](../../aspose.page.xps.xpsmetadata/pageresolutionoption/setresolutiony/)(int) | 설정 스코어링된 속성 값. |
