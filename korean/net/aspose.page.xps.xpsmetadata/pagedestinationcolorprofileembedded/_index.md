...
포함된 대상 색상 프로필을 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
...
| 이름 | 설명 |
| --- | --- |
| [PageDestinationColorProfileEmbedded](pagedestinationcolorprofileembedded/)(string) | 새 인스턴스를 만듭니다. |
