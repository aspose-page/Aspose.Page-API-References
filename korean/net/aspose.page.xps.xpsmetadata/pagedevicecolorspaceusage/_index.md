...
와 함께[`PageDeviceColorSpaceProfileURI`](../pagedevicecolorspaceprofileuri/) 매개변수, 이 매개변수는 장치 색상 공간에 표시되는 요소의 렌더링 동작을 정의합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
...
| 이름 | 설명 |
| --- | --- |
| [PageDeviceColorSpaceUsage](pagedevicecolorspaceusage/)(params PageDeviceColorSpaceUsageOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageDeviceColorSpaceUsageOption](pagedevicecolorspaceusage.pagedevicecolorspaceusageoption/) | 설명`PageDeviceColorSpaceUsage` 기능 옵션. |
