...
롤 용지 절단 방법을 설명합니다. 작업이 끝나면 롤을 절단해야 합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
...
| 이름 | 설명 |
| --- | --- |
| [JobRollCutAtEndOfJob](jobrollcutatendofjob/)(params RollCutOption[]) | 새 인스턴스를 만듭니다. |
