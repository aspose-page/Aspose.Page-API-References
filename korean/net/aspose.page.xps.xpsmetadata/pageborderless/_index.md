...
이미지 콘텐츠를 미디어의 물리적 가장자리에 인쇄해야 하는 경우를 설명합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
...
| 이름 | 설명 |
| --- | --- |
| [PageBorderless](pageborderless/)(params PageBorderlessOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption/) | 설명`PageBorderless` 기능 옵션. |
