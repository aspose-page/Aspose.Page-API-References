...
대상 색상 프로필의 특성을 정의합니다. 응용 프로그램 또는 드라이버가 사용할 대상 색상 프로필을 선택하는지 설명합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofile
...
| 이름 | 설명 |
| --- | --- |
| [PageDestinationColorProfile](pagedestinationcolorprofile/)(params PageDestinationColorProfileOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | 설명`PageDestinationColorProfile` 기능 옵션. |
