...
전체 작업에 대한 디지털 서명 처리 구성을 설명합니다. 디지털 서명이 포함된 콘텐츠에만 적용됩니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
...
| 이름 | 설명 |
| --- | --- |
| [JobDigitalSignatureProcessing](jobdigitalsignatureprocessing/)(params JobDigitalSignatureProcessingOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [JobDigitalSignatureProcessingOption](jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/) | 설명`JobDigitalSignatureProcessing` 기능 옵션. |
