...
블렌딩에 사용해야 하는 색상 공간을 정의하는 ICC 프로필에 대한 상대 URI 참조를 지정합니다. &lt;Uri&gt;는 패키지 루트에 상대적인 절대 part_name입니다. https://docs.microsoft.com/en-us /windows/win32/printdocs/pageblendcolorspaceiccprofileuri
...
| 이름 | 설명 |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI](pageblendcolorspaceiccprofileuri/)(string) | 새 인스턴스를 만듭니다. |
