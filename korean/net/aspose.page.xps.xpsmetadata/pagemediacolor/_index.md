...
미디어 색상 옵션 및 각 옵션의 특성을 설명합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
...
| 이름 | 설명 |
| --- | --- |
| [PageMediaColor](pagemediacolor/)(params PageMediaColorOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageMediaColorOption](pagemediacolor.pagemediacoloroption/) | 설명`PageMediaColor` 기능 옵션. |
