...
지정된 옵션에 표시된 대로 특정 사용 시나리오에 대한 출력을 최적화하기 위한 작업 처리를 설명합니다.
...
| 이름 | 설명 |
| --- | --- |
| [JobOutputOptimization](joboutputoptimization/)(params JobOutputOptimizationOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [JobOutputOptimizationOption](joboutputoptimization.joboutputoptimizationoption/) | 설명`JobOutputOptimization` 기능 옵션. |
