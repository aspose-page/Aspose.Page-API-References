...
작업에 대한 사용자 정의 앞표지 기본 시트의 소스를 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
...
| 이름 | 설명 |
| --- | --- |
| [JobPrimaryCoverFrontSource](jobprimarycoverfrontsource/)(string) | 새 인스턴스를 만듭니다. |
