...
물리적 미디어 시트의 방향을 설명합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| 이름 | 설명 |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | 새 인스턴스를 만듭니다. |
...
| 이름 | 설명 |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | 설명`PageOrientation` 기능 옵션. |
