...
사용자 지정 오류 시트의 소스를 지정합니다. https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheetsource
...
| 이름 | 설명 |
| --- | --- |
| [JobErrorSheetSource](joberrorsheetsource/)(string) | 새 인스턴스를 만듭니다. |
