...
설명[`JobOutputBin`](../joboutputbin/) ,[`DocumentOutputBin`](../documentoutputbin/) and [`PageOutputBin`](../pageoutputbin/) 기능 옵션.
...
| 이름 | 설명 |
| --- | --- |
| [OutputBinOption](outputbinoption/)() | 새 인스턴스를 만듭니다. |
...
| [Add](../../aspose.page.xps.xpsmetadata/outputbinoption/add/#add)(params IOutputBinOptionItem[]) | 배열을 추가합니다.[`IOutputBinOptionItem`](../outputbin.ioutputbinoptionitem/)feature. 에 대한 인스턴스 |
| [SetMediaSheetCapacity](../../aspose.page.xps.xpsmetadata/outputbinoption/setmediasheetcapacity/)(int) | 설정 스코어링된 속성 값. |
