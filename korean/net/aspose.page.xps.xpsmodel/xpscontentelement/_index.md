...
description: Aspose.Page.XPS.XpsModel.XpsContentElement 수업. XPS 콘텐츠 요소인 캔버스 경로 및 글리프의 기능을 캡슐화합니다.
type: docs
weight: 3000
url: /ko/net/aspose.page.xps.xpsmodel/xpscontentelement/
---
## XpsContentElement class

XPS 콘텐츠 요소인 캔버스, 경로 및 글리프의 기능을 캡슐화합니다.
