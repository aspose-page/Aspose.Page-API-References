...
ImageBrush 속성 요소 기능을 캡슐화하는 클래스입니다. 이 요소는 이미지로 영역을 채우는 데 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [Image](../../aspose.page.xps.xpsmodel/xpsimagebrush/image/) { get; } | 브러시에 사용된 이미지 리소스를 반환합니다. |
| [ImageSource](../../aspose.page.xps.xpsmodel/xpsimagebrush/imagesource/) { get; } | 이미지 리소스의 URI를 반환합니다. |
...
| 이름 | 설명 |
| --- | --- |
| [Clone](../../aspose.page.xps.xpsmodel/xpsimagebrush/clone/)() | 이 이미지 브러시를 복제합니다. |
