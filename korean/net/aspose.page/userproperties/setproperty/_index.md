...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| properties | Dictionary`2 | 속성 테이블입니다. |
| key | String | 속성의 이름입니다. |
| value | String[] | 재산의 가치. |
