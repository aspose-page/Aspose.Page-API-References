...
GCR が開始する "ハイライトからシャドウ" の範囲内のポイントを記述します (100% の最も暗いシャドウ)。
...
| 名前 | 説明 |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart](pageblackgenerationprocessinggraycomponentreplacementstart/)(int) | 新しいインスタンスを作成します。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| override [MaxValue](../../aspose.page.xps.xpsmetadata/pageblackgenerationprocessinggraycomponentreplacementstart/maxvalue/) { get; } | 整数値または 10 進数値のパラメーターの場合、許容される最大値を定義します。 |
| override [MinValue](../../aspose.page.xps.xpsmetadata/pageblackgenerationprocessinggraycomponentreplacementstart/minvalue/) { get; } | 整数値または 10 進数値のパラメーターの場合、許容される最小値を定義します。 |
