...
物理メディア シートの向きを記述します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| 名前 | 説明 |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | 新しいインスタンスを作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | は、`PageOrientation`機能オプション. |
