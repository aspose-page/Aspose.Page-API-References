...
出力の負の設定について説明します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
...
| 名前 | 説明 |
| --- | --- |
| [PageNegativeImage](pagenegativeimage/)(params PageNegativeImageOption[]) | 新しいインスタンスを作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| class [PageNegativeImageOption](pagenegativeimage.pagenegativeimageoption/) | 定義`PageNegativeImage`機能オプション. |
