...
description: Aspose.Page.XPS.XpsMetadata.PageDestinationColorProfileEmbedded クラス. 埋め込み先のカラー プロファイルを指定します https//docs.microsoft.com/enus/windows/win32/printdocs/pagedestinationcolorprofileembedded
type: docs
weight: 1910
url: /ja/net/aspose.page.xps.xpsmetadata/pagedestinationcolorprofileembedded/
---
## PageDestinationColorProfileEmbedded class

埋め込み先のカラー プロファイルを指定します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
...
| 名前 | 説明 |
| --- | --- |
| [PageDestinationColorProfileEmbedded](pagedestinationcolorprofileembedded/)(string) | 新しいインスタンスを作成します。 |
