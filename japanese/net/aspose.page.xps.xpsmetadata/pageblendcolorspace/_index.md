...
ブレンド操作に使用する色空間について説明します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspace
...
| 名前 | 説明 |
| --- | --- |
| [PageBlendColorSpace](pageblendcolorspace/)(params PageBlendColorSpaceOption[]) | 新しいインスタンスを作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| class [PageBlendColorSpaceOption](pageblendcolorspace.pageblendcolorspaceoption/) | は、`PageBlendColorSpace`機能オプション. |
