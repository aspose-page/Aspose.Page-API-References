...
ソース カラー プロファイルの特性を定義します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagesourcecolorprofile
...
| 名前 | 説明 |
| --- | --- |
| [PageSourceColorProfile](pagesourcecolorprofile/)(params PageSourceColorProfileOption[]) | 新しいインスタンスを作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| class [PageSourceColorProfileOption](pagesourcecolorprofile.pagesourcecolorprofileoption/) | は、`PageSourceColorProfile`機能オプション. |
