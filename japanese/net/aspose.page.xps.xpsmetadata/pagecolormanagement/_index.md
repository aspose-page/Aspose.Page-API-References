...
現在のページのカラー管理を構成します。 これは SHIM で自動と見なされます - DM_ICMMethod Add System. カラー管理を実行する必要があるコンポーネント (つまり、ドライバー) を説明します。 /win32/printdocs/pagecolormanagement
...
| 名前 | 説明 |
| --- | --- |
| [PageColorManagement](pagecolormanagement/)(params PageColorManagementOption[]) | 新しいインスタンスを作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| class [PageColorManagementOption](pagecolormanagement.pagecolormanagementoption/) | は、`PageColorManagement`機能オプション. |
