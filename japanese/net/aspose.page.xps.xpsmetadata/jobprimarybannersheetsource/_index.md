...
ジョブのプライマリ カスタム バナー シートのソースを指定します。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
...
| 名前 | 説明 |
| --- | --- |
| [JobPrimaryBannerSheetSource](jobprimarybannersheetsource/)(string) | 新しいインスタンスを作成します。 |
