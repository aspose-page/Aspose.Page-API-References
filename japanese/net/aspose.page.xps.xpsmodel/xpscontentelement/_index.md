...
description: Aspose.Page.XPS.XpsModel.XpsContentElement クラス. XPS コンテンツ要素の機能をカプセル化します CanvasPathおよび Glyphs.
type: docs
weight: 3000
url: /ja/net/aspose.page.xps.xpsmodel/xpscontentelement/
---
## XpsContentElement class

XPS コンテンツ要素の機能をカプセル化します: Canvas、Path、および Glyphs.
