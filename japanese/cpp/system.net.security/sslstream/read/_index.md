---
title: "System::Net::Security::SslStream::Read メソッド"
linktitle: "読み取り"
second_title: "C++ 用 Aspose.Page"
description: "System::Net::Security::SslStream::Read メソッド。ストリームから指定されたバイト数を読み取り、C++ で指定されたバイト配列に書き込みます。"
type: docs
weight: 3200
url: /ja/cpp/system.net.security/sslstream/read/
---
