---
title: "System::IO::BasicSTDIOStreamWrapper::Write メソッド"
linktitle: "Write"
second_title: "C++ 用 Aspose.Page"
description: "System::IO::BasicSTDIOStreamWrapper::Write メソッド。ラッピングモードがバイナリの場合、指定されたバイト配列から指定されたバイト範囲をストリームに書き込み、そうでない場合は指定されたバイト配列から指定されたバイト範囲を char_type 型に変換し、結果をストリームに書き込みます。C++ で。"
type: docs
weight: 700
url: /ja/cpp/system.io/basicstdiostreamwrapper/write/
---
