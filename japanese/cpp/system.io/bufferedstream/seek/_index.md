---
title: "System::IO::BufferedStream::Seek メソッド"
linktitle: "Seek"
second_title: "C++ 用 Aspose.Page"
description: "System::IO::BufferedStream::Seek メソッド。現在のオブジェクトが表すストリームの位置を設定します（C++）。"
type: docs
weight: 1100
url: /ja/cpp/system.io/bufferedstream/seek/
---
