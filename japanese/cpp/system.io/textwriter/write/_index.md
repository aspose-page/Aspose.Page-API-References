...
description: "System::IO::TextWriter::Write メソッド。C++ で指定されたブール値の文字列表現を書き込みます。"
type: docs
weight: 900
url: /ja/cpp/system.io/textwriter/write/
---
...
指定された [TypeInfo](../../../system/typeinfo/) オブジェクトの文字列表現を書き込み、ストリームに出力します。
...
指定された [Decimal](../../../system/decimal/) オブジェクトの文字列表現を書き込み、ストリームに出力します。
