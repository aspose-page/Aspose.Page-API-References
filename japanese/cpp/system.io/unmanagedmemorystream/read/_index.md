---
title: "System::IO::UnmanagedMemoryStream::Read メソッド"
linktitle: "読み取り"
second_title: "C++ 用 Aspose.Page"
description: "System::IO::UnmanagedMemoryStream::Read メソッド。ストリームから指定されたバイト数を読み取り、指定されたバイト配列に書き込みます（C++）。"
type: docs
weight: 1000
url: /ja/cpp/system.io/unmanagedmemorystream/read/
---
