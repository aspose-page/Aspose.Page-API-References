---
title: "System::TupleFactory::Create メソッド"
linktitle: "作成"
second_title: "C++ 用 Aspose.Page"
description: "System::TupleFactory::Create メソッド。C++ で新しいタプルオブジェクトを作成します。"
type: docs
weight: 100
url: /ja/cpp/system/tuplefactory/create/
---
...
新しい 8 タプルを作成します。8 番目の要素は [Tuple](../../tuple/) に格納されます。
