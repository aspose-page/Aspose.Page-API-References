---
title: "System::setter_post_increment_wrap メソッド"
linktitle: "setter_post_increment_wrap"
second_title: "C++ 用 Aspose.Page"
description: "System::setter_post_increment_wrap メソッド。Translator は、setter と getter が定義されたインスタンスのプロパティを対象とする C# のポストインクリメント式を、C++ のこの関数（const getter 用のオーバーロード）の呼び出しに変換します。"
type: docs
weight: 37900
url: /ja/cpp/system/setter_post_increment_wrap/
---
