...
description: "System::Int64::Parse method. 指定された数値の文字列表現を含む文字列を、C++ における同等の 64 ビット符号付き整数に変換します。"
type: docs
weight: 100
url: /ja/cpp/system/int64/parse/
---
...
指定された文字列が表す数値に等しい 64 ビット符号付き整数です。
...
指定された文字列（数値の文字列表現を含む）を、提供された書式情報を使用して同等の64ビット符号付き整数に変換します。
