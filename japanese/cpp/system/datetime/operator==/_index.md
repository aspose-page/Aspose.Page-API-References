---
title: "System::DateTime::operator== メソッド"
linktitle: "operator=="
second_title: "C++ 用 Aspose.Page"
description: "System::DateTime::operator== メソッド。現在のオブジェクトと指定された DateTime オブジェクトが同じ日付と時刻の値を表しているかどうかを判断します（C++）。"
type: docs
weight: 3900
url: /ja/cpp/system/datetime/operator==/
---
