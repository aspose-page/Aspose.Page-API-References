---
title: "System::Array::Find メソッド"
linktitle: "検索"
second_title: "C++ 用 Aspose.Page"
description: "System::Array::Find メソッド。C++ で指定された配列内で、指定された述語の条件を満たす最初の要素を検索します。"
type: docs
weight: 5100
url: /ja/cpp/system/array/find/
---
## Array::Find method
...
述語で定義された条件を満たす配列の最初の要素のコピー。条件を満たさない場合は型 T のデフォルト値を返します。
