---
title: "System::Drawing::Graphics::DrawPie メソッド"
linktitle: "DrawPie"
second_title: "C++ 用 Aspose.Page"
description: "System::Drawing::Graphics::DrawPie メソッド。C++ で現在のオブジェクトが表すサーフェス上に、指定されたペンを使用して指定されたパイを描画します。"
type: docs
weight: 2400
url: /ja/cpp/system.drawing/graphics/drawpie/
---
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| ペン | const SharedPtr\<Pen\>\& | パイを描画する際に使用するペン |
...
| startAngle | int32_t | X 軸からパイの開始点まで、時計回りに測定した角度（度） |
| sweepAngle | int32_t | パイの終了点まで、**startAngle** から時計回りに測定した角度（度） |
