---
title: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import メソッド"
linktitle: "Import"
second_title: "C++ 用 Aspose.Page"
description: "System::Security::Cryptography::X509Certificates::X509Certificate2::Import メソッド。指定された証明書データから情報をインポートします（C++）。"
type: docs
weight: 2400
url: /ja/cpp/system.security.cryptography.x509certificates/x509certificate2/import/
---
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| データ | const ByteArrayPtr\& | 証明書ファイル名。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| データ | const ByteArrayPtr\& | X.509 証明書データ。 |
