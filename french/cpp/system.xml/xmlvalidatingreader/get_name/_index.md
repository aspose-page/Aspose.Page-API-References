...
description: "System::Xml::XmlValidatingReader::get_Name méthode. Retourne le nom qualifié du nœud actuel en C++."
type: docs
weight: 1700
...
Le nom retourné dépend du XmlValidatingReader::NodeType du nœud. Les types de nœuds suivants retournent les valeurs indiquées. Tous les autres types de nœuds retournent une chaîne vide. |||
|-|-|
| Type de nœud | Nom |
