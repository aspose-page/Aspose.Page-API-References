...
description: "Classe System::Xml::XmlSignificantWhitespace. Représente l'espace blanc entre le balisage dans un nœud à contenu mixte ou l'espace blanc dans une portée xml:space=''preserve''. Ceci est également appelé espace blanc significatif en C++."
type: docs
weight: 3700
url: /fr/cpp/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace class


Représente les espaces blancs entre les balises dans un nœud à contenu mixte ou les espaces blancs à l'intérieur d'une portée **xml:space='preserve'**. Ceci est également appelé espace blanc significatif.
