...
description: "Méthode System::IO::BasicSTDIOStreamWrapper::Write. Si le mode d'encapsulation est binaire, écrit dans le flux la sous-plage spécifiée d'octets du tableau d'octets indiqué, sinon convertit la sous-plage spécifiée d'octets du tableau d'octets en type char_type puis écrit le résultat dans le flux en C++."
type: docs
weight: 700
