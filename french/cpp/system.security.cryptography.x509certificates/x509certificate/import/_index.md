---
title: "System::Security::Cryptography::X509Certificates::X509Certificate::Import méthode"
linktitle: "Import"
second_title: "Aspose.Page pour C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate::Import méthode. Importe les informations à partir des données de certificat spécifiées. NON IMPLEMENTÉ en C++."
type: docs
weight: 2500
url: /fr/cpp/system.security.cryptography.x509certificates/x509certificate/import/
---
## X509Certificate::Import(const ByteArrayPtr\&) method


Importe les informations des données de certificat spécifiées. NON IMPLEMENTÉ.
...
| --- | --- | --- |
| données | const ByteArrayPtr\& | Le nom du fichier de certificat. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| données | const ByteArrayPtr\& | Les données du certificat X.509. |
...
Importe les informations du fichier de certificat spécifié. NON IMPLEMENTÉ.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| filename | const String\& | Le nom du fichier de certificat. |
