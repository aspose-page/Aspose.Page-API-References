---
title: "méthode System::setter_decrement_wrap"
linktitle: "setter_decrement_wrap"
second_title: "Aspose.Page pour C++"
description: "méthode System::setter_decrement_wrap. Le traducteur traduit les expressions de pré‑décrément de C#''s ciblant la propriété d'instance''s qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const) en C++."
type: docs
weight: 37100
url: /fr/cpp/system/setter_decrement_wrap/
---
## System::setter_decrement_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété d'instance's qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const).
...
Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété d'instance's qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter non‑const).
...
Le traducteur traduit les expressions de pré‑décrément de C#'s ciblant la propriété de classe' qui possède un setter et un getter définis, en appel de cette fonction.
