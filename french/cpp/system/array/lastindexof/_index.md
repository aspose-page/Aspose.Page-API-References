---
title: "Méthode System::Array::LastIndexOf"
linktitle: "LastIndexOf"
second_title: "Aspose.Page pour C++"
description: "Méthode System::Array::LastIndexOf. Détermine l'indice de la dernière occurrence de l'élément spécifié dans une plage d'éléments du tableau définie par l'indice de départ et le nombre d'éléments de la plage en C++."
type: docs
weight: 5500
url: /fr/cpp/system/array/lastindexof/
---
## Array::LastIndexOf(const ArrayPtr\<ArrayType\>\&, const ValueType\&, int, int) method


Détermine l'index de la dernière occurrence de l'élément spécifié dans une plage d'éléments du tableau définie par l'index de départ et le nombre d'éléments dans la plage.
...
Indice de la dernière occurrence de l'élément spécifié si l'élément est trouvé, sinon -1
...
| Paramètre | Type | Description |
| --- | --- | --- |
| items | const ArrayPtr\<ArrayType\>\& | [Array](../) pour rechercher l'élément spécifié |
| value | const ValueType\& | Indice de l'élément dont l'indice doit être déterminé |
...
Détermine l'index de la dernière occurrence de l'élément spécifié dans le tableau en commençant à l'index spécifié.
