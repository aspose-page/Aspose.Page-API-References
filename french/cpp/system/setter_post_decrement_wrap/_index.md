...
description: "Méthode System::setter_post_decrement_wrap. Le traducteur traduit les expressions post‑décrément de C#''s ciblant la propriété d''une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const) en C++."
type: docs
weight: 37600
...
Le traducteur traduit les expressions post‑décrément de C#'s ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter const).
...
Le traducteur traduit les expressions post‑décrément de C#'s ciblant la propriété d'une instance qui possède un setter et un getter définis, en appel de cette fonction (surcharge pour le getter non‑const).
...
Le traducteur traduit les expressions post‑décrément de C#'s ciblant la propriété d'une classe qui possède un setter et un getter définis, en appel de cette fonction.
