...
description: Spécifie une référence URI relative à un profil ICC définissant lespace colorimétrique qui DEVRAIT être utilisé pour le mélange. Le ltUrigt est un part_name absolu relatif à la racine du package. https//docs.microsoft.com/enus /windows/win32/printdocs/pageblendcolorspaceiccprofileuri
type: docs
weight: 1760
