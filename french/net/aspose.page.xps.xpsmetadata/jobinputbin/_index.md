...
Décrit le bac d'entrée installé dans un périphérique ou la liste complète des bacs pris en charge pour un périphérique. Permet la spécification du bac d'entrée par tâche. Le`JobInputBin` ,[`DocumentInputBin`](../documentinputbin/) , et[`PageInputBin`](../pageinputbin/) les mots-clés sont mutuellement exclusifs. Les deux ne doivent pas être spécifiés simultanément dans un document PrintTicket ou Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobinputbin
...
| Nom | La description |
| --- | --- |
| [JobInputBin](jobinputbin/)(params IInputBinItem[]) | Crée une nouvelle instance. |
