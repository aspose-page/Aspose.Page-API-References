...
Décrit la première page de couverture. Chaque document aura une feuille séparée. La page de garde doit être imprimée sur le[`PageMediaSize`](../pagemediasize/) et[`PageMediaType`](../pagemediatype/) utilisé pour la première page du document. La page de garde doit être intégrée dans les options de traitement (telles que[`DocumentDuplex`](../documentduplex/) ,[`DocumentNUp`](../documentnup/) ) comme indiqué par l'option spécifiée. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
...
| Nom | La description |
| --- | --- |
| [DocumentCoverFront](documentcoverfront/)(params CoverFrontOption[]) | Crée une nouvelle instance. |
...
| Nom | La description |
| --- | --- |
| class [CoverFrontOption](documentcoverfront.coverfrontoption/) | Décrit le`DocumentCoverFront` options de fonctionnalité. |
