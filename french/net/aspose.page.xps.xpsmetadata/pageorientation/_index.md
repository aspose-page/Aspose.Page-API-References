...
description: Décrit lorientation de la feuille de support physique. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2240
...
| Nom | La description |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption) | Décrit le[`PageOrientation`](../pageorientation) options de fonctionnalité. |
