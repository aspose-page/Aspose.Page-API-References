...
description: Décrit la sortie et le format de plusieurs pages logiques sur une seule feuille physique. Chaque document est compilé séparément. etJobNUpAllDocumentsContiguously./jobnupalldocumentscontiguously sexcluent mutuellement. Il appartient au pilote de déterminer la gestion des contraintes entre ces mots clés. https//docs.microsoft.com/enus/windows/win32/printdocs/documentnup
type: docs
weight: 680
