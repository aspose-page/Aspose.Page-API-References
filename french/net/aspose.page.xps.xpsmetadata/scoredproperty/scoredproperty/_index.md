...
| items | IScoredPropertyItem[] | Un tableau arbitraire de[`IScoredPropertyItem`](../../iscoredpropertyitem)instances. Chacun doit être un[`ScoredProperty`](../../scoredproperty) , un[`Property`](../../property) ou un[`Value`](../../value) exemple. |
