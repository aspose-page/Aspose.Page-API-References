...
| Nom | La description |
| --- | --- |
| class [CoverFrontOption](jobprimarycoverfront.coverfrontoption/) | Décrit le`JobPrimaryCoverFront` options de fonctionnalité. |
