...
description: Décrit la méthode de liaison. Chaque document est lié séparément. DocumentBinding et JobBindAllDocuments sexcluent mutuellement. Il appartient au pilote de déterminer la gestion des contraintes entre les mots clés. https//docs.microsoft.com/enus/windows/win32/printdocs/documentbinding
type: docs
weight: 500
...
| class [BindingOption](documentbinding.bindingoption) | Représente les options du[`DocumentBinding`](../documentbinding) fonctionnalité. |
