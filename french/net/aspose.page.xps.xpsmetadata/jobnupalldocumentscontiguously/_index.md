...
description: Décrit la sortie de plusieurs pages logiques vers une seule feuille physique. Tous les documents du job sont compilés ensemble de manière contiguë.JobNUpAllDocumentsContiguously./jobnupalldocumentscontiguously etDocumentNUp./documentnup sexcluent mutuellement. Il appartient au pilote de déterminer la gestion des contraintes entre ces mots clés. https//docs.microsoft.com/enus/windows/win32/printdocs/jobnupalldocumentscontiguously
type: docs
weight: 1320
