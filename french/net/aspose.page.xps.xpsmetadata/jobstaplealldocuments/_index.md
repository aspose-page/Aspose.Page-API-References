...
description: Décrit les caractéristiques dagrafage de la sortie. Tous les documents du travail sont agrafés ensemble. LeJobStapleAllDocuments./jobstaplealldocuments etDocumentStaple./documentstaple les motsclés sexcluent mutuellement. Il appartient au pilote de déterminer la gestion des contraintes entre ces motsclés. https//docs.microsoft.com/enus/windows/win32/printdocs/jobstaplealldocuments
type: docs
weight: 1520
...
Décrit les caractéristiques d'agrafage de la sortie. Tous les documents du travail sont agrafés ensemble. Le[`JobStapleAllDocuments`](../jobstaplealldocuments) et[`DocumentStaple`](../documentstaple) les mots-clés s'excluent mutuellement. Il appartient au pilote de déterminer la gestion des contraintes entre ces mots-clés. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
