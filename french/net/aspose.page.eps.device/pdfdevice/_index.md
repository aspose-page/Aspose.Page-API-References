...
description: Cette classe encapsule le rendu du document au format PDF.
type: docs
weight: 60
...
| Nom | La description |
| --- | --- |
| [PdfDevice](pdfdevice#constructor)(Stream) | Initialise la nouvelle instance de[`PdfDevice`](../pdfdevice) avec flux de sortie. |
| [PdfDevice](pdfdevice#constructor_1)(Stream, Size) | Initialise la nouvelle instance de[`PdfDevice`](../pdfdevice) avec flux de sortie et taille spécifiée d'une page. |
