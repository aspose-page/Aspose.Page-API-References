...
| [DrawTransparentImage](../../aspose.page.eps/psdocument/drawtransparentimage/)(Bitmap, Matrix, int) | Dessine une image transparente transformée. Si l'image n'a pas de canal Alpha, elle sera dessinée comme opaque image |
| [Fill](../../aspose.page.eps/psdocument/fill/)(GraphicsPath) | Remplissez un chemin arbitraire. |
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext)(string, DrFont, float, float, Brush, Pen) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes et en dessinant les contours des glyphes. |
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext_3)(string, Font, float, float, Brush, Pen) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes et en dessinant les contours des glyphes. |
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext_1)(string, float[], DrFont, float, float, Brush, Pen) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes et en dessinant les contours des glyphes. |
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext_2)(string, float[], Font, float, float, Brush, Pen) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes et en dessinant les contours des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext)(string, DrFont, float, float) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_6)(string, Font, float, float) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_1)(string, DrFont, float, float, Brush) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_2)(string, float[], DrFont, float, float) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_4)(string, float[], Font, float, float) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_7)(string, Font, float, float, Brush) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_3)(string, float[], DrFont, float, float, Brush) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_5)(string, float[], Font, float, float, Brush) | Ajoute une chaîne de texte en remplissant l'intérieur des glyphes. |
...
| [OpenPage](../../aspose.page.eps/psdocument/openpage/#openpage_1)(string) | Crée une nouvelle page avec la taille du document et en fait une page actuelle. |
| [OpenPage](../../aspose.page.eps/psdocument/openpage/#openpage)(float, float) | Crée une nouvelle page et en fait une page actuelle. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext)(string, DrFont, float, float) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_6)(string, Font, float, float) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_1)(string, DrFont, float, float, Pen) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_2)(string, float[], DrFont, float, float) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_4)(string, float[], Font, float, float) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_7)(string, Font, float, float, Pen) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_3)(string, float[], DrFont, float, float, Pen) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_5)(string, float[], Font, float, float, Pen) | Ajoute une chaîne de texte en dessinant les contours des glyphes. |
| [Rotate](../../aspose.page.eps/psdocument/rotate/#rotate_1)(float) | Ajoute une rotation dans le sens antihoraire autour de l'origine à l'état graphique actuel (faire pivoter la matrice actuelle). |
| [Rotate](../../aspose.page.eps/psdocument/rotate/#rotate)(int) | Ajoute une rotation dans le sens antihoraire autour de l'origine à l'état graphique actuel (faire pivoter la matrice actuelle). |
...
| [SetTransform](../../aspose.page.eps/psdocument/settransform/)(Matrix) | Définir la transformation actuelle sur celle-ci. |
