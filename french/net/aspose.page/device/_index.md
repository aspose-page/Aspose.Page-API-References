...
description: Aspose.Page.Device classe. Cette classe encapsule le rendu du document sur un périphérique abstrait. Le rendu du document est effectué page par page.
type: docs
weight: 20
...
| Nom | La description |
| --- | --- |
| [Device](device/)(Size) | Initialise`Device` avec une taille d'une page. |
