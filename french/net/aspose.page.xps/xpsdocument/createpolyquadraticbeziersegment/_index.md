...
description: Crée un nouvel ensemble de courbes de Bézier quadratiques à partir du point précédent dans la figure du chemin à travers un ensemble de sommets en utilisant des points de contrôle spécifiés.
type: docs
weight: 320
