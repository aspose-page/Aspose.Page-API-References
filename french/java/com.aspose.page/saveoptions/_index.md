...
type: docs
weight: 16
url: /fr/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [SaveOptions()](#SaveOptions--) | Initialiser une nouvelle instance de SaveOptions avec les valeurs par défaut pour les indicateurs  suppressErrors  (true) et  debug  (false). |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | Initialiser une nouvelle instance de SaveOptions avec la valeur par défaut pour l'indicateur  debug  (false). |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | Initialise une nouvelle instance de  SaveOptions  avec la taille spécifiée. |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | Initialiser une nouvelle instance de SaveOptions avec la valeur par défaut pour l'indicateur  debug  (false) et avec la taille spécifiée. |
## Méthodes
...
Initialiser une nouvelle instance de SaveOptions avec les valeurs par défaut pour les indicateurs  suppressErrors  (true) et  debug  (false).
...
Initialiser une nouvelle instance de SaveOptions avec la valeur par défaut pour l'indicateur  debug  (false).
...
Initialise une nouvelle instance de  SaveOptions  avec la taille spécifiée.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| taille | java.awt.Dimension | La taille. |
...
Initialiser une nouvelle instance de SaveOptions avec la valeur par défaut pour l'indicateur  debug  (false) et avec la taille spécifiée.
