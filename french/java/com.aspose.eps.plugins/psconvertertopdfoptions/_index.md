...
description: "Représente les options du convertisseur PS/EPS vers PDF pour le plugin."
type: docs
weight: 13
url: /fr/java/com.aspose.eps.plugins/psconvertertopdfoptions/
---
**Inheritance:**
...
Représente les options du convertisseur PS/EPS vers PDF pour le plugin [PsConverter](../../com.aspose.eps.plugins/psconverter).
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PsConverterToPdfOptions()](#PsConverterToPdfOptions--) | Initialise une nouvelle instance de l'objet [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions). |
## Méthodes
...
Initialise une nouvelle instance de l'objet [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions).
