...
description: "Spécifie si l'anticrénelage du lissage est appliqué aux lignes et aux courbes ainsi qu'aux bords des zones remplies."
type: docs
weight: 24
url: /fr/java/com.aspose.xps.rendering/smoothingmode/
---
**Inheritance:**
...
| Champ | Description |
| --- | --- |
| [AntiAlias](#AntiAlias) | Spécifie le rendu antialiasé. |
| [Default](#Default) | Spécifie aucun antialiasing. |
| [HighQuality](#HighQuality) | Spécifie le rendu antialiasé. |
| [HighSpeed](#HighSpeed) | Spécifie aucun antialiasing. |
| [None](#None) | Spécifie aucun antialiasing. |
## Méthodes
