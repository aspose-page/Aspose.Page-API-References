...
description: "Classe pour les options d'enregistrement XPS-as-TIFF."
type: docs
weight: 16
url: /fr/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Classe pour les options d'enregistrement XPS-as-TIFF.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Crée une nouvelle instance d'options. |
## Méthodes
...
| [multipage()](#multipage--) | Obtient le drapeau qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage. |
| [multipage(boolean value)](#multipage-boolean-) | Définit le drapeau qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Obtient le drapeau qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage.

**Returns:**
boolean - L'indicateur qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage.
...
Définit le drapeau qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | L'indicateur qui définit si plusieurs images doivent être enregistrées dans un seul fichier TIFF multipage. |
