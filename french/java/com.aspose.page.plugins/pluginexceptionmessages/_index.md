...
description: "Cette classe représente un stockage pour les messages utilisés dans les exceptions levées par les plugins."
type: docs
weight: 15
url: /fr/java/com.aspose.page.plugins/pluginexceptionmessages/
---
**Inheritance:**
java.lang.Object
```
...
Cette classe représente un stockage pour les messages utilisés dans les exceptions levées par les plugins.
## Constructeurs
