...
description: "Interface générale de résultat d'opération qui définit les méthodes communes que le résultat d'opération de plugin concret doit implémenter."
type: docs
weight: 22
url: /fr/java/com.aspose.page.plugins/ioperationresult/
---```
