...
description: "Interface générale d'instruction de sauvegarde qui définit les membres communs que l'option de plugin concrète doit implémenter."
type: docs
weight: 25
url: /fr/java/com.aspose.page.plugins/isaveinstruction/
---```
