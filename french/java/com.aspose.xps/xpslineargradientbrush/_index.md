...
description: "Classe encapsulant les fonctionnalités de l’élément de propriété LinearGradientBrush."
type: docs
weight: 34
url: /fr/java/com.aspose.xps/xpslineargradientbrush/
---
**Inheritance:**
...
Classe encapsulant les fonctionnalités de l'élément de propriété LinearGradientBrush. Cet élément est utilisé pour spécifier un pinceau de dégradé linéaire le long d'un vecteur.
## Méthodes

| Méthode | Description |
| --- | --- |
| [deepClone()](#deepClone--) | Clone ce pinceau de dégradé linéaire. |
...
| [getEndPoint()](#getEndPoint--) | Renvoie le point final du dégradé linéaire. |
...
| [getStartPoint()](#getStartPoint--) | Renvoie le point de départ du dégradé linéaire. |
...
| [setEndPoint(Point2D value)](#setEndPoint-java.awt.geom.Point2D-) | Renvoie/definit le point final du dégradé linéaire. |
...
| [setStartPoint(Point2D value)](#setStartPoint-java.awt.geom.Point2D-) | Définit le point de départ du dégradé linéaire. |
...
Clone ce pinceau de dégradé linéaire.
...
Renvoie le point final du dégradé linéaire.

**Returns:**
java.awt.geom.Point2D - Le point final du dégradé linéaire.
...
Renvoie le point de départ du dégradé linéaire.

**Returns:**
java.awt.geom.Point2D - Le point de départ du dégradé linéaire.
...
Renvoie/definit le point final du dégradé linéaire.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.awt.geom.Point2D | Le point final du dégradé linéaire. |
...
Définit le point de départ du dégradé linéaire.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.awt.geom.Point2D | Le point de départ du dégradé linéaire. |
