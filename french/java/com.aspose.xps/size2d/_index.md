...
description: "La classe Size2D décrit les dimensions w x h."
type: docs
weight: 12
url: /fr/java/com.aspose.xps/size2d/
---
**Inheritance:**
...
La classe `Size2D` décrit les dimensions (w x h).

Cette classe n'est que la superclasse abstraite pour tous les objets qui stockent des dimensions 2D. La représentation de stockage réelle des dimensions est laissée à la sous‑classe.
## Constructeurs
