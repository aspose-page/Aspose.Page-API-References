...
description: "Décrit quand le contenu de l'image doit être imprimé jusqu'aux bords physiques du support."
type: docs
weight: 88
url: /fr/java/com.aspose.xps.metadata/pageborderless/
---
**Inheritance:**
...
Décrit quand le contenu image doit être imprimé jusqu'aux bords physiques du support. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBorderless(PageBorderless.PageBorderlessOption[] options)](#PageBorderless-com.aspose.xps.metadata.PageBorderless.PageBorderlessOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [PageBorderlessOption\[\]](../../com.aspose.xps.metadata/pageborderlessoption) | Un tableau d'options spécifiques à la fonctionnalité. |
