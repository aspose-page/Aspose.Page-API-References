...
description: "Décrit la méthode de coupe du papier en rouleau."
type: docs
weight: 33
url: /fr/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Décrit la méthode de coupe pour le papier en rouleau. Chaque document est traité séparément. Les options spécifiées décrivent les différentes méthodes de coupe en rouleau. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Un tableau d'options spécifiques à la fonctionnalité. |
