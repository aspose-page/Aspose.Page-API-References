...
description: "En conjonction avec le paramètre PageDeviceColorSpaceProfileURI, ce paramètre définit le comportement de rendu pour les éléments présentés dans un espace colorimétrique d'appareil."
type: docs
weight: 95
url: /fr/java/com.aspose.xps.metadata/pagedevicecolorspaceusage/
---
**Inheritance:**
...
En conjonction avec le paramètre  PageDeviceColorSpaceProfileURI , ce paramètre définit le comportement de rendu pour les éléments présentés dans un espace colorimétrique d'appareil. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageDeviceColorSpaceUsage(PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption[] options)](#PageDeviceColorSpaceUsage-com.aspose.xps.metadata.PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [PageDeviceColorSpaceUsageOption\[\]](../../com.aspose.xps.metadata/pagedevicecolorspaceusageoption) | Un tableau d'options spécifiques à la fonctionnalité. |
