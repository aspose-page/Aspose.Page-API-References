...
description: "Décrit les options de fonctionnalité PageDestinationColorProfile."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité  PageDestinationColorProfile .
## Champs

| Champ | Description |
| --- | --- |
| [Application](#Application) | L'application spécifie le profil de destination à utiliser. |
| [DriverConfiguration](#DriverConfiguration) | Profil de destination utilisé pour effectuer la gestion des couleurs. |
## Méthodes
