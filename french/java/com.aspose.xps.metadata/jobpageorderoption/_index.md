...
description: "Décrit les options de la fonctionnalité JobPageOrder."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité JobPageOrder.
## Champs

| Champ | Description |
| --- | --- |
| [Reverse](#Reverse) | Spécifie l'ordre des pages de l'arrière vers l'avant. |
| [Standard](#Standard) | Spécifie l'ordre des pages de l'avant vers l'arrière. |
## Méthodes
...
Spécifie l'ordre des pages de l'arrière vers l'avant.
...
Spécifie l'ordre des pages de l'avant vers l'arrière.
