...
description: "Décrit le bac d'entrée installé dans un appareil ou la liste complète des bacs pris en charge pour un appareil."
type: docs
weight: 100
url: /fr/java/com.aspose.xps.metadata/pageinputbin/
---
**Inheritance:**
...
Décrit le bac d'entrée installé dans un appareil ou la liste complète des bacs pris en charge pour un appareil. Permet la spécification du bac d'entrée page par page. Les mots-clés  JobInputBin ,  DocumentInputBin  et  PageInputBin  sont mutuellement exclusifs. Ils ne doivent pas être spécifiés simultanément dans un document PrintTicket ou Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageinputbin
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageInputBin(InputBin.IInputBinItem[] items)](#PageInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| items | [IInputBinItem\[\]](../../com.aspose.xps.metadata/iinputbinitem) | Un tableau d’éléments spécifiques à la fonctionnalité. |
