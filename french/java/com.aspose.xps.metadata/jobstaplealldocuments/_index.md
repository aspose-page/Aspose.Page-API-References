...
type: docs
weight: 72
url: /fr/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Décrit les caractéristiques d'agrafage de la sortie. Tous les documents du travail sont agrafés ensemble. Les mots-clés  JobStapleAllDocuments  et  DocumentStaple  sont mutuellement exclusifs. Il appartient au pilote de déterminer la gestion des contraintes entre ces mots-clés. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Crée une nouvelle instance. |
## Méthodes
