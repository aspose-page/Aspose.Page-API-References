...
description: "Décrit les options des fonctionnalités JobDuplexAllDocumentsContiguously et DocumentDuplex."
type: docs
weight: 11
url: /fr/java/com.aspose.xps.metadata/duplex.duplexoption/
---
**Inheritance:**
...
Décrit les options des fonctionnalités  JobDuplexAllDocumentsContiguously  et  DocumentDuplex .
## Champs

| Champ | Description |
| --- | --- |
| [OneSided](#OneSided) | Spécifie l'impression recto simple. |
## Méthodes
...
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
| [twoSidedLongEdge(Duplex.DuplexMode duplexMode)](#twoSidedLongEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Spécifie l'impression recto verso de façon que la page soit retournée parallèlement à la direction  MediaSizeHeight . |
| [twoSidedShortEdge(Duplex.DuplexMode duplexMode)](#twoSidedShortEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Spécifie l'impression recto verso de façon que la page soit retournée parallèlement à la direction  MediaSizeWidth . |
| [wait()](#wait--) |  |
...
Spécifie l'impression recto simple.
...
Spécifie l'impression recto verso de façon que la page soit retournée parallèlement à la direction  MediaSizeHeight .

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| duplexMode | [DuplexMode](../../com.aspose.xps.metadata/duplexmode) | Le  DuplexMode |
...
Spécifie l'impression recto verso de façon que la page soit retournée parallèlement à la direction  MediaSizeWidth .
