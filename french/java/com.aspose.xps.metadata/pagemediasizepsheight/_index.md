...
description: "Spécifie la hauteur de la page parallèle à la direction d'alimentation."
type: docs
weight: 105
url: /fr/java/com.aspose.xps.metadata/pagemediasizepsheight/
---
**Inheritance:**
...
Spécifie la hauteur de la page, parallèle à la direction d'alimentation. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | Crée une nouvelle instance. |
## Méthodes
