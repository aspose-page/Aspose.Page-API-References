...
description: "Décrit la liste complète des bacs pris en charge pour l'appareil."
type: docs
weight: 114
url: /fr/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Décrit la liste complète des bacs pris en charge par l'appareil. Permet la spécification du bac de sortie par page. Les mots-clés JobOutputBin, DocumentOutputBin et PageOutputBin sont mutuellement exclusifs ; un seul doit être spécifié dans un document PrintTicket ou Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Crée une nouvelle instance. |
## Méthodes
