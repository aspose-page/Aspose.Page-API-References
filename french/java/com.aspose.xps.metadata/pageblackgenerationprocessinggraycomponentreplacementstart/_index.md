...
description: "Décrit le point dans la plage de surbrillance à ombre où le GCR doit commencer, 100 % d'ombre la plus sombre."
type: docs
weight: 82
url: /fr/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementstart/
---
**Inheritance:**
...
Décrit le point dans la plage "surbrillance à ombre" où le GCR doit commencer (100 % d'ombre la plus sombre). https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | Crée une nouvelle instance. |
## Méthodes
