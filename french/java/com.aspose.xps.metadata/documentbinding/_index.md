...
type: docs
weight: 15
url: /fr/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Décrit la méthode de reliure. Chaque document est relié séparément. DocumentBinding et JobBindAllDocuments sont mutuellement exclusifs. Il appartient au pilote de déterminer la gestion des contraintes entre les mots‑clés. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Crée une nouvelle instance. |
## Méthodes
