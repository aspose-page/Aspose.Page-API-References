...
description: "Configure la gestion des couleurs pour la page actuelle."
type: docs
weight: 89
url: /fr/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
Configure la gestion des couleurs pour la page actuelle. Ceci est considéré comme automatique dans SHIM - DM\_ICMMethod Add System. Décrit quel composant doit effectuer la gestion des couleurs (c.-à-d. le pilote). https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | Un tableau d'options spécifiques à la fonctionnalité. |
