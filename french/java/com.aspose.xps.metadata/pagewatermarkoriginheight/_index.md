...
description: "Spécifie l'origine d'un filigrane par rapport à l'origine du PageImageableSize."
type: docs
weight: 132
url: /fr/java/com.aspose.xps.metadata/pagewatermarkoriginheight/
---
**Inheritance:**
...
Spécifie l'origine d'un filigrane par rapport à l'origine du  PageImageableSize . https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageWatermarkOriginHeight(int value)](#PageWatermarkOriginHeight-int-) | Crée une nouvelle instance. |
## Méthodes
