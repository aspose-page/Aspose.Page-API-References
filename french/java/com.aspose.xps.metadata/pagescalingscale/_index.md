...
description: "Spécifie le facteur de mise à l’échelle pour une mise à l’échelle carrée personnalisée."
type: docs
weight: 124
url: /fr/java/com.aspose.xps.metadata/pagescalingscale/
---
**Inheritance:**
...
Spécifie le facteur d'échelle pour le redimensionnement carré personnalisé. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscale
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageScalingScale(int value)](#PageScalingScale-int-) | Crée une nouvelle instance. |
## Méthodes
