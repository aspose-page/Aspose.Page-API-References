...
description: "Décrit les caractéristiques duplex de la sortie."
type: docs
weight: 52
url: /fr/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Décrit les caractéristiques duplex de la sortie. La fonction duplex permet l'impression des deux côtés du support. Tous les documents du travail sont duplexés ensemble de manière contiguë.  JobDuplexAllDocumentsContiguously  et  DocumentDuplex  sont mutuellement exclusifs. C'est au pilote de déterminer la gestion des contraintes entre ces mots‑clés. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [DuplexOption\[\]](../../com.aspose.xps.metadata/duplexoption) | Un tableau d'options spécifiques à la fonctionnalité. |
