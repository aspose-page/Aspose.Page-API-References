...
description: "Spécifie l'angle du texte du filigrane par rapport à la direction PageImageableSizeWidth."
type: docs
weight: 134
url: /fr/java/com.aspose.xps.metadata/pagewatermarktextangle/
---
**Inheritance:**
...
Spécifie l'angle du texte du filigrane par rapport à la direction PageImageableSizeWidth. L'angle est mesuré dans le sens inverse des aiguilles d'une montre. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageWatermarkTextAngle(int value)](#PageWatermarkTextAngle-int-) | Crée une nouvelle instance. |
## Méthodes
