...
description: "Décrit les options de la fonctionnalité PageDeviceFontSubstitution."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité  PageDeviceFontSubstitution .
## Champs

| Champ | Description |
| --- | --- |
| [Off](#Off) | La substitution de police du dispositif de page est désactivée. |
| [On](#On) | La substitution de police du dispositif de page est activée. |
## Méthodes
...
La substitution de police du dispositif de page est désactivée.
...
La substitution de police du dispositif de page est activée.
