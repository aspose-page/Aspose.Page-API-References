...
description: "Décrit les options de fonctionnalité JobAccountingSheet."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité  JobAccountingSheet  .
## Champs

| Champ | Description |
| --- | --- |
| [None](#None) | Spécifie qu'aucune feuille de comptabilité ne sera générée. |
| [Standard](#Standard) | Spécifie que la feuille de comptabilité standard (définie par l'appareil) doit être générée. |
## Méthodes
...
Spécifie qu'aucune feuille de comptabilité ne sera générée.
...
Spécifie que la feuille de comptabilité standard (définie par l'appareil) doit être générée.
