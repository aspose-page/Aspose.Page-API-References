...
description: "Décrit la méthode de reliure."
type: docs
weight: 45
url: /fr/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Décrit la méthode de reliure. Tous les documents du travail sont reliés ensemble.  JobBindAllDocuments  et  DocumentBinding  sont mutuellement exclusifs. C'est au pilote de déterminer la gestion des contraintes entre ces mots‑clés. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Un tableau d'options spécifiques à la fonctionnalité. |
