...
description: "Spécifie la direction de la dimension MediaSizeWidth pour l'option MediaSize personnalisée."
type: docs
weight: 103
url: /fr/java/com.aspose.xps.metadata/pagemediasizemediasizeheight/
---
**Inheritance:**
...
Spécifie la direction de la dimension MediaSizeWidth pour l'option MediaSize personnalisée. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizeheight
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageMediaSizeMediaSizeHeight(int value)](#PageMediaSizeMediaSizeHeight-int-) | Crée une nouvelle instance. |
## Méthodes
