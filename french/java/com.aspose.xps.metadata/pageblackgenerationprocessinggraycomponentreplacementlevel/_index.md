...
description: "Spécifie le pourcentage de remplacement du composant gris à effectuer."
type: docs
weight: 81
url: /fr/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementlevel/
---
**Inheritance:**
...
Spécifie le pourcentage de remplacement du composant gris à effectuer. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementlevel
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementLevel(int value)](#PageBlackGenerationProcessingGrayComponentReplacementLevel-int-) | Crée une nouvelle instance. |
## Méthodes
