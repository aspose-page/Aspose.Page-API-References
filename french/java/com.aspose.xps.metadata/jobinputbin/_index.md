...
type: docs
weight: 57
url: /fr/java/com.aspose.xps.metadata/jobinputbin/
---
**Inheritance:**
...
Décrit le bac d'entrée installé dans un appareil ou la liste complète des bacs pris en charge pour un appareil. Permet la spécification du bac d'entrée par travail. Les mots-clés JobInputBin, DocumentInputBin et PageInputBin sont mutuellement exclusifs. Aucun d'eux ne doit être spécifié simultanément dans un document PrintTicket ou Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobinputbin
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobInputBin(InputBin.IInputBinItem[] items)](#JobInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Crée une nouvelle instance. |
## Méthodes
