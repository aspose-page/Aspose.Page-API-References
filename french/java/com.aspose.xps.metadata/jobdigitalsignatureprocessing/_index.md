...
description: "Décrit la configuration du traitement de la signature numérique pour l'ensemble du travail."
type: docs
weight: 51
url: /fr/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing/
---
**Inheritance:**
...
Décrit la configuration du traitement des signatures numériques pour l'ensemble du travail. Applicable uniquement au contenu contenant des signatures numériques. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobDigitalSignatureProcessing(JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption[] options)](#JobDigitalSignatureProcessing-com.aspose.xps.metadata.JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [JobDigitalSignatureProcessingOption\[\]](../../com.aspose.xps.metadata/jobdigitalsignatureprocessingoption) | Un tableau d'options spécifiques à la fonctionnalité. |
