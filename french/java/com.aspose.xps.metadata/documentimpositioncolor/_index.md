...
type: docs
weight: 26
url: /fr/java/com.aspose.xps.metadata/documentimpositioncolor/
---
**Inheritance:**
...
Le contenu de l'application étiqueté avec la couleur nommée spécifiée DOIT apparaître sur toutes les séparations de couleur. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentimpositioncolor
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [DocumentImpositionColor(String value)](#DocumentImpositionColor-java.lang.String-) | Crée une nouvelle instance. |
## Méthodes
