...
description: "Décrit les options de la fonctionnalité JobErrorSheet."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/joberrorsheet.errorsheetoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité  JobErrorSheet  .
## Champs

| Champ | Description |
| --- | --- |
| [Custom](#Custom) | Spécifie qu'une feuille d'erreur personnalisée doit être générée. |
| [None](#None) | Spécifie qu'aucune feuille d'erreur ne doit être générée. |
| [Standard](#Standard) | Spécifie que la feuille d'erreur standard (définie par le dispositif) doit être générée. |
## Méthodes
...
Spécifie qu'une feuille d'erreur personnalisée doit être générée. Si un élément  JobErrorSheetSource   ParameterInit  n'est pas spécifié, cette option doit être ignorée.
...
Spécifie que la feuille d'erreur standard (définie par le dispositif) doit être générée.
