...
description: "Spécifie la direction de la dimension MediaSizeHeight pour l'option MediaSize personnalisée."
type: docs
weight: 104
url: /fr/java/com.aspose.xps.metadata/pagemediasizemediasizewidth/
---
**Inheritance:**
...
Spécifie la direction de la dimension  MediaSizeHeight  pour l'option  MediaSize  personnalisée. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | Crée une nouvelle instance. |
## Méthodes
