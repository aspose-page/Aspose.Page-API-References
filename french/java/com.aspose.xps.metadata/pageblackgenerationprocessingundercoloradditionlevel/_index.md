...
description: "Décrit la quantité d'encre chromatique en rapports de composantes grises à ajouter aux zones où GCR/UCR a généré BlackInkLimit ou UCAStart, si spécifié, dans les neutres sombres et les zones quasi neutres."
type: docs
weight: 84
url: /fr/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionlevel/
---
**Inheritance:**
...
Décrit la quantité d'encre chromatique (en rapports de composantes grises) à ajouter aux zones où GCR/UCR a généré "BlackInkLimit" (ou UCAStart, si spécifié) dans les neutres sombres et les zones quasi neutres. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionlevel
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionLevel(int value)](#PageBlackGenerationProcessingUnderColorAdditionLevel-int-) | Crée une nouvelle instance. |
## Méthodes
