...
description: "Décrit les caractéristiques de perforation de la sortie."
type: docs
weight: 55
url: /fr/java/com.aspose.xps.metadata/jobholepunch/
---
**Inheritance:**
...
Décrit les caractéristiques de perforation du résultat. Tous les documents sont perforés ensemble. Les mots-clés  JobHolePunch  et  DocumentHolePunch  sont mutuellement exclusifs. Les deux ne doivent pas être spécifiés simultanément dans un document PrintTicket ou Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [JobHolePunch(HolePunch.HolePunchOption[] options)](#JobHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [HolePunchOption\[\]](../../com.aspose.xps.metadata/holepunchoption) | Un tableau d'options spécifiques à la fonctionnalité. |
