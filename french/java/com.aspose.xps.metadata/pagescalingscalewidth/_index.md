...
description: "Spécifie le facteur d'échelle dans la direction ImageableSizeWidth pour un redimensionnement personnalisé."
type: docs
weight: 126
url: /fr/java/com.aspose.xps.metadata/pagescalingscalewidth/
---
**Inheritance:**
...
Spécifie le facteur d'échelle dans la direction  ImageableSizeWidth  pour un redimensionnement personnalisé. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageScalingScaleWidth(int value)](#PageScalingScaleWidth-int-) | Crée une nouvelle instance. |
## Méthodes
