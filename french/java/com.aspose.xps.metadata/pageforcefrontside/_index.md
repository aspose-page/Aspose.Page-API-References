...
description: "Force la sortie à apparaître sur le devant d'une feuille de support."
type: docs
weight: 97
url: /fr/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Force la sortie à apparaître sur le côté avant d'une feuille de support. Pertinent pour les feuilles de support avec des surfaces différentes sur chaque face. Dans les cas où cette fonctionnalité interfère avec les options de traitement (comme  DocumentDuplex ),  PageForceFrontSide  prend le pas pour la page spécifique à laquelle la fonctionnalité s'applique.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | Un tableau d'options spécifiques à la fonctionnalité. |
