...
description: "Décrit les options de la fonctionnalité JobOutputOptimization."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/joboutputoptimization.joboutputoptimizationoption/
---
**Inheritance:**
...
Décrit les options de la fonctionnalité JobOutputOptimization.
## Champs

| Champ | Description |
| --- | --- |
| [ArchiveFormat](#ArchiveFormat) | Spécifie que le traitement du travail doit être optimisé pour une sortie d’archive. |
| [None](#None) | Spécifie que le traitement du travail ne doit pas être optimisé pour un scénario particulier. |
| [OptimizeForPortability](#OptimizeForPortability) | Spécifie que le traitement du travail doit être optimisé pour la portabilité (inter-appareil) de la sortie. |
| [OptimizeForQuality](#OptimizeForQuality) | Spécifie que le traitement du travail doit être optimisé pour la qualité de la sortie. |
| [OptimizeForSpeed](#OptimizeForSpeed) | Spécifie que le traitement du travail doit être optimisé pour la rapidité de la sortie. |
## Méthodes
...
Spécifie que le traitement du travail doit être optimisé pour une sortie d’archive.
...
Spécifie que le traitement du travail doit être optimisé pour la qualité de la sortie.
...
Spécifie que le traitement du travail doit être optimisé pour la rapidité de la sortie.
