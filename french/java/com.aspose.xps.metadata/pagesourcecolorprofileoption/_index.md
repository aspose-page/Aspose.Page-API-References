...
description: "Décrit les options de la fonctionnalité PageSourceColorProfile."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/pagesourcecolorprofile.pagesourcecolorprofileoption/
---
**Inheritance:**
...
Décrit les options de fonctionnalité PageSourceColorProfile.
## Champs

| Champ | Description |
| --- | --- |
| [CMYK](#CMYK) | Profil source utilisé pour effectuer la gestion des couleurs des données CMYK non balisées. |
| [None](#None) | Aucun profil source. |
| [RGB](#RGB) | Profil source utilisé pour effectuer la gestion des couleurs des données RGB non balisées. |
## Méthodes
...
Profil source utilisé pour effectuer la gestion des couleurs des données CMYK non balisées.
...
Profil source utilisé pour effectuer la gestion des couleurs des données RGB non balisées.
