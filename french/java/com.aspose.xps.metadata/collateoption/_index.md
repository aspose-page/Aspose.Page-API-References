...
description: "Décrit les options des fonctionnalités DocumentCollate et JobCollateAllDocuments."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
Décrit les options des fonctionnalités DocumentCollate et JobCollateAllDocuments.
## Champs

| Champ | Description |
| --- | --- |
| [Collated](#Collated) | Spécifie le regroupement. |
| [Uncollated](#Uncollated) | Spécifie aucun regroupement. |
## Méthodes
