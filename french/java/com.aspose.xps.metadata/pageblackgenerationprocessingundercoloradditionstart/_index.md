...
description: "Décrit le niveau d'ombre en dessous duquel l'UCA sera appliqué."
type: docs
weight: 85
url: /fr/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionstart/
---
**Inheritance:**
...
Décrit le niveau d'ombre en dessous duquel l'UCA sera appliqué. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionstart
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionStart(int value)](#PageBlackGenerationProcessingUnderColorAdditionStart-int-) | Crée une nouvelle instance. |
## Méthodes
