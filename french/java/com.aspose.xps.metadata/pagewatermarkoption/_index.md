...
description: "Décrit les options des fonctionnalités de PageWatermark."
type: docs
weight: 12
url: /fr/java/com.aspose.xps.metadata/pagewatermark.pagewatermarkoption/
---
**Inheritance:**
...
Décrit les options des fonctionnalités de  PageWatermark .
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageWatermarkOption(String optionName, PageWatermark.IPageWatermarkOptionItem[] items)](#PageWatermarkOption-java.lang.String-com.aspose.xps.metadata.PageWatermark.IPageWatermarkOptionItem...-) | Crée une nouvelle instance. |
| [PageWatermarkOption(PageWatermark.PageWatermarkOption option)](#PageWatermarkOption-com.aspose.xps.metadata.PageWatermark.PageWatermarkOption-) | Clone cette instance d'option. |
## Champs

| Champ | Description |
| --- | --- |
| [Text](#Text) | Spécifie un filigrane texte uniquement. |
## Méthodes
...
| [add(PageWatermark.IPageWatermarkOptionItem[] items)](#add-com.aspose.xps.metadata.PageWatermark.IPageWatermarkOptionItem...-) | Ajoute un tableau d'instances  IPageWatermarkOptionItem  à l'option. |
...
| items | [IPageWatermarkOptionItem\[\]](../../com.aspose.xps.metadata/ipagewatermarkoptionitem) | Un tableau arbitraire d'instances  IPageWatermarkOptionItem . |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| option | [PageWatermarkOption](../../com.aspose.xps.metadata/pagewatermarkoption) | Une instance à cloner. |
...
Spécifie un filigrane texte uniquement.
...
Ajoute un tableau d'instances  IPageWatermarkOptionItem  à l'option.
