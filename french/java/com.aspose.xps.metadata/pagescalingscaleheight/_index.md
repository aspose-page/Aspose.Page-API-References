...
description: "Spécifie le facteur d'échelle dans la direction ImageableSizeHeight pour un redimensionnement personnalisé."
type: docs
weight: 125
url: /fr/java/com.aspose.xps.metadata/pagescalingscaleheight/
---
**Inheritance:**
...
Spécifie le facteur d'échelle dans la direction  ImageableSizeHeight  pour un redimensionnement personnalisé. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageScalingScaleHeight(int value)](#PageScalingScaleHeight-int-) | Crée une nouvelle instance. |
## Méthodes
