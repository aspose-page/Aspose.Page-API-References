...
description: "Spécifie le décalage parallèle à la direction d'orientation du flux."
type: docs
weight: 106
url: /fr/java/com.aspose.xps.metadata/pagemediasizepsheightoffset/
---
**Inheritance:**
...
Spécifie le décalage, parallèle à la direction d'orientation du flux. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheightoffset
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageMediaSizePSHeightOffset(int value)](#PageMediaSizePSHeightOffset-int-) | Crée une nouvelle instance. |
## Méthodes
