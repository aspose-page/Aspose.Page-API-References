...
description: "Spécifie le décalage de mise à l'échelle dans la direction ImageableSizeWidth pour la mise à l'échelle personnalisée."
type: docs
weight: 123
url: /fr/java/com.aspose.xps.metadata/pagescalingoffsetwidth/
---
**Inheritance:**
...
Spécifie le décalage de mise à l'échelle dans la  ImageableSizeWidth  direction pour la mise à l'échelle personnalisée. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetwidth
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageScalingOffsetWidth(int value)](#PageScalingOffsetWidth-int-) | Crée une nouvelle instance. |
## Méthodes
