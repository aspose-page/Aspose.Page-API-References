...
description: "Décrit la feuille de couverture avant (début)."
type: docs
weight: 68
url: /fr/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Décrit la feuille de couverture avant (début). L'ensemble du travail aura une seule feuille principale. La feuille de couverture doit être imprimée sur le  PageMediaSize  et le  PageMediaType  utilisés pour la première page du travail. La feuille de couverture doit être intégrée aux options de traitement (telles que  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) comme indiqué par l'Option spécifiée. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Méthodes
