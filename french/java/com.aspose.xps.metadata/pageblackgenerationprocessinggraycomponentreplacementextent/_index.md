...
description: "Décrit l'étendue au-delà des neutres vers les couleurs chromatiques que GRC applique. 0 Remplacement uniforme des composants 100 Remplacement du composant gris."
type: docs
weight: 80
url: /fr/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementextent/
---
**Inheritance:**
...
Décrit l'étendue au-delà des neutres (vers les couleurs chromatiques) que GRC applique. 0 % = Remplacement uniforme des composants, 100 % = Remplacement du composant gris. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementextent
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementExtent(int value)](#PageBlackGenerationProcessingGrayComponentReplacementExtent-int-) | Crée une nouvelle instance. |
## Méthodes
