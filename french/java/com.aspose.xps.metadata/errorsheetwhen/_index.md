...
description: "Décrit la fonctionnalité interne ErrorSheetWhen."
type: docs
weight: 11
url: /fr/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen/
---
**Inheritance:**
...
Décrit la fonctionnalité interne  ErrorSheetWhen  .
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ErrorSheetWhen(JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption[] options)](#ErrorSheetWhen-com.aspose.xps.metadata.JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption...-) | Crée une nouvelle instance. |
## Méthodes
...
| --- | --- | --- |
| options | [ErrorSheetWhenOption\[\]](../../com.aspose.xps.metadata/errorsheetwhenoption) | Un tableau d'options spécifiques à la fonctionnalité. |
