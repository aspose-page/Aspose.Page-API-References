...
description: "Définit les options de la fonctionnalité PageNegativeImage."
type: docs
weight: 10
url: /fr/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
Définit les options de la fonctionnalité  PageNegativeImage .
## Champs

| Champ | Description |
| --- | --- |
| [Negative](#Negative) | Spécifie que la sortie doit être l'image négative. |
| [None](#None) | Spécifie que la sortie doit être l'image non négative. |
## Méthodes
