...
description: "Описывает характеристики масштабирования вывода."
type: docs
weight: 121
url: /ru/java/com.aspose.xps.metadata/pagescaling/
---
**Inheritance:**
...
| --- | --- |
| [PageScaling(PageScaling.IPageScalingItem[] items)](#PageScaling-com.aspose.xps.metadata.PageScaling.IPageScalingItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| items | [IPageScalingItem\[\]](../../com.aspose.xps.metadata/ipagescalingitem) | Массив элементов, специфичных для функции. |
