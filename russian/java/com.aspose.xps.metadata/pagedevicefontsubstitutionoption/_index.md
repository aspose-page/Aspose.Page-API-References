...
description: "Описывает параметры функции PageDeviceFontSubstitution."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Описывает параметры функции PageDeviceFontSubstitution.
## Поля

| Поле | Описание |
| --- | --- |
| [Off](#Off) | Подстановка шрифтов устройства страницы отключена. |
| [On](#On) | Подстановка шрифтов устройства страницы включена. |
## Методы
