...
description: "Описывает установленный лоток вывода в устройстве или полный список поддерживаемых лотков для устройства."
type: docs
weight: 61
url: /ru/java/com.aspose.xps.metadata/joboutputbin/
---
**Inheritance:**
...
Описывает установленный выходной лоток в устройстве или полный список поддерживаемых лотков для устройства. Ключевые слова  JobOutputBin ,  DocumentOutputBin  и  PageOutputBin  являются взаимоисключающими; только один из них должен быть указан в документе PrintTicket или Print Capabilities документ. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputbin
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobOutputBin(OutputBin.IOutputBinItem[] items)](#JobOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| items | [IOutputBinItem\[\]](../../com.aspose.xps.metadata/ioutputbinitem) | Массив элементов, специфичных для функции. |
