...
description: "Описывает, когда содержимое изображения должно печататься до физических краёв носителя."
type: docs
weight: 88
url: /ru/java/com.aspose.xps.metadata/pageborderless/
---
**Inheritance:**
...
Описывает, когда изображение должно печататься до физических краёв носителя. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageBorderless(PageBorderless.PageBorderlessOption[] options)](#PageBorderless-com.aspose.xps.metadata.PageBorderless.PageBorderlessOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageBorderlessOption\[\]](../../com.aspose.xps.metadata/pageborderlessoption) | Массив параметров, специфичных для функции. |
