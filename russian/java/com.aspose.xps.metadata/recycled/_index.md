...
description: "Определяет константы для значения свойства Recycled."
type: docs
weight: 16
url: /ru/java/com.aspose.xps.metadata/pagemediatype.recycled/
---
**Inheritance:**
...
Определяет константы для значения свойства  Recycled .
## Поля

| Поле | Описание |
| --- | --- |
| [None](#None) | Значение None. |
| [Standard](#Standard) | Стандартное значение. |
## Методы
