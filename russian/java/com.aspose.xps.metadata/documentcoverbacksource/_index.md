...
description: "Указывает источник пользовательской задней обложки."
type: docs
weight: 20
url: /ru/java/com.aspose.xps.metadata/documentcoverbacksource/
---
**Inheritance:**
...
| --- | --- |
| [DocumentCoverBackSource(String value)](#DocumentCoverBackSource-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
