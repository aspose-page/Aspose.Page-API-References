...
description: "Указывает описательное имя задания."
type: docs
weight: 59
url: /ru/java/com.aspose.xps.metadata/jobname/
---
**Inheritance:**
...
Указывает описательное имя задания. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobname
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobName(String jobName)](#JobName-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| jobName | java.lang.String | Имя задания. |
