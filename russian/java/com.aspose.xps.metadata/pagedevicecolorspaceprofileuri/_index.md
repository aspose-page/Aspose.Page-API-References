...
description: "Указывает относительный URI к корню пакета для ICC‑профиля, содержащегося в документе XPS."
type: docs
weight: 94
url: /ru/java/com.aspose.xps.metadata/pagedevicecolorspaceprofileuri/
---
**Inheritance:**
...
Указывает относительный URI от корня пакета к ICC‑профилю, содержащемуся в документе XPS. Обработка этой опции зависит от настройки функции PageDeviceColorSpaceUsage. Предполагается, что все элементы, использующие этот профиль, уже находятся в соответствующем цветовом пространстве устройства и не будут управляться цветом в драйвере или устройстве. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceprofileuri
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageDeviceColorSpaceProfileURI(String value)](#PageDeviceColorSpaceProfileURI-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
