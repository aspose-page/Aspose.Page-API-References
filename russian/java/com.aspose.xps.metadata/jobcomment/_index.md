...
description: "Указывает комментарий, связанный с заданием."
type: docs
weight: 48
url: /ru/java/com.aspose.xps.metadata/jobcomment/
---
**Inheritance:**
...
Указывает комментарий, связанный с заданием. Пример: "Пожалуйста, доставьте в комнату 1234 после завершения". https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobComment(String value)](#JobComment-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
