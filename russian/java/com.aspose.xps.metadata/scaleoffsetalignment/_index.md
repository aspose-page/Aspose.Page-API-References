...
description: "Описывает внутреннюю функцию ScaleOffsetAlignment."
type: docs
weight: 11
url: /ru/java/com.aspose.xps.metadata/pagescaling.scaleoffsetalignment/
---
**Inheritance:**
...
Описывает внутреннюю функцию  ScaleOffsetAlignment  .
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ScaleOffsetAlignment(PageScaling.ScaleOffsetAlignmentOption[] options)](#ScaleOffsetAlignment-com.aspose.xps.metadata.PageScaling.ScaleOffsetAlignmentOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [ScaleOffsetAlignmentOption\[\]](../../com.aspose.xps.metadata/scaleoffsetalignmentoption) | Массив параметров, специфичных для функции. |
