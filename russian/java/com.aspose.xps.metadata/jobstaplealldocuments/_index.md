...
description: "Описывает характеристики скрепления вывода."
type: docs
weight: 72
url: /ru/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Описывает характеристики скрепления вывода. Все документы в задании скрепляются вместе. Ключевые слова  JobStapleAllDocuments  и  DocumentStaple  взаимно исключают друг друга. Определять обработку ограничений между этими ключевыми словами обязан драйвер. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | Массив параметров, специфичных для функции. |
