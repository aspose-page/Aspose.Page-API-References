...
description: "Описывает параметры функции JobAccountingSheet."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Описывает параметры функции JobAccountingSheet.
## Поля

| Поле | Описание |
| --- | --- |
| [None](#None) | Указывает, что бухгалтерский лист не будет выводиться. |
| [Standard](#Standard) | Указывает, что следует выводить стандартный (определяемый устройством) бухгалтерский лист. |
## Методы
...
Указывает, что следует выводить стандартный (определяемый устройством) бухгалтерский лист.
