...
description: "Указывает источник пользовательской передней обложки."
type: docs
weight: 22
url: /ru/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
Указывает источник пользовательского листа передней обложки. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
