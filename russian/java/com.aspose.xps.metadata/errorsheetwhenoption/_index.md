...
description: "Описывает параметры функции ErrorSheetWhen."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Описывает параметры функции ErrorSheetWhen.
## Поля

| Поле | Описание |
| --- | --- |
| [Always](#Always) | Указывает, что лист ошибки будет выводиться для каждого задания. |
| [OnError](#OnError) | Указывает, что лист ошибки будет выводиться только при ошибке. |
## Методы
...
Указывает, что лист ошибки будет выводиться для каждого задания.
...
Указывает, что лист ошибки будет выводиться только при ошибке.
