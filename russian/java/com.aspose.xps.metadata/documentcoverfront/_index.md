...
description: "Описывает переднюю (начальную) обложку листа."
type: docs
weight: 21
url: /ru/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
Описывает переднюю (начальную) обложку. Каждый документ будет иметь отдельный лист. Обложка должна печататься на  PageMediaSize  и  PageMediaType , используемых для первой страницы документа. Обложка должна быть интегрирована в параметры обработки (например,  DocumentDuplex ,  DocumentNUp ), как указано в заданном параметре Option. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | Массив параметров, специфичных для функции. |
