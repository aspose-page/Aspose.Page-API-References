...
description: "Описывает полный список поддерживаемых лотков для устройства."
type: docs
weight: 114
url: /ru/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Описывает полный список поддерживаемых лотков для устройства. Позволяет указывать лоток вывода для каждой страницы отдельно. Ключевые слова  JobOutputBin ,  DocumentOutputBin  и  PageOutputBin  взаимоисключающие; только одно из них должно быть указано в документе PrintTicket или Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Создаёт новый экземпляр. |
## Методы
