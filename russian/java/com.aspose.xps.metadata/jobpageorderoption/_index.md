...
description: "Описывает параметры функции JobPageOrder."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Описывает параметры функции  JobPageOrder .
## Поля

| Поле | Описание |
| --- | --- |
| [Reverse](#Reverse) | Указывает порядок страниц от задней к передней. |
| [Standard](#Standard) | Указывает порядок страниц от передней к задней. |
## Методы
...
Указывает порядок страниц от задней к передней.
...
Указывает порядок страниц от передней к задней.
