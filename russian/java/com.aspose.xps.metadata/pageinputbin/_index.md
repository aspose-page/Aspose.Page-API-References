...
type: docs
weight: 100
url: /ru/java/com.aspose.xps.metadata/pageinputbin/
---
**Inheritance:**
...
Описывает установленный входной лоток в устройстве или полный список поддерживаемых лотков для устройства. Позволяет указывать входной лоток для каждой страницы. Ключевые слова  JobInputBin ,  DocumentInputBin  и  PageInputBin  являются взаимоисключающими. Их не следует указывать одновременно в документе PrintTicket или Print Capabilities документ. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageinputbin
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageInputBin(InputBin.IInputBinItem[] items)](#PageInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Создаёт новый экземпляр. |
## Методы
