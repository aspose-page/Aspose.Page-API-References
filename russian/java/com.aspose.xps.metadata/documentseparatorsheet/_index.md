...
description: "Описывает использование разделительного листа для документа."
type: docs
weight: 34
url: /ru/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Описывает использование листа‑разделителя для документа. Листы‑разделители должны появляться в выводе в соответствии с указанным ниже параметром Option. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | Массив параметров, специфичных для функции. |
