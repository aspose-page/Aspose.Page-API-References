...
description: "Описывает параметры функции наложения слоёв."
type: docs
weight: 11
url: /ru/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Описывает  Layering  опции функции.
## Поля

| Поле | Описание |
| --- | --- |
| [Overlay](#Overlay) | Водяной знак отображается поверх содержимого страницы. |
| [Underlay](#Underlay) | Водяной знак отображается под содержимым страницы. |
## Методы
...
Водяной знак отображается поверх содержимого страницы.
...
Водяной знак отображается под содержимым страницы.
