...
description: "Указывает относительную ссылку URI на ICC‑профиль, определяющий цветовое пространство, которое ДОЛЖНО использоваться для смешивания."
type: docs
weight: 87
url: /ru/java/com.aspose.xps.metadata/pageblendcolorspaceiccprofileuri/
---
**Inheritance:**
...
Указывает относительную ссылку URI на профиль ICC, определяющий цветовое пространство, которое ДОЛЖНО использоваться для смешивания. <Uri> является абсолютной частью\_name, относительно корня пакета. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspaceiccprofileuri
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI(String value)](#PageBlendColorSpaceICCProfileURI-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
