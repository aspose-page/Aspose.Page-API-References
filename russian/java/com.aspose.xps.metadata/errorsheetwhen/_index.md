...
description: "Описывает внутреннюю функцию ErrorSheetWhen."
type: docs
weight: 11
url: /ru/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen/
---
**Inheritance:**
...
Описывает внутреннюю функцию ErrorSheetWhen.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ErrorSheetWhen(JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption[] options)](#ErrorSheetWhen-com.aspose.xps.metadata.JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [ErrorSheetWhenOption\[\]](../../com.aspose.xps.metadata/errorsheetwhenoption) | Массив параметров, специфичных для функции. |
