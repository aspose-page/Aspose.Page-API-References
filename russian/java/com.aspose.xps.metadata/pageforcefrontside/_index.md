...
description: "Принуждает вывод появляться на передней стороне листа носителя."
type: docs
weight: 97
url: /ru/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Принуждает вывод появляться на передней стороне листа носителя. Актуально для листов носителя с разными поверхностями с каждой стороны. В случаях, когда эта функция конфликтует с параметрами обработки (например,  DocumentDuplex ),  PageForceFrontSide  имеет приоритет для конкретной страницы, к которой применяется функция.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | Массив параметров, специфичных для функции. |
