...
description: "Описывает параметры функции PageForceFrontSide."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Описывает параметры функции PageForceFrontSide.
## Поля

| Поле | Описание |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Указывает, что вывод ограничен передней стороной листа. |
| [None](#None) | Указывает отсутствие ограничений вывода. |
## Методы
...
Указывает, что вывод ограничен передней стороной листа.
...
Указывает отсутствие ограничений вывода.
