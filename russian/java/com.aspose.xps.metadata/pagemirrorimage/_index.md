...
description: "Описывает настройку зеркального отображения вывода."
type: docs
weight: 111
url: /ru/java/com.aspose.xps.metadata/pagemirrorimage/
---
**Inheritance:**
...
Описывает настройку зеркального отображения вывода. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemirrorimage
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageMirrorImage(PageMirrorImage.PageMirrorImageOption[] options)](#PageMirrorImage-com.aspose.xps.metadata.PageMirrorImage.PageMirrorImageOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageMirrorImageOption\[\]](../../com.aspose.xps.metadata/pagemirrorimageoption) | Массив или параметр функции. |
