...
description: "Определяет константы для значения свойства MediaTypeAutoSense."
type: docs
weight: 19
url: /ru/java/com.aspose.xps.metadata/inputbin.mediatypeautosense/
---
**Inheritance:**
...
Определяет константы для значения свойства MediaTypeAutoSense.
## Поля

| Поле | Описание |
| --- | --- |
| [None](#None) | Значение None. |
| [Supported](#Supported) | Поддерживаемое значение. |
## Методы
