...
type: docs
weight: 112
url: /ru/java/com.aspose.xps.metadata/pagenegativeimage/
---
**Inheritance:**
...
Описывает настройку негативного вывода. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageNegativeImage(PageNegativeImage.PageNegativeImageOption[] options)](#PageNegativeImage-com.aspose.xps.metadata.PageNegativeImage.PageNegativeImageOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageNegativeImageOption\[\]](../../com.aspose.xps.metadata/pagenegativeimageoption) | Массив или параметр функции. |
