...
description: "Описывает метод резки рулонной бумаги."
type: docs
weight: 33
url: /ru/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Описывает метод резки рулонной бумаги. Каждый документ обрабатывается отдельно. Указанные параметры описывают различные методы резки рулона. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Массив параметров, специфичных для функции. |
