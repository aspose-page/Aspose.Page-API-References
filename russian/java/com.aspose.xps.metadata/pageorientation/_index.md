...
description: "Описывает ориентацию физического листа носителя."
type: docs
weight: 113
url: /ru/java/com.aspose.xps.metadata/pageorientation/
---
**Inheritance:**
...
Описывает ориентацию физического листа носителя. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageOrientation(PageOrientation.PageOrientationOption[] options)](#PageOrientation-com.aspose.xps.metadata.PageOrientation.PageOrientationOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageOrientationOption\[\]](../../com.aspose.xps.metadata/pageorientationoption) | Массив параметров, специфичных для функции. |
