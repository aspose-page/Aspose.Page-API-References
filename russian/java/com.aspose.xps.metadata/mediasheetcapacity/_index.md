...
description: "Определяет оценочное значение свойства MediaSheetCapacity, которое указывает ёмкость носителя в количестве страниц при полном заполнении контейнера."
type: docs
weight: 11
url: /ru/java/com.aspose.xps.metadata/outputbin.mediasheetcapacity/
---
**Inheritance:**
...
Определяет значение свойства  MediaSheetCapacity , которое указывает емкость носителя в количестве страниц (полный уровень) лотка.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [MediaSheetCapacity(int mediaSheetCapacity)](#MediaSheetCapacity-int-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| mediaSheetCapacity | int | Оценочное значение свойства  MediaSheetCapacity . |
