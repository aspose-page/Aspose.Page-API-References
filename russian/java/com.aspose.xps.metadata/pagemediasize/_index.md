...
description: "Описывает физические размеры носителя, используемые для вывода."
type: docs
weight: 102
url: /ru/java/com.aspose.xps.metadata/pagemediasize/
---
**Inheritance:**
...
Описывает физические размеры носителя, используемые для вывода. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasize
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageMediaSize(PageMediaSize.IPageMediaSizeItem[] options)](#PageMediaSize-com.aspose.xps.metadata.PageMediaSize.IPageMediaSizeItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [IPageMediaSizeItem\[\]](../../com.aspose.xps.metadata/ipagemediasizeitem) | Массив параметров, специфичных для функции. |
