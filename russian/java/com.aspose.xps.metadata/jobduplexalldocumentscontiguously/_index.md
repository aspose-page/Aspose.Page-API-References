...
type: docs
weight: 52
url: /ru/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Описывает характеристики дуплекса вывода. Функция дуплекса позволяет печатать на обеих сторонах носителя. Все документы в задании дуплицируются вместе последовательно.  JobDuplexAllDocumentsContiguously  и  DocumentDuplex  взаимно исключают друг друга. Обработка ограничений между этими ключевыми словами определяется драйвером. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Создаёт новый экземпляр. |
## Методы
