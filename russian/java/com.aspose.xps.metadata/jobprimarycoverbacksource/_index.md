...
description: "Указывает источник основного пользовательского листа задней обложки для задания."
type: docs
weight: 67
url: /ru/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Указывает источник для пользовательского листа основной задней обложки задания. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
