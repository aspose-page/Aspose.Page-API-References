...
description: "Указывает источник основного пользовательского листа передней обложки для задания."
type: docs
weight: 69
url: /ru/java/com.aspose.xps.metadata/jobprimarycoverfrontsource/
---
**Inheritance:**
...
Указывает источник для пользовательского листа основной обложки спереди для задания. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobPrimaryCoverFrontSource(String value)](#JobPrimaryCoverFrontSource-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
