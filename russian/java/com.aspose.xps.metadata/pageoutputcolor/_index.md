...
description: "Описывает характеристики цветовых настроек вывода."
type: docs
weight: 115
url: /ru/java/com.aspose.xps.metadata/pageoutputcolor/
---
**Inheritance:**
...
| --- | --- |
| [PageOutputColor(PageOutputColor.IPageOutputColorItem[] items)](#PageOutputColor-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| items | [IPageOutputColorItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloritem) | Массив элементов, специфичных для функции. |
