...
description: "Определяет характеристики исходного цветового профиля."
type: docs
weight: 127
url: /ru/java/com.aspose.xps.metadata/pagesourcecolorprofile/
---
**Inheritance:**
...
| --- | --- |
| [PageSourceColorProfile(PageSourceColorProfile.PageSourceColorProfileOption[] options)](#PageSourceColorProfile-com.aspose.xps.metadata.PageSourceColorProfile.PageSourceColorProfileOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageSourceColorProfileOption\[\]](../../com.aspose.xps.metadata/pagesourcecolorprofileoption) | Массив параметров, специфичных для функции. |
