...
description: "Описывает параметры функции PageDestinationColorProfile."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Описывает параметры функции PageDestinationColorProfile.
## Поля

| Поле | Описание |
| --- | --- |
| [Application](#Application) | Приложение указывает профиль назначения, который будет использоваться. |
| [DriverConfiguration](#DriverConfiguration) | Профиль назначения, используемый для управления цветом. |
## Методы
...
Приложение указывает профиль назначения, который будет использоваться.
...
Профиль назначения, используемый для управления цветом.
