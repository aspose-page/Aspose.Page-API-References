...
type: docs
weight: 17
url: /ru/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Описывает характеристики сортировки вывода. Все страницы в каждом отдельном документе сортируются. DocumentCollate и JobCollateAlldocuments являются взаимоисключающими. Поведение и реализация того, реализованы ли оба или только один из этих ключевых слов, оставляются на усмотрение драйвера. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Создаёт новый экземпляр. |
## Методы
