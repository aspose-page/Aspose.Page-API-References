...
description: "Описывает параметры функции PageResolution."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pageresolution.pageresolutionoption/
---
**Inheritance:**
...
Описывает  PageResolution  опции функций.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageResolutionOption(String optionName, PageResolution.IPageResolutionOptionItem[] items)](#PageResolutionOption-java.lang.String-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | Создаёт новый экземпляр. |
## Методы
...
| [add(PageResolution.IPageResolutionOptionItem[] items)](#add-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | Добавляет массив экземпляров  IPageResolutionOptionItem  к параметру. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setResolutionX(int resolutionX)](#setResolutionX-int-) | Устанавливает значение оцененного свойства  ResolutionX . |
| [setResolutionY(int resolutionY)](#setResolutionY-int-) | Устанавливает значение оцененного свойства  ResolutionY . |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| items | [IPageResolutionOptionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionoptionitem) | Произвольный массив экземпляров  IPageResolutionOptionItem . |
...
Добавляет массив экземпляров  IPageResolutionOptionItem  к параметру.
...
Устанавливает значение оцененного свойства  ResolutionX .

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| resolutionX | int | Оцененное значение свойства  ResolutionX . |
...
Устанавливает значение оцененного свойства  ResolutionY .

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| resolutionY | int | Оцененное значение свойства  ResolutionY . |
