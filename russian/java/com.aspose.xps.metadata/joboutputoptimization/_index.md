...
description: "Описывает обработку задания, направленную на оптимизацию вывода для конкретных сценариев использования, как указано в заданной опции."
type: docs
weight: 62
url: /ru/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
Описывает обработку задания, направленную на оптимизацию вывода для конкретных сценариев использования, как указано в заданной опции. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | Массив параметров, специфичных для функции. |
