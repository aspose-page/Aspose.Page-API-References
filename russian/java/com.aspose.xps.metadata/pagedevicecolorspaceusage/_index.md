...
description: "В сочетании с параметром PageDeviceColorSpaceProfileURI этот параметр определяет поведение рендеринга для элементов, представленных в цветовом пространстве устройства."
type: docs
weight: 95
url: /ru/java/com.aspose.xps.metadata/pagedevicecolorspaceusage/
---
**Inheritance:**
...
В сочетании с параметром  PageDeviceColorSpaceProfileURI  этот параметр определяет поведение рендеринга для элементов, представленных в цветовом пространстве устройства. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageDeviceColorSpaceUsage(PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption[] options)](#PageDeviceColorSpaceUsage-com.aspose.xps.metadata.PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageDeviceColorSpaceUsageOption\[\]](../../com.aspose.xps.metadata/pagedevicecolorspaceusageoption) | Массив параметров, специфичных для функции. |
