...
description: "Указывает текст водяного знака."
type: docs
weight: 137
url: /ru/java/com.aspose.xps.metadata/pagewatermarktexttext/
---
**Inheritance:**
...
Указывает текст водяного знака. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktexttext
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageWatermarkTextText(String value)](#PageWatermarkTextText-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
