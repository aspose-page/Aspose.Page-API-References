...
description: "Определяет разрешение страницы печатного вывода как качественное значение, как значение в точках на дюйм или оба."
type: docs
weight: 120
url: /ru/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
Определяет разрешение страницы печатного вывода как качественное значение, как значение в точках на дюйм или оба. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | Массив элементов, специфичных для функции. |
