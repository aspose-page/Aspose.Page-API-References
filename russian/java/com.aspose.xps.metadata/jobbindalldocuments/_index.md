...
type: docs
weight: 45
url: /ru/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Описывает метод скрепления. Все документы в задании скрепляются вместе.  JobBindAllDocuments  и  DocumentBinding  взаимно исключают друг друга. Обработка ограничений между этими ключевыми словами определяется драйвером. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Создаёт новый экземпляр. |
## Методы
