...
description: "Описывает вывод нескольких логических страниц на один физический лист."
type: docs
weight: 58
url: /ru/java/com.aspose.xps.metadata/jobnupalldocumentscontiguously/
---
**Inheritance:**
...
Описывает вывод нескольких логических страниц на один физический лист. Все документы в задании компилируются вместе последовательно. JobNUpAllDocumentsContiguously и DocumentNUp являются взаимно исключающимися. Обработка ограничений между этими ключевыми словами зависит от драйвера. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobNUpAllDocumentsContiguously(NUp.INUpItem[] items)](#JobNUpAllDocumentsContiguously-com.aspose.xps.metadata.NUp.INUpItem...-) | Создаёт новый экземпляр. |
## Методы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Значение свойства PagesPerSheet. Поддерживаемый набор может быть любым набором целых чисел, например \{1,2,4,6,8,9,16\}. |
