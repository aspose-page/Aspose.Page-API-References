...
description: "Определяет порядок физических страниц для вывода."
type: docs
weight: 63
url: /ru/java/com.aspose.xps.metadata/jobpageorder/
---
**Inheritance:**
...
| --- | --- |
| [JobPageOrder(JobPageOrder.JobPageOrderOption[] options)](#JobPageOrder-com.aspose.xps.metadata.JobPageOrder.JobPageOrderOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [JobPageOrderOption\[\]](../../com.aspose.xps.metadata/jobpageorderoption) | Массив параметров, специфичных для функции. |
