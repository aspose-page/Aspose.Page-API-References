...
description: "Описывает лист учёта, который будет выводиться для задания."
type: docs
weight: 44
url: /ru/java/com.aspose.xps.metadata/jobaccountingsheet/
---
**Inheritance:**
...
Описывает лист учета, который должен быть выведен для задания. Лист учета должен выводиться с использованием значения по умолчанию  PageMediaSize  и значения по умолчанию  PageMediaType . Лист учета должен быть изолирован от остальной части задания. Это означает, что любые параметры отделки или обработки (например,  JobDuplex ,  JobStaple , или  JobBinding ) не должны включать лист учета. Лист учета может находиться первой или последней страницей задания по усмотрению реализующего. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobaccountingsheet
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobAccountingSheet(JobAccountingSheet.JobAccountingSheetOption[] options)](#JobAccountingSheet-com.aspose.xps.metadata.JobAccountingSheet.JobAccountingSheetOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [JobAccountingSheetOption\[\]](../../com.aspose.xps.metadata/jobaccountingsheetoption) | Массив параметров, специфичных для функции. |
