...
description: "Описывает языки устройств, поддерживаемые для передачи данных от драйвера к физическому устройству."
type: docs
weight: 50
url: /ru/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
Описывает языки устройств, поддерживаемые для передачи данных от драйвера к физическому устройству. Это часто называют "Page Description Language". Этот ключевое слово определяет, какой язык описания страниц поддерживается драйвером и физическим устройством. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdevicelanguage
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | Массив параметров, специфичных для функции. |
