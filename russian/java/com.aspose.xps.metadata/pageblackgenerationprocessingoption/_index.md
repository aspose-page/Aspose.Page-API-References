...
description: "Описывает параметры функции PageBlackGenerationProcessing."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pageblackgenerationprocessing.pageblackgenerationprocessingoption/
---
**Inheritance:**
...
Описывает параметры функции  PageBlackGenerationProcessing .
## Поля

| Поле | Описание |
| --- | --- |
| [Automatic](#Automatic) | Автоматический вариант. |
| [Custom](#Custom) | Пользовательский вариант. |
## Методы
