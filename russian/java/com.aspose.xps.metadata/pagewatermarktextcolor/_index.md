...
description: "Определяет цвет sRGB для текста водяного знака."
type: docs
weight: 135
url: /ru/java/com.aspose.xps.metadata/pagewatermarktextcolor/
---
**Inheritance:**
...
| --- | --- |
| [PageWatermarkTextColor(String value)](#PageWatermarkTextColor-java.lang.String-) | Создаёт новый экземпляр. |
## Методы
