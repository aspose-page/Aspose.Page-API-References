...
description: "Описывает цветовое пространство, которое следует использовать для операций смешивания."
type: docs
weight: 86
url: /ru/java/com.aspose.xps.metadata/pageblendcolorspace/
---
**Inheritance:**
...
| --- | --- |
| [PageBlendColorSpace(PageBlendColorSpace.PageBlendColorSpaceOption[] options)](#PageBlendColorSpace-com.aspose.xps.metadata.PageBlendColorSpace.PageBlendColorSpaceOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageBlendColorSpaceOption\[\]](../../com.aspose.xps.metadata/pageblendcolorspaceoption) | Массив параметров, специфичных для функции. |
