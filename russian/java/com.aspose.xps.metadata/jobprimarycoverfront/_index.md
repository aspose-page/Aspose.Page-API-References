...
type: docs
weight: 68
url: /ru/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Описывает переднюю (начальную) обложку листа. Вся задача будет иметь один основной лист. Обложка должна печататься с использованием  PageMediaSize  и  PageMediaType  , применяемых для первой страницы задачи. Обложка должна быть интегрирована в параметры обработки (например,  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ), как указано в указанном параметре Option. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Методы
