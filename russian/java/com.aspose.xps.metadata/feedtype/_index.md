...
description: "Определяет константы для значения оцененного свойства FeedType."
type: docs
weight: 13
url: /ru/java/com.aspose.xps.metadata/inputbin.feedtype/
---
**Inheritance:**
...
Определяет константы значения свойства  FeedType .
## Поля

| Поле | Описание |
| --- | --- |
| [Automatic](#Automatic) | Автоматическое значение. |
| [Manual](#Manual) | Ручное значение. |
## Методы
