...
description: "Указывает высокоуровневое намерение драйверу для заполнения настроек фотопечати."
type: docs
weight: 117
url: /ru/java/com.aspose.xps.metadata/pagephotoprintingintent/
---
**Inheritance:**
...
Указывает высокоуровневое намерение драйвера для заполнения настроек печати фотографий. Эти настройки относятся к ожидаемому качеству вывода, которое пользователь может указать при печати фотографий. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagephotoprintingintent
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PagePhotoPrintingIntent(PagePhotoPrintingIntent.PagePhotoPrintingIntentOption[] options)](#PagePhotoPrintingIntent-com.aspose.xps.metadata.PagePhotoPrintingIntent.PagePhotoPrintingIntentOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PagePhotoPrintingIntentOption\[\]](../../com.aspose.xps.metadata/pagephotoprintingintentoption) | Массив или параметр функции. |
