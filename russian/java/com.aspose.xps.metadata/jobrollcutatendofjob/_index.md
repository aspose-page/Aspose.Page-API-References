...
type: docs
weight: 71
url: /ru/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Описывает метод резки рулонной бумаги. Рулон должен быть отрезан в конце задания. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Создаёт новый экземпляр. |
## Методы
