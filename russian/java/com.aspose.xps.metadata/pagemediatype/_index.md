...
description: "Описывает варианты MediaType и характеристики каждого варианта."
type: docs
weight: 110
url: /ru/java/com.aspose.xps.metadata/pagemediatype/
---
**Inheritance:**
...
Описывает варианты MediaType и характеристики каждого варианта. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediatype
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageMediaType(PageMediaType.IPageMediaTypeItem[] items)](#PageMediaType-com.aspose.xps.metadata.PageMediaType.IPageMediaTypeItem...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| items | [IPageMediaTypeItem\[\]](../../com.aspose.xps.metadata/ipagemediatypeitem) | Массив элементов, специфичных для функции. |
