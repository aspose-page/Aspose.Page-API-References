...
description: "Описывает параметры функции PageBorderless."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pageborderless.pageborderlessoption/
---
**Inheritance:**
...
Описывает параметры функции PageBorderless.
## Поля

| Поле | Описание |
| --- | --- |
| [Borderless](#Borderless) | Указывает печать без полей. |
| [None](#None) | Указывает отсутствие печати без полей. |
## Методы
...
Указывает отсутствие печати без полей.
