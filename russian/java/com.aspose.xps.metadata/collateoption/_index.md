...
description: "Описывает параметры функций DocumentCollate и JobCollateAllDocuments."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
Описывает параметры функций DocumentCollate и JobCollateAllDocuments.
## Поля

| Поле | Описание |
| --- | --- |
| [Collated](#Collated) | Указывает на сборку. |
| [Uncollated](#Uncollated) | Указывает, что сборка не требуется. |
## Методы
...
Указывает, что сборка не требуется.
