...
description: "Настраивает управление цветом для текущей страницы."
type: docs
weight: 89
url: /ru/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
Настраивает управление цветом для текущей страницы. Это считается автоматическим в SHIM - DM\_ICMMethod Add System. Описывает, какой компонент должен выполнять управление цветом (т.е. драйвер). https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | Массив параметров, специфичных для функции. |
