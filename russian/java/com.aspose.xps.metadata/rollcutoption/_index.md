...
description: "Описывает параметры функций JobRollCutAtEndOfJob и DocumentRollCut."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Описывает параметры функций JobRollCutAtEndOfJob и DocumentRollCut.
## Поля

| Поле | Описание |
| --- | --- |
| [Banner](#Banner) | Указывает метод резки для баннера (только DocumentRollCut). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Указывает резку по краю изображения. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Указывает резку для стандартного размера носителя. |
| [None](#None) | Указывает отсутствие резки ролика задания. |
## Методы
...
Указывает метод резки для баннера (только DocumentRollCut).
...
Указывает резку по краю изображения.
...
Указывает резку для стандартного размера носителя.
...
Указывает отсутствие резки ролика задания.
