...
description: "Описывает метод переплёта."
type: docs
weight: 15
url: /ru/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Описывает метод скрепления. Каждый документ скрепляется отдельно. DocumentBinding и JobBindAllDocuments являются взаимоисключающими. Обработка ограничений между ключевыми словами оставляется на усмотрение драйвера. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Массив параметров, специфичных для функции. |
