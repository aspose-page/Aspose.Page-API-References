...
description: "Определяет параметры функции PageNegativeImage."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
Определяет параметры функции  PageNegativeImage .
## Поля

| Поле | Описание |
| --- | --- |
| [Negative](#Negative) | Указывает, что вывод должен быть отрицательным изображением. |
| [None](#None) | Указывает, что вывод должен быть неотрицательным изображением. |
## Методы
...
Указывает, что вывод должен быть отрицательным изображением.
...
Указывает, что вывод должен быть неотрицательным изображением.
