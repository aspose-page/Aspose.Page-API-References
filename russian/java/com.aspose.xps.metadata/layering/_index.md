...
description: "Описывает внутреннюю функцию Layering."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.metadata/pagewatermark.layering/
---
**Inheritance:**
...
Описывает внутреннюю функцию Layering. Определяет поведение наложения водяного знака.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Layering(PageWatermark.LayeringOption[] options)](#Layering-com.aspose.xps.metadata.PageWatermark.LayeringOption...-) | Создаёт новый экземпляр. |
## Методы
...
| --- | --- | --- |
| options | [LayeringOption\[\]](../../com.aspose.xps.metadata/layeringoption) | Массив параметров, специфичных для функции. |
