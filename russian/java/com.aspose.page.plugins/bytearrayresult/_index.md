...
description: "Представляет результат операции в виде массива байтов."
type: docs
weight: 11
url: /ru/java/com.aspose.page.plugins/bytearrayresult/
---
**Inheritance:**
java.lang.Object
...
Представляет результат операции в виде массива байтов.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ByteArrayResult(byte[][] data)](#ByteArrayResult-byte-----) | Инициализирует новый экземпляр с массивом массивов байтов. |
## Методы
...
Инициализирует новый экземпляр с массивом массивов байтов.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| данные | byte[][] | Массив массивов байтов. Используется для преобразования документа в изображение. Один массив байтов содержит байты изображения одной страницы. |
