...
description: "Общий интерфейс контейнера данных, определяющий общие методы, которые конкретные параметры плагина контейнера данных должны реализовать."
type: docs
weight: 20
url: /ru/java/com.aspose.page.plugins/idatacontainer/
---```
