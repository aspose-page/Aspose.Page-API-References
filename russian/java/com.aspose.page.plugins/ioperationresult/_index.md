...
description: "Общий интерфейс результата операции, определяющий общие методы, которые должен реализовать конкретный результат операции плагина."
type: docs
weight: 22
url: /ru/java/com.aspose.page.plugins/ioperationresult/
---```
