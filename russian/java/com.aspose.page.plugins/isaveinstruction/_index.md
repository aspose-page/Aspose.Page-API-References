...
description: "Общий интерфейс инструкции сохранения, определяющий общие члены, которые должна реализовать конкретная опция плагина."
type: docs
weight: 25
url: /ru/java/com.aspose.page.plugins/isaveinstruction/
---```
