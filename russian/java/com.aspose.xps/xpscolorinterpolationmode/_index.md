...
description: "Допустимые значения свойства ColorInterpolationMode градиентных кистей."
type: docs
weight: 56
url: /ru/java/com.aspose.xps/xpscolorinterpolationmode/
---
**Inheritance:**
...
Допустимые значения свойства ColorInterpolationMode градиентных кистей.
## Поля

| Поле | Описание |
| --- | --- |
| [SRgbLinearInterpolation](#SRgbLinearInterpolation) | Режим SRgbLinearInterpolation. |
| [ScRgbLinearInterpolation](#ScRgbLinearInterpolation) | Режим ScRgbLinearInterpolation. |
## Методы
...
Режим ScRgbLinearInterpolation.
