...
description: "Допустимые значения для стилей шрифтов."
type: docs
weight: 60
url: /ru/java/com.aspose.xps/xpsfontstyle/
---
**Inheritance:**
...
Допустимые значения для стилей шрифтов.
## Поля

| Поле | Описание |
| --- | --- |
| [Bold](#Bold) | Жирный текст. |
| [BoldItalic](#BoldItalic) | Жирный курсивный текст. |
| [Italic](#Italic) | Курсивный текст. |
| [Regular](#Regular) | Обычный текст. |
## Методы
