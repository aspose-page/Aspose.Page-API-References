...
description: "Допустимые значения свойств StrokeStartLineCap и StrokeEndLineCap элементов Path."
type: docs
weight: 61
url: /ru/java/com.aspose.xps/xpslinecap/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [Flat](#Flat) | Плоский конец линии. |
| [Round](#Round) | Круглый конец линии. |
| [Square](#Square) | Квадратный конец линии. |
| [Triangle](#Triangle) | Треугольный конец линии. |
## Методы
