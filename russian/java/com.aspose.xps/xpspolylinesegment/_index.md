...
description: "Класс, инкапсулирующий свойства элемента PolyLineSegment."
type: docs
weight: 46
url: /ru/java/com.aspose.xps/xpspolylinesegment/
---
**Inheritance:**
...
Класс, инкапсулирующий свойства элемента PolyLineSegment. Этот элемент описывает многоугольное изображение, содержащее произвольное количество отдельных вершин.
## Методы

| Метод | Описание |
| --- | --- |
| [deepClone()](#deepClone--) | Клонирует этот полигон. |
