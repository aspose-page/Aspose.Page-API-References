...
description: "Параметры загрузки XPS‑документов."
type: docs
weight: 35
url: /ru/java/com.aspose.xps/xpsloadoptions/
---
**Inheritance:**
...
Параметры загрузки XPS‑документов.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [XpsLoadOptions()](#XpsLoadOptions--) | Создаёт новый экземпляр параметров. |
## Методы
