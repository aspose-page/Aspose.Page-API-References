...
description: "Перечисление, определяющее порядок операций с матрицей."
type: docs
weight: 10
url: /ru/java/com.aspose.xps/xpsmatrix.matrixorder/
---
**Inheritance:**
...
Перечисление, определяющее порядок операций с матрицей.
## Поля

| Поле | Описание |
| --- | --- |
| [Append](#Append) | Порядок добавления. |
| [Prepend](#Prepend) | Порядок вставки в начало. |
## Методы
