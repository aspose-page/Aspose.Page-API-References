...
description: "Класс, инкапсулирующий особенности свойства элемента ImageBrush."
type: docs
weight: 33
url: /ru/java/com.aspose.xps/xpsimagebrush/
---
**Inheritance:**
...
Класс, инкапсулирующий свойства элемента ImageBrush. Этот элемент используется для заполнения области изображением.
## Методы

| Метод | Описание |
| --- | --- |
| [deepClone()](#deepClone--) | Клонирует эту кисть изображения. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getImage()](#getImage--) | Возвращает ресурс изображения, используемый для кисти. |
| [getImageSource()](#getImageSource--) | Возвращает URI ресурса изображения. |
...
**Returns:**
java.lang.String - URI ресурса изображения.
