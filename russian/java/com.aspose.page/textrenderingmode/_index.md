...
description: "Это перечисление содержит возможные значения режима рендеринга текста."
type: docs
weight: 24
url: /ru/java/com.aspose.page/textrenderingmode/
---
**Inheritance:**
...
Это перечисление содержит возможные значения режима рендеринга текста.
## Поля

| Поле | Описание |
| --- | --- |
| [Fill](#Fill) | Заполнить текст. |
| [FillAndStroke](#FillAndStroke) | Заполнить и обвести текст. |
| [No](#No) | Ни заполнить, ни обвести текст. |
| [Stroke](#Stroke) | Обвести текст. |
## Методы
