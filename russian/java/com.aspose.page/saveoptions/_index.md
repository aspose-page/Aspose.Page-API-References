...
type: docs
weight: 16
url: /ru/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [SaveOptions()](#SaveOptions--) | Инициализировать новый экземпляр SaveOptions с значениями по умолчанию для флагов  suppressErrors  (true) и  debug  (false). |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | Инициализировать новый экземпляр SaveOptions с значением по умолчанию для флага  debug  (false). |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | Инициализирует новый экземпляр SaveOptions с указанным размером. |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | Инициализировать новый экземпляр SaveOptions с значением по умолчанию для флага  debug  (false) и с указанным размером. |
## Методы
...
Инициализировать новый экземпляр SaveOptions с значениями по умолчанию для флагов  suppressErrors  (true) и  debug  (false).
...
Инициализировать новый экземпляр SaveOptions с значением по умолчанию для флага  debug  (false).
...
Инициализирует новый экземпляр SaveOptions с указанным размером.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| размер | java.awt.Dimension | Размер. |
...
Инициализировать новый экземпляр SaveOptions с значением по умолчанию для флага  debug  (false) и с указанным размером.
