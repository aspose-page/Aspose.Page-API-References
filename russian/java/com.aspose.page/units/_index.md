...
description: "Это перечисление содержит возможные значения единиц измерения размеров."
type: docs
weight: 25
url: /ru/java/com.aspose.page/units/
---
**Inheritance:**
...
Это перечисление содержит возможные значения единиц измерения размеров.
## Поля
...
| [Percents](#Percents) | Проценты от существующего размера. |
| [Points](#Points) | Пункты (1/72 дюйма). |
## Методы
...
Проценты от существующего размера.
