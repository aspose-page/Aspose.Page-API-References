...
description: "Представляет параметры конвертера PS/EPS в PDF для  плагина."
type: docs
weight: 13
url: /ru/java/com.aspose.eps.plugins/psconvertertopdfoptions/
---
**Inheritance:**
...
Представляет параметры конвертера PS/EPS в PDF для плагина [PsConverter](../../com.aspose.eps.plugins/psconverter) plugin.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PsConverterToPdfOptions()](#PsConverterToPdfOptions--) | Инициализирует новый экземпляр объекта [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions). |
## Методы
...
Инициализирует новый экземпляр объекта [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions).
