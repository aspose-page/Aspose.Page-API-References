...
description: "Определяет общий интерфейс обработчика событий перед сохранением."
type: docs
weight: 13
url: /ru/java/com.aspose.xps.features.eventbasedmodifications/ibeforesavingeventhandler/
---```
