...
description: "Класс параметров сохранения XPS-as-PNG."
type: docs
weight: 15
url: /ru/java/com.aspose.xps.rendering/pngsaveoptions/
---
**Inheritance:**
...
Класс параметров сохранения XPS-as-PNG.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PngSaveOptions()](#PngSaveOptions--) | Создаёт новый экземпляр параметров. |
## Методы
