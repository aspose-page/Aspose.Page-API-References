...
description: "Класс параметров сохранения XPS-as-TIFF."
type: docs
weight: 16
url: /ru/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Класс параметров сохранения XPS-as-TIFF.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Создаёт новый экземпляр параметров. |
## Методы
...
| [multipage()](#multipage--) | Получает флаг, определяющий, следует ли сохранять несколько изображений в одном многостраничном файле TIFF. |
| [multipage(boolean value)](#multipage-boolean-) | Устанавливает флаг, определяющий, следует ли сохранять несколько изображений в одном многостраничном файле TIFF. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Получает флаг, определяющий, следует ли сохранять несколько изображений в одном многостраничном файле TIFF.

**Returns:**
boolean - Флаг, определяющий, следует ли сохранять несколько изображений в один многостраничный файл TIFF.
...
Устанавливает флаг, определяющий, следует ли сохранять несколько изображений в одном многостраничном файле TIFF.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Флаг, определяющий, следует ли сохранять несколько изображений в один многостраничный файл TIFF. |
