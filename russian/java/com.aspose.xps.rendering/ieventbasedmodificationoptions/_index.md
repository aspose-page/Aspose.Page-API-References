...
description: "Определяет параметры, относящиеся к обработке модификаций, основанных на событиях, во время сохранения документа."
type: docs
weight: 17
url: /ru/java/com.aspose.xps.rendering/ieventbasedmodificationoptions/
---```
