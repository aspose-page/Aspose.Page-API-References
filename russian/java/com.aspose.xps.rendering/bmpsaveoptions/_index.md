...
description: "Класс параметров сохранения XPS-as-BMP."
type: docs
weight: 10
url: /ru/java/com.aspose.xps.rendering/bmpsaveoptions/
---
**Inheritance:**
...
| --- | --- |
| [BmpSaveOptions()](#BmpSaveOptions--) | Создаёт новый экземпляр параметров. |
## Методы
