...
description: Aspose.Page.SaveOptions сорт. Этот класс содержит параметры необходимые для управления процессом преобразования.
type: docs
weight: 300
...
| Имя | Описание |
| --- | --- |
| [SaveOptions](saveoptions/#constructor)() | Инициализирует новый экземпляр`SaveOptions` класс со значениями по умолчанию для флагов!:SuppressErrors (правда) и[`Debug`](./debug/) (ложь). |
| [SaveOptions](saveoptions/#constructor_1)(bool) | Инициализирует новый экземпляр`SaveOptions` класс со значением по умолчанию для флага[`Debug`](./debug/) (ложь). |
