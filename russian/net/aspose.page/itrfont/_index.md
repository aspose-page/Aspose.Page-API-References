...
Этот интерфейс предоставляет доступ к основным параметрам шрифта.
...
| [DeriveFont](../../aspose.page/itrfont/derivefont#derivefont_2)(Matrix) | f символ Создает эквивалент этого шрифта с новым преобразованием. |
