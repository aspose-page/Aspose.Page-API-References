...
description: Aspose.Page.XPS.Presentation.Image.BmpSaveOptions сорт. Класс для параметров сохранения XPSasBMP.
type: docs
weight: 340
...
Класс для параметров сохранения XPS-as-BMP.
...
| Имя | Описание |
| --- | --- |
| [BmpSaveOptions](bmpsaveoptions/)() | Создает новый экземпляр options. |
