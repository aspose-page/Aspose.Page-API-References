...
description: Класс для опций сохранения XPS-as-JPEG.
type: docs
weight: 290
...
Класс для опций сохранения XPS-as-JPEG.
...
| Имя | Описание |
| --- | --- |
| [JpegSaveOptions](jpegsaveoptions)() | Создает новый экземпляр параметров. |
