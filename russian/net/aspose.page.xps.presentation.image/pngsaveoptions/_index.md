...
description: Класс для параметров сохранения XPS-as-PNG.
type: docs
weight: 300
...
Класс для параметров сохранения XPS-as-PNG.
...
| Имя | Описание |
| --- | --- |
| [PngSaveOptions](pngsaveoptions)() | Создает новый экземпляр параметров. |
