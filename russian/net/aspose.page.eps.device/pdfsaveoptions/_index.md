...
description: Aspose.Page.EPS.Device.PdfSaveOptions сорт. Этот класс содержит входные и выходные потоки и другие параметры необходимые для управления процессом преобразования.
type: docs
weight: 70
...
| Имя | Описание |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/#constructor)() | Инициализирует новый экземпляр`PdfSaveOptions` класс со значениями по умолчанию для флагов!:SuppressErrors (правда) и!:Debug (ложь). |
| [PdfSaveOptions](pdfsaveoptions/#constructor_1)(bool) | Инициализирует новый экземпляр`PdfSaveOptions` класс со значениями по умолчанию для флага!:Debug (ложь). |
