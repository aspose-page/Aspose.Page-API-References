...
description: Aspose.Page.EPS.Device.ImageDevice сорт. Этот класс инкапсулирует рендеринг документа в изображение.
type: docs
weight: 40
...
| Имя | Описание |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)() | Инициализирует новый экземпляр`ImageDevice` . |
| [ImageDevice](imagedevice/#constructor_1)(ImageFormat) | Инициализирует новый экземпляр`ImageDevice` с указанным форматом изображения. |
| [ImageDevice](imagedevice/#constructor_2)(Size) | Инициализирует новый экземпляр`ImageDevice` с указанным размером страницы. |
| [ImageDevice](imagedevice/#constructor_3)(Size, ImageFormat) | Инициализирует новый экземпляр`ImageDevice` с указанным размером страницы и форматом изображения. |
