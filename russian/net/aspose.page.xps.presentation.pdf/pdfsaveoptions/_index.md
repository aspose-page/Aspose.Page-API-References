...
description: Класс для параметров сохранения XPSasPDF.
type: docs
weight: 380
...
| [OutlineTreeHeight](../../aspose.page.xps.presentation.pdf/pdfsaveoptions/outlinetreeheight) { get; set; } | Определяет высоту дерева структуры документа для сохранения. 0 - дерево структуры не будет преобразовано, 1 - будут преобразованы только элементы структуры первого уровня, и т.д.. |
