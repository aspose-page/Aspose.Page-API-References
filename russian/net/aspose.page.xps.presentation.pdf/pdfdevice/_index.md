...
| override [OpacityMask](../../aspose.page.xps.presentation.pdf/pdfdevice/opacitymask) { get; set; } | Получает/устанавливает кисть для непрозрачной маски. Маска применяется поверх Paint или Strike. |
| override [Paint](../../aspose.page.xps.presentation.pdf/pdfdevice/paint) { get; set; } | Получает/устанавливает кисть для заполнения контуров. |
...
| override [Stroke](../../aspose.page.xps.presentation.pdf/pdfdevice/stroke) { get; set; } | Получает/устанавливает обводку для контуров рисования. |
...
| virtual [AddOutline](../../aspose.page.xps.presentation.pdf/pdfdevice/addoutline#addoutline_1)(PointF, int, string) | Добавляет элемент контура с исходной точкой в качестве цели. |
| virtual [ClosePage](../../aspose.page.xps.presentation.pdf/pdfdevice/closepage)() | Завершает страницу. |
| virtual [ClosePartition](../../aspose.page.xps.presentation.pdf/pdfdevice/closepartition)() | Выполнен раздел документов. |
| override [Create](../../aspose.page.xps.presentation.pdf/pdfdevice/create)() | Создает новый экземпляр устройства на основе этого экземпляра устройства. Записывает графическое состояние этого устройства, т.е. создаетApsCanvasэкземпляр(ы) с соответствующими свойствами RenderTransform и Clip. |
| override [Dispose](../../aspose.page.xps.presentation.pdf/pdfdevice/dispose)() | Удаляет этот экземпляр устройства. Завершает графическое состояние этого экземпляра устройства, т.е. переключает контекст компоновки APS наApsCanvasуровня выше, чем у этого устройства состояние графикиApsCanvas. |
...
| override [Scale](../../aspose.page.xps.presentation.pdf/pdfdevice/scale)(double, double) | Применяет указанный вектор масштаба к текущей матрице преобразования. |
...
| override [SetTransform](../../aspose.page.xps.presentation.pdf/pdfdevice/settransform)(Matrix) | Устанавливает текущую матрицу преобразования. |
...
| override [Transform](../../aspose.page.xps.presentation.pdf/pdfdevice/transform)(Matrix) | Умножает текущую матрицу преобразования на указаннуюMatrix. |
