...
| Имя | Описание |
| --- | --- |
| [JobAccountingSheet](jobaccountingsheet/)(params JobAccountingSheetOption[]) | Создает новый экземпляр. |
...
| Имя | Описание |
| --- | --- |
| class [JobAccountingSheetOption](jobaccountingsheet.jobaccountingsheetoption/) | Описывает`JobAccountingSheet` параметры функции. |
