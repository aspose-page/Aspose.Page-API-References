...
Описывает характеристики сшивания вывода. Все документы в задании скреплены вместе. `JobStapleAllDocuments` и[`DocumentStaple`](../documentstaple/) ключевые слова являются взаимоисключающими. Драйвер должен определить обработку ограничений между этими ключевыми словами. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
...
| Имя | Описание |
| --- | --- |
| [JobStapleAllDocuments](jobstaplealldocuments/)(params StapleOption[]) | Создает новый экземпляр. |
