...
| Имя | Описание |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | Описывает`PageDestinationColorProfile` параметры функции. |
