...
Описывает цель рендеринга в соответствии со спецификацией ICC v2. Это значение следует игнорировать, если изображение или графический элемент имеет встроенный профиль , указывающий цель рендеринга. https://docs.microsoft.com/en-us/ windows/win32/printdocs/pageicmrenderingintent
...
| Имя | Описание |
| --- | --- |
| [PageICMRenderingIntent](pageicmrenderingintent/)(params PageICMRenderingIntentOption[]) | Создает новый экземпляр. |
...
| Имя | Описание |
| --- | --- |
| class [PageICMRenderingIntentOption](pageicmrenderingintent.pageicmrenderingintentoption/) | Описывает`PageICMRenderingIntent` параметры функции. |
