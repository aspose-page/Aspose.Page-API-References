...
| Имя | Описание |
| --- | --- |
| [PresentationDirection](presentationdirection/)(params PresentationDirectionOption[]) | Создает новый экземпляр. |
...
| Имя | Описание |
| --- | --- |
| class [PresentationDirectionOption](nup.presentationdirection.presentationdirectionoption/) | Описывает`PresentationDirection` параметры функции. |
