...
| Имя | Описание |
| --- | --- |
| class [PresentationDirectionOption](nup.presentationdirection.presentationdirectionoption) | Описывает[`PresentationDirection`](../nup.presentationdirection) параметры функции. |
