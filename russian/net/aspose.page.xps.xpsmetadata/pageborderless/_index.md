...
description: Описывает когда содержимое изображения должно быть напечатано до физических краев носителя. https//docs.microsoft.com/enus/windows/win32/printdocs/pageborderless
type: docs
weight: 1770
...
| Имя | Описание |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption) | Описывает[`PageBorderless`](../pageborderless) параметры функции. |
