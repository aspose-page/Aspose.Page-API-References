...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation сорт. Описывает ориентацию листа физического носителя. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
url: /ru/net/aspose.page.xps.xpsmetadata/pageorientation/
---
## PageOrientation class

Описывает ориентацию листа физического носителя. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| Имя | Описание |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | Создает новый экземпляр. |
...
| Имя | Описание |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | Описывает`PageOrientation` параметры функции. |
