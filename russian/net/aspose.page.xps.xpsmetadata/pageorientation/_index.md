...
description: Описывает ориентацию листа физического носителя. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2240
...
| Имя | Описание |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption) | Описывает[`PageOrientation`](../pageorientation) параметры функции. |
