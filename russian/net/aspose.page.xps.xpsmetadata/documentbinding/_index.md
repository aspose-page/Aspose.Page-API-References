...
description: Описывает метод привязки. Каждый документ связан отдельно. DocumentBinding и JobBindAllDocuments являются взаимоисключающими. Драйвер должен определить обработку ограничений между ключевыми словами. https//docs.microsoft.com/enus/windows/win32/printdocs/documentbinding
type: docs
weight: 500
...
| class [BindingOption](documentbinding.bindingoption) | Представляет параметры[`DocumentBinding`](../documentbinding) особенность. |
