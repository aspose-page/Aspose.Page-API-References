...
description: Описывает метод привязки. Все документы в задании связаны вместе. JobBindAllDocuments./jobbindalldocuments а такжеDocumentBinding./documentbinding являются взаимоисключающими. Драйвер должен определить обработку ограничений между этими ключевыми словами. https//docs.microsoft.com/enus/windows/win32/printdocs/jobbindalldocuments
type: docs
weight: 1090
...
Описывает метод привязки. Все документы в задании связаны вместе. [`JobBindAllDocuments`](../jobbindalldocuments) а также[`DocumentBinding`](../documentbinding) являются взаимоисключающими. Драйвер должен определить обработку ограничений между этими ключевыми словами. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
...
| class [BindingOption](jobbindalldocuments.bindingoption) | Описывает[`JobBindAllDocuments`](../jobbindalldocuments) параметры функции. |
