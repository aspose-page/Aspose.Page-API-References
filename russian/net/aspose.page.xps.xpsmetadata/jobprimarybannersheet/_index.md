...
| Имя | Описание |
| --- | --- |
| class [BannerSheetOption](jobprimarybannersheet.bannersheetoption/) | Представляет параметры`JobPrimaryBannerSheet` особенность. |
