...
description: Абстрактный класс для функции печати билета на уровне задания.
type: docs
weight: 550
url: /ru/net/aspose.page.xps.xpsmetadata/jobfeature/
---
## JobFeature class

Абстрактный класс для функции печати билета на уровне задания.
