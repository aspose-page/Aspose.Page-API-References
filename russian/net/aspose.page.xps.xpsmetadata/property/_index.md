...
description: Aspose.Page.XPS.XpsMetadata.Property сорт. Класс реализующий общий PrintTicket . Базовый класс для всех свойств определенных схемой. A элемент объявляет устройство форматирование задания или другое соответствующее свойство  имя которого задается его атрибутом имени. АValue элемент используется для присвоения значения. А может быть сложным возможно содержать несколько подсвойств. Подсвойства также представлены элементы. https//docs.microsoft.com/enus/windows/win32/printdocs/property
type: docs
weight: 2820
