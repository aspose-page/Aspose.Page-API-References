...
description: Property строитель. Создает новый экземпляр.
type: docs
weight: 10
...
| property | Property | Обязательный[`Property`](../) пример. |
| items | IPropertyItem[] | Произвольный массив[`IPropertyItem`](../../ipropertyitem/)instances. Каждый должен быть[`Property`](../) или[`Value`](../../value/) пример. |
