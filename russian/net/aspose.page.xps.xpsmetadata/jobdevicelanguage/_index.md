...
| class [JobDeviceLanguageOption](jobdevicelanguage.jobdevicelanguageoption) | Описывает[`JobDeviceLanguage`](../jobdevicelanguage) параметры функции. |
