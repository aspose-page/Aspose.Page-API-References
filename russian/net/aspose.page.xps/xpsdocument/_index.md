...
description: Класс инкапсулирующий основной объект XPS-документа обеспечивающий манипулирование методами для любого элемента XPS.
type: docs
weight: 390
...
Класс, инкапсулирующий основной объект XPS-документа, обеспечивающий манипулирование методами для любого элемента XPS.
...
| [XpsDocument](xpsdocument#constructor_2)(string) | Открывает существующий документ XPS, расположенный по адресу*path*. |
...
| [XpsDocument](xpsdocument#constructor_3)(string, LoadOptions) | Открывает существующий документ, расположенный по адресу*path*как документ XPS. |
...
| [JobPrintTicket](../../aspose.page.xps/xpsdocument/jobprintticket) { get; set; } | Возвращает/устанавливает билет задания печати документа |
| [Page](../../aspose.page.xps/xpsdocument/page) { get; } | Возвращает экземпляр[`XpsPage`](../../aspose.page.xps.xpsmodel/xpspage)для активной страницы. |
...
| [AddDocument](../../aspose.page.xps/xpsdocument/adddocument#adddocument_1)(float, float, bool) | Добавляет пустой документ с размерами первой страницы *ширина*и*высота*. |
...
| [AddPage](../../aspose.page.xps/xpsdocument/addpage#addpage_2)(float, float, bool) | Добавляет в документ пустую страницу с указанными *width*и*height*. |
...
| [CreateFont](../../aspose.page.xps/xpsdocument/createfont#createfont)(Stream) | Создает новый ресурс шрифта TrueType вне потока. |
...
| [CreateIccProfile](../../aspose.page.xps/xpsdocument/createiccprofile#createiccprofile_1)(string) | Создает новый ресурс профиля ICC из файла профиля ICC, расположенного по адресу *iccProfilePath*. |
...
| [CreateLinearGradientBrush](../../aspose.page.xps/xpsdocument/createlineargradientbrush#createlineargradientbrush_1)(PointF, PointF) | Создает новую кисть с линейным градиентом. |
| [CreateLinearGradientBrush](../../aspose.page.xps/xpsdocument/createlineargradientbrush#createlineargradientbrush)(List&lt;XpsGradientStop&gt;, PointF, PointF) | Создает новую кисть с линейным градиентом. |
...
| [CreatePolyQuadraticBezierSegment](../../aspose.page.xps/xpsdocument/createpolyquadraticbeziersegment)(PointF[], bool) | Создает новый набор квадратичных кривых Безье из предыдущей точки на фигуре пути через набор вершин, используя указанные контрольные точки. |
| [CreateRadialGradientBrush](../../aspose.page.xps/xpsdocument/createradialgradientbrush#createradialgradientbrush_1)(PointF, PointF, float, float) | Создает новую кисть с радиальным градиентом. |
| [CreateRadialGradientBrush](../../aspose.page.xps/xpsdocument/createradialgradientbrush#createradialgradientbrush)(List&lt;XpsGradientStop&gt;, PointF, PointF, float, float) | Создает новую кисть с радиальным градиентом. |
...
| [GetPagePrintTicket](../../aspose.page.xps/xpsdocument/getpageprintticket)(int, int) | Возвращает билет печати страницы, проиндексированной*pageIndex* в документе, проиндексированном*индексдокумента*. |
| [Insert&lt;T&gt;](../../aspose.page.xps/xpsdocument/insert)(int, T) | Вставляет элемент (холст, контур или глифы) на активную страницу в позиции*index*. |
| [InsertCanvas](../../aspose.page.xps/xpsdocument/insertcanvas)(int) | Вставляет новый холст на активную страницу в позиции*index*. |
| [InsertDocument](../../aspose.page.xps/xpsdocument/insertdocument#insertdocument)(int, bool) | Вставляет пустой документ с размером страницы по умолчанию в позицию*index*. |
| [InsertDocument](../../aspose.page.xps/xpsdocument/insertdocument#insertdocument_1)(int, float, float, bool) | Вставляет пустой документ с размерами первой страницы *ширина*и*высота*at*index*position. |
| [InsertGlyphs](../../aspose.page.xps/xpsdocument/insertglyphs#insertglyphs)(int, XpsFont, float, float, float, string) | Вставляет новые глифы на активную страницу в позиции*index*. |
| [InsertGlyphs](../../aspose.page.xps/xpsdocument/insertglyphs#insertglyphs_1)(int, string, float, FontStyle, float, float, string) | Вставляет новые глифы на активную страницу в позиции*index*. |
| [InsertPage](../../aspose.page.xps/xpsdocument/insertpage#insertpage_1)(int, bool) | Вставляет в документ пустую страницу с размером страницы по умолчанию в позиции*index*. |
| [InsertPage](../../aspose.page.xps/xpsdocument/insertpage#insertpage)(int, XpsPage, bool) | Вставляет страницу в документ в позиции*index*. |
| [InsertPage](../../aspose.page.xps/xpsdocument/insertpage#insertpage_2)(int, float, float, bool) | Вставляет в документ пустую страницу с указанным *width*и*height*at*index*position. |
| [InsertPath](../../aspose.page.xps/xpsdocument/insertpath)(int, XpsPathGeometry) | Вставляет новый путь к активной странице в позиции*index*. |
| [Merge](../../aspose.page.xps/xpsdocument/merge#merge_1)(string[], Stream) | Объединение нескольких файлов XPS в один документ XPS. |
| [Merge](../../aspose.page.xps/xpsdocument/merge#merge)(string[], Device, SaveOptions) | Объединение документов XPS в PDF с использованием экземпляра[`Device`](../../aspose.page/device). |
| [Remove&lt;T&gt;](../../aspose.page.xps/xpsdocument/remove)(T) | Удаляет элемент с активной страницы. |
| [RemoveAt](../../aspose.page.xps/xpsdocument/removeat)(int) | Удаляет элемент в позиции*index*с активной страницы. |
| [RemoveDocumentAt](../../aspose.page.xps/xpsdocument/removedocumentat)(int) | Удаляет документ в позиции*index*. |
| [RemovePage](../../aspose.page.xps/xpsdocument/removepage)(XpsPage) | Удаляет страницу из документа. |
| [RemovePageAt](../../aspose.page.xps/xpsdocument/removepageat)(int) | Удаляет страницу из документа в позиции*index*. |
...
| override [Save](../../aspose.page.xps/xpsdocument/save#save)(Device, SaveOptions) | Сохраняет документ, используя экземпляр[`Device`](../../aspose.page/device). |
...
| [SetDocumentPrintTicket](../../aspose.page.xps/xpsdocument/setdocumentprintticket)(int, DocumentPrintTicket) | Связывает*printTicket*с документом, проиндексированным*documentIndex*. |
| [SetPagePrintTicket](../../aspose.page.xps/xpsdocument/setpageprintticket)(int, int, PagePrintTicket) | Связывает*printTicket*со страницей, проиндексированной*pageIndex* в документе индексируется*documentIndex*. |
