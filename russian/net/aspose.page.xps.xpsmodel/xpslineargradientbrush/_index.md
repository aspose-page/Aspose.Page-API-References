...
description: Класс инкапсулирующий функции элемента свойства LinearGradientBrush. Этот элемент используется для указания кисти с линейным градиентом вдоль вектора.
type: docs
weight: 1100
...
| [EndPoint](../../aspose.page.xps.xpsmodel/xpslineargradientbrush/endpoint) { get; set; } | Возвращает/устанавливает конечную точку линейного градиента. |
