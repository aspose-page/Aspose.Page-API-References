...
description: Aspose.Page.XPS.XpsModel.XpsImageBrush сорт. Класс инкапсулирующий функции элемента свойства ImageBrush. Этот элемент используется для заполнения области изображением.
type: docs
weight: 3180
url: /ru/net/aspose.page.xps.xpsmodel/xpsimagebrush/
---
## XpsImageBrush class

Класс, инкапсулирующий функции элемента свойства ImageBrush. Этот элемент используется для заполнения области изображением.
...
| Имя | Описание |
| --- | --- |
| [Image](../../aspose.page.xps.xpsmodel/xpsimagebrush/image/) { get; } | Возвращает ресурс изображения, использованный для кисти. |
| [ImageSource](../../aspose.page.xps.xpsmodel/xpsimagebrush/imagesource/) { get; } | Возвращает URI ресурса изображения. |
...
| Имя | Описание |
| --- | --- |
| [Clone](../../aspose.page.xps.xpsmodel/xpsimagebrush/clone/)() | Клонирует эту кисть изображения. |
