...
| --- | --- |
| [WdpNet20NotSupportedException](./wdpnet20notsupportedexception/) | Исключение, возникающее всякий раз, когда документ XPS, содержащий изображения WDP, преобразуется в версию библиотеки для .NET 2.0. |
