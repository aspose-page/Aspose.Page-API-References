---
title: "Конструктор System::Diagnostics::PerformanceCounter::PerformanceCounter"
linktitle: "PerformanceCounter"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Diagnostics::PerformanceCounter::PerformanceCounter. Создаёт счётчик производительности в C++."
type: docs
weight: 100
url: /ru/cpp/system.diagnostics/performancecounter/performancecounter/
---
## PerformanceCounter::PerformanceCounter() constructor


Создаёт счётчик производительности.
...
Создаёт счётчик производительности для конкретной категории.
...
Создаёт счётчик производительности для конкретной категории и имени экземпляра.
