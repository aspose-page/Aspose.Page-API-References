...
| virtual [GetFrame](./getframe/)(uint32_t) | Получает стековый кадр. |
...
| [StackTrace](./stacktrace/)(const StackTrace\&) | Копирование запрещено. |
