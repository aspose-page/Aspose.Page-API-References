...
description: "System::Xml::XPath::XPathItem::get_IsNode method. При переопределении в производном классе получает значение, указывающее, представляет ли элемент узел XPath или атомарное значение в C++."
type: docs
weight: 100
url: /ru/cpp/system.xml.xpath/xpathitem/get_isnode/
---
