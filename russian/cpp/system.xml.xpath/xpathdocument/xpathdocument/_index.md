---
title: "Конструктор System::Xml::XPath::XPathDocument::XPathDocument"
linktitle: "XPathDocument"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Xml::XPath::XPathDocument::XPathDocument. Инициализирует новый экземпляр класса XPathDocument из XML-данных в указанном объекте Stream в C++."
type: docs
weight: 100
url: /ru/cpp/system.xml.xpath/xpathdocument/xpathdocument/
---
...
| --- | --- | --- |
| поток | const SharedPtr\<IO::Stream\>\& | Объект Stream, содержащий XML-данные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| textReader | const SharedPtr\<IO::TextReader\>\& | Объект TextReader, содержащий XML-данные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | Объект [XmlReader](../../../system.xml/xmlreader/), содержащий XML-данные. |
...
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | Объект [XmlReader](../../../system.xml/xmlreader/), содержащий XML-данные. |
| space | XmlSpace | Объект [XmlSpace](../../../system.xml/xmlspace/). |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| uri | const String\& | Путь к файлу, содержащему XML-данные. |
