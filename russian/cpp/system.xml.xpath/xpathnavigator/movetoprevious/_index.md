...
description: "System::Xml::XPath::XPathNavigator::MoveToPrevious method. Когда переопределяется в производном классе, перемещает XPathNavigator к предыдущему узлу‑сиблинг текущего узла в C++."
type: docs
weight: 6400
url: /ru/cpp/system.xml.xpath/xpathnavigator/movetoprevious/
---
## XPathNavigator::MoveToPrevious method


Когда переопределяется в производном классе, перемещает [XPathNavigator](../) к предыдущему узлу‑сиблинг текущего узла.
