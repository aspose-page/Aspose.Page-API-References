...
| --- | --- | --- |
| namespaceURI | const String\& | URI пространства имён для разрешения префикса. |

### ReturnValue

Объект [String](../../../system/string/), содержащий префикс пространства имён, назначенный указанному URI пространства имён; в противном случае [String::Empty](../../../system/string/empty/), если префикс не назначен. Возвращённый [String](../../../system/string/) атомизирован.
