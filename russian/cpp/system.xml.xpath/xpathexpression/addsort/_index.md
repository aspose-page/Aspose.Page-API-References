---
title: "System::Xml::XPath::XPathExpression::AddSort метод"
linktitle: "AddSort"
second_title: "Aspose.Page для C++"
description: "System::Xml::XPath::XPathExpression::AddSort метод. Когда переопределяется в производном классе, сортирует узлы, выбранные выражением XPath, в соответствии с указанным объектом IComparer в C++."
type: docs
weight: 100
...
Когда переопределяется в производном классе, сортирует узлы, выбранные выражением [XPath](../../), в соответствии с указанным объектом IComparer.
...
| сравнитель | SharedPtr\<Collections::Generic::IComparer\<SharedPtr\<Object\>\>\> | Объект IComparer, предоставляющий сравнения конкретных типов данных для сравнения двух объектов на эквивалентность. |
...
Когда переопределяется в производном классе, сортирует узлы, выбранные выражением [XPath](../../), в соответствии с переданными параметрами.
