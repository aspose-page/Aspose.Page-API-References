---
title: "System::ComponentModel::TypeConverter::ConvertFromInvariantString метод"
linktitle: "ConvertFromInvariantString"
second_title: "Aspose.Page для C++"
description: "System::ComponentModel::TypeConverter::ConvertFromInvariantString метод. Преобразует инвариантную строку в объект в C++."
type: docs
weight: 300
url: /ru/cpp/system.componentmodel/typeconverter/convertfrominvariantstring/
---
## TypeConverter::ConvertFromInvariantString(const System::SharedPtr\<ITypeDescriptorContext\>\&, const System::String\&) method


Преобразует инвариантную строку в объект.
...
| text | const System::String\& | Значение для преобразования. |
