...
| Метод | Описание |
| --- | --- |
| static [GetConverter](./getconverter/)(const TypeInfo\&) | Информация RTTI. |
## См. также
