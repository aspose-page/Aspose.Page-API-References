---
title: "конструктор System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName"
linktitle: "X500DistinguishedName"
second_title: "Aspose.Page для C++"
description: "конструктор System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName. Конструктор в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography.x509certificates/x500distinguishedname/x500distinguishedname/
---
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Закодированное отличительное имя. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) представляющий отличительное имя. |
## Примечания
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Отличительное имя, из которого копировать данные. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| distinguished_name | const String\& | Отличительное имя. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Отличительное имя. |
| flags | X500DistinguishedNameFlags | Битово‑комбинированные флаги, определяющие свойства построения имени. |
