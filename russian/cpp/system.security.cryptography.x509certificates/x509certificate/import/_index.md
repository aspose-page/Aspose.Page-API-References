---
title: "System::Security::Cryptography::X509Certificates::X509Certificate::Import метод"
linktitle: "Import"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate::Import метод. Импортирует информацию из указанных данных сертификата. НЕ РЕАЛИЗОВАНО в C++."
type: docs
weight: 2500
url: /ru/cpp/system.security.cryptography.x509certificates/x509certificate/import/
---
## X509Certificate::Import(const ByteArrayPtr\&) method


Импортирует информацию из указанных данных сертификата. НЕ РЕАЛИЗОВАНО.
...
| --- | --- | --- |
| данные | const ByteArrayPtr\& | Имя файла сертификата. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| данные | const ByteArrayPtr\& | Данные сертификата X.509. |
| password | const SecureStringPtr\& | Пароль, необходимый для доступа к данным сертификата. |
...
| --- | --- | --- |
| данные | const ByteArrayPtr\& | Имя файла сертификата. |
| password | const String\& | Пароль, необходимый для доступа к данным сертификата. |
| key_storage_flags | X509KeyStorageFlags |  |
...
Импортирует информацию из указанного файла сертификата. НЕ РЕАЛИЗОВАНО.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| filename | const String\& | Имя файла сертификата. |
