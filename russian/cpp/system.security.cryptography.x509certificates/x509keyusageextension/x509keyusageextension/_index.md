---
title: "System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::X509KeyUsageExtension конструктор"
linktitle: "X509KeyUsageExtension"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::X509KeyUsageExtension конструктор. Информация RTTI в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography.x509certificates/x509keyusageextension/x509keyusageextension/
---
...
| --- | --- | --- |
| encoded_key_usage | const SharedPtr\<AsnEncodedData\>\& | Закодированные данные назначений ключа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| key_usages | X509KeyUsageFlags | Назначения ключа. |
| критический | bool | Признак критичности. |
