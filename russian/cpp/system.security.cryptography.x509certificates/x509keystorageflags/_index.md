...
| UserKeySet | 1 | Использовать хранилище, связанное с пользователем, вместо локального для машины. |
| MachineKeySet | 2 | Используйте хранилище локального компьютера вместо пользовательского. |
| Экспортируемый | 4 | Помечает импортированные ключи как экспортируемые. |
