---
title: "System::Web::Services::WebServiceBindingAttribute::WebServiceBindingAttribute конструктор"
linktitle: "WebServiceBindingAttribute"
second_title: "Aspose.Page для C++"
description: "System::Web::Services::WebServiceBindingAttribute::WebServiceBindingAttribute конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.web.services/webservicebindingattribute/webservicebindingattribute/
---
...
| --- | --- | --- |
| name | String | Имя привязки. |
| ns | String | Пространство имён, связанное с привязкой. |
...
| name | String | Имя привязки. |
| ns | String | Пространство имён, связанное с привязкой. |
| location | String | Местоположение, где определена привязка. |
