...
| [IFormatterConverter](./iformatterconverter/) | Обеспечивает связь между экземпляром [System::Runtime::Serialization::SerializationInfo](./serializationinfo/) и классом, предоставляемым форматтером, который лучше всего подходит для разбора данных внутри [System::Runtime::Serialization::SerializationInfo](./serializationinfo/). |
...
| [StreamingContext](./streamingcontext/) | Фиктивный класс, позволяющий скомпилировать переведённые классы, использующие StreamingContext. Не управляйте экземплярами этого класса с помощью [SmartPtr](../system/smartptr/), они должны создаваться только в стеке. |
