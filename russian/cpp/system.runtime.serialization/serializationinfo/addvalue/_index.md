---
title: "Метод System::Runtime::Serialization::SerializationInfo::AddValue"
linktitle: "AddValue"
second_title: "Aspose.Page для C++"
description: "Метод System::Runtime::Serialization::SerializationInfo::AddValue. Помещает булево значение. Не реализовано в C++."
type: docs
weight: 200
url: /ru/cpp/system.runtime.serialization/serializationinfo/addvalue/
---
## SerializationInfo::AddValue(const System::String\&, bool) method


Записывает логическое значение. Не реализовано.
...
| --- | --- | --- |
| name | const System::String\& | Имя значения. |
| value | bool | Значение для помещения. |
...
Записывает значение объекта. Не реализовано.
...
| --- | --- | --- |
| name | const System::String\& | Имя значения. |
| value | const System::SharedPtr\<System::Object\>\& | Значение для помещения. |
...
Записывает значение объекта с указанным типом. Не реализовано.
...
| name | const System::String\& | Имя значения. |
| value | const System::SharedPtr\<System::Object\>\& | Значение для помещения. |
| тип | const System::TypeInfo\& | Тип значения для помещения. |
...
Записывает значение типа float. Не реализовано.
...
| --- | --- | --- |
| name | const System::String\& | Имя значения. |
| value | float | Значение для помещения. |
...
Записывает значение типа short. Не реализовано.
...
| --- | --- | --- |
| name | const System::String\& | Имя значения. |
| value | short | Значение для помещения. |
