---
title: "System::Net::Http::HttpRequestMessage::HttpRequestMessage конструктор"
linktitle: "HttpRequestMessage"
second_title: "Aspose.Page для C++"
description: "System::Net::Http::HttpRequestMessage::HttpRequestMessage конструктор. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http/httprequestmessage/httprequestmessage/
---
...
| --- | --- | --- |
| метод | System::SharedPtr\<HttpMethod\> | HTTP‑метод. |
| requestUri | String | URI запрашиваемого ресурса. |
...
| --- | --- | --- |
| метод | System::SharedPtr\<HttpMethod\> | HTTP‑метод. |
| requestUri | System::SharedPtr\<Uri\> | URI запрашиваемого ресурса. |
