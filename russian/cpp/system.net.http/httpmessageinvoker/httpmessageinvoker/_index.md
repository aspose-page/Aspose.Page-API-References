---
title: "Конструктор System::Net::Http::HttpMessageInvoker::HttpMessageInvoker"
linktitle: "HttpMessageInvoker"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Net::Http::HttpMessageInvoker::HttpMessageInvoker. Информация RTTI в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.http/httpmessageinvoker/httpmessageinvoker/
---
...
| --- | --- | --- |
| обработчик | System::SharedPtr\<HttpMessageHandler\> | Обработчик HTTP, используемый для отправки запросов. |
## Примечания
...
| --- | --- | --- |
| обработчик | System::SharedPtr\<HttpMessageHandler\> | Обработчик HTTP, используемый для отправки запросов. |
| disposeHandler | bool | Значение, указывающее, должен ли обработчик быть освобождён, когда освобождается этот экземпляр. |
