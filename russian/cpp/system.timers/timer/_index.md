...
| [set_AutoReset](./set_autoreset/)(bool) | Устанавливает таймер в режим автоматического сброса или выводит его из него. |
| [set_Enabled](./set_enabled/)(bool) | Запускает или останавливает таймер. Запуск таймера не перезапускает подсчёт времени, если таймер уже работает. |
| [set_Interval](./set_interval/)(double) | Устанавливает интервал таймера. |
| [Start](./start/)() | Запускает таймер. Не перезапускает подсчёт времени, если таймер уже работает. |
