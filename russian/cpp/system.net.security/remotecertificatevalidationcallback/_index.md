...
description: "System::Net::Security::RemoteCertificateValidationCallback typedef. Делегат пользователя, используемый для проверки удалённого SSL‑сертификата в C++."
type: docs
weight: 700
