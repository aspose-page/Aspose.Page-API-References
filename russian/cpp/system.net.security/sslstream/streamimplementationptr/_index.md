...
description: "System::Net::Security::SslStream::StreamImplementationPtr typedef. Тип указателя на реализацию в C++."
type: docs
weight: 4000
url: /ru/cpp/system.net.security/sslstream/streamimplementationptr/
---
## StreamImplementationPtr typedef


Тип указателя на реализацию.
