---
title: "Метод System::Text::StringBuilder::Append"
linktitle: "Добавить"
second_title: "Aspose.Page для C++"
description: "Метод System::Text::StringBuilder::Append. Добавляет символ в builder на C++."
type: docs
weight: 300
...
Добавляет массив символов в builder.
...
Добавляет срез массива символов в builder.
...
Добавляет содержимое builder в builder.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| builder | const SharedPtr\<StringBuilder\>\& | Builder, из которого добавлять содержимое. |
...
Добавляет строковое представление объекта в builder.
...
Добавляет срез строки в builder.
...
Добавляет значение с плавающей точкой в builder.
...
Добавляет целочисленное значение в builder.
...
Добавляет арифметическое значение в builder.
