---
title: "Метод System::Text::StringBuilder::AppendFormat"
linktitle: "AppendFormat"
second_title: "Aspose.Page для C++"
description: "Метод System::Text::StringBuilder::AppendFormat. Добавляет отформатированную строку в builder на C++."
type: docs
weight: 400
