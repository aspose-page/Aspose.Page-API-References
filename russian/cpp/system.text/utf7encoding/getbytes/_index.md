---
title: "System::Text::UTF7Encoding::GetBytes метод"
linktitle: "GetBytes"
second_title: "Aspose.Page для C++"
description: "System::Text::UTF7Encoding::GetBytes метод. Получить байты, полученные в результате кодирования буфера символов в C++."
type: docs
weight: 500
url: /ru/cpp/system.text/utf7encoding/getbytes/
---
...
| --- | --- | --- |
| chars | ArrayPtr\<char_t\> | Символы для кодирования. |
| индекс | int | Начало фрагмента символов. |
