...
| [And](./and/)(const BitArrayPtr\&) | Вычисляет побитовое 'and' между двумя BitSets. |
...
| [BitArray](./bitarray/)(int, bool) | Конструктор заполнения. |
...
| [Or](./or/)(const BitArrayPtr\&) | Вычисляет побитовое 'or' между двумя BitSets. |
...
| [SetAll](./setall/)(bool) | Устанавливает все элементы в определённое значение. |
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Формальная реализация механизма слабых шаблонных аргументов; неприменима к этому классу. |
...
| [Xor](./xor/)(const BitArrayPtr\&) | Вычисляет побитовое 'xor' между двумя BitSets. |
## Typedefs
