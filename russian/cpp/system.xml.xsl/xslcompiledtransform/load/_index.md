---
title: "System::Xml::Xsl::XslCompiledTransform::Load метод"
linktitle: "Загрузить"
second_title: "Aspose.Page для C++"
description: "System::Xml::Xsl::XslCompiledTransform::Load метод. Компилирует таблицу стилей, содержащуюся в объекте IXPathNavigable, в C++."
type: docs
weight: 300
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stylesheet | const SharedPtr\<XmlReader\>\& | [XmlReader](../../../system.xml/xmlreader/) содержащий таблицу стилей. |
...
Загружает и компилирует XSLT‑таблицу стилей, указанную в URI. [XmlResolver](../../../system.xml/xmlresolver/) разрешает любые элементы XSLT **import** или **include**, а настройки XSLT определяют разрешения для таблицы стилей.
...
| stylesheetUri | const String\& | URI таблицы стилей. |
| settings | const SharedPtr\<XsltSettings\>\& | Настройки [XsltSettings](../../xsltsettings/), применяемые к таблице стилей. Если значение **nullptr**, применяется настройка [XsltSettings::get_Default](../../xsltsettings/get_default/). |
| stylesheetResolver | const SharedPtr\<XmlResolver\>\& | [XmlResolver](../../../system.xml/xmlresolver/) используется для разрешения URI таблицы стилей и любых таблиц стилей, на которые ссылаются элементы XSLT **import** и **include**. |
