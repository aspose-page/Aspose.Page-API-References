...
description: "System::Xml::Xsl::XslCompiledTransform class. Преобразует XML‑данные с помощью XSLT‑таблицы стилей в C++."
type: docs
weight: 300
...
Преобразует XML‑данные с помощью XSLT‑таблицы стилей.
...
| Метод | Описание |
| --- | --- |
| [get_OutputSettings](./get_outputsettings/)() | Возвращает объект [XmlWriterSettings](../../system.xml/xmlwritersettings/), содержащий информацию о выводе, полученную из элемента **xsl:output** таблицы стилей. |
...
| [Load](./load/)(const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\&, SharedPtr\<XsltSettings\>, SharedPtr\<XmlResolver\>) | Компилирует XSLT‑таблицу стилей, содержащуюся в IXPathNavigable. [XmlResolver](../../system.xml/xmlresolver/) разрешает любые элементы XSLT **import** или **include**, а параметры XSLT определяют разрешения для таблицы стилей. |
...
| [Transform](./transform/)(const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<IO::TextWriter\>\&) | Выполняет преобразование, используя входной документ, указанный объектом IXPathNavigable, и выводит результаты в TextWriter. [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
| [Transform](./transform/)(const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<IO::Stream\>\&) | Выполняет преобразование, используя входной документ, указанный объектом IXPathNavigable, и выводит результаты в поток. [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
...
| [Transform](./transform/)(const SharedPtr\<XmlReader\>\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<IO::TextWriter\>\&) | Выполняет преобразование, используя входной документ, указанный объектом [XmlReader](../../system.xml/xmlreader/), и выводит результаты в TextWriter. [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
| [Transform](./transform/)(const SharedPtr\<XmlReader\>\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<IO::Stream\>\&) | Выполняет преобразование, используя входной документ, указанный объектом [XmlReader](../../system.xml/xmlreader/), и выводит результаты в поток. [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
...
| [Transform](./transform/)(const String\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<XmlWriter\>\&) | Выполняет преобразование, используя входной документ, указанный URI, и выводит результаты в [XmlWriter](../../system.xml/xmlwriter/). [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
...
| [Transform](./transform/)(const String\&, const SharedPtr\<XsltArgumentList\>\&, const SharedPtr\<IO::Stream\>\&) | Выполняет преобразование, используя входной документ, указанный URI, и выводит результаты в поток. [XsltArgumentList](../xsltargumentlist/) предоставляет дополнительные аргументы во время выполнения. |
