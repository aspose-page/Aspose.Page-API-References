---
title: "System::Xml::Xsl::IXsltContextVariable класс"
linktitle: "IXsltContextVariable"
second_title: "Aspose.Page для C++"
description: "System::Xml::Xsl::IXsltContextVariable класс. Предоставляет интерфейс к заданной переменной, определённой в таблице стилей во время выполнения в C++."
type: docs
weight: 200
...
| Метод | Описание |
| --- | --- |
| virtual [Evaluate](./evaluate/)(SharedPtr\<XsltContext\>) | Выполняет вычисление переменной во время выполнения и возвращает объект, представляющий значение переменной. |
...
| virtual [get_VariableType](./get_variabletype/)() | Возвращает XPathResultType, представляющий тип XML Path Language ([XPath](../../system.xml.xpath/)) переменной. |
## См. также
