...
description: "Метод System::Xml::Xsl::XsltContext::PreserveWhitespace. При переопределении в производном классе определяет, следует ли сохранять узлы пробельных символов или удалять их в данном контексте в C++."
type: docs
weight: 300
...
При переопределении в производном классе определяет, сохранять ли узлы пробельных символов или удалять их в данном контексте.
