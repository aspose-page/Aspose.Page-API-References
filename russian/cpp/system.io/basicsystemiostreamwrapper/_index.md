...
description: "System::IO::BasicSystemIOStreamWrapper класс. Представляет собой обёртку, похожую на std::iostream, использующую BasicSystemIOStreamBuf в качестве внутреннего буфера в C++."
type: docs
weight: 500
...
Представляет обёртку, похожую на std::iostream, использующую [BasicSystemIOStreamBuf](../basicsystemiostreambuf/) в качестве внутреннего буфера.
...
| [operator=](./operator=/)(BasicSystemIOStreamWrapper\&&) | Оператор перемещения присваивания. |
