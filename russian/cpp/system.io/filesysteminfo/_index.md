...
| Метод | Описание |
| --- | --- |
| virtual [Delete](./delete/)() | Удаляет сущность, представленную текущим объектом. |
| virtual [Finalize](./finalize/)() | Не делает ничего. |
