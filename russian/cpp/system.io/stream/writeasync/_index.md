---
title: "Метод System::IO::Stream::WriteAsync"
linktitle: "WriteAsync"
second_title: "Aspose.Page для C++"
description: "Метод System::IO::Stream::WriteAsync. Асинхронно записывает последовательность байтов в текущий поток, перемещает текущую позицию в этом потоке на количество записанных байтов и отслеживает запросы на отмену в C++."
type: docs
weight: 2700
