---
title: "System::IO::BasicSTDIStreamWrapper::BasicSTDIStreamWrapper конструктор"
linktitle: "BasicSTDIStreamWrapper"
second_title: "Aspose.Page для C++"
description: "System::IO::BasicSTDIStreamWrapper::BasicSTDIStreamWrapper конструктор. Конструктор копирования. Удалён в C++."
type: docs
weight: 100
url: /ru/cpp/system.io/basicstdistreamwrapper/basicstdistreamwrapper/
---
...
Создаёт новый экземпляр [BasicSTDIStreamWrapper](../).
...
| --- | --- | --- |
| str | std::basic_istream\<char_type, traits_type\>\& | Ссылка на поток |
