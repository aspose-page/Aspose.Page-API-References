---
title: "System::IO::BasicSystemIStreamWrapper класс"
linktitle: "BasicSystemIStreamWrapper"
second_title: "Aspose.Page для C++"
description: "System::IO::BasicSystemIStreamWrapper класс. Представляет собой обёртку, похожую на std::istream, которая использует BasicSystemIOStreamBuf в качестве внутреннего буфера в C++."
type: docs
weight: 600
...
Представляет собой обёртку, похожую на std::istream, которая использует [BasicSystemIOStreamBuf](../basicsystemiostreambuf/) в качестве внутреннего буфера.
...
| [operator=](./operator=/)(BasicSystemIStreamWrapper\&&) | Оператор перемещения присваивания. |
