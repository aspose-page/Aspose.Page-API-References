---
title: "System::IO::StreamWriter::Write метод"
linktitle: "Write"
second_title: "Aspose.Page для C++"
description: "System::IO::StreamWriter::Write метод. Записывает указанный символ в поток в C++."
type: docs
weight: 1000
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| буфер | const char_t * | C‑строка для записи |
