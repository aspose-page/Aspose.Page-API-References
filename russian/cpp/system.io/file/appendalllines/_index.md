...
description: "System::IO::File::AppendAllLines метод. Добавляет строки из указанной коллекции строк в указанный файл, используя заданную кодировку, записывая каждую строку в новой строке. Если указанный файл не существует, он будет создан. Файл закрывается после записи всех строк в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| путь | const String\& | Путь к файлу, к которому следует добавить строки |
