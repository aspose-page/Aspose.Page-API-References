...
description: "System::IO::BasicSystemOStreamWrapper класс. Представляет обёртку, похожую на std::ostream, которая использует BasicSystemIOStreamBuf в качестве внутреннего буфера в C++."
type: docs
weight: 700
...
| [operator=](./operator=/)(BasicSystemOStreamWrapper\&&) | Оператор перемещения присваивания. |
