...
description: "System::IO::Directory::GetFiles метод. Выполняет поиск файлов, соответствующих указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корневым которым является указанный каталог, в C++."
type: docs
weight: 1200
