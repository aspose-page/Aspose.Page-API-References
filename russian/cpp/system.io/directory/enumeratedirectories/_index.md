...
description: "System::IO::Directory::EnumerateDirectories метод. Выполняет поиск каталогов, соответствующих указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корневым которым является указанный каталог, в C++."
type: docs
weight: 300
