...
description: "System::IO::Directory::GetDirectories method. Выполняет поиск каталогов, соответствующих указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корнем которого является указанный каталог, в C++."
type: docs
weight: 1000
url: /ru/cpp/system.io/directory/getdirectories/
---
