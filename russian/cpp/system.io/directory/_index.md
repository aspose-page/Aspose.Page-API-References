---
title: "System::IO::Directory класс"
linktitle: "Directory"
second_title: "Aspose.Page для C++"
description: "System::IO::Directory класс. Содержит методы для работы с каталогами. Это статический тип без сервисов экземпляра. Вы никогда не должны создавать его экземпляры каким-либо способом в C++."
type: docs
weight: 1100
...
| static [EnumerateFileSystemEntries](./enumeratefilesystementries/)(const String\&, const String\&, SearchOption) | Ищет файлы и каталоги, соответствующие указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корнем которого является указанный каталог. |
...
| static [GetFileSystemEntries](./getfilesystementries/)(const String\&, const String\&, SearchOption) | Ищет файлы и каталоги, соответствующие указанным критериям поиска, либо в указанном каталоге, либо во всём дереве каталогов, корнем которого является указанный каталог. |
...
| static [Move](./move/)(const String\&, const String\&) | Перемещает указанную сущность в новое место. Если перемещаемая сущность является каталогом, она перемещается вместе со всем её содержимым. |
...
| --- | --- |
| [StringEnumerablePtr](./stringenumerableptr/) | Псевдоним умного указателя на объект IEnumerable, который перечисляет набор объектов [String](../../system/string/). |
## Примечания
