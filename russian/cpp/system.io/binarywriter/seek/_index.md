---
title: "Метод System::IO::BinaryWriter::Seek"
linktitle: "Seek"
second_title: "Aspose.Page для C++"
description: "Метод System::IO::BinaryWriter::Seek. Устанавливает позицию потока, представленного текущим объектом, в C++."
type: docs
weight: 700
...
| origin | System::IO::SeekOrigin | Указывает позицию, от которой, и направление, в котором вычисляется смещение |
