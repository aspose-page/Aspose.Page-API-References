---
title: "System::IO::BasicSTDOStreamWrapper::BasicSTDOStreamWrapper конструктор"
linktitle: "BasicSTDOStreamWrapper"
second_title: "Aspose.Page для C++"
description: "Конструктор System::IO::BasicSTDOStreamWrapper::BasicSTDOStreamWrapper. Конструктор копирования. Удалён в C++."
type: docs
weight: 100
url: /ru/cpp/system.io/basicstdostreamwrapper/basicstdostreamwrapper/
---
...
| --- | --- | --- |
| str | std::basic_ostream\<char_type, traits_type\>\& | Ссылка на поток |
