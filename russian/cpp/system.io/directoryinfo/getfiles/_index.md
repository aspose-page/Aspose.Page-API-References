...
description: "System::IO::DirectoryInfo::GetFiles метод. Возвращает массив, содержащий разделяемые указатели на объекты FileInfo, представляющие все каталоги, расположенные в директории, представленной текущим объектом, в C++."
type: docs
weight: 1300
...
Возвращает массив, содержащий разделяемые указатели на объекты [FileInfo](../../fileinfo/), представляющие все каталоги, расположенные в директории, представленной текущим объектом.
...
Массив разделяемых указателей на объекты [FileInfo](../../fileinfo/), представляющих найденные файлы, имена которых соответствуют **searchPattern**
