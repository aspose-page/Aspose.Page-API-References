...
| [ReadByte](./readbyte/)() override | Читает один байт из базового потока и возвращает 32‑битное целое значение, эквивалентное значению прочитанного байта. |
...
| [WriteByte](./writebyte/)(uint8_t) override | Записывает указанное беззнаковое 8‑битное целое значение в базовый поток. |
