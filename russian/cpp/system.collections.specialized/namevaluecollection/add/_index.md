---
title: "System::Collections::Specialized::NameValueCollection::Add метод"
linktitle: "Add"
second_title: "Aspose.Page для C++"
description: "System::Collections::Specialized::NameValueCollection::Add метод. Переопределяет метод ICollection — не реализовано в C++."
type: docs
weight: 200
url: /ru/cpp/system.collections.specialized/namevaluecollection/add/
---
## NameValueCollection::Add(const String\&) method


Переопределяет метод [ICollection](../../../system.collections/icollection/) — не реализовано.
