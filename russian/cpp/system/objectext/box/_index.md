...
Упаковывает типы значений для преобразования в [Object](../../object/). Реализация для типов enum.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | const T\& | Значение [Enum](../../enum/) для упаковки. |
...
Упаковывает типы значений для преобразования в [Object](../../object/). Реализация для не‑enum типов.
