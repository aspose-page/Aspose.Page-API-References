---
title: "System::ObjectExt::ToString метод"
linktitle: "ToString"
second_title: "Aspose.Page для C++"
description: "System::ObjectExt::ToString метод. Замена метода C# ToString для работы с любым типом C++ в C++."
type: docs
weight: 1300
...
Замена метода ToString из C# для работы с любым типом C++.
