...
Истина, если строки совпадают, иначе ложь.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| obj | const double\& | Значение плавающей точки слева. |
| другой | const double\& | Значение плавающей точки справа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| obj | const float\& | Значение плавающей точки слева. |
| другой | const float\& | Значение плавающей точки справа. |
...
| Параметр | Описание |
| --- | --- |
| T | Первый тип объекта. |
| T2 | Второй тип объекта. |
