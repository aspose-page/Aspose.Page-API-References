---
title: "System::DateTimeOffset::DateTimeOffset конструктор"
linktitle: "DateTimeOffset"
second_title: "Aspose.Page для C++"
description: "Конструктор System::DateTimeOffset::DateTimeOffset. Конструктор по умолчанию в C++."
type: docs
weight: 100
url: /ru/cpp/system/datetimeoffset/datetimeoffset/
---
...
| --- | --- | --- |
| date_time | DateTime | Дата и время. |
| смещение | TimeSpan | Смещение времени от UTC. |
...
| --- | --- | --- |
| год | int | Год. |
| месяц | int | Месяц (от 1 до 12). |
| день | int | День (от 1 до количества дней в месяце). |
| час | int | Час (от 0 до 23). |
| минута | int | Минута (от 0 до 59). |
| секунда | int | Секунда (от 0 до 59). |
| миллисекунда | int | Миллисекунда (от 0 до 999). |
| календарь | const SharedPtr\<Globalization::Calendar\>\& | Календарь, используемый для интерпретации года, месяца и дня. |
| смещение | TimeSpan | Смещение времени от UTC. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| тиков | int64_t | Количество тиков. |
| смещение | TimeSpan | Смещение времени от UTC. |
