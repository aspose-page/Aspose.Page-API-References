...
| static [get_CurrentCulture](./get_currentculture/)() | Синглтон сравнивателя текущей культуры. |
| static [get_CurrentCultureIgnoreCase](./get_currentcultureignorecase/)() | Синглтон сравнивателя текущей культуры без учёта регистра. |
| static [get_InvariantCulture](./get_invariantculture/)() | Синглтон сравнивателя инвариантной культуры. |
| static [get_InvariantCultureIgnoreCase](./get_invariantcultureignorecase/)() | Синглтон сравнивателя инвариантной культуры без учёта регистра. |
| static [get_Ordinal](./get_ordinal/)() | Синглтон порядкового сравнивателя. |
| static [get_OrdinalIgnoreCase](./get_ordinalignorecase/)() | Синглтон порядкового сравнивателя без учёта регистра. |
