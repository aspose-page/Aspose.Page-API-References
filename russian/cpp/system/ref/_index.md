---
title: "System::Ref метод"
linktitle: "Ref"
second_title: "Aspose.Page для C++"
description: "System::Ref метод. Обёртка, чтобы убедиться, что Ref(std::ref(DynamicWeakPtr)) работает в C++."
type: docs
weight: 36600
...
Обёртка, чтобы убедиться, что Ref(std::ref(DynamicWeakPtr)) работает.
...
Вспомогательная функция для получения ссылок на объекты. Используется, чтобы гарантировать, что [System::DynamicWeakPtr](../dynamicweakptr/) обновляет ссылочный объект после присваиваний.
