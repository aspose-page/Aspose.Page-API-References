...
| dstOffset | int | Смещение в байтах в представлении массива назначения, с которого начинать вставку данных |
| count | int | Количество байтов для копирования |
...
| --- | --- |
| TSrc | Тип элементов исходного массива |
| TDst | Тип элементов стека массива назначения |
| ND | Размер стека массива назначения |

| Параметр | Тип | Описание |
| --- | --- | --- |
| src | const SharedPtr\<Array\<TSrc\>\>\& | Исходный массив |
| srcOffset | int | Смещение в байтах в исходном массиве, с которого начинается копирование |
| dst | const System::Details::StackArray\<TDst, ND\>\& | Стек массива назначения |
| dstOffset | int | Смещение в байтах в стеке массива назначения, с которого начинать вставку данных |
| count | int | Количество байтов для копирования |
...
| srcOffset | int | Смещение в байтах в представлении tho исходного массива, с которого начинается копирование |
| dst | const SharedPtr\<Array\<TDst\>\>\& | Целевой массив |
| dstOffset | int | Смещение в байтах в целевом массиве, с которого начинается вставка данных |
| count | int | Количество байтов для копирования |
...
| Параметр | Описание |
| --- | --- |
| TSrc | Тип элементов стека исходного массива |
| NS | Размер стека исходного массива |
| TDst | Тип элементов целевого массива |

| Параметр | Тип | Описание |
| --- | --- | --- |
| src | const System::Details::StackArray\<TSrc, NS\>\& | Стек исходного массива |
| srcOffset | int | Смещение в байтах в стеке tho исходного массива, с которого начинается копирование |
| dst | const SharedPtr\<Array\<TDst\>\>\& | Целевой массив |
| dstOffset | int | Смещение в байтах в целевом массиве, с которого начинается вставка данных |
| count | int | Количество байтов для копирования |
