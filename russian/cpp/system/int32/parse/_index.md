---
title: "Метод System::Int32::Parse"
linktitle: "Parse"
second_title: "Aspose.Page для C++"
description: "Как использовать метод Parse класса System::Int32 в C++."
type: docs
weight: 100
url: /ru/cpp/system/int32/parse/
---
...
32-битное знаковое целое, равное числу, представленному указанной строкой.
...
Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 32‑битное знаковое целое, используя предоставленную информацию о форматировании.
