...
description: "System::Nullable::Nullable constructor. Создаёт экземпляр, представляющий значение null, в C++."
type: docs
weight: 100
...
Создаёт экземпляр, представляющий значение, которое представлено указанным объектом [Nullable](../). Указанный nullable‑объект может представлять значение другого типа, чем базовый тип создаваемого экземпляра, в этом случае представленное значение преобразуется к типу T.
