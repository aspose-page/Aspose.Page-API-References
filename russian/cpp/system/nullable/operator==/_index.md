...
Истина, если значение, представленное текущим объектом, равно указанному значению, иначе — ложь
...
Истина, если значение, представленное текущим объектом, равно null, иначе — ложь
