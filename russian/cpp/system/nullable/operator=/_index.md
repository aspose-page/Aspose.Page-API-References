...
description: "Метод System::Nullable::operator=. Заменяет текущее представленное значение объекта на указанное в C++."
type: docs
weight: 1800
...
Заменяет текущее представленное объектом значение указанным значением.
