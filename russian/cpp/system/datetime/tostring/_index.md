---
title: "System::DateTime::ToString метод"
linktitle: "ToString"
second_title: "Aspose.Page для C++"
description: "System::DateTime::ToString метод. Возвращает строковое представление значения даты и времени, представленного текущим объектом, используя правила форматирования, определённые текущей культурой, в C++."
type: docs
weight: 5200
url: /ru/cpp/system/datetime/tostring/
---
...
| --- | --- | --- |
| поставщик | const SharedPtr\<IFormatProvider\>\& | Объект, представляющий информацию о формате |
