---
title: "System::DateTime::SpecifyKind метод"
linktitle: "SpecifyKind"
second_title: "Aspose.Page для C++"
description: "System::DateTime::SpecifyKind метод. Создаёт новый объект DateTime, который представляет то же количество тиков, что и указанный объект DateTime, и представляет локальное время, время UTC или ни то ни другое в зависимости от аргумента kind в C++."
type: docs
weight: 6800
