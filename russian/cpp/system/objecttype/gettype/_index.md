...
Константная ссылка на структуру [TypeInfo](../../typeinfo/), описывающую указанную структуру или тип указателя, если вызывается для [SmartPtr](../../smartptr/).
