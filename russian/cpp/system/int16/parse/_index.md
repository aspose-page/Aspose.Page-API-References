---
title: "метод System::Int16::Parse"
linktitle: "Parse"
second_title: "Aspose.Page для C++"
description: "Метод System::Int16::Parse. Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 16‑битное знаковое целое в C++."
type: docs
weight: 100
url: /ru/cpp/system/int16/parse/
---
...
16‑битное знаковое целое, равное числу, представленному в указанной строке.
...
Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 16‑битное знаковое целое, используя предоставленную информацию о форматировании.
