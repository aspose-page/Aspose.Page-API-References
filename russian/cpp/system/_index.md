---
title: "Пространство имен System"
linktitle: "System"
second_title: "Aspose.Page для C++"
description: "Как использовать пространство имен System в C++."
type: docs
weight: 2100
url: /ru/cpp/system/
---
...
| [BitConverter](./bitconverter/) | Содержит методы, выполняющие преобразования последовательности байтов в тип значения и наоборот. Это статический тип без сервисов экземпляра. Вы никогда не должны создавать его экземпляры каким-либо способом. |
...
| [DateTimeOffset](./datetimeoffset/) | Содержит дату и время суток относительно всемирного координированного времени (UTC). Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
...
| [EventArgs](./eventargs/) | Базовый класс для классов, представляющих контекст, который передаётся подписчикам событий при возникновении события. Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
| [ExceptionWrapper](./exceptionwrapper/) | Шаблон, представляющий оболочку исключений, производных от класса [Exception](./exception/). |
| [FlagsAttribute](./flagsattribute/) | Указывает, что перечисление может рассматриваться как битовое поле; то есть набор. |
| [Func](./func/) | Функциональный делегат. Этот тип должен быть выделен в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
| [GC](./gc/) | Представляет эмулированную сборку мусора, которая больше похожа на заглушку и фактически ничего не делает. Это статический тип без экземплярных сервисов. Вы никогда не должны создавать его экземпляры никакими способами. |
| [Guid](./guid/) | Представляет глобальный уникальный идентификатор. Этот тип должен быть выделен в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
...
| [IConvertible](./iconvertible/) | Определяет методы, преобразующие значение реализующего ссылки или тип значения в тип среды выполнения общего языка, имеющий эквивалентное значение. Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
...
| [ObjectExt](./objectext/) | Предоставляет статические методы, эмулирующие методы C# [Object](./object/) для не‑Object типов C++ (строки, числа и т.д.). Это статический тип без экземплярных сервисов. Вы никогда не должны создавать его экземпляры никакими способами. |
| [ObjectType](./objecttype/) | Предоставляет статические методы, реализующие геттеры типа объекта. Это статический тип без экземплярных сервисов. Вы никогда не должны создавать его экземпляры никакими способами. |
| [OperatingSystem](./operatingsystem/) | Представляет конкретную операционную систему и предоставляет информацию о ней. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
| [Random](./random/) | Представляет генератор псевдослучайных чисел. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
| [ReadOnlySpan](./readonlyspan/) | Предназначен для использования внутри класса [Span](./span/). |
| [ScopedCulture](./scopedculture/) | Представляет культуру, используемую в текущей области. |
| [SmartPtr](./smartptr/) | Класс-указатель для обёртывания типов, выделяемых в куче. Используйте его для управления памятью классов, наследующих [Object](./object/). Этот тип указателя следует семантике внедрённых указателей. Счётчик ссылок хранится либо в самом [Object](./object/), либо в структуре счётчика, тесно связанной с экземпляром [Object](./object/). В любом случае все экземпляры [SmartPtr](./smartptr/) образуют единую группу владения независимо от способа их создания, что отличается от поведения класса std::shared_ptr. Преобразование сырого указателя в [SmartPtr](./smartptr/) безопасно, если существуют другие экземпляры [SmartPtr](./smartptr/), удерживающие совместные ссылки на тот же объект. Экземпляр класса [SmartPtr](./smartptr/) может находиться в одном из двух состояний: совместный указатель и слабый указатель. Чтобы объект оставался живым, количество совместных ссылок на него должно быть положительным. И слабые, и совместные указатели могут использоваться для доступа к объекту (вызов методов, чтение или запись полей и т.д.), но слабые указатели не участвуют в подсчёте совместных ссылок. [Object](./object/) удаляется, когда последний «совместный» указатель [SmartPtr](./smartptr/) на него уничтожается. Поэтому убедитесь, что этого не происходит, когда другие совместные указатели [SmartPtr](./smartptr/) на объект отсутствуют, например, во время конструирования или разрушения объекта. Используйте охранные объекты System::Object::ThisProtector (в коде C++) или атрибуты CppCTORSelfReference и CppSelfReference (в переводимом коде C#) для исправления этой проблемы. Аналогично, разбирайте циклические ссылки, используя класс указателя [System::WeakPtr](./weakptr/) или режим указателя [System::SmartPtrMode::Weak](./smartptrmode/) (в коде C++) или атрибут CppWeakPtr (в переводимом коде C#). Если два или более объектов ссылаются друг на друга с помощью «совместных» указателей, они никогда не будут удалены. Если тип указателя (слабый или совместный) должен переключаться во время выполнения, используйте метод [System::SmartPtr<T>::set_Mode()](./smartptr/set_mode/) или класс [System::DynamicWeakPtr](./dynamicweakptr/). Класс [SmartPtr](./smartptr/) не содержит виртуальных методов. Наследовать его следует только если вы создаёте собственную стратегию управления памятью. Этот тип представляет собой указатель для управления удалением другого объекта. Он должен выделяться в стеке и передаваться в функции по значению или по константной ссылке. |
| [SmartPtrInfo](./smartptrinfo/) | Сервисный класс для тестирования и изменения содержимого [SmartPtr](./smartptr/) без знания конечного типа. Используется для сборки мусора и обнаружения циклических ссылок и т.д. Считайте его «указателем на указатель». Мы не можем использовать базовый тип [SmartPtr](./smartptr/), так как его нет; вместо этого используем этот «информационный» класс. |
| [Span](./span/) | Представляет непрерывный регион произвольной памяти, аналогичный std::span из C++20. |
| [String](./string/) | Класс [String](./string/) используется по всей библиотеке. Является заменой C# [System.String](./string/) при переводе кода. По причинам оптимизации не считается подклассом [Object](./object/). Этот тип должен выделяться в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
| [StringComparer](./stringcomparer/) | Сравнивает строки, используя различные режимы сравнения. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
| [StringHashCompiletime](./stringhashcompiletime/) | Вспомогательный класс, генерирующий хеш‑значение из C‑строки. |
| [TimeSpan](./timespan/) | Представляет временной интервал. Этот тип должен выделяться в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
| [TimeZone](./timezone/) | Представляет часовой пояс. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
| [TimeZoneInfo](./timezoneinfo/) | Представляет информацию, описывающую конкретный часовой пояс. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
...
| [Uri](./uri/) | Унифицированный идентификатор ресурса. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](./makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](./smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. |
...
| [ValueType](./valuetype/) | Базовый класс для значимых типов с наследованием от [Object](./object/), усечённый в целях производительности. Этот тип должен выделяться в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
...
| [Void](./void/) |  |
| [WeakPtr](./weakptr/) | Подкласс [System::SmartPtr](./smartptr/), который устанавливает себя в слабый режим при конструировании. Обратите внимание, что этот класс не гарантирует, что его экземпляр всегда останется в слабом режиме, поскольку метод [set_Mode()](./smartptr/set_mode/) остаётся доступным. Этот тип представляет собой указатель для управления удалением другого объекта. Он должен выделяться в стеке и передаваться в функции либо по значению, либо по константной ссылке. |
...
| [MidpointRounding](./midpointrounding/) | Указывает поведение функций округления. |
| [PlatformID](./platformid/) | Представляет платформу операционной системы. |
| [SmartPtrMode](./smartptrmode/) | [SmartPtr](./smartptr/) тип указателя: слабый или разделяемый. Определяет, учитывается ли указатель при решении, удалять объект или нет. |
...
| [UriFormat](./uriformat/) | Указывает, как экранируется URI. |
...
| [DirectoryInfoPtr](./directoryinfoptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::DirectoryInfo](../system.io/directoryinfo/). |
| [EncoderFallbackBufferPtr](./encoderfallbackbufferptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::EncoderFallbackBuffer](../system.text/encoderfallbackbuffer/). |
| [EncoderFallbackPtr](./encoderfallbackptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::EncoderFallback](../system.text/encoderfallback/). |
| [EncoderPtr](./encoderptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::Encoder](../system.text/encoder/). |
| [EncoderReplacementFallbackBufferPtr](./encoderreplacementfallbackbufferptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::EncoderReplacementFallbackBuffer](../system.text/encoderreplacementfallbackbuffer/). |
| [EncoderReplacementFallbackPtr](./encoderreplacementfallbackptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::EncoderReplacementFallback](../system.text/encoderreplacementfallback/). |
| [EncodingInfoPtr](./encodinginfoptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::EncodingInfo](../system.text/encodinginfo/). |
| [EncodingPtr](./encodingptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Text::Encoding](../system.text/encoding/). |
...
| [EventHandler](./eventhandler/) | Представляет метод, который реагирует на событие и обрабатывает его. Этот тип должен быть выделен в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](./smartptr/) для управления объектами этого типа. |
...
| [FileInfoPtr](./fileinfoptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::FileInfo](../system.io/fileinfo/). |
| [FileStreamPtr](./filestreamptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::FileStream](../system.io/filestream/). |
| [FileSystemInfoPtr](./filesysteminfoptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::FileSystemInfo](../system.io/filesysteminfo/). |
| [FunctionPtr](./functionptr/) | Псевдоним для типа функции с соглашением вызова по умолчанию. |
| [IAsyncResultPtr](./iasyncresultptr/) | Умный указатель на [IAsyncResult](./iasyncresult/). |
| [IFormatProviderPtr](./iformatproviderptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IFormatProvider](./iformatprovider/). |
| [MakeConstRef_t](./makeconstref_t/) | Вспомогательный тип для модификатора [MakeConstRef](./makeconstref/). |
| [MemoryStreamPtr](./memorystreamptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::MemoryStream](../system.io/memorystream/). |
...
| [RTaskPtr](./rtaskptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::Threading::Tasks::ResultTask](../system.threading.tasks/resulttask/). |
| [SharedPtr](./sharedptr/) | Псевдоним для умного указателя, широко используемого в библиотеке. |
| [StreamPtr](./streamptr/) | Псевдоним для умного указателя, который указывает на экземпляр класса [System::IO::Stream](../system.io/stream/). |
...
| С | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
| С | System.Collections.Generic.List`1[Doxygen2HugoConverter.Markup.SimpleMarkupEntry] |
