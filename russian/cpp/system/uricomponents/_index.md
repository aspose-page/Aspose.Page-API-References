...
| StrongPort | 128 | Данные порта; если данные порта отсутствуют в [Uri](../uri/) и схеме был назначен порт по умолчанию, возвращается порт по умолчанию; если порта по умолчанию нет, возвращается -1. |
