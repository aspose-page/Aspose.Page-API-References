...
Сортирует два массива, один содержащий ключи, а другой — соответствующие элементы, основываясь на значениях массива с ключами, элементы которого сравниваются с помощью operator<.
...
Сортирует два массива, один содержащий ключи, а другой — соответствующие элементы, основываясь на значениях массива с ключами, элементы которого сравниваются с помощью сравнивателя по умолчанию.
