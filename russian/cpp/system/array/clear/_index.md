...
description: "Метод System::Array::Clear. Не поддерживается, потому что массив, представляемый текущим объектом, является только для чтения в C++."
type: docs
weight: 600
...
| startIndex | int | Индекс, с которого начинать замену элементов |
