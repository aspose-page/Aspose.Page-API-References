---
title: "System::Array::Array конструктор"
linktitle: "Массив"
second_title: "Aspose.Page для C++"
description: "System::Array::Array конструктор. Создаёт пустой массив в C++."
type: docs
weight: 100
...
| Параметр | Описание |
| --- | --- |
| Q | Тип элементов объекта std::vector, из которого копировать элементы. |
...
Создаёт объект [Array](../) и заполняет его значениями, перемещёнными из объекта std::vector, тип значений которого совпадает с **T**, но отличается от **[UnderlyingType](../underlyingtype/)**.
