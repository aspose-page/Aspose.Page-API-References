...
description: "System::String::Trim method. Удаляет все пробельные символы как в начале, так и в конце строки в C++."
type: docs
weight: 5800
url: /ru/cpp/system/string/trim/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| anyOf | const ArrayPtr\<char_t\>\& | [Array](../../array/) символов для удаления. |
