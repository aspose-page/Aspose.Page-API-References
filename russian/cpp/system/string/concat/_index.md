---
title: "System::String::Concat метод"
linktitle: "Concat"
second_title: "Aspose.Page для C++"
description: "System::String::Concat метод. Объединяет строки в C++."
type: docs
weight: 6400
url: /ru/cpp/system/string/concat/
---
...
| --- | --- | --- |
| части | const ArrayPtr\<String\>\& | Строки для объединения. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| str0 | const String\& | Первая строка для объединения. |
| str1 | const String\& | Вторая строка для объединения. |
...
| str0 | const String\& | Первая строка для объединения. |
| str1 | const String\& | Вторая строка для объединения. |
| str2 | const String\& | Третья строка для объединения. |
...
| str1 | const String\& | Вторая строка для объединения. |
| str2 | const String\& | Третья строка для объединения. |
| str3 | const String\& | Четвёртая строка для объединения. |
