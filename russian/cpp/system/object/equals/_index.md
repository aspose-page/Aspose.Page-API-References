...
| Параметр | Тип | Описание |
| --- | --- | --- |
| objA | double const\& | Значение плавающей точки слева. |
| objB | double const\& | Значение плавающей точки справа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| objA | float const\& | Значение плавающей точки слева. |
| objB | float const\& | Значение плавающей точки справа. |
...
Сравнивает объекты типа значения в стиле C#.
