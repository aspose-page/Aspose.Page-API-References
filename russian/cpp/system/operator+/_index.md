...
description: "System::operator+ method. Конкатенация строк в C++."
type: docs
weight: 27500
...
Возвращает новый экземпляр класса [Decimal](../decimal/), который представляет значение, являющееся суммой указанного значения и значения, представленного указанным объектом [Decimal](../decimal/).
...
Новый экземпляр класса [Decimal](../decimal/), который представляет значение, являющееся суммой **x** и значения, представленного **d**.
...
Суммирует не-nullable и nullable значения.
...
Возвращает делегат, содержащий обратные вызовы значения левой руки, а затем правой.
