---
title: "System::Guid::Guid конструктор"
linktitle: "Guid"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Guid::Guid. Создает объект, представляющий GUID, состоящий только из нулей в C++."
type: docs
weight: 100
...
Создаёт объект, представляющий GUID, указанный в виде массива беззнаковых 8‑битных целочисленных значений.
...
Создает экземпляр класса [Guid](../) из указанных компонентов GUID.
...
Создает экземпляр класса [Guid](../) из указанных беззнаковых целых чисел и байтов.
