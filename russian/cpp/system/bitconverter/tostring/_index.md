---
title: "System::BitConverter::ToString метод"
linktitle: "ToString"
second_title: "Aspose.Page для C++"
description: "System::BitConverter::ToString метод. Преобразует все значения указанного массива байтов в их шестнадцатеричное строковое представление. Регистр букв, используемых в шестнадцатеричной нотации, и разделитель, вставляемый между каждой парой соседних байтов, задаются соответствующими аргументами в C++."
type: docs
weight: 1200
...
Преобразует все значения указанного массива байтов в их шестнадцатеричное строковое представление. Регистры букв, используемых в шестнадцатеричной нотации, и разделитель, вставляемый между каждой парой соседних байтов, задаются соответствующими аргументами.
...
| разделитель | const String\& | Строка, используемая в качестве разделителя, вставляемого между каждой парой соседних байтов в результирующей строке |
...
| --- | --- | --- |
| value | const ArrayPtr\<uint8_t\>\& | [Array](../../array/) содержащий байты для преобразования |
| startIndex | int | Индекс в указанном массиве, с которого начинается диапазон элементов массива байтов для преобразования |
| length | int | Длина диапазона элементов массива байтов для преобразования |
