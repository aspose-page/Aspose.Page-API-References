---
title: "Метод System::BitConverter::ToInt16"
linktitle: "ToInt16"
second_title: "Aspose.Page для C++"
description: "Метод System::BitConverter::ToInt16. Преобразует два байта из указанного массива, начиная с заданного индекса, в 16‑битное целочисленное значение в C++."
type: docs
weight: 800
url: /ru/cpp/system/bitconverter/toint16/
---
## BitConverter::ToInt16(const System::ArrayPtr\<uint8_t\>\&, int) method


Преобразует два байта из указанного массива, начиная с указанного индекса, в 16‑битное целочисленное значение.
...
16‑битное целочисленное значение, полученное в результате преобразования
