---
title: "System::TimeSpan::TryParse метод"
linktitle: "TryParse"
second_title: "Aspose.Page для C++"
description: "Как использовать метод TryParse класса System::TimeSpan в C++."
type: docs
weight: 4400
url: /ru/cpp/system/timespan/tryparse/
---
...
Преобразует строку в эквивалентный объект [TimeSpan](../), используя указанный поставщик формата, и возвращает результат преобразования.
...
| результат | TimeSpan\& | Интервал времени, соответствующий строке. |
