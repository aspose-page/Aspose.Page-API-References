...
description: "Метод System::operator-. Возвращает новый экземпляр класса Decimal, представляющий значение, полученное в результате вычитания значения, представленного указанным объектом Decimal, из заданного значения в C++."
type: docs
weight: 28100
...
Возвращает новый экземпляр класса [Decimal](../decimal/), представляющий значение, полученное в результате вычитания значения, представленного указанным объектом [Decimal](../decimal/), из заданного значения.
...
Новый экземпляр класса [Decimal](../decimal/), представляющий значение, полученное в результате вычитания значения, представленного **d**, из **x**.
...
Количество дней между будними днями **a** и **b**; возвращаемое значение отрицательно, если *goes* после ****
