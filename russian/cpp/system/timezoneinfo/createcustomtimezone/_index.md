...
| base_utc_offset | TimeSpan | Временной интервал между стандартным временем текущего часового пояса и временем UTC. |
| display_name | const String\& | Отображаемое имя. |
| standard_display_name | const String\& | Название стандартного времени. |
...
| display_name | const String\& | Отображаемое имя. |
| standard_display_name | const String\& | Название стандартного времени. |
| daylight_display_name | const String\& | Название летнего времени. |
...
| daylight_display_name | const String\& | Название летнего времени. |
| adjustment_rules | const ArrayPtr\<AdjustmentRulePtr\>\& | [Array](../../array/) правил корректировки. |
| disable_daylight_saving_time | bool | True, чтобы удалить любую информацию о переходе на летнее время, присутствующую в adjustment_rules. |
