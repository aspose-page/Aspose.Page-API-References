---
title: "System::TimeZoneInfo::ConvertTime метод"
linktitle: "ConvertTime"
second_title: "Aspose.Page для C++"
description: "System::TimeZoneInfo::ConvertTime метод. Преобразует время в время указанного часового пояса в C++."
type: docs
weight: 200
url: /ru/cpp/system/timezoneinfo/converttime/
---
...
| destination_time_zone | const TimeZoneInfoPtr\& | Часовой пояс назначения. |
...
| --- | --- | --- |
| date_time | DateTime | Дата и время для преобразования. |
| source_time_zone | const TimeZoneInfoPtr\& | Исходный часовой пояс. |
| destination_time_zone | const TimeZoneInfoPtr\& | Часовой пояс назначения. |
