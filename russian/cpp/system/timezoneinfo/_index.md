...
| static [ConvertTime](./converttime/)(DateTime, const TimeZoneInfoPtr\&, const TimeZoneInfoPtr\&) | [Преобразовать](../convert/) время из одного часового пояса в другой. |
| static [ConvertTime](./converttime/)(const DateTimeOffset\&, const TimeZoneInfoPtr\&) | [Преобразовать](../convert/) время в время указанного часового пояса. |
| static [ConvertTime](./converttime/)(DateTime, const TimeZoneInfoPtr\&) | [Преобразовать](../convert/) время в время указанного часового пояса. |
| static [ConvertTimeBySystemTimeZoneId](./converttimebysystemtimezoneid/)(DateTime, const String\&) | [Преобразовать](../convert/) время в время указанного часового пояса. |
| static [ConvertTimeBySystemTimeZoneId](./converttimebysystemtimezoneid/)(const DateTimeOffset\&, const String\&) | [Преобразовать](../convert/) время в время указанного часового пояса. |
| static [ConvertTimeBySystemTimeZoneId](./converttimebysystemtimezoneid/)(DateTime, const String\&, const String\&) | [Преобразовать](../convert/) время в время указанного часового пояса. |
...
| [GetAdjustmentRules](./getadjustmentrules/)() const | Возвращает массив, состоящий из объектов [AdjustmentRule](./adjustmentrule/), представляющих правила корректировки, применяемые к текущему объекту [TimeZoneInfo](./). |
| [GetAmbiguousTimeOffsets](./getambiguoustimeoffsets/)(DateTime) const | Получает даты и время UTC, к которым может быть сопоставлена указанная дата и время. |
| [GetAmbiguousTimeOffsets](./getambiguoustimeoffsets/)(const DateTimeOffset\&) const | Получает даты и время UTC, к которым может быть сопоставлена указанная дата и время. |
...
| static [GetUtcOffsetFromUtc](./getutcoffsetfromutc/)(DateTime, const TimeZoneInfoPtr\&) | Внутренняя вспомогательная функция, возвращающая смещение UTC для даты‑времени UTC в указанном часовом поясе. ДЛЯ ВНУТРЕННЕГО ИСПОЛЬЗОВАНИЯ. |
| static [GetUtcOffsetFromUtc](./getutcoffsetfromutc/)(DateTime, const TimeZoneInfoPtr\&, bool\&, bool\&) | Внутренняя вспомогательная функция, возвращающая смещение UTC для даты‑времени UTC в указанном часовом поясе. ДЛЯ ВНУТРЕННЕГО ИСПОЛЬЗОВАНИЯ. |
| [GetUtcOffsetNoThrow](./getutcoffsetnothrow/)(DateTime) const | Вычисляет разницу между временем в этом часовом поясе и временем UTC для указанной даты и времени. ДЛЯ ВНУТРЕННЕГО ИСПОЛЬЗОВАНИЯ. |
...
| [IsAmbiguousTime](./isambiguoustime/)(DateTime) const | Проверяет, является ли указанная дата и время неоднозначными и могут ли они быть сопоставлены с множеством UTC‑времен. |
| [IsAmbiguousTime](./isambiguoustime/)(const DateTimeOffset\&) const | Проверяет, является ли указанная дата и время неоднозначными и могут ли они быть сопоставлены с множеством UTC‑времен. |
| [IsDaylightSavingTime](./isdaylightsavingtime/)(DateTime) const | Проверяет, попадает ли указанная дата и время в диапазон летнего времени. |
| [IsDaylightSavingTime](./isdaylightsavingtime/)(const DateTimeOffset\&) const | Проверяет, попадает ли указанная дата и время в диапазон летнего времени. |
| [IsDaylightSavingTimeNoThrow](./isdaylightsavingtimenothrow/)(DateTime) const | Проверяет, попадает ли указанная дата и время в диапазон летнего времени. |
...
| --- | --- |
| [AdjustmentRulePtr](./adjustmentruleptr/) | Псевдоним для shared‑указателя на экземпляр класса [AdjustmentRule](./adjustmentrule/). |
## См. также
