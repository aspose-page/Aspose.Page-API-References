...
description: "System::operator<< метод. Выводит строку в поток вывода, используя кодировку UTF-8 в C++."
type: docs
weight: 29100
url: /ru/cpp/system/operator__/
---
## System::operator<<(std::ostream\&, const String\&) method


Выводит строку в поток вывода, используя кодировку UTF-8.
...
| --- | --- | --- |
| os | std::ostream\& | Объект выходного потока (инстанцирование **basic_ostream** с **char**). |
| str | const String\& | Строка, которую нужно отправить в выходной поток. |

### ReturnValue

Выходной поток, к которому была добавлена строка.
...
| decimal | const Decimal\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| exception | const Exception\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| guid | const Guid\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| os | const OperatingSystem\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| object | const System::Object\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| type_info | const TypeInfo\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| version | const Version\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| date_time | DateTime | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| value | DateTimeOffset | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| time_span | TimeSpan | [Data](../../system.data/) для вставки. |
...
Выводит строку в выходной поток.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| os | std::wostream\& | Объект выходного потока (инстанцирование **basic_ostream** с **wchar_t**). |
| str | const String\& | Строка, которую нужно отправить в выходной поток. |
...
second_title: Aspose.Page для C++
описание: 'System::operator>> метод. Получает строку из входного потока, используя кодировку UTF-8 в C++.'
type: docs
вес: 35100
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| в | std::istream\& | Объект входного потока (инстанцирование **basic_ostream** с **char**). |
| str | String\& | Строка для чтения из входного потока. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| в | std::wistream\& | Объект входного потока (инстанцирование **basic_ostream** с **wchar_t**). |
| str | String\& | Строка для чтения из входного потока. |
