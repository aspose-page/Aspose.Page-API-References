---
title: "Метод System::Byte::Parse"
linktitle: "Parse"
second_title: "Aspose.Page для C++"
description: "Метод System::Byte::Parse. Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 8-битное беззнаковое целое в C++."
type: docs
weight: 100
url: /ru/cpp/system/byte/parse/
---
...
8-битное беззнаковое целое, равное числу, представленному указанной строкой.
...
Преобразует указанную строку, содержащую строковое представление числа, в эквивалентное 8‑битное беззнаковое целое число, используя предоставленную информацию о форматировании.
