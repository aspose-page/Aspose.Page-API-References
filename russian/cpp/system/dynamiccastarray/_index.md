---
title: "метод System::DynamicCastArray"
linktitle: "DynamicCastArray"
second_title: "Aspose.Page для C++"
description: "Метод System::DynamicCastArray. Выполняет приведение элементов указанного массива к другому типу в C++."
type: docs
weight: 17900
...
| --- | --- | --- |
| from | const SharedPtr\<Array\<From\>\>\& | Умный указатель на массив, содержащий элементы для приведения |
