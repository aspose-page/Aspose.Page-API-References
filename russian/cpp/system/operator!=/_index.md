...
Сравнение на неравенство двух умных указателей.
...
Сравнение умного указателя с простым (C) указателем на неравенство.
...
Определяет, не равна ли указанная величина значению, представленному указанным объектом [Nullable](../nullable/), применяя к этим значениям [operator!=()](./).
...
Проверяет, не является ли умный указатель нулевым.
...
Ложь, если указатель нулевой, иначе истина.
...
Истина, если указанный объект представляет ненулевое значение, иначе ложь
...
ложь, если строка нулевая, иначе истина.
