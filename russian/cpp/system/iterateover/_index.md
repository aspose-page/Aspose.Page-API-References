...
description: "Метод System::IterateOver. Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable с типом цели по умолчанию в C++."
type: docs
weight: 23100
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable с типом цели по умолчанию.
...
| Параметр | Описание |
| --- | --- |
| Enumerable | Тип обёрнутого объекта |
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable без методов begin(), end() с аргументом типа цели для (auto& value : IterateOver<SomeType>(enumerable))
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable без методов begin(), end() с аргументом типа цели по умолчанию для (auto& value : IterateOver(enumerable)), аналогично следующему коду C#: foreach (var value in enumerable)
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable с методами begin(), end() и типом цели по умолчанию для (auto& value : IterateOver(enumerable))
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable с методами begin(), end() и типом цели, совпадающим с оригинальным value_type итератора.
...
Это свойство‑функция оборачивает перечислимый (или итерируемый) объект, чтобы его можно было использовать в диапазонном цикле for. Эта перегрузка для Enumerable с методами begin(), end() и различным типом цели и оригинальным value_type итератора.
