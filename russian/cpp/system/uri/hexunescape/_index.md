...
Символ, представленный шестнадцатеричным кодированием в позиции **index**. Если символ в **index** не закодирован в шестнадцатеричном виде, возвращается символ из **index**. Значение **index** увеличивается, указывая на символ, следующий за возвращённым.
