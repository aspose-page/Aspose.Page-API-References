...
| [get_Expired](./get_expired/)() | Получает значение, указывающее, истёк ли cookie. |
...
| [set_Expired](./set_expired/)(bool) | Устанавливает значение, указывающее, истек ли cookie. |
...
| static [EqualsLiteral](./equalsliteral/) | Разделитель, который используется для разделения имени и значения атрибута. |
