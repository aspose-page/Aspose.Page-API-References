...
| Поле | Описание |
| --- | --- |
| static [Http](./http/) | Информация RTTI. |
| static [Https](./https/) | Строковое представление HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | Строка, представляющая разделитель схемы. |
| static [Ws](./ws/) | Строковое представление WS. |
| static [Wss](./wss/) | Строковое представление WSS. |
## См. также
