---
title: "Метод System::Net::Dns::BeginGetHostByName"
linktitle: "BeginGetHostByName"
second_title: "Aspose.Page для C++"
description: "Метод System::Net::Dns::BeginGetHostByName. Инициирует асинхронную операцию по созданию нового экземпляра класса IPHostEntry с использованием указанного имени хоста в C++."
type: docs
weight: 200
url: /ru/cpp/system.net/dns/begingethostbyname/
---
