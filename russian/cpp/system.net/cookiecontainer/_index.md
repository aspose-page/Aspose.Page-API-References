...
| [Add](./add/)(System::SharedPtr\<Uri\>, System::SharedPtr\<CookieCollection\>) | Копирует cookies из указанной коллекции для указанного URI в текущую коллекцию. |
...
| [CookieCutter](./cookiecutter/)(System::SharedPtr\<Uri\>, String, String, bool) | Копирует cookies из указанного HTTP-заголовка для указанного URI. |
...
| [GetCookieHeader](./getcookieheader/)(System::SharedPtr\<Uri\>) | Возвращает HTTP-заголовок, содержащий cookies, связанные с указанным URI. |
| [GetCookieHeader](./getcookieheader/)(System::SharedPtr\<Uri\>, String\&) | Возвращает HTTP-заголовок, содержащий cookies, связанные с указанным URI. |
| [GetCookies](./getcookies/)(System::SharedPtr\<Uri\>) | Возвращает коллекцию cookies, связанных с указанным URI. |
| [InternalGetCookies](./internalgetcookies/)(System::SharedPtr\<Uri\>) | Возвращает коллекцию cookies, связанных с указанным URI. |
...
| [SetCookies](./setcookies/)(System::SharedPtr\<Uri\>, String) | Копирует cookies из указанного заголовка в коллекцию и связывает их с указанным URI. |
## Поля
