---
title: "System::Net::CookieContainer::Add метод"
linktitle: "Add"
second_title: "Aspose.Page для C++"
description: "System::Net::CookieContainer::Add метод. Добавляет cookie в коллекцию в C++."
type: docs
weight: 200
url: /ru/cpp/system.net/cookiecontainer/add/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| куки | System::SharedPtr\<CookieCollection\> | Коллекция, из которой будут скопированы куки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| uri | System::SharedPtr\<Uri\> | URI куки. |
| cookie | System::SharedPtr\<Cookie\> | Cookie для добавления. |
...
Копирует cookies из указанной коллекции для указанного URI в текущую коллекцию.
...
| --- | --- | --- |
| uri | System::SharedPtr\<Uri\> | URI куки. |
| куки | System::SharedPtr\<CookieCollection\> | Коллекция куки, из которой необходимо скопировать куки. |
