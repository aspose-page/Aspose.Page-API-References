...
| [get_IsIPv6SiteLocal](./get_isipv6sitelocal/)() | Возвращает значение, указывающее, является ли адрес site-local адресом IPv6. |
| [get_IsIPv6Teredo](./get_isipv6teredo/)() | Возвращает значение, указывающее, является ли адрес IPv6-адресом Teredo. |
| [get_ScopeId](./get_scopeid/)() | Получает идентификатор области (scope) IPv6-адреса. |
...
| static [HostToNetworkOrder](./hosttonetworkorder/)(int64_t) | Преобразует указанный порядок байтов хоста в соответствующий сетевой порядок байтов. |
| static [HostToNetworkOrder](./hosttonetworkorder/)(int32_t) | Преобразует указанный порядок байтов хоста в соответствующий сетевой порядок байтов. |
| static [HostToNetworkOrder](./hosttonetworkorder/)(int16_t) | Преобразует указанный порядок байтов хоста в соответствующий сетевой порядок байтов. |
...
| static [IsLoopback](./isloopback/)(System::SharedPtr\<IPAddress\>) | Возвращает значение, указывающее, является ли указанный адрес адресом loopback. |
| [MapToIPv4](./maptoipv4/)() | Преобразует адрес в IPv4-адрес. |
| [MapToIPv6](./maptoipv6/)() | Преобразует адрес в IPv6-адрес. |
| static [NetworkToHostOrder](./networktohostorder/)(int64_t) | Преобразует указанный сетевой порядок байтов в соответствующий порядок байтов хоста. |
| static [NetworkToHostOrder](./networktohostorder/)(int32_t) | Преобразует указанный сетевой порядок байтов в соответствующий порядок байтов хоста. |
| static [NetworkToHostOrder](./networktohostorder/)(int16_t) | Преобразует указанный сетевой порядок байтов в соответствующий порядок байтов хоста. |
