---
title: "Конструктор System::Net::NetworkCredential::NetworkCredential"
linktitle: "NetworkCredential"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Net::NetworkCredential::NetworkCredential. Создает новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net/networkcredential/networkcredential/
---
...
| userName | String | Имя пользователя. |
| password | String | Пароль. |
| домен | String | Домен, который проверяет учетные данные. |
