...
description: "System::Net::IPEndPoint::GetImpl method. Возвращает указатель на реализацию в C++."
type: docs
weight: 800
url: /ru/cpp/system.net/ipendpoint/getimpl/
---
## IPEndPoint::GetImpl method


Возвращает указатель на реализацию.
