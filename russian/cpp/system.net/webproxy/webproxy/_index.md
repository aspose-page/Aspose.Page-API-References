---
title: "Конструктор System::Net::WebProxy::WebProxy"
linktitle: "WebProxy"
second_title: "Aspose.Page для C++"
description: "Конструктор System::Net::WebProxy::WebProxy. Создаёт новый экземпляр в C++."
type: docs
weight: 100
url: /ru/cpp/system.net/webproxy/webproxy/
---
...
| --- | --- | --- |
| Адрес | String | Адрес прокси‑сервера. |
...
| Адрес | String | Адрес прокси‑сервера. |
| BypassOnLocal | bool | Значение, указывающее, должен ли прокси‑сервер использоваться для локальных адресов. |
| BypassList | System::ArrayPtr\<String\> | Список адресов, которые не используют прокси‑сервер. |
...
| BypassOnLocal | bool | Значение, указывающее, должен ли прокси‑сервер использоваться для локальных адресов. |
| BypassList | System::ArrayPtr\<String\> | Список адресов, которые не используют прокси‑сервер. |
| Credentials | System::SharedPtr\<ICredentials\> | Учётные данные, отправляемые прокси‑серверу для аутентификации. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| Адрес | System::SharedPtr\<Uri\> | Адрес прокси‑сервера. |
