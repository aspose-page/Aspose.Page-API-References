---
title: "System::Threading::Tasks::ResultValueTask класс"
...
| Метод | Описание |
| --- | --- |
| [AsTask](./astask/)() const | Преобразует этот [ResultValueTask](./) в разделяемый указатель к [ResultTask<T>](../resulttask/). |
...
| [get_Result](./get_result/)() const | Получает результат завершённой задачи. |
...
| [ResultValueTask](./resultvaluetask/)(const RTaskPtr\<T\>\&) | Создаёт [ResultValueTask](./) из разделяемого указателя на [ResultTask<T>](../resulttask/). |
## Примечания
