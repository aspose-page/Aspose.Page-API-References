...
description: "System::Threading::Tasks::Task::Task конструктор. Внутренний конструктор для создания неинициализированных заданий в C++."
type: docs
weight: 100
...
Создаёт [Task](../) с состоянием действия, объектом состояния и токеном отмены.
