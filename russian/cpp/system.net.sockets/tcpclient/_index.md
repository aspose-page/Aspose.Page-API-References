...
| [get_Available](./get_available/)() | Возвращает количество байтов, полученных и готовых к чтению. |
