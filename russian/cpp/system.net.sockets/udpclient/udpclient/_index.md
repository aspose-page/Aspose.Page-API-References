---
title: "System::Net::Sockets::UdpClient::UdpClient конструктор"
linktitle: "UdpClient"
second_title: "Aspose.Page для C++"
description: "System::Net::Sockets::UdpClient::UdpClient конструктор. Инициализирует новый экземпляр класса UdpClient в C++."
type: docs
weight: 100
url: /ru/cpp/system.net.sockets/udpclient/udpclient/
---
...
| --- | --- | --- |
| семейство | AddressFamily | Значение, указывающее схему адресации сокета. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| порт | int32_t | Локальный номер порта, из которого вы планируете общаться. |
...
Создаёт новый экземпляр класса [UdpClient](../) и подключается к указанному удалённому хосту на указанном порту.
