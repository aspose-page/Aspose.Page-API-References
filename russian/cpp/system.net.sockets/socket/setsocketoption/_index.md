---
title: "System::Net::Sockets::Socket::SetSocketOption метод"
linktitle: "SetSocketOption"
second_title: "Aspose.Page для C++"
description: "System::Net::Sockets::Socket::SetSocketOption метод. Устанавливает указанную опцию сокета в указанное значение в C++."
type: docs
weight: 6200
url: /ru/cpp/system.net.sockets/socket/setsocketoption/
---
...
| optionName | SocketOptionName | Имя опции, которую необходимо обновить. |
| optionValue | bool | Значение, которое необходимо установить для указанной опции. |
...
| optionLevel | SocketOptionLevel | Уровень параметра сокета. |
| optionName | SocketOptionName | Имя опции, которую необходимо обновить. |
| optionValue | int32_t | Значение, которое необходимо установить для указанной опции. |
...
| optionLevel | SocketOptionLevel | Уровень параметра сокета. |
| optionName | SocketOptionName | Имя опции, которую необходимо обновить. |
| optionValue | System::ArrayPtr\<uint8_t\> | Значение, которое необходимо установить для указанной опции. |
...
| optionLevel | SocketOptionLevel | Уровень параметра сокета. |
| optionName | SocketOptionName | Имя опции, которую необходимо обновить. |
| optionValue | System::SharedPtr\<Object\> | Значение, которое необходимо установить для указанной опции. |
