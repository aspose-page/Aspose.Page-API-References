---
title: "Метод System::Net::Sockets::Socket::BeginReceive"
linktitle: "BeginReceive"
second_title: "Aspose.Page для C++"
description: "Метод System::Net::Sockets::Socket::BeginReceive. Инициирует асинхронную операцию записи в C++."
type: docs
weight: 800
...
| --- | --- | --- |
| буфер | System::ArrayPtr\<uint8_t\> | Буфер, в который будут записаны полученные данные. |
...
Объект [IAsyncResult](../../../system/iasyncresult/) представляет инициированную асинхронную операцию получения.
