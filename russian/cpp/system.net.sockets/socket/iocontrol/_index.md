---
title: "Метод System::Net::Sockets::Socket::IOControl"
linktitle: "IOControl"
second_title: "Aspose.Page для C++"
description: "Метод System::Net::Sockets::Socket::IOControl. Устанавливает низкоуровневые режимы работы сокета в C++."
type: docs
weight: 4000
...
Устанавливает низкоуровневые режимы работы для socket.
