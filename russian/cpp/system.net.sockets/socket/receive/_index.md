...
Принимает данные из socket и записывает их в указанный массив байтов.
...
Принимает данные из socket и записывает их в указанные массивы байтов.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| buffers | System::SharedPtr\<Collections::Generic::IList\<ArraySegment\<uint8_t\>\>\> | Массивы байтов, в которые будут записаны полученные данные. |
