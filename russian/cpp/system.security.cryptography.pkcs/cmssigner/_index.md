...
| Метод | Описание |
| --- | --- |
| [CmsSigner](./cmssigner/)(const SharedPtr\<X509Certificates::X509Certificate2\>\&) | Инициализирует подписанта с сертификатом X509. |
| [get_DigestAlgorithm](./get_digestalgorithm/)() const | Получает алгоритм хеширования, используемый в подписи. |
| [get_IncludeOption](./get_includeoption/)() const | Проверяет, какие сертификаты из цепочки будут включены в подпись. |
| [set_DigestAlgorithm](./set_digestalgorithm/)(const SharedPtr\<Oid\>\&) | Устанавливает алгоритм хеширования, используемый в подписи. |
