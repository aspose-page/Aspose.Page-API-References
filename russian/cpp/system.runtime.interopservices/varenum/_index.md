...
description: "System::Runtime::InteropServices::VarEnum enum. Определяет, как элементы массива должны маршалиться в C++."
type: docs
weight: 300
url: /ru/cpp/system.runtime.interopservices/varenum/
---
## VarEnum enum
...
| VT_NULL | 1 | [Marshal](../marshal/) как null. |
| VT_I2 | 2 | 2-байтовое целое. |
| VT_I4 | 3 | 4-байтовое целое. |
| VT_R4 | 4 | 4-байтовое число с плавающей точкой. |
| VT_R8 | 5 | 8-байтовое число с плавающей точкой. |
...
| VT_BOOL | 11 | [Boolean](../../system/boolean/) значение. |
| VT_VARIANT | 12 | Значение Variant. |
| VT_UNKNOWN | 13 | Указатель IUnknown. |
| VT_DECIMAL | 14 | [Decimal](../../system/decimal/) значение. |
| VT_I1 | 16 | [Byte](../../system/byte/) значение. |
...
| VT_LPSTR | 30 | Строка символов, завершающаяся нулевым символом. |
| VT_LPWSTR | 31 | Строка wchar_t, завершающаяся нулевым символом. |
...
| VT_STREAMED_OBJECT | 68 | [Object](../../system/object/) сериализованный в потоке. |
| VT_STORED_OBJECT | 69 | [Object](../../system/object/) сериализованный в хранилище. |
| VT_BLOB_OBJECT | 70 | [Object](../../system/object/) сериализованный в блобе. |
