---
title: "System::Threading::Timer::Timer конструктор"
linktitle: "Timer"
second_title: "Aspose.Page для C++"
description: "System::Threading::Timer::Timer конструктор. Конструктор в C++."
type: docs
weight: 100
...
| dueTime | int64_t | [Timeout](../../timeout/) перед первым вызовом функции обратного вызова, в миллисекундах; отрицательные значения не планируют таймер после создания, поэтому его можно запланировать позже. |
...
| обратный вызов | TimerCallback | Функция, вызываемая таймером. |
| state | const System::SharedPtr\<System::Object\>\& | Аргумент функции обратного вызова. |
| dueTime | System::TimeSpan | [Timeout](../../timeout/) перед первым вызовом функции обратного вызова; отрицательные значения не планируют таймер после создания, поэтому его можно запланировать позже. |
