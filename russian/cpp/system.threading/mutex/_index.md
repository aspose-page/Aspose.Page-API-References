...
| [WaitOne](./waitone/)() override | Блокирует мьютекс. Выполняет неограниченное ожидание, если необходимо. |
| [WaitOne](./waitone/)(int) override | Блокирует мьютекс. Выполняет ожидание, если необходимо. |
| [WaitOne](./waitone/)(TimeSpan) override | Блокирует мьютекс. Выполняет ожидание, если необходимо. |
## Поля
