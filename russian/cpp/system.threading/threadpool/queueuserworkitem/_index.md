---
title: "System::Threading::ThreadPool::QueueUserWorkItem метод"
linktitle: "QueueUserWorkItem"
second_title: "Aspose.Page для C++"
description: "System::Threading::ThreadPool::QueueUserWorkItem метод. Помещает элемент работы в очередь, который представлен обратным вызовом без параметров в C++."
type: docs
weight: 600
...
Помещает рабочий элемент в очередь, который присутствует с обратным вызовом без параметров.
