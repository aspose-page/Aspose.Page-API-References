...
description: "System::Text::RegularExpressions::CaptureCollectionPtr typedef. Указатель на коллекцию захватов в C++."
type: docs
weight: 1000
url: /ru/cpp/system.text.regularexpressions/capturecollectionptr/
---
## CaptureCollectionPtr typedef


Указатель на коллекцию захватов.
