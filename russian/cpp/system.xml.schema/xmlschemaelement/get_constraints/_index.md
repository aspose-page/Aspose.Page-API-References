...
description: "System::Xml::Schema::XmlSchemaElement::get_Constraints method. Возвращает коллекцию ограничений для элемента в C++."
type: docs
weight: 400
url: /ru/cpp/system.xml.schema/xmlschemaelement/get_constraints/
---
## XmlSchemaElement::get_Constraints method


Возвращает коллекцию ограничений элемента.
