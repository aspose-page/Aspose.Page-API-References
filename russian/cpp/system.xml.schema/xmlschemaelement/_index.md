...
description: "System::Xml::Schema::XmlSchemaElement класс. Представляет элемент из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс является базовым классом для всех типов частиц и используется для описания элемента в XML‑документе в C++."
type: docs
weight: 2600
...
Представляет **element** элемент из XML [Schema](../) согласно World Wide [Web](../../system.web/) Consortium (W3C). Этот класс является базовым классом для всех типов частиц и используется для описания элемента в XML‑документе.
...
| Метод | Описание |
| --- | --- |
| [get_Block](./get_block/)() | Возвращает **Block** производное. |
...
| [get_ElementType](./get_elementtype/)() | Возвращает объект, основанный на [XmlSchemaElement](./) или [XmlSchemaElement](./) элемента, который содержит посткомпиляционную интерпретацию значения **ElementType**. |
...
| [get_IsAbstract](./get_isabstract/)() | Возвращает информацию, указывающую, может ли элемент использоваться в экземпляре документа. |
| [get_IsNillable](./get_isnillable/)() | Возвращает информацию, указывающую, может ли **xsi:nil** встречаться в данных экземпляра. Указывает, может ли явное значение nil быть назначено элементу. |
...
| [set_Block](./set_block/)(XmlSchemaDerivationMethod) | Устанавливает **Block** производное. |
...
| [set_Final](./set_final/)(XmlSchemaDerivationMethod) | Устанавливает значение **Final**, указывая, что дальнейшие производные недопустимы. |
...
| [set_IsAbstract](./set_isabstract/)(bool) | Устанавливает информацию, указывающую, может ли элемент использоваться в документе‑пример. |
| [set_IsNillable](./set_isnillable/)(bool) | Устанавливает информацию, указывающую, может ли **xsi:nil** встречаться в данных экземпляра. Указывает, может ли явное значение nil быть присвоено элементу. |
