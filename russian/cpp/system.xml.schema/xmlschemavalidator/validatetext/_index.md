---
title: "System::Xml::Schema::XmlSchemaValidator::ValidateText метод"
linktitle: "ValidateText"
second_title: "Aspose.Page для C++"
description: "System::Xml::Schema::XmlSchemaValidator::ValidateText метод. Проверяет, разрешена ли указанная строка текста в контексте текущего элемента, и собирает текст для проверки, если текущий элемент имеет простой контент в C++."
type: docs
weight: 2000
...
Проверяет, разрешена ли указанная текстовая **строка** в текущем контексте элемента, и собирает текст для проверки, если текущий элемент имеет простое содержимое.
