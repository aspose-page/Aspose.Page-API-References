---
title: "Класс System::Xml::Schema::XmlSchemaImport"
linktitle: "XmlSchemaImport"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaImport. Представляет элемент import из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс используется для импорта компонентов схем из других схем в C++."
type: docs
weight: 3500
...
Представляет элемент **import** из XML [Schema](../), определённый World Wide [Web](../../system.web/) Consortium (W3C). Этот класс используется для импорта компонентов схем из других схем.
