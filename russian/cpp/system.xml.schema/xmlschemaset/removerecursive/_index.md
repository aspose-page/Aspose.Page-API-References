...
description: "System::Xml::Schema::XmlSchemaSet::RemoveRecursive метод. Удаляет указанную XML Schema definition language (XSD) схему и все схемы, которые она импортирует, из XmlSchemaSet в C++."
type: docs
weight: 1400
