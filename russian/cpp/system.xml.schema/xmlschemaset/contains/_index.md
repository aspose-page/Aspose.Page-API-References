...
description: "System::Xml::Schema::XmlSchemaSet::Contains method. Указывает, находится ли указанный объект XML Schema языка определения (XSD) XmlSchema в XmlSchemaSet на C++."
type: docs
weight: 400
...
Указывает, находится ли указанный объект XML [Schema](../../) языка определения (XSD) [XmlSchema](../../xmlschema/) в [XmlSchemaSet](../).
