...
description: "System::Xml::Schema::XmlSchemaFractionDigitsFacet class. Задает ограничение на количество цифр, которые могут быть введены для дробного значения элемента simpleType. Значение fractionDigits должно быть положительным целым числом. Представляет facet fractionDigits консорциума World Wide Web Consortium (W3C) в C++."
type: docs
weight: 3000
url: /ru/cpp/system.xml.schema/xmlschemafractiondigitsfacet/
---
## XmlSchemaFractionDigitsFacet class


Задает ограничение на количество цифр, которые могут быть введены для дробного значения элемента simpleType. Значение fractionDigits должно быть положительным целым числом. Представляет консорциум World Wide [Web](../../system.web/) Consortium (W3C) **fractionDigits** facet.
...
| Метод | Описание |
| --- | --- |
| [XmlSchemaFractionDigitsFacet](./xmlschemafractiondigitsfacet/)() | Инициализирует новый экземпляр класса [XmlSchemaFractionDigitsFacet](./). |
## Typedefs
