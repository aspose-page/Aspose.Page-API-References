...
description: "System::Xml::Schema::XmlSchemaSimpleContentRestriction::get_BaseType метод. Возвращает базовое значение простого типа в C++."
type: docs
weight: 400
url: /ru/cpp/system.xml.schema/xmlschemasimplecontentrestriction/get_basetype/
---
## XmlSchemaSimpleContentRestriction::get_BaseType method


Возвращает базовое значение простого типа.
...
Базовое значение простого типа.
