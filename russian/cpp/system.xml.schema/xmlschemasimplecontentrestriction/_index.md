---
title: "Класс System::Xml::Schema::XmlSchemaSimpleContentRestriction"
linktitle: "XmlSchemaSimpleContentRestriction"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaSimpleContentRestriction. Представляет элемент ограничения для простого содержимого из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для создания простых типов посредством ограничения. Такие наследования могут использоваться для ограничения диапазона значений элемента до подмножества значений, указанных в унаследованном простом типе, в C++."
type: docs
weight: 6100
...
Представляет элемент **restriction** для простого содержимого из XML [Schema](../), как указано World Wide [Web](../../system.web/) Consortium (W3C). Этот класс может использоваться для создания простых типов посредством ограничения. Такие наследования могут использоваться для ограничения диапазона значений элемента до подмножества значений, указанных в унаследованном простом типе.
...
| [get_BaseTypeName](./get_basetypename/)() | Возвращает имя встроенного типа данных или простого типа, от которого происходит этот тип. |
...
| [set_BaseTypeName](./set_basetypename/)(const SharedPtr\<XmlQualifiedName\>\&) | Устанавливает имя встроенного типа данных или простого типа, от которого происходит этот тип. |
