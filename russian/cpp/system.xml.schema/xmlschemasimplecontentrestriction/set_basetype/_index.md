...
description: "System::Xml::Schema::XmlSchemaSimpleContentRestriction::set_BaseType method. Устанавливает базовое значение простого типа в C++."
type: docs
weight: 800
url: /ru/cpp/system.xml.schema/xmlschemasimplecontentrestriction/set_basetype/
---
## XmlSchemaSimpleContentRestriction::set_BaseType method


Устанавливает базовое значение простого типа.
