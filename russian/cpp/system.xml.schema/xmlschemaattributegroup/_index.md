...
Представляет элемент **attributeGroup** из XML [Schema](../) в соответствии со спецификацией World Wide [Web](../../system.web/) Consortium (W3C). AttributesGroups предоставляет механизм группировки набора объявлений атрибутов, чтобы их можно было включить как группу в определения сложных типов.
