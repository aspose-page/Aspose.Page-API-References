---
title: "Класс System::Xml::Schema::XmlSchemaObjectCollection"
linktitle: "XmlSchemaObjectCollection"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaObjectCollection. Коллекция объектов XmlSchemaObject в C++."
type: docs
weight: 5100
...
Коллекция объектов XmlSchemaObjects.
...
| [CopyTo](./copyto/)(const ArrayPtr\<SharedPtr\<XmlSchemaObject\>\>\&, int32_t) | Копирует все объекты XmlSchemaObject из коллекции в заданный массив, начиная с указанного индекса. |
| [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель для перебора объектов XmlSchemaObject, содержащихся в [XmlSchemaObjectCollection](./). |
