---
title: "System::Xml::Schema::XmlSchema::Read метод"
linktitle: "Read"
second_title: "Aspose.Page для C++"
description: "System::Xml::Schema::XmlSchema::Read метод. Считывает XML‑схему из предоставленного потока в C++."
type: docs
weight: 2900
...
| validationEventHandler | ValidationEventHandler | Обработчик события проверки, который получает информацию о синтаксических ошибках XML [Schema](../../). |
