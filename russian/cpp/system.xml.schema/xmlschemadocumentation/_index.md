...
description: "System::Xml::Schema::XmlSchemaDocumentation класс. Представляет элемент documentation из XML Schema, как указано консорциумом World Wide Web Consortium (W3C). Этот класс определяет информацию, которую люди могут читать или использовать в аннотации в C++."
type: docs
weight: 2500
...
Представляет элемент **documentation** из XML [Schema](../), как указано консорциумом World Wide [Web](../../system.web/) (W3C). Этот класс определяет информацию, которую люди могут читать или использовать в **annotation**.
