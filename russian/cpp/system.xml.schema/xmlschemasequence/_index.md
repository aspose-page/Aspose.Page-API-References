...
description: "System::Xml::Schema::XmlSchemaSequence класс. Представляет элемент sequence (композитор) из XML Schema, как указано World Wide Web Consortium (W3C). Элемент sequence требует, чтобы элементы в группе появлялись в указанном порядке внутри содержащего элемента в C++."
type: docs
weight: 5700
...
| Метод | Описание |
| --- | --- |
| [get_Items](./get_items/)() override | Элементы, содержащиеся в композиторе. Коллекция из [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) или [XmlSchemaAny](../xmlschemaany/). |
