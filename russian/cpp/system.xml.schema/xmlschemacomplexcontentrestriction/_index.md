---
title: "Класс System::Xml::Schema::XmlSchemaComplexContentRestriction"
linktitle: "XmlSchemaComplexContentRestriction"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaComplexContentRestriction. Представляет элемент restriction из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс предназначен для сложных типов с моделью сложного содержимого, полученной посредством ограничения. Он ограничивает содержимое сложного типа подмножеством унаследованного сложного типа в C++."
type: docs
weight: 2000
...
Представляет элемент **restriction** из XML [Schema](../), определённый World Wide [Web](../../system.web/) Consortium (W3C). Этот класс предназначен для сложных типов с моделью сложного содержимого, полученной посредством ограничения. Он ограничивает содержимое сложного типа подмножеством унаследованного сложного типа.
...
| [get_BaseTypeName](./get_basetypename/)() | Возвращает имя сложного типа, от которого этот тип наследуется посредством ограничения. |
...
| [set_BaseTypeName](./set_basetypename/)(const SharedPtr\<XmlQualifiedName\>\&) | Устанавливает имя сложного типа, от которого этот тип наследуется посредством ограничения. |
