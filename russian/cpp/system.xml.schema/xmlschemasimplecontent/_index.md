---
title: "Класс System::Xml::Schema::XmlSchemaSimpleContent"
linktitle: "XmlSchemaSimpleContent"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaSimpleContent. Представляет элемент simpleContent из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс предназначен для простых и сложных типов с простой моделью содержимого в C++."
type: docs
weight: 5900
...
Представляет элемент **simpleContent** из XML [Schema](../), определённый World Wide [Web](../../system.web/) Consortium (W3C). Этот класс предназначен для простых и сложных типов с простой моделью содержимого.
