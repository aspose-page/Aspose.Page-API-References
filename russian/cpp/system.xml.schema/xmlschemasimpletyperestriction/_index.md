---
title: "System::Xml::Schema::XmlSchemaSimpleTypeRestriction класс"
linktitle: "XmlSchemaSimpleTypeRestriction"
second_title: "Aspose.Page для C++"
description: "System::Xml::Schema::XmlSchemaSimpleTypeRestriction класс. Представляет элемент restriction для простых типов из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для ограничения элемента simpleType в C++."
type: docs
weight: 6500
