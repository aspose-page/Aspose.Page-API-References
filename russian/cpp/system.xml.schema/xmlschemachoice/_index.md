...
description: "Класс System::Xml::Schema::XmlSchemaChoice. Представляет элемент choice (композитор) из XML‑Schema, определённый World Wide Web Consortium (W3C). Элемент choice допускает появление только одного из своих дочерних элементов в экземпляре в C++."
type: docs
weight: 1400
...
Представляет элемент **choice** (композитор) из XML [Schema](../), определённый World Wide [Web](../../system.web/) Consortium (W3C). Элемент **choice** допускает появление только одного из своих дочерних элементов в экземпляре.
