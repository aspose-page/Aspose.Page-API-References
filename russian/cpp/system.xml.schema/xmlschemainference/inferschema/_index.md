...
description: "System::Xml::Schema::XmlSchemaInference::InferSchema метод. Выводит схему XML Schema Definition Language (XSD) из XML‑документа, содержащегося в указанном объекте XmlReader в C++."
type: docs
weight: 400
