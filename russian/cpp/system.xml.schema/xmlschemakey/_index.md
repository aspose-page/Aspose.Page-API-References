---
title: "Класс System::Xml::Schema::XmlSchemaKey"
linktitle: "XmlSchemaKey"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaKey. Этот класс представляет ключевой элемент из XMLSchema, как указано World Wide Web Consortium (W3C) в C++."
type: docs
weight: 3900
url: /ru/cpp/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey class


Этот класс представляет элемент **key** из XMLSchema, как указано World Wide [Web](../../system.web/) Consortium (W3C).
