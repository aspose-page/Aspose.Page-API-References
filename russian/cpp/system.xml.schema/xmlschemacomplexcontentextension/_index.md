...
description: "System::Xml::Schema::XmlSchemaComplexContentExtension класс. Представляет элемент **extension** из XML Schema, как указано Всемирным консорциумом Web (W3C). Этот класс предназначен для сложных типов с моделью сложного содержимого, полученной посредством расширения. Он расширяет сложный тип, добавляя атрибуты или элементы в C++."
type: docs
weight: 1900
...
Представляет элемент **extension** из XML [Schema](../), как указано Всемирным консорциумом [Web](../../system.web/) (W3C). Этот класс предназначен для сложных типов с моделью сложного содержимого, полученной посредством расширения. Он расширяет сложный тип, добавляя атрибуты или элементы.
