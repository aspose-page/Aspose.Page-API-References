...
description: "System::Xml::Schema::XmlSchemaLengthFacet class. Представляет фасет длины из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для указания ограничения длины элемента **simpleType** в типе данных в C++."
type: docs
weight: 4100
url: /ru/cpp/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet class


Представляет фасет **length** из XML [Schema](../) как указано World Wide [Web](../../system.web/) Consortium (W3C). Этот класс может использоваться для указания ограничения длины элемента **simpleType** в типе данных.
...
| Метод | Описание |
| --- | --- |
| [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Инициализирует новый экземпляр класса [XmlSchemaLengthFacet](./). |
## Typedefs
