...
description: "System::Xml::Schema::XmlSchemaInclude class. Представляет элемент include из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс используется для включения объявлений и определений из внешней схемы. Включённые объявления и определения затем доступны для обработки в содержащей схеме в C++."
type: docs
weight: 3600
...
Представляет элемент **include** из XML [Schema](../), как указано Всемирным консорциумом [Web](../../system.web/) (W3C). Этот класс используется для включения объявлений и определений из внешней схемы. Включённые объявления и определения затем доступны для обработки в содержащей схеме.
