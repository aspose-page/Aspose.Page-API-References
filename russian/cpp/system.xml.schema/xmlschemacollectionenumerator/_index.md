---
title: "System::Xml::Schema::XmlSchemaCollectionEnumerator класс"
linktitle: "XmlSchemaCollectionEnumerator"
second_title: "Aspose.Page для C++"
description: "System::Xml::Schema::XmlSchemaCollectionEnumerator класс. Поддерживает простую итерацию по коллекции. Этот класс не может быть унаследован в C++."
type: docs
weight: 1600
