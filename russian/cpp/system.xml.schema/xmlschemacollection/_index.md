---
title: "Класс System::Xml::Schema::XmlSchemaCollection"
linktitle: "XmlSchemaCollection"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::Schema::XmlSchemaCollection. Содержит кэш схем определения XML Schema (XSD) и XML-Data Reduced (XDR) на C++."
type: docs
weight: 1500
...
| Метод | Описание |
| --- | --- |
| [Add](./add/)(const String\&, const String\&) | Добавляет схему, найденную по указанному URL, в коллекцию схем. |
...
| [Add](./add/)(const SharedPtr\<XmlSchemaCollection\>\&) | Добавляет все пространства имён, определённые в заданной коллекции (включая связанные с ними схемы), в эту коллекцию. |
...
| [Contains](./contains/)(const String\&) | Возвращает значение, указывающее, присутствует ли схема с указанным пространством имён в коллекции. |
