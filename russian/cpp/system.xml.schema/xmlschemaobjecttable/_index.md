...
description: "System::Xml::Schema::XmlSchemaObjectTable class. Предоставляет коллекции для содержащихся элементов в классе XmlSchema (например, Attributes, AttributeGroups, Elements и т.д.) в C++."
type: docs
weight: 5300
...
Предоставляет коллекции для содержащихся элементов в классе [XmlSchema](../xmlschema/) (например, Attributes, AttributeGroups, Elements и т.д.).
