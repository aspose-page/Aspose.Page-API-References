---
title: "Метод System::Xml::Schema::XmlSchemaDatatype::ParseValue"
linktitle: "ParseValue"
second_title: "Aspose.Page для C++"
description: "Метод System::Xml::Schema::XmlSchemaDatatype::ParseValue. При переопределении в производном классе проверяет указанную строку на соответствие встроенному или пользовательскому простому типу в C++."
type: docs
weight: 700
...
| --- | --- | --- |
| s | String | Строка **string**, которую нужно проверить на соответствие простому типу. |
