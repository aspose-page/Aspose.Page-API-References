...
| [get_UseDefaultCredentials](./get_usedefaultcredentials/)() | Получает значение, указывающее, равен ли свойство "Credential" свойству "DefaultCredentials". |
...
| [set_Timeout](./set_timeout/)(int32_t) | Устанавливает интервал времени ожидания до истечения срока действия запроса. |
