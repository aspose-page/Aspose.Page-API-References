...
| [FindHeader](./findheader/)(System::ArrayPtr\<System::SharedPtr\<SoapHeaderMapping\>\>, const TypeInfo\&) | Находит сопоставление заголовка по указанному типу заголовка. |
...
| [get_Exception](./get_exception/)() | Получает исключение, которое генерируется методом XML [Web](../../system.web/) службы. |
| [get_Headers](./get_headers/)() | Возвращает коллекцию заголовков SOAP. |
| [get_InParameters](./get_inparameters/)() | Получает параметры, передаваемые в метод XML [Web](../../system.web/) службы. |
| [get_IsSoap12](./get_issoap12/)() | Возвращает значение, указывающее, используется ли версия SOAP 1.2. |
| [get_OutParameters](./get_outparameters/)() | Получает выходные параметры, передаваемые в метод XML [Web](../../system.web/) службы. |
...
| virtual [get_Url](./get_url/)() | Возвращает URL службы XML [Web](../../system.web/). |
...
| [GetReturnValue](./getreturnvalue/)() | Получает возвращаемое значение метода службы XML [Web](../../system.web/). |
...
| [set_InParameters](./set_inparameters/)(System::ArrayPtr\<System::SharedPtr\<Object\>\>) | Устанавливает параметры, передаваемые в метод XML [Web](../../system.web/) службы. |
...
| [set_OutParameters](./set_outparameters/)(System::ArrayPtr\<System::SharedPtr\<Object\>\>) | Устанавливает выходные параметры, передаваемые в метод XML [Web](../../system.web/) службы. |
| [SetException](./setexception/)(SoapException) | Устанавливает исключение, генерируемое методом XML [Web](../../system.web/) службы. |
| [SetHeaders](./setheaders/)(System::SharedPtr\<SoapHeaderCollection\>) | Устанавливает коллекцию заголовков SOAP. |
| [SetStage](./setstage/)(SoapMessageStage) | Устанавливает стадию обработки SOAP‑сообщения. |
