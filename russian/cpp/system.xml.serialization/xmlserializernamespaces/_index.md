...
description: "System::Xml::Serialization::XmlSerializerNamespaces класс. Содержит пространства имён XML и префиксы, которые Serialization::XmlSerializer использует для генерации квалифицированных имён в экземпляре XML‑документа в C++."
type: docs
weight: 800
...
Содержит пространства имён XML и префиксы, которые [Serialization::XmlSerializer](../xmlserializer/) использует для генерации квалифицированных имён в экземпляре XML‑документа.
