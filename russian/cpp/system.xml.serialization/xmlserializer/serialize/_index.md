...
description: "System::Xml::Serialization::XmlSerializer::Serialize method. Сериализует документ в XML в C++."
type: docs
weight: 300
url: /ru/cpp/system.xml.serialization/xmlserializer/serialize/
---
...
| --- | --- | --- |
| поток | System::SharedPtr\<IO::Stream\> | Поток назначения. |
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
...
| поток | System::SharedPtr\<IO::Stream\> | Поток назначения. |
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
| пространства имён | System::SharedPtr\<XmlSerializerNamespaces\> | Хранилище пространств имён. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| textWriter | System::SharedPtr\<IO::TextWriter\> | Поток назначения. |
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| xmlWriter | System::SharedPtr\<XmlWriter\> | Поток назначения. |
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
...
| o | System::SharedPtr\<Object\> | [Object](../../../system/object/) для сериализации. |
| пространства имён | System::SharedPtr\<XmlSerializerNamespaces\> | Хранилище пространств имён. |
| encodingStyle | String | Стиль, используемый при сериализации объекта. |
...
| пространства имён | System::SharedPtr\<XmlSerializerNamespaces\> | Хранилище пространств имён. |
| encodingStyle | String | Стиль, используемый при сериализации объекта. |
| id | String | [Object](../../../system/object/) id для использования при сериализации его. |
