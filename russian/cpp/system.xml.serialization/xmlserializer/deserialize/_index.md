---
title: "System::Xml::Serialization::XmlSerializer::Deserialize метод"
linktitle: "Deserialize"
second_title: "Aspose.Page для C++"
description: "System::Xml::Serialization::XmlSerializer::Deserialize метод. Десериализует XML-документ в объект в C++."
type: docs
weight: 200
url: /ru/cpp/system.xml.serialization/xmlserializer/deserialize/
---
...
| --- | --- | --- |
| поток | System::SharedPtr\<IO::Stream\> | Поток для чтения документа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| textReader | System::SharedPtr\<IO::TextReader\> | Читатель для чтения документа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| xmlReader | System::SharedPtr\<XmlReader\> | Читатель для чтения документа. |
...
| --- | --- | --- |
| xmlReader | System::SharedPtr\<XmlReader\> | Читатель для чтения документа. |
| encodingStyle | String | Стиль, используемый для сериализации объекта. |
