...
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Обеспечивает компиляцию, но на самом деле ничего не делает, так как эта структура не владеет данными. |
