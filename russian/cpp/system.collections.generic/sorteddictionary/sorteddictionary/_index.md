---
title: "System::Collections::Generic::SortedDictionary::SortedDictionary конструктор"
linktitle: "SortedDictionary"
second_title: "Aspose.Page для C++"
description: "System::Collections::Generic::SortedDictionary::SortedDictionary конструктор. Создаёт пустой словарь в C++."
type: docs
weight: 200
url: /ru/cpp/system.collections.generic/sorteddictionary/sorteddictionary/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<typename BasePointerType\<TKey\>::type\>\>\& | [Comparer](../../comparer/) для использования. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Исходный словарь, из которого копировать данные. |
