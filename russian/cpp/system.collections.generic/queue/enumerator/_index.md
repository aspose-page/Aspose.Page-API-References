...
| Метод | Описание |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Создаёт перечислитель, указывающий на конкретную очередь. |
## См. также
