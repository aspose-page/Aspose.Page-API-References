...
description: "System::Collections::Generic::Queue class. Предварительное объявление класса Queue в C++."
type: docs
weight: 3600
...
| [GetEnumerator](./getenumerator/)() override | Получает перечислитель для обхода очереди. |
