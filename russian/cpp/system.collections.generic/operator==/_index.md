...
description: "System::Collections::Generic::operator== метод. Сравнивает две пары ключ‑значение, используя ''equals'' семантику. Использует оператор == или метод EqualsTo для обоих ключей и значений, в зависимости от того, что определено в C++."
type: docs
weight: 5600
