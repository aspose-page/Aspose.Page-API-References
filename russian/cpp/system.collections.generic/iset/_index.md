...
| virtual [SymmetricExceptWith](./symmetricexceptwith/)(IEnumerablePtr) | Вычисляет симметрическое исключение двух контейнеров. Удаляет все элементы, присутствующие в обоих контейнерах, и одновременно добавляет все элементы, присутствующие в **other**, но отсутствующие в текущем наборе. |
