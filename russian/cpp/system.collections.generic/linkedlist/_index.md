---
title: "System::Collections::Generic::LinkedList класс"
linktitle: "LinkedList"
second_title: "Aspose.Page для C++"
description: "System::Collections::Generic::LinkedList класс. Предварительное объявление LinkedList в C++."
type: docs
weight: 3100
...
| [Find](./find/)(const T\&) const | Выполняет поиск в прямом направлении **element** в списке. |
| [FindLast](./findlast/)(const T\&) const | Выполняет поиск в обратном направлении **element** в списке. |
...
| [GetEnumerator](./getenumerator/)() override | Получает перечислитель для итерации по текущему [LinkedList](./). |
