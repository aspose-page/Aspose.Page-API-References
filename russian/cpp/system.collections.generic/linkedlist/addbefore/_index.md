...
description: "Метод System::Collections::Generic::LinkedList::AddBefore. Добавляет newNode перед узлом списка в C++."
type: docs
weight: 400
...
| --- | --- | --- |
| узел | const SharedPtr\<LinkedListNode\<T\>\>\& | Узел, перед которым нужно вставить |
