---
title: "метод System::Collections::Generic::List::Sort"
linktitle: "Sort"
second_title: "Aspose.Page для C++"
description: "Метод System::Collections::Generic::List::Sort. Сортирует элементы списка, используя компаратор по умолчанию, в C++."
type: docs
weight: 4400
