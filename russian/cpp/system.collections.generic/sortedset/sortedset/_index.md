---
title: "System::Collections::Generic::SortedSet::SortedSet конструктор"
linktitle: "SortedSet"
second_title: "Aspose.Page для C++"
description: "System::Collections::Generic::SortedSet::SortedSet конструктор. Информация RTTI в C++."
type: docs
weight: 100
url: /ru/cpp/system.collections.generic/sortedset/sortedset/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<T\>\>\& | [Comparer](../../comparer/) объект для связывания с [SortedSet](../). |
