---
title: "System::Collections::Generic::IEnumerable::LINQ_Any метод"
linktitle: "LINQ_Any"
second_title: "Aspose.Page для C++"
description: "System::Collections::Generic::IEnumerable::LINQ_Any метод. Определяет, содержит ли последовательность какие-либо элементы в C++."
type: docs
weight: 800
url: /ru/cpp/system.collections.generic/ienumerable/linq_any/
---
