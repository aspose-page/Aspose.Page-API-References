---
title: "System::Collections::Generic::IEnumerable класс"
linktitle: "IEnumerable"
second_title: "Aspose.Page для C++"
description: "System::Collections::Generic::IEnumerable класс. Интерфейс объекта, предоставляющего перечислитель над содержащимися элементами в C++."
type: docs
weight: 2200
...
| [LINQ_OrderBy](./linq_orderby/)(const Func\<T, Key\>\&) | Сортирует элементы последовательности по возрастанию в соответствии со значениями ключа, выбранными keySelector. |
| [LINQ_OrderBy](./linq_orderby/)(const Func\<Source, Key\>\&) |  |
| [LINQ_OrderByDescending](./linq_orderbydescending/)(const Func\<T, Key\>\&) | Сортирует элементы последовательности по убыванию в соответствии со значениями ключа, выбранными keySelector. |
...
| [LINQ_Take](./linq_take/)(int32_t) | Возвращает указанное количество смежных элементов с начала последовательности. |
...
| [LINQ_Where](./linq_where/)(std::function\<bool(T)>) | Фильтрует последовательность по указанному предикату. |
