...
| --- | --- | --- |
| map | const map_t\& | Map для копирования данных из. |
...
Перегрузка, соответствующая созданию предварительно выделенного словаря; фактически не выполняет выделения памяти.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| ёмкость | int | Ёмкость для выделения; игнорируется. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| capacity | int | [Dictionary](../) ёмкость после создания; игнорируется. |
| comparer | const SharedPtr\<IEqualityComparer\<TKey\>\>\& | [Comparer](../../comparer/) для использования. |
