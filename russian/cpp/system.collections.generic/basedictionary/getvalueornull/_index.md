...
description: "System::Collections::Generic::BaseDictionary::GetValueOrNull method. Возвращает значение, если найдено; иначе null. Имеет смысл только для ссылочных типов в C++."
type: docs
weight: 1500
url: /ru/cpp/system.collections.generic/basedictionary/getvalueornull/
---
