---
title: "System::Globalization::ChineseLunisolarCalendar::IsLeapMonth метод"
linktitle: "IsLeapMonth"
second_title: "Aspose.Page для C++"
description: "System::Globalization::ChineseLunisolarCalendar::IsLeapMonth метод. Проверяет, является ли месяц високосным в C++."
type: docs
weight: 1100
url: /ru/cpp/system.globalization/chineselunisolarcalendar/isleapmonth/
---
## ChineseLunisolarCalendar::IsLeapMonth(int, int) const method


Проверяет, является ли месяц високосным.
...
True, если указанный месяц високосный, иначе false.
