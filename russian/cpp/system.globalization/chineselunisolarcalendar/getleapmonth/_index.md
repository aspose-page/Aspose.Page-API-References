---
title: "System::Globalization::ChineseLunisolarCalendar::GetLeapMonth метод"
linktitle: "GetLeapMonth"
second_title: "Aspose.Page для C++"
description: "System::Globalization::ChineseLunisolarCalendar::GetLeapMonth метод. Получает високосный месяц для указанного года в C++."
type: docs
weight: 800
url: /ru/cpp/system.globalization/chineselunisolarcalendar/getleapmonth/
---
...
| --- | --- | --- |
| год | int | Год, для которого нужно получить високосный месяц. |
