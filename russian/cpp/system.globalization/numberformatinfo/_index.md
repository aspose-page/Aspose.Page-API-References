...
| [get_CurrencyDecimalDigits](./get_currencydecimaldigits/)() const | Получает количество десятичных знаков валюты. |
| [get_CurrencyDecimalSeparator](./get_currencydecimalseparator/)() const | Получает десятичный разделитель валюты. |
| [get_CurrencyGroupSeparator](./get_currencygroupseparator/)() const | Получает разделитель группировки валюты. |
| [get_CurrencyGroupSizes](./get_currencygroupsizes/)() const | Получает количество десятичных знаков валюты в группе. |
| [get_CurrencyNegativePattern](./get_currencynegativepattern/)() const | Получает шаблон отрицательной валюты. |
| [get_CurrencyPositivePattern](./get_currencypositivepattern/)() const | Получает шаблон положительной валюты. |
| [get_CurrencySymbol](./get_currencysymbol/)() const | Получает символ валюты. |
| static [get_CurrentInfo](./get_currentinfo/)() | Получает информацию о числовом формате, определённую культурой текущего потока. |
| [get_DigitSubstitution](./get_digitsubstitution/)() const | Получает значение, указывающее, как отображать форму цифры. |
| static [get_InvariantInfo](./get_invariantinfo/)() | Получает информацию о числовом формате, определённую инвариантной культурой. |
...
| [get_NumberGroupSeparator](./get_numbergroupseparator/)() const | Получает разделитель группировки чисел. |
...
| [get_PositiveSign](./get_positivesign/)() const | Получает знак плюс. |
...
| static [ReadOnly](./readonly/)(NumberFormatInfoPtr) | Получает только‑читаемую версию форматировщика. |
...
| [set_DigitSubstitution](./set_digitsubstitution/)(DigitShapes) | Устанавливает значение, определяющее отображение формы цифры. |
...
| [set_NegativeSign](./set_negativesign/)(const String\&) | Устанавливает знак минус. |
...
| [set_PercentDecimalDigits](./set_percentdecimaldigits/)(int) | Устанавливает количество десятичных знаков в процентных значениях. |
| [set_PercentDecimalSeparator](./set_percentdecimalseparator/)(const String\&) | Устанавливает десятичный разделитель в процентных значениях. |
| [set_PercentGroupSeparator](./set_percentgroupseparator/)(const String\&) | Устанавливает разделитель групп в процентных значениях. |
| [set_PercentGroupSizes](./set_percentgroupsizes/)(const ArrayPtr\<int\>\&) | Устанавливает количество цифр в каждой группе процентных значений. |
| [set_PercentNegativePattern](./set_percentnegativepattern/)(int) | Устанавливает шаблон отрицательного процента. |
| [set_PercentPositivePattern](./set_percentpositivepattern/)(int) | Устанавливает шаблон положительного процента. |
