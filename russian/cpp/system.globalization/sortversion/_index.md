---
title: "System::Globalization::SortVersion класс"
...
| [operator!=](./operator!=/)(const SortVersion\&) | Проверяет, что текущий экземпляр [SortVersion](./) не равен указанному объекту [SortVersion](./). |
