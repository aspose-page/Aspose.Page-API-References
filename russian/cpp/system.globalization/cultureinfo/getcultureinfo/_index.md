---
title: "System::Globalization::CultureInfo::GetCultureInfo метод"
linktitle: "GetCultureInfo"
second_title: "Aspose.Page для C++"
description: "System::Globalization::CultureInfo::GetCultureInfo метод. Получает культуру по её имени. То же, что и CreateSpecificCulture в C++."
type: docs
weight: 4200
url: /ru/cpp/system.globalization/cultureinfo/getcultureinfo/
---
...
| --- | --- | --- |
| name | const String\& | Предопределённое имя культуры или имя существующего объекта культуры. |

### ReturnValue

Новосозданный объект культуры.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| name | const String\& | Название культуры. |
| text_and_compare_culture_name | const String\& | Имя культуры, используемое для объектов [TextInfo](../../textinfo/) и [CompareInfo](../../compareinfo/). |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| культура | int32_t | Идентификатор культуры. |
