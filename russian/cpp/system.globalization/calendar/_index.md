...
| virtual [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const | Максимальная точка во времени, поддерживаемая календарём. |
| virtual [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const | Минимальная точка во времени, поддерживаемая календарём. |
| virtual [get_TwoDigitYearMax](./get_twodigityearmax/)() const | Получает последний год, который может быть представлен двухзначным. |
| virtual [GetDayOfMonth](./getdayofmonth/)(DateTime) const | Получает день месяца для указанной точки во времени. |
| virtual [GetDayOfWeek](./getdayofweek/)(DateTime) const | Получает день недели для указанной точки во времени. |
| virtual [GetDayOfYear](./getdayofyear/)(DateTime) const | Получает день года для указанной точки во времени. |
...
| virtual [GetEra](./getera/)(DateTime) const | Получает эпоху для указанной точки во времени. |
...
| virtual [GetMonth](./getmonth/)(DateTime) const | Получает месяц для указанной точки во времени. |
...
| virtual [GetWeekOfYear](./getweekofyear/)(DateTime, CalendarWeekRule, DayOfWeek) const | Получает номер недели года для указанного момента времени. |
...
| static [ReadOnly](./readonly/)(const CalendarPtr\&) | Получает только для чтения версию календаря. |
...
| virtual [ToFourDigitYear](./tofourdigityear/)(int) const | Преобразует год в 4-значный, используя свойство TwoDigitYearMax. |
## См. также
