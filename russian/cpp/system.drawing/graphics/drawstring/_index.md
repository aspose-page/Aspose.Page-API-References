---
title: "Метод System::Drawing::Graphics::DrawString"
linktitle: "DrawString"
second_title: "Aspose.Page для C++"
description: "Метод System::Drawing::Graphics::DrawString. Рисует указанную строку в указанном месте, используя указанный шрифт и кисть в C++."
type: docs
weight: 2800
...
| font | const SharedPtr\<Font\>\& | Шрифт для использования |
| brush | const SharedPtr\<Brush\>\& | Объект [Brush](../../brush/) для рисования |
| x | float | Координата X расположения верхнего левого угла нарисованной строки |
| y | float | Координата Y расположения верхнего левого угла нарисованной строки |
| stringFormat | const System::SharedPtr\<System::Drawing::StringFormat\>\& | Указывает формат строки |
...
| font | const SharedPtr\<Font\>\& | Шрифт для использования |
| brush | const SharedPtr\<Brush\>\& | Объект [Brush](../../brush/) для рисования |
| topLeft | PointF | Указывает расположение верхнего левого угла нарисованной строки |
| stringFormat | const System::SharedPtr\<System::Drawing::StringFormat\>\& | Указывает формат строки |
