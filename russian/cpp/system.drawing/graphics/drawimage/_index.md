---
title: "Метод System::Drawing::Graphics::DrawImage"
linktitle: "DrawImage"
second_title: "Aspose.Page для C++"
description: "Метод System::Drawing::Graphics::DrawImage. НЕ РЕАЛИЗОВАН в C++."
type: docs
weight: 1800
url: /ru/cpp/system.drawing/graphics/drawimage/
---
...
Рисует указанную область указанного изображения в указанном месте.
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destPoints | const ArrayPtr\<Point\>\& | Массив, содержащий три точки, определяющих параллелограмм на поверхности рисования, куда будет отрисовано изображение |
| srcRect | Rectangle | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
| imageAttr | const SharedPtr\<Imaging::ImageAttributes\>\& | Указывает информацию о цвете и гамме изображения |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| rect | const Rectangle\& | Прямоугольник, в который будет отрисовано изображение |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| rect | const RectangleF\& | Прямоугольник, в который будет отрисовано изображение |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | IGNORED |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destPoints | const System::ArrayPtr\<PointF\>\& | Массив, содержащий три точки, определяющих параллелограмм на поверхности рисования, куда будет отрисовано изображение |
| srcRect | const RectangleF\& | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Указывает информацию о цвете и гамме изображения |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Представление массива, содержащее три точки, определяющие параллелограмм на поверхности рисования, в который будет отрисовано изображение |
| srcRect | const RectangleF\& | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Указывает информацию о цвете и гамме изображения |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destPoints | const System::Details::StackArray\<PointF, N\>\& | Стековый массив, содержащий три точки, определяющие параллелограмм на поверхности рисования, в который будет отрисовано изображение |
| srcRect | const RectangleF\& | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Указывает информацию о цвете и гамме изображения |
...
Рисует указанное изображение в указанный прямоугольник.
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| x | float | Координата X верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| y | float | Координата Y верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| ширина | float | Ширина верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| высота | float | Высота верхнего левого угла прямоугольника, в который будет отрисовано изображение |
...
| x | float | Координата X верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| y | float | Координата Y верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| srcRect | RectangleF | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| x | int | Координата X верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| y | int | Координата Y верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| ширина | int | Ширина верхнего левого угла прямоугольника, в который будет отрисовано изображение |
| высота | int | Высота верхнего левого угла прямоугольника, в который будет отрисовано изображение |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| pt | Point | Расположение верхнего левого угла отрисованного изображения |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| pt | PointF | Расположение верхнего левого угла отрисованного изображения |
...
Рисует указанную область указанного изображения в указанный прямоугольник.
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destRect | Rectangle | Прямоугольник, в который будет отрисовано изображение |
| srcX | float | Координата X верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcY | float | Координата Y верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcWidth | float | Ширина верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcHeight | float | Высота верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, в которых задаются параметры **srcX**, **srcY**, **srcWidth** и **srcHeight** |
...
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destRect | Rectangle | Прямоугольник, в который будет отрисовано изображение |
| srcX | int | Координата X верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcY | int | Координата Y верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcWidth | int | Ширина верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcHeight | int | Высота верхнего левого угла прямоугольника, определяющего часть изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, в которых задаются параметры **srcX**, **srcY**, **srcWidth** и **srcHeight** |
...
| --- | --- | --- |
| изображение | const SharedPtr\<Image\>\& | Изображение для отрисовки |
| destRect | RectangleF | Прямоугольник, в который будет отрисовано изображение |
| srcRect | RectangleF | Прямоугольник, определяющий область указанного изображения для отрисовки |
| srcUnit | GraphicsUnit | Единицы измерения, используемые параметром **srcRect** |
