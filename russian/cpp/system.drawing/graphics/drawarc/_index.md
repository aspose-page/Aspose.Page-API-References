---
title: "Метод System::Drawing::Graphics::DrawArc"
linktitle: "DrawArc"
second_title: "Aspose.Page для C++"
description: "Метод System::Drawing::Graphics::DrawArc. Рисует указанную дугу с использованием указанного пера на поверхности, представленной текущим объектом, в C++."
type: docs
weight: 1000
url: /ru/cpp/system.drawing/graphics/drawarc/
---
## Graphics::DrawArc(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Рисует указанный дугу с использованием указанного пера на поверхности, представленной текущим объектом.
...
| --- | --- | --- |
| кисть | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании дуги |
...
| ширина | int32_t | Ширина прямоугольника, определяющего эллипс |
| высота | int32_t | Высота прямоугольника, определяющего эллипс |
...
| --- | --- | --- |
| кисть | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании дуги |
| rect | Rectangle | Прямоугольник, определяющий эллипс |
| startAngle | float | Угол в градусах, измеряемый по часовой стрелке от оси X до начальной точки дуги |
| sweepAngle | float | Угол в градусах, измеряемый по часовой стрелке от **startAngle** до конечной точки дуги |
...
| --- | --- | --- |
| кисть | const SharedPtr\<Pen\>\& | Перо, используемое при рисовании дуги |
| rect | RectangleF | Прямоугольник, определяющий эллипс |
| startAngle | float | Угол в градусах, измеряемый по часовой стрелке от оси X до начальной точки дуги |
| sweepAngle | float | Угол в градусах, измеряемый по часовой стрелке от **startAngle** до конечной точки дуги |
