...
description: "System::Drawing::Graphics::SetClip method. Устанавливает область отсечения поверхности рисования, представленной текущим объектом Graphics, в результат указанной операции, объединяющей текущую область отсечения и область, заданную графическим путем, в C++."
type: docs
weight: 8600
...
Устанавливает область отсечения поверхности рисования, представленной текущим объектом [Graphics](../), в результат указанной операции, объединяющей текущую область отсечения и указанную область.
