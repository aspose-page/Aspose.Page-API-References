...
description: "System::Drawing::Graphics::BeginContainer метод. Сохраняет контейнер с текущим состоянием этого объекта, открывает и использует новый контейнер и возвращает сохранённый контейнер в C++."
type: docs
weight: 600
...
| --- | --- | --- |
| dstrect | Rectangle | Прямоугольник, определяющий масштабное преобразование нового контейнера. Используется вместе с **srcrect** |
| srcrect | Rectangle | Прямоугольник, определяющий масштабное преобразование нового контейнера. Используется вместе с **dstrect** |
| единица | GraphicsUnit | Значение, определяющее единицу измерения нового контейнера |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| dstrect | RectangleF | Прямоугольник, определяющий масштабное преобразование нового контейнера. Используется вместе с **srcrect** |
| srcrect | RectangleF | Прямоугольник, определяющий масштабное преобразование нового контейнера. Используется вместе с **dstrect** |
| единица | GraphicsUnit | Значение, определяющее единицу измерения нового контейнера |
