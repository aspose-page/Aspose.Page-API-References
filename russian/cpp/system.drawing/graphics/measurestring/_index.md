...
| --- | --- | --- |
| str | String const\& | Строка, размер которой нужно вычислить |
| font | System::SharedPtr\<Font\> const\& | Шрифт, используемый для отрисовки строки |
| ширина | int | Максимальная ширина строки |
