---
title: "Метод System::Drawing::operator<<"
linktitle: "operator<<"
second_title: "Aspose.Page для C++"
description: "Метод System::Drawing::operator<<. Вставьте данные в поток, используя кодировку UTF‑8 в C++."
type: docs
weight: 3900
url: /ru/cpp/system.drawing/operator__/
---
...
| color | Color | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| point | const Point\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| point | const PointF\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| rectangle | const Rectangle\& | [Data](../../system.data/) для вставки. |
...
| --- | --- | --- |
| поток | std::ostream\& | Выходной поток для вставки данных. |
| rectangle | const RectangleF\& | [Data](../../system.data/) для вставки. |
