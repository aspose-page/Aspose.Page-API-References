...
description: "System::Drawing::Bitmap::LockBits метод. Блокирует объект Bitmap в системной памяти в C++."
type: docs
weight: 1500
...
| flags | Imaging::ImageLockMode | Указывает уровень доступа к растровому изображению |
| формат | Imaging::PixelFormat | Формат данных этого растрового изображения |
