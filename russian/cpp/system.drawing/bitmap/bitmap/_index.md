...
| --- | --- | --- |
| исходный | const SharedPtr\<Image\>\& | Существующее изображение, из которого создается bitmap-изображение. |
...
| --- | --- | --- |
| исходный | const SharedPtr\<Image\>\& | Существующее изображение, из которого создается bitmap-изображение. |
| ширина | int | Ширина нового изображения |
| высота | int | Высота нового изображения |
...
Создает новый объект [Bitmap](../), представляющий bitmap-изображение с указанными шириной, высотой, форматом пикселей и данными пикселей.
