...
description: "System::Drawing::Image::SaveAdd method. Добавляет кадр в файл или поток, указанный в предыдущем вызове метода Save() в C++."
type: docs
weight: 2300
url: /ru/cpp/system.drawing/image/saveadd/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| image | const SharedPtr\<Image\>\& | Объект [Image](../), содержащий кадр для добавления |
| encoder_params | const Imaging::EncoderParametersPtr\& | Параметры кодировщика для использования |
