...
| [get_DigitSubstitutionLanguage](./get_digitsubstitutionlanguage/)() const | Возвращает значение, указывающее язык, используемый при замене локальных цифр на западные. |
| [get_DigitSubstitutionMethod](./get_digitsubstitutionmethod/)() const | Возвращает метод замены цифр. |
| [get_FormatFlags](./get_formatflags/)() const | Возвращает побитовое сочетание [StringFormatFlags](../stringformatflags/), которое определяет формат строки, представленный текущим объектом. |
...
| [StringFormat](./stringformat/)(StringFormatFlags, int32_t) | Создает новый экземпляр класса [StringFormat](./) с указанными флагами формата и языком. |
