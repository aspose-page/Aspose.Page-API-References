---
title: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush конструктор"
linktitle: "LinearGradientBrush"
second_title: "Aspose.Page для C++"
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush конструктор. Создаёт новый экземпляр LinearGradientBrush в C++."
type: docs
weight: 100
url: /ru/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


Создаёт новый экземпляр [LinearGradientBrush](../).
...
| --- | --- | --- |
| point1 | const Point\& | Начальная точка градиента |
| point2 | const Point\& | Конечная точка градиента |
| color1 | const Color\& | Начальный цвет градиента |
| color2 | const Color\& | Конечный цвет градиента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| point1 | const PointF\& | Начальная точка градиента |
| point2 | const PointF\& | Конечная точка градиента |
| color1 | const Color\& | Начальный цвет градиента |
| color2 | const Color\& | Конечный цвет градиента |
## Примечания
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| rect | const Rectangle\& | Ограничивающий прямоугольник градиента |
| color1 | const Color\& | Начальный цвет градиента |
| color2 | const Color\& | Конечный цвет градиента |
| угол | float | Угол линии ориентации градиента; измеряется в градусах по часовой стрелке от оси X |
| isAngleScaleable | bool | Указывает, влияет ли угол градиента на трансформацию, связанную с кистью |
...
| color1 | const Color\& | Начальный цвет градиента |
| color2 | const Color\& | Конечный цвет градиента |
| linearGradientMode | LinearGradientMode | Направление градиента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| rect | const RectangleF\& | Ограничивающий прямоугольник градиента |
| color1 | const Color\& | Начальный цвет градиента |
| color2 | const Color\& | Конечный цвет градиента |
| угол | float | Угол линии ориентации градиента; измеряется в градусах по часовой стрелке от оси X |
| isAngleScaleable | bool | Указывает, влияет ли угол градиента на трансформацию, связанную с кистью |
