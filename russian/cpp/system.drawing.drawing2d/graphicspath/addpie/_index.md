---
title: "System::Drawing::Drawing2D::GraphicsPath::AddPie метод"
linktitle: "AddPie"
second_title: "Aspose.Page для C++"
description: "System::Drawing::Drawing2D::GraphicsPath::AddPie метод. Добавляет указанный контур формы пирога к пути, представленному текущим объектом в C++."
type: docs
weight: 1200
url: /ru/cpp/system.drawing.drawing2d/graphicspath/addpie/
---
## GraphicsPath::AddPie(const Rectangle\&, float, float) method


Добавляет указанный контур формы сектора к пути, представленному текущим объектом.
...
| --- | --- | --- |
| rect | const Rectangle\& | Прямоугольник, ограничивающий эллипс, из которого рисуется пирог |
...
| ширина | float | Ширина прямоугольника, ограничивающего эллипс, из которого рисуется пирог |
| высота | float | Высота прямоугольника, ограничивающего эллипс, из которого рисуется пирог |
| startAngle | float | Указывает начальный угол пирога в градусах, измеряемый по часовой стрелке от оси X |
| sweepAngle | float | Указывает угол между начальным углом и концом пирога |
...
| ширина | int | Ширина прямоугольника, ограничивающего эллипс, из которого рисуется пирог |
| высота | int | Высота прямоугольника, ограничивающего эллипс, из которого рисуется пирог |
| startAngle | float | Указывает начальный угол пирога в градусах, измеряемый по часовой стрелке от оси X |
| sweepAngle | float | Указывает угол между начальным углом и концом пирога |
