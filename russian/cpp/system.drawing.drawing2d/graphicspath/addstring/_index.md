---
title: "Метод System::Drawing::Drawing2D::GraphicsPath::AddString"
linktitle: "AddString"
second_title: "Aspose.Page для C++"
description: "Метод System::Drawing::Drawing2D::GraphicsPath::AddString. Добавляет строку текста к пути, представленному текущим объектом, в C++."
type: docs
weight: 1600
url: /ru/cpp/system.drawing.drawing2d/graphicspath/addstring/
---
## GraphicsPath::AddString(const String\&, const SharedPtr\<FontFamily\>\&, int, float, Point, const SharedPtr\<StringFormat\>\&) method


Добавляет строку текста к пути, представленному текущим объектом.
...
| --- | --- | --- |
| text | const String\& | Текст для добавления |
| семейство | const SharedPtr\<FontFamily\>\& | Семейство шрифтов, используемое для отрисовки текста |
| style | int | Значение перечисления [FontStyle](../../../system.drawing/fontstyle/), указывающее стиль шрифта для использования |
| emSize | float | Высота квадратного блока em, ограничивающего каждый символ строки |
| origin | Point | Указывает расположение, где начинается текст |
| stringFormat | const SharedPtr\<StringFormat\>\& | Формат строки |
...
| style | int | Значение перечисления [FontStyle](../../../system.drawing/fontstyle/), указывающее стиль шрифта для использования |
| emSize | float | Высота квадратного блока em, ограничивающего каждый символ строки |
| origin | PointF | Указывает расположение, где начинается текст |
| stringFormat | const SharedPtr\<StringFormat\>\& | Формат строки |
...
| style | int | Значение перечисления [FontStyle](../../../system.drawing/fontstyle/), указывающее стиль шрифта для использования |
| emSize | float | Высота квадратного блока em, ограничивающего каждый символ строки |
| layoutRect | Rectangle | Прямоугольник, ограничивающий текст |
| stringFormat | const SharedPtr\<StringFormat\>\& | Формат строки |
...
| style | int | Значение перечисления [FontStyle](../../../system.drawing/fontstyle/), указывающее стиль шрифта для использования |
| emSize | float | Высота квадратного блока em, ограничивающего каждый символ строки |
| layoutRect | RectangleF | Прямоугольник, ограничивающий текст |
| stringFormat | const SharedPtr\<StringFormat\>\& | Формат строки |
