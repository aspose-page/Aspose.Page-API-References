...
description: "System::Net::Http::Headers::AuthenticationHeaderValue::ToString метод. Аналог метода C# Object.ToString(). Позволяет преобразовывать пользовательские объекты в строку в C++."
type: docs
weight: 700
url: /ru/cpp/system.net.http.headers/authenticationheadervalue/tostring/
---
