...
description: "System::Net::Http::Headers::AuthenticationHeaderValue::Parse метод. Преобразует переданную строку в экземпляр класса AuthenticationHeaderValue в C++."
type: docs
weight: 900
url: /ru/cpp/system.net.http.headers/authenticationheadervalue/parse/
---
