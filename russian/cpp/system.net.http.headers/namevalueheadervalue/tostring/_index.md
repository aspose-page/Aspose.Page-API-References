---
title: "System::Net::Http::Headers::NameValueHeaderValue::ToString метод"
linktitle: "ToString"
second_title: "Aspose.Page для C++"
description: "System::Net::Http::Headers::NameValueHeaderValue::ToString метод. Аналог метода C# Object.ToString(). Позволяет преобразовывать пользовательские объекты в строку в C++."
type: docs
weight: 700
url: /ru/cpp/system.net.http.headers/namevalueheadervalue/tostring/
---
...
Возвращает строковое представление коллекции экземпляров класса NameValueHeaderValue.
...
| --- | --- | --- |
| значения | System::SharedPtr\<ObjectCollection\<System::SharedPtr\<NameValueHeaderValue\>\>\> | Коллекция экземпляров класса NameValueHeaderValue. |
| разделитель | char16_t | Строковый разделитель. |
| leadingSeparator | bool | Значение, указывающее, должен ли строковый разделитель быть добавлен перед первым элементом коллекции. |

### ReturnValue

Строковое представление коллекции экземпляров класса NameValueHeaderValue.
...
| разделитель | char16_t | Строковый разделитель. |
| leadingSeparator | bool | Значение, указывающее, должен ли строковый разделитель быть добавлен перед первым элементом коллекции. |
| destination | System::SharedPtr\<Text::StringBuilder\> | Экземпляр, в который будет присвоено строковое представление. |
