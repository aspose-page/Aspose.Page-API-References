---
title: "Метод System::Net::Http::Headers::NameValueHeaderValue::GetHashCode"
linktitle: "GetHashCode"
second_title: "Aspose.Page для C++"
description: "Метод System::Net::Http::Headers::NameValueHeaderValue::GetHashCode. Аналог метода C# Object.GetHashCode(). Позволяет хешировать пользовательские объекты в C++."
type: docs
weight: 500
url: /ru/cpp/system.net.http.headers/namevalueheadervalue/gethashcode/
---
...
Возвращает хеш‑код всех элементов коллекции.
...
Хеш‑код всех элементов коллекции.
