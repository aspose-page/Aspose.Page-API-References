---
title: "System::Net::Http::Headers::RetryConditionHeaderValue::GetRetryConditionLength метод"
linktitle: "GetRetryConditionLength"
second_title: "Aspose.Page для C++"
description: "System::Net::Http::Headers::RetryConditionHeaderValue::GetRetryConditionLength метод. Преобразует переданную строку, начиная с указанного индекса, в экземпляр класса RetryConditionHeaderValue в C++."
type: docs
weight: 700
url: /ru/cpp/system.net.http.headers/retryconditionheadervalue/getretryconditionlength/
---
