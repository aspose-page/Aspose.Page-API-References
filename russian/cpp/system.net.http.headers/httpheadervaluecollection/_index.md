...
| [get_IsReadOnly](./get_isreadonly/)() | Получает значение, указывающее, является ли текущая коллекция только для чтения. |
| [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Получает значение, указывающее, содержит ли текущая коллекция "специальное значение". |
