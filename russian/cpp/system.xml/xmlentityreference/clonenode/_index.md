...
| --- | --- | --- |
| deep | bool | **true** для рекурсивного клонирования поддерева под указанным узлом; **false** для клонирования только самого узла. Для узлов [XmlEntityReference](../) этот метод всегда возвращает узел ссылки на сущность без дочерних элементов. Текст замены устанавливается, когда узел вставляется в родитель. |
