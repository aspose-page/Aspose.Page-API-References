...
description: "System::Xml::XmlNamedNodeMap::GetNamedItem method. Получает узел с совпадающими значениями XmlNode::get_LocalName и XmlNode::get_NamespaceURI в C++."
type: docs
weight: 700
...
| namespaceURI | String | Унифицированный идентификатор ресурса (URI) пространства имён узла для получения. |
...
Получает [XmlNode](../../xmlnode/), указанный по имени.
