...
description: "System::Xml::XmlTextReader::GetNamespacesInScope method. Возвращает коллекцию, содержащую все пространства имён, находящиеся в текущей области видимости, в C++."
type: docs
weight: 3400
