...
description: "Класс System::Xml::XmlTextReader. Представляет читатель, предоставляющий быстрый, некешированный, только прямой доступ к XML‑данным в C++."
type: docs
weight: 3900
...
| [get_NamespaceURI](./get_namespaceuri/)() override | Возвращает URI пространства имён (как определено в спецификации W3C Namespace) узла, на котором находится считыватель. |
...
| [get_Normalization](./get_normalization/)() | Возвращает значение, указывающее, следует ли нормализовать пробелы и значения атрибутов. |
...
| [get_WhitespaceHandling](./get_whitespacehandling/)() | Возвращает значение, определяющее, как обрабатываются пробелы. |
...
| [ReadBase64](./readbase64/)(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) | Декодирует Base64 и возвращает декодированные бинарные байты. |
| [ReadBinHex](./readbinhex/)(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) | Декодирует **BinHex** и возвращает декодированные бинарные байты. |
...
| [ReadContentAsBase64](./readcontentasbase64/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Считывает содержимое и возвращает декодированные из **Base64** бинарные байты. |
| [ReadContentAsBinHex](./readcontentasbinhex/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Считывает содержимое и возвращает декодированные из **BinHex** бинарные байты. |
...
| [ResetState](./resetstate/)() | Сбрасывает состояние читателя к [ReadState::Initial](../readstate/). |
...
| [set_WhitespaceHandling](./set_whitespacehandling/)(System::Xml::WhitespaceHandling) | Устанавливает значение, которое определяет, как обрабатываются пробелы. |
...
| [Skip](./skip/)() override | Пропускает дочерние элементы текущего узла. |
