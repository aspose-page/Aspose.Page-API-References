...
| --- | --- | --- |
| буфер | const ArrayPtr\<char16_t\>\& | Массив символов, который служит буфером, в который записывается текстовое содержимое. |
...
Количество считанных символов. Может быть 0, если читатель не находится на элементе или если в текущем контексте нет больше текстового содержимого для возврата.
