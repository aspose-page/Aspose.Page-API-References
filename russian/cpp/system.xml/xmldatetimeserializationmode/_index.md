...
description: "System::Xml::XmlDateTimeSerializationMode enum. Указывает, как обрабатывать значение времени при преобразовании между строкой и DateTime в C++."
type: docs
weight: 5800
...
| --- | --- | --- |
| Local | 0 | Обрабатывать как локальное время. Если объект [DateTime](../../system/datetime/) представляет координированное всемирное время (UTC), он преобразуется в локальное время. |
