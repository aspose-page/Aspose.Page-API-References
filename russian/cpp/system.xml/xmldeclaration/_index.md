---
title: "System::Xml::XmlDeclaration класс"
linktitle: "XmlDeclaration"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlDeclaration класс. Представляет узел объявления XML <?xml version=''1.0''...?> в C++."
type: docs
weight: 1300
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Сохраняет дочерние элементы узла в указанный [XmlWriter](../xmlwriter/). Поскольку узлы [XmlDeclaration](./) не имеют дочерних элементов, этот метод не оказывает эффекта. |
