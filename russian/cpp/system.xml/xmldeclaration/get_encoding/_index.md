...
Это значение является необязательным. Если значение не задано, этот метод возвращает [String::Empty](../../../system/string/empty/). Если атрибут кодировки не указан, предполагается кодировка UTF-8 при записи или сохранении документа.
## См. также
