...
| --- | --- | --- |
| префикс | const String\& | Префикс, URI пространства имён которого необходимо разрешить. Чтобы соответствовать пространству имён по умолчанию, передайте пустую строку. |
