...
description: "System::Xml::NameTable::Add method. Атомизирует указанную строку и добавляет её в NameTable в C++."
type: docs
weight: 200
...
| start | int32_t | Нулевой индекс в массиве, указывающий первый символ строки. |
