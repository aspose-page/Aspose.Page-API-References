...
description: "System::Xml::XmlNodeReader::LookupNamespace метод. Разрешает префикс пространства имён в области действия текущего элемента в C++."
type: docs
weight: 2500
...
| --- | --- | --- |
| префикс | const String\& | Префикс, пространство имён которого вы хотите разрешить. Чтобы соответствовать пространству имён по умолчанию, передайте пустую строку. Эта строка не обязана быть атомизирована. |
