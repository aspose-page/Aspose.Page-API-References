...
description: "System::Xml::XmlNodeReader class. Представляет читатель, который обеспечивает быстрый, некешированный, только прямой доступ к XML-данным в XmlNode в C++."
type: docs
weight: 2800
