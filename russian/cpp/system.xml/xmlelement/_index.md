---
title: "Класс System::Xml::XmlElement"
linktitle: "XmlElement"
second_title: "Aspose.Page для C++"
description: "Класс System::Xml::XmlElement. Представляет элемент в C++."
type: docs
weight: 1700
...
| [get_InnerXml](./get_innerxml/)() override | Возвращает разметку, представляющую только дочерние элементы этого узла. |
