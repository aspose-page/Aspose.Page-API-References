...
description: "System::Xml::XmlDocument::CreateDocumentType метод. Возвращает новый объект XmlDocumentType на C++."
type: docs
weight: 700
...
| --- | --- | --- |
| name | const String\& | Имя типа документа. |
| publicId | const String\& | Публичный идентификатор типа документа или **nullptr**. Вы можете указать публичный URI, а также системный идентификатор для указания местоположения внешнего подмножества DTD. |
