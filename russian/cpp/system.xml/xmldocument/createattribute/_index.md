---
title: "Метод System::Xml::XmlDocument::CreateAttribute"
linktitle: "CreateAttribute"
second_title: "Aspose.Page для C++"
description: "Метод System::Xml::XmlDocument::CreateAttribute. Создаёт XmlAttribute с указанным именем в C++."
type: docs
weight: 300
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| qualifiedName | const String\& | Квалифицированное имя атрибута. Если имя содержит двоеточие, значение [XmlNode::get_Prefix](../../xmlnode/get_prefix/) будет отражать часть имени до двоеточия, а значение [XmlDocument::get_LocalName](../get_localname/) будет отражать часть имени после двоеточия. |
