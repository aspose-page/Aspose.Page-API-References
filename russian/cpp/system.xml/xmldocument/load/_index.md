---
title: "System::Xml::XmlDocument::Load метод"
linktitle: "Загрузить"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlDocument::Load метод. Загружает XML‑документ из указанного потока в C++."
type: docs
weight: 3400
url: /ru/cpp/system.xml/xmldocument/load/
---
...
| --- | --- | --- |
| inStream | SharedPtr\<IO::Stream\> | Поток, содержащий XML‑документ для загрузки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| txtReader | SharedPtr\<IO::TextReader\> | TextReader, используемый для подачи XML‑данных в документ. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| reader | SharedPtr\<XmlReader\> | Экземпляр [XmlReader](../../xmlreader/) используется для подачи XML‑данных в документ. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| filename | String | URL файла, содержащего XML‑документ для загрузки. URL может быть как локальным файлом, так и HTTP‑URL (адресом [Web](../../../system.web/)). |
