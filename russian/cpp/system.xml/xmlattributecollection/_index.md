...
description: "System::Xml::XmlAttributeCollection class. Представляет коллекцию атрибутов, к которым можно получить доступ по имени или индексу в C++."
type: docs
weight: 700
...
| [idx_get](./idx_get/)(const String\&, const String\&) | Возвращает атрибут с указанным локальным именем и URI пространства имён (Uniform Resource Identifier). |
...
| [Prepend](./prepend/)(const SharedPtr\<XmlAttribute\>\&) | Вставляет указанный атрибут в качестве первого узла в коллекции. |
...
| [RemoveAt](./removeat/)(int32_t) | Удаляет атрибут, соответствующий указанному индексу, из коллекции. |
| [SetNamedItem](./setnameditem/)(SharedPtr\<XmlNode\>) override | Добавляет [XmlNode](../xmlnode/) с использованием результата его [XmlNode::get_Name](../xmlnode/get_name/). |
## Typedefs
