---
title: "System::Xml::XmlSignificantWhitespace класс"
linktitle: "XmlSignificantWhitespace"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlSignificantWhitespace класс. Представляет пробельные символы между разметкой в узле смешанного содержимого или пробелы в области xml:space=''preserve''. Это также называется значимыми пробельными символами в C++."
type: docs
weight: 3700
...
Представляет пробелы между разметкой в узле смешанного содержимого или пробелы внутри области **xml:space='preserve'**. Это также называется значимыми пробелами.
