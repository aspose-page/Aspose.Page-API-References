---
title: "Метод System::Xml::XmlWriterSettings::get_NewLineOnAttributes"
linktitle: "get_NewLineOnAttributes"
second_title: "Aspose.Page для C++"
description: "Метод System::Xml::XmlWriterSettings::get_NewLineOnAttributes. Возвращает значение, указывающее, следует ли записывать атрибуты на новой строке в C++."
type: docs
weight: 1300
url: /ru/cpp/system.xml/xmlwritersettings/get_newlineonattributes/
---
