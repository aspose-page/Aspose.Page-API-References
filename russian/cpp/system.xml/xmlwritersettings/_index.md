---
title: "Класс System::Xml::XmlWriterSettings"
linktitle: "XmlWriterSettings"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlWriterSettings класс. Указывает набор функций, поддерживаемых объектом XmlWriter, созданным методом XmlWriter::Create в C++."
type: docs
weight: 4500
...
| [get_CheckCharacters](./get_checkcharacters/)() | Возвращает значение, указывающее, должен ли XML‑writer проверять, что все символы в документе соответствуют разделу "2.2 Characters" рекомендации W3C [XML 1.0 Recommendation](https://www.w3.org/TR/REC-xml/#charsets). |
...
| [get_ConformanceLevel](./get_conformancelevel/)() | Возвращает уровень соответствия, который XML‑writer проверяет в выводе XML. |
...
| [get_Indent](./get_indent/)() | Возвращает значение, указывающее, следует ли делать отступы элементов. |
...
| [get_WriteEndDocumentOnClose](./get_writeenddocumentonclose/)() | Возвращает значение, указывающее, будет ли [XmlWriter](../xmlwriter/) добавлять закрывающие теги ко всем незакрытым элементам при вызове метода [XmlWriter::Close](../xmlwriter/close/). |
...
| [set_Encoding](./set_encoding/)(const SharedPtr\<System::Text::Encoding\>\&) | Устанавливает тип используемой текстовой кодировки. |
| [set_Indent](./set_indent/)(bool) | Устанавливает значение, указывающее, следует ли делать отступы элементов. |
| [set_IndentChars](./set_indentchars/)(const String\&) | Устанавливает строку символов, используемую при отступе. Этот параметр используется, когда значение [XmlWriterSettings::set_Indent](./set_indent/) установлено в **true**. |
| [set_NamespaceHandling](./set_namespacehandling/)(System::Xml::NamespaceHandling) | Устанавливает значение, указывающее, должен ли [XmlWriter](../xmlwriter/) удалять дублирующие объявления пространств имён при записи XML‑содержимого. Поведение по умолчанию заключается в том, что запись выводит все объявления пространств имён, присутствующие в разрешателе пространств имён записи. |
