---
title: "System::Xml::XmlResolver::SupportsType метод"
linktitle: "SupportsType"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlResolver::SupportsType метод. Позволяет резолверу возвращать типы, отличные от Stream, в C++."
type: docs
weight: 400
