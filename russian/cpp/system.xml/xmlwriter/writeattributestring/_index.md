---
title: "Метод System::Xml::XmlWriter::WriteAttributeString"
linktitle: "WriteAttributeString"
second_title: "Aspose.Page для C++"
description: "Метод System::Xml::XmlWriter::WriteAttributeString. При переопределении в производном классе записывает атрибут с указанным локальным именем, URI пространства имён и значением в C++."
type: docs
weight: 1000
url: /ru/cpp/system.xml/xmlwriter/writeattributestring/
---
...
| ns | const String\& | URI пространства имён, ассоциируемый с атрибутом. |
| value | const String\& | Значение атрибута. |
