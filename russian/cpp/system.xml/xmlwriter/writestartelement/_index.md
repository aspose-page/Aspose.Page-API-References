...
При переопределении в производном классе выводит начальный тег с указанным локальным именем.
...
При переопределении в производном классе записывает указанный начальный тег и связывает его с заданным пространством имён.
...
| --- | --- | --- |
| localName | const String\& | Локальное имя элемента. |
| ns | const String\& | URI пространства имён, который следует связать с элементом. Если это пространство имён уже находится в области видимости и имеет связанный префикс, писатель автоматически также записывает этот префикс. |
...
При переопределении в производном классе записывает указанный начальный тег и связывает его с заданным пространством имён и префиксом.
...
| localName | const String\& | Локальное имя элемента. |
| ns | const String\& | URI пространства имён, который следует связать с элементом. |
