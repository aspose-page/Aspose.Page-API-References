...
description: "System::Xml::XmlEntity::CloneNode метод. Создаёт дубликат этого узла. Узлы сущностей нельзя клонировать. Вызов этого метода для объекта XmlEntity вызывает исключение в C++."
type: docs
weight: 100
...
Создаёт дубликат этого узла. Узлы сущностей нельзя клонировать. Вызов этого метода для объекта [XmlEntity](../) вызывает исключение.
