---
title: "System::Xml::XmlParserContext::XmlParserContext конструктор"
linktitle: "XmlParserContext"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlParserContext::XmlParserContext конструктор. Инициализирует новый экземпляр класса XmlParserContext с указанными XmlNameTable, XmlNamespaceManager, базовым URI, xml:lang, xml:space и значениями типа документа в C++."
type: docs
weight: 100
...
| --- | --- | --- |
| nt | const SharedPtr\<XmlNameTable\>\& | Элемент [XmlNameTable](../../xmlnametable/) для атомизации строк. Если это **nullptr**, используется таблица имён, применённая при построении **nsMgr**. Для получения дополнительной информации об атомизованных строках см. [XmlNameTable](../../xmlnametable/). |
| nsMgr | const SharedPtr\<XmlNamespaceManager\>\& | Элемент [XmlNamespaceManager](../../xmlnamespacemanager/) для поиска информации о пространствах имён, или **nullptr**. |
...
| xmlSpace | System::Xml::XmlSpace | Значение [XmlSpace](../../xmlspace/), указывающее область **xml:space**. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| nt | const SharedPtr\<XmlNameTable\>\& | Класс [XmlNameTable](../../xmlnametable/), используемый для атомизации строк. Если это **nullptr**, используется таблица имён, применённая при построении **nsMgr**. Для получения дополнительной информации об атомизированных строках см. [XmlNameTable](../../xmlnametable/). |
| nsMgr | const SharedPtr\<XmlNamespaceManager\>\& | Элемент [XmlNamespaceManager](../../xmlnamespacemanager/) для поиска информации о пространствах имён, или **nullptr**. |
| xmlLang | const String\& | Область **xml:lang**. |
| xmlSpace | System::Xml::XmlSpace | Значение [XmlSpace](../../xmlspace/), указывающее область **xml:space**. |
| enc | const SharedPtr\<System::Text::Encoding\>\& | Объект Encoding, указывающий настройку кодировки. |
