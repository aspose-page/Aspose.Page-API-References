...
description: "Класс System::Xml::XmlParserContext. Предоставляет всю контекстную информацию, необходимую XmlReader для разбора XML‑фрагмента на C++."
type: docs
weight: 3000
...
| [get_InternalSubset](./get_internalsubset/)() | Возвращает внутреннее подмножество DTD. |
...
| [set_InternalSubset](./set_internalsubset/)(const String\&) | Устанавливает внутреннее подмножество DTD. |
...
| [set_XmlLang](./set_xmllang/)(const String\&) | Устанавливает текущую область **xml:lang**. |
| [set_XmlSpace](./set_xmlspace/)(System::Xml::XmlSpace) | Устанавливает текущую область **xml:space**. |
