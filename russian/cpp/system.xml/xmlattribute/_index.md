...
description: "Класс System::Xml::XmlAttribute. Представляет атрибут. Допустимые и значения по умолчанию для атрибута определяются в определении типа документа (DTD) или схеме в C++."
type: docs
weight: 600
...
| Метод | Описание |
| --- | --- |
| [AppendChild](./appendchild/)(SharedPtr\<XmlNode\>) override | Добавляет указанный узел в конец списка дочерних узлов данного узла. |
...
| [InsertAfter](./insertafter/)(SharedPtr\<XmlNode\>, SharedPtr\<XmlNode\>) override | Вставляет указанный узел непосредственно после указанного узла‑ссылки. |
| [InsertBefore](./insertbefore/)(SharedPtr\<XmlNode\>, SharedPtr\<XmlNode\>) override | Вставляет указанный узел непосредственно перед указанным узлом‑ссылкой. |
