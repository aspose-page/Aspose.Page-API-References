...
| --- | --- | --- |
| node | const SharedPtr\<XmlNode\>\& | Элемент [XmlNode](../../xmlnode/), который сгенерировал событие. |
| oldParent | const SharedPtr\<XmlNode\>\& | Старый родительский [XmlNode](../../xmlnode/) элемента [XmlNode](../../xmlnode/), который сгенерировал событие. |
| newParent | const SharedPtr\<XmlNode\>\& | Новый родительский [XmlNode](../../xmlnode/) элемента [XmlNode](../../xmlnode/), который сгенерировал событие. |
...
| action | XmlNodeChangedAction | Элемент [XmlNodeChangedAction](../../xmlnodechangedaction/). |
