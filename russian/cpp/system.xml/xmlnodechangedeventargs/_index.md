...
description: "System::Xml::XmlNodeChangedEventArgs класс. Предоставляет данные для событий XmlDocument::NodeChanged, XmlDocument::NodeChanging, XmlDocument::NodeInserted, XmlDocument::NodeInserting, XmlDocument::NodeRemoved и XmlDocument::NodeRemoving в C++."
type: docs
weight: 2600
...
| Метод | Описание |
| --- | --- |
| [get_Action](./get_action/)() | Возвращает значение, указывающее, какой тип события изменения узла происходит. |
