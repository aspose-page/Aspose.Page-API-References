...
description: "System::Xml::XmlNode::get_LocalName метод. Возвращает локальное имя узла, когда переопределено в производном классе в C++."
type: docs
weight: 1400
...
|-|-|
| Тип | Имя |
| Attribute | Локальное имя атрибута. |
| CDATA | #cdata-section |
| Comment | #comment |
| Document | #document |
