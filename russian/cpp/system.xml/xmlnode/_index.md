---
title: "System::Xml::XmlNode класс"
linktitle: "XmlNode"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlNode класс. Представляет отдельный узел в XML‑документе в C++."
type: docs
weight: 2500
...
| Метод | Описание |
| --- | --- |
| virtual [AppendChild](./appendchild/)(SharedPtr\<XmlNode\>) | Добавляет указанный узел в конец списка дочерних узлов данного узла. |
| virtual [Clone](./clone/)() | Создаёт дубликат этого узла. |
| virtual [CloneNode](./clonenode/)(bool) | Создаёт копию узла, когда переопределяется в производном классе. |
| [CreateNavigator](./createnavigator/)() override | Создает XPathNavigator для навигации по этому объекту. |
| virtual [get_Attributes](./get_attributes/)() | Возвращает [XmlAttributeCollection](../xmlattributecollection/) , содержащий атрибуты данного узла. |
| virtual [get_BaseURI](./get_baseuri/)() | Возвращает базовый URI текущего узла. |
| virtual [get_ChildNodes](./get_childnodes/)() | Возвращает все дочерние узлы данного узла. |
| virtual [get_FirstChild](./get_firstchild/)() | Возвращает первый дочерний узел данного узла. |
| virtual [get_HasChildNodes](./get_haschildnodes/)() | Возвращает значение, указывающее, имеет ли данный узел какие-либо дочерние узлы. |
...
| virtual [get_LastChild](./get_lastchild/)() | Возвращает последний дочерний узел данного узла. |
...
| virtual [get_ParentNode](./get_parentnode/)() | Возвращает родительский узел этого узла (для узлов, которые могут иметь родителей). |
...
| virtual [get_PreviousText](./get_previoustext/)() | Возвращает текстовый узел, непосредственно предшествующий этому узлу. |
...
| virtual [GetNamespaceOfPrefix](./getnamespaceofprefix/)(String) | Ищет ближайшее объявление **xmlns** для заданного префикса, которое находится в области действия текущего узла, и возвращает URI пространства имен из объявления. |
| virtual [GetPrefixOfNamespace](./getprefixofnamespace/)(String) | Ищет ближайшее объявление **xmlns** для заданного URI пространства имен, которое находится в области действия текущего узла, и возвращает префикс, определенный в этом объявлении. |
...
| virtual [InsertAfter](./insertafter/)(SharedPtr\<XmlNode\>, SharedPtr\<XmlNode\>) | Вставляет указанный узел непосредственно после указанного узла‑ссылки. |
| virtual [InsertBefore](./insertbefore/)(SharedPtr\<XmlNode\>, SharedPtr\<XmlNode\>) | Вставляет указанный узел непосредственно перед указанным узлом‑ссылкой. |
| virtual [Normalize](./normalize/)() | Приводит все узлы [XmlText](../xmltext/) на полной глубине поддерева под этим [XmlNode](./) в \"нормальную\" форму, где только разметка (то есть теги, комментарии, инструкции обработки, секции CDATA и ссылки на сущности) разделяют узлы [XmlText](../xmltext/), то есть нет соседних узлов [XmlText](../xmltext/). |
...
| [SelectSingleNode](./selectsinglenode/)(const String\&) | Выбирает первый [XmlNode](./), соответствующий выражению [XPath](../../system.xml.xpath/). |
| [SelectSingleNode](./selectsinglenode/)(const String\&, const SharedPtr\<XmlNamespaceManager\>\&) | Выбирает первый [XmlNode](./), соответствующий выражению [XPath](../../system.xml.xpath/). Любые префиксы, найденные в выражении [XPath](../../system.xml.xpath/), разрешаются с помощью предоставленного [XmlNamespaceManager](../xmlnamespacemanager/). |
...
| virtual [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) | Сохраняет все дочерние узлы узла в указанный [XmlWriter](../xmlwriter/), когда переопределено в производном классе. |
| virtual [WriteTo](./writeto/)(const SharedPtr\<XmlWriter\>\&) | Сохраняет текущий узел в указанный [XmlWriter](../xmlwriter/), когда переопределено в производном классе. |
## Typedefs
