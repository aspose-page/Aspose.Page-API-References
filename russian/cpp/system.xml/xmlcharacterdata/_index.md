...
description: "System::Xml::XmlCharacterData class. Предоставляет методы манипуляции текстом, которые используются несколькими классами в C++."
type: docs
weight: 900
...
| virtual [InsertData](./insertdata/)(int32_t, String) | Вставляет указанную строку в указанную позицию символа. |
...
| virtual [Substring](./substring/)(int32_t, int32_t) | Получает подстроку полной строки из указанного диапазона. |
## Typedefs
