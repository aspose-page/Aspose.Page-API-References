---
title: "System::Xml::XmlValidatingReader::get_IsEmptyElement метод"
linktitle: "get_IsEmptyElement"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlValidatingReader::get_IsEmptyElement метод. Возвращает значение, указывающее, является ли текущий узел пустым элементом (например, <MyElement/>) в C++."
type: docs
weight: 1300
url: /ru/cpp/system.xml/xmlvalidatingreader/get_isemptyelement/
---
