---
title: "System::Xml::XmlText класс"
linktitle: "XmlText"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlText класс. Представляет текстовое содержимое элемента или атрибута в C++."
type: docs
weight: 3800
...
| virtual [SplitText](./splittext/)(int32_t) | Разделяет узел на два узла по указанному смещению, оставляя оба в дереве как соседние. |
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Сохраняет всех дочерних элементов узла в указанный [XmlWriter](../xmlwriter/). Узлы [XmlText](./) не имеют дочерних элементов, поэтому этот метод не оказывает эффекта. |
