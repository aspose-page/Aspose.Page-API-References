---
title: "System::Xml::XmlConvert::ToDateTime метод"
linktitle: "ToDateTime"
second_title: "Aspose.Page для C++"
description: "System::Xml::XmlConvert::ToDateTime метод. Преобразует String в эквивалент DateTime в C++."
type: docs
weight: 1400
...
| --- | --- | --- |
| s | const String\& | Строка для преобразования. |
| formats | const ArrayPtr\<String\>\& | Массив, содержащий структуры формата, которые следует применить к преобразованному [DateTime](../../../system/datetime/). Допустимые форматы включают "yyyy-MM-ddTHH:mm:sszzzzzz" и их подмножества. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| s | const String\& | Значение [String](../../../system/string/), которое нужно преобразовать. |
| dateTimeOption | XmlDateTimeSerializationMode | Одно из значений перечисления, указывающее, следует ли преобразовать дату к локальному времени или сохранить её как всемирное координированное время (UTC), если дата указана в UTC. |
