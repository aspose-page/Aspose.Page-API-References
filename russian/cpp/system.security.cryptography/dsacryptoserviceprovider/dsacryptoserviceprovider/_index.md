---
title: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider конструктор"
linktitle: "DSACryptoServiceProvider"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider конструктор. Конструктор. Использует параметры по умолчанию в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography/dsacryptoserviceprovider/dsacryptoserviceprovider/
---
...
| --- | --- | --- |
| параметры | const DSAParameters\& | Параметры алгоритма. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| параметры | const SharedPtr\<CspParameters\>\& | Параметры алгоритма. |
