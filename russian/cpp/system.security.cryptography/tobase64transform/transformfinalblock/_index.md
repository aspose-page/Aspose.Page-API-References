...
description: "System::Security::Cryptography::ToBase64Transform::TransformFinalBlock method. Обрабатывает последний блок данных и вычисляет выходное значение в C++."
type: docs
weight: 900
...
Вывод рассчитан для всей входной последовательности.
