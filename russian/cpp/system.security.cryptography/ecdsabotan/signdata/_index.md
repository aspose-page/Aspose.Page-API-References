---
title: "System::Security::Cryptography::ECDsaBotan::SignData метод"
linktitle: "SignData"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::ECDsaBotan::SignData метод. Вычисляет хеш-значение указанного массива данных и подписывает результат в C++."
type: docs
weight: 1100
url: /ru/cpp/system.security.cryptography/ecdsabotan/signdata/
---
...
| --- | --- | --- |
| данные | const ByteArrayPtr\& | Входной массив данных. Возвращает подпись ECDSA для входных данных. |
...
| count | int32_t | Количество байтов, используемых в качестве входных данных. возвращает подпись ECDSA для входных данных. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| поток | const StreamPtr\& | Бинарный поток. возвращает подпись ECDSA для входных данных. |
