---
title: "System::Security::Cryptography::CryptoStream::Read метод"
linktitle: "Read"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::CryptoStream::Read метод. Считывает данные из потока в C++."
type: docs
weight: 1000
url: /ru/cpp/system.security.cryptography/cryptostream/read/
---
...
| --- | --- | --- |
| буфер | const ArrayPtr\<uint8_t\>\& | Буфер данных назначения. |
| смещение | int32_t | Смещение в буфере назначения. |
| count | int32_t | Количество байтов для чтения. |

### ReturnValue

Фактическое количество читаемых байтов.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| буфер | const System::Details::ArrayView\<uint8_t\>\& | Буфер данных назначения. |
| смещение | int32_t | Смещение в буфере назначения. |
| count | int32_t | Количество байтов для чтения. |
