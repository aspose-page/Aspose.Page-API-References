---
title: "System::Security::Cryptography::CspParameters::CspParameters конструктор"
linktitle: "CspParameters"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::CspParameters::CspParameters конструктор. Конструктор в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography/cspparameters/cspparameters/
---
...
| --- | --- | --- |
| dwTypeIn | int | Код типа провайдера; игнорируется. |
...
| --- | --- | --- |
| dwTypeIn | int | Код типа провайдера; игнорируется. |
| strProviderNameIn | const System::String\& | Имя провайдера; игнорируется. |
...
| dwTypeIn | int | Код типа провайдера; игнорируется. |
| strProviderNameIn | const System::String\& | Имя провайдера; игнорируется. |
| strContainerNameIn | const System::String\& | Имя контейнера; игнорируется. |
