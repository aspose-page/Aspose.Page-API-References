...
| [SetHashAlgorithm](./sethashalgorithm/)(System::String) override | Устанавливает используемый алгоритм хеширования. |
