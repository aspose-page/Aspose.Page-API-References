---
title: "Метод System::Security::Cryptography::RC2Managed::CreateDecryptor"
linktitle: "CreateDecryptor"
second_title: "Aspose.Page для C++"
description: "Метод System::Security::Cryptography::RC2Managed::CreateDecryptor. Создаёт объект дешифратора с параметрами, определёнными объектом алгоритма, в C++."
type: docs
weight: 100
