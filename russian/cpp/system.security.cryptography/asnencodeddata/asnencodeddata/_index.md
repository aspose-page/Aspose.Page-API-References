---
title: "System::Security::Cryptography::AsnEncodedData::AsnEncodedData конструктор"
linktitle: "AsnEncodedData"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::AsnEncodedData::AsnEncodedData конструктор. Конструктор в C++."
type: docs
weight: 100
url: /ru/cpp/system.security.cryptography/asnencodeddata/asnencodeddata/
---
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Закодированные данные в формате необработанных байтов. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| asn_encoded_data | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) для копирования данных из. |
## Примечания
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) идентификатор закодированных данных. |
| raw_data | const ByteArrayPtr\& | Закодированные данные в формате необработанных байтов. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) идентификатор закодированных данных. |
| raw_data | const ByteArrayPtr\& | Закодированные данные в формате необработанных байтов. |
