---
title: "Метод System::Security::Cryptography::RSA::SignData"
linktitle: "SignData"
second_title: "Aspose.Page для C++"
description: "Метод System::Security::Cryptography::RSA::SignData. Вычисляет хеш-значение указанного массива данных, используя указанный алгоритм хеширования и заполнение, и подписывает результат в C++."
type: docs
weight: 1000
...
Вычисляет хеш‑значение указанного массива данных, используя указанный алгоритм хеширования и заполнение, и подписывает результат.
...
Вычисляет хеш‑значение указанного бинарного потока, используя указанный алгоритм хеширования и заполнение, и подписывает результат.
