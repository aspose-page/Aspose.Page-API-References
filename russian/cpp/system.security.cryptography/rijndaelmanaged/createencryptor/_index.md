---
title: "System::Security::Cryptography::RijndaelManaged::CreateEncryptor метод"
linktitle: "CreateEncryptor"
second_title: "Aspose.Page для C++"
description: "System::Security::Cryptography::RijndaelManaged::CreateEncryptor метод. Создает объект шифратора с параметрами, определенными объектом алгоритма в C++."
type: docs
weight: 200
url: /ru/cpp/system.security.cryptography/rijndaelmanaged/createencryptor/
---
