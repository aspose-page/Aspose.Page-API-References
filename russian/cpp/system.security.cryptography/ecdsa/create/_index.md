---
title: "System::Security::Cryptography::ECDsa::Create метод"
linktitle: "Создать"
second_title: "Aspose.Page для C++"
description: "Метод System::Security::Cryptography::ECDsa::Create. Создает реализацию алгоритма ECDSA по умолчанию в C++."
type: docs
weight: 1100
url: /ru/cpp/system.security.cryptography/ecdsa/create/
---
## ECDsa::Create() method
...
Создаёт реализацию алгоритма ECDSA по умолчанию с недавно созданным ключом для указанной кривой.
...
| --- | --- | --- |
| curve | const ECCurve\& | Кривая, используемая для создания ключа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| параметры | const ECParameters\& | Параметры, представляющие ключ. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| алгоритм | const String\& | Имя алгоритма. |
