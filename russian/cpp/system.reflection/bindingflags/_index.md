...
Определяет члены и режимы поиска типов и привязки.
...
| DeclaredOnly | 2 | Искать только члены, объявленные в типе, и не в базовых типах. |
...
| PutRefDispProperty | 32768 | Устанавливает COM‑ссылочное свойство. |
| ExactBinding | 65536 | Привязка типов должна быть точной, без каких-либо изменений типов. |
