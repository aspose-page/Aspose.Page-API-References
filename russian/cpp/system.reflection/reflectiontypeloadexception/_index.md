...
description: "System::Reflection::ReflectionTypeLoadException typedef. ReflectionTypeLoadException выбрасывается методом Module.GetTypes, если любые классы в модуле не удаётся загрузить. Никогда не оборачивайте экземпляры класса ReflectionTypeLoadException в System::SmartPtr в C++."
type: docs
weight: 1400
url: /ru/cpp/system.reflection/reflectiontypeloadexception/
---
