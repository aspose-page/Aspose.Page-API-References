---
title: "System::Int16::Parse 方法"
linktitle: "解析"
second_title: "Aspose.Page 适用于 C++"
description: "System::Int16::Parse 方法。将包含数字字符串表示的指定字符串转换为 C++ 中等价的 16 位有符号整数。"
type: docs
weight: 100
url: /zh/cpp/system/int16/parse/
---
...
使用提供的格式信息，将包含数字字符串表示的指定字符串转换为等价的 16 位有符号整数。
