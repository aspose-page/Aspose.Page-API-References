---
title: "System::DateTime::operator== 方法"
linktitle: "operator=="
second_title: "Aspose.Page 适用于 C++"
description: "System::DateTime::operator== 方法。确定当前对象和指定的 DateTime 对象是否表示相同的日期时间值（在 C++ 中）。"
type: docs
weight: 3900
url: /zh/cpp/system/datetime/operator==/
---
## DateTime::operator==(DateTime) const method


确定当前对象和指定的 [DateTime](../) 对象是否表示相同的日期时间值。
