---
title: "System::Int32::Parse 方法"
linktitle: "解析"
second_title: "Aspose.Page 适用于 C++"
description: "如何在 C++ 中使用 System::Int32 类的 Parse 方法。"
type: docs
weight: 100
url: /zh/cpp/system/int32/parse/
---
...
使用提供的格式信息，将包含数字字符串表示的指定字符串转换为等价的 32 位有符号整数。
