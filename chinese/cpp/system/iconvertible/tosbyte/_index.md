---
title: "System::IConvertible::ToSByte 方法"
linktitle: "ToSByte"
second_title: "Aspose.Page 适用于 C++"
description: "System::IConvertible::ToSByte 方法。使用 C++ 中指定的特定文化格式信息，将此实例的值转换为等效的 8 位有符号整数。"
type: docs
weight: 1100
url: /zh/cpp/system/iconvertible/tosbyte/
---
## IConvertible::ToSByte method


使用指定的特定文化格式信息，将此实例的值转换为等效的 8 位有符号整数。
