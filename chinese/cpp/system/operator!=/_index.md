...
description: "如何在 C++ 中使用 operator!= 方法。"
type: docs
weight: 25800
...
如果对象的字符串表示等于该字符串则为 false，否则为 true。
...
确定指定的值是否不等于由指定的 [Nullable](../nullable/) 对象表示的值，方法是对这些值应用 [operator!=()](./)。
...
如果指定的对象表示非 null 值则为 true，否则为 false
