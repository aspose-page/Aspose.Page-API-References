---
title: "System::setter_decrement_wrap 方法"
linktitle: "setter_decrement_wrap"
second_title: "Aspose.Page 适用于 C++"
description: "System::setter_decrement_wrap 方法。翻译器将 C#''s 前递减表达式（针对具有已定义 setter 和 getter 的实例属性）转换为在 C++ 中调用此函数（针对 const getter 的重载）。"
type: docs
weight: 37100
url: /zh/cpp/system/setter_decrement_wrap/
---
