---
title: "System::Xml::XPath::XPathNavigator::InsertAfter 方法"
linktitle: "InsertAfter"
second_title: "Aspose.Page 适用于 C++"
description: "System::Xml::XPath::XPathNavigator::InsertAfter 方法。返回一个 XmlWriter 对象，用于在 C++ 中在当前选定节点之后创建一个新的兄弟节点。"
type: docs
weight: 4100
url: /zh/cpp/system.xml.xpath/xpathnavigator/insertafter/
---
...
使用指定的 [XmlReader](../../../system.xml/xmlreader/) 对象的 XML 内容，在当前选定节点之后创建一个新的兄弟节点。
...
使用指定的 [XPathNavigator](../) 对象中的节点，在当前选定节点之后创建一个新的兄弟节点。
