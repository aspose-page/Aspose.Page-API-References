...
description: "System::Xml::XmlSignificantWhitespace 类。表示混合内容节点中标记之间的空白，或 xml:space=''preserve'' 范围内的空白。这在 C++ 中也称为重要空白。"
type: docs
weight: 3700
...
表示混合内容节点中标记之间的空白或 **xml:space='preserve'** 范围内的空白。这也称为显著空白。
