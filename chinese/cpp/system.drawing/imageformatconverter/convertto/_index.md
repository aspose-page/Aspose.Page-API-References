---
title: "System::Drawing::ImageFormatConverter::ConvertTo 方法"
linktitle: "ConvertTo"
second_title: "Aspose.Page 适用于 C++"
description: "System::Drawing::ImageFormatConverter::ConvertTo 方法。在 C++ 中将对象转换为特定类型。"
type: docs
weight: 300
url: /zh/cpp/system.drawing/imageformatconverter/convertto/
---
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| context | const SharedPtr\<ComponentModel::ITypeDescriptorContext\>\& | [Object](../../../system/object/) 转换上下文信息。 |
| 区域性 | const SharedPtr\<Globalization::CultureInfo\>\& | 在转换对象时使用的区域性。 |
| value | const SharedPtr\<Object\>\& | [Object](../../../system/object/) 用于转换。 |
| destinationType | const TypeInfo\& | 要转换成的类型。 |
