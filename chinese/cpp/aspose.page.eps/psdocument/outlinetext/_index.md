---
title: "Aspose::Page::EPS::PsDocument::OutlineText 方法"
linktitle: "OutlineText"
second_title: "Aspose.Page 适用于 C++"
description: "Aspose::Page::EPS::PsDocument::OutlineText 方法。 在 C++ 中通过绘制字形轮廓添加文本字符串。"
type: docs
weight: 3900
url: /zh/cpp/aspose.page.eps/psdocument/outlinetext/
---
...
| x | 单精度浮点数 | 文本起点的 X 坐标。 |
| y | 单精度浮点数 | 文本起点的 Y 坐标。 |
| stroke | System::SharedPtr\<System::Drawing::Pen\> | 用于绘制字形轮廓的笔画。 |
