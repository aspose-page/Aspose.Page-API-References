...
description: "表示用于插件的 PS/EPS 到 PDF 转换器选项。"
type: docs
weight: 13
url: /zh/java/com.aspose.eps.plugins/psconvertertopdfoptions/
---
**Inheritance:**
...
表示用于 [PsConverter](../../com.aspose.eps.plugins/psconverter) 插件的 PS/EPS 到 PDF 转换器选项。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PsConverterToPdfOptions()](#PsConverterToPdfOptions--) | 初始化 [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions) 对象的新实例。 |
## 方法
...
初始化 [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions) 对象的新实例。
