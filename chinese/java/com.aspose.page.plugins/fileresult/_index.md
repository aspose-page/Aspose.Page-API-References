...
description: "表示以文件路径字符串形式的操作结果。"
type: docs
weight: 14
url: /zh/java/com.aspose.page.plugins/fileresult/
---
**Inheritance:**
java.lang.Object
...
| 构造函数 | 描述 |
| --- | --- |
| [FileResult(String path)](#FileResult-java.lang.String-) | 使用指定的输出文件路径初始化一个新实例。 |
## 方法
