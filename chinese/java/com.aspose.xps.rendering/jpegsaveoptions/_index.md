...
description: "用于 XPS-as-JPEG 保存选项的类。"
type: docs
weight: 12
url: /zh/java/com.aspose.xps.rendering/jpegsaveoptions/
---
**Inheritance:**
...
用于 XPS-as-JPEG 保存选项的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [JpegSaveOptions()](#JpegSaveOptions--) | 创建 options 的新实例。 |
## 方法
