...
type: docs
weight: 11
url: /zh/java/com.aspose.eps.device/pdfsaveoptions/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | 使用默认值初始化 PdfSaveOptions 类的新实例，标志 suppressErrors 为 true，debug 为 false。 |
| [PdfSaveOptions(boolean supressErrors)](#PdfSaveOptions-boolean-) | 使用默认值初始化 PdfSaveOptions 类的新实例，标志 debug 为 false。 |
| [PdfSaveOptions(Dimension size)](#PdfSaveOptions-java.awt.Dimension-) | 使用页面尺寸初始化 PdfSaveOptions 类的新实例。 |
| [PdfSaveOptions(boolean supressErrors, Dimension size)](#PdfSaveOptions-boolean-java.awt.Dimension-) | 使用默认值初始化 PdfSaveOptions 类的新实例，标志 debug 为 false，并设置页面尺寸。 |
## 方法
...
使用页面尺寸初始化 PdfSaveOptions 类的新实例。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 大小 | java.awt.Dimension | 页面的尺寸。 |
...
使用默认值初始化 PdfSaveOptions 类的新实例，标志 debug 为 false，并设置页面尺寸。
