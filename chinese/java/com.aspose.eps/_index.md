...
description: "com.aspose.eps 是处理 PS/EPS 文件的所有类的根包。"
type: docs
weight: 10
url: /zh/java/com.aspose.eps/
---

该 **com.aspose.eps** 是处理 PS/EPS 文件的所有类的根包。
...
| 类 | 描述 |
| --- | --- |
| [FontConstants](../com.aspose.eps/fontconstants) | 此类定义了一组用于保存字体的常量。 |
| [HatchPaintLibrary](../com.aspose.eps/hatchpaintlibrary) | 将 GDI+ 交叉刷转换为适用于写入 XPS 和 PDF 的图像。 |
