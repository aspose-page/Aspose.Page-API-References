...
| 构造函数 | 描述 |
| --- | --- |
| [PsConverterLicenseException(String errorStr)](#PsConverterLicenseException-java.lang.String-) | 从 errorStr 字符串初始化 PsConverterLicenseException 的新实例。 |
## 方法
...
从 errorStr 字符串初始化 PsConverterLicenseException 的新实例。
