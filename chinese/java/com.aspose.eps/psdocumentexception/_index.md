...
| 构造函数 | 描述 |
| --- | --- |
| [PsDocumentException(String errorStr)](#PsDocumentException-java.lang.String-) | 从 errorStr 字符串初始化一个新的 PsDocumentException 实例。 |
## 方法
...
从 errorStr 字符串初始化一个新的 PsDocumentException 实例。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| errorStr | java.lang.String | 描述错误原因的字符串。 |
