...
description: "封装 PolyBezierSegment 元素特性的类。"
type: docs
weight: 45
url: /zh/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
封装 PolyBezierSegment 元素特性的类。此元素描述一组立方 B?bezier 曲线。
## 方法

| 方法 | 描述 |
| --- | --- |
| [deepClone()](#deepClone--) | 克隆此组立方 B?bezier 曲线。 |
