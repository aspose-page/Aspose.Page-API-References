...
type: docs
weight: 30
url: /zh/java/com.aspose.xps/xpsiccbasedcolor/
---
**Inheritance:**
...
| [getClass()](#getClass--) |  |
| [getIccProfile()](#getIccProfile--) | 返回该颜色所基于的 ICC 配置文件资源。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toColor()](#toColor--) | 用于获取 ICC 基础颜色的 .NET 本机表示的便利方法。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
