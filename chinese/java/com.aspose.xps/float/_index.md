...
`Float` 类定义了以浮点坐标指定的尺寸。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Float()](#Float--) | 创建 Size2D 实例。 |
| [Float(float width, float height)](#Float-float-float-) | 创建 Size2D 实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [height](#height) | 此 `Size2D` 的高度。 |
| [width](#width) | 此 `Size2D` 的宽度。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| w | float | 此 `Size2D` 的宽度 |
| h | float | 此 `Size2D` 的高度 |
