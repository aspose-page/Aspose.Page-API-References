...
description: "指定装订槽的宽度。"
type: docs
weight: 46
url: /zh/java/com.aspose.xps.metadata/jobbindalldocumentsgutter/
---
**Inheritance:**
...
指定装订槽的宽度。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocumentsgutter
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [JobBindAllDocumentsGutter(int value)](#JobBindAllDocumentsGutter-int-) | 创建一个新实例。 |
## 方法
