...
description: "指定作业的副本数量。"
type: docs
weight: 49
url: /zh/java/com.aspose.xps.metadata/jobcopiesalldocuments/
---
**Inheritance:**
...
指定作业的副本数量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcopiesalldocuments
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [JobCopiesAllDocuments(int value)](#JobCopiesAllDocuments-int-) | 创建一个新实例。 |
## 方法
