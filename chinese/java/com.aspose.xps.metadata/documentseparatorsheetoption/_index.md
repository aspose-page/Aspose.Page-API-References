...
description: "描述 DocumentSeparatorSheet 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/documentseparatorsheet.documentseparatorsheetoption/
---
**Inheritance:**
...
描述  DocumentSeparatorSheet  功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [BothSheets](#BothSheets) | 指定在文档的开始和结束处使用分隔纸。 |
| [EndSheet](#EndSheet) | 指定在文档结束处使用分隔纸。 |
| [None](#None) | 指定不使用分隔纸。 |
| [StartSheet](#StartSheet) | 指定在文档开始处使用分隔纸。 |
## 方法
