...
type: docs
weight: 123
url: /zh/java/com.aspose.xps.metadata/pagescalingoffsetwidth/
---
**Inheritance:**
...
指定自定义缩放时在  ImageableSizeWidth  方向上的缩放偏移量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetwidth
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageScalingOffsetWidth(int value)](#PageScalingOffsetWidth-int-) | 创建一个新实例。 |
## 方法
