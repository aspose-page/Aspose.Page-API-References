...
type: docs
weight: 112
url: /zh/java/com.aspose.xps.metadata/pagenegativeimage/
---
**Inheritance:**
...
描述输出的负片设置。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageNegativeImage(PageNegativeImage.PageNegativeImageOption[] options)](#PageNegativeImage-com.aspose.xps.metadata.PageNegativeImage.PageNegativeImageOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageNegativeImageOption\[\]](../../com.aspose.xps.metadata/pagenegativeimageoption) | 一个数组或功能选项。 |
