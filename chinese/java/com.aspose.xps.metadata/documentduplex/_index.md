...
description: "描述输出的双面特性。"
type: docs
weight: 23
url: /zh/java/com.aspose.xps.metadata/documentduplex/
---
**Inheritance:**
...
描述输出的双面特性。双面功能允许在介质的两面进行打印。每个文档分别进行双面处理。DocumentDuplex 与 JobDuplexAllDocumentsContiguously 互斥。由驱动程序决定这些关键字之间的约束处理方式。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentduplex
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentDuplex(Duplex.DuplexOption[] options)](#DocumentDuplex-com.aspose.xps.metadata.Duplex.DuplexOption...-) | 创建一个新实例。 |
## 方法
