...
description: "指定页面的宽度，垂直于进纸方向。"
type: docs
weight: 108
url: /zh/java/com.aspose.xps.metadata/pagemediasizepswidth/
---
**Inheritance:**
...
指定页面相对于送纸方向垂直的宽度。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidth
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSizePSWidth(int value)](#PageMediaSizePSWidth-int-) | 创建一个新实例。 |
## 方法
