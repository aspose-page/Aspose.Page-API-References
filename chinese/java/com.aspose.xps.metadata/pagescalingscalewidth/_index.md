...
description: "指定自定义缩放时 ImageableSizeWidth 方向的缩放因子。"
type: docs
weight: 126
url: /zh/java/com.aspose.xps.metadata/pagescalingscalewidth/
---
**Inheritance:**
...
指定自定义缩放时 ImageableSizeWidth 方向的缩放因子。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageScalingScaleWidth(int value)](#PageScalingScaleWidth-int-) | 创建一个新实例。 |
## 方法
