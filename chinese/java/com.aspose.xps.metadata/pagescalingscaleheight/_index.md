...
description: "指定自定义缩放中 ImageableSizeHeight 方向的缩放因子。"
type: docs
weight: 125
...
指定自定义缩放中 ImageableSizeHeight 方向的缩放因子。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
## 构造函数
