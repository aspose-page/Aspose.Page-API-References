...
type: docs
weight: 45
url: /zh/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
描述装订方式。作业中的所有文档一起装订。  JobBindAllDocuments  和  DocumentBinding  互斥。由驱动程序决定这些关键字之间的约束处理方式。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | 针对该功能的特定选项数组。 |
