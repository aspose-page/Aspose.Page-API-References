...
描述装订方式。作业中的所有文档将一起装订。JobBindAllDocuments 和 DocumentBinding 互斥。由驱动程序决定这些关键字之间的约束处理方式。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## 构造函数
