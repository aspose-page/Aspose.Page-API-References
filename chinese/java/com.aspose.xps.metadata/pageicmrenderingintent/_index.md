...
description: "描述 ICC v2 规范定义的渲染意图。"
type: docs
weight: 98
url: /zh/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
描述由 ICC v2 规范定义的渲染意图。如果图像或图形元素嵌入了指定渲染意图的配置文件，则应忽略此值。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageicmrenderingintent
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | 针对该功能的特定选项数组。 |
