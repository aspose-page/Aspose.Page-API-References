...
description: "指定指向 XPS 文档中包含的 ICC 配置文件的包根的相对 URI。"
type: docs
weight: 94
url: /zh/java/com.aspose.xps.metadata/pagedevicecolorspaceprofileuri/
---
**Inheritance:**
...
指定相对于包根的 URI，指向 XPS 文档中包含的 ICC 配置文件。此选项的处理取决于 PageDeviceColorSpaceUsage 功能的设置。使用该配置文件的所有元素被视为已经处于适当的设备颜色空间，驱动程序或设备将不会对其进行颜色管理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceprofileuri
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageDeviceColorSpaceProfileURI(String value)](#PageDeviceColorSpaceProfileURI-java.lang.String-) | 创建一个新实例。 |
## 方法
...
| [getClass()](#getClass--) |  |
| [getMaxLength()](#getMaxLength--) | 对于字符串值，定义最短的最长字符串。 |
| [getMinLength()](#getMinLength--) | 对于字符串值，定义允许的最短字符串。 |
