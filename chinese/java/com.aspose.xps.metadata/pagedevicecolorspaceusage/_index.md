...
description: "结合 PageDeviceColorSpaceProfileURI 参数，此参数定义在设备颜色空间中呈现的元素的渲染行为。"
type: docs
weight: 95
url: /zh/java/com.aspose.xps.metadata/pagedevicecolorspaceusage/
---
**Inheritance:**
...
结合 PageDeviceColorSpaceProfileURI 参数，此参数定义在设备颜色空间中呈现的元素的渲染行为。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageDeviceColorSpaceUsage(PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption[] options)](#PageDeviceColorSpaceUsage-com.aspose.xps.metadata.PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageDeviceColorSpaceUsageOption\[\]](../../com.aspose.xps.metadata/pagedevicecolorspaceusageoption) | 针对该功能的特定选项数组。 |
