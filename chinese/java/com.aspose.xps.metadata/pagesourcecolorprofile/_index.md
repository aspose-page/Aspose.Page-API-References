...
description: "定义源颜色配置文件的特性。"
type: docs
weight: 127
url: /zh/java/com.aspose.xps.metadata/pagesourcecolorprofile/
---
**Inheritance:**
...
定义源颜色配置文件的特性。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagesourcecolorprofile
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageSourceColorProfile(PageSourceColorProfile.PageSourceColorProfileOption[] options)](#PageSourceColorProfile-com.aspose.xps.metadata.PageSourceColorProfile.PageSourceColorProfileOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageSourceColorProfileOption\[\]](../../com.aspose.xps.metadata/pagesourcecolorprofileoption) | 针对该功能的特定选项数组。 |
