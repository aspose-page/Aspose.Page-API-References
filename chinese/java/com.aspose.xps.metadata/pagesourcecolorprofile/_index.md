...
定义源色彩配置文件的特性。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagesourcecolorprofile
## 构造函数
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageSourceColorProfileOption\[\]](../../com.aspose.xps.metadata/pagesourcecolorprofileoption) | 特定于此功能的选项数组。 |
