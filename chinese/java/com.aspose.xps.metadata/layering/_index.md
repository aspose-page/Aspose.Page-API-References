...
description: "描述内部 Layering 功能。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/pagewatermark.layering/
---
**Inheritance:**
...
描述内部 Layering 功能。定义水印的分层行为。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Layering(PageWatermark.LayeringOption[] options)](#Layering-com.aspose.xps.metadata.PageWatermark.LayeringOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [LayeringOption\[\]](../../com.aspose.xps.metadata/layeringoption) | 特定于此功能的选项数组。 |
