...
description: "指定页面的副本数量。"
type: docs
weight: 90
url: /zh/java/com.aspose.xps.metadata/pagecopies/
---
**Inheritance:**
...
指定页面的副本数量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecopies
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageCopies(int value)](#PageCopies-int-) | 创建一个新实例。 |
## 方法
