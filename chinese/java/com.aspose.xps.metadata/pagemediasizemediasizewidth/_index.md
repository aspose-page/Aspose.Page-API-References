...
description: "指定自定义 MediaSize 选项的 MediaSizeHeight 方向尺寸。"
type: docs
weight: 104
url: /zh/java/com.aspose.xps.metadata/pagemediasizemediasizewidth/
---
**Inheritance:**
...
指定自定义 MediaSize 选项的 MediaSizeHeight 方向尺寸。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | 创建一个新实例。 |
## 方法
