...
description: "指示驱动程序对照片打印设置进行填充的高级意图。"
type: docs
weight: 117
url: /zh/java/com.aspose.xps.metadata/pagephotoprintingintent/
---
**Inheritance:**
...
指示驱动程序的高级意图，以填充照片打印设置。这些设置涉及用户在打印照片时可能指定的期望输出质量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagephotoprintingintent
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PagePhotoPrintingIntent(PagePhotoPrintingIntent.PagePhotoPrintingIntentOption[] options)](#PagePhotoPrintingIntent-com.aspose.xps.metadata.PagePhotoPrintingIntent.PagePhotoPrintingIntentOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PagePhotoPrintingIntentOption\[\]](../../com.aspose.xps.metadata/pagephotoprintingintentoption) | 一个数组或功能选项。 |
