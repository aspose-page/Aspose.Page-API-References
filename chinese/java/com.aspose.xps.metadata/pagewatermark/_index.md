...
description: "描述输出的水印设置及水印特性。"
type: docs
weight: 131
url: /zh/java/com.aspose.xps.metadata/pagewatermark/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageWatermark(PageWatermark.IPageWatermarkItem[] items)](#PageWatermark-com.aspose.xps.metadata.PageWatermark.IPageWatermarkItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| items | [IPageWatermarkItem\[\]](../../com.aspose.xps.metadata/ipagewatermarkitem) | 特定于该功能的项目数组。 |
