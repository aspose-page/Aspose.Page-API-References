...
description: "指定文档的描述性名称。"
type: docs
weight: 29
url: /zh/java/com.aspose.xps.metadata/documentname/
---
**Inheritance:**
...
指定文档的描述性名称。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentname
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentName(String documentName)](#DocumentName-java.lang.String-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| documentName | java.lang.String | 文档名称。 |
