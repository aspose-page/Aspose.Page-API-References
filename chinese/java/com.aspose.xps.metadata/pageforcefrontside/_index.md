...
description: "强制输出显示在介质纸张的正面。"
type: docs
weight: 97
url: /zh/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | 创建一个新实例。 |
## 方法
