...
description: "指定指向 XPS 文档中包含的 ICC 配置文件的相对 URI 引用。"
type: docs
weight: 93
url: /zh/java/com.aspose.xps.metadata/pagedestinationcolorprofileuri/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageDestinationColorProfileURI(String value)](#PageDestinationColorProfileURI-java.lang.String-) | 创建一个新实例。 |
## 方法
