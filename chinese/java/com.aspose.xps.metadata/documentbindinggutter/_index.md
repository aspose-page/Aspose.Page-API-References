...
type: docs
weight: 16
url: /zh/java/com.aspose.xps.metadata/documentbindinggutter/
---
**Inheritance:**
...
指定装订槽的宽度。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbindinggutter
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentBindingGutter(int value)](#DocumentBindingGutter-int-) | 创建一个新实例。 |
## 方法
