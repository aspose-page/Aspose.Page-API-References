...
description: "描述将多个逻辑页输出到单个物理纸张的方式和格式。"
type: docs
weight: 28
...
描述将多个逻辑页输出到单个物理纸张的方式和格式。每个文档分别编译。DocumentNUp 和 JobNUpAllDocumentsContiguously 互斥。由驱动程序决定这些关键字之间的约束处理方式。https://docs.microsoft.com/en-us/windows/win32/printdocs/documentnup
## 构造函数
