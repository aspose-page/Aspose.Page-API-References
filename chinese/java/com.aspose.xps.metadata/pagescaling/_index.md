...
description: "描述输出的缩放特性。"
type: docs
weight: 121
url: /zh/java/com.aspose.xps.metadata/pagescaling/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageScaling(PageScaling.IPageScalingItem[] items)](#PageScaling-com.aspose.xps.metadata.PageScaling.IPageScalingItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| items | [IPageScalingItem\[\]](../../com.aspose.xps.metadata/ipagescalingitem) | 特定于该功能的项目数组。 |
