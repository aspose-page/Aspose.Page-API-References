...
description: "为文档指定唯一标识符。"
type: docs
weight: 25
url: /zh/java/com.aspose.xps.metadata/documentid/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [DocumentID(String documentID)](#DocumentID-java.lang.String-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| documentID | java.lang.String | 文档 ID。 |
