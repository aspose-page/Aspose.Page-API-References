...
description: "定义打印输出的页面分辨率，可以是定性值、每英寸点数或两者兼有。"
type: docs
weight: 120
url: /zh/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
定义打印输出的页面分辨率，可以是定性值、每英寸点数，或两者兼有。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | 特定于该功能的项目数组。 |
