...
type: docs
weight: 33
url: /zh/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
描述卷纸的切割方法。每个文档单独处理。指定的选项描述了卷切的不同方法。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | 创建一个新实例。 |
## 方法
