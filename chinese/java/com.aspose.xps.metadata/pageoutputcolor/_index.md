...
description: "描述输出的颜色设置特性。"
type: docs
weight: 115
url: /zh/java/com.aspose.xps.metadata/pageoutputcolor/
---
**Inheritance:**
...
描述输出的颜色设置特性。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputcolor
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageOutputColor(PageOutputColor.IPageOutputColorItem[] items)](#PageOutputColor-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| items | [IPageOutputColorItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloritem) | 特定于该功能的项目数组。 |
