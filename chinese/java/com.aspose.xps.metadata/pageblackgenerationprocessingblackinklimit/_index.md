...
description: "标记为指定命名颜色的应用内容必须出现在所有颜色分离中。"
type: docs
weight: 79
url: /zh/java/com.aspose.xps.metadata/pageblackgenerationprocessingblackinklimit/
---
**Inheritance:**
...
标记为指定命名颜色的应用程序内容必须出现在所有颜色分离中。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingblackinklimit
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageBlackGenerationProcessingBlackInkLimit(int value)](#PageBlackGenerationProcessingBlackInkLimit-int-) | 创建一个新实例。 |
## 方法
