...
description: "指定与进纸方向平行的偏移量。"
type: docs
weight: 106
url: /zh/java/com.aspose.xps.metadata/pagemediasizepsheightoffset/
---
**Inheritance:**
...
指定与进纸方向平行的偏移量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheightoffset
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSizePSHeightOffset(int value)](#PageMediaSizePSHeightOffset-int-) | 创建一个新实例。 |
## 方法
