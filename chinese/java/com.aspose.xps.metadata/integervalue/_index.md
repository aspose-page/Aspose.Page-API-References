...
description: "封装 PrintTicket 文档中整数值的类。"
type: docs
weight: 43
url: /zh/java/com.aspose.xps.metadata/integervalue/
---
**Inheritance:**
...
封装 PrintTicket 文档中整数值的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [IntegerValue(int value)](#IntegerValue-int-) | 创建一个新实例。 |
## 方法
