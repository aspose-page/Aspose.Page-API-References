...
description: "定义输出的物理页顺序。"
type: docs
weight: 63
url: /zh/java/com.aspose.xps.metadata/jobpageorder/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [JobPageOrder(JobPageOrder.JobPageOrderOption[] options)](#JobPageOrder-com.aspose.xps.metadata.JobPageOrder.JobPageOrderOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [JobPageOrderOption\[\]](../../com.aspose.xps.metadata/jobpageorderoption) | 针对该功能的特定选项数组。 |
