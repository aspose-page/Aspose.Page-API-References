...
type: docs
weight: 133
url: /zh/java/com.aspose.xps.metadata/pagewatermarkoriginwidth/
---
**Inheritance:**
...
指定水印相对于 PageImageableSize 原点的位置。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginwidth
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageWatermarkOriginWidth(int value)](#PageWatermarkOriginWidth-int-) | 创建一个新实例。 |
## 方法
