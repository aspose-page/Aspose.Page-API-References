...
可作为复合打印模式元素（即包含其他元素）的类的基类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CompositePrintTicketElement(String name, IPrintTicketElementChild[] items)](#CompositePrintTicketElement-java.lang.String-com.aspose.xps.metadata.IPrintTicketElementChild...-) | 创建一个新实例。 |
| [CompositePrintTicketElement(CompositePrintTicketElement element)](#CompositePrintTicketElement-com.aspose.xps.metadata.CompositePrintTicketElement-) | 克隆此元素实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| element | [CompositePrintTicketElement](../../com.aspose.xps.metadata/compositeprintticketelement) | 要克隆的元素实例。 |
