...
description: "描述媒体颜色选项及每个选项的特性。"
type: docs
weight: 101
url: /zh/java/com.aspose.xps.metadata/pagemediacolor/
---
**Inheritance:**
...
描述媒体颜色选项以及每个选项的特性。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaColor(PageMediaColor.PageMediaColorOption[] options)](#PageMediaColor-com.aspose.xps.metadata.PageMediaColor.PageMediaColorOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageMediaColorOption\[\]](../../com.aspose.xps.metadata/pagemediacoloroption) | 针对该功能的特定选项数组。 |
