...
description: "描述何时应将图像内容打印到介质的物理边缘。"
type: docs
weight: 88
url: /zh/java/com.aspose.xps.metadata/pageborderless/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageBorderless(PageBorderless.PageBorderlessOption[] options)](#PageBorderless-com.aspose.xps.metadata.PageBorderless.PageBorderlessOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageBorderlessOption\[\]](../../com.aspose.xps.metadata/pageborderlessoption) | 针对该功能的特定选项数组。 |
