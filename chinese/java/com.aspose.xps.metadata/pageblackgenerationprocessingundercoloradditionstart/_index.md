...
description: "描述将在其以下应用 UCA 的阴影级别。"
type: docs
weight: 85
url: /zh/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionstart/
---
**Inheritance:**
...
描述将在其下应用 UCA 的阴影级别。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionstart
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionStart(int value)](#PageBlackGenerationProcessingUnderColorAdditionStart-int-) | 创建一个新实例。 |
## 方法
