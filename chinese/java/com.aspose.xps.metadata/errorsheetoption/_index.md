...
description: "描述 JobErrorSheet 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/joberrorsheet.errorsheetoption/
---
**Inheritance:**
...
描述 JobErrorSheet 功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Custom](#Custom) | 指定应输出自定义错误页。 |
| [None](#None) | 指定不应输出错误纸张。 |
| [Standard](#Standard) | 指定应输出标准（设备定义的）错误纸张。 |
## 方法
