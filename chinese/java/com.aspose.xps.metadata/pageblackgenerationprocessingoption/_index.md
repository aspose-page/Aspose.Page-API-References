...
description: "描述 PageBlackGenerationProcessing 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/pageblackgenerationprocessing.pageblackgenerationprocessingoption/
---
**Inheritance:**
...
描述  PageBlackGenerationProcessing  功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Automatic](#Automatic) | 自动选项。 |
| [Custom](#Custom) | 自定义选项。 |
## 方法
