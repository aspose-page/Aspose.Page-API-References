...
description: "指定水印相对于 PageImageableSize 原点的位置。"
type: docs
weight: 132
url: /zh/java/com.aspose.xps.metadata/pagewatermarkoriginheight/
---
**Inheritance:**
...
指定水印相对于 PageImageableSize 原点的起始位置。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageWatermarkOriginHeight(int value)](#PageWatermarkOriginHeight-int-) | 创建一个新实例。 |
## 方法
