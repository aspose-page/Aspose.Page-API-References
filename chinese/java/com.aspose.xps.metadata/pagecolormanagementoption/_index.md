...
description: "描述 PageColorManagement 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/pagecolormanagement.pagecolormanagementoption/
---
**Inheritance:**
...
描述 PageColorManagement 功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Device](#Device) | 应用程序未执行颜色管理，由设备决定颜色管理。 |
| [Driver](#Driver) | 应用程序未执行颜色管理，由驱动程序决定颜色管理。 |
| [None](#None) | 应用程序已对目标配置文件执行颜色管理。 |
| [System](#System) | 颜色管理由系统执行。 |
## 方法
...
颜色管理由系统执行。打印到 XPSDrv 打印驱动程序时不应使用。
