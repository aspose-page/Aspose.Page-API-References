...
description: "定义水印文本可用的字体大小。"
type: docs
weight: 136
url: /zh/java/com.aspose.xps.metadata/pagewatermarktextfontsize/
---
**Inheritance:**
...
定义水印文本可用的字体大小。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextfontsize
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageWatermarkTextFontSize(int value)](#PageWatermarkTextFontSize-int-) | 创建一个新实例。 |
## 方法
