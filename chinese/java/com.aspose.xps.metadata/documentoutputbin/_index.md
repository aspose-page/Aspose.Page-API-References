...
type: docs
weight: 30
url: /zh/java/com.aspose.xps.metadata/documentoutputbin/
---
**Inheritance:**
...
描述设备支持的完整容器列表。允许在每个文档基础上指定输出容器。  JobOutputBin 、  DocumentOutputBin  和  PageOutputBin  关键字相互排斥，只应在 PrintTicket 或 Print Capabilities 文档中指定其中一个。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentoutputbin
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentOutputBin(OutputBin.IOutputBinItem[] items)](#DocumentOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | 创建一个新实例。 |
## 方法
