...
描述设备支持的完整纸盒列表。允许在每个文档基础上指定输出纸盒。  JobOutputBin 、  DocumentOutputBin  和  PageOutputBin  关键字互斥，PrintTicket 或 Print Capabilities 文档中只能指定一个。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentoutputbin
## 构造函数
