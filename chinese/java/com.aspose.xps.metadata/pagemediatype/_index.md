...
description: "描述 MediaType 选项及每个选项的特性。"
type: docs
weight: 110
url: /zh/java/com.aspose.xps.metadata/pagemediatype/
---
**Inheritance:**
...
描述 MediaType 选项及每个选项的特性。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediatype
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaType(PageMediaType.IPageMediaTypeItem[] items)](#PageMediaType-com.aspose.xps.metadata.PageMediaType.IPageMediaTypeItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| items | [IPageMediaTypeItem\[\]](../../com.aspose.xps.metadata/ipagemediatypeitem) | 特定于该功能的项目数组。 |
