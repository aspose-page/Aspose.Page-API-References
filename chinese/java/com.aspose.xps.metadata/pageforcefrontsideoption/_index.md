...
description: "描述 PageForceFrontSide 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
描述  PageForceFrontSide  功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | 指定输出仅限于纸张的正面。 |
| [None](#None) | 指定没有输出限制。 |
## 方法
