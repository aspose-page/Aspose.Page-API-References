...
description: "描述输出的负片设置。"
type: docs
weight: 116
url: /zh/java/com.aspose.xps.metadata/pageoutputquality/
---
**Inheritance:**
...
描述输出的负面设置。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputquality
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageOutputQuality(PageOutputQuality.PageOutputQualityOption[] options)](#PageOutputQuality-com.aspose.xps.metadata.PageOutputQuality.PageOutputQualityOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageOutputQualityOption\[\]](../../com.aspose.xps.metadata/pageoutputqualityoption) | 一个数组或功能选项。 |
