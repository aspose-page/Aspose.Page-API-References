...
description: "描述用于混合操作的颜色空间。"
type: docs
weight: 86
url: /zh/java/com.aspose.xps.metadata/pageblendcolorspace/
---
**Inheritance:**
...
描述用于混合操作的颜色空间。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspace
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageBlendColorSpace(PageBlendColorSpace.PageBlendColorSpaceOption[] options)](#PageBlendColorSpace-com.aspose.xps.metadata.PageBlendColorSpace.PageBlendColorSpaceOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageBlendColorSpaceOption\[\]](../../com.aspose.xps.metadata/pageblendcolorspaceoption) | 针对该功能的特定选项数组。 |
