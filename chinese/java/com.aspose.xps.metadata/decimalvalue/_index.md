...
description: "在 PrintTicket 文档中封装十进制值的类。"
type: docs
weight: 12
url: /zh/java/com.aspose.xps.metadata/decimalvalue/
---
**Inheritance:**
...
在 PrintTicket 文档中封装十进制值的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DecimalValue(float value)](#DecimalValue-float-) | 创建一个新实例。 |
## 方法
