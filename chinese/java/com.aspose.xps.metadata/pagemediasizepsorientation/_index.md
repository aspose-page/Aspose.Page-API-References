...
description: "指定相对于进纸方向的方向 https//docs.microsoft.com/en-us/windows/win32rintdocsagemediasizepsorientation"
type: docs
weight: 107
url: /zh/java/com.aspose.xps.metadata/pagemediasizepsorientation/
---
**Inheritance:**
...
指定相对于进纸方向的方向 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsorientation
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSizePSOrientation(int value)](#PageMediaSizePSOrientation-int-) | 创建一个新实例。 |
## 方法
