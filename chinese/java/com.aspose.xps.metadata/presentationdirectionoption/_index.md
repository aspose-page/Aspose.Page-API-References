...
description: "描述 PresentationDirection 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/nup.presentationdirection.presentationdirectionoption/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [BottomLeft](#BottomLeft) | 指定从上到下、从右到左。 |
| [BottomRight](#BottomRight) | 指定从上到下、从左到右。 |
| [LeftBottom](#LeftBottom) | 指定从右到左、从上到下。 |
| [LeftTop](#LeftTop) | 指定从右到左、从下到上。 |
| [RightBottom](#RightBottom) | 指定从左到右、从上到下。 |
| [RightTop](#RightTop) | 指定从左到右、从下到上。 |
| [TopLeft](#TopLeft) | 指定从下到上、从右到左。 |
| [TopRight](#TopRight) | 指定从下到上、从左到右。 |
## 方法
