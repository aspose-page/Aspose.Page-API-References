...
描述前置（起始）封面页。每个文档都有单独的封面页。封面页应使用文档首页的 PageMediaSize 和 PageMediaType 打印。封面页应根据指定的 Option 集成到处理选项中（例如 DocumentDuplex、DocumentNUp）。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## 构造函数
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | 特定于此功能的选项数组。 |
