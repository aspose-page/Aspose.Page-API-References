...
type: docs
weight: 21
url: /zh/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
描述前置（开始）封面页。每个文档都有单独的封面页。封面页应使用文档首页的 PageMediaSize 和 PageMediaType 进行打印。封面页应根据指定的 Option 集成到处理选项中（例如 DocumentDuplex、DocumentNUp）。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | 针对该功能的特定选项数组。 |
