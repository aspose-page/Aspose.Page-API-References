...
description: "指定文档的副本数量。"
type: docs
weight: 18
url: /zh/java/com.aspose.xps.metadata/documentcopiesallpages/
---
**Inheritance:**
...
指定文档的副本数量。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcopiesallpages
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentCopiesAllPages(int value)](#DocumentCopiesAllPages-int-) | 创建一个新实例。 |
## 方法
