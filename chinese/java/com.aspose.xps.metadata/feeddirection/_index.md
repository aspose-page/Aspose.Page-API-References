...
description: "定义 FeedDirection 计分属性值的常量。"
type: docs
weight: 11
url: /zh/java/com.aspose.xps.metadata/inputbin.feeddirection/
---
**Inheritance:**
...
定义 FeedDirection 计分属性值的常量。
## 字段

| 字段 | 描述 |
| --- | --- |
| [LongEdgeFirst](#LongEdgeFirst) | LongEdgeFirst 值。 |
| [ShortEdgeFirst](#ShortEdgeFirst) | LongEdgeFirst 值。 |
## 方法
