...
description: "描述物理介质纸张的方向。"
type: docs
weight: 113
url: /zh/java/com.aspose.xps.metadata/pageorientation/
---
**Inheritance:**
...
描述物理介质纸张的方向。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageOrientation(PageOrientation.PageOrientationOption[] options)](#PageOrientation-com.aspose.xps.metadata.PageOrientation.PageOrientationOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageOrientationOption\[\]](../../com.aspose.xps.metadata/pageorientationoption) | 针对该功能的特定选项数组。 |
