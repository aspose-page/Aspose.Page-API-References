...
description: "在 PrintTicket 文档中封装 String 值的类。"
type: docs
weight: 150
url: /zh/java/com.aspose.xps.metadata/stringvalue/
---
**Inheritance:**
...
在 PrintTicket 文档中封装 String 值的类。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [StringValue(String value)](#StringValue-java.lang.String-) | 创建一个新实例。 |
## 方法
