...
description: "指定页面高度，平行于送纸方向。"
type: docs
weight: 105
url: /zh/java/com.aspose.xps.metadata/pagemediasizepsheight/
---
**Inheritance:**
...
指定页面高度，平行于送纸方向。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | 创建一个新实例。 |
## 方法
