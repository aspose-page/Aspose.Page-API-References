...
description: "描述文档的输出范围（以页为单位）。"
type: docs
weight: 31
url: /zh/java/com.aspose.xps.metadata/documentpageranges/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [DocumentPageRanges(String value)](#DocumentPageRanges-java.lang.String-) | 创建一个新实例。 |
## 方法
