...
type: docs
weight: 35
url: /zh/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
描述输出的装订特性。每个文档分别装订。  JobStapleAllDocuments  和  DocumentStaple  关键字互斥。由驱动程序决定这些关键字之间的约束处理方式。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | 创建一个新实例。 |
## 方法
