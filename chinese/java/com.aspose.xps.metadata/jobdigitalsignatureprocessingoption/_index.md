...
description: "描述 JobDigitalSignatureProcessing 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/
---
**Inheritance:**
...
描述 JobDigitalSignatureProcessing 功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [PrintInvalidSignatures](#PrintInvalidSignatures) | 无论数字签名是否有效，都打印作业。 |
| [PrintInvalidSignaturesWithErrorReport](#PrintInvalidSignaturesWithErrorReport) | 无论数字签名是否有效，都打印作业。 |
| [PrintOnlyValidSignatures](#PrintOnlyValidSignatures) | 仅当所有数字签名有效时才打印作业。 |
## 方法
...
无论数字签名是否有效，都打印作业。如果遇到无效签名，应在作业结束时打印错误页。数字签名必须不被忽略。
