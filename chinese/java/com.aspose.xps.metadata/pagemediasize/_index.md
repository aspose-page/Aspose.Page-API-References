...
description: "描述用于输出的物理介质尺寸。"
type: docs
weight: 102
url: /zh/java/com.aspose.xps.metadata/pagemediasize/
---
**Inheritance:**
...
描述用于输出的物理介质尺寸。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasize
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageMediaSize(PageMediaSize.IPageMediaSizeItem[] options)](#PageMediaSize-com.aspose.xps.metadata.PageMediaSize.IPageMediaSizeItem...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [IPageMediaSizeItem\[\]](../../com.aspose.xps.metadata/ipagemediasizeitem) | 针对该功能的特定选项数组。 |
