...
description: "表示 JobPrimaryBannerSheet 功能的选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/jobprimarybannersheet.bannersheetoption/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [Custom](#Custom) | 指定应输出自定义横幅纸张。 |
| [None](#None) | 指定不应输出横幅纸张。 |
| [Standard](#Standard) | 指定应输出标准（设备定义的）横幅纸张。 |
## 方法
...
指定应输出自定义横幅纸张。如果未指定 JobPrimaryBannerSheetSource ParameterInit 元素，则应忽略此选项。
