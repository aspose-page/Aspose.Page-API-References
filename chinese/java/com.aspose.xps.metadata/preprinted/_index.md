...
description: "定义 PrePrinted 计分属性值的常量。"
type: docs
weight: 14
url: /zh/java/com.aspose.xps.metadata/pagemediatype.preprinted/
---
**Inheritance:**
...
定义  PrePrinted  计分属性值的常量。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Letterhead](#Letterhead) | Letterhead 值。 |
| [None](#None) | None 值。 |
| [PrePrintedValue](#PrePrintedValue) | PrePrinted 值。 |
## 方法
