...
description: "描述内部 ErrorSheetWhen 功能。"
type: docs
weight: 11
url: /zh/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen/
---
**Inheritance:**
...
描述内部 ErrorSheetWhen 功能。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ErrorSheetWhen(JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption[] options)](#ErrorSheetWhen-com.aspose.xps.metadata.JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [ErrorSheetWhenOption\[\]](../../com.aspose.xps.metadata/errorsheetwhenoption) | 针对该功能的特定选项数组。 |
