...
description: "描述 PageOrientation 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/pageorientation.pageorientationoption/
---
**Inheritance:**
...
描述  PageOrientation  功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Landscape](#Landscape) | 内容相对于标准（纵向）方向在页面上逆时针旋转 90 度。 |
| [Portrait](#Portrait) | 标准方向。 |
| [ReverseLandscape](#ReverseLandscape) | 内容相对于标准（纵向）方向在页面上逆时针旋转 270 度。 |
| [ReversePortrait](#ReversePortrait) | 内容相对于标准（纵向）方向在页面上旋转 180 度。 |
## 方法
