...
type: docs
weight: 55
url: /zh/java/com.aspose.xps.metadata/jobholepunch/
---
**Inheritance:**
...
描述输出的打孔特性。所有文档一起打孔。JobHolePunch 和 DocumentHolePunch 关键字互斥。两者不应在同一 PrintTicket 或打印功能文档中同时指定。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [JobHolePunch(HolePunch.HolePunchOption[] options)](#JobHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | 创建一个新实例。 |
## 方法
