...
description: "描述 JobPageOrder 功能选项。"
type: docs
weight: 10
url: /zh/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
描述 JobPageOrder 功能选项。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Reverse](#Reverse) | 指定从后到前的页面顺序。 |
| [Standard](#Standard) | 指定从前到后的页面顺序。 |
## 方法
