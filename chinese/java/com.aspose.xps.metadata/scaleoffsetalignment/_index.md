...
description: "描述内部 ScaleOffsetAlignment 功能。"
type: docs
weight: 11
url: /zh/java/com.aspose.xps.metadata/pagescaling.scaleoffsetalignment/
---
**Inheritance:**
...
描述内部  ScaleOffsetAlignment  功能。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ScaleOffsetAlignment(PageScaling.ScaleOffsetAlignmentOption[] options)](#ScaleOffsetAlignment-com.aspose.xps.metadata.PageScaling.ScaleOffsetAlignmentOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [ScaleOffsetAlignmentOption\[\]](../../com.aspose.xps.metadata/scaleoffsetalignmentoption) | 针对该功能的特定选项数组。 |
