...
description: "描述在高光到阴影范围内 GCR 应该开始的点，即 100% 最暗阴影。"
type: docs
weight: 82
url: /zh/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementstart/
---
**Inheritance:**
...
描述在“高光到阴影”范围内 GCR 应该开始的点（100% 最暗阴影）。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | 创建一个新实例。 |
## 方法
