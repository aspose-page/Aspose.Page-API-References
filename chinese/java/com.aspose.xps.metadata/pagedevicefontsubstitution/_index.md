...
description: "描述设备字体替换的启用/禁用状态。"
type: docs
weight: 96
url: /zh/java/com.aspose.xps.metadata/pagedevicefontsubstitution/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PageDeviceFontSubstitution(PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption[] options)](#PageDeviceFontSubstitution-com.aspose.xps.metadata.PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption...-) | 创建一个新实例。 |
## 方法
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| options | [PageDeviceFontSubstitutionOption\[\]](../../com.aspose.xps.metadata/pagedevicefontsubstitutionoption) | 针对该功能的特定选项数组。 |
