...
description: 这个类封装了文档到抽象设备的渲染 文档的渲染是逐页执行的
type: docs
weight: 20
...
| 姓名 | 描述 |
| --- | --- |
| [Device](device)(Size) | 初始化[`Device`](../device)一页大小。 |
...
| virtual [DrawString](../../aspose.page/device/drawstring)(string, double, double) | 在给定点绘制一个字符串。 |
...
| virtual [FillPolygon](../../aspose.page/device/fillpolygon#fillpolygon)(double[], double[], int) | 填充一个 poligone. |
| virtual [FillPolygon](../../aspose.page/device/fillpolygon#fillpolygon_1)(int[], int[], int) | 填充一个 poligone. |
...
| virtual [Rotate](../../aspose.page/device/rotate#rotate)(double) | 旋转当前变换矩阵。调用 writeTransform(Transform). 旋转正角度 theta 将正 x 轴 上的点向正 y 轴旋转。 |
...
| virtual [Translate](../../aspose.page/device/translate)(double, double) | 平移当前变换矩阵。调用 writeTransform(Transform). |
