...
description: 允许设置类型属性并返回 的特殊属性类如果此属性对象不包含该属性它还允许搜索两个默认属性对象 的连接
type: docs
weight: 240
...
允许设置类型属性并返回 的特殊属性类。如果此属性对象不包含该属性，它还允许搜索两个默认属性对象 的连接。
...
| [UserProperties](userproperties#constructor_1)(Dictionary&lt;string, object&gt;) | 用默认值初始化 UserProperties 类。 |
...
| 姓名 | 描述 |
| --- | --- |
| virtual [Properties](../../aspose.page/userproperties/properties) { set; } | 复制属性，包括其默认值到此 UserProperties |
...
| virtual [GetPropertyDouble](../../aspose.page/userproperties/getpropertydouble#getpropertydouble)(string) | 获取双精度属性值。 |
| virtual [GetPropertyDouble](../../aspose.page/userproperties/getpropertydouble#getpropertydouble_1)(string, double) | 获取双精度属性值。如果请求的属性不存在，则返回提供的默认值。 |
...
| virtual [GetPropertySize](../../aspose.page/userproperties/getpropertysize#getpropertysize)(string) | 获取 size 属性值。 |
| virtual [GetPropertySize](../../aspose.page/userproperties/getpropertysize#getpropertysize_1)(string, Size) | 获取 size 属性值。如果请求的属性不存在，则返回提供的默认值。 |
...
| static [SetProperty](../../aspose.page/userproperties/setproperty#setproperty_6)(Dictionary&lt;string, object&gt;, string, Rectangle) | 设置指定属性表中的矩形属性值。 |
