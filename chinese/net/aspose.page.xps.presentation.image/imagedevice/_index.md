...
| 姓名 | 描述 |
| --- | --- |
| override [Background](../../aspose.page.xps.presentation.image/imagedevice/background) { get; set; } | 获取/设置背景颜色。 |
| virtual [CharTM](../../aspose.page/device/chartm) { get; set; } | 返回或指定当前字符变换。 |
| [Creator](../../aspose.page/device/creator) { get; set; } | 返回或指定结果设备输出的创建者。 |
| virtual [CurrentPageNumber](../../aspose.page.xps.presentation.image/imagedevice/currentpagenumber) { get; } | 返回文档中当前页面的绝对编号。 |
...
| [IsLicensed](../../aspose.page/device/islicensed) { get; } | 表示此 Aspose.Page 库实例是否已获得许可。 |
| override [Opacity](../../aspose.page.xps.presentation.image/imagedevice/opacity) { get; set; } | 获取/设置不透明度。 |
| override [OpacityMask](../../aspose.page.xps.presentation.image/imagedevice/opacitymask) { get; set; } | 获取/设置不透明蒙版的画笔。遮罩适用于 Paint 或 Strike. |
| override [Paint](../../aspose.page.xps.presentation.image/imagedevice/paint) { get; set; } | 获取/设置用于填充路径的画笔。 |
...
| override [Stroke](../../aspose.page.xps.presentation.image/imagedevice/stroke) { get; set; } | 获取/设置绘制路径的笔触。 |
...
| virtual [ClosePartition](../../aspose.page.xps.presentation.image/imagedevice/closepartition)() | 完成文档分区。 |
| override [Create](../../aspose.page.xps.presentation.image/imagedevice/create)() | 基于此设备实例创建新的设备实例。 写入此设备图形状态，即创建ApsCanvasinstance(s) 具有相应的 RenderTransform 和 Clip 属性。 |
| override [Dispose](../../aspose.page.xps.presentation.image/imagedevice/dispose)() | 释放此设备实例。最终确定此设备实例图形状态， 即将 APS 组合上下文切换到ApsCanvas高于 this 设备的图形状态的级别ApsCanvas. |
| override [Draw](../../aspose.page.xps.presentation.image/imagedevice/draw)(GraphicsPath) | 绘制指定路径。 |
| virtual [DrawArc](../../aspose.page/device/drawarc)(double, double, double, double, double, double) | 绘制弧线。 |
| virtual [DrawImage](../../aspose.page/device/drawimage)(Bitmap, Matrix, Color) | 使用指定的变换和背景绘制图像。 |
...
| override [DrawString](../../aspose.page.xps.presentation.image/imagedevice/drawstring)(string, double, double) | 在指定位置绘制一个字符串。 |
| override [EndDocument](../../aspose.page.xps.presentation.image/imagedevice/enddocument)() | 完成文档。 |
| override [Fill](../../aspose.page.xps.presentation.image/imagedevice/fill)(GraphicsPath) | 填充指定路径。 |
| virtual [FillArc](../../aspose.page/device/fillarc)(double, double, double, double, double, double) | 填充弧线。 |
| virtual [FillOval](../../aspose.page/device/filloval)(double, double, double, double) | 填充椭圆形。 |
| virtual [FillPolygon](../../aspose.page/device/fillpolygon)(double[], double[], int) | 填充一个 poligone. |
| virtual [FillPolygon](../../aspose.page/device/fillpolygon)(int[], int[], int) | 填充一个 poligone. |
| virtual [FillRect](../../aspose.page/device/fillrect)(double, double, double, double) | 填充一个矩形。 |
| virtual [FillRoundRect](../../aspose.page/device/fillroundrect)(double, double, double, double, double, double) | 填充一个圆形矩形。 |
...
| [GetPropertyDouble](../../aspose.page/device/getpropertydouble)(string) | 获取双属性值。 |
| [GetPropertyInt](../../aspose.page/device/getpropertyint)(string) | 获取整数属性的值。 |
| [GetPropertyMargins](../../aspose.page/device/getpropertymargins)(string) | 获取边距属性的值。 |
...
| virtual [OpenPage](../../aspose.page.xps.presentation.image/imagedevice/openpage#openpage_1)(string) | 以指定的标题开始一个新页面。 |
| virtual [OpenPage](../../aspose.page.xps.presentation.image/imagedevice/openpage#openpage)(float, float) | 以指定的宽度和高度开始新页面。 |
