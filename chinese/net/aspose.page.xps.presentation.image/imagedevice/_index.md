...
| virtual [CurrentRelativePageNumber](../../aspose.page.xps.presentation.image/imagedevice/currentrelativepagenumber) { get; } | 返回当前分区中当前页的相对编号。 |
...
| override [Stroke](../../aspose.page.xps.presentation.image/imagedevice/stroke) { get; set; } | 获取/设置绘制路径的描边。 |
...
| override [Create](../../aspose.page.xps.presentation.image/imagedevice/create)() | 基于此设备实例创建一个新的设备实例。 写入此设备图形状态，即创建ApsCanvas实例 具有相应的 RenderTransform 和 Clip 属性。 |
| override [Dispose](../../aspose.page.xps.presentation.image/imagedevice/dispose)() | 释放此设备实例。最终确定此设备实例图形状态， 即将 APS 组合上下文切换到比此 设备更高级别的ApsCanvas图形状态ApsCanvas。 |
...
| virtual [OpenPage](../../aspose.page.xps.presentation.image/imagedevice/openpage#openpage_1)(string) | 用指定的标题开始一个新页面。 |
...
| override [Rotate](../../aspose.page.xps.presentation.image/imagedevice/rotate#rotate)(double) | 将围绕原点的顺时针旋转应用于当前变换矩阵。 |
