...
| override [Stroke](../../aspose.page.xps.presentation.pdf/pdfdevice/stroke) { get; set; } | 获取/设置绘制路径的笔触。 |
...
| override [Create](../../aspose.page.xps.presentation.pdf/pdfdevice/create)() | 基于此设备实例创建新的设备实例。 写入此设备图形状态，即创建ApsCanvasinstance(s) 具有相应的 RenderTransform 和 Clip 属性。 |
| override [Dispose](../../aspose.page.xps.presentation.pdf/pdfdevice/dispose)() | 释放此设备实例。最终确定此设备实例图形状态， 即将 APS 组合上下文切换到ApsCanvas高于 this 设备的图形状态的级别ApsCanvas. |
...
| override [DrawString](../../aspose.page.xps.presentation.pdf/pdfdevice/drawstring)(string, double, double) | 在指定位置绘制一个字符串。 |
...
| virtual [OpenPage](../../aspose.page.xps.presentation.pdf/pdfdevice/openpage#openpage_1)(string) | 以指定的标题开始一个新页面。 |
| virtual [OpenPage](../../aspose.page.xps.presentation.pdf/pdfdevice/openpage#openpage)(float, float) | 以指定的宽度和高度开始新页面。 |
