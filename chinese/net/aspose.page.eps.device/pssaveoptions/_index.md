...
description: 此类包含管理将文档转换为 PostScript PS 或 Encapsulated PostScript EPS 文件的过程所需的选项
type: docs
weight: 80
...
此类包含管理将文档转换为 PostScript (PS) 或 Encapsulated PostScript (EPS) 文件的过程所需的选项。
...
| 姓名 | 描述 |
| --- | --- |
| [PsSaveOptions](pssaveoptions#constructor)() | 初始化[`PsSaveOptions`](../pssaveoptions)标志的默认值 的类!:SuppressErrors（真实）和!:Debug（假）. |
| [PsSaveOptions](pssaveoptions#constructor_1)(bool) | 初始化[`PsSaveOptions`](../pssaveoptions)具有标志默认值的类!:Debug（假）. |
