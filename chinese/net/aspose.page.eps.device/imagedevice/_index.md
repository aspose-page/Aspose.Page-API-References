...
| 姓名 | 描述 |
| --- | --- |
| [ImageDevice](imagedevice#constructor)() | 初始化的新实例[`ImageDevice`](../imagedevice). |
| [ImageDevice](imagedevice#constructor_1)(ImageFormat) | 初始化的新实例[`ImageDevice`](../imagedevice)具有指定的图像格式。 |
| [ImageDevice](imagedevice#constructor_2)(Size) | 初始化的新实例[`ImageDevice`](../imagedevice)具有指定大小的页面。 |
| [ImageDevice](imagedevice#constructor_3)(Size, ImageFormat) | 初始化的新实例[`ImageDevice`](../imagedevice)具有指定的页面大小和图像格式。 |
...
| override [SaveOptions](../../aspose.page.eps.device/imagedevice/saveoptions) { set; } | 用于管理渲染进程的选项。 |
...
| override [DrawImage](../../aspose.page.eps.device/imagedevice/drawimage)(Bitmap, Matrix, Color) | 使用指定的变换和背景绘制图像。 |
...
| override [DrawString](../../aspose.page.eps.device/imagedevice/drawstring)(string, double, double) | 在给定点绘制一个字符串。 |
...
| [GetPropertyDouble](../../aspose.page.eps.device/imagedevice/getpropertydouble#getpropertydouble)(string) | 获取双属性值。 (2 methods) |
...
| override [Rotate](../../aspose.page.eps.device/imagedevice/rotate#rotate)(double) | 在 Z 轴上旋转当前变换矩阵。调用 writeTransform(Transform). 旋转正角度 theta 将正 x 轴 上的点向正 y 轴旋转。 |
...
| override [Translate](../../aspose.page.eps.device/imagedevice/translate)(double, double) | 平移当前变换矩阵。调用 writeTransform(Transform). |
