...
| 姓名 | 描述 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | 初始化[`ImageSaveOptions`](../imagesaveoptions)标志的默认值 的类!:SuppressErrors（真实）和!:Debug（假）. |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(bool) | 初始化[`ImageSaveOptions`](../imagesaveoptions) with 标志的默认值!:Debug（假）. |
