...
| 姓名 | 描述 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | 使用默认值 初始化[`ImageSaveOptions`](../imagesaveoptions)类的新实例:用于标志!:SuppressErrors(true) 和!:Debug(false)。 |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(bool) | 使用 默认值初始化[`ImageSaveOptions`](../imagesaveoptions)的新实例用于标志!:Debug(false)。 |
