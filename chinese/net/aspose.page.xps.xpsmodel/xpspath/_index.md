...
类封装 Path 元素特性。 该元素是将矢量图形和图像添加到固定页面的唯一方法。 它定义了要在页面上呈现的单个矢量图形。
...
| [Fill](../../aspose.page.xps.xpsmodel/xpspath/fill/) { get; set; } | 返回/设置用于绘制由路径的数据属性指定的 几何体的画笔。 |
...
| [StrokeDashArray](../../aspose.page.xps.xpsmodel/xpspath/strokedasharray/) { get; set; } | 返回/设置指定轮廓笔划的破折号和间隙长度的数组。 |
| [StrokeDashCap](../../aspose.page.xps.xpsmodel/xpspath/strokedashcap/) { get; set; } | 返回/设置指定如何绘制每个破折号末端的值。 |
| [StrokeDashOffset](../../aspose.page.xps.xpsmodel/xpspath/strokedashoffset/) { get; set; } | 返回/设置重复虚线数组模式的起点。 如果省略此值，则虚线数组与笔划的原点对齐。 |
| [StrokeEndLineCap](../../aspose.page.xps.xpsmodel/xpspath/strokeendlinecap/) { get; set; } | 返回/设置定义笔划中最后一个破折号末端形状的值。 |
| [StrokeLineJoin](../../aspose.page.xps.xpsmodel/xpspath/strokelinejoin/) { get; set; } | 返回/设置定义笔划中第一个破折号开始形状的值。 |
| [StrokeMiterLimit](../../aspose.page.xps.xpsmodel/xpspath/strokemiterlimit/) { get; set; } | 返回/设置最大斜接长度与笔划粗细的一半之间的比率。 只有当`描线连接`属性指定`斜接`. |
| [StrokeStartLineCap](../../aspose.page.xps.xpsmodel/xpspath/strokestartlinecap/) { get; set; } | 返回/设置定义笔划中第一个破折号开始形状的值。 |
| [StrokeThickness](../../aspose.page.xps.xpsmodel/xpspath/strokethickness/) { get; set; } | 返回/设置笔划的粗细，以 有效坐标空间（包括路径的渲染变换）为单位。 笔划绘制在由 Path 元素的数据属性指定的 几何图形的边界之上。一半的 StrokeThickness extends 超出了 Data 属性指定的几何图形，另一半 扩展到了几何图形的内部。 |
