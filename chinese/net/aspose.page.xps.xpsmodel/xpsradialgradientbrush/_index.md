...
description: 封装 RadialGradientBrush 属性元素 features 的类 此元素用于指定径向渐变画笔
type: docs
weight: 3270
...
封装 RadialGradientBrush 属性元素 features 的类。 此元素用于指定径向渐变画笔。
...
| [RadiusY](../../aspose.page.xps.xpsmodel/xpsradialgradientbrush/radiusy) { get; set; } | 返回/设置定义径向梯度的椭圆的 y 维半径。 |
