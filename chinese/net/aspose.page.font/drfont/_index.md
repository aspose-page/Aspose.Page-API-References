...
| [IsItalic](../../aspose.page.font/drfont/isitalic) { get; } | 获取一个值，该值指示此实例是否为斜体。 |
| [LeadingLis](../../aspose.page.font/drfont/leadinglis) { get; } | 返回此字体的前导 (lis)。 这是[`LineSpacingLis`](./linespacinglis)-[`CellHeightLis`](./cellheightlis). |
| [LeadingPoints](../../aspose.page.font/drfont/leadingpoints) { get; } | 返回此字体的前导 (lis)。 这是[`LineSpacingLis`](./linespacinglis)-[`CellHeightLis`](./cellheightlis). |
...
| 姓名 | 描述 |
| --- | --- |
| override [Equals](../../aspose.page.font/drfont/equals)(object) | 判断是否指定Object 等于这个实例。 |
