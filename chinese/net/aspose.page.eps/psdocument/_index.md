...
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext_1)(string, Font, float, float, Brush, Brush, Pen) | 通过填充字形内部和绘制字形轮廓来添加文本字符串。 |
| [FillAndStrokeText](../../aspose.page.eps/psdocument/fillandstroketext/#fillandstroketext)(string, float[], Font, float, float, Brush, Brush, Pen) | 通过填充字形内部和绘制字形轮廓来添加文本字符串。 |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext_1)(string, Font, float, float) | 通过填充字形的内部来添加文本字符串。 |
| [FillText](../../aspose.page.eps/psdocument/filltext/#filltext)(string, float[], Font, float, float) | 通过填充字形的内部来添加文本字符串。 |
...
| [OpenPage](../../aspose.page.eps/psdocument/openpage/)(float, float) | 创建新页面并使其成为当前页面。 |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext_1)(string, Font, float, float) | 通过绘制字形轮廓添加文本字符串。 |
| [OutlineText](../../aspose.page.eps/psdocument/outlinetext/#outlinetext)(string, float[], Font, float, float) | 通过绘制字形轮廓添加文本字符串。 |
| [Rotate](../../aspose.page.eps/psdocument/rotate/)(float) | 将旋转添加到当前图形状态（旋转当前矩阵）。 |
