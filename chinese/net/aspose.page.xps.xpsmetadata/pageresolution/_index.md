...
将打印输出的页面分辨率定义为定性值或每英寸点数，或两者。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
...
| 姓名 | 描述 |
| --- | --- |
| interface [IPageResolutionItem](pageresolution.ipageresolutionitem/) | 任何接口`PageResolution`特色项目. |
| interface [IPageResolutionOptionItem](pageresolution.ipageresolutionoptionitem/) | 任何接口[`PageResolutionOption`](../pageresolution.pageresolutionoption/)项目. |
| class [PageResolutionOption](pageresolution.pageresolutionoption/) | 描述了`PageResolution`功能选项. |
