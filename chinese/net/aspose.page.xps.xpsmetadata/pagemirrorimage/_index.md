...
| 姓名 | 描述 |
| --- | --- |
| [PageMirrorImage](pagemirrorimage/)(params PageMirrorImageOption[]) | 创建一个新实例。 |
...
| 姓名 | 描述 |
| --- | --- |
| class [PageMirrorImageOption](pagemirrorimage.pagemirrorimageoption/) | 定义`PageMirrorImage`功能选项. |
