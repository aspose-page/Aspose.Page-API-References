...
description: JobDigitalSignatureProcessing 构造函数. 创建一个新实例
type: docs
weight: 10
url: /zh/net/aspose.page.xps.xpsmetadata/jobdigitalsignatureprocessing/jobdigitalsignatureprocessing/
---
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| options | JobDigitalSignatureProcessingOption[] | 一组特定于该功能的选项。 |
...
* 命名空间 [Aspose.Page.XPS.XpsMetadata](../../jobdigitalsignatureprocessing/)
* 部件 [Aspose.Page](../../../)
