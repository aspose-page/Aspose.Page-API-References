...
| 姓名 | 描述 |
| --- | --- |
| class [DuplexMode](duplex.duplexmode/) | 定义了可能的值[`DuplexOption`](../duplex.duplexoption/)秒得分属性. |
| class [DuplexOption](duplex.duplexoption/) | 描述了[`JobDuplexAllDocumentsContiguously`](../jobduplexalldocumentscontiguously/)和[`DocumentDuplex`](../documentduplex/)功能选项. |
