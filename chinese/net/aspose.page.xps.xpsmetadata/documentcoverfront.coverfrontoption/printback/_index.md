...
description: 指定CoverFrontSource指示的封面应打印在封面的背面 如果一个DocumentCoverFrontSourceaspose.page.xps.xpsmetadata/documentcoverfrontsourceParameterInitaspose.page.xps.xpsmetadata/parameterinit 元素未指定应忽略此选项
type: docs
weight: 30
