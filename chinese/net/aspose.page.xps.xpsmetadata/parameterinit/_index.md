...
实现通用 PrintTicket 参数初始值设定项的类。 所有模式定义的参数初始值设定项的基类。 为一个实例定义一个值元素. A元素是一个引用的目标[`ParameterRef`](../parameterref/)element. https://docs.microsoft.com/en-us/windows/win32/printdocs/parameterinit
