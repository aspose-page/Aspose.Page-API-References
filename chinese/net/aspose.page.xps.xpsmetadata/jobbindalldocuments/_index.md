...
描述了绑定的方法。作业中的所有文档都绑定在一起。 `JobBindAllDocuments`和[`DocumentBinding`](../documentbinding/)是互斥的。 由驱动程序确定这些关键字之间的约束处理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
...
| 姓名 | 描述 |
| --- | --- |
| class [BindingGutter](jobbindalldocuments.bindinggutter/) | 描述指定的方式得分属性值， 是通过整数值还是通过对参数. |
| class [BindingOption](jobbindalldocuments.bindingoption/) | 描述了`JobBindAllDocuments`功能选项. |
| interface [IBindingOptionItem](jobbindalldocuments.ibindingoptionitem/) | 任何接口[`BindingOption`](../jobbindalldocuments.bindingoption/)项目. |
