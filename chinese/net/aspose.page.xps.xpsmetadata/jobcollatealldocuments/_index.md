...
描述输出的整理特性。每个单独作业中的所有文档都经过整理。 [`DocumentCollate`](../documentcollate/)和`JobCollateAllDocuments`是互斥的。 是否实现这两个关键字或仅实现其中一个关键字的行为和实现留给驱动程序。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
