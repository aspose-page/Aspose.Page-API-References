...
description: 指定与作业关联的注释示例完成后请送到 1234 房间 https//docs.microsoft.com/enus/windows/win32/printdocs/jobcomment
type: docs
weight: 1150
...
指定与作业关联的注释。示例：“完成后请送到 1234 房间”。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
