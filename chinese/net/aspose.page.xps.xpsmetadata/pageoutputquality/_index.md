...
描述输出的负设置。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputquality
...
| 姓名 | 描述 |
| --- | --- |
| class [PageOutputQualityOption](pageoutputquality.pageoutputqualityoption/) | 定义`PageOutputQuality`功能选项. |
