...
描述了 GCR 应该开始的“高光到阴影”范围内的点（100% 最暗的阴影）。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
...
| 姓名 | 描述 |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart](pageblackgenerationprocessinggraycomponentreplacementstart/)(int) | 创建一个新实例。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| override [MaxValue](../../aspose.page.xps.xpsmetadata/pageblackgenerationprocessinggraycomponentreplacementstart/maxvalue/) { get; } | 对于整数或小数值参数，定义最大允许值。 |
| override [MinValue](../../aspose.page.xps.xpsmetadata/pageblackgenerationprocessinggraycomponentreplacementstart/minvalue/) { get; } | 对于整数或小数值参数，定义最小允许值。 |
