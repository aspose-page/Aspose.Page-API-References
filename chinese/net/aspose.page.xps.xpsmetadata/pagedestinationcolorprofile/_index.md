...
description: 定义目标颜色配置文件的特征 描述应用程序或驱动程序是否选择要使用的目标颜色配置文件 https//docs.microsoft.com/enus/windows/win32/printdocs/pagedestinationcolorprofile
type: docs
weight: 1820
...
| 姓名 | 描述 |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption) | 描述[`PageDestinationColorProfile`](../pagedestinationcolorprofile)功能选项. |
