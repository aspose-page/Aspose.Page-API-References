...
| 姓名 | 描述 |
| --- | --- |
| [PageDestinationColorProfile](pagedestinationcolorprofile/)(params PageDestinationColorProfileOption[]) | 创建一个新实例。 |
...
| 姓名 | 描述 |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | 描述了`PageDestinationColorProfile`功能选项. |
