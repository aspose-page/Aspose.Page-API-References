...
描述了绑定的方法。每个文档单独绑定。 DocumentBinding 和 JobBindAllDocuments 是互斥的。 由驱动程序确定关键字之间的约束处理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
...
| 姓名 | 描述 |
| --- | --- |
| class [BindingGutter](documentbinding.bindinggutter/) | 描述指定的方式得分属性值， 是通过整数值还是通过对参数. |
| class [BindingOption](documentbinding.bindingoption/) | 代表选项`DocumentBinding`特征. |
| interface [IBindingOptionItem](documentbinding.ibindingoptionitem/) | 任何接口[`BindingOption`](../documentbinding.bindingoption/)项目. |
