...
description: 描述要使用的 TrueType 字体处理方法 https//docs.microsoft.com/enus/windows/win32/printdocs/pagetruetypefontmode
type: docs
weight: 2560
...
| 姓名 | 描述 |
| --- | --- |
| class [PageTrueTypeFontModeOption](pagetruetypefontmode.pagetruetypefontmodeoption) | 描述[`PageTrueTypeFontMode`](../pagetruetypefontmode)功能选项. |
