...
| --- | --- | --- |
| name | String | 属性名称。 |
| parameterRef | ParameterRef | 一个[`ParameterRef`](../../parameterref)实例。 |
...
| name | String | 属性名称。 |
| value | Value | 一个属性值。 |
| items | IScoredPropertyItem[] | 任意数组[`IScoredPropertyItem`](../../iscoredpropertyitem)instance. 每一个都必须是一个[`ScoredProperty`](../../scoredproperty)， 一个[`Property`](../../property)或一个[`Value`](../../value)实例。 |
