...
description: 描述 ICC v2 规范定义的渲染意图 如果图像或图形元素具有指定渲染意图的嵌入式配置文件 则应忽略此值 https//docs.microsoft.com/enus/ windows/win32/printdocs/pageicmrenderingintent
type: docs
weight: 1930
...
| 姓名 | 描述 |
| --- | --- |
| class [PageICMRenderingIntentOption](pageicmrenderingintent.pageicmrenderingintentoption) | 描述[`PageICMRenderingIntent`](../pageicmrenderingintent)功能选项. |
