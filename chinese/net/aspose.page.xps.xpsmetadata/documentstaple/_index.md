...
描述了输出的装订特性。每个文件单独装订。 [`JobStapleAllDocuments`](../jobstaplealldocuments/)和`DocumentStaple`关键字是互斥的。 由驱动程序确定这些关键字之间的约束处理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
...
| 姓名 | 描述 |
| --- | --- |
| [DocumentStaple](documentstaple/)(params StapleOption[]) | 创建一个新实例。 |
