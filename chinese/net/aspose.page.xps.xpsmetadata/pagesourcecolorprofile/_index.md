...
description: 定义源颜色配置文件的特征 https//docs.microsoft.com/enus/windows/win32/printdocs/pagesourcecolorprofile
type: docs
weight: 2520
...
| 姓名 | 描述 |
| --- | --- |
| class [PageSourceColorProfileOption](pagesourcecolorprofile.pagesourcecolorprofileoption) | 描述[`PageSourceColorProfile`](../pagesourcecolorprofile)功能选项. |
