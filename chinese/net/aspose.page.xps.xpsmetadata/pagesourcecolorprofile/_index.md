...
description: Aspose.Page.XPS.XpsMetadata.PageSourceColorProfile 班级. 定义源颜色配置文件的特征 https//docs.microsoft.com/enus/windows/win32/printdocs/pagesourcecolorprofile
type: docs
weight: 2580
url: /zh/net/aspose.page.xps.xpsmetadata/pagesourcecolorprofile/
---
...
| 姓名 | 描述 |
| --- | --- |
| [PageSourceColorProfile](pagesourcecolorprofile/)(params PageSourceColorProfileOption[]) | 创建一个新实例。 |
...
| 姓名 | 描述 |
| --- | --- |
| class [PageSourceColorProfileOption](pagesourcecolorprofile.pagesourcecolorprofileoption/) | 描述了`PageSourceColorProfile`功能选项. |
