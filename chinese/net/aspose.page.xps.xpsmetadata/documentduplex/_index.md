...
description: 描述输出的双工特性双面功能允许在介质的两面进行 for 打印每个文档单独进行双工 DocumentDuplex 和 JobDuplexAllDocumentsContiguously 是互斥的 由驱动程序确定这些关键字之间的约束处理 https//docs.microsoft.com/enus/windows/win32/printdocs/ documentduplex
type: docs
weight: 630
...
描述输出的双工特性。双面功能允许在介质的两面进行 for 打印。每个文档单独进行双工。 DocumentDuplex 和 JobDuplexAllDocumentsContiguously 是互斥的。 由驱动程序确定这些关键字之间的约束处理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/ documentduplex
