...
描述了多个逻辑页到单个物理页的输出。 job 中的所有文档都是连续编译的。`JobNUpAllDocumentsContiguously`和[`DocumentNUp`](../documentnup/) 是互斥的。由驱动程序确定这些关键字之间的约束处理。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
...
| [AddPagesPerSheetOption](../../aspose.page.xps.xpsmetadata/jobnupalldocumentscontiguously/addpagespersheetoption/)(int) | 添加和选项scored 属性值。 指定每个物理工作表的逻辑页数。 |
