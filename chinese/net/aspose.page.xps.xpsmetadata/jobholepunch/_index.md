...
描述了输出的打孔特性。所有文件一起打孔. 的`JobHolePunch`和[`DocumentHolePunch`](../documentholepunch/)关键字是互斥的。 不应在 PrintTicket 或 Print Capabilities 文档中同时指定两者。 https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
