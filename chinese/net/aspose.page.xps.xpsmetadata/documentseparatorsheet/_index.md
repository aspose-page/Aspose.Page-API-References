...
| 姓名 | 描述 |
| --- | --- |
| [DocumentSeparatorSheet](documentseparatorsheet/)(params DocumentSeparatorSheetOption[]) | 创建一个新实例。 |
...
| 姓名 | 描述 |
| --- | --- |
| class [DocumentSeparatorSheetOption](documentseparatorsheet.documentseparatorsheetoption/) | 描述了`DocumentSeparatorSheet`功能选项. |
