...
description: 描述输出的打孔特性每个文件单独打孔 JobHolePunch./jobholepunch和DocumentHolePunch./documentholepunch关键字是互斥的 不应在 PrintTicket 或 Print Capabilities 文档中同时指定两者 https//docs.microsoft.com/enus/windows/win32/printdocs/documentholepunch
type: docs
weight: 640
...
描述输出的打孔特性。每个文件单独打孔。 [`JobHolePunch`](../jobholepunch)和[`DocumentHolePunch`](../documentholepunch)关键字是互斥的。 不应在 PrintTicket 或 Print Capabilities 文档中同时指定两者。 https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
