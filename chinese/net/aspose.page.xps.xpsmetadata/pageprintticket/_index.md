...
| 姓名 | 描述 |
| --- | --- |
| [PagePrintTicket](pageprintticket/)(params IPagePrintTicketItem[]) | 创建页面级打印票证实例。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.page.xps.xpsmetadata/pageprintticket/add/)(params IPagePrintTicketItem[]) | 将项目数组添加到此 PrintTicket 项目列表的末尾。 每一个都可能是一个[`Feature`](../feature/)， 一个[`Option`](../option/)或[`Property`](../property/)实例. |
