...
| 姓名 | 描述 |
| --- | --- |
| [JobPrintTicket](jobprintticket/)(params IJobPrintTicketItem[]) | 创建作业级打印票证实例。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.page.xps.xpsmetadata/jobprintticket/add/)(params IJobPrintTicketItem[]) | 将项目数组添加到此 PrintTicket 项目列表的末尾。 每一个都可能是一个[`Feature`](../feature/)， 一个[`Option`](../option/)或[`Property`](../property/)实例. |
