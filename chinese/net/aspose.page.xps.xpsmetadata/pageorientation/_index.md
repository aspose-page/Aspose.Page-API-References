...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation 班级. 描述物理介质表的方向 https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
url: /zh/net/aspose.page.xps.xpsmetadata/pageorientation/
---
## PageOrientation class

描述物理介质表的方向。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| 姓名 | 描述 |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | 创建一个新实例。 |
...
| 姓名 | 描述 |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | 描述了`PageOrientation`功能选项. |
