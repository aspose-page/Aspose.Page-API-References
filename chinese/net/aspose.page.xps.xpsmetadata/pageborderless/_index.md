...
description: 描述何时应将图像内容打印到介质的物理边缘 https//docs.microsoft.com/enus/windows/win32/printdocs/pageborderless
type: docs
weight: 1770
...
| 姓名 | 描述 |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption) | 描述[`PageBorderless`](../pageborderless)功能选项. |
