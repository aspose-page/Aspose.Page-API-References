...
描述作业处理，旨在优化特定使用场景的输出，如指定选项所示。 https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
...
| 姓名 | 描述 |
| --- | --- |
| class [JobOutputOptimizationOption](joboutputoptimization.joboutputoptimizationoption/) | 描述了`JobOutputOptimization`功能选项. |
