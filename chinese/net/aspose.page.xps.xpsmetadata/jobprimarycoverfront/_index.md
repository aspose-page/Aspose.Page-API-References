...
| 姓名 | 描述 |
| --- | --- |
| class [CoverFrontOption](jobprimarycoverfront.coverfrontoption/) | 描述了`JobPrimaryCoverFront`功能选项. |
