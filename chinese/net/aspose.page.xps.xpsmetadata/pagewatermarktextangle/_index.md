...
指定水印文本相对于direction. 角度是按逆时针方向测量的。 https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
...
| 姓名 | 描述 |
| --- | --- |
| [PageWatermarkTextAngle](pagewatermarktextangle/)(int) | 创建一个新实例。 |
