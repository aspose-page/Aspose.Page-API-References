...
description: "System::Globalization::ChineseLunisolarCalendar class. Calendario lunisolare cinese. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento in C++."
type: docs
weight: 300
url: /it/cpp/system.globalization/chineselunisolarcalendar/
---
## ChineseLunisolarCalendar class


Calendario lunisolare cinese. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| [ChineseLunisolarCalendar](./chineselunisolarcalendar/)() | Costruttore predefinito. |
...
| Campo | Descrizione |
| --- | --- |
| static constexpr [ChineseEra](./chineseera/) | Era cinese corrente. |
## Vedi anche
