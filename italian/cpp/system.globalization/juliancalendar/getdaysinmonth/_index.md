...
description: "System::Globalization::JulianCalendar::GetDaysInMonth method. Ottiene il numero di giorni nel mese specifico in C++."
type: docs
weight: 700
url: /it/cpp/system.globalization/juliancalendar/getdaysinmonth/
---
...
| --- | --- | --- |
| anno | int | Anno. |
| mese | int | Mese per cui ottenere il numero di giorni. |

### ReturnValue

Numero di giorni nel mese specificato dell'anno specificato.
...
Numero di giorni nel mese specificato dell'anno specificato dell'era specificata.
