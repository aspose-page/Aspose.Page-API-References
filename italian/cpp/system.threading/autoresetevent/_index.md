...
description: "System::Threading::AutoResetEvent classe. Evento per notificare il thread in attesa che si resetta automaticamente. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento in C++."
type: docs
weight: 100
url: /it/cpp/system.threading/autoresetevent/
---
...
| Metodo | Descrizione |
| --- | --- |
| [AutoResetEvent](./autoresetevent/)(bool) | Informazioni RTTI. |
## Campi
