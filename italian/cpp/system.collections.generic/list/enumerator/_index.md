...
description: "System::Collections::Generic::List::Enumerator class. Enumeratore per iterare gli elementi della lista. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare questo puntatore per passarlo alle funzioni come argomento in C++."
type: docs
weight: 6100
url: /it/cpp/system.collections.generic/list/enumerator/
---
## Enumerator class
...
| Metodo | Descrizione |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Crea un enumeratore che itera attraverso una lista specifica. |
## Vedi anche
