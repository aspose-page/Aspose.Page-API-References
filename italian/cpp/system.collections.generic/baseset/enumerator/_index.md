...
description: "System::Collections::Generic::BaseSet::Enumerator classe. Classe Enumerator. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarla alle funzioni come argomento in C++."
type: docs
weight: 2800
url: /it/cpp/system.collections.generic/baseset/enumerator/
---
## Enumerator class
...
| Metodo | Descrizione |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Crea un enumeratore che itera attraverso l'oggetto **set**. |
## Vedi anche
