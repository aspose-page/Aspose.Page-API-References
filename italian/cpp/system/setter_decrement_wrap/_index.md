---
title: "metodo System::setter_decrement_wrap"
linktitle: "setter_decrement_wrap"
second_title: "Aspose.Page per C++"
description: "Metodo System::setter_decrement_wrap. Il traduttore traduce le espressioni di pre-decremento di C# che hanno come target la proprietà di un'istanza con setter e getter definiti, in una chiamata a questa funzione (sovraccarico per getter const) in C++."
type: docs
weight: 37100
url: /it/cpp/system/setter_decrement_wrap/
---
## System::setter_decrement_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Il traduttore traduce le espressioni di pre-decremento di C# che hanno come target la proprietà di un'istanza con setter e getter definiti, in una chiamata a questa funzione (sovraccarico per getter const).
...
Il traduttore traduce le espressioni di pre-decremento di C# che hanno come target la proprietà di un'istanza con setter e getter definiti, in una chiamata a questa funzione (sovraccarico per getter non const).
...
Il traduttore traduce le espressioni di pre-decremento di C# che hanno come target la proprietà di una classe con setter e getter definiti, in una chiamata a questa funzione.
