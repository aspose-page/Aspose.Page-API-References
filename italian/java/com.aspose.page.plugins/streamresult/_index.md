...
description: "Rappresenta il risultato dell'operazione sotto forma di Stream."
type: docs
weight: 18
url: /it/java/com.aspose.page.plugins/streamresult/
---
**Inheritance:**
java.lang.Object
...
Rappresenta il risultato dell'operazione sotto forma di Stream.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [StreamResult(OutputStream stream)](#StreamResult-java.io.OutputStream-) | Inizializza una nuova istanza con l'oggetto stream specificato. |
## Metodi
...
Inizializza una nuova istanza con l'oggetto stream specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | java.io.OutputStream | Oggetto stream |
