...
description: "Rappresenta il risultato dell'operazione sotto forma di array di byte."
type: docs
weight: 11
url: /it/java/com.aspose.page.plugins/bytearrayresult/
---
**Inheritance:**
java.lang.Object
...
Rappresenta il risultato dell'operazione sotto forma di array di byte.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ByteArrayResult(byte[][] data)](#ByteArrayResult-byte-----) | Inizializza una nuova istanza con l'array di byte. |
## Metodi
...
Inizializza una nuova istanza con l'array di byte.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| dati | byte[][] | Array di array di byte. È usato per la conversione di un documento in immagine. Un array di byte contiene i byte di un'immagine di una pagina. |
