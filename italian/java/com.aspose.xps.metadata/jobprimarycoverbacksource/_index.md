...
description: "Specifica la sorgente per un foglio di copertina posteriore primario personalizzato per il lavoro."
type: docs
weight: 67
url: /it/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Specifica la sorgente per un foglio primario di copertina posteriore personalizzato per il lavoro. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Crea una nuova istanza. |
## Metodi
