...
description: "Specifica la sorgente per un foglio banner personalizzato."
type: docs
weight: 14
url: /it/java/com.aspose.xps.metadata/documentbannersheetsource/
---
**Inheritance:**
...
Specifica la sorgente per un foglio banner personalizzato. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbannersheetsource
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentBannerSheetSource(String value)](#DocumentBannerSheetSource-java.lang.String-) | Crea una nuova istanza. |
## Metodi
