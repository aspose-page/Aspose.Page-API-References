...
description: "La classe che implementa una ScoredProperty comune di PrintTicket."
type: docs
weight: 146
url: /it/java/com.aspose.xps.metadata/scoredproperty/
---
**Inheritance:**
...
La classe che implementa una ScoredProperty comune di PrintTicket. La classe base per tutte le proprietà valutate definite dallo schema. Un elemento ScoredProperty dichiara una proprietà intrinseca a una definizione di Option. Tali proprietà dovrebbero essere confrontate quando si valuta quanto una Option richiesta corrisponda a una Option supportata dal dispositivo. https://docs.microsoft.com/en-us/windows/win32/printdocs/scoredproperty
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ScoredProperty(String name, ParameterRef parameterRef)](#ScoredProperty-java.lang.String-com.aspose.xps.metadata.ParameterRef-) | Crea una nuova istanza. |
| [ScoredProperty(String name, Value value, IScoredPropertyItem[] items)](#ScoredProperty-java.lang.String-com.aspose.xps.metadata.Value-com.aspose.xps.metadata.IScoredPropertyItem...-) | Crea una nuova istanza. |
## Metodi
...
| parameterRef | [ParameterRef](../../com.aspose.xps.metadata/parameterref) | Un'istanza di ParameterRef. |
...
| --- | --- | --- |
| nome | java.lang.String | Un nome di proprietà. |
| value | [Value](../../com.aspose.xps.metadata/value) | Un valore di proprietà. |
| items | [IScoredPropertyItem\[\]](../../com.aspose.xps.metadata/iscoredpropertyitem) | Un array arbitrario di istanze IScoredPropertyItem. Ognuna deve essere un'istanza di ScoredProperty, di Property o di Value. |
