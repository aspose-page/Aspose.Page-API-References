...
type: docs
weight: 71
url: /it/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Descrive il metodo di taglio per la carta a rotolo. Il rotolo dovrebbe essere tagliato alla fine del lavoro. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Crea una nuova istanza. |
## Metodi
