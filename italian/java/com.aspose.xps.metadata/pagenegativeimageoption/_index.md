...
description: "Definisce le opzioni della funzionalità PageNegativeImage."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
Definisce le opzioni della funzionalità PageNegativeImage.
## Campi

| Campo | Descrizione |
| --- | --- |
| [Negative](#Negative) | Specifica che l'output deve essere l'immagine negativa. |
| [None](#None) | Specifica che l'output deve essere l'immagine non negativa. |
## Metodi
