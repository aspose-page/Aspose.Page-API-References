...
description: "Descrive le opzioni della funzionalità PageForceFrontSide."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità  PageForceFrontSide  .
## Campi

| Campo | Descrizione |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Specifica che l'output è limitato al lato frontale del foglio. |
| [None](#None) | Specifica nessuna restrizione sull'output. |
## Metodi
...
Specifica che l'output è limitato al lato frontale del foglio.
...
Specifica nessuna restrizione sull'output.
