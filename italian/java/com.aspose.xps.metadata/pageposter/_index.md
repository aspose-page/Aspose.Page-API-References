...
description: "Descrive l'output di una singola pagina su più fogli di supporto fisico."
type: docs
weight: 118
url: /it/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Descrive l'output di una singola pagina su più fogli di supporto fisico. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Costruttori
...
Aggiunge un'opzione con un valore di proprietà valutato PagesPerSheet. Specifica il numero di fogli fisici per pagina logica.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | int | Un valore di proprietà valutato PagesPerSheet. |
