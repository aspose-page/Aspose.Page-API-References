...
description: "Descrive le caratteristiche di foratura dell'output."
type: docs
weight: 55
url: /it/java/com.aspose.xps.metadata/jobholepunch/
---
**Inheritance:**
...
Descrive le caratteristiche di foratura dell'output. Tutti i documenti sono forati insieme. Le parole chiave  JobHolePunch  e  DocumentHolePunch  sono mutualmente esclusive. Entrambe non devono essere specificate simultaneamente in un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobHolePunch(HolePunch.HolePunchOption[] options)](#JobHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [HolePunchOption\[\]](../../com.aspose.xps.metadata/holepunchoption) | Un array di opzioni specifiche per la funzionalità. |
