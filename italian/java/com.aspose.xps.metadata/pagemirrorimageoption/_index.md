...
description: "Definisce le opzioni della funzionalità PageMirrorImage."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pagemirrorimage.pagemirrorimageoption/
---
**Inheritance:**
...
Definisce le opzioni della funzionalità PageMirrorImage.
## Campi

| Campo | Descrizione |
| --- | --- |
| [MirrorImageHeight](#MirrorImageHeight) | Specifica che l'output deve essere specchiato parallelamente alla direzione MediaSizeHeight. |
| [MirrorImageWidth](#MirrorImageWidth) | Specifica che l'output deve essere specchiato parallelamente alla direzione MediaSizeWidth. |
| [None](#None) | Specifica che l'output non deve essere specchiato. |
## Metodi
...
Specifica che l'output deve essere specchiato parallelamente alla direzione MediaSizeHeight.
...
Specifica che l'output deve essere specchiato parallelamente alla direzione MediaSizeWidth.
...
Specifica che l'output non deve essere specchiato.
