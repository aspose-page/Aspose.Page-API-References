...
description: "Descrive le opzioni della funzionalità PageDestinationColorProfile."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità  PageDestinationColorProfile  .
## Campi

| Campo | Descrizione |
| --- | --- |
| [Application](#Application) | L'applicazione specifica il profilo di destinazione da utilizzare. |
| [DriverConfiguration](#DriverConfiguration) | Profilo di destinazione utilizzato per eseguire la gestione del colore. |
## Metodi
