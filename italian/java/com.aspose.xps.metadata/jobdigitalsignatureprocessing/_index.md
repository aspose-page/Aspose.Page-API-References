...
description: "Descrive la configurazione dell'elaborazione della firma digitale per l'intero lavoro."
type: docs
weight: 51
url: /it/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing/
---
**Inheritance:**
...
Descrive la configurazione dell'elaborazione della firma digitale per l'intero lavoro. Applicabile solo ai contenuti che contengono firme digitali. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobDigitalSignatureProcessing(JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption[] options)](#JobDigitalSignatureProcessing-com.aspose.xps.metadata.JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [JobDigitalSignatureProcessingOption\[\]](../../com.aspose.xps.metadata/jobdigitalsignatureprocessingoption) | Un array di opzioni specifiche per la funzionalità. |
