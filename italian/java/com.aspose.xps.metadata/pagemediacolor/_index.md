...
description: "Descrive le opzioni di Media Color e le caratteristiche di ciascuna opzione."
type: docs
weight: 101
url: /it/java/com.aspose.xps.metadata/pagemediacolor/
---
**Inheritance:**
...
Descrive le opzioni di Media Color e le caratteristiche di ciascuna opzione. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageMediaColor(PageMediaColor.PageMediaColorOption[] options)](#PageMediaColor-com.aspose.xps.metadata.PageMediaColor.PageMediaColorOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [PageMediaColorOption\[\]](../../com.aspose.xps.metadata/pagemediacoloroption) | Un array di opzioni specifiche per la funzionalità. |
