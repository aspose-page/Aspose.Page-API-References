...
type: docs
weight: 45
url: /it/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Descrive il metodo di rilegatura. Tutti i documenti nel lavoro sono rilegati insieme.  JobBindAllDocuments  e  DocumentBinding  sono mutualmente esclusivi. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Crea una nuova istanza. |
## Metodi
