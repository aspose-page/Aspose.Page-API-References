...
description: "Descrive le opzioni delle funzionalità JobOutputBin, DocumentOutputBin e PageOutputBin."
type: docs
weight: 12
url: /it/java/com.aspose.xps.metadata/outputbin.outputbinoption/
---
**Inheritance:**
...
Descrive le opzioni delle funzionalità  JobOutputBin ,  DocumentOutputBin  e  PageOutputBin .
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [OutputBinOption(OutputBin.IOutputBinOptionItem[] items)](#OutputBinOption-com.aspose.xps.metadata.OutputBin.IOutputBinOptionItem...-) | Crea una nuova istanza. |
## Metodi
...
| [add(OutputBin.IOutputBinOptionItem[] items)](#add-com.aspose.xps.metadata.OutputBin.IOutputBinOptionItem...-) | Aggiunge un array di istanze di IOutputBinOptionItem alla funzionalità. |
...
| --- | --- | --- |
| items | [IOutputBinOptionItem\[\]](../../com.aspose.xps.metadata/ioutputbinoptionitem) | Un array arbitrario di istanze di IOutputBinOptionItem. |
...
Aggiunge un array di istanze di IOutputBinOptionItem alla funzionalità.
