...
description: "Descrive le opzioni della funzionalità ErrorSheetWhen."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità ErrorSheetWhen.
## Campi

| Campo | Descrizione |
| --- | --- |
| [Always](#Always) | Specifica che un foglio di errore verrà generato per ogni lavoro. |
| [OnError](#OnError) | Specifica che un foglio di errore verrà generato solo in caso di errore. |
## Metodi
...
Specifica che un foglio di errore verrà generato per ogni lavoro.
...
Specifica che un foglio di errore verrà generato solo in caso di errore.
