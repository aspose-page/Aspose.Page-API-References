...
type: docs
weight: 24
url: /it/java/com.aspose.xps.metadata/documentholepunch/
---
**Inheritance:**
...
Descrive le caratteristiche di foratura del risultato. Ogni documento è forato separatamente. Le parole chiave  JobHolePunch  e  DocumentHolePunch  sono mutualmente esclusive. Entrambe non dovrebbero essere specificate simultaneamente in un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentHolePunch(HolePunch.HolePunchOption[] options)](#DocumentHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Crea una nuova istanza. |
## Metodi
