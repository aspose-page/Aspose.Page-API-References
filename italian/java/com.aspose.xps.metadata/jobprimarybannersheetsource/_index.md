...
description: "Specifica la sorgente per un foglio banner personalizzato primario per il lavoro."
type: docs
weight: 65
url: /it/java/com.aspose.xps.metadata/jobprimarybannersheetsource/
---
**Inheritance:**
...
Specifica l'origine per un foglio banner personalizzato primario per il lavoro. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobPrimaryBannerSheetSource(String value)](#JobPrimaryBannerSheetSource-java.lang.String-) | Crea una nuova istanza. |
## Metodi
