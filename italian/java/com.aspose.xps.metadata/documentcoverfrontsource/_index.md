...
description: "Specifica la sorgente per un foglio di copertina anteriore personalizzato."
type: docs
weight: 22
url: /it/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
Specifica la sorgente per un foglio di copertina anteriore personalizzato. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | Crea una nuova istanza. |
## Metodi
