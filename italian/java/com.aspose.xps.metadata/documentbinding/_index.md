...
description: "Descrive il metodo di rilegatura."
type: docs
weight: 15
url: /it/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Descrive il metodo di rilegatura. Ogni documento è rilegato separatamente. DocumentBinding e JobBindAllDocuments sono mutualmente esclusivi. Spetta al driver determinare la gestione dei vincoli tra le parole chiave. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Un array di opzioni specifiche per la funzionalità. |
