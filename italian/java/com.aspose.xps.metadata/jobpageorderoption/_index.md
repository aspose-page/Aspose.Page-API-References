...
description: "Descrive le opzioni della funzionalità JobPageOrder."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità  JobPageOrder  .
## Campi

| Campo | Descrizione |
| --- | --- |
| [Reverse](#Reverse) | Specifica l'ordine delle pagine da retro a fronte. |
| [Standard](#Standard) | Specifica l'ordine delle pagine da fronte a retro. |
## Metodi
...
Specifica l'ordine delle pagine da retro a fronte.
...
Specifica l'ordine delle pagine da fronte a retro.
