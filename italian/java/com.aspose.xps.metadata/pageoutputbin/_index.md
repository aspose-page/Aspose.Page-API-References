...
type: docs
weight: 114
url: /it/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Descrive l'elenco completo dei vassoi supportati dal dispositivo. Consente la specificazione del vassoio di uscita per pagina. Le parole chiave  JobOutputBin ,  DocumentOutputBin  e  PageOutputBin  sono mutualmente esclusive; solo una dovrebbe essere specificata in un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Crea una nuova istanza. |
## Metodi
