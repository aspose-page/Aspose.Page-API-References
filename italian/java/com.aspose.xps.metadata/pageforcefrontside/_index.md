...
description: "Forza l'output a comparire sul lato anteriore di un foglio di supporto."
type: docs
weight: 97
url: /it/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Forza l'output a comparire sul lato anteriore di un foglio di supporto. Rilevante per fogli di supporto con superfici diverse su ciascun lato. Nei casi in cui questa funzionalità interferisce con le opzioni di elaborazione (come  DocumentDuplex ),  PageForceFrontSide  ha la precedenza per la pagina specifica a cui la funzionalità si applica.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | Un array di opzioni specifiche per la funzionalità. |
