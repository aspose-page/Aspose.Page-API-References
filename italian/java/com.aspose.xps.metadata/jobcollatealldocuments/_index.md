...
description: "Descrive le caratteristiche di raggruppamento dell'output."
type: docs
weight: 47
url: /it/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Descrive le caratteristiche di raggruppamento dell'output. Tutti i documenti in ciascun lavoro individuale sono raggruppati.  DocumentCollate  e  JobCollateAllDocuments  sono mutualmente esclusivi. Il comportamento e l'implementazione di se entrambi o solo uno di questi termini chiave è implementato è lasciato al driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | Un array di opzioni specifiche per la funzionalità. |
