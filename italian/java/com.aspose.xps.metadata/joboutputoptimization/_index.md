...
description: "Descrive l'elaborazione del lavoro destinata a ottimizzare l'output per particolari scenari d'uso come indicato dall'opzione specificata."
type: docs
weight: 62
url: /it/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
Descrive l'elaborazione del lavoro, destinata a ottimizzare l'output per particolari scenari d'uso come indicato dall'opzione specificata. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | Un array di opzioni specifiche per la funzionalità. |
