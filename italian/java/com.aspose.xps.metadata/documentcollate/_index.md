...
type: docs
weight: 17
url: /it/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Descrive le caratteristiche di raggruppamento dell'output. Tutte le pagine in ciascun documento individuale sono raggruppate. DocumentCollate e JobCollateAlldocuments sono mutualmente esclusivi. Il comportamento e l'implementazione di se entrambi o solo uno di questi termini chiave è implementato è lasciato al driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Crea una nuova istanza. |
## Metodi
