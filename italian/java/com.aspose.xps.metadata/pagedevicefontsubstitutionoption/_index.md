...
description: "Descrive le opzioni della funzionalità PageDeviceFontSubstitution."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità  PageDeviceFontSubstitution  .
## Campi

| Campo | Descrizione |
| --- | --- |
| [Off](#Off) | La sostituzione dei caratteri del dispositivo di pagina è disattivata. |
| [On](#On) | La sostituzione dei caratteri del dispositivo di pagina è attivata. |
## Metodi
...
La sostituzione dei caratteri del dispositivo di pagina è disattivata.
...
La sostituzione dei caratteri del dispositivo di pagina è attivata.
