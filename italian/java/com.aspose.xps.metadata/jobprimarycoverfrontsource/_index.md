...
description: "Specifica la sorgente per un foglio di copertina anteriore primario personalizzato per il lavoro."
type: docs
weight: 69
url: /it/java/com.aspose.xps.metadata/jobprimarycoverfrontsource/
---
**Inheritance:**
...
Specifica l'origine per un foglio principale di copertina anteriore personalizzato per il lavoro. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobPrimaryCoverFrontSource(String value)](#JobPrimaryCoverFrontSource-java.lang.String-) | Crea una nuova istanza. |
## Metodi
