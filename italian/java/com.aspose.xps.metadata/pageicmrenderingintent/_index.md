...
description: "Descrive l'intento di rendering come definito dalla Specifica ICC v2."
type: docs
weight: 98
url: /it/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
Descrive l'intento di rendering come definito dalla Specifica ICC v2. Questo valore dovrebbe essere ignorato se un'immagine o un elemento grafico ha un profilo incorporato che specifica l'intento di Rendering. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageicmrenderingintent
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | Un array di opzioni specifiche per la funzionalità. |
