...
description: "Descrive le caratteristiche duplex dell'output."
type: docs
weight: 52
url: /it/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Descrive le caratteristiche duplex dell'output. La funzionalità duplex consente la stampa su entrambi i lati del supporto. Tutti i Documenti nel lavoro vengono duplexati insieme in modo contiguo.  JobDuplexAllDocumentsContiguously  e  DocumentDuplex  sono mutualmente esclusivi. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [DuplexOption\[\]](../../com.aspose.xps.metadata/duplexoption) | Un array di opzioni specifiche per la funzionalità. |
