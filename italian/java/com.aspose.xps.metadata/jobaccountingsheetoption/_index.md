...
description: "Descrive le opzioni della funzionalità JobAccountingSheet."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità JobAccountingSheet.
## Campi

| Campo | Descrizione |
| --- | --- |
| [None](#None) | Specifica che non verrà generato alcun foglio di contabilità. |
| [Standard](#Standard) | Specifica che dovrebbe essere generato il foglio di contabilità standard (definito dal dispositivo). |
## Metodi
...
Specifica che non verrà generato alcun foglio di contabilità.
...
Specifica che dovrebbe essere generato il foglio di contabilità standard (definito dal dispositivo).
