...
description: "Descrive il metodo di taglio per la carta rotolo."
type: docs
weight: 33
url: /it/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Descrive il metodo di taglio per la carta a rotolo. Ogni documento è gestito separatamente. Le opzioni specificate descrivono i diversi metodi per il taglio a rotolo. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Un array di opzioni specifiche per la funzionalità. |
