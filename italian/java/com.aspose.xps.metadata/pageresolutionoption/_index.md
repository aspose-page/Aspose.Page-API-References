...
description: "Descrive le opzioni delle funzionalità PageResolution."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pageresolution.pageresolutionoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità PageResolution.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageResolutionOption(String optionName, PageResolution.IPageResolutionOptionItem[] items)](#PageResolutionOption-java.lang.String-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | Crea una nuova istanza. |
## Metodi
...
| [add(PageResolution.IPageResolutionOptionItem[] items)](#add-com.aspose.xps.metadata.PageResolution.IPageResolutionOptionItem...-) | Aggiunge un array di istanze IPageResolutionOptionItem all'opzione. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setResolutionX(int resolutionX)](#setResolutionX-int-) | Imposta un valore di proprietà valutato  ResolutionX  . |
| [setResolutionY(int resolutionY)](#setResolutionY-int-) | Imposta un valore di proprietà valutato  ResolutionY  . |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| items | [IPageResolutionOptionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionoptionitem) | Un array arbitrario di istanze di  IPageResolutionOptionItem  . |
...
Aggiunge un array di istanze IPageResolutionOptionItem all'opzione.
...
Imposta un valore di proprietà valutato  ResolutionX  .

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| resolutionX | int | Un valore di proprietà valutato  ResolutionX  . |
...
Imposta un valore di proprietà valutato  ResolutionY  .

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| resolutionY | int | Un valore di proprietà valutato  ResolutionY  . |
