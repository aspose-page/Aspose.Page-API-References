...
type: docs
weight: 35
url: /it/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
Descrive le caratteristiche di rilegatura dell'output. Ogni documento è rilegato separatamente. Le parole chiave JobStapleAllDocuments e DocumentStaple sono mutualmente esclusive. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | Crea una nuova istanza. |
## Metodi
