...
description: "Definisce il valore della proprietà valutata MediaSheetCapacity che specifica la capacità del supporto in numero di pagine al livello pieno del contenitore."
type: docs
weight: 11
url: /it/java/com.aspose.xps.metadata/outputbin.mediasheetcapacity/
---
**Inheritance:**
...
Definisce il valore della proprietà valutata  MediaSheetCapacity  che specifica la capacità del supporto in numero di pagine (livello completo) del vassoio.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [MediaSheetCapacity(int mediaSheetCapacity)](#MediaSheetCapacity-int-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| mediaSheetCapacity | int | Un valore della proprietà valutata  MediaSheetCapacity . |
