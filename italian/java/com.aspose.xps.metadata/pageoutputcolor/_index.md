...
description: "Descrive le caratteristiche delle impostazioni di colore per l'output."
type: docs
weight: 115
url: /it/java/com.aspose.xps.metadata/pageoutputcolor/
---
**Inheritance:**
...
Descrive le caratteristiche delle impostazioni di colore per l'output. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputcolor
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PageOutputColor(PageOutputColor.IPageOutputColorItem[] items)](#PageOutputColor-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorItem...-) | Crea una nuova istanza. |
## Metodi
...
| --- | --- | --- |
| items | [IPageOutputColorItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloritem) | Un array di elementi specifici per la funzionalità. |
