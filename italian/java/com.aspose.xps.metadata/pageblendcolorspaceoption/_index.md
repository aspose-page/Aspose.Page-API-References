...
description: "Descrive le opzioni della funzionalità PageBlendColorSpace."
type: docs
weight: 10
url: /it/java/com.aspose.xps.metadata/pageblendcolorspace.pageblendcolorspaceoption/
---
**Inheritance:**
...
Descrive le opzioni della funzionalità  PageBlendColorSpace  .
## Campi

| Campo | Descrizione |
| --- | --- |
| [ICCProfile](#ICCProfile) | Specifica un profilo ICC che definisce lo spazio colore che DOVREBBE essere usato per la fusione. |
| [sRGB](#sRGB) | Lo spazio colore sRGB DEVE essere usato per la fusione. |
| [scRGB](#scRGB) | Lo spazio colore scRGB DEVE essere usato per la fusione. |
## Metodi
...
Specifica un profilo ICC che definisce lo spazio colore che DEVE essere usato per la fusione. Nota: ciò si applica solo ai documenti XPS e non dovrebbe essere usato in PrintTicket arbitrari.
...
Lo spazio colore sRGB DEVE essere usato per la fusione.
...
Lo spazio colore scRGB DEVE essere usato per la fusione.
