...
type: docs
weight: 11
url: /it/java/com.aspose.eps.device/pdfsaveoptions/
---
**Inheritance:**
...
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | Inizializza una nuova istanza della classe PdfSaveOptions con i valori predefiniti per i flag suppressErrors (true) e debug (false). |
| [PdfSaveOptions(boolean supressErrors)](#PdfSaveOptions-boolean-) | Inizializza una nuova istanza della classe PdfSaveOptions con i valori predefiniti per il flag debug (false). |
| [PdfSaveOptions(Dimension size)](#PdfSaveOptions-java.awt.Dimension-) | Inizializza una nuova istanza della classe PdfSaveOptions con la dimensione della pagina. |
| [PdfSaveOptions(boolean supressErrors, Dimension size)](#PdfSaveOptions-boolean-java.awt.Dimension-) | Inizializza una nuova istanza della classe PdfSaveOptions con i valori predefiniti per il flag debug (false) e la dimensione della pagina. |
## Metodi
...
Inizializza una nuova istanza della classe PdfSaveOptions con la dimensione della pagina.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| dimensione | java.awt.Dimension | La dimensione della pagina. |
...
Inizializza una nuova istanza della classe PdfSaveOptions con i valori predefiniti per il flag debug (false) e la dimensione della pagina.
