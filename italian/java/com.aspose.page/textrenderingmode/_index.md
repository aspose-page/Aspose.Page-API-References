...
description: "Questo enum contiene i possibili valori per la modalità di rendering del testo."
type: docs
weight: 24
url: /it/java/com.aspose.page/textrenderingmode/
---
**Inheritance:**
...
Questo enum contiene i possibili valori per la modalità di rendering del testo.
## Campi

| Campo | Descrizione |
| --- | --- |
| [Fill](#Fill) | Riempire un testo. |
| [FillAndStroke](#FillAndStroke) | Riempire e tracciare un testo. |
| [No](#No) | Né riempire né tracciare un testo. |
| [Stroke](#Stroke) | Tracciare un testo. |
## Metodi
...
Né riempire né tracciare un testo.
