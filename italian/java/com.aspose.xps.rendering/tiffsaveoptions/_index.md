...
description: "Classe per le opzioni di salvataggio XPS-as-TIFF."
type: docs
weight: 16
url: /it/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Classe per le opzioni di salvataggio XPS-as-TIFF.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Crea una nuova istanza di opzioni. |
## Metodi
...
| [multipage()](#multipage--) | Ottiene il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina. |
| [multipage(boolean value)](#multipage-boolean-) | Imposta il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Ottiene il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina.

**Returns:**
boolean - Il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina.
...
Imposta il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Il flag che definisce se più immagini devono essere salvate in un unico file TIFF multipagina. |
