...
description: Questa classe incapsula il rendering del documento in un dispositivo astratto. Il rendering del documento viene eseguito pagina per pagina.
type: docs
weight: 20
...
| Nome | Descrizione |
| --- | --- |
| [Device](device)(Size) | Inizializza[`Device`](../device) con una dimensione di una pagina. |
...
| virtual [Paint](../../aspose.page/device/paint) { get; set; } | Restituisce o specifica la vernice corrente. |
...
| virtual [Dispose](../../aspose.page/device/dispose)() | Elimina il dispositivo. |
...
| virtual [DrawPolygon](../../aspose.page/device/drawpolygon#drawpolygon)(double[], double[], int) | Disegna un poligone. |
...
| virtual [DrawString](../../aspose.page/device/drawstring)(string, double, double) | Disegna una stringa in un determinato punto. |
| virtual [EndDocument](../../aspose.page/device/enddocument)() | Rende necessaria la preparazione del dispositivo dopo il rendering del documento. |
...
| virtual [ReNew](../../aspose.page/device/renew)() | Reimposta il dispositivo allo stato iniziale per l'intero documento. Utilizzato per ripristinare il flusso di output. |
| virtual [Reset](../../aspose.page/device/reset)() | Reimposta il dispositivo allo stato iniziale per una pagina. |
| virtual [Rotate](../../aspose.page/device/rotate#rotate)(double) | Ruota la matrice di trasformazione corrente. Chiama writeTransform(Transform). Ruotando con un angolo positivo theta ruota i punti sull'asse x positivo verso l'asse y positivo. |
...
| virtual [Transform](../../aspose.page/device/transform)(Matrix) | Trasforma la matrice di trasformazione corrente. Chiamate writeTransform(Transform) |
| virtual [Translate](../../aspose.page/device/translate)(double, double) | Traduce la matrice di trasformazione corrente. Chiama writeTransform(Transform). |
...
| Nome | Descrizione |
| --- | --- |
| static [VERSION](../../aspose.page/device/version) | Versione attuale del dispositivo. |
