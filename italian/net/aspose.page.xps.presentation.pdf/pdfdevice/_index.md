...
description: Aspose.Page.XPS.Presentation.Pdf.PdfDevice classe. Classe che incapsula il dispositivo di composizione dellimmagine.
type: docs
weight: 400
...
| [PdfDevice](pdfdevice/#constructor_1)(Stream, Size) | Crea la nuova istanza con le dimensioni del supporto specificate. |
...
| override [Font](../../aspose.page.xps.presentation.pdf/pdfdevice/font/) { get; set; } | Ottiene/imposta il font corrente. |
...
| override [Paint](../../aspose.page.xps.presentation.pdf/pdfdevice/paint/) { get; set; } | Ottiene/imposta il pennello per riempire i tracciati. |
...
| override [Size](../../aspose.page.xps.presentation.pdf/pdfdevice/size/) { get; set; } | Ottiene/imposta le dimensioni del supporto del dispositivo. |
| override [Stroke](../../aspose.page.xps.presentation.pdf/pdfdevice/stroke/) { get; set; } | Ottiene/imposta il tratto per tracciare i percorsi. |
...
| Nome | Descrizione |
| --- | --- |
| virtual [AddOutline](../../aspose.page.xps.presentation.pdf/pdfdevice/addoutline/#addoutline)(int, string) | Aggiunge un elemento di contorno con l'ultimo oggetto come destinazione. |
| virtual [AddOutline](../../aspose.page.xps.presentation.pdf/pdfdevice/addoutline/#addoutline_1)(PointF, int, string) | Aggiunge un elemento di contorno con il punto di origine come destinazione. |
| virtual [ClosePage](../../aspose.page.xps.presentation.pdf/pdfdevice/closepage/)() | Realizza la pagina. |
| virtual [ClosePartition](../../aspose.page.xps.presentation.pdf/pdfdevice/closepartition/)() | Completata la partizione del documento. |
| override [Create](../../aspose.page.xps.presentation.pdf/pdfdevice/create/)() | Crea una nuova istanza del dispositivo basata su questa istanza del dispositivo. Scrive questo stato grafico del dispositivo, ovvero creaApsCanvas instance(s) con proprietà RenderTransform e Clip corrispondenti. |
| override [Dispose](../../aspose.page.xps.presentation.pdf/pdfdevice/dispose/)() | Elimina questa istanza del dispositivo. Finalizza lo stato grafico di questa istanza del dispositivo, ovvero cambia il contesto di composizione APS inApsCanvas del livello più alto dello stato grafico di this dispositivoApsCanvas . |
...
| override [EndDocument](../../aspose.page.xps.presentation.pdf/pdfdevice/enddocument/)() | Realizza il documento. |
...
| [InitPageNumbers](../../aspose.page.xps.presentation.pdf/pdfdevice/initpagenumbers/)() | Inizializza il numero di pagine da produrre. |
...
| virtual [OpenPartition](../../aspose.page.xps.presentation.pdf/pdfdevice/openpartition/)() | Inizia una nuova partizione del documento. |
...
| override [Rotate](../../aspose.page.xps.presentation.pdf/pdfdevice/rotate/#rotate)(double) | Applica una rotazione oraria attorno all'origine alla matrice di trasformazione corrente. |
...
| override [Transform](../../aspose.page.xps.presentation.pdf/pdfdevice/transform/)(Matrix) | Moltiplica la matrice di trasformazione corrente per quella specificataMatrix . |
