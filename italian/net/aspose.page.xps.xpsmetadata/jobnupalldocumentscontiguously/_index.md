...
description: Aspose.Page.XPS.XpsMetadata.JobNUpAllDocumentsContiguously classe. Descrive loutput di più pagine logiche in un singolo foglio fisico. Tutti i documenti nel job vengono compilati insieme in modo contiguo.JobNUpAllDocumentsContiguously EDocumentNUp si escludono a vicenda. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https//docs.microsoft.com/enus/windows/win32/printdocs/jobnupalldocumentscontiguously
type: docs
weight: 1380
...
Descrive l'output di più pagine logiche in un singolo foglio fisico. Tutti i documenti nel job vengono compilati insieme in modo contiguo.`JobNUpAllDocumentsContiguously` E[`DocumentNUp`](../documentnup/) si escludono a vicenda. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
...
| [AddPagesPerSheetOption](../../aspose.page.xps.xpsmetadata/jobnupalldocumentscontiguously/addpagespersheetoption/)(int) | Aggiunge un'opzione con a valore della proprietà score. Specifica il numero di pagine logiche per foglio fisico. |
