...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation classe. Descrive lorientamento del foglio del supporto fisico. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2310
...
Descrive l'orientamento del foglio del supporto fisico. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| Nome | Descrizione |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | Descrive il`PageOrientation` opzioni di funzionalità. |
