...
Descrive le caratteristiche di perforazione dell'output. Ogni documento è perforato separatamente. The[`JobHolePunch`](../jobholepunch/) E`DocumentHolePunch` le parole chiave si escludono a vicenda. Non devono essere specificate entrambe contemporaneamente in un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
