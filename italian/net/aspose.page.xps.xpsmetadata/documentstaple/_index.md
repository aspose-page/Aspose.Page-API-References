...
description: Descrive le caratteristiche di pinzatura delloutput. Ogni documento viene pinzato separatamente. IlJobStapleAllDocuments./jobstaplealldocuments eDocumentStaple./documentstaplele parole chiave si escludono a vicenda. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https//docs.microsoft.com/enus/windows/win32/printdocs/documentstaple
type: docs
weight: 760
