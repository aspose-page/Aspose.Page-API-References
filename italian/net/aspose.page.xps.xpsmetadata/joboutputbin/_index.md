...
Descrive il raccoglitore di uscita installato in un dispositivo o l'elenco completo dei raccoglitori supportati per un dispositivo. Il`JobOutputBin` ,[`DocumentOutputBin`](../documentoutputbin/) E[`PageOutputBin`](../pageoutputbin/) keywords si escludono a vicenda, solo una deve essere specificata in un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputbin
