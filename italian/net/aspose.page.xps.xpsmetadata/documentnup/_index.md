...
description: Descrive loutput e il formato di più pagine logiche in un unico foglio fisico. Ogni documento viene compilato separatamente. eJobNUpAllDocumentsContiguously./jobnupalldocumentscontiguously si escludono a vicenda. Spetta al driver determinare la gestione dei vincoli tra queste parole chiave. https//docs.microsoft.com/enus/windows/win32/printdocs/documentnup
type: docs
weight: 680
...
| [AddPagesPerSheetOption](../../aspose.page.xps.xpsmetadata/documentnup/addpagespersheetoption)(int) | Aggiunge e opzione con a valore della proprietà con punteggio. Specifica il numero di pagine logiche per foglio fisico. |
