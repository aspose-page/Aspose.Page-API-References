...
type: docs
weight: 1830
url: /it/net/aspose.page.xps.xpsmetadata/pageblendcolorspaceiccprofileuri/
---
## PageBlendColorSpaceICCProfileURI class

Specifica un riferimento URI relativo a un profilo ICC che definisce lo spazio colore che DOVREBBE essere utilizzato per la fusione. &lt;Uri&gt; è un nome_parte assoluto relativo alla radice del pacchetto. https://docs.microsoft.com/en-us /windows/win32/printdocs/pageblendcolorspaceiccprofileuri
...
| Nome | Descrizione |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI](pageblendcolorspaceiccprofileuri/)(string) | Crea una nuova istanza. |
