...
description: Aspose.Page.XPS.XpsMetadata.JobPrimaryCoverFrontSource classe. Specifica lorigine per un foglio primario di copertina anteriore personalizzato per il lavoro. https//docs.microsoft.com/enus/windows/win32/printdocs/jobprimarycoverfrontsource
type: docs
weight: 1550
...
Specifica l'origine per un foglio primario di copertina anteriore personalizzato per il lavoro. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
