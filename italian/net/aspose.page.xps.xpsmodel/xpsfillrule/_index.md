...
description: Valori validi della proprietà FillRule dellelemento PathGeometry.
type: docs
weight: 3010
...
| NonZero | `1` | Questa regola determina l'"interno" di un punto sulla tela disegnando un raggio dal punto all'infinito in qualsiasi direzione e quindi esaminando i punti in cui un segmento della forma attraversa il raggio. Partendo da zero, aggiungi uno ogni volta che un segmento attraversa il raggio da sinistra a destra e sottrai uno ogni volta che un segmento di percorso attraversa il raggio da destra a sinistra. Dopo aver contato gli incroci, se il risultato è zero allora il punto è fuori dal percorso; altrimenti è dentro. |
