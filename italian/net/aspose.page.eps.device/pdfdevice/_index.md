...
description: Questa classe incapsula il rendering del documento in PDF.
type: docs
weight: 60
...
| Nome | Descrizione |
| --- | --- |
| [PdfDevice](pdfdevice#constructor)(Stream) | Inizializza la nuova istanza di[`PdfDevice`](../pdfdevice) con flusso di output. |
| [PdfDevice](pdfdevice#constructor_1)(Stream, Size) | Inizializza la nuova istanza di[`PdfDevice`](../pdfdevice) con flusso di output e dimensione specificata di una pagina. |
...
| virtual [CurrentPageNumber](../../aspose.page.eps.device/pdfdevice/currentpagenumber) { get; } | Numero di pagina corrente. |
...
| override [Paint](../../aspose.page.eps.device/pdfdevice/paint) { set; } | Restituisce o specifica la vernice corrente. |
...
| Nome | Descrizione |
| --- | --- |
| virtual [ClosePage](../../aspose.page.eps.device/pdfdevice/closepage)() | Effettua la preparazione necessaria del dispositivo dopo il rendering della pagina. |
| override [Create](../../aspose.page.eps.device/pdfdevice/create)() | Crea una copia di questo dispositivo. |
| override [Dispose](../../aspose.page.eps.device/pdfdevice/dispose)() | Elimina il contesto grafico. Se alla creazione restoreOnDispose era true, verrà chiamato writeGraphicsRestore(). |
...
| override [DrawString](../../aspose.page.eps.device/pdfdevice/drawstring)(string, double, double) | Disegna una stringa in un determinato punto. |
| override [EndDocument](../../aspose.page.eps.device/pdfdevice/enddocument)() | Rende necessaria la preparazione del dispositivo dopo il rendering del documento. |
...
| virtual [InitPageNumbers](../../aspose.page.eps.device/pdfdevice/initpagenumbers)() | Inizializza il numero di pagine da stampare. |
| [IsProperty](../../aspose.page/device/isproperty)(string) | Ottiene un valore della proprietà booleana. |
| virtual [OpenPage](../../aspose.page.eps.device/pdfdevice/openpage#openpage_1)(string) | Effettua la preparazione necessaria del dispositivo prima del rendering della pagina. |
| virtual [OpenPage](../../aspose.page.eps.device/pdfdevice/openpage#openpage)(float, float) | Effettua la necessaria preparazione del dispositivo prima di ogni rendering di pagina. |
| override [ReNew](../../aspose.page.eps.device/pdfdevice/renew)() | Reimposta il dispositivo allo stato iniziale per l'intero documento. Utilizzato per ripristinare il flusso di output. |
| override [Reset](../../aspose.page.eps.device/pdfdevice/reset)() | Se verranno impostati i parametri del dispositivo della pagina, questo metodo consente di restituire lo stream di scrittura all'inizio della pagina. |
| override [Rotate](../../aspose.page.eps.device/pdfdevice/rotate#rotate)(double) | Ruota la trasformazione corrente sull'asse Z. Chiama writeTransform(Transform). Ruotando con un angolo positivo theta ruota i punti sull'asse x positivo verso l'asse y positivo. |
...
| override [Transform](../../aspose.page.eps.device/pdfdevice/transform)(Matrix) | Trasforma la matrice di trasformazione corrente. Chiamate writeTransform(Transform) |
| override [Translate](../../aspose.page.eps.device/pdfdevice/translate)(double, double) | Traduce la matrice di trasformazione corrente. Chiama writeTransform(Transform). |
| virtual [UpdatePageParameters](../../aspose.page.eps.device/pdfdevice/updatepageparameters)(IMultiPageDevice) | Aggiorna i parametri della pagina da un altro dispositivo a più pagine. |
...
| static readonly [BACKGROUND](../../aspose.page.eps.device/pdfdevice/background) | Chiave proprietà "Sfondo". |
| static readonly [BACKGROUND_COLOR](../../aspose.page.eps.device/pdfdevice/background_color) | Chiave di proprietà "Colore di sfondo". |
| static readonly [COMPRESS](../../aspose.page.eps.device/pdfdevice/compress) | Chiave proprietà "Comprimi". |
...
| static readonly [FIT_TO_PAGE](../../aspose.page.eps.device/pdfdevice/fit_to_page) | Chiave proprietà "Adatta contenuto alla pagina". |
| static readonly [KEYWORDS](../../aspose.page.eps.device/pdfdevice/keywords) | Valore della proprietà "Parole chiave". |
| static readonly [ORIENTATION](../../aspose.page.eps.device/pdfdevice/orientation) | Chiave proprietà "Orientamento". |
| static readonly [PAGE_MARGINS](../../aspose.page.eps.device/pdfdevice/page_margins) | Chiave proprietà "Margini pagina". |
| static readonly [PAGE_SIZE](../../aspose.page.eps.device/pdfdevice/page_size) | Chiave proprietà "Dimensioni pagina". |
...
| static readonly [TRANSPARENT](../../aspose.page.eps.device/pdfdevice/transparent) | Chiave proprietà "Trasparente". |
| static readonly [VERSION](../../aspose.page.eps.device/pdfdevice/version) | Chiave proprietà "Versione". |
| const [VERSION5](../../aspose.page.eps.device/pdfdevice/version5) | Valore della proprietà "Versione di Adobe Acrobat Reader". |
| static readonly [WRITE_IMAGES_AS](../../aspose.page.eps.device/pdfdevice/write_images_as) | Chiave proprietà "Formato immagini". |
