...
description: Aspose.Page.EPS.Device.ImageSaveOptions classe. Questa classe contiene le opzioni necessarie per gestire il processo di salvataggio delle immagini.
type: docs
weight: 50
...
Questa classe contiene le opzioni necessarie per gestire il processo di salvataggio delle immagini.
...
| Nome | Descrizione |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/#constructor)() | Inizializza una nuova istanza di`ImageSaveOptions` class con valori predefiniti per i flag!:SuppressErrors (vero) e!:Debug (falso). |
| [ImageSaveOptions](imagesaveoptions/#constructor_1)(bool) | Inizializza una nuova istanza di`ImageSaveOptions` with valore predefinito per flag!:Debug (falso). |
...
| [SmoothingMode](../../aspose.page.eps.device/imagesaveoptions/smoothingmode/) { get; set; } | Ottiene/imposta la modalità di smoothing per il rendering dell'immagine. |
