...
description: Questa classe contiene le opzioni necessarie per gestire il processo di conversione del documento in file PostScript PS o Encapsulated PostScript EPS.
type: docs
weight: 80
...
Questa classe contiene le opzioni necessarie per gestire il processo di conversione del documento in file PostScript (PS) o Encapsulated PostScript (EPS).
...
| Nome | Descrizione |
| --- | --- |
| [PsSaveOptions](pssaveoptions#constructor)() | Inizializza una nuova istanza di[`PsSaveOptions`](../pssaveoptions) classe con valori predefiniti per i flag!:SuppressErrors (vero) e!:Debug (falso). |
| [PsSaveOptions](pssaveoptions#constructor_1)(bool) | Inizializza una nuova istanza di[`PsSaveOptions`](../pssaveoptions) classe con valori predefiniti per flag!:Debug (falso). |
