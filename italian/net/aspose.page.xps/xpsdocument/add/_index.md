...
description: Aggiunge un elemento di contenuto tela percorso o glifi
type: docs
weight: 90
url: /it/net/aspose.page.xps/xpsdocument/add/
---
## XpsDocument.Add&lt;T&gt; method

Aggiunge un elemento di contenuto (tela, percorso o glifi)
