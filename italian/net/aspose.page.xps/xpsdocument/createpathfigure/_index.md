...
description: XpsDocument metodo. Crea una nuova figura di percorso.
type: docs
weight: 280
...
| isClosed | Boolean | Specifica se il percorso è chiuso. Se impostato su true, il tratto viene disegnato "chiuso", ovvero l'ultimo punto nell'ultimo segmento della figura del percorso è connesso con il punto specificato nell'attributo StartPoint, altrimenti il tratto viene disegnato "aperto" e l'ultimo punto non è collegato al punto iniziale. Applicabile solo se la cifra del percorso è utilizzata in un elemento {Path} che specifica un tratto. |
