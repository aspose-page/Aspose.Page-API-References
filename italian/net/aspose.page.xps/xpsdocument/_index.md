...
description: Classe che incapsula lentità principale del documento XPS che fornisce metodi di manipolazione per qualsiasi elemento XPS.
type: docs
weight: 410
...
| Nome | Descrizione |
| --- | --- |
| [XpsDocument](xpsdocument#constructor)() | Crea un documento XPS vuoto con dimensioni pagina predefinite. |
...
| [JobPrintTicket](../../aspose.page.xps/xpsdocument/jobprintticket) { get; set; } | Restituisce/imposta il ticket di stampa del lavoro del documento |
| [Page](../../aspose.page.xps/xpsdocument/page) { get; } | Restituisce un[`XpsPage`](../../aspose.page.xps.xpsmodel/xpspage) istanza per pagina attiva. |
...
| Nome | Descrizione |
| --- | --- |
| [Add&lt;T&gt;](../../aspose.page.xps/xpsdocument/add)(T) | Aggiunge un elemento di contenuto (tela, percorso o glifi) |
| [AddCanvas](../../aspose.page.xps/xpsdocument/addcanvas)() | Aggiunge una nuova tela alla pagina attiva. |
| [AddDocument](../../aspose.page.xps/xpsdocument/adddocument#adddocument)(bool) | Aggiunge un documento vuoto con dimensioni pagina predefinite. |
...
| [AddOutlineEntry](../../aspose.page.xps/xpsdocument/addoutlineentry)(string, int, XpsHyperlinkTarget) | Aggiunge una voce di struttura al documento. |
| [AddPage](../../aspose.page.xps/xpsdocument/addpage#addpage_1)(bool) | Aggiunge una pagina vuota al documento con dimensioni pagina predefinite. |
...
| [CreateFont](../../aspose.page.xps/xpsdocument/createfont#createfont)(Stream) | Crea una nuova risorsa font TrueType fuori flusso. |
...
| [CreateImage](../../aspose.page.xps/xpsdocument/createimage#createimage_1)(string) | Crea una nuova risorsa immagine dal file immagine che si trova in*imagePath* . |
...
| [CreateLinearGradientBrush](../../aspose.page.xps/xpsdocument/createlineargradientbrush#createlineargradientbrush_1)(PointF, PointF) | Crea un nuovo pennello gradiente lineare. |
| [CreateLinearGradientBrush](../../aspose.page.xps/xpsdocument/createlineargradientbrush#createlineargradientbrush)(List&lt;XpsGradientStop&gt;, PointF, PointF) | Crea un nuovo pennello gradiente lineare. |
...
| [CreatePathGeometry](../../aspose.page.xps/xpsdocument/createpathgeometry#createpathgeometry_1)(List&lt;XpsPathFigure&gt;) | Crea una nuova geometria del percorso con l'elenco specificato di figure del percorso. |
...
| [CreatePolyLineSegment](../../aspose.page.xps/xpsdocument/createpolylinesegment)(PointF[], bool) | Crea un nuovo disegno poligonale contenente un numero arbitrario di vertici individuali. |
| [CreatePolyQuadraticBezierSegment](../../aspose.page.xps/xpsdocument/createpolyquadraticbeziersegment)(PointF[], bool) | Crea un nuovo insieme di curve di Bézier quadratiche dal punto precedente nella figura del percorso attraverso un insieme di vertici, utilizzando punti di controllo specificati. |
...
| [Insert&lt;T&gt;](../../aspose.page.xps/xpsdocument/insert)(int, T) | Inserisce un elemento (Canvas, Path o Glyphs) nella pagina attiva in*index* posizione. |
...
| [InsertDocument](../../aspose.page.xps/xpsdocument/insertdocument#insertdocument)(int, bool) | Inserisce un documento vuoto con dimensione pagina predefinita a*index* posizione. |
...
| [InsertPage](../../aspose.page.xps/xpsdocument/insertpage#insertpage_1)(int, bool) | Inserisce una pagina vuota nel documento con dimensione pagina predefinita in*index* posizione. |
...
| [Merge](../../aspose.page.xps/xpsdocument/merge#merge_1)(string[], Stream) | Unione di più file XPS in un documento XPS. |
...
| [Save](../../aspose.page.xps/xpsdocument/save#save_1)(Stream) | Salva il documento XPS in streaming. |
| [Save](../../aspose.page.xps/xpsdocument/save#save_2)(string) | Salva il documento XPS nel file XPS che si trova nella cartella*path* . |
| override [Save](../../aspose.page.xps/xpsdocument/save#save)(Device, SaveOptions) | Salva il documento utilizzando il[`Device`](../../aspose.page/device) istanza. |
| [SelectActiveDocument](../../aspose.page.xps/xpsdocument/selectactivedocument)(int) | Seleziona un documento attivo per la modifica. |
| [SelectActivePage](../../aspose.page.xps/xpsdocument/selectactivepage)(int) | Seleziona una pagina del documento attiva per la modifica. |
