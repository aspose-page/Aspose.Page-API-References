...
description: XpsDocument metodo. Inserisce un elemento Canvas Path o Glyphs nella pagina attiva aindex posizione.
type: docs
weight: 390
...
Inserisce un elemento (Canvas, Path o Glyphs) nella pagina attiva a*index* posizione.
