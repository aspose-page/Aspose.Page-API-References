...
description: Aspose.Page.XPS.XpsMetadata.PageDestinationColorProfileEmbedded τάξη. Καθορίζει το ενσωματωμένο χρωματικό προφίλ προορισμού. https//docs.microsoft.com/enus/windows/win32/printdocs/pagedestinationcolorprofileembedded
type: docs
weight: 1900
url: /el/net/aspose.page.xps.xpsmetadata/pagedestinationcolorprofileembedded/
---
## PageDestinationColorProfileEmbedded class

Καθορίζει το ενσωματωμένο χρωματικό προφίλ προορισμού. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageDestinationColorProfileEmbedded](pagedestinationcolorprofileembedded/)(string) | Δημιουργεί μια νέα παρουσία. |
