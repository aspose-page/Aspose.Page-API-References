...
Περιγράφει την αρνητική ρύθμιση της εξόδου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputquality
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageOutputQuality](pageoutputquality/)(params PageOutputQualityOption[]) | Δημιουργεί μια νέα παρουσία. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| class [PageOutputQualityOption](pageoutputquality.pageoutputqualityoption/) | Ορίζει`PageOutputQuality` επιλογές χαρακτηριστικών. |
