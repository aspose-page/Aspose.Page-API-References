...
Σε συνδυασμό με το[`PageDeviceColorSpaceProfileURI`](../pagedevicecolorspaceprofileuri/) παράμετρος, αυτή η παράμετρος ορίζει τη συμπεριφορά απόδοσης για στοιχεία που παρουσιάζονται σε έναν χρωματικό χώρο συσκευής. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageDeviceColorSpaceUsage](pagedevicecolorspaceusage/)(params PageDeviceColorSpaceUsageOption[]) | Δημιουργεί μια νέα παρουσία. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| class [PageDeviceColorSpaceUsageOption](pagedevicecolorspaceusage.pagedevicecolorspaceusageoption/) | Περιγράφει το`PageDeviceColorSpaceUsage` επιλογές χαρακτηριστικών. |
