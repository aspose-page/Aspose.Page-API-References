...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation τάξη. Περιγράφει τον προσανατολισμό του φυσικού φύλλου μέσων. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
url: /el/net/aspose.page.xps.xpsmetadata/pageorientation/
---
## PageOrientation class

Περιγράφει τον προσανατολισμό του φυσικού φύλλου μέσων. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | Δημιουργεί μια νέα παρουσία. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | Περιγράφει το`PageOrientation` επιλογές χαρακτηριστικών. |
