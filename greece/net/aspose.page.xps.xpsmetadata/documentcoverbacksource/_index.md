...
description: Aspose.Page.XPS.XpsMetadata.DocumentCoverBackSource τάξη. Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο οπισθόφυλλου. https//docs.microsoft.com/enus/windows/win32/printdocs/documentcoverbacksource
type: docs
weight: 660
url: /el/net/aspose.page.xps.xpsmetadata/documentcoverbacksource/
---
## DocumentCoverBackSource class

Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο οπισθόφυλλου. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverbacksource
...
| Ονομα | Περιγραφή |
| --- | --- |
| [DocumentCoverBackSource](documentcoverbacksource/)(string) | Δημιουργεί μια νέα παρουσία. |
