...
Καθορίζει την πηγή για ένα προσαρμοσμένο κύριο φύλλο οπισθόφυλλου για την εργασία. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
...
| Ονομα | Περιγραφή |
| --- | --- |
| [JobPrimaryCoverBackSource](jobprimarycoverbacksource/)(string) | Δημιουργεί μια νέα παρουσία. |
