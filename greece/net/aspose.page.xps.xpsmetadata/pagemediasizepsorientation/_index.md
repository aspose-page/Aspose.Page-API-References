...
Καθορίζει τον προσανατολισμό σε σχέση με την κατεύθυνση προσανατολισμού ροής https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsorientation
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageMediaSizePSOrientation](pagemediasizepsorientation/)(int) | Δημιουργεί μια νέα παρουσία. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| override [MaxValue](../../aspose.page.xps.xpsmetadata/pagemediasizepsorientation/maxvalue/) { get; } | Για παραμέτρους με ακέραιο ή δεκαδικό αριθμό, ορίζει τη μεγαλύτερη επιτρεπόμενη τιμή. |
| override [MinValue](../../aspose.page.xps.xpsmetadata/pagemediasizepsorientation/minvalue/) { get; } | Για παραμέτρους με ακέραιο ή δεκαδικό αριθμό, ορίζει τη μικρότερη επιτρεπόμενη τιμή. |
