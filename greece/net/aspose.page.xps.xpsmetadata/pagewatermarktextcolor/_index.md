...
Καθορίζει το χρώμα sRGB για το κείμενο του υδατογραφήματος. Η μορφή είναι ARGB: #AARRGGBB. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextcolor
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageWatermarkTextColor](pagewatermarktextcolor/)(string) | Δημιουργεί μια νέα παρουσία. |
