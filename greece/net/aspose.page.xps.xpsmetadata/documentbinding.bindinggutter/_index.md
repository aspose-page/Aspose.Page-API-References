...
| Ονομα | Περιγραφή |
| --- | --- |
| static [DocumentBindingGutter](../../aspose.page.xps.xpsmetadata/bindinggutter/documentbindinggutter/) | Καθορίζει το βαθμολογήθηκε η τιμή ιδιότητας με την αναφορά στο παράμετρος. |
