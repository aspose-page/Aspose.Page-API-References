...
Καθορίζει τη σειρά των φυσικών σελίδων για την έξοδο. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobpageorder
...
| Ονομα | Περιγραφή |
| --- | --- |
| [JobPageOrder](jobpageorder/)(params JobPageOrderOption[]) | Δημιουργεί μια νέα παρουσία. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| class [JobPageOrderOption](jobpageorder.jobpageorderoption/) | Περιγράφει το`JobPageOrder` επιλογές χαρακτηριστικών. |
