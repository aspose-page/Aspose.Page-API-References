...
Καθορίζει συμπεριφορά μαύρης γενιάς για διαχωρισμούς CMYK. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessing
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageBlackGenerationProcessing](pageblackgenerationprocessing/)(params PageBlackGenerationProcessingOption[]) | Δημιουργεί μια νέα παρουσία. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| class [PageBlackGenerationProcessingOption](pageblackgenerationprocessing.pageblackgenerationprocessingoption/) | Περιγράφει το`PageBlackGenerationProcessing` επιλογές χαρακτηριστικών. |
