...
Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο σφαλμάτων. https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheetsource
...
| Ονομα | Περιγραφή |
| --- | --- |
| [JobErrorSheetSource](joberrorsheetsource/)(string) | Δημιουργεί μια νέα παρουσία. |
