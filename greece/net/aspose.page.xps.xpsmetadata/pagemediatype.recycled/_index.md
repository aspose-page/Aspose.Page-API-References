...
description: Aspose.Page.XPS.XpsMetadata.PageMediaTypeRecycled τάξη. Ορίζει σταθερές για το βαθμολογία ιδιότητας.
type: docs
weight: 2260
url: /el/net/aspose.page.xps.xpsmetadata/pagemediatype.recycled/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| static [None](../../aspose.page.xps.xpsmetadata/recycled/none/) | Καμία τιμή. |
| static [Standard](../../aspose.page.xps.xpsmetadata/recycled/standard/) | Τυπική τιμή. |
