...
description: Aspose.Page.XPS.XpsMetadata.PageWatermarkTextText τάξη. Καθορίζει το κείμενο του υδατογραφήματος. https//docs.microsoft.com/enus/windows/win32/printdocs/pagewatermarktexttext
type: docs
weight: 2750
url: /el/net/aspose.page.xps.xpsmetadata/pagewatermarktexttext/
---
## PageWatermarkTextText class

Καθορίζει το κείμενο του υδατογραφήματος. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktexttext
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PageWatermarkTextText](pagewatermarktexttext/)(string) | Δημιουργεί μια νέα παρουσία. |
