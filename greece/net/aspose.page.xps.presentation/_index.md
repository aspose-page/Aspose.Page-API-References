...
| Τάξη | Περιγραφή |
| --- | --- |
| [WdpNet20NotSupportedException](./wdpnet20notsupportedexception/) | Η εξαίρεση που δημιουργείται κάθε φορά που ένα έγγραφο XPS που περιέχει εικόνες WDP μετατρέπεται στην έκδοση βιβλιοθήκης για .NET 2.0. |
