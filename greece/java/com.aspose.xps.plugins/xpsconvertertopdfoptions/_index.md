...
description: "Αντιπροσωπεύει τις επιλογές του μετατροπέα XPS σε PDF για το plugin."
type: docs
weight: 13
url: /el/java/com.aspose.xps.plugins/xpsconvertertopdfoptions/
---
**Inheritance:**
...
Αντιπροσωπεύει τις επιλογές του μετατροπέα XPS σε PDF για το plugin [XpsConverter](../../com.aspose.xps.plugins/xpsconverter).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [XpsConverterToPdfOptions()](#XpsConverterToPdfOptions--) | Αρχικοποιεί μια νέα παρουσία του αντικειμένου [XpsConverterToPdfOptions](../../com.aspose.xps.plugins/xpsconvertertopdfoptions). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία του αντικειμένου [XpsConverterToPdfOptions](../../com.aspose.xps.plugins/xpsconvertertopdfoptions).
