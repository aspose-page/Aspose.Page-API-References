...
description: "Επιλογές φόρτωσης εγγράφου PS."
type: docs
weight: 18
url: /el/java/com.aspose.eps/psloadoptions/
---
**Inheritance:**
...
Επιλογές φόρτωσης εγγράφου PS.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PsLoadOptions()](#PsLoadOptions--) | Δημιουργεί νέα παρουσία των επιλογών. |
## Μέθοδοι
