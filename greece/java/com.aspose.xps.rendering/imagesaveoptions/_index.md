...
description: "Βασική κλάση για επιλογές αποθήκευσης XPS-as-image."
type: docs
weight: 11
url: /el/java/com.aspose.xps.rendering/imagesaveoptions/
---
**Inheritance:**
...
| --- | --- |
| [ImageSaveOptions()](#ImageSaveOptions--) | Δημιουργεί νέο αντικείμενο επιλογών |
## Μέθοδοι
...
Δημιουργεί νέο αντικείμενο επιλογών
