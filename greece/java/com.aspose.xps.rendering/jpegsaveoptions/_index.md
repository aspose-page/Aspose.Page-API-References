...
description: "Κλάση για επιλογές αποθήκευσης XPS-as-JPEG."
type: docs
weight: 12
url: /el/java/com.aspose.xps.rendering/jpegsaveoptions/
---
**Inheritance:**
...
Κλάση για επιλογές αποθήκευσης XPS-as-JPEG.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JpegSaveOptions()](#JpegSaveOptions--) | Δημιουργεί νέα παρουσία των επιλογών. |
## Μέθοδοι
