...
description: "Κλάση για επιλογές αποθήκευσης XPS-as-PNG."
type: docs
weight: 15
url: /el/java/com.aspose.xps.rendering/pngsaveoptions/
---
**Inheritance:**
...
Κλάση για επιλογές αποθήκευσης XPS-as-PNG.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PngSaveOptions()](#PngSaveOptions--) | Δημιουργεί νέα παρουσία των επιλογών. |
## Μέθοδοι
