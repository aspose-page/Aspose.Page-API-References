...
description: "Κλάση για επιλογές αποθήκευσης XPS-as-BMP."
type: docs
weight: 10
url: /el/java/com.aspose.xps.rendering/bmpsaveoptions/
---
**Inheritance:**
...
Κλάση για επιλογές αποθήκευσης XPS-as-BMP.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [BmpSaveOptions()](#BmpSaveOptions--) | Δημιουργεί νέα παρουσία των επιλογών. |
## Μέθοδοι
