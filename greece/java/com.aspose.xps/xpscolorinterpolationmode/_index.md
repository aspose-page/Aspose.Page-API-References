...
description: "Έγκυρες τιμές της ιδιότητας ColorInterpolationMode των gradient brushes."
type: docs
weight: 56
url: /el/java/com.aspose.xps/xpscolorinterpolationmode/
---
**Inheritance:**
...
Έγκυρες τιμές της ιδιότητας ColorInterpolationMode των πινέλων διαβάθμισης.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [SRgbLinearInterpolation](#SRgbLinearInterpolation) | Λειτουργία SRgbLinearInterpolation. |
| [ScRgbLinearInterpolation](#ScRgbLinearInterpolation) | Λειτουργία ScRgbLinearInterpolation. |
## Μέθοδοι
...
Λειτουργία SRgbLinearInterpolation.
...
Λειτουργία ScRgbLinearInterpolation.
