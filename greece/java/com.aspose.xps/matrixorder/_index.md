...
description: "Απαρίθμηση που ορίζει τη σειρά των λειτουργιών του πίνακα."
type: docs
weight: 10
url: /el/java/com.aspose.xps/xpsmatrix.matrixorder/
---
**Inheritance:**
...
Απαρίθμηση που ορίζει τη σειρά των λειτουργιών του πίνακα.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Append](#Append) | Σειρά προσθήκης. |
| [Prepend](#Prepend) | Σειρά προεγγραφής. |
## Μέθοδοι
