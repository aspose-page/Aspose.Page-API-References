...
description: "Περιλαμβάνει χαρακτηριστικά των στοιχείων περιεχομένου XPS Canvas Path και Glyphs."
type: docs
weight: 18
url: /el/java/com.aspose.xps/xpscontentelement/
---
**Inheritance:**
...
Ενσωματώνει χαρακτηριστικά των στοιχείων περιεχομένου XPS: Canvas, Path και Glyphs.
## Μέθοδοι
