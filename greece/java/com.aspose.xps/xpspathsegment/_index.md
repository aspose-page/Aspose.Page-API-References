...
description: "Κλάση που ενσωματώνει τις κοινές δυνατότητες όλων των στοιχείων τμημάτων διαδρομής."
type: docs
weight: 44
url: /el/java/com.aspose.xps/xpspathsegment/
---
**Inheritance:**
...
Κλάση που ενσωματώνει τις κοινές δυνατότητες όλων των στοιχείων τμημάτων διαδρομής.
## Μέθοδοι
