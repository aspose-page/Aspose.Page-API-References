...
description: "Κλάση που ενσωματώνει χαρακτηριστικά του στοιχείου ιδιότητας ImageBrush."
type: docs
weight: 33
url: /el/java/com.aspose.xps/xpsimagebrush/
---
**Inheritance:**
...
Κλάση που ενσωματώνει τις δυνατότητες του στοιχείου ιδιότητας ImageBrush. Αυτό το στοιχείο χρησιμοποιείται για τη γέμιση μιας περιοχής με εικόνα.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [deepClone()](#deepClone--) | Δημιουργεί κλώνα αυτού του πινέλου εικόνας. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getImage()](#getImage--) | Επιστρέφει τον πόρο εικόνας που χρησιμοποιείται για το πινέλο. |
| [getImageSource()](#getImageSource--) | Επιστρέφει το URI ενός πόρου εικόνας. |
...
Δημιουργεί κλώνα αυτού του πινέλου εικόνας.
...
Επιστρέφει τον πόρο εικόνας που χρησιμοποιείται για το πινέλο.
...
Επιστρέφει το URI ενός πόρου εικόνας.

**Returns:**
java.lang.String - Το URI ενός πόρου εικόνας.
