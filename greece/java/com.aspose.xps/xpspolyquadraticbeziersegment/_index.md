...
description: "Κλάση που ενσωματώνει τις δυνατότητες του στοιχείου PolyQuadraticBezierSegment."
type: docs
weight: 47
url: /el/java/com.aspose.xps/xpspolyquadraticbeziersegment/
---
**Inheritance:**
...
Κλάση που ενσωματώνει χαρακτηριστικά του στοιχείου PolyQuadraticBezierSegment. Αυτό το στοιχείο περιγράφει ένα σύνολο τετραγωνικών καμπυλών B?zier από το προηγούμενο σημείο στο σχήμα διαδρομής μέσω ενός συνόλου κορυφών, χρησιμοποιώντας καθορισμένα σημεία ελέγχου.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [deepClone()](#deepClone--) | Δημιουργεί κλώνα αυτού του συνόλου τετραγωνικών καμπυλών B?zier. |
...
Δημιουργεί κλώνα αυτού του συνόλου τετραγωνικών καμπυλών B?zier.
