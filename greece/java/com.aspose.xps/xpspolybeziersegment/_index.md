...
description: "Κλάση που ενσωματώνει τις δυνατότητες του στοιχείου PolyBezierSegment."
type: docs
weight: 45
url: /el/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
Κλάση που ενσωματώνει τις δυνατότητες του στοιχείου PolyBezierSegment. Αυτό το στοιχείο περιγράφει ένα σύνολο κυβικών καμπυλών B?bezier.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [deepClone()](#deepClone--) | Κλωνοποιεί αυτό το σύνολο κυβικών καμπυλών B?bezier. |
...
Κλωνοποιεί αυτό το σύνολο κυβικών καμπυλών B?bezier.
