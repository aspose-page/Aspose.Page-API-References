...
description: "Έγκυρες τιμές της ιδιότητας SweepDirection των στοιχείων ArcSegment."
type: docs
weight: 65
url: /el/java/com.aspose.xps/xpssweepdirection/
---
**Inheritance:**
...
Έγκυρες τιμές της ιδιότητας SweepDirection του στοιχείου ArcSegment.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Clockwise](#Clockwise) | Κατεύθυνση δεξιόστροφα. |
| [Counterclockwise](#Counterclockwise) | Κατεύθυνση αριστερόστροφα. |
## Μέθοδοι
