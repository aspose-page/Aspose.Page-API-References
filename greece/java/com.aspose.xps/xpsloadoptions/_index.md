...
description: "Επιλογές φόρτωσης εγγράφου XPS."
type: docs
weight: 35
url: /el/java/com.aspose.xps/xpsloadoptions/
---
**Inheritance:**
...
Επιλογές φόρτωσης εγγράφου XPS.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [XpsLoadOptions()](#XpsLoadOptions--) | Δημιουργεί νέα παρουσία των επιλογών. |
## Μέθοδοι
