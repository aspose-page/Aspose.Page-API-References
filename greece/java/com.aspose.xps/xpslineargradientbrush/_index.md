...
description: "Κλάση που ενσωματώνει χαρακτηριστικά του στοιχείου ιδιότητας LinearGradientBrush."
type: docs
weight: 34
url: /el/java/com.aspose.xps/xpslineargradientbrush/
---
**Inheritance:**
...
Κλάση που ενσωματώνει χαρακτηριστικά του στοιχείου ιδιότητας LinearGradientBrush. Αυτό το στοιχείο χρησιμοποιείται για τον καθορισμό ενός γραμμικού διαβαθμιστικού πινέλου κατά μήκος ενός διανύσματος.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [deepClone()](#deepClone--) | Δημιουργεί κλώνα αυτού του γραμμικού διαβαθμιστικού πινέλου. |
...
| [getEndPoint()](#getEndPoint--) | Επιστρέφει το τελικό σημείο του γραμμικού διαβαθμισμού. |
...
| [getStartPoint()](#getStartPoint--) | Επιστρέφει το αρχικό σημείο του γραμμικού διαβαθμισμού. |
...
| [setEndPoint(Point2D value)](#setEndPoint-java.awt.geom.Point2D-) | Επιστρέφει/ορίζει το τελικό σημείο του γραμμικού διαβαθμισμού. |
...
| [setStartPoint(Point2D value)](#setStartPoint-java.awt.geom.Point2D-) | Ορίζει το αρχικό σημείο του γραμμικού διαβαθμισμού. |
...
Δημιουργεί κλώνα αυτού του γραμμικού διαβαθμιστικού πινέλου.
...
Επιστρέφει το τελικό σημείο του γραμμικού διαβαθμισμού.

**Returns:**
java.awt.geom.Point2D - Το τελικό σημείο του γραμμικού διαβαθμισμού.
...
Επιστρέφει το αρχικό σημείο του γραμμικού διαβαθμισμού.

**Returns:**
java.awt.geom.Point2D - Το αρχικό σημείο του γραμμικού διαβαθμισμού.
...
Επιστρέφει/ορίζει το τελικό σημείο του γραμμικού διαβαθμισμού.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | java.awt.geom.Point2D | Το τελικό σημείο της γραμμικής διαβάθμισης. |
...
Ορίζει το αρχικό σημείο του γραμμικού διαβαθμισμού.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | java.awt.geom.Point2D | Το αρχικό σημείο της γραμμικής διαβάθμισης. |
