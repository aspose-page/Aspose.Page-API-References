...
description: "Έγκυρες τιμές για στυλ γραμματοσειράς."
type: docs
weight: 60
url: /el/java/com.aspose.xps/xpsfontstyle/
---
**Inheritance:**
...
Έγκυρες τιμές για στυλ γραμματοσειράς.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Bold](#Bold) | Έντονο κείμενο. |
| [BoldItalic](#BoldItalic) | Έντονο πλάγιο κείμενο. |
| [Italic](#Italic) | Πλάγιο κείμενο. |
| [Regular](#Regular) | Κανονικό κείμενο. |
## Μέθοδοι
