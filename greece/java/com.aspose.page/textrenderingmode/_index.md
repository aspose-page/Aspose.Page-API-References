...
description: "Αυτή η απαρίθμηση περιέχει τις πιθανές τιμές για τη λειτουργία απόδοσης κειμένου."
type: docs
weight: 24
url: /el/java/com.aspose.page/textrenderingmode/
---
**Inheritance:**
...
Αυτή η απαρίθμηση περιέχει τις πιθανές τιμές για τη λειτουργία απόδοσης κειμένου.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Fill](#Fill) | Γέμισε ένα text. |
| [FillAndStroke](#FillAndStroke) | Γέμισε και σχεδίασε ένα text. |
| [No](#No) | Ούτε γέμισε ούτε σχεδίασε ένα text. |
| [Stroke](#Stroke) | Σχεδίασε ένα text. |
## Μέθοδοι
...
Ούτε γέμισε ούτε σχεδίασε ένα text.
