...
description: "Ορίζει σταθερές για την τιμή της ιδιότητας PrePunched με βαθμολογία."
type: docs
weight: 15
url: /el/java/com.aspose.xps.metadata/pagemediatype.prepunched/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή ιδιότητας  PrePunched  με βαθμολογία.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [None](#None) | Τιμή None. |
| [PrePunchedValue](#PrePunchedValue) | Τιμή PrePunched. |
## Μέθοδοι
