...
description: "Περιγράφει τις φυσικές διαστάσεις των μέσων που χρησιμοποιούνται για την έξοδο."
type: docs
weight: 102
url: /el/java/com.aspose.xps.metadata/pagemediasize/
---
**Inheritance:**
...
Περιγράφει τις διαστάσεις του φυσικού μέσου που χρησιμοποιείται για την έξοδο. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasize
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageMediaSize(PageMediaSize.IPageMediaSizeItem[] options)](#PageMediaSize-com.aspose.xps.metadata.PageMediaSize.IPageMediaSizeItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [IPageMediaSizeItem\[\]](../../com.aspose.xps.metadata/ipagemediasizeitem) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
