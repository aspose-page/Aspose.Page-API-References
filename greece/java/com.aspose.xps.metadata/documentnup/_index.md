...
description: "Περιγράφει την έξοδο και τη μορφή πολλαπλών λογικών σελίδων σε ένα μόνο φυσικό φύλλο."
type: docs
weight: 28
url: /el/java/com.aspose.xps.metadata/documentnup/
---
**Inheritance:**
...
Περιγράφει την έξοδο και τη μορφή πολλαπλών λογικών σελίδων σε ένα μόνο φυσικό φύλλο. Κάθε έγγραφο συντίθεται ξεχωριστά.  DocumentNUp  και  JobNUpAllDocumentsContiguously  είναι αμοιβαία αποκλειστικά. Η ευθύνη του οδηγού είναι να καθορίσει τη διαχείριση περιορισμών μεταξύ αυτών των λέξεων-κλειδιά. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentnup
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentNUp(NUp.INUpItem[] items)](#DocumentNUp-com.aspose.xps.metadata.NUp.INUpItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
τιμή ιδιότητας με βαθμολογία. Το υποστηριζόμενο σύνολο μπορεί να είναι οποιοδήποτε σύνολο ακεραίων π.χ. \{1,2,4,6,8,9,16\}. |
