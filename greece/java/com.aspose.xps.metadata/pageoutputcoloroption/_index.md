...
description: "Περιγράφει τις επιλογές χαρακτηριστικού PageOutputColor."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/pageoutputcolor.pageoutputcoloroption/
---
**Inheritance:**
...
| --- | --- |
| [PageOutputColorOption(String optionName, PageOutputColor.IPageOutputColorOptionItem[] items)](#PageOutputColorOption-java.lang.String-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorOptionItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [Color(int deviceBitsPerPixel, int driverBitsPerPixel)](#Color-int-int-) | Καθορίζει ότι η έξοδος πρέπει να είναι έγχρωμη. |
| [Grayscale(int deviceBitsPerPixel, int driverBitsPerPixel)](#Grayscale-int-int-) | Καθορίζει ότι η έξοδος πρέπει να είναι σε αποχρώσεις του γκρι. |
| [Monochrome(int deviceBitsPerPixel, int driverBitsPerPixel)](#Monochrome-int-int-) | Καθορίζει ότι η έξοδος πρέπει να είναι μονόχρωμη (Μαύρο). |
...
| [add(PageOutputColor.IPageOutputColorOptionItem[] items)](#add-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorOptionItem...-) | Προσθέτει έναν πίνακα των  IPageOutputColorOptionItem  παραδειγμάτων στην επιλογή. |
...
| items | [IPageOutputColorOptionItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloroptionitem) | Ένας αυθαίρετος πίνακας των  IPageOutputColorOptionItem  παραδειγμάτων. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| deviceBitsPerPixel | int | Μια  DeviceBitsPerPixel  τιμή ιδιότητας βαθμολογημένη που υποδεικνύει τον αριθμό των bit ανά pixel των χρωματικών δεδομένων που υποστηρίζονται από τον εκτυπωτή. |
| driverBitsPerPixel | int | Μια  DriverBitsPerPixel  τιμή ιδιότητας βαθμολογημένη που υποδεικνύει τον αριθμό των bit ανά pixel που πρέπει να χρησιμοποιεί ο βασικός οδηγός για το buffer απόδοσης bitmap του. |
