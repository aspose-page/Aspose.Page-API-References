...
description: "Περιγράφει την έξοδο πολλαπλών λογικών σελίδων σε ένα μόνο φυσικό φύλλο."
type: docs
weight: 58
url: /el/java/com.aspose.xps.metadata/jobnupalldocumentscontiguously/
---
**Inheritance:**
...
Περιγράφει την έξοδο πολλαπλών λογικών σελίδων σε ένα μόνο φυσικό φύλλο. Όλα τα έγγραφα στη δουλειά συντίθενται μαζί συνεχόμενα.  JobNUpAllDocumentsContiguously  και  DocumentNUp  είναι αμοιβαία αποκλειστικά. Εξαρτάται από τον οδηγό να καθορίσει τον χειρισμό περιορισμών μεταξύ αυτών των λέξεων-κλειδιών. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobNUpAllDocumentsContiguously(NUp.INUpItem[] items)](#JobNUpAllDocumentsContiguously-com.aspose.xps.metadata.NUp.INUpItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| [addPagesPerSheetOption(int value)](#addPagesPerSheetOption-int-) | Προσθέτει μια επιλογή με μια τιμή ιδιότητας  PagesPerSheet . |
...
| --- | --- | --- |
| items | [INUpItem\[\]](../../com.aspose.xps.metadata/inupitem) | Ένας πίνακας στοιχείων συγκεκριμένων για το χαρακτηριστικό. |
...
Προσθέτει μια επιλογή με μια τιμή ιδιότητας  PagesPerSheet . Καθορίζει τον αριθμό λογικών σελίδων ανά φυσικό φύλλο.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Μια τιμή ιδιότητας  PagesPerSheet . Το υποστηριζόμενο σύνολο μπορεί να είναι οποιοδήποτε σύνολο ακεραίων, π.χ. \{1,2,4,6,8,9,16\}. |
