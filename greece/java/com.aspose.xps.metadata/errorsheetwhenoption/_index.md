...
description: "Περιγράφει τις επιλογές της δυνατότητας ErrorSheetWhen."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές λειτουργίας ErrorSheetWhen.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Always](#Always) | Καθορίζει ότι θα εκτυπώνεται ένα φύλλο σφάλματος για κάθε εργασία. |
| [OnError](#OnError) | Καθορίζει ότι θα εκτυπώνεται ένα φύλλο σφάλματος μόνο σε περίπτωση σφάλματος. |
## Μέθοδοι
...
Καθορίζει ότι θα εκτυπώνεται ένα φύλλο σφάλματος για κάθε εργασία.
...
Καθορίζει ότι θα εκτυπώνεται ένα φύλλο σφάλματος μόνο σε περίπτωση σφάλματος.
