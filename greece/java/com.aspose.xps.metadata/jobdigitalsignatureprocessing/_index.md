...
description: "Περιγράφει τη διαμόρφωση της επεξεργασίας ψηφιακής υπογραφής για ολόκληρη την εργασία."
type: docs
weight: 51
url: /el/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing/
---
**Inheritance:**
...
Περιγράφει τη ρύθμιση της επεξεργασίας ψηφιακής υπογραφής για ολόκληρη την εργασία. Εφαρμόζεται μόνο σε περιεχόμενο που περιέχει ψηφιακές υπογραφές. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobDigitalSignatureProcessing(JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption[] options)](#JobDigitalSignatureProcessing-com.aspose.xps.metadata.JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [JobDigitalSignatureProcessingOption\[\]](../../com.aspose.xps.metadata/jobdigitalsignatureprocessingoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
