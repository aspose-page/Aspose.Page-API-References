...
description: "Περιγράφει το χρωματικό χώρο που πρέπει να χρησιμοποιηθεί για λειτουργίες ανάμειξης."
type: docs
weight: 86
url: /el/java/com.aspose.xps.metadata/pageblendcolorspace/
---
**Inheritance:**
...
Περιγράφει το χρωματικό χώρο που πρέπει να χρησιμοποιηθεί για λειτουργίες ανάμειξης. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspace
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageBlendColorSpace(PageBlendColorSpace.PageBlendColorSpaceOption[] options)](#PageBlendColorSpace-com.aspose.xps.metadata.PageBlendColorSpace.PageBlendColorSpaceOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageBlendColorSpaceOption\[\]](../../com.aspose.xps.metadata/pageblendcolorspaceoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
