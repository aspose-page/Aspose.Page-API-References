...
description: "Περιγράφει τα χαρακτηριστικά ταξινόμησης της εξόδου."
type: docs
weight: 17
url: /el/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Περιγράφει τα χαρακτηριστικά ταξινόμησης της εξόδου. Όλες οι σελίδες σε κάθε μεμονωμένο έγγραφο ταξινομούνται. DocumentCollate και JobCollateAlldocuments είναι αμοιβαία αποκλειστικά. Η συμπεριφορά και η υλοποίηση του εάν και τα δύο ή μόνο ένα από αυτές τις λέξεις-κλειδιά υλοποιείται αφήνεται στον οδηγό. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
