...
description: "Ορίζει τις πιθανές τιμές της ιδιότητας DuplexMode της DuplexOptions."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/duplex.duplexmode/
---
**Inheritance:**
...
Ορίζει τις πιθανές τιμές της ιδιότητας DuplexMode της DuplexOption.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Automatic](#Automatic) | Αυτόματη τιμή. |
| [Manual](#Manual) | Χειροκίνητη τιμή. |
## Μέθοδοι
