...
description: "Ορίστε σταθερές για την τιμή ιδιότητας MediaCapacity που καθορίζουν εάν το κάδο είναι ποιοτικά υψηλής χωρητικότητας."
type: docs
weight: 15
url: /el/java/com.aspose.xps.metadata/inputbin.mediacapacity/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή της ιδιότητας MediaCapacity που καθορίζουν εάν ο κάδος είναι υψηλής χωρητικότητας (ποιοτική).
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [High](#High) | Υψηλή τιμή. |
| [Standard](#Standard) | Τυπική τιμή. |
## Μέθοδοι
