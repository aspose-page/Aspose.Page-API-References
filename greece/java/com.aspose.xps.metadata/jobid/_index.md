...
description: "Καθορίζει ένα μοναδικό αναγνωριστικό για την εργασία."
type: docs
weight: 56
url: /el/java/com.aspose.xps.metadata/jobid/
---
**Inheritance:**
...
Καθορίζει ένα μοναδικό αναγνωριστικό για τη δουλειά. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobid
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobID(String jobID)](#JobID-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| jobID | java.lang.String | Το αναγνωριστικό της εργασίας. |
