...
description: "Περιγράφει τη λειτουργία εσωτερικής στρωματοποίησης."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/pagewatermark.layering/
---
**Inheritance:**
...
Περιγράφει τη λειτουργία εσωτερικής  Layering  . Ορίζει τη συμπεριφορά στρωματοποίησης του υδατογραφήματος.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Layering(PageWatermark.LayeringOption[] options)](#Layering-com.aspose.xps.metadata.PageWatermark.LayeringOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [LayeringOption\[\]](../../com.aspose.xps.metadata/layeringoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
