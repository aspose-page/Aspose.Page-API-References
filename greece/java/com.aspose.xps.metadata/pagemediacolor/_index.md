...
description: "Περιγράφει τις επιλογές χρώματος μέσου και τα χαρακτηριστικά κάθε επιλογής."
type: docs
weight: 101
url: /el/java/com.aspose.xps.metadata/pagemediacolor/
---
**Inheritance:**
...
Περιγράφει τις επιλογές χρώματος μέσου και τα χαρακτηριστικά κάθε επιλογής. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageMediaColor(PageMediaColor.PageMediaColorOption[] options)](#PageMediaColor-com.aspose.xps.metadata.PageMediaColor.PageMediaColorOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageMediaColorOption\[\]](../../com.aspose.xps.metadata/pagemediacoloroption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
