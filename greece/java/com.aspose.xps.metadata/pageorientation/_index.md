...
description: "Περιγράφει τον προσανατολισμό του φύλλου φυσικού μέσου."
type: docs
weight: 113
url: /el/java/com.aspose.xps.metadata/pageorientation/
---
**Inheritance:**
...
Περιγράφει τον προσανατολισμό του φυσικού φύλλου μέσου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageOrientation(PageOrientation.PageOrientationOption[] options)](#PageOrientation-com.aspose.xps.metadata.PageOrientation.PageOrientationOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageOrientationOption\[\]](../../com.aspose.xps.metadata/pageorientationoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
