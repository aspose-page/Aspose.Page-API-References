...
description: "Ορίζει τα χαρακτηριστικά του προφίλ χρώματος πηγής."
type: docs
weight: 127
url: /el/java/com.aspose.xps.metadata/pagesourcecolorprofile/
---
**Inheritance:**
...
Ορίζει τα χαρακτηριστικά του πηγαίου χρωματικού προφίλ. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagesourcecolorprofile
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageSourceColorProfile(PageSourceColorProfile.PageSourceColorProfileOption[] options)](#PageSourceColorProfile-com.aspose.xps.metadata.PageSourceColorProfile.PageSourceColorProfileOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageSourceColorProfileOption\[\]](../../com.aspose.xps.metadata/pagesourcecolorprofileoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
