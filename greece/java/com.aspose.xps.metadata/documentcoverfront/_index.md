...
description: "Περιγράφει το φύλλο κάλυψης στην αρχή (μπροστά)."
type: docs
weight: 21
url: /el/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
Περιγράφει το εξώφυλλο μπροστά (αρχικό). Κάθε έγγραφο θα έχει ξεχωριστό φύλλο. Το εξώφυλλο πρέπει να εκτυπώνεται στο  PageMediaSize  και  PageMediaType  που χρησιμοποιούνται για την πρώτη σελίδα του εγγράφου. Το εξώφυλλο πρέπει να ενσωματώνεται στις επιλογές επεξεργασίας (όπως  DocumentDuplex ,  DocumentNUp ) όπως υποδεικνύεται από την καθορισμένη Option. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
