...
description: "Περιγράφει τις επιλογές χαρακτηριστικού PageDeviceFontSubstitution."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές χαρακτηριστικού PageDeviceFontSubstitution.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Off](#Off) | Η αντικατάσταση γραμματοσειράς της συσκευής σελίδας είναι απενεργοποιημένη. |
| [On](#On) | Η αντικατάσταση γραμματοσειράς της συσκευής σελίδας είναι ενεργοποιημένη. |
## Μέθοδοι
...
Η αντικατάσταση γραμματοσειράς της συσκευής σελίδας είναι απενεργοποιημένη.
...
Η αντικατάσταση γραμματοσειράς της συσκευής σελίδας είναι ενεργοποιημένη.
