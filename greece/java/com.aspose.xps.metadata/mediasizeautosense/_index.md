...
description: "Ορίζει σταθερές για την τιμή της ιδιότητας MediaSizeAutoSense."
type: docs
weight: 18
url: /el/java/com.aspose.xps.metadata/inputbin.mediasizeautosense/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή της ιδιότητας MediaSizeAutoSense.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [None](#None) | Τιμή None. |
| [Supported](#Supported) | Υποστηριζόμενη τιμή. |
## Μέθοδοι
