...
description: "Περιγράφει τα χαρακτηριστικά κλιμάκωσης της εξόδου."
type: docs
weight: 121
url: /el/java/com.aspose.xps.metadata/pagescaling/
---
**Inheritance:**
...
Περιγράφει τα χαρακτηριστικά κλιμάκωσης του εξόδου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescaling
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageScaling(PageScaling.IPageScalingItem[] items)](#PageScaling-com.aspose.xps.metadata.PageScaling.IPageScalingItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| items | [IPageScalingItem\[\]](../../com.aspose.xps.metadata/ipagescalingitem) | Ένας πίνακας στοιχείων συγκεκριμένων για το χαρακτηριστικό. |
