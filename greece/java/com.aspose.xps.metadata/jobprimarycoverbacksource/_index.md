...
description: "Καθορίζει την πηγή για ένα προσαρμοσμένο κύριο φύλλο οπισθόφυλλου για τη δουλειά."
type: docs
weight: 67
url: /el/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Καθορίζει την πηγή για ένα προσαρμοσμένο κύριο φύλλο πίσω εξώφυλλου για την εργασία. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
