...
description: "Περιγράφει τις επιλογές χαρακτηριστικού PageDestinationColorProfile."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές χαρακτηριστικού PageDestinationColorProfile.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Application](#Application) | Η εφαρμογή καθορίζει το προφίλ προορισμού που θα χρησιμοποιηθεί. |
| [DriverConfiguration](#DriverConfiguration) | Προφίλ προορισμού που χρησιμοποιείται για τη διαχείριση χρώματος. |
## Μέθοδοι
...
Η εφαρμογή καθορίζει το προφίλ προορισμού που θα χρησιμοποιηθεί.
...
Προφίλ προορισμού που χρησιμοποιείται για τη διαχείριση χρώματος.
