...
description: "Περιγράφει τη ρύθμιση αρνητικού της εξόδου."
type: docs
weight: 112
url: /el/java/com.aspose.xps.metadata/pagenegativeimage/
---
**Inheritance:**
...
Περιγράφει τη ρύθμιση αρνητικού του αποτελέσματος. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageNegativeImage(PageNegativeImage.PageNegativeImageOption[] options)](#PageNegativeImage-com.aspose.xps.metadata.PageNegativeImage.PageNegativeImageOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageNegativeImageOption\[\]](../../com.aspose.xps.metadata/pagenegativeimageoption) | Ένας πίνακας ή επιλογή χαρακτηριστικού. |
