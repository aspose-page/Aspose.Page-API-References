...
description: "Καθορίζει την πηγή για ένα προσαρμοσμένο κύριο φύλλο εξώφυλλου για τη δουλειά."
type: docs
weight: 69
url: /el/java/com.aspose.xps.metadata/jobprimarycoverfrontsource/
---
**Inheritance:**
...
Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο εξώφυλλου μπροστά για τη δουλειά. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobPrimaryCoverFrontSource(String value)](#JobPrimaryCoverFrontSource-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
