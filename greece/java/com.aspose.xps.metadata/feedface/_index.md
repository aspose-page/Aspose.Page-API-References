...
description: "Ορίζει σταθερές για την τιμή της ιδιότητας FeedFace."
type: docs
weight: 12
url: /el/java/com.aspose.xps.metadata/inputbin.feedface/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή της ιδιότητας FeedFace.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [FaceDown](#FaceDown) | Τιμή FaceDown. |
| [FaceUp](#FaceUp) | Τιμή FaceUp. |
## Μέθοδοι
