...
type: docs
weight: 71
url: /el/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Περιγράφει τη μέθοδο κοπής για ρολό χαρτιού. Ο ρολός πρέπει να κοπεί στο τέλος της εργασίας. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
