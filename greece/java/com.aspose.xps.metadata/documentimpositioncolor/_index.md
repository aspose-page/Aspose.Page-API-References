...
description: "Το περιεχόμενο της εφαρμογής που επισημαίνεται με το καθορισμένο ονομαστικό χρώμα ΠΡΕΠΕΙ να εμφανίζεται σε όλες τις χρωματικές διαχωριστικές ενότητες."
type: docs
weight: 26
url: /el/java/com.aspose.xps.metadata/documentimpositioncolor/
---
**Inheritance:**
...
Το περιεχόμενο της εφαρμογής που επισημαίνεται με το καθορισμένο ονομαστικό χρώμα ΠΡΕΠΕΙ να εμφανίζεται σε όλες τις χρωματικές διαχωριστικές ενότητες. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentimpositioncolor
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentImpositionColor(String value)](#DocumentImpositionColor-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
