...
description: "Περιγράφει τη χρήση φύλλου διαχωριστή για ένα έγγραφο."
type: docs
weight: 34
url: /el/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Περιγράφει τη χρήση του φύλλου διαχωριστή για ένα έγγραφο. Τα φύλλα διαχωριστή πρέπει να εμφανίζονται στην έξοδο όπως υποδεικνύεται από την Επιλογή που καθορίζεται παρακάτω. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
