...
type: docs
weight: 116
url: /el/java/com.aspose.xps.metadata/pageoutputquality/
---
**Inheritance:**
...
Περιγράφει τη αρνητική ρύθμιση της εξόδου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputquality
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageOutputQuality(PageOutputQuality.PageOutputQualityOption[] options)](#PageOutputQuality-com.aspose.xps.metadata.PageOutputQuality.PageOutputQualityOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageOutputQualityOption\[\]](../../com.aspose.xps.metadata/pageoutputqualityoption) | Ένας πίνακας ή επιλογή χαρακτηριστικού. |
