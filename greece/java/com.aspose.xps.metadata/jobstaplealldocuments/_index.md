...
description: "Περιγράφει τα χαρακτηριστικά δέσμευσης του εξόδου."
type: docs
weight: 72
url: /el/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Περιγράφει τα χαρακτηριστικά δέσμευσης της εξόδου. Όλα τα έγγραφα στην εργασία συνδέονται μαζί. Οι λέξεις-κλειδιά  JobStapleAllDocuments  και  DocumentStaple  είναι αμοιβαία αποκλειστικές. Εξαρτάται από τον οδηγό να καθορίσει τη διαχείριση περιορισμών μεταξύ αυτών των λέξεων-κλειδιών. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
