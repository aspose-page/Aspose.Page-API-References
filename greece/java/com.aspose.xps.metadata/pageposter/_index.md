...
description: "Περιγράφει την έξοδο μιας μόνο σελίδας σε πολλαπλά φυσικά φύλλα μέσου."
type: docs
weight: 118
url: /el/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Περιγράφει την έξοδο μιας μόνο σελίδας σε πολλαπλά φυσικά φύλλα μέσου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Κατασκευαστές
...
Προσθέτει μια επιλογή με μια τιμή ιδιότητας  PagesPerSheet  με σκορ. Καθορίζει τον αριθμό των φυσικών φύλλων ανά λογική σελίδα.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Μια τιμή ιδιότητας  PagesPerSheet  με σκορ. |
