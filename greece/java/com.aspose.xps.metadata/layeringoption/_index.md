...
description: "Περιγράφει τις επιλογές της λειτουργίας Στοίβαξης."
type: docs
weight: 11
url: /el/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές χαρακτηριστικού Layering.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Overlay](#Overlay) | Το υδατογράφημα εμφανίζεται πάνω από το περιεχόμενο της σελίδας. |
| [Underlay](#Underlay) | Το υδατογράφημα εμφανίζεται κάτω από το περιεχόμενο της σελίδας. |
## Μέθοδοι
...
Το υδατογράφημα εμφανίζεται πάνω από το περιεχόμενο της σελίδας.
...
Το υδατογράφημα εμφανίζεται κάτω από το περιεχόμενο της σελίδας.
