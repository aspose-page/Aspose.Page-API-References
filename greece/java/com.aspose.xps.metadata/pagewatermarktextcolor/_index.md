...
description: "Ορίζει το χρώμα sRGB για το κείμενο του υδατογραφήματος."
type: docs
weight: 135
url: /el/java/com.aspose.xps.metadata/pagewatermarktextcolor/
---
**Inheritance:**
...
Ορίζει το χρώμα sRGB για το κείμενο υδατογραφήματος. Η μορφή είναι ARGB: \#AARRGGBB. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextcolor
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageWatermarkTextColor(String value)](#PageWatermarkTextColor-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
