...
description: "Ορίζει σταθερές για την τιμή της ιδιότητας FeedDirection."
type: docs
weight: 11
url: /el/java/com.aspose.xps.metadata/inputbin.feeddirection/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή της ιδιότητας FeedDirection.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [LongEdgeFirst](#LongEdgeFirst) | Τιμή LongEdgeFirst. |
| [ShortEdgeFirst](#ShortEdgeFirst) | Τιμή LongEdgeFirst. |
## Μέθοδοι
