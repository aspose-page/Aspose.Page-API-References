...
type: docs
weight: 73
url: /el/java/com.aspose.xps.metadata/joburi/
---
**Inheritance:**
...
Καθορίζει έναν ενιαίο εντοπιστή πόρων (URI) για το έγγραφο. https://docs.microsoft.com/en-us/windows/win32/printdocs/joburi
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobURI(String jobURI)](#JobURI-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| jobURI | java.lang.String | Το URI εργασίας. |
