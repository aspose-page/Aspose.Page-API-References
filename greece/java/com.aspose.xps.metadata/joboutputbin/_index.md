...
description: "Περιγράφει το εγκατεστημένο κουτί εξόδου σε μια συσκευή ή τη πλήρη λίστα των υποστηριζόμενων κουτιών για μια συσκευή."
type: docs
weight: 61
url: /el/java/com.aspose.xps.metadata/joboutputbin/
---
**Inheritance:**
...
Περιγράφει το εγκατεστημένο εξαγωγικό κουτί σε μια συσκευή ή τη πλήρη λίστα των υποστηριζόμενων κουτιών για μια συσκευή. Οι λέξεις-κλειδιά  JobOutputBin ,  DocumentOutputBin  και  PageOutputBin  είναι αμοιβαία αποκλειστικές· μόνο μία πρέπει να καθορίζεται σε ένα έγγραφο PrintTicket ή Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputbin
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobOutputBin(OutputBin.IOutputBinItem[] items)](#JobOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
