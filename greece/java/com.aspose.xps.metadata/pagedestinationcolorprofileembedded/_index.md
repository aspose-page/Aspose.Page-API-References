...
description: "Καθορίζει το ενσωματωμένο προφίλ χρώματος προορισμού."
type: docs
weight: 92
url: /el/java/com.aspose.xps.metadata/pagedestinationcolorprofileembedded/
---
**Inheritance:**
...
Καθορίζει το ενσωματωμένο προφίλ χρώματος προορισμού. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageDestinationColorProfileEmbedded(String value)](#PageDestinationColorProfileEmbedded-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
