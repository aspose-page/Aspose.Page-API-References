...
description: "Περιγράφει τις επιλογές χαρακτηριστικού JobDigitalSignatureProcessing."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές λειτουργίας JobDigitalSignatureProcessing.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [PrintInvalidSignatures](#PrintInvalidSignatures) | Εκτυπώστε την εργασία ανεξάρτητα από την εγκυρότητα των ψηφιακών υπογραφών. |
| [PrintInvalidSignaturesWithErrorReport](#PrintInvalidSignaturesWithErrorReport) | Εκτυπώστε την εργασία ανεξάρτητα από την εγκυρότητα των ψηφιακών υπογραφών. |
| [PrintOnlyValidSignatures](#PrintOnlyValidSignatures) | Εκτυπώστε την εργασία μόνο εάν όλες οι ψηφιακές υπογραφές είναι έγκυρες. |
## Μέθοδοι
...
Εκτυπώστε την εργασία ανεξάρτητα από την εγκυρότητα των ψηφιακών υπογραφών. Οι ψηφιακές υπογραφές ΜΠΟΡΟΥΝ να αγνοηθούν.
...
Εκτυπώστε την εργασία ανεξάρτητα από την εγκυρότητα των ψηφιακών υπογραφών. Σε περίπτωση που εντοπιστεί μη έγκυρη υπογραφή, μια σελίδα σφάλματος πρέπει να εκτυπωθεί στο τέλος της εργασίας. Οι ψηφιακές υπογραφές ΠΡΕΠΕΙ να μην αγνοηθούν.
...
Εκτυπώστε την εργασία μόνο εάν όλες οι ψηφιακές υπογραφές είναι έγκυρες. Οι ψηφιακές υπογραφές ΠΡΕΠΕΙ να μην αγνοηθούν.
