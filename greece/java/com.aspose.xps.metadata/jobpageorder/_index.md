...
description: "Ορίζει τη σειρά των φυσικών σελίδων για την έξοδο."
type: docs
weight: 63
url: /el/java/com.aspose.xps.metadata/jobpageorder/
---
**Inheritance:**
...
Ορίζει τη σειρά των φυσικών σελίδων για την έξοδο. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobpageorder
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobPageOrder(JobPageOrder.JobPageOrderOption[] options)](#JobPageOrder-com.aspose.xps.metadata.JobPageOrder.JobPageOrderOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [JobPageOrderOption\[\]](../../com.aspose.xps.metadata/jobpageorderoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
