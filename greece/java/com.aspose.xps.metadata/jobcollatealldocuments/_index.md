...
type: docs
weight: 47
url: /el/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Περιγράφει τα χαρακτηριστικά ταξινόμησης της εξόδου. Όλα τα έγγραφα σε κάθε μεμονωμένη εργασία ταξινομούνται.  DocumentCollate  και  JobCollateAllDocuments  είναι αμοιβαία αποκλειστικά. Η συμπεριφορά και η υλοποίηση του αν θα εφαρμοστούν και οι δύο ή μόνο μία από αυτές τις λέξεις-κλειδιά αφήνεται στον οδηγό. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
