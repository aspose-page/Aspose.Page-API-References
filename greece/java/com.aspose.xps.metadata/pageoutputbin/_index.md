...
type: docs
weight: 114
url: /el/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Περιγράφει την πλήρη λίστα των υποστηριζόμενων θήσεων για τη συσκευή. Επιτρέπει τον καθορισμό της θήσης εξόδου ανά σελίδα. Οι λέξεις-κλειδιά JobOutputBin, DocumentOutputBin και PageOutputBin είναι αμοιβαία αποκλειστικές· πρέπει να καθορίζεται μόνο μία σε ένα έγγραφο PrintTicket ή Print Capabilities document. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
