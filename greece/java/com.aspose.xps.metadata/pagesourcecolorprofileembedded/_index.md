...
description: "Καθορίζει το ενσωματωμένο προφίλ χρώματος πηγής."
type: docs
weight: 128
url: /el/java/com.aspose.xps.metadata/pagesourcecolorprofileembedded/
---
**Inheritance:**
...
Καθορίζει το ενσωματωμένο προφίλ χρώματος πηγής.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageSourceColorProfileEmbedded(String value)](#PageSourceColorProfileEmbedded-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
