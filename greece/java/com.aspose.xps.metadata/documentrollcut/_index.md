...
description: "Περιγράφει τη μέθοδο κοπής για το ρολό χαρτιού."
type: docs
weight: 33
url: /el/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Περιγράφει τη μέθοδο κοπής για ρολό χαρτιού. Κάθε έγγραφο επεξεργάζεται ξεχωριστά. Οι καθορισμένες επιλογές περιγράφουν τις διαφορετικές μεθόδους για κοπή ρολού. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
