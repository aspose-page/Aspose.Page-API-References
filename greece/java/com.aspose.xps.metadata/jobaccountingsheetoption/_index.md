...
description: "Περιγράφει τις επιλογές χαρακτηριστικού JobAccountingSheet."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές λειτουργίας JobAccountingSheet.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [None](#None) | Καθορίζει ότι δεν θα παραχθεί φύλλο λογιστικής. |
| [Standard](#Standard) | Καθορίζει ότι πρέπει να παραχθεί το τυπικό (ορισμένο από τη συσκευή) φύλλο λογιστικής. |
## Μέθοδοι
...
Καθορίζει ότι δεν θα παραχθεί φύλλο λογιστικής.
...
Καθορίζει ότι πρέπει να παραχθεί το τυπικό (ορισμένο από τη συσκευή) φύλλο λογιστικής.
