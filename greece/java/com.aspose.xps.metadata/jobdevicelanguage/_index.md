...
description: "Περιγράφει τις γλώσσες συσκευής που υποστηρίζονται για αποστολή δεδομένων από τον οδηγό στη φυσική συσκευή."
type: docs
weight: 50
url: /el/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
