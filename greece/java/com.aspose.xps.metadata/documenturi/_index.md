...
description: "Καθορίζει έναν ενιαίο εντοπιστή πόρων (URI) για το έγγραφο."
type: docs
weight: 36
url: /el/java/com.aspose.xps.metadata/documenturi/
---
**Inheritance:**
...
Καθορίζει έναν ενιαίο αναγνωριστικό πόρου (URI) για το έγγραφο. https://docs.microsoft.com/en-us/windows/win32/printdocs/documenturi
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentURI(String documentURI)](#DocumentURI-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| documentURI | java.lang.String | Το URI του εγγράφου. |
