...
description: "Καθορίζει την πηγή για προσαρμοσμένο φύλλο σφάλματος."
type: docs
weight: 54
url: /el/java/com.aspose.xps.metadata/joberrorsheetsource/
---
**Inheritance:**
...
Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο σφάλματος. https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheetsource
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobErrorSheetSource(String value)](#JobErrorSheetSource-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
