...
description: "Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο banner."
type: docs
weight: 14
url: /el/java/com.aspose.xps.metadata/documentbannersheetsource/
---
**Inheritance:**
...
| --- | --- |
| [DocumentBannerSheetSource(String value)](#DocumentBannerSheetSource-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
