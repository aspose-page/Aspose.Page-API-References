...
description: "Περιγράφει τη μέθοδο διαχείρισης γραμματοσειρών TrueType που θα χρησιμοποιηθεί."
type: docs
weight: 130
url: /el/java/com.aspose.xps.metadata/pagetruetypefontmode/
---
**Inheritance:**
...
Περιγράφει τη μέθοδο διαχείρισης γραμματοσειρών TrueType που θα χρησιμοποιηθεί. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagetruetypefontmode
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageTrueTypeFontMode(PageTrueTypeFontMode.PageTrueTypeFontModeOption[] options)](#PageTrueTypeFontMode-com.aspose.xps.metadata.PageTrueTypeFontMode.PageTrueTypeFontModeOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageTrueTypeFontModeOption\[\]](../../com.aspose.xps.metadata/pagetruetypefontmodeoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
