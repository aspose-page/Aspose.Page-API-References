...
description: "Ορίζει σταθερές για την τιμή της ιδιότητας PrePrinted."
type: docs
weight: 14
url: /el/java/com.aspose.xps.metadata/pagemediatype.preprinted/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή ιδιότητας  PrePrinted  με βαθμολογία.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Letterhead](#Letterhead) | Τιμή Letterhead. |
| [None](#None) | Τιμή None. |
| [PrePrintedValue](#PrePrintedValue) | Τιμή PrePrinted. |
## Μέθοδοι
