...
description: "Ορίζει σταθερές για τη βαθμολογημένη τιμή ιδιότητας MediaPath."
type: docs
weight: 16
url: /el/java/com.aspose.xps.metadata/inputbin.mediapath/
---
**Inheritance:**
...
Ορίζει σταθερές για την τιμή της ιδιότητας MediaPath.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Serpentine](#Serpentine) | Τιμή serpentine. |
| [Straight](#Straight) | Απλή τιμή. |
## Μέθοδοι
