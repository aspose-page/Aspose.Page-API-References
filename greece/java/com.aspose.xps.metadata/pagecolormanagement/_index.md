...
description: "Διαμορφώνει τη διαχείριση χρώματος για την τρέχουσα σελίδα."
type: docs
weight: 89
url: /el/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
Διαμορφώνει τη διαχείριση χρώματος για την τρέχουσα σελίδα. Αυτό θεωρείται αυτόματο στο SHIM - DM\_ICMMethod Add System. Περιγράφει ποιο στοιχείο πρέπει να εκτελεί τη διαχείριση χρώματος (π.χ. Driver). https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
