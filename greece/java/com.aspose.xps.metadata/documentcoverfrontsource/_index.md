...
description: "Καθορίζει την πηγή για ένα προσαρμοσμένο μπροστινό εξώφυλλο."
type: docs
weight: 22
url: /el/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
Καθορίζει την πηγή για ένα προσαρμοσμένο φύλλο εξώφυλλου. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
