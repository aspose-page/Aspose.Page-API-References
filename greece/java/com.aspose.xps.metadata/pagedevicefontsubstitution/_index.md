...
description: "Περιγράφει την κατάσταση ενεργοποιημένου/απενεργοποιημένου αντικατάστασης γραμματοσειράς συσκευής."
type: docs
weight: 96
url: /el/java/com.aspose.xps.metadata/pagedevicefontsubstitution/
---
**Inheritance:**
...
Περιγράφει την κατάσταση ενεργοποιημένου/απενεργοποιημένου της αντικατάστασης γραμματοσειράς συσκευής. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicefontsubstitution
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageDeviceFontSubstitution(PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption[] options)](#PageDeviceFontSubstitution-com.aspose.xps.metadata.PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageDeviceFontSubstitutionOption\[\]](../../com.aspose.xps.metadata/pagedevicefontsubstitutionoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
