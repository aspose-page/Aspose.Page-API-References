...
type: docs
weight: 45
url: /el/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Περιγράφει τη μέθοδο δέσμευσης. Όλα τα έγγραφα στην εργασία δεσμεύονται μαζί.  JobBindAllDocuments  και  DocumentBinding  είναι αμοιβαία αποκλειστικά. Εξαρτάται από τον οδηγό να καθορίσει τη διαχείριση περιορισμών μεταξύ αυτών των λέξεων-κλειδιών. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
