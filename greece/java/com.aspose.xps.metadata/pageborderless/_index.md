...
description: "Περιγράφει πότε το περιεχόμενο εικόνας πρέπει να εκτυπωθεί στα φυσικά άκρα του μέσου."
type: docs
weight: 88
url: /el/java/com.aspose.xps.metadata/pageborderless/
---
**Inheritance:**
...
Περιγράφει πότε το περιεχόμενο της εικόνας πρέπει να εκτυπώνεται στα φυσικά άκρα του μέσου. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PageBorderless(PageBorderless.PageBorderlessOption[] options)](#PageBorderless-com.aspose.xps.metadata.PageBorderless.PageBorderlessOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PageBorderlessOption\[\]](../../com.aspose.xps.metadata/pageborderlessoption) | Ένας πίνακας επιλογών συγκεκριμένων για τη λειτουργία. |
