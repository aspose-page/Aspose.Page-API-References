...
description: "Η κλάση που ενσωματώνει μια κοινή λειτουργία Print Schema."
type: docs
weight: 38
url: /el/java/com.aspose.xps.metadata/feature/
---
**Inheritance:**
...
Η κλάση που ενσωματώνει ένα κοινό χαρακτηριστικό Print Schema. Η βασική κλάση για όλα τα χαρακτηριστικά που ορίζονται από το σχήμα. Ένα  Feature  στοιχείο περιέχει έναν πλήρη κατάλογο των στοιχείων  Option  και  Property  που περιγράφουν πλήρως μια ιδιότητα συσκευής, ρύθμιση μορφοποίησης εργασίας ή άλλο σχετικό χαρακτηριστικό. https://docs.microsoft.com/en-us/windows/win32/printdocs/feature
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Feature(String name, Option option, IFeatureItem[] items)](#Feature-java.lang.String-com.aspose.xps.metadata.Option-com.aspose.xps.metadata.IFeatureItem...-) | Δημιουργεί ένα νέο αντικείμενο χαρακτηριστικού PrintTicket. |
| [Feature(String name, Feature feature, IFeatureItem[] items)](#Feature-java.lang.String-com.aspose.xps.metadata.Feature-com.aspose.xps.metadata.IFeatureItem...-) | Δημιουργεί ένα νέο αντικείμενο χαρακτηριστικού PrintTicket. |
## Μέθοδοι
...
Δημιουργεί ένα νέο αντικείμενο χαρακτηριστικού PrintTicket.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| όνομα | java.lang.String | Ένα όνομα χαρακτηριστικού. |
| option | [Option](../../com.aspose.xps.metadata/option) | Απαιτούμενη  Option  παρουσία. |
| items | [IFeatureItem\[\]](../../com.aspose.xps.metadata/ifeatureitem) | Ένας αυθαίρετος πίνακας από  IFeatureItem  αντικείμενα. Κάθε ένα πρέπει να είναι ένα  Feature , ένα  Option , ή ένα  Property  αντικείμενο. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| όνομα | java.lang.String | Όνομα χαρακτηριστικού. |
| feature | [Feature](../../com.aspose.xps.metadata/feature) | Απαιτούμενο  Feature  αντικείμενο. |
| items | [IFeatureItem\[\]](../../com.aspose.xps.metadata/ifeatureitem) | Ένας αυθαίρετος πίνακας από  Property  αντικείμενα. Κάθε ένα πρέπει να είναι ένα  Feature , ένα  Option , ή ένα  Property  αντικείμενο. |
