...
description: "Περιγράφει τις επιλογές λειτουργίας του PageForceFrontSide."
type: docs
weight: 10
url: /el/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Περιγράφει τις επιλογές χαρακτηριστικού PageForceFrontSide.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Καθορίζει ότι η έξοδος περιορίζεται στην μπροστινή πλευρά του φύλλου. |
| [None](#None) | Καθορίζει ότι δεν υπάρχουν περιορισμοί εξόδου. |
## Μέθοδοι
...
Καθορίζει ότι η έξοδος περιορίζεται στην μπροστινή πλευρά του φύλλου.
...
Καθορίζει ότι δεν υπάρχουν περιορισμοί εξόδου.
