...
description: "Δείχνει μια υψηλού επιπέδου πρόθεση προς τον οδηγό για τη συμπλήρωση των ρυθμίσεων εκτύπωσης φωτογραφιών."
type: docs
weight: 117
url: /el/java/com.aspose.xps.metadata/pagephotoprintingintent/
---
**Inheritance:**
...
Υποδεικνύει μια υψηλού επιπέδου πρόθεση προς τον οδηγό για τη ρύθμιση των ρυθμίσεων εκτύπωσης φωτογραφιών. Αυτές οι ρυθμίσεις αφορούν την αναμενόμενη ποιότητα εξόδου που μπορεί να καθορίσει ο χρήστης κατά την εκτύπωση φωτογραφιών. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagephotoprintingintent
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PagePhotoPrintingIntent(PagePhotoPrintingIntent.PagePhotoPrintingIntentOption[] options)](#PagePhotoPrintingIntent-com.aspose.xps.metadata.PagePhotoPrintingIntent.PagePhotoPrintingIntentOption...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| options | [PagePhotoPrintingIntentOption\[\]](../../com.aspose.xps.metadata/pagephotoprintingintentoption) | Ένας πίνακας ή επιλογή χαρακτηριστικού. |
