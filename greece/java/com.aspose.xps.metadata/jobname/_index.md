...
description: "Καθορίζει ένα περιγραφικό όνομα για την εργασία."
type: docs
weight: 59
url: /el/java/com.aspose.xps.metadata/jobname/
---
**Inheritance:**
...
Καθορίζει ένα περιγραφικό όνομα για τη δουλειά. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobname
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [JobName(String jobName)](#JobName-java.lang.String-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| jobName | java.lang.String | Το όνομα της εργασίας. |
