...
description: "Περιγράφει τα χαρακτηριστικά των ρυθμίσεων χρώματος για την έξοδο."
type: docs
weight: 115
url: /el/java/com.aspose.xps.metadata/pageoutputcolor/
---
**Inheritance:**
...
| --- | --- |
| [PageOutputColor(PageOutputColor.IPageOutputColorItem[] items)](#PageOutputColor-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorItem...-) | Δημιουργεί μια νέα παρουσία. |
## Μέθοδοι
...
| --- | --- | --- |
| items | [IPageOutputColorItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloritem) | Ένας πίνακας στοιχείων συγκεκριμένων για το χαρακτηριστικό. |
