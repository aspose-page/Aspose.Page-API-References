...
description: "Αντιπροσωπεύει το αποτέλεσμα της λειτουργίας με τη μορφή πίνακα bytes."
type: docs
weight: 11
url: /el/java/com.aspose.page.plugins/bytearrayresult/
---
**Inheritance:**
java.lang.Object
...
Αντιπροσωπεύει το αποτέλεσμα της λειτουργίας με τη μορφή πίνακα bytes.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ByteArrayResult(byte[][] data)](#ByteArrayResult-byte-----) | Αρχικοποιεί μια νέα παρουσία με τον πίνακα των bytes. |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία με τον πίνακα των bytes.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| δεδομένα | byte[][] | Πίνακας πινάκων bytes. Χρησιμοποιείται για τη μετατροπή εγγράφου σε εικόνα. Ένας πίνακας bytes περιέχει τα bytes μιας εικόνας σελίδας. |
