...
description: "Γενική διεπαφή δοχείου δεδομένων που ορίζει κοινές μεθόδους που πρέπει να υλοποιήσουν οι συγκεκριμένες επιλογές plugin δοχείου δεδομένων."
type: docs
weight: 20
url: /el/java/com.aspose.page.plugins/idatacontainer/
---```
