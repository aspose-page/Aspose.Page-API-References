...
description: "Αντιπροσωπεύει το αποτέλεσμα της λειτουργίας με τη μορφή string."
type: docs
weight: 19
url: /el/java/com.aspose.page.plugins/stringresult/
---
**Inheritance:**
java.lang.Object
...
Αντιπροσωπεύει το αποτέλεσμα της λειτουργίας με τη μορφή string.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [StringResult(String result)](#StringResult-java.lang.String-) | Αρχικοποιεί νέα παρουσία StringResult με μια συμβολοσειρά. |
## Μέθοδοι
...
| [getText()](#getText--) | Επιστρέφει την αναπαράσταση σε συμβολοσειρά του αποτελέσματος. |
| [hashCode()](#hashCode--) |  |
...
| [toString()](#toString--) | Προσπαθεί να μετατρέψει το αποτέλεσμα σε συμβολοσειρά. |
| [wait()](#wait--) |  |
...
Αρχικοποιεί νέα παρουσία StringResult με μια συμβολοσειρά.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| result | java.lang.String | Συμβολοσειρά που αντιπροσωπεύει το αποτέλεσμα |
...
Επιστρέφει την αναπαράσταση σε συμβολοσειρά του αποτελέσματος.
...
**Returns:**
java.lang.String - Μια συμβολοσειρά που αντιπροσωπεύει το κείμενο εάν το αποτέλεσμα είναι συμβολοσειρά· διαφορετικά επιστρέφει το base.ToString().
### wait() {#wait--}
```
