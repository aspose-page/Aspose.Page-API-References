...
type: docs
weight: 11
url: /el/java/com.aspose.eps.device/pdfsaveoptions/
---
**Inheritance:**
...
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με προεπιλεγμένες τιμές για τις σημαίες  suppressErrors  (true) και  debug  (false). |
| [PdfSaveOptions(boolean supressErrors)](#PdfSaveOptions-boolean-) | Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με προεπιλεγμένη τιμή για τη σημαία  debug  (false). |
| [PdfSaveOptions(Dimension size)](#PdfSaveOptions-java.awt.Dimension-) | Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με το μέγεθος της σελίδας. |
| [PdfSaveOptions(boolean supressErrors, Dimension size)](#PdfSaveOptions-boolean-java.awt.Dimension-) | Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με προεπιλεγμένες τιμές για τη σημαία  debug  (false) και το μέγεθος της σελίδας. |
## Μέθοδοι
...
Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με το μέγεθος της σελίδας.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| μέγεθος | java.awt.Dimension | Το μέγεθος της σελίδας. |
...
Αρχικοποιήστε νέα παρουσία της κλάσης  PdfSaveOptions  με προεπιλεγμένες τιμές για τη σημαία  debug  (false) και το μέγεθος της σελίδας.
