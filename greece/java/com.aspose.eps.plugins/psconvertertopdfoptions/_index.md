...
description: "Αναπαριστά τις επιλογές του μετατροπέα PS/EPS σε PDF για το plugin."
type: docs
weight: 13
url: /el/java/com.aspose.eps.plugins/psconvertertopdfoptions/
---
**Inheritance:**
...
Αναπαριστά τις επιλογές του μετατροπέα PS/EPS σε PDF για το πρόσθετο [PsConverter](../../com.aspose.eps.plugins/psconverter) plugin.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PsConverterToPdfOptions()](#PsConverterToPdfOptions--) | Αρχικοποιεί νέα παρουσία του αντικειμένου [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions). |
## Μέθοδοι
...
Αρχικοποιεί νέα παρουσία του αντικειμένου [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions).
