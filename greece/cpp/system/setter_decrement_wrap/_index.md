---
title: "System::setter_decrement_wrap μέθοδος"
linktitle: "setter_decrement_wrap"
second_title: "Aspose.Page για C++"
description: "System::setter_decrement_wrap μέθοδος. Ο μεταφραστής μεταφράζει τις προ-αφαιρετικές εκφράσεις της C#''s που στοχεύουν στην ιδιότητα ενός στιγμιότυπου που έχει ορισμένα setter και getter, σε κλήση αυτής της συνάρτησης (υπερφόρτωση για const getter) σε C++."
type: docs
weight: 37100
url: /el/cpp/system/setter_decrement_wrap/
---
## System::setter_decrement_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Ο μεταφραστής μεταφράζει τις προ-αφαιρετικές εκφράσεις της C#'s που στοχεύουν στην ιδιότητα ενός στιγμιότυπου που έχει ορισμένα setter και getter, σε κλήση αυτής της συνάρτησης (υπερφόρτωση για const getter).
...
Ο μεταφραστής μεταφράζει τις προ-αφαιρετικές εκφράσεις της C#'s που στοχεύουν στην ιδιότητα ενός στιγμιότυπου που έχει ορισμένα setter και getter, σε κλήση αυτής της συνάρτησης (υπερφόρτωση για non-const getter).
...
Ο μεταφραστής μεταφράζει τις προ-αφαιρετικές εκφράσεις της C#'s που στοχεύουν στην ιδιότητα μιας κλάσης που έχει ορισμένα setter και getter, σε κλήση αυτής της συνάρτησης.
