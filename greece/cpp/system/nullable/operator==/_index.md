...
description: "System::Nullable::operator== μέθοδος. Καθορίζει εάν η τιμή που αντιπροσωπεύεται από το τρέχον αντικείμενο είναι ίση με την τιμή που αντιπροσωπεύεται από το καθορισμένο αντικείμενο Nullable σε C++."
type: docs
weight: 1900
...
Αληθές εάν η τιμή που αντιπροσωπεύεται από το τρέχον αντικείμενο είναι ίση με την καθορισμένη τιμή, διαφορετικά - ψευδές
...
Αληθές εάν η τιμή που αντιπροσωπεύεται από το τρέχον αντικείμενο είναι null, διαφορετικά - ψευδές
