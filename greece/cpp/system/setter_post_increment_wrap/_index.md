---
title: "System::setter_post_increment_wrap μέθοδος"
linktitle: "setter_post_increment_wrap"
second_title: "Aspose.Page για C++"
description: "System::setter_post_increment_wrap μέθοδος. Ο μεταφραστής μεταφράζει τις εκφράσεις μετα-αύξησης της C#''s που στοχεύουν στην ιδιότητα του instance''s, η οποία έχει ορισμένο setter και getter, σε κλήση αυτής της συνάρτησης (υπερφόρτωση για const getter) σε C++."
type: docs
weight: 37900
url: /el/cpp/system/setter_post_increment_wrap/
---
