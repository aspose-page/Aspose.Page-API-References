---
title: "System::Text::UTF7Encoding::GetCharCount μέθοδος"
linktitle: "GetCharCount"
second_title: "Aspose.Page για C++"
description: "System::Text::UTF7Encoding::GetCharCount μέθοδος. Λάβετε τον αριθμό των χαρακτήρων που απαιτούνται για την αποκωδικοποίηση ενός buffer byte σε C++."
type: docs
weight: 600
url: /el/cpp/system.text/utf7encoding/getcharcount/
---
## UTF7Encoding::GetCharCount(ArrayPtr\<uint8_t\>) method


Λάβετε τον αριθμό των χαρακτήρων που απαιτούνται για την αποκωδικοποίηση ενός buffer byte.
