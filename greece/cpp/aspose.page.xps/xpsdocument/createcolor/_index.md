...
description: "Aspose::Page::XPS::XpsDocument::CreateColor method. Δημιουργεί ένα νέο χρώμα στο χρωματικό χώρο scRGB σε C++."
type: docs
weight: 1200
url: /el/cpp/aspose.page.xps/xpsdocument/createcolor/
---
...
| --- | --- | --- |
| ένα | float | Το συστατικό αλφα χρώματος. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| ένα | int32_t | Το συστατικό αλφα χρώματος. |
| r | int32_t | Το κόκκινο συστατικό χρώματος. |
| g | int32_t | Το πράσινο συστατικό χρώματος. |
| b | int32_t | Το μπλε συστατικό χρώματος. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| color | System::Drawing::Color | Μία εγγενής παρουσία χρώματος για χρώμα RGB. |
...
Δημιουργεί ένα νέο χρώμα σε χρωματικό χώρο βασισμένο σε ICC.
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| iccProfile | System::SharedPtr\<XpsModel::XpsIccProfile\> | Ο πόρος του προφίλ ICC. |
| συστατικά | const System::ArrayPtr\<float\>\& | Συστατικά χρώματος. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| path | System::String | Η διαδρομή προς το προφίλ ICC. |
| συστατικά | const System::ArrayPtr\<float\>\& | Συστατικά χρώματος. |
