---
title: "System::Globalization::ThaiBuddhistCalendar::ToDateTime method"
linktitle: "ToDateTime"
second_title: "Aspose.Page για C++"
description: "System::Globalization::ThaiBuddhistCalendar::ToDateTime method. Δημιουργεί αντικείμενο DateTime από τα συστατικά σε C++."
type: docs
weight: 2000
url: /el/cpp/system.globalization/thaibuddhistcalendar/todatetime/
---
## ThaiBuddhistCalendar::ToDateTime(int, int, int, int, int, int, int) const method


Δημιουργεί αντικείμενο [DateTime](../../../system/datetime/) από τα συστατικά.
...
| ώρα | int | Ώρα. |
| λεπτό | int | Λεπτό. |
| δευτερόλεπτο | int | Δευτερόλεπτο. |
| χιλιοστό του δευτερολέπτου | int | Χιλιοστό του δευτερολέπτου. |
