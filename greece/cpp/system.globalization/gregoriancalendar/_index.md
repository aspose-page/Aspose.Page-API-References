...
| virtual [get_CalendarType](./get_calendartype/)() const | Λαμβάνει τον τύπο του Γρηγοριανού ημερολογίου. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | Λαμβάνει το προεπιλεγμένο στιγμιότυπο του Γρηγοριανού ημερολογίου. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | Δημιουργεί συγκεκριμένο Γρηγοριανό ημερολόγιο. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | Ορίζει τον τύπο του Γρηγοριανού ημερολογίου. |
