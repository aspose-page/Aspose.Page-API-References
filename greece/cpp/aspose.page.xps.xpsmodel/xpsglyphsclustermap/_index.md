---
title: "Aspose::Page::XPS::XpsModel::XpsGlyphsClusterMap κλάση"
linktitle: "XpsGlyphsClusterMap"
second_title: "Aspose.Page για C++"
description: "Πώς να χρησιμοποιήσετε την κλάση Aspose::Page::XPS::XpsModel::XpsGlyphsClusterMap σε C++."
type: docs
weight: 1600
url: /el/cpp/aspose.page.xps.xpsmodel/xpsglyphsclustermap/
---
...
| [ToString](./tostring/)() const override | Αναλογικό της μεθόδου C# Object.ToString(). Επιτρέπει τη μετατροπή προσαρμοσμένων αντικειμένων σε συμβολοσειρά. |
