---
title: "System::IO::BasicSTDOStreamWrapper::Write μέθοδος"
linktitle: "Write"
second_title: "Aspose.Page για C++"
description: "System::IO::BasicSTDOStreamWrapper::Write μέθοδος. Εάν η λειτουργία περιτύλιξης είναι δυαδική, γράφει στη ροή το καθορισμένο υποσύνολο των bytes από τον καθορισμένο πίνακα bytes, διαφορετικά μετατρέπει το καθορισμένο υποσύνολο των bytes από τον καθορισμένο πίνακα bytes σε τύπο char_type και στη συνέχεια γράφει το αποτέλεσμα στη ροή σε C++."
type: docs
weight: 700
url: /el/cpp/system.io/basicstdostreamwrapper/write/
---
