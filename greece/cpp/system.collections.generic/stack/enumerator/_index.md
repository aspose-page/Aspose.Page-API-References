...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Δημιουργεί απαριθμητή που επαναλαμβάνει τη δοσμένη στοίβα. |
## Δείτε επίσης
