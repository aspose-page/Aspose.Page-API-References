...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Δημιουργεί enumerator που διασχίζει το αντικείμενο **set**. |
## Δείτε επίσης
