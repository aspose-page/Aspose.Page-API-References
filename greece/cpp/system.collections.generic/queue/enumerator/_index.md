...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Δημιουργεί ενδείκτη που δείχνει σε συγκεκριμένη ουρά. |
## Δείτε επίσης
