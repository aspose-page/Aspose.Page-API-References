---
title: "System::Xml::XmlTextReader::ReadContentAsBase64 μέθοδος"
linktitle: "ReadContentAsBase64"
second_title: "Aspose.Page για C++"
description: "System::Xml::XmlTextReader::ReadContentAsBase64 method. Διαβάζει το περιεχόμενο και επιστρέφει τα δυαδικά bytes αποκωδικοποιημένα σε Base64 σε C++."
type: docs
weight: 4700
url: /el/cpp/system.xml/xmltextreader/readcontentasbase64/
---
## XmlTextReader::ReadContentAsBase64 method


Διαβάζει το περιεχόμενο και επιστρέφει τα **Base64** αποκωδικοποιημένα δυαδικά bytes.
