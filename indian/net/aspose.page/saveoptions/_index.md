...
description: Aspose.Page.SaveOptions कक्ष. इस वर्ग में रूपंतरण प्रक्रय के प्रबंधन के लए आवश्यक वकल्प हैं
type: docs
weight: 300
url: /hi/net/aspose.page/saveoptions/
---
## SaveOptions class
...
| नाम | विवरण |
| --- | --- |
| [SaveOptions](saveoptions/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`SaveOptions` ध्वज के लिए डिफ़ॉल्ट मान वाला वर्ग!:SuppressErrors (सत्य) और[`Debug`](./debug/) (झूठा). |
| [SaveOptions](saveoptions/#constructor_1)(bool) | का एक नया उदाहरण प्रारंभ करता है`SaveOptions` वर्ग ध्वज के लिए डिफ़ॉल्ट मान के साथ[`Debug`](./debug/) (झूठा). |
...
| virtual [SupressErrors](../../aspose.page/saveoptions/supresserrors/) { get; set; } | निर्दिष्ट करता है कि त्रुटियों को दबाया जाना चाहिए या नहीं। यदि सही दबाई गई त्रुटियों को इसमें जोड़ा जाता है[`Exceptions`](./exceptions/) list. यदि गलत है तो पहली त्रुटि प्रोग्राम को समाप्त कर देगी। |
