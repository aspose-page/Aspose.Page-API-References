...
के संयोजन में[`PageDeviceColorSpaceProfileURI`](../pagedevicecolorspaceprofileuri/) पैरामीटर, यह पैरामीटर परिभाषित करता है डिवाइस रंग स्थान में प्रस्तुत तत्वों के लिए प्रतिपादन व्यवहार। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
...
| नाम | विवरण |
| --- | --- |
| [PageDeviceColorSpaceUsage](pagedevicecolorspaceusage/)(params PageDeviceColorSpaceUsageOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PageDeviceColorSpaceUsageOption](pagedevicecolorspaceusage.pagedevicecolorspaceusageoption/) | का वर्णन करता है`PageDeviceColorSpaceUsage` सुविधा विकल्प. |
