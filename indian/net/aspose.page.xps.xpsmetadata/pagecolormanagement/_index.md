...
वर्तमान पृष्ठ के लिए रंग प्रबंधन को कॉन्फ़िगर करता है। इसे SHIM - DM_ICMMedod Add System में स्वचालित माना जाता है। वर्णन करता है कि किस घटक को रंग प्रबंधन करना चाहिए (अर्थात ड्राइवर)। https://docs.microsoft.com/en-us/windows /win32/printdocs/pagecolormanagement
...
| नाम | विवरण |
| --- | --- |
| [PageColorManagement](pagecolormanagement/)(params PageColorManagementOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PageColorManagementOption](pagecolormanagement.pagecolormanagementoption/) | का वर्णन करता है`PageColorManagement` सुविधा विकल्प. |
