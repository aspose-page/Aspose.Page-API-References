...
डिवाइस फ़ॉन्ट प्रतिस्थापन की सक्षम/अक्षम स्थिति का वर्णन करता है।
...
| नाम | विवरण |
| --- | --- |
| [PageDeviceFontSubstitution](pagedevicefontsubstitution/)(params PageDeviceFontSubstitutionOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PageDeviceFontSubstitutionOption](pagedevicefontsubstitution.pagedevicefontsubstitutionoption/) | का वर्णन करता है`PageDeviceFontSubstitution` सुविधा विकल्प. |
