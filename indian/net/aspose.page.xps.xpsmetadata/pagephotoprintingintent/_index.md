...
फोटो प्रिंटिंग सेटिंग्स की आबादी के लिए ड्राइवर के लिए एक उच्च-स्तरीय इरादे का संकेत देता है। ये सेटिंग्स अपेक्षित आउटपुट गुणवत्ता से संबंधित होती हैं, जिसे उपयोगकर्ता फोटो प्रिंट करते समय निर्दिष्ट कर सकता है। https://docs.microsoft.com/en-us/windows /win32/printdocs/pagephotoprintingintent
...
| नाम | विवरण |
| --- | --- |
| [PagePhotoPrintingIntent](pagephotoprintingintent/)(params PagePhotoPrintingIntentOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PagePhotoPrintingIntentOption](pagephotoprintingintent.pagephotoprintingintentoption/) | परिभाषित करता है`PagePhotoPrintingIntent` सुविधा विकल्प. |
