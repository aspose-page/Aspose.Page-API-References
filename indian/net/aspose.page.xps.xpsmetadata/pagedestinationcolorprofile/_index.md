...
डेस्टिनेशन कलर प्रोफाइल की विशेषताओं को परिभाषित करता है। बताता है कि एप्लिकेशन या ड्राइवर उपयोग किए जाने वाले डेस्टिनेशन कलर प्रोफाइल का चयन करता है या नहीं। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofile
...
| नाम | विवरण |
| --- | --- |
| [PageDestinationColorProfile](pagedestinationcolorprofile/)(params PageDestinationColorProfileOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | का वर्णन करता है`PageDestinationColorProfile` सुविधा विकल्प. |
