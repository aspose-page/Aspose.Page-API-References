...
आउटपुट की स्टेपलिंग विशेषताओं का वर्णन करता है। जॉब के सभी दस्तावेज़ एक साथ स्टेपल किए गए हैं. द`JobStapleAllDocuments` और[`DocumentStaple`](../documentstaple/) कीवर्ड परस्पर अनन्य हैं। यह ड्राइवर पर निर्भर है कि वह इन कीवर्ड्स के बीच बाधा से निपटने का निर्धारण करे। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
...
| नाम | विवरण |
| --- | --- |
| [JobStapleAllDocuments](jobstaplealldocuments/)(params StapleOption[]) | एक नया उदाहरण बनाता है। |
