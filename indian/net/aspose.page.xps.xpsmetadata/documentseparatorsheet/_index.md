...
एक दस्तावेज़ के लिए विभाजक पत्रक उपयोग का वर्णन करता है। विभाजक पत्रक आउटपुट में दिखाई देने चाहिए जैसा कि नीचे निर्दिष्ट विकल्प द्वारा इंगित किया गया है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
...
| नाम | विवरण |
| --- | --- |
| [DocumentSeparatorSheet](documentseparatorsheet/)(params DocumentSeparatorSheetOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [DocumentSeparatorSheetOption](documentseparatorsheet.documentseparatorsheetoption/) | का वर्णन करता है`DocumentSeparatorSheet` सुविधा विकल्प. |
