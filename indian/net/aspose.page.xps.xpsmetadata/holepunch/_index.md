...
के लिए आधार वर्ग[`JobHolePunch`](../jobholepunch/) और[`DocumentHolePunch`](../documentholepunch/) सुविधाओं की कक्षाएं.
...
| नाम | विवरण |
| --- | --- |
| class [HolePunchOption](holepunch.holepunchoption/) | का वर्णन करता है`HolePunch` सुविधा विकल्प. |
