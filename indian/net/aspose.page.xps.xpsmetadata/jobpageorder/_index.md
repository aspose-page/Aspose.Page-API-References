...
आउटपुट के लिए भौतिक पृष्ठों के क्रम को परिभाषित करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobpageorder
...
| नाम | विवरण |
| --- | --- |
| [JobPageOrder](jobpageorder/)(params JobPageOrderOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [JobPageOrderOption](jobpageorder.jobpageorderoption/) | का वर्णन करता है`JobPageOrder` सुविधा विकल्प. |
