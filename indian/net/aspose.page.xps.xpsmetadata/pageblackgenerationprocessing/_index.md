...
सीएमवाईके अलगाव के लिए काली पीढ़ी के व्यवहार को निर्दिष्ट करता है।
...
| नाम | विवरण |
| --- | --- |
| [PageBlackGenerationProcessing](pageblackgenerationprocessing/)(params PageBlackGenerationProcessingOption[]) | एक नया उदाहरण बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| class [PageBlackGenerationProcessingOption](pageblackgenerationprocessing.pageblackgenerationprocessingoption/) | का वर्णन करता है`PageBlackGenerationProcessing` सुविधा विकल्प. |
