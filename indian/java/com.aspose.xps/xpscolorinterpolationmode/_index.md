...
description: "ग्रेडिएंट ब्रशेज़ के ColorInterpolationMode गुण के मान्य मान।"
type: docs
weight: 56
url: /hi/java/com.aspose.xps/xpscolorinterpolationmode/
---
**Inheritance:**
...
ग्रेडिएंट ब्रशेज़ की ColorInterpolationMode प्रॉपर्टी के वैध मान।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [SRgbLinearInterpolation](#SRgbLinearInterpolation) | SRgbLinearInterpolation मोड। |
| [ScRgbLinearInterpolation](#ScRgbLinearInterpolation) | ScRgbLinearInterpolation मोड। |
## मेथड्स
