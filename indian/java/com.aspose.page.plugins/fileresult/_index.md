...
description: "ऑपरेशन परिणाम को फ़ाइल के स्ट्रिंग पथ के रूप में दर्शाता है।"
type: docs
weight: 14
url: /hi/java/com.aspose.page.plugins/fileresult/
---
**Inheritance:**
java.lang.Object
...
ऑपरेशन परिणाम को फ़ाइल के स्ट्रिंग पथ के रूप में दर्शाता है।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [FileResult(String path)](#FileResult-java.lang.String-) | निर्दिष्ट आउटपुट फ़ाइल पथ के साथ एक नया इंस्टेंस प्रारंभ करता है। |
## मेथड्स
...
निर्दिष्ट आउटपुट फ़ाइल पथ के साथ एक नया इंस्टेंस प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| path | java.lang.String | फ़ाइल का पथ। |
