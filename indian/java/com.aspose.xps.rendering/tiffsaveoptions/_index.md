...
description: "XPS-को-TIFF के रूप में सहेजने के विकल्पों के लिए क्लास।"
type: docs
weight: 16
url: /hi/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
XPS-को-TIFF के रूप में सहेजने के विकल्पों के लिए क्लास।
## कंस्ट्रक्टर्स
...
| [multipage()](#multipage--) | एकल मल्टीपेज TIFF फ़ाइल में कई छवियों को सहेजने के लिए परिभाषित करने वाला फ़्लैग प्राप्त करता है। |
| [multipage(boolean value)](#multipage-boolean-) | एकल मल्टीपेज TIFF फ़ाइल में कई छवियों को सहेजने के लिए परिभाषित करने वाला फ़्लैग सेट करता है। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
एकल मल्टीपेज TIFF फ़ाइल में कई छवियों को सहेजने के लिए परिभाषित करने वाला फ़्लैग प्राप्त करता है।

**Returns:**
boolean - वह फ़्लैग जो निर्धारित करता है कि कई छवियों को एक ही मल्टीपेज TIFF फ़ाइल में सहेजा जाना चाहिए।
...
एकल मल्टीपेज TIFF फ़ाइल में कई छवियों को सहेजने के लिए परिभाषित करने वाला फ़्लैग सेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | boolean | वह फ़्लैग जो निर्धारित करता है कि कई छवियों को एक ही मल्टीपेज TIFF फ़ाइल में सहेजा जाना चाहिए। |
