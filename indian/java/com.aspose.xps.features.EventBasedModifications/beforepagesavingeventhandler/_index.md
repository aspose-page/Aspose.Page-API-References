...
description: "पेज-सहेजने से पहले इवेंट हैंडलर्स के लिए बेस क्लास।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.features.eventbasedmodifications/beforepagesavingeventhandler/
---
**Inheritance:**
java.lang.Object
...
पेज-सहेजने से पहले इवेंट हैंडलर्स के लिए बेस क्लास।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [BeforePageSavingEventHandler()](#BeforePageSavingEventHandler--) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| [getClass()](#getClass--) |  |
| [handle(EventBasedModifications.BeforeSavingEventArgs<EventBasedModifications.PageAPI> args)](#handle-com.aspose.xps.features.EventBasedModifications.BeforeSavingEventArgs-com.aspose.xps.features.EventBasedModifications.PageAPI--) | इवेंट को संभालता है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| args | com.aspose.xps.features.EventBasedModifications.BeforeSavingEventArgs<com.aspose.xps.features.EventBasedModifications.PageAPI> | इवेंट तर्क। |
