...
description: "PS/EPS को इमेज में बदलने वाले कनवर्टर विकल्पों का प्रतिनिधित्व करता है प्लगइन के लिए।"
type: docs
weight: 12
url: /hi/java/com.aspose.eps.plugins/psconvertertoimageoptions/
---
**Inheritance:**
...
PS/EPS को इमेज में बदलने वाले कनवर्टर विकल्पों का प्रतिनिधित्व करता है [PsConverter](../../com.aspose.eps.plugins/psconverter) प्लगइन के लिए।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PsConverterToImageOptions()](#PsConverterToImageOptions--) | नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है। |
| [PsConverterToImageOptions(ImageFormat imageFormat)](#PsConverterToImageOptions-com.aspose.page.ImageFormat-) | इमेज फ़ॉर्मेट के साथ नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है। |
| [PsConverterToImageOptions(Dimension size)](#PsConverterToImageOptions-java.awt.Dimension-) | परिणामी इमेज के आकार के साथ नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है। |
| [PsConverterToImageOptions(ImageFormat imageFormat, Dimension size)](#PsConverterToImageOptions-com.aspose.page.ImageFormat-java.awt.Dimension-) | इमेज फ़ॉर्मेट के साथ नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है। |
## मेथड्स
...
| [getImageFormat()](#getImageFormat--) | छवि प्रारूप प्राप्त करता है। |
...
| [getSize()](#getSize--) | परिणामी छवि का आकार प्राप्त करता है। |
| [getSmoothingMode()](#getSmoothingMode--) | छवि रेंडरिंग के लिए स्मूदिंग मोड प्राप्त करता है। |
| [hashCode()](#hashCode--) |  |
...
| [setImageFormat(ImageFormat imageFormat)](#setImageFormat-com.aspose.page.ImageFormat-) | छवि प्रारूप प्राप्त करता है। |
| [setJpegQualityLevel(int value)](#setJpegQualityLevel-int-) | छवि के लिए संपीड़न स्तर निर्दिष्ट करने वाला मान सेट करता है। |
| [setResolution(int resolution)](#setResolution-int-) | छवि का रिज़ॉल्यूशन सेट करता है। |
| [setSize(Dimension size)](#setSize-java.awt.Dimension-) | परिणामी छवि का आकार सेट करता है। |
| [setSmoothingMode(SmoothingMode smoothingMode)](#setSmoothingMode-com.aspose.eps.device.SmoothingMode-) | छवि रेंडरिंग के लिए स्मूदिंग मोड सेट करता है। |
...
नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है।
...
इमेज फ़ॉर्मेट के साथ नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| imageFormat | [ImageFormat](../../com.aspose.page/imageformat) | परिणामी छवि का प्रारूप। |
...
परिणामी इमेज के आकार के साथ नए [PsConverterToImageOptions](../../com.aspose.eps.plugins/psconvertertoimageoptions) ऑब्जेक्ट का नया उदाहरण प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| आकार | java.awt.Dimension | परिणामी छवि का आकार। |
...
परिणामी छवि का आकार प्राप्त करता है।

**Returns:**
java.awt.Dimension - एक छवि आकार।
...
छवि रेंडरिंग के लिए स्मूदिंग मोड प्राप्त करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| रिज़ॉल्यूशन | int | परिणामी छवि का रिज़ॉल्यूशन। |
...
परिणामी छवि का आकार सेट करता है।
...
छवि रेंडरिंग के लिए स्मूदिंग मोड सेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| smoothingMode | [SmoothingMode](../../com.aspose.eps.device/smoothingmode) | स्मूदिंग मोड। |
