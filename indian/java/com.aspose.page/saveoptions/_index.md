...
type: docs
weight: 16
url: /hi/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [SaveOptions()](#SaveOptions--) | डिफ़ॉल्ट मानों के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग suppressErrors (true) और debug (false) के लिए। |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | डिफ़ॉल्ट मान के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग debug (false) के लिए। |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | निर्दिष्ट आकार के साथ SaveOptions का नया इंस्टेंस प्रारंभ करता है। |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | डिफ़ॉल्ट मान के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग debug (false) और निर्दिष्ट आकार के साथ। |
## मेथड्स
...
डिफ़ॉल्ट मानों के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग suppressErrors (true) और debug (false) के लिए।
...
डिफ़ॉल्ट मान के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग debug (false) के लिए।
...
निर्दिष्ट आकार के साथ SaveOptions का नया इंस्टेंस प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| आकार | java.awt.Dimension | आकार। |
...
डिफ़ॉल्ट मान के साथ नया SaveOptions इंस्टेंस प्रारंभ करें, फ़्लैग debug (false) और निर्दिष्ट आकार के साथ।
