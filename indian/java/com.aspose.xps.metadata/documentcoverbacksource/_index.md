...
description: "कस्टम बैक-कवर शीट के स्रोत को निर्दिष्ट करता है।"
type: docs
weight: 20
url: /hi/java/com.aspose.xps.metadata/documentcoverbacksource/
---
**Inheritance:**
...
कस्टम बैक-कवरे शीट के स्रोत को निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverbacksource
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentCoverBackSource(String value)](#DocumentCoverBackSource-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
