...
description: "एम्बेडेड गंतव्य रंग प्रोफ़ाइल को निर्दिष्ट करता है।"
type: docs
weight: 92
url: /hi/java/com.aspose.xps.metadata/pagedestinationcolorprofileembedded/
---
**Inheritance:**
...
एम्बेडेड डेस्टिनेशन कलर प्रोफ़ाइल को निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageDestinationColorProfileEmbedded(String value)](#PageDestinationColorProfileEmbedded-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
