...
description: "दस्तावेज़ के लिए एक अद्वितीय ID को निर्दिष्ट करता है।"
type: docs
weight: 25
url: /hi/java/com.aspose.xps.metadata/documentid/
---
**Inheritance:**
...
दस्तावेज़ के लिए एक अद्वितीय ID निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentid
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentID(String documentID)](#DocumentID-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| documentID | java.lang.String | दस्तावेज़ ID। |
