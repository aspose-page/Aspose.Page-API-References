...
description: "PageDeviceColorSpaceProfileURI पैरामीटर के साथ मिलकर यह पैरामीटर डिवाइस रंग स्थान में प्रस्तुत तत्वों के रेंडरिंग व्यवहार को परिभाषित करता है।"
type: docs
weight: 95
url: /hi/java/com.aspose.xps.metadata/pagedevicecolorspaceusage/
---
**Inheritance:**
...
PageDeviceColorSpaceProfileURI पैरामीटर के साथ मिलकर यह पैरामीटर डिवाइस रंग स्थान में प्रस्तुत तत्वों के रेंडरिंग व्यवहार को परिभाषित करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceusage
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageDeviceColorSpaceUsage(PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption[] options)](#PageDeviceColorSpaceUsage-com.aspose.xps.metadata.PageDeviceColorSpaceUsage.PageDeviceColorSpaceUsageOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageDeviceColorSpaceUsageOption\[\]](../../com.aspose.xps.metadata/pagedevicecolorspaceusageoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
