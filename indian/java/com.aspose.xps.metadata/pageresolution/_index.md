...
description: "प्रिंटेड आउटपुट की पेज रेज़ोल्यूशन को गुणात्मक मान, डॉट्स प्रति इंच, या दोनों के रूप में परिभाषित करता है।"
type: docs
weight: 120
url: /hi/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
प्रिंटेड आउटपुट की पेज रेज़ोल्यूशन को गुणात्मक मान, डॉट्स प्रति इंच, या दोनों के रूप में परिभाषित करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | विशेषता के लिए विशिष्ट आइटमों की एक एरे। |
