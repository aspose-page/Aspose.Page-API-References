...
description: "जॉब के लिए कस्टम बैक-कवर प्राथमिक शीट का स्रोत निर्दिष्ट करता है।"
type: docs
weight: 67
url: /hi/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
जॉब के लिए कस्टम बैक-कवर प्राइमरी शीट का स्रोत निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
