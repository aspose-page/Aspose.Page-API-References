...
description: "PageICMRenderingIntent फीचर विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/pageicmrenderingintent.pageicmrenderingintentoption/
---
**Inheritance:**
...
वर्णन करता है  PageICMRenderingIntent  सुविधा विकल्पों को।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [AbsoluteColorimetric](#AbsoluteColorimetric) | Absolute Colorimetric रेंडरिंग इंटेंट। |
| [BusinessGraphics](#BusinessGraphics) | Business Graphics रेंडरिंग इंटेंट। |
| [Photographs](#Photographs) | Photographs रेंडरिंग इंटेंट। |
| [RelativeColorimetric](#RelativeColorimetric) | Relative Colorimetric रेंडरिंग इंटेंट। |
## मेथड्स
...
Absolute Colorimetric रेंडरिंग इंटेंट।
...
Business Graphics रेंडरिंग इंटेंट।
...
Relative Colorimetric रेंडरिंग इंटेंट।
