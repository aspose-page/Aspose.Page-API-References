...
description: "एक सापेक्ष URI निर्दिष्ट करता है पैकेज रूट के लिए, जो XPS दस्तावेज़ में सम्मिलित ICC प्रोफ़ाइल की ओर इशारा करता है।"
type: docs
weight: 94
url: /hi/java/com.aspose.xps.metadata/pagedevicecolorspaceprofileuri/
---
**Inheritance:**
...
XPS दस्तावेज़ में सम्मिलित एक ICC प्रोफ़ाइल के लिए पैकेज रूट का एक सापेक्ष URI निर्दिष्ट करता है। इस विकल्प की प्रोसेसिंग PageDeviceColorSpaceUsage सुविधा की सेटिंग पर निर्भर करती है। इस प्रोफ़ाइल का उपयोग करने वाले सभी तत्वों को मान लिया जाता है कि वे पहले से ही उपयुक्त डिवाइस रंग स्थान में हैं, और ड्राइवर या डिवाइस में रंग प्रबंधन नहीं किया जाएगा। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceprofileuri
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageDeviceColorSpaceProfileURI(String value)](#PageDeviceColorSpaceProfileURI-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
