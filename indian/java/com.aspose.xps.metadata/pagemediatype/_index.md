...
description: "MediaType विकल्पों और प्रत्येक विकल्प की विशेषताओं का वर्णन करता है।"
type: docs
weight: 110
url: /hi/java/com.aspose.xps.metadata/pagemediatype/
---
**Inheritance:**
...
MediaType विकल्पों और प्रत्येक विकल्प की विशेषताओं का वर्णन करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediatype
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageMediaType(PageMediaType.IPageMediaTypeItem[] items)](#PageMediaType-com.aspose.xps.metadata.PageMediaType.IPageMediaTypeItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| items | [IPageMediaTypeItem\[\]](../../com.aspose.xps.metadata/ipagemediatypeitem) | विशेषता के लिए विशिष्ट आइटमों की एक एरे। |
