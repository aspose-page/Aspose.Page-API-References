...
description: "दस्तावेज़ के लिए सेपरेटर शीट के उपयोग का वर्णन करता है।"
type: docs
weight: 34
url: /hi/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
दस्तावेज़ के लिए सेपरेटर शीट उपयोग का वर्णन करता है। सेपरेटर शीट्स को नीचे निर्दिष्ट विकल्प के अनुसार आउटपुट में दिखना चाहिए। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
