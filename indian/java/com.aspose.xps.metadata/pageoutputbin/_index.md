...
type: docs
weight: 114
url: /hi/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
डिवाइस के लिए समर्थित बिनों की पूरी सूची का वर्णन करता है। प्रति पृष्ठ आधार पर आउटपुट बिन निर्दिष्ट करने की अनुमति देता है। JobOutputBin, DocumentOutputBin और PageOutputBin कीवर्ड परस्पर अनन्य हैं; केवल एक को PrintTicket या Print Capabilities दस्तावेज़ में निर्दिष्ट किया जाना चाहिए। https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
