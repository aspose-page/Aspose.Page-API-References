...
description: "रोल पेपर के लिए कटिंग विधि का वर्णन करता है।"
type: docs
weight: 71
url: /hi/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
रोल पेपर के कटिंग विधि का वर्णन करता है। रोल को कार्य के अंत में काटा जाना चाहिए। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
