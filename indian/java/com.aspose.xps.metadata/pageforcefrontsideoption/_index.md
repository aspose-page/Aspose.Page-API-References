...
description: "PageForceFrontSide फीचर विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
वर्णन करता है  PageForceFrontSide  सुविधा विकल्पों को।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | निर्दिष्ट करता है कि आउटपुट शीट की फ्रंट साइड तक सीमित है। |
| [None](#None) | कोई आउटपुट प्रतिबंध नहीं निर्दिष्ट करता है। |
## मेथड्स
...
निर्दिष्ट करता है कि आउटपुट शीट की फ्रंट साइड तक सीमित है।
...
कोई आउटपुट प्रतिबंध नहीं निर्दिष्ट करता है।
