...
description: "आउटपुट की कोलैटिंग विशेषताओं का वर्णन करता है।"
type: docs
weight: 47
url: /hi/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
आउटपुट की कोलैटिंग विशेषताओं का वर्णन करता है। प्रत्येक व्यक्तिगत जॉब में सभी दस्तावेज़ कोलैट किए जाते हैं। DocumentCollate और JobCollateAllDocuments परस्पर अनन्य हैं। यह व्यवहार और कार्यान्वयन कि इन कीवर्ड्स में से दोनों या केवल एक लागू किया जाए, ड्राइवर पर निर्भर करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
