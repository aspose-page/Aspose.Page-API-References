...
description: "भौतिक मीडिया शीट के अभिविन्यास का वर्णन करता है।"
type: docs
weight: 113
url: /hi/java/com.aspose.xps.metadata/pageorientation/
---
**Inheritance:**
...
भौतिक मीडिया शीट की अभिविन्यास का वर्णन करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageOrientation(PageOrientation.PageOrientationOption[] options)](#PageOrientation-com.aspose.xps.metadata.PageOrientation.PageOrientationOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageOrientationOption\[\]](../../com.aspose.xps.metadata/pageorientationoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
