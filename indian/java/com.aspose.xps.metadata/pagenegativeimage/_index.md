...
description: "आउटपुट की नेगेटिव सेटिंग का वर्णन करता है।"
type: docs
weight: 112
url: /hi/java/com.aspose.xps.metadata/pagenegativeimage/
---
**Inheritance:**
...
आउटपुट की नकारात्मक सेटिंग का वर्णन करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageNegativeImage(PageNegativeImage.PageNegativeImageOption[] options)](#PageNegativeImage-com.aspose.xps.metadata.PageNegativeImage.PageNegativeImageOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageNegativeImageOption\[\]](../../com.aspose.xps.metadata/pagenegativeimageoption) | एक एरे या फीचर विकल्प। |
