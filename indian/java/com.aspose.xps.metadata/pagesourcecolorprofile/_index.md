...
description: "स्रोत रंग प्रोफ़ाइल की विशेषताओं को परिभाषित करता है।"
type: docs
weight: 127
url: /hi/java/com.aspose.xps.metadata/pagesourcecolorprofile/
---
**Inheritance:**
...
स्रोत कलर प्रोफ़ाइल की विशेषताओं को परिभाषित करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagesourcecolorprofile
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageSourceColorProfile(PageSourceColorProfile.PageSourceColorProfileOption[] options)](#PageSourceColorProfile-com.aspose.xps.metadata.PageSourceColorProfile.PageSourceColorProfileOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageSourceColorProfileOption\[\]](../../com.aspose.xps.metadata/pagesourcecolorprofileoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
