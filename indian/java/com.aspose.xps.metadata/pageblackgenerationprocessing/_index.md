...
description: "CMYK विभाजन के लिए ब्लैक जेनरेशन व्यवहार निर्दिष्ट करता है।"
type: docs
weight: 78
url: /hi/java/com.aspose.xps.metadata/pageblackgenerationprocessing/
---
**Inheritance:**
...
CMYK विभाजनों के लिए ब्लैक जेनरेशन व्यवहार निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessing
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageBlackGenerationProcessing(PageBlackGenerationProcessing.PageBlackGenerationProcessingOption[] options)](#PageBlackGenerationProcessing-com.aspose.xps.metadata.PageBlackGenerationProcessing.PageBlackGenerationProcessingOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageBlackGenerationProcessingOption\[\]](../../com.aspose.xps.metadata/pageblackgenerationprocessingoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
