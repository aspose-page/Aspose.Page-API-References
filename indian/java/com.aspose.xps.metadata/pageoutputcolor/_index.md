...
description: "आउटपुट के लिए रंग सेटिंग्स की विशेषताओं का वर्णन करता है।"
type: docs
weight: 115
url: /hi/java/com.aspose.xps.metadata/pageoutputcolor/
---
**Inheritance:**
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageOutputColor(PageOutputColor.IPageOutputColorItem[] items)](#PageOutputColor-com.aspose.xps.metadata.PageOutputColor.IPageOutputColorItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| items | [IPageOutputColorItem\[\]](../../com.aspose.xps.metadata/ipageoutputcoloritem) | विशेषता के लिए विशिष्ट आइटमों की एक एरे। |
