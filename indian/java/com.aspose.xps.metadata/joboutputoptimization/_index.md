...
description: "निर्दिष्ट विकल्प द्वारा संकेतित विशिष्ट उपयोग परिदृश्यों के लिए आउटपुट को अनुकूलित करने के उद्देश्य से जॉब प्रोसेसिंग का वर्णन करता है।"
type: docs
weight: 62
url: /hi/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
जॉब प्रोसेसिंग का वर्णन करता है, जो निर्दिष्ट विकल्प द्वारा संकेतित विशिष्ट उपयोग परिदृश्यों के लिए आउटपुट को अनुकूलित करने के उद्देश्य से है। https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
