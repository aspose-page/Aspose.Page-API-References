...
description: "ICC v2 विनिर्देशन द्वारा परिभाषित रेंडरिंग इरादे का वर्णन करता है।"
type: docs
weight: 98
url: /hi/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
