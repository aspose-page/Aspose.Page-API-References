...
description: "आउटपुट के लिए उपयोग किए जाने वाले भौतिक मीडिया आयामों का वर्णन करता है।"
type: docs
weight: 102
url: /hi/java/com.aspose.xps.metadata/pagemediasize/
---
**Inheritance:**
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageMediaSize(PageMediaSize.IPageMediaSizeItem[] options)](#PageMediaSize-com.aspose.xps.metadata.PageMediaSize.IPageMediaSizeItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [IPageMediaSizeItem\[\]](../../com.aspose.xps.metadata/ipagemediasizeitem) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
