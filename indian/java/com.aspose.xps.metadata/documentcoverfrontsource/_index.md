...
description: "कस्टम फ्रंट-कवर शीट के स्रोत को निर्दिष्ट करता है।"
type: docs
weight: 22
url: /hi/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
कस्टम फ्रंट-कवर शीट के स्रोत को निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
