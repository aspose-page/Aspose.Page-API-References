...
description: "कस्टम बैनर शीट के स्रोत को निर्दिष्ट करता है।"
type: docs
weight: 14
url: /hi/java/com.aspose.xps.metadata/documentbannersheetsource/
---
**Inheritance:**
...
कस्टम बैनर शीट के स्रोत को निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbannersheetsource
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentBannerSheetSource(String value)](#DocumentBannerSheetSource-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
