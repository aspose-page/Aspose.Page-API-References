...
description: "PageSourceColorProfile सुविधा विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/pagesourcecolorprofile.pagesourcecolorprofileoption/
---
**Inheritance:**
...
वर्णन करता है  PageSourceColorProfile  फीचर विकल्पों को।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [CMYK](#CMYK) | अटैग्ड CMYK डेटा के लिए रंग प्रबंधन करने हेतु उपयोग किया जाने वाला स्रोत प्रोफ़ाइल। |
| [None](#None) | कोई स्रोत प्रोफ़ाइल नहीं। |
| [RGB](#RGB) | अटैग्ड RGB डेटा के लिए रंग प्रबंधन करने हेतु उपयोग किया जाने वाला स्रोत प्रोफ़ाइल। |
## मेथड्स
...
अटैग्ड CMYK डेटा के लिए रंग प्रबंधन करने हेतु उपयोग किया जाने वाला स्रोत प्रोफ़ाइल।
...
अटैग्ड RGB डेटा के लिए रंग प्रबंधन करने हेतु उपयोग किया जाने वाला स्रोत प्रोफ़ाइल।
