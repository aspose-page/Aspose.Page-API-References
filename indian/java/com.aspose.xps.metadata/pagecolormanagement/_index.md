...
description: "वर्तमान पृष्ठ के लिए रंग प्रबंधन को कॉन्फ़िगर करता है।"
type: docs
weight: 89
url: /hi/java/com.aspose.xps.metadata/pagecolormanagement/
---
**Inheritance:**
...
वर्तमान पृष्ठ के लिए रंग प्रबंधन को कॉन्फ़िगर करता है। इसे SHIM - DM\_ICMMethod Add System में स्वचालित माना जाता है। वर्णन करता है कि कौन सा घटक रंग प्रबंधन करना चाहिए (जैसे ड्राइवर)। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecolormanagement
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageColorManagement(PageColorManagement.PageColorManagementOption[] options)](#PageColorManagement-com.aspose.xps.metadata.PageColorManagement.PageColorManagementOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageColorManagementOption\[\]](../../com.aspose.xps.metadata/pagecolormanagementoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
