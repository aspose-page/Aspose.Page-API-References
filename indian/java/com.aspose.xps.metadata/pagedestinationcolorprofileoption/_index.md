...
description: "PageDestinationColorProfile फीचर विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
वर्णन करता है  PageDestinationColorProfile  सुविधा विकल्पों को।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [Application](#Application) | एप्लिकेशन उपयोग किए जाने वाले डेस्टिनेशन प्रोफ़ाइल को निर्दिष्ट करता है। |
| [DriverConfiguration](#DriverConfiguration) | रंग प्रबंधन करने के लिए उपयोग किया गया डेस्टिनेशन प्रोफ़ाइल। |
## मेथड्स
...
एप्लिकेशन उपयोग किए जाने वाले डेस्टिनेशन प्रोफ़ाइल को निर्दिष्ट करता है।
...
रंग प्रबंधन करने के लिए उपयोग किया गया डेस्टिनेशन प्रोफ़ाइल।
