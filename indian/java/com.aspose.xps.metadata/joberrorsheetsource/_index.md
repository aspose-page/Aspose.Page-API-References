...
description: "कस्टम एरर शीट के स्रोत को निर्दिष्ट करता है।"
type: docs
weight: 54
url: /hi/java/com.aspose.xps.metadata/joberrorsheetsource/
---
**Inheritance:**
...
कस्टम त्रुटि शीट के स्रोत को निर्दिष्ट करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheetsource
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobErrorSheetSource(String value)](#JobErrorSheetSource-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
