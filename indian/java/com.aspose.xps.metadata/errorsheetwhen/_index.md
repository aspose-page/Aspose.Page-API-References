...
description: "आंतरिक ErrorSheetWhen फीचर का वर्णन करता है।"
type: docs
weight: 11
url: /hi/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen/
---
**Inheritance:**
...
ErrorSheetWhen आंतरिक फीचर का वर्णन करता है।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [ErrorSheetWhen(JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption[] options)](#ErrorSheetWhen-com.aspose.xps.metadata.JobErrorSheet.ErrorSheetWhen.ErrorSheetWhenOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [ErrorSheetWhenOption\[\]](../../com.aspose.xps.metadata/errorsheetwhenoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
