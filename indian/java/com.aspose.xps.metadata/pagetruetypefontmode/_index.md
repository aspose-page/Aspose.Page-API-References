...
description: "उपयोग किए जाने वाले TrueType फ़ॉन्ट हैंडलिंग की विधि का वर्णन करता है।"
type: docs
weight: 130
url: /hi/java/com.aspose.xps.metadata/pagetruetypefontmode/
---
**Inheritance:**
...
उपयोग किए जाने वाले TrueType फ़ॉन्ट हैंडलिंग की विधि का वर्णन करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagetruetypefontmode
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageTrueTypeFontMode(PageTrueTypeFontMode.PageTrueTypeFontModeOption[] options)](#PageTrueTypeFontMode-com.aspose.xps.metadata.PageTrueTypeFontMode.PageTrueTypeFontModeOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageTrueTypeFontModeOption\[\]](../../com.aspose.xps.metadata/pagetruetypefontmodeoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
