...
description: "आउटपुट के लिए भौतिक पृष्ठों का क्रम निर्धारित करता है।"
type: docs
weight: 63
url: /hi/java/com.aspose.xps.metadata/jobpageorder/
---
**Inheritance:**
...
आउटपुट के लिए भौतिक पृष्ठों का क्रम निर्धारित करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobpageorder
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobPageOrder(JobPageOrder.JobPageOrderOption[] options)](#JobPageOrder-com.aspose.xps.metadata.JobPageOrder.JobPageOrderOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [JobPageOrderOption\[\]](../../com.aspose.xps.metadata/jobpageorderoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
