...
description: "PageMirrorImage फीचर विकल्पों को परिभाषित करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/pagemirrorimage.pagemirrorimageoption/
---
**Inheritance:**
...
PageMirrorImage फीचर विकल्पों को परिभाषित करता है।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [MirrorImageHeight](#MirrorImageHeight) | निर्देशित करता है कि आउटपुट को MediaSizeHeight दिशा के समानांतर प्रतिबिंबित किया जाना चाहिए। |
| [MirrorImageWidth](#MirrorImageWidth) | निर्देशित करता है कि आउटपुट को MediaSizeWidth दिशा के समानांतर प्रतिबिंबित किया जाना चाहिए। |
| [None](#None) | निर्देशित करता है कि आउटपुट को प्रतिबिंबित नहीं किया जाना चाहिए। |
## मेथड्स
...
निर्देशित करता है कि आउटपुट को MediaSizeHeight दिशा के समानांतर प्रतिबिंबित किया जाना चाहिए।
...
निर्देशित करता है कि आउटपुट को MediaSizeWidth दिशा के समानांतर प्रतिबिंबित किया जाना चाहिए।
...
निर्देशित करता है कि आउटपुट को प्रतिबिंबित नहीं किया जाना चाहिए।
