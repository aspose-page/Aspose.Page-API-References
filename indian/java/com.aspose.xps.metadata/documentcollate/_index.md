...
type: docs
weight: 17
url: /hi/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
आउटपुट की कोलैटिंग विशेषताओं का वर्णन करता है। प्रत्येक व्यक्तिगत दस्तावेज़ में सभी पृष्ठ कोलैट किए जाते हैं। DocumentCollate और JobCollateAlldocuments परस्पर अनन्य हैं। दोनों या केवल इन कुंजियों में से एक के लागू होने का व्यवहार और कार्यान्वयन ड्राइवर पर छोड़ दिया गया है। https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
