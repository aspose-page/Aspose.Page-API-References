...
description: "DocumentCollate और JobCollateAllDocuments सुविधाओं के विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
DocumentCollate और JobCollateAllDocuments फीचर विकल्पों का वर्णन करता है।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [Collated](#Collated) | कोलैटिंग निर्दिष्ट करता है। |
| [Uncollated](#Uncollated) | कोलैटिंग नहीं निर्दिष्ट करता है। |
## मेथड्स
...
कोलैटिंग नहीं निर्दिष्ट करता है।
