...
description: "डिवाइस फ़ॉन्ट प्रतिस्थापन की सक्षम/अक्षम स्थिति का वर्णन करता है।"
type: docs
weight: 96
url: /hi/java/com.aspose.xps.metadata/pagedevicefontsubstitution/
---
**Inheritance:**
...
डिवाइस फ़ॉन्ट प्रतिस्थापन की सक्षम/अक्षम स्थिति का वर्णन करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicefontsubstitution
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageDeviceFontSubstitution(PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption[] options)](#PageDeviceFontSubstitution-com.aspose.xps.metadata.PageDeviceFontSubstitution.PageDeviceFontSubstitutionOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PageDeviceFontSubstitutionOption\[\]](../../com.aspose.xps.metadata/pagedevicefontsubstitutionoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
