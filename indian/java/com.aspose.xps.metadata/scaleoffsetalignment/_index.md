...
description: "आंतरिक ScaleOffsetAlignment फीचर का वर्णन करता है।"
type: docs
weight: 11
url: /hi/java/com.aspose.xps.metadata/pagescaling.scaleoffsetalignment/
---
**Inheritance:**
...
आंतरिक  ScaleOffsetAlignment  फीचर का वर्णन करता है।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [ScaleOffsetAlignment(PageScaling.ScaleOffsetAlignmentOption[] options)](#ScaleOffsetAlignment-com.aspose.xps.metadata.PageScaling.ScaleOffsetAlignmentOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [ScaleOffsetAlignmentOption\[\]](../../com.aspose.xps.metadata/scaleoffsetalignmentoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
