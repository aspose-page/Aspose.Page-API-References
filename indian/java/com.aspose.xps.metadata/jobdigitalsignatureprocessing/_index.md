...
description: "पूरे जॉब के लिए डिजिटल सिग्नेचर प्रोसेसिंग को कॉन्फ़िगर करने का वर्णन करता है।"
type: docs
weight: 51
url: /hi/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing/
---
**Inheritance:**
...
पूरे जॉब के लिए डिजिटल सिग्नेचर प्रोसेसिंग को कॉन्फ़िगर करने का वर्णन करता है। यह केवल उन सामग्री पर लागू होता है जिनमें डिजिटल सिग्नेचर होते हैं। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobDigitalSignatureProcessing(JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption[] options)](#JobDigitalSignatureProcessing-com.aspose.xps.metadata.JobDigitalSignatureProcessing.JobDigitalSignatureProcessingOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [JobDigitalSignatureProcessingOption\[\]](../../com.aspose.xps.metadata/jobdigitalsignatureprocessingoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
