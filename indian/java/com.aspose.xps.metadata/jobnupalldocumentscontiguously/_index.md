...
description: "एकल भौतिक शीट पर कई लॉजिकल पेजों के आउटपुट का वर्णन करता है।"
type: docs
weight: 58
url: /hi/java/com.aspose.xps.metadata/jobnupalldocumentscontiguously/
---
**Inheritance:**
...
कई लॉजिकल पृष्ठों के आउटपुट को एक सिंगल फिजिकल शीट में वर्णित करता है। जॉब में सभी दस्तावेज़ लगातार एक साथ संकलित होते हैं।  JobNUpAllDocumentsContiguously  और  DocumentNUp  परस्पर अनन्य हैं। इन कीवर्ड्स के बीच प्रतिबंधों को संभालना ड्राइवर पर निर्भर करता है। https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [JobNUpAllDocumentsContiguously(NUp.INUpItem[] items)](#JobNUpAllDocumentsContiguously-com.aspose.xps.metadata.NUp.INUpItem...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | int | एक  PagesPerSheet  स्कोर्ड प्रॉपर्टी वैल्यू। समर्थित सेट कोई भी पूर्णांक सेट हो सकता है, उदाहरण के लिए \{1,2,4,6,8,9,16\}। |
