...
description: "ErrorSheetWhen सुविधा विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
ErrorSheetWhen फीचर विकल्पों का वर्णन करता है।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [Always](#Always) | निर्दिष्ट करता है कि प्रत्येक कार्य के लिए एक त्रुटि शीट आउटपुट होगी। |
| [OnError](#OnError) | निर्दिष्ट करता है कि केवल त्रुटि होने पर ही एक त्रुटि शीट आउटपुट होगी। |
## मेथड्स
...
निर्दिष्ट करता है कि प्रत्येक कार्य के लिए एक त्रुटि शीट आउटपुट होगी।
...
निर्दिष्ट करता है कि केवल त्रुटि होने पर ही एक त्रुटि शीट आउटपुट होगी।
