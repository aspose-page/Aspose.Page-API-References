...
description: "JobRollCutAtEndOfJob और DocumentRollCut सुविधाओं के विकल्पों का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
JobRollCutAtEndOfJob और DocumentRollCut फीचर विकल्पों का वर्णन करता है।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [Banner](#Banner) | बैनर के लिए कटिंग विधि निर्दिष्ट करता है (केवल DocumentRollCut)। |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | छवि के किनारे पर कटिंग निर्दिष्ट करता है। |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | मानक मीडिया आकार के लिए कटिंग निर्दिष्ट करता है। |
| [None](#None) | कोई जॉब रोल कट नहीं निर्दिष्ट करता। |
## मेथड्स
...
बैनर के लिए कटिंग विधि निर्दिष्ट करता है (केवल DocumentRollCut)।
...
छवि के किनारे पर कटिंग निर्दिष्ट करता है।
...
मानक मीडिया आकार के लिए कटिंग निर्दिष्ट करता है।
...
कोई जॉब रोल कट नहीं निर्दिष्ट करता।
