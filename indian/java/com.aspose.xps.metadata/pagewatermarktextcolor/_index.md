...
description: "वॉटरमार्क टेक्स्ट के लिए sRGB रंग को परिभाषित करता है।"
type: docs
weight: 135
url: /hi/java/com.aspose.xps.metadata/pagewatermarktextcolor/
---
**Inheritance:**
...
वॉटरमार्क टेक्स्ट के लिए sRGB रंग को परिभाषित करता है। फॉर्मेट ARGB: \#AARRGGBB है। https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextcolor
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PageWatermarkTextColor(String value)](#PageWatermarkTextColor-java.lang.String-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
