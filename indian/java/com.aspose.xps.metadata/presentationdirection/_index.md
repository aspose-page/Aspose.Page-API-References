...
description: "आंतरिक PresentationDirection फीचर का वर्णन करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.xps.metadata/nup.presentationdirection/
---
**Inheritance:**
...
आंतरिक PresentationDirection फीचर का वर्णन करता है।
## कंस्ट्रक्टर्स

| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [PresentationDirection(NUp.PresentationDirection.PresentationDirectionOption[] options)](#PresentationDirection-com.aspose.xps.metadata.NUp.PresentationDirection.PresentationDirectionOption...-) | एक नया इंस्टेंस बनाता है। |
## मेथड्स
...
| --- | --- | --- |
| options | [PresentationDirectionOption\[\]](../../com.aspose.xps.metadata/presentationdirectionoption) | फ़ीचर के लिए विशिष्ट विकल्पों की एक सरणी। |
