...
| [get_Delta](./get_delta/)() | डेल्टा मान लौटाता है। |
...
| static [GetRetryConditionLength](./getretryconditionlength/)(String, int32_t, System::SharedPtr\<Object\>\&) | निर्दिष्ट इंडेक्स से पास की गई स्ट्रिंग को [RetryConditionHeaderValue](./) क्लास के एक इंस्टेंस में परिवर्तित करता है। |
| static [Parse](./parse/)(String) | पास की गई स्ट्रिंग को [RetryConditionHeaderValue](./) क्लास के एक इंस्टेंस में परिवर्तित करता है। |
| [RetryConditionHeaderValue](./retryconditionheadervalue/)(DateTimeOffset) | एक नया उदाहरण बनाता है। |
| [RetryConditionHeaderValue](./retryconditionheadervalue/)(TimeSpan) | एक नया उदाहरण बनाता है। |
...
| static [TryParse](./tryparse/)(String, System::SharedPtr\<RetryConditionHeaderValue\>\&) | पास की गई स्ट्रिंग को [RetryConditionHeaderValue](./) क्लास के एक इंस्टेंस में परिवर्तित करने का प्रयास करता है। |
## संबंधित देखें
