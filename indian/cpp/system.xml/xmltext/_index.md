---
title: "System::Xml::XmlText क्लास"
linktitle: "XmlText"
second_title: "Aspose.Page C++ के लिए"
description: "System::Xml::XmlText क्लास। C++ में किसी तत्व या गुणधर्म की पाठ सामग्री को दर्शाता है।"
type: docs
weight: 3800
url: /hi/cpp/system.xml/xmltext/
---
## XmlText class


एक तत्व या विशेषता की टेक्स्ट सामग्री का प्रतिनिधित्व करता है।
...
| virtual [SplitText](./splittext/)(int32_t) | निर्दिष्ट ऑफसेट पर नोड को दो नोड्स में विभाजित करता है, दोनों को पेड़ में भाई-बहन के रूप में रखता है। |
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | निर्दिष्ट [XmlWriter](../xmlwriter/) में नोड के सभी चाइल्ड को सहेजता है। [XmlText](./) नोड्स के पास चाइल्ड नहीं होते, इसलिए इस मेथड का कोई प्रभाव नहीं पड़ता। |
