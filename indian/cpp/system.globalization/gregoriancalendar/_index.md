...
| virtual [get_CalendarType](./get_calendartype/)() const | ग्रेगोरियन कैलेंडर प्रकार प्राप्त करता है। |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | डिफ़ॉल्ट ग्रेगोरियन कैलेंडर इंस्टेंस प्राप्त करता है। |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | विशिष्ट ग्रेगोरियन कैलेंडर बनाता है। |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | ग्रेगोरियन कैलेंडर प्रकार सेट करता है। |
...
| फ़ील्ड | विवरण |
| --- | --- |
| static constexpr [ADEra](./adera/) | वर्तमान युग। |
## संबंधित देखें
