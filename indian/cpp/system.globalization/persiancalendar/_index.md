...
| virtual [GetDaysInMonth](./getdaysinmonth/)(int, int) const | RTTI जानकारी। |
...
| [PersianCalendar](./persiancalendar/)() | निर्माता। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| static constexpr [PersianEra](./persianera/) | वर्तमान फ़ारसी युग। |
## संबंधित देखें
