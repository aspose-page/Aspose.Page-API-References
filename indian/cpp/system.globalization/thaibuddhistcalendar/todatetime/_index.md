...
description: "System::Globalization::ThaiBuddhistCalendar::ToDateTime method. घटकों से C++ में DateTime ऑब्जेक्ट बनाता है।"
type: docs
weight: 2000
url: /hi/cpp/system.globalization/thaibuddhistcalendar/todatetime/
---
## ThaiBuddhistCalendar::ToDateTime(int, int, int, int, int, int, int) const method


घटकों से [DateTime](../../../system/datetime/) ऑब्जेक्ट बनाता है।
