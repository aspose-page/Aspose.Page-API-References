---
title: "System::Collections::Generic::LinkedList::AddLast मेथड"
linktitle: "AddLast"
second_title: "Aspose.Page C++ के लिए"
description: "System::Collections::Generic::LinkedList::AddLast method. सूची के अंत में newNode जोड़ता है C++ में।"
type: docs
weight: 600
url: /hi/cpp/system.collections.generic/linkedlist/addlast/
---
## LinkedList::AddLast(const SharedPtr\<LinkedListNode\<T\>\>\&) method


सूची के अंत में **newNode** जोड़ता है।
...
| --- | --- | --- |
| newNode | const SharedPtr\<LinkedListNode\<T\>\>\& | जोड़ने के लिए नया नोड। |
