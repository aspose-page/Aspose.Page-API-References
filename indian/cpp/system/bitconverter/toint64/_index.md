---
title: "System::BitConverter::ToInt64 विधि"
linktitle: "ToInt64"
second_title: "Aspose.Page C++ के लिए"
description: "System::BitConverter::ToInt64 विधि। निर्दिष्ट सरणी से निर्दिष्ट इंडेक्स से शुरू होकर आठ बाइट्स को C++ में 64-बिट पूर्णांक मान में परिवर्तित करता है।"
type: docs
weight: 1000
url: /hi/cpp/system/bitconverter/toint64/
---
## BitConverter::ToInt64(const System::ArrayPtr\<uint8_t\>\&, int) method


निर्दिष्ट सरणी से निर्दिष्ट सूचकांक से शुरू होकर आठ बाइट्स को 64-बिट पूर्णांक मान में परिवर्तित करता है।
...
| --- | --- | --- |
| value | const System::ArrayPtr\<uint8_t\>\& | बाइट्स को परिवर्तित करने वाला [Array](../../array/) |
| startIndex | int | रूपांतरण के लिए बाइट्स लेना शुरू करने के लिए ऐरे में सूचकांक |

### ReturnValue

रूपांतरण से प्राप्त 64-बिट पूर्णांक मान
