---
title: "System::Xml::Schema::XmlTypeCode एनम"
linktitle: "XmlTypeCode"
second_title: "Aspose.Page C++ के लिए"
description: "System::Xml::Schema::XmlTypeCode एनम। C++ में W3C XML Schema Definition Language (XSD) स्कीमा प्रकारों का प्रतिनिधित्व करता है।"
type: docs
weight: 8200
url: /hi/cpp/system.xml.schema/xmltypecode/
---
## XmlTypeCode enum


W3C XML [Schema](../) Definition Language (XSD) स्कीमा प्रकारों का प्रतिनिधित्व करता है।
...
| Item | 1 | एक आइटम जैसे कि नोड या एटॉमिक मान। |
| Node | 2 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| Document | 3 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| Element | 4 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| Attribute | 5 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| नामस्थान | 6 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| ProcessingInstruction | 7 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| Comment | 8 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| Text | 9 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| AnyAtomicType | 10 | संघ का कोई भी एटॉमिक मान। |
| UntypedAtomic | 11 | एक अनटाइप्ड एटॉमिक मान। |
...
| YearMonthDuration | 53 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
| DayTimeDuration | 54 | यह मान आंतरिक प्रयोजनों के लिए उपयोग किया जाता है और इसे आपके कोड से सीधे उपयोग करने के लिए अभिप्रेत नहीं है। |
