...
| virtual [get_CalendarType](./get_calendartype/)() const | Haalt het type van de Gregoriaanse kalender op. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | Haalt de standaardinstantie van de Gregoriaanse kalender op. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | Construeert een specifieke Gregoriaanse kalender. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | Stelt het type van de Gregoriaanse kalender in. |
...
| Veld | Beschrijving |
| --- | --- |
| static constexpr [ADEra](./adera/) | Huidig tijdperk. |
## Zie ook
