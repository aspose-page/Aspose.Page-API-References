...
description: "System::Globalization::ThaiBuddhistCalendar class. Thaibuddhistische kalender. Objecten van deze klasse mogen alleen worden gealloceerd met de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime‑fouten en/of assertiefouten kan veroorzaken. Wrap deze klasse altijd in een System::SmartPtr‑pointer en gebruik deze pointer om deze als argument aan functies door te geven in C++."
type: docs
weight: 2900
url: /nl/cpp/system.globalization/thaibuddhistcalendar/
---
## ThaiBuddhistCalendar class


Thaibuddhistische kalender. Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime‑fouten en/of assertiefouten kan veroorzaken. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om deze als argument aan functies door te geven.
...
| [GetDayOfMonth](./getdayofmonth/)(DateTime) const override | Haalt de dag van de maand op voor het opgegeven tijdstip. |
| [GetDayOfWeek](./getdayofweek/)(DateTime) const override | Haalt de dag van de week op voor het opgegeven tijdstip. |
| [GetDayOfYear](./getdayofyear/)(DateTime) const override | Haalt de dag van het jaar op voor het opgegeven tijdstip. |
...
| Veld | Beschrijving |
| --- | --- |
| static constexpr [ThaiBuddhistEra](./thaibuddhistera/) | Huidige Thaibuddhistische era. |
## Zie ook
