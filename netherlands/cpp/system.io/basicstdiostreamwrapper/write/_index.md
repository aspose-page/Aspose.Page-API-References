...
description: "System::IO::BasicSTDIOStreamWrapper::Write methode. Als de omhullende modus binair is, schrijft het de opgegeven subreeks van bytes uit de opgegeven byte-array naar de stream; anders wordt de opgegeven subreeks van bytes uit de opgegeven byte-array geconverteerd naar het type char_type en vervolgens wordt het resultaat naar de stream geschreven in C++."
type: docs
weight: 700
url: /nl/cpp/system.io/basicstdiostreamwrapper/write/
---
