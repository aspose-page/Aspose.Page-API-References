...
description: "System::IO::DirectoryInfo::EnumerateFiles methode. Retourneert een enumerabele collectie die alle bestanden bevat die zich bevinden in de map die wordt vertegenwoordigd door het huidige object in C++."
type: docs
weight: 600
url: /nl/cpp/system.io/directoryinfo/enumeratefiles/
---
## DirectoryInfo::EnumerateFiles() method


Retourneert een doorzoekbare collectie met alle bestanden die zich bevinden in de map die door het huidige object wordt vertegenwoordigd.
...
De enumerabele collectie van gedeelde pointers naar [FileInfo](../../fileinfo/) objecten die de gevonden bestanden vertegenwoordigen waarvan de namen overeenkomen met **searchPattern**
