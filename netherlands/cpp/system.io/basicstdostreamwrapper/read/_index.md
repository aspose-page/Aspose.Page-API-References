...
description: "System::IO::BasicSTDOStreamWrapper::Read methode. Als de wraapmodus binair is, leest het het opgegeven aantal bytes van de stream; anders leest het het opgegeven aantal tekens en converteert deze naar het type uint8_t. Schrijft het resultaat van het lezen naar de opgegeven byte‑array. Niet ondersteund! in C++."
type: docs
weight: 400
url: /nl/cpp/system.io/basicstdostreamwrapper/read/
---
## BasicSTDOStreamWrapper::Read(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) method


Als de wrappermodus binair is, leest het opgegeven aantal bytes van de stream, anders leest het het opgegeven aantal tekens en converteert deze naar het type uint8_t. Schrijft het resultaat van het lezen naar de opgegeven byte‑array. Niet ondersteund!
