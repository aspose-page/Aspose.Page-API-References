...
type: docs
weight: 100
url: /nl/cpp/system.threading/thread/thread/
---
...
| --- | --- | --- |
| thread_function | ParameterizedThreadStart | Functie die door de thread moet worden uitgevoerd. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| t | Thread\& | [Thread](../) om gegevens van te kopiëren. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| thread_function | ThreadStart | Functie die door de thread moet worden uitgevoerd. |
