...
description: "System::Net::Sockets::TcpClient::BeginConnect method. Start een asynchrone verbindingsoperatie in C++."
type: docs
weight: 300
url: /nl/cpp/system.net.sockets/tcpclient/beginconnect/
---
...
| --- | --- | --- |
| host | String | Een externe hostnaam. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| addresses | System::ArrayPtr\\<System::SharedPtr\\<IPAddress\\>\\ | De IP-adressen van een externe host. |
| port | int32_t | Een poort van de externe host. |
| requestCallback | AsyncCallback | Een callback die wordt aangeroepen wanneer de bewerking is voltooid. |
| state | System::SharedPtr\<Object\> | Door de gebruiker geleverde gegevens die worden gebruikt om elke asynchrone verbindingsoperatie uniek te identificeren. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| adres | System::SharedPtr\<IPAddress\> | Het IP-adres van een externe host. |
| port | int32_t | Een poort van de externe host. |
| requestCallback | AsyncCallback | Een callback die wordt aangeroepen wanneer de bewerking is voltooid. |
| state | System::SharedPtr\<Object\> | Door de gebruiker geleverde gegevens die worden gebruikt om elke asynchrone verbindingsoperatie uniek te identificeren. |
