...
description: "System::setter_post_increment_wrap methode. Vertaler vertaalt C#''s post‑increment‑expressies die gericht zijn op de eigenschap van een instantie die een setter en getter heeft gedefinieerd, naar een aanroep van deze functie (overload voor const‑getter) in C++."
type: docs
weight: 37900
url: /nl/cpp/system/setter_post_increment_wrap/
---
## System::setter_post_increment_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Vertaler vertaalt C#'s post‑increment‑expressies die gericht zijn op de eigenschap van een instantie die een setter en getter heeft gedefinieerd, naar een aanroep van deze functie (overload voor const‑getter).
...
Vertaler vertaalt C#‑post‑increment‑expressies die gericht zijn op de eigenschap van een instantie met gedefinieerde setter en getter, naar een aanroep van deze functie (overload voor niet‑const getter).
...
Vertaler vertaalt C#‑post‑increment‑expressies die gericht zijn op de eigenschap van een klasse met gedefinieerde setter en getter, naar een aanroep van deze functie.
