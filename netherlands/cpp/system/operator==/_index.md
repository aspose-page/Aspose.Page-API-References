...
Bepaalt of de opgegeven waarde gelijk is aan de waarde die wordt vertegenwoordigd door het opgegeven [Nullable](../nullable/) object door [operator==()](./) toe te passen op deze waarden.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| x | std::nullptr_t | [Object](../object/) om te controleren. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| x | T const\& | [Object](../object/) om te controleren. |
