...
description: "Deze enum bevat mogelijke waarden voor de tekstweergavemodus."
type: docs
weight: 24
url: /nl/java/com.aspose.page/textrenderingmode/
---
**Inheritance:**
...
Deze enum bevat mogelijke waarden voor de tekstweergavemodus.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Fill](#Fill) | Vul een tekst. |
| [FillAndStroke](#FillAndStroke) | Vul en teken een tekst. |
| [No](#No) | Noch vullen noch tekenen van een tekst. |
| [Stroke](#Stroke) | Teken een tekst. |
## Methoden
...
Noch vullen noch tekenen van een tekst.
