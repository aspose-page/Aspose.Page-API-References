...
type: docs
weight: 16
url: /nl/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [SaveOptions()](#SaveOptions--) | Initialiseer een nieuw SaveOptions instance met standaardwaarden voor de vlaggen suppressErrors (true) en debug (false). |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | Initialiseer een nieuw SaveOptions instance met standaardwaarde voor de vlag debug (false). |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | Initialiseert een nieuw SaveOptions instance met opgegeven grootte. |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | Initialiseer een nieuw SaveOptions instance met standaardwaarde voor de vlag debug (false) en met opgegeven grootte. |
## Methoden
...
Initialiseer een nieuw SaveOptions instance met standaardwaarden voor de vlaggen suppressErrors (true) en debug (false).
...
Initialiseer een nieuw SaveOptions instance met standaardwaarde voor de vlag debug (false).
...
Initialiseert een nieuw SaveOptions instance met opgegeven grootte.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| grootte | java.awt.Dimension | De grootte. |
...
Initialiseer een nieuw SaveOptions instance met standaardwaarde voor de vlag debug (false) en met opgegeven grootte.
