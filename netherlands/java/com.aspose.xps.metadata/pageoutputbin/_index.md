...
description: "Beschrijft de volledige lijst van ondersteunde bakken voor het apparaat."
type: docs
weight: 114
url: /nl/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Beschrijft de volledige lijst van ondersteunde bakken voor het apparaat. Stelt het specificeren van een uitvoerbak per pagina mogelijk. De trefwoorden JobOutputBin, DocumentOutputBin en PageOutputBin zijn onderling exclusief; er mag er slechts één worden gespecificeerd in een PrintTicket‑ of Print‑Capabilities‑document. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Maakt een nieuw exemplaar aan. |
## Methoden
