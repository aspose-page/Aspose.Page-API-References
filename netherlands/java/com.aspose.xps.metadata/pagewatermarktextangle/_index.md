...
description: "Specificeert de hoek van de watermerktekst ten opzichte van de PageImageableSizeWidth-richting."
type: docs
weight: 134
url: /nl/java/com.aspose.xps.metadata/pagewatermarktextangle/
---
**Inheritance:**
...
Specificeert de hoek van de watermerktekst ten opzichte van de  PageImageableSizeWidth  richting. De hoek wordt gemeten in tegenwijzerzin. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageWatermarkTextAngle(int value)](#PageWatermarkTextAngle-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
