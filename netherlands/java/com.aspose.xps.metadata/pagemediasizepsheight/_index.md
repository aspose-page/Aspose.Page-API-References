...
description: "Specificeert de hoogte van de pagina parallel aan de voedingsoriëntatierichting."
type: docs
weight: 105
url: /nl/java/com.aspose.xps.metadata/pagemediasizepsheight/
---
**Inheritance:**
...
Specificeert de hoogte van de pagina, parallel aan de voedingsoriëntatierichting. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
