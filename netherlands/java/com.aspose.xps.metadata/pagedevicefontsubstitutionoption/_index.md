...
description: "Beschrijft de opties voor de PageDeviceFontSubstitution-functie."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Beschrijft de opties voor de functie  PageDeviceFontSubstitution .
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Off](#Off) | Page device font substitution is uitgeschakeld. |
| [On](#On) | Page device font substitution is ingeschakeld. |
## Methoden
...
Page device font substitution is uitgeschakeld.
...
Page device font substitution is ingeschakeld.
