...
description: "Beschrijft de apparaatstalen die worden ondersteund voor het verzenden van gegevens van de driver naar het fysieke apparaat."
type: docs
weight: 50
url: /nl/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
Beschrijft de apparaattaalondersteuning voor het verzenden van gegevens van de driver naar het fysieke apparaat. Dit wordt vaak "Page Description Language" genoemd. Dit trefwoord definieert welke paginabeschrijvingstaal wordt ondersteund door de driver en het fysieke apparaat. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdevicelanguage
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | Een array van opties specifiek voor de functie. |
