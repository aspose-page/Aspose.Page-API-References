...
description: "Specificeert de breedte van de pagina loodrecht op de feed-orientatierichting."
type: docs
weight: 108
url: /nl/java/com.aspose.xps.metadata/pagemediasizepswidth/
---
**Inheritance:**
...
Specificeert de breedte van de pagina loodrecht op de feed-orientatierichting. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidth
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageMediaSizePSWidth(int value)](#PageMediaSizePSWidth-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
