...
description: "Specificeert de schaalfactor in de ImageableSizeWidth-richting voor aangepaste schaalvergroting."
type: docs
weight: 126
url: /nl/java/com.aspose.xps.metadata/pagescalingscalewidth/
---
**Inheritance:**
...
Specificeert de schaalfactor in de  ImageableSizeWidth  richting voor aangepaste schaalvergroting. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageScalingScaleWidth(int value)](#PageScalingScaleWidth-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
