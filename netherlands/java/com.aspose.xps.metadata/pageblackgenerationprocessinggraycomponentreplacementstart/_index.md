...
description: "Beschrijft het punt in het bereik van highlight tot schaduw waar GCR moet beginnen 100 donkerste schaduw."
type: docs
weight: 82
url: /nl/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementstart/
---
**Inheritance:**
...
Beschrijft het punt in het \"highlight to shadow\"-bereik waar GCR moet beginnen (100% donkerste schaduw). https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
