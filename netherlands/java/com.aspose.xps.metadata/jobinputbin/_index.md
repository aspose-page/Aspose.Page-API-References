...
description: "Beschrijft de geïnstalleerde invoerbak in een apparaat of de volledige lijst met ondersteunde bakken voor een apparaat."
type: docs
weight: 57
url: /nl/java/com.aspose.xps.metadata/jobinputbin/
---
**Inheritance:**
...
Beschrijft de geïnstalleerde invoerbak in een apparaat of de volledige lijst van ondersteunde bakken voor een apparaat. Stelt de specificatie van invoerbak per taak in. De  JobInputBin ,  DocumentInputBin , en  PageInputBin  trefwoorden zijn onderling exclusief. Beide mogen niet gelijktijdig worden gespecificeerd in een PrintTicket of Print Capabilities-document. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobinputbin
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobInputBin(InputBin.IInputBinItem[] items)](#JobInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| items | [IInputBinItem\[\]](../../com.aspose.xps.metadata/iinputbinitem) | Een array van items specifiek voor de functie. |
