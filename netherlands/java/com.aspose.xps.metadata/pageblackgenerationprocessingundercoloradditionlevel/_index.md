...
description: "Beschrijft de hoeveelheid chromatische inkt in grijze‑componentverhoudingen die moet worden toegevoegd aan gebieden waar GCR/UCR een BlackInkLimit of UCAStart heeft gegenereerd, indien gespecificeerd in de donkere neutrale en bijna‑neutrale gebieden."
type: docs
weight: 84
url: /nl/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionlevel/
---
**Inheritance:**
...
Beschrijft de hoeveelheid chromatische inkt (in grijze‑componentverhoudingen) die moet worden toegevoegd aan gebieden waar GCR/UCR een "BlackInkLimit" (of UCAStart, indien gespecificeerd) heeft gegenereerd in de donkere neutrale en bijna‑neutrale gebieden. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionlevel
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionLevel(int value)](#PageBlackGenerationProcessingUnderColorAdditionLevel-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
