...
description: "Specificeert een unieke ID voor de opdracht."
type: docs
weight: 56
url: /nl/java/com.aspose.xps.metadata/jobid/
---
**Inheritance:**
...
Specificeert een unieke ID voor de taak. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobid
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobID(String jobID)](#JobID-java.lang.String-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| jobID | java.lang.String | De taak-ID. |
