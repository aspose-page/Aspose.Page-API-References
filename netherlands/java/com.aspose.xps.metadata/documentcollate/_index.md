...
type: docs
weight: 17
url: /nl/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Beschrijft de collatie-eigenschappen van de uitvoer. Alle pagina's in elk afzonderlijk document worden samengevoegd. DocumentCollate en JobCollateAlldocuments zijn wederzijds exclusief. Het gedrag en de implementatie van of beide of slechts één van deze trefwoorden wordt geïmplementeerd, wordt overgelaten aan de driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
