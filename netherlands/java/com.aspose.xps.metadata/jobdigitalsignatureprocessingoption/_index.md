...
description: "Beschrijft de functieopties van JobDigitalSignatureProcessing."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/
---
**Inheritance:**
...
Beschrijft de  JobDigitalSignatureProcessing  functieopties.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [PrintInvalidSignatures](#PrintInvalidSignatures) | Print de taak ongeacht de geldigheid van de digitale handtekeningen. |
| [PrintInvalidSignaturesWithErrorReport](#PrintInvalidSignaturesWithErrorReport) | Print de taak ongeacht de geldigheid van de digitale handtekeningen. |
| [PrintOnlyValidSignatures](#PrintOnlyValidSignatures) | Print de taak alleen als alle digitale handtekeningen geldig zijn. |
## Methoden
...
Print de taak ongeacht de geldigheid van de digitale handtekeningen. Digitale handtekeningen MOGEN worden genegeerd.
...
Print de taak ongeacht de geldigheid van de digitale handtekeningen. In het geval dat een ongeldige handtekening wordt aangetroffen, moet er aan het einde van de taak een foutpagina worden afgedrukt. Digitale handtekeningen MOETEN niet worden genegeerd.
...
Print de taak alleen als alle digitale handtekeningen geldig zijn. Digitale handtekeningen MOETEN niet worden genegeerd.
