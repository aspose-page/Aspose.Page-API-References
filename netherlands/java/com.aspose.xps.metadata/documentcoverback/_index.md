...
description: "Beschrijft het achterste omslagvel."
type: docs
weight: 19
url: /nl/java/com.aspose.xps.metadata/documentcoverback/
---
**Inheritance:**
...
Beschrijft de achterste (eind) omslagblad. Elk document krijgt een afzonderlijk blad. Het omslagblad moet worden afgedrukt op de  PageMediaSize  en  PageMediaType  die worden gebruikt voor de laatste pagina van het document. Het omslagblad moet worden geïntegreerd in verwerkingsopties (zoals  DocumentDuplex ,  DocumentNUp ) zoals aangegeven door de gespecificeerde optie. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DocumentCoverBack(DocumentCoverBack.CoverBackOption[] options)](#DocumentCoverBack-com.aspose.xps.metadata.DocumentCoverBack.CoverBackOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| options | [CoverBackOption\[\]](../../com.aspose.xps.metadata/coverbackoption) | Een array van opties specifiek voor de functie. |
