...
description: "Beschrijft de sorteerkenmerken van de uitvoer."
type: docs
weight: 47
url: /nl/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Beschrijft de collatiekenmerken van de uitvoer. Alle documenten in elke individuele taak worden samengevoegd.  DocumentCollate  en  JobCollateAllDocuments  zijn wederzijds exclusief. Het gedrag en de implementatie van of beide of slechts één van deze trefwoorden wordt geïmplementeerd, wordt overgelaten aan de driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | Een array van opties specifiek voor de functie. |
