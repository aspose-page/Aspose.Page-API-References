...
type: docs
weight: 45
url: /nl/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Beschrijft de bindmethode. Alle documenten in de taak worden samengebonden.  JobBindAllDocuments  en  DocumentBinding  zijn wederzijds exclusief. Het is aan de driver om de afhandeling van beperkingen tussen deze trefwoorden te bepalen. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
