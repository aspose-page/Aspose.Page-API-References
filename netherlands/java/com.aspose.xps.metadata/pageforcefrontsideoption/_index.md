...
description: "Beschrijft de opties voor de PageForceFrontSide‑functie."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Beschrijft de opties voor de functie  PageForceFrontSide .
## Velden

| Veld | Beschrijving |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Geeft aan dat de uitvoer beperkt is tot de voorzijde van het vel. |
| [None](#None) | Geeft aan dat er geen uitvoerbeperkingen zijn. |
## Methoden
...
Geeft aan dat de uitvoer beperkt is tot de voorzijde van het vel.
...
Geeft aan dat er geen uitvoerbeperkingen zijn.
