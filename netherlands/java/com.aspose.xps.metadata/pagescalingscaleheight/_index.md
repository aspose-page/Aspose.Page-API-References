...
description: "Specificeert de schaalfactor in de ImageableSizeHeight‑richting voor aangepaste schaalvergroting."
type: docs
weight: 125
url: /nl/java/com.aspose.xps.metadata/pagescalingscaleheight/
---
**Inheritance:**
...
Specificeert de schaalfactor in de  ImageableSizeHeight  richting voor aangepaste schaalvergroting. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageScalingScaleHeight(int value)](#PageScalingScaleHeight-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
