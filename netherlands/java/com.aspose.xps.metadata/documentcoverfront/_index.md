...
type: docs
weight: 21
url: /nl/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
Beschrijft het voorste (beginnende) omslagvel. Elk document krijgt een apart vel. Het omslagvel moet worden afgedrukt op de  PageMediaSize  en  PageMediaType  die voor de eerste pagina van het document worden gebruikt. Het omslagvel moet worden geïntegreerd in verwerkingsopties (zoals  DocumentDuplex ,  DocumentNUp ) zoals aangegeven door de gespecificeerde optie. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
...
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | Een array van opties specifiek voor de functie. |
