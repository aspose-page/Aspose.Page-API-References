...
description: "Beschrijft de JobPageOrder-functieopties."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Beschrijft de  JobPageOrder  functie-opties.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Reverse](#Reverse) | Specificeert de volgorde van achter naar voor pagina's. |
| [Standard](#Standard) | Specificeert de volgorde van voor naar achter pagina's. |
## Methoden
...
Specificeert de volgorde van achter naar voor pagina's.
...
Specificeert de volgorde van voor naar achter pagina's.
