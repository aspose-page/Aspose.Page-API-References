...
description: "Specificeert de schaalverschuiving in de ImageableSizeWidth-richting voor aangepaste schaalvergroting."
type: docs
weight: 122
url: /nl/java/com.aspose.xps.metadata/pagescalingoffsetheight/
---
**Inheritance:**
...
Specificeert de schaalverschuiving in de  ImageableSizeWidth  richting voor aangepaste schaalvergroting. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetheight
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageScalingOffsetHeight(int value)](#PageScalingOffsetHeight-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
