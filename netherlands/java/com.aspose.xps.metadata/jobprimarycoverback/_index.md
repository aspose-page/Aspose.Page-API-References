...
type: docs
weight: 66
url: /nl/java/com.aspose.xps.metadata/jobprimarycoverback/
---
**Inheritance:**
...
Beschrijft het achtereinde (eind) omslagvel. Elke taak krijgt een apart primair vel. Het omslagvel moet worden afgedrukt op de  PageMediaSize  en  PageMediaType  die worden gebruikt voor de laatste pagina van de taak. Het omslagvel moet worden geïntegreerd in verwerkingsopties (zoals  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) zoals aangegeven door de gespecificeerde Option. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverback
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JobPrimaryCoverBack(JobPrimaryCoverBack.CoverBackOption[] options)](#JobPrimaryCoverBack-com.aspose.xps.metadata.JobPrimaryCoverBack.CoverBackOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
