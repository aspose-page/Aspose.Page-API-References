...
description: "Beschrijft de opties van de ErrorSheetWhen‑functie."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Beschrijft de  ErrorSheetWhen  functieopties.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Always](#Always) | Specificeert dat een foutblad wordt uitgegeven voor elke taak. |
| [OnError](#OnError) | Specificeert dat een foutblad alleen bij een fout wordt uitgegeven. |
## Methoden
...
Specificeert dat een foutblad wordt uitgegeven voor elke taak.
...
Specificeert dat een foutblad alleen bij een fout wordt uitgegeven.
