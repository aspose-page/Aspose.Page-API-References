...
type: docs
weight: 79
url: /nl/java/com.aspose.xps.metadata/pageblackgenerationprocessingblackinklimit/
---
**Inheritance:**
...
Applicatie-inhoud gelabeld met de opgegeven naamkleur MOET verschijnen op alle kleurscheidingen. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingblackinklimit
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageBlackGenerationProcessingBlackInkLimit(int value)](#PageBlackGenerationProcessingBlackInkLimit-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
