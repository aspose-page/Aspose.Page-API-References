...
type: docs
weight: 23
url: /nl/java/com.aspose.xps.metadata/documentduplex/
---
**Inheritance:**
...
Beschrijft de duplexkenmerken van de uitvoer. De duplexfunctie maakt afdrukken aan beide zijden van het medium mogelijk. Elk document wordt afzonderlijk gedupliceerd. DocumentDuplex en JobDuplexAllDocumentsContiguously zijn wederzijds exclusief. Het is aan de driver om de afhandelingsbeperkingen tussen deze trefwoorden te bepalen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentduplex
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DocumentDuplex(Duplex.DuplexOption[] options)](#DocumentDuplex-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
