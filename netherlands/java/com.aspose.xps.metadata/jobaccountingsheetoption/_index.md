...
description: "Beschrijft de opties van de JobAccountingSheet-functie."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Beschrijft de  JobAccountingSheet  functieopties.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [None](#None) | Specificeert dat er geen boekhoudblad wordt gegenereerd. |
| [Standard](#Standard) | Specificeert dat het standaard (apparaat‑gedefinieerde) boekhoudblad moet worden gegenereerd. |
## Methoden
...
Specificeert dat er geen boekhoudblad wordt gegenereerd.
...
Specificeert dat het standaard (apparaat‑gedefinieerde) boekhoudblad moet worden gegenereerd.
