...
description: "Specificeert de oorsprong van een watermerk ten opzichte van de oorsprong van de PageImageableSize."
type: docs
weight: 132
url: /nl/java/com.aspose.xps.metadata/pagewatermarkoriginheight/
---
**Inheritance:**
...
Specificeert de oorsprong van een watermerk ten opzichte van de oorsprong van de  PageImageableSize . https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageWatermarkOriginHeight(int value)](#PageWatermarkOriginHeight-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
