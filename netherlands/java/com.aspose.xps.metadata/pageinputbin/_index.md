...
type: docs
weight: 100
url: /nl/java/com.aspose.xps.metadata/pageinputbin/
---
**Inheritance:**
...
Beschrijft de geïnstalleerde invoerbak in een apparaat of de volledige lijst van ondersteunde bakken voor een apparaat. Staat toe om de invoerbak per pagina te specificeren. De trefwoorden  JobInputBin ,  DocumentInputBin  en  PageInputBin  zijn onderling exclusief. Beide mogen niet gelijktijdig worden gespecificeerd in een PrintTicket- of Print Capabilities-document. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageinputbin
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageInputBin(InputBin.IInputBinItem[] items)](#PageInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Maakt een nieuw exemplaar aan. |
## Methoden
