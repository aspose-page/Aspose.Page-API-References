...
description: "Specificeert de dimensie MediaSizeHeight richting voor de aangepaste MediaSize-optie."
type: docs
weight: 104
url: /nl/java/com.aspose.xps.metadata/pagemediasizemediasizewidth/
---
**Inheritance:**
...
Specificeert de dimensie  MediaSizeHeight  richting voor de aangepaste  MediaSize  optie. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
