...
description: "Specificeert de oriëntatie ten opzichte van de feed-orientatierichting https//docs.microsoft.com/en-us/windows/win32rintdocsagemediasizepsorientation"
type: docs
weight: 107
url: /nl/java/com.aspose.xps.metadata/pagemediasizepsorientation/
---
**Inheritance:**
...
Specificeert de oriëntatie ten opzichte van de feed-orientatierichting https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsorientation
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PageMediaSizePSOrientation(int value)](#PageMediaSizePSOrientation-int-) | Maakt een nieuw exemplaar aan. |
## Methoden
