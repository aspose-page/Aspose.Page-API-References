...
type: docs
weight: 35
url: /nl/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
Beschrijft de stapelkenmerken van de uitvoer. Elk document wordt afzonderlijk gestapeld. De  JobStapleAllDocuments  en  DocumentStaple  trefwoorden zijn wederzijds exclusief. Het is aan de driver om de afhandeling van beperkingen tussen deze trefwoorden te bepalen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | Maakt een nieuw exemplaar aan. |
## Methoden
