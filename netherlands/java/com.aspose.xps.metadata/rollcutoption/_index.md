...
description: "Beschrijft de opties voor de functies JobRollCutAtEndOfJob en DocumentRollCut."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Beschrijft de  JobRollCutAtEndOfJob  en  DocumentRollCut  functie-opties.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Banner](#Banner) | Specificeert de snijmethode voor banner ( alleen DocumentRollCut ). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Specificeert snijden aan de rand van de afbeelding. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Specificeert snijden voor standaardmediaspecificatie. |
| [None](#None) | Specificeert geen taak‑snijbeurt. |
## Methoden
...
Specificeert de snijmethode voor banner ( alleen DocumentRollCut ).
...
Specificeert snijden aan de rand van de afbeelding.
...
Specificeert snijden voor standaardmediaspecificatie.
...
Specificeert geen taak‑snijbeurt.
