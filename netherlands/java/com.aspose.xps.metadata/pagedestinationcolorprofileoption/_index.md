...
description: "Beschrijft de functie‑opties van PageDestinationColorProfile."
type: docs
weight: 10
url: /nl/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Beschrijft de opties voor de functie  PageDestinationColorProfile .
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Application](#Application) | Applicatie specificeert het te gebruiken bestemmingsprofiel. |
| [DriverConfiguration](#DriverConfiguration) | Bestemmingsprofiel gebruikt om kleurbeheer uit te voeren. |
## Methoden
...
Applicatie specificeert het te gebruiken bestemmingsprofiel.
...
Bestemmingsprofiel gebruikt om kleurbeheer uit te voeren.
