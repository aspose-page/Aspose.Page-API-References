...
description: "Stelt het resultaat van een bewerking voor in de vorm van een byte-array."
type: docs
weight: 11
url: /nl/java/com.aspose.page.plugins/bytearrayresult/
---
**Inheritance:**
java.lang.Object
...
Stelt het resultaat van een bewerking voor in de vorm van een byte-array.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ByteArrayResult(byte[][] data)](#ByteArrayResult-byte-----) | Initialiseert een nieuw exemplaar met de byte-array. |
## Methoden
...
Initialiseert een nieuw exemplaar met de byte-array.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| gegevens | byte[][] | Array van byte-arrays. Het wordt gebruikt voor de conversie van een document naar een afbeelding. Eén byte-array bevat de bytes van een pagina-afbeelding. |
