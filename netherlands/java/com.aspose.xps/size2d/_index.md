...
description: "De Size2D-klasse beschrijft afmetingen w x h."
type: docs
weight: 12
url: /nl/java/com.aspose.xps/size2d/
---
**Inheritance:**
...
De `Size2D`-klasse beschrijft afmetingen (b x h).

Deze klasse is alleen de abstracte superklasse voor alle objecten die 2D-afmetingen opslaan. De feitelijke opslagrepresentatie van de afmetingen wordt overgelaten aan de subklasse.
## Constructors
