...
description: "Klasse die de kenmerken van het PolyBezierSegment-element omvat."
type: docs
weight: 45
url: /nl/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
Klasse die de kenmerken van het PolyBezierSegment-element incapsuleert. Dit element beschrijft een set van kubieke B?zier-curven.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [deepClone()](#deepClone--) | Kloont deze set van kubieke B?zier-curven. |
...
Kloont deze set van kubieke B?zier-curven.
