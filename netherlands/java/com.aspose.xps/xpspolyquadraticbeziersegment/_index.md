...
description: "Klasse die de kenmerken van het PolyQuadraticBezierSegment-element omvat."
type: docs
weight: 47
url: /nl/java/com.aspose.xps/xpspolyquadraticbeziersegment/
---
**Inheritance:**
...
Klasse die de eigenschappen van het PolyQuadraticBezierSegment-element omvat. Dit element beschrijft een reeks kwadratische Bézier‑curves vanaf het vorige punt in de padfiguur via een reeks vertices, met behulp van opgegeven controlepunten.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [deepClone()](#deepClone--) | Kloont deze reeks kwadratische Bézier‑curves. |
...
Kloont deze reeks kwadratische Bézier‑curves.
