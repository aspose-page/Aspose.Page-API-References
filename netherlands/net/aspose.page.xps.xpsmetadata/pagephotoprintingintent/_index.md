...
| Naam | Beschrijving |
| --- | --- |
| [PagePhotoPrintingIntent](pagephotoprintingintent/)(params PagePhotoPrintingIntentOption[]) | Maakt een nieuwe instantie aan. |
...
| Naam | Beschrijving |
| --- | --- |
| class [PagePhotoPrintingIntentOption](pagephotoprintingintent.pagephotoprintingintentoption/) | Definieert`PagePhotoPrintingIntent` functie-opties. |
