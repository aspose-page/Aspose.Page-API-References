...
Beschrijft het achterblad (eindblad). Elk document heeft een apart vel. Het voorblad moet worden afgedrukt op de[`PageMediaSize`](../pagemediasize/) En[`PageMediaType`](../pagemediatype/) gebruikt voor de laatste pagina van het document. Het voorblad moet worden geïntegreerd in processing options (zoals[`DocumentDuplex`](../documentduplex/) ,[`DocumentNUp`](../documentnup/) ) zoals aangegeven door de opgegeven optie. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
...
| Naam | Beschrijving |
| --- | --- |
| [DocumentCoverBack](documentcoverback/)(params CoverBackOption[]) | Maakt een nieuwe instantie aan. |
...
| Naam | Beschrijving |
| --- | --- |
| class [CoverBackOption](documentcoverback.coverbackoption/) | Beschrijft de`DocumentCoverBack` functie-opties. |
