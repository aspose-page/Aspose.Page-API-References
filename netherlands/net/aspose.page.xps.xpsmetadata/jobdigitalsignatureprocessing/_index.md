...
Beschrijft het configureren van de verwerking van digitale handtekeningen voor de volledige taak. Alleen van toepassing op inhoud die digitale handtekeningen bevat. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdigitalsignatureprocessing
...
| Naam | Beschrijving |
| --- | --- |
| [JobDigitalSignatureProcessing](jobdigitalsignatureprocessing/)(params JobDigitalSignatureProcessingOption[]) | Maakt een nieuwe instantie aan. |
...
| Naam | Beschrijving |
| --- | --- |
| class [JobDigitalSignatureProcessingOption](jobdigitalsignatureprocessing.jobdigitalsignatureprocessingoption/) | Beschrijft de`JobDigitalSignatureProcessing` functie-opties. |
