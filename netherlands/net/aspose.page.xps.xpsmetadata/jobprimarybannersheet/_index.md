...
| Naam | Beschrijving |
| --- | --- |
| [JobPrimaryBannerSheet](jobprimarybannersheet/)(params BannerSheetOption[]) | Maakt een nieuwe instantie aan. |
...
| Naam | Beschrijving |
| --- | --- |
| class [BannerSheetOption](jobprimarybannersheet.bannersheetoption/) | Vertegenwoordigt opties van de`JobPrimaryBannerSheet` functie. |
