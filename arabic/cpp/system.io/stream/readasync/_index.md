...
description: "طريقة System::IO::Stream::ReadAsync. تقرأ بشكل غير متزامن تسلسلًا من البايتات من التدفق الحالي، وتُحرك الموضع داخل التدفق بعدد البايتات المقروءة، وتراقب طلبات الإلغاء في C++."
type: docs
weight: 1900
