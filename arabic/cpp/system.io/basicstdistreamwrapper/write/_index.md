...
description: "طريقة System::IO::BasicSTDIStreamWrapper::Write. إذا كان وضع التغليف ثنائيًا، يكتب إلى الدفق النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة، وإلا يحول النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة إلى النوع char_type ثم يكتب النتيجة إلى الدفق. غير مدعوم! في C++."
type: docs
weight: 700
...
إذا كان وضع التغليف ثنائيًا، يكتب إلى الدفق النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة، وإلا يحول النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة إلى النوع [char_type](../char_type/) ثم يكتب النتيجة إلى الدفق. غير مدعوم!
