---
title: "طريقة System::IO::BasicSTDOStreamWrapper::Write"
linktitle: "Write"
second_title: "Aspose.Page لـ C++"
description: "طريقة System::IO::BasicSTDOStreamWrapper::Write. إذا كان وضع التغليف ثنائيًا، يكتب إلى الدفق النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة، وإلا يحول النطاق الفرعي المحدد من البايتات من المصفوفة البايتية المحددة إلى نوع char_type ثم يكتب النتيجة إلى الدفق في C++."
type: docs
weight: 700
