---
title: "System::Drawing::ImageFormatConverter::ConvertTo طريقة"
linktitle: "ConvertTo"
second_title: "Aspose.Page لـ C++"
description: "System::Drawing::ImageFormatConverter::ConvertTo طريقة. يحول الكائن إلى نوع محدد في C++."
type: docs
weight: 300
url: /ar/cpp/system.drawing/imageformatconverter/convertto/
---
...
| --- | --- | --- |
| context | const SharedPtr\<ComponentModel::ITypeDescriptorContext\>\& | [Object](../../../system/object/) معلومات سياق التحويل. |
| الثقافة | const SharedPtr\<Globalization::CultureInfo\>\& | الثقافة المستخدمة عند تحويل الكائنات. |
| value | const SharedPtr\<Object\>\& | [Object](../../../system/object/) للتحويل. |
| destinationType | const TypeInfo\& | النوع للتحويل إليه. |
