...
description: "System::Globalization::GregorianCalendar class. تقويم غريغوري. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تقم بإنشاء مثال من هذا النوع على المكدس أو باستخدام المشغل new، لأن ذلك سيؤدي إلى أخطاء وقت التشغيل أو أخطاء تأكيد. احرص دائمًا على تغليف هذه الفئة في مؤشر System::SmartPtr واستخدام هذا المؤشر لتمريره إلى الدوال كمعامل في C++."
type: docs
weight: 1000
...
تقويم غريغوري. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تقم بإنشاء مثال من هذا النوع على المكدس أو باستخدام المشغل new، لأن ذلك سيؤدي إلى أخطاء وقت التشغيل أو أخطاء تأكيد. احرص دائمًا على تغليف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدام هذا المؤشر لتمريره إلى الدوال كمعامل.
...
| virtual [get_CalendarType](./get_calendartype/)() const | يحصل على نوع تقويم غريغوري. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | يحصل على نسخة تقويم غريغوري الافتراضية. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | ينشئ تقويم غريغوري محدد. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | يضبط نوع تقويم غريغوري. |
