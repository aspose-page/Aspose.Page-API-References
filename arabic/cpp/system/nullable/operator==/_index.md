...
description: "System::Nullable::operator== method. يحدد ما إذا كانت القيمة التي يمثلها الكائن الحالي مساوية للقيمة التي يمثلها كائن Nullable المحدد في C++."
type: docs
weight: 1900
...
يحدد ما إذا كانت القيمة التي يمثلها الكائن الحالي فارغة (null).
