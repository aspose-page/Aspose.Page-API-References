...
description: "طريقة System::setter_post_decrement_wrap. يترجم المترجم تعبيرات ما بعد‑الإنقاص في C# التي تستهدف خاصية الكائن التي لديها setter و getter معرفة، إلى استدعاء هذه الدالة (إفراط للـ const getter) في C++."
type: docs
weight: 37600
...
يترجم المترجم تعبيرات ما بعد‑الإنقاص في C# التي تستهدف خاصية الكائن التي لديها setter و getter معرفة، إلى استدعاء هذه الدالة (إفراط للـ const getter).
...
يترجم المترجم تعبيرات ما بعد‑الإنقاص في C# التي تستهدف خاصية الكائن التي لديها setter و getter معرفة، إلى استدعاء هذه الدالة (إفراط للـ non‑const getter).
...
يترجم المترجم تعبيرات ما بعد‑الإنقاص في C# التي تستهدف خاصية الصنف التي لديها setter و getter معرفة، إلى استدعاء هذه الدالة.
