...
description: "فئة لخيارات حفظ XPS كـ BMP."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.rendering/bmpsaveoptions/
---
**Inheritance:**
...
فئة لخيارات حفظ XPS كـ BMP.
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [BmpSaveOptions()](#BmpSaveOptions--) | ينشئ مثلاً جديداً من الخيارات. |
## الطرق
