...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(Device device, SaveOptions options)](#save-com.aspose.page.Device-com.aspose.page.SaveOptions-) | يحفظ هذا المستند إلى جهاز. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يحفظ هذا المستند إلى جهاز.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| device | [Device](../../com.aspose.page/device) | جهاز إخراج. |
| options | [SaveOptions](../../com.aspose.page/saveoptions) | خيار. |
