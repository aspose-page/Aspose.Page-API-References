...
description: "يصف خيارات ميزات DocumentCollate و JobCollateAllDocuments."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/collate.collateoption/
---
**Inheritance:**
...
يصف خيارات ميزات DocumentCollate و JobCollateAllDocuments.
## الحقول

| حقل | الوصف |
| --- | --- |
| [Collated](#Collated) | يحدد التجميع. |
| [Uncollated](#Uncollated) | يحدد عدم التجميع. |
## الطرق
