...
description: "يصف خيارات الميزة PageICMRenderingIntent."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/pageicmrenderingintent.pageicmrenderingintentoption/
---
**Inheritance:**
...
يصف خيارات ميزة  PageICMRenderingIntent .
## الحقول

| حقل | الوصف |
| --- | --- |
| [AbsoluteColorimetric](#AbsoluteColorimetric) | نية العرض اللوني المطلق. |
| [BusinessGraphics](#BusinessGraphics) | نية عرض الرسومات التجارية. |
| [Photographs](#Photographs) | نية عرض الصور. |
| [RelativeColorimetric](#RelativeColorimetric) | نية العرض اللوني النسبي. |
## الطرق
