...
description: "يصف النقطة في نطاق الإضاءة إلى الظل حيث يجب أن يبدأ GCR عند أكثر الظلال سوادًا بنسبة 100%."
type: docs
weight: 82
...
| منشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | ينشئ نسخة جديدة. |
## الطرق
