...
description: "يصف النقطة في نطاق الإضاءة إلى الظل حيث يجب أن يبدأ GCR بأكثر الظلال سوادًا بنسبة 100٪."
type: docs
weight: 82
url: /ar/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementstart/
---
**Inheritance:**
...
يصف النقطة في نطاق "الإضاءة إلى الظل" حيث يجب أن يبدأ GCR (أكثر الظلال سوادًا بنسبة 100٪). https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
