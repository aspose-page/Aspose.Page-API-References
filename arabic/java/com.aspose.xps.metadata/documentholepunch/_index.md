...
type: docs
weight: 24
url: /ar/java/com.aspose.xps.metadata/documentholepunch/
---
**Inheritance:**
...
يصف خصائص ثقب الإخراج. يتم ثقب كل مستند على حدة. كلمات المفتاح JobHolePunch و DocumentHolePunch متعارضة. لا يجب تحديدهما معًا في مستند PrintTicket أو مستند قدرات الطباعة. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [DocumentHolePunch(HolePunch.HolePunchOption[] options)](#DocumentHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | ينشئ نسخة جديدة. |
## الطرق
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| options | [HolePunchOption\[\]](../../com.aspose.xps.metadata/holepunchoption) | مصفوفة من الخيارات الخاصة بالميزة. |
