...
يصف خصائص ثقب الإخراج. يتم ثقب كل مستند بشكل منفصل. الكلمات المفتاحية  JobHolePunch  و  DocumentHolePunch  متعارضة. لا ينبغي تحديدهما معًا في مستند PrintTicket أو مستند إمكانيات الطباعة. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [DocumentHolePunch(HolePunch.HolePunchOption[] options)](#DocumentHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | ينشئ مثيلًا جديدًا. |
## الطرق
