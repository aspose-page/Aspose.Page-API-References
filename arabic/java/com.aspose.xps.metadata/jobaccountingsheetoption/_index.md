...
description: "يصف خيارات الميزة JobAccountingSheet."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
يصف خيارات الميزة JobAccountingSheet.
## الحقول

| حقل | الوصف |
| --- | --- |
| [None](#None) | يحدد عدم إخراج ورقة محاسبة. |
| [Standard](#Standard) | يحدد أنه يجب إخراج ورقة المحاسبة القياسية (المحددة من الجهاز). |
## الطرق
...
يحدد أنه يجب إخراج ورقة المحاسبة القياسية (المحددة من الجهاز).
