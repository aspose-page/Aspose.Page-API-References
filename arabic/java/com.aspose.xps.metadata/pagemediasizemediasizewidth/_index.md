...
description: "يحدد اتجاه البُعد MediaSizeHeight لخيار MediaSize المخصص."
type: docs
weight: 104
url: /ar/java/com.aspose.xps.metadata/pagemediasizemediasizewidth/
---
**Inheritance:**
...
يحدد اتجاه البُعد MediaSizeHeight لخيار MediaSize المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | ينشئ نسخة جديدة. |
## الطرق
