...
description: "يحدد بعد اتجاه MediaSizeHeight لخيار Custom MediaSize."
type: docs
weight: 104
...
يحدد بعد اتجاه MediaSizeHeight لخيار Custom MediaSize. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
