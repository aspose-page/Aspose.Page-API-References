...
description: "يصف مستوى الظل الذي أدناه سيتم تطبيق UCA."
type: docs
weight: 85
url: /ar/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionstart/
---
**Inheritance:**
...
يصف مستوى الظل الذي أدناه سيتم تطبيق UCA. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionstart
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionStart(int value)](#PageBlackGenerationProcessingUnderColorAdditionStart-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
