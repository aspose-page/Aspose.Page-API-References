...
description: "يصف خيارات ميزة الطبقات."
type: docs
weight: 11
url: /ar/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
يصف خيارات ميزة  Layering .
## الحقول

| حقل | الوصف |
| --- | --- |
| [Overlay](#Overlay) | تظهر العلامة المائية فوق محتوى الصفحة. |
| [Underlay](#Underlay) | تظهر العلامة المائية تحت محتوى الصفحة. |
## الطرق
