...
description: "يحدد خيارات ميزة PageMirrorImage."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/pagemirrorimage.pagemirrorimageoption/
---
**Inheritance:**
...
يعرّف خيارات ميزة PageMirrorImage.
## الحقول

| حقل | الوصف |
| --- | --- |
| [MirrorImageHeight](#MirrorImageHeight) | يحدد أن الإخراج يجب أن يُعكس موازياً لاتجاه MediaSizeHeight. |
| [MirrorImageWidth](#MirrorImageWidth) | يحدد أن الإخراج يجب أن يُعكس موازياً لاتجاه MediaSizeWidth. |
| [None](#None) | يحدد أن الإخراج لا يجب أن يُعكس. |
## الطرق
...
يحدد أن الإخراج يجب أن يُعكس موازياً لاتجاه MediaSizeHeight.
...
يحدد أن الإخراج يجب أن يُعكس موازياً لاتجاه MediaSizeWidth.
...
يحدد أن الإخراج لا يجب أن يُعكس.
