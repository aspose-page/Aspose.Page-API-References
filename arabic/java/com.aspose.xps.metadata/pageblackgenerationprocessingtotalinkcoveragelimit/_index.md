...
description: "يحدد الحد الأقصى المسموح لمجموع تغطية الحبر الأربعة في أي مكان داخل الصورة."
type: docs
weight: 83
url: /ar/java/com.aspose.xps.metadata/pageblackgenerationprocessingtotalinkcoveragelimit/
---
**Inheritance:**
...
يحدد الحد الأقصى المسموح به لمجموع تغطية الحبر الأربعة في أي مكان داخل الصورة. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingtotalinkcoveragelimit
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingTotalInkCoverageLimit(int value)](#PageBlackGenerationProcessingTotalInkCoverageLimit-int-) | ينشئ نسخة جديدة. |
## الطرق
