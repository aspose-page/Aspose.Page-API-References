...
description: "يحدد ارتفاع الصفحة المتوازي مع اتجاه التغذية."
type: docs
weight: 105
url: /ar/java/com.aspose.xps.metadata/pagemediasizepsheight/
---
**Inheritance:**
...
يحدد ارتفاع الصفحة، المتوازي مع اتجاه التغذية. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
