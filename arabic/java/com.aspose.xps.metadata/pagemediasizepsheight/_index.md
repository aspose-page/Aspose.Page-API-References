...
description: "يحدد ارتفاع الصفحة موازٍ لاتجاه تغذية الورق."
type: docs
weight: 105
...
يحدد ارتفاع الصفحة، موازٍ لاتجاه تغذية الورق. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | ينشئ نسخة جديدة. |
## الطرق
