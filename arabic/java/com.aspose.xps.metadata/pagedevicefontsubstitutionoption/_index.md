...
description: "يصف خيارات ميزة PageDeviceFontSubstitution."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
يصف خيارات ميزة  PageDeviceFontSubstitution .
## الحقول

| حقل | الوصف |
| --- | --- |
| [Off](#Off) | استبدال خط جهاز الصفحة معطل. |
| [On](#On) | استبدال خط جهاز الصفحة مفعّل. |
## الطرق
