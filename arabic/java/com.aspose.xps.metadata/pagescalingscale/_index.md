...
description: "يحدد معامل التحجيم لتقويم مربع مخصص."
type: docs
weight: 124
...
يحدد عامل التحجيم للتكبير المربع المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscale
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageScalingScale(int value)](#PageScalingScale-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
