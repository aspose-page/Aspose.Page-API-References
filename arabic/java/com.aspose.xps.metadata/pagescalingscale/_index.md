...
description: "يحدد عامل التحجيم للتقويم المربع المخصص."
type: docs
weight: 124
url: /ar/java/com.aspose.xps.metadata/pagescalingscale/
---
**Inheritance:**
...
يحدد عامل التحجيم لتقنية التحجيم المربعة المخصصة. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscale
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageScalingScale(int value)](#PageScalingScale-int-) | ينشئ نسخة جديدة. |
## الطرق
