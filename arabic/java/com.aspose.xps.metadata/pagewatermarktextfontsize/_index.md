...
description: "يحدد أحجام الخط المتاحة لنص العلامة المائية."
type: docs
weight: 136
url: /ar/java/com.aspose.xps.metadata/pagewatermarktextfontsize/
---
**Inheritance:**
...
يحدد أحجام الخط المتاحة لنص العلامة المائية. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextfontsize
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageWatermarkTextFontSize(int value)](#PageWatermarkTextFontSize-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
