...
description: "يصف خيارات ميزة DocumentSeparatorSheet."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/documentseparatorsheet.documentseparatorsheetoption/
---
**Inheritance:**
...
يصف خيارات ميزة  DocumentSeparatorSheet  .
## الحقول

| حقل | الوصف |
| --- | --- |
| [BothSheets](#BothSheets) | يحدد وجود ورقة فاصل في بداية ونهاية المستند. |
| [EndSheet](#EndSheet) | يحدد وجود ورقة فاصل في نهاية المستند. |
| [None](#None) | يحدد عدم وجود أي ورقة فاصل. |
| [StartSheet](#StartSheet) | يحدد وجود ورقة فاصل في بداية المستند. |
## الطرق
...
يحدد وجود ورقة فاصل في بداية ونهاية المستند.
...
يحدد وجود ورقة فاصل في نهاية المستند.
...
يحدد وجود ورقة فاصل في بداية المستند.
