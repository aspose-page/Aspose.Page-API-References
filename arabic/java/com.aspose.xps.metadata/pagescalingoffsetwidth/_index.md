...
يحدد إزاحة القياس في اتجاه ImageableSizeWidth للتوسيع المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetwidth
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageScalingOffsetWidth(int value)](#PageScalingOffsetWidth-int-) | ينشئ نسخة جديدة. |
## الطرق
