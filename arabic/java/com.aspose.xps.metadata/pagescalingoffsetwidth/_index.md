...
type: docs
weight: 123
url: /ar/java/com.aspose.xps.metadata/pagescalingoffsetwidth/
---
**Inheritance:**
...
يحدد إزاحة التحجيم في اتجاه ImageableSizeWidth لتخصيص التحجيم. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetwidth
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageScalingOffsetWidth(int value)](#PageScalingOffsetWidth-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
