...
description: "يصف خيارات ميزة PageDestinationColorProfile."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
يصف خيارات ميزة  PageDestinationColorProfile .
## الحقول

| حقل | الوصف |
| --- | --- |
| [Application](#Application) | التطبيق يحدد ملف التعريف الوجهة الذي سيُستخدم. |
| [DriverConfiguration](#DriverConfiguration) | ملف التعريف الوجهة المستخدم لإجراء إدارة الألوان. |
## الطرق
...
التطبيق يحدد ملف التعريف الوجهة الذي سيُستخدم.
...
ملف التعريف الوجهة المستخدم لإجراء إدارة الألوان.
