...
type: docs
weight: 27
url: /ar/java/com.aspose.xps.metadata/documentinputbin/
---
**Inheritance:**
...
يصف صينية الإدخال المثبتة في الجهاز أو القائمة الكاملة للصناديق المدعومة للجهاز. الكلمات المفتاحية  JobInputBin ,  DocumentInputBin , و  PageInputBin  متعارضة ولا يمكن استخدامها معًا. لا ينبغي تحديد كلاهما في نفس الوقت في مستند PrintTicket أو مستند إمكانيات الطباعة. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentinputbin
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [DocumentInputBin(InputBin.IInputBinItem[] items)](#DocumentInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | ينشئ نسخة جديدة. |
## الطرق
