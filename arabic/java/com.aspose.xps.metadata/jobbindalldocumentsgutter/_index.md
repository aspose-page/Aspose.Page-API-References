...
description: "يحدد عرض تجويف التجليد."
type: docs
weight: 46
url: /ar/java/com.aspose.xps.metadata/jobbindalldocumentsgutter/
---
**Inheritance:**
...
يحدد عرض الفتحة الخاصة بالربط. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocumentsgutter
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [JobBindAllDocumentsGutter(int value)](#JobBindAllDocumentsGutter-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
