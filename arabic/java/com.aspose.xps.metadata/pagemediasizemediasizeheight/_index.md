...
description: "يحدد بُعد اتجاه MediaSizeWidth لخيار MediaSize المخصص."
type: docs
weight: 103
...
يحدد بُعد اتجاه MediaSizeWidth لخيار MediaSize المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizeheight
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageMediaSizeMediaSizeHeight(int value)](#PageMediaSizeMediaSizeHeight-int-) | ينشئ نسخة جديدة. |
## الطرق
