...
description: "يحدد بُعد اتجاه MediaSizeWidth لخيار Custom MediaSize."
type: docs
weight: 103
url: /ar/java/com.aspose.xps.metadata/pagemediasizemediasizeheight/
---
**Inheritance:**
...
يحدد بُعد اتجاه  MediaSizeWidth  لخيار  Custom  MediaSize. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizeheight
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageMediaSizeMediaSizeHeight(int value)](#PageMediaSizeMediaSizeHeight-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
