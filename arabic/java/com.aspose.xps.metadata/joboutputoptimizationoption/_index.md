...
description: "يصف خيارات ميزة JobOutputOptimization."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/joboutputoptimization.joboutputoptimizationoption/
---
**Inheritance:**
...
يصف خيارات ميزة JobOutputOptimization.
## الحقول

| حقل | الوصف |
| --- | --- |
| [ArchiveFormat](#ArchiveFormat) | يحدد أن معالجة الوظيفة يجب أن تُحسّن لإخراج الأرشيف. |
| [None](#None) | يحدد أن معالجة الوظيفة لا يجب أن تُحسّن لسيناريو معين. |
| [OptimizeForPortability](#OptimizeForPortability) | يحدد أن معالجة الوظيفة يجب أن تُحسّن لقابلية النقل (عبر الأجهزة) للإخراج. |
| [OptimizeForQuality](#OptimizeForQuality) | يحدد أن معالجة الوظيفة يجب أن تُحسّن لجودة الإخراج. |
| [OptimizeForSpeed](#OptimizeForSpeed) | يحدد أن معالجة الوظيفة يجب أن تُحسّن لسرعة الإخراج. |
## الطرق
...
يحدد أن معالجة الوظيفة يجب أن تُحسّن لإخراج الأرشيف.
...
يحدد أن معالجة الوظيفة لا يجب أن تُحسّن لسيناريو معين.
...
يحدد أن معالجة الوظيفة يجب أن تُحسّن لقابلية النقل (عبر الأجهزة) للإخراج.
...
يحدد أن معالجة الوظيفة يجب أن تُحسّن لجودة الإخراج.
...
يحدد أن معالجة الوظيفة يجب أن تُحسّن لسرعة الإخراج.
