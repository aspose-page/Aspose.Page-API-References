...
description: "يحدد عدد النسخ من الصفحة."
type: docs
weight: 90
url: /ar/java/com.aspose.xps.metadata/pagecopies/
---
**Inheritance:**
...
يحدد عدد النسخ من الصفحة. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagecopies
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageCopies(int value)](#PageCopies-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
