...
description: "يحدد عامل التحجيم في اتجاه ImageableSizeWidth للتقويم المخصص."
type: docs
weight: 126
url: /ar/java/com.aspose.xps.metadata/pagescalingscalewidth/
---
**Inheritance:**
...
يحدد عامل التحجيم في اتجاه ImageableSizeWidth للتقويم المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageScalingScaleWidth(int value)](#PageScalingScaleWidth-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
