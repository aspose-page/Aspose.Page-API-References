...
description: "يصف خيارات ميزة JobPageOrder."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
يصف خيارات ميزة JobPageOrder.
## الحقول

| حقل | الوصف |
| --- | --- |
| [Reverse](#Reverse) | يحدد ترتيب الصفحات من الخلف إلى الأمام. |
| [Standard](#Standard) | يحدد ترتيب الصفحات من الأمام إلى الخلف. |
## الطرق
...
يحدد ترتيب الصفحات من الخلف إلى الأمام.
