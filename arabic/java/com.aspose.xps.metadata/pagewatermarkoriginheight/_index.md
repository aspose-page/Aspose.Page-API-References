...
type: docs
weight: 132
url: /ar/java/com.aspose.xps.metadata/pagewatermarkoriginheight/
---
**Inheritance:**
...
يحدد أصل العلامة المائية بالنسبة إلى أصل PageImageableSize. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageWatermarkOriginHeight(int value)](#PageWatermarkOriginHeight-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
