...
description: "يحدد عامل التحجيم في اتجاه ImageableSizeHeight للتقويم المخصص."
type: docs
weight: 125
url: /ar/java/com.aspose.xps.metadata/pagescalingscaleheight/
---
**Inheritance:**
...
يحدد عامل التحجيم في اتجاه  ImageableSizeHeight  للتقويم المخصص. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageScalingScaleHeight(int value)](#PageScalingScaleHeight-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
