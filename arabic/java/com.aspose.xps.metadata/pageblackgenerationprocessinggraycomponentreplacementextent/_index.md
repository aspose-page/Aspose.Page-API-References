...
description: "يصف الامتداد إلى ما بعد الألوان المحايدة إلى الألوان الصبغية الذي يطبقه GCR. 0 استبدال مكوّن موحد 100 استبدال مكوّن رمادي."
type: docs
weight: 80
...
يصف الامتداد إلى ما بعد الألوان المحايدة (إلى الألوان الصبغية) الذي يطبقه GCR. 0% = استبدال مكوّن موحد، 100% = استبدال مكوّن رمادي. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementextent
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementExtent(int value)](#PageBlackGenerationProcessingGrayComponentReplacementExtent-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
