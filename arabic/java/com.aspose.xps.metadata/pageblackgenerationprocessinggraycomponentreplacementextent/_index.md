...
description: "يصف الامتداد إلى ما وراء الألوان المحايدة إلى الألوان الصبغية الذي يطبقه GCR. 0 استبدال مكوّن موحد 100 استبدال المكوّن الرمادي."
type: docs
weight: 80
url: /ar/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementextent/
---
**Inheritance:**
...
يصف الامتداد إلى ما وراء الألوان المحايدة (إلى الألوان الصبغية) الذي يطبقه GCR. 0% = استبدال مكوّن موحد، 100% = استبدال المكوّن الرمادي. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementextent
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementExtent(int value)](#PageBlackGenerationProcessingGrayComponentReplacementExtent-int-) | ينشئ نسخة جديدة. |
## الطرق
