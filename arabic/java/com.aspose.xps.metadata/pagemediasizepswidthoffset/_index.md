...
description: "يحدد الإزاحة عموديًا على اتجاه تغذية التوجيه."
type: docs
weight: 109
url: /ar/java/com.aspose.xps.metadata/pagemediasizepswidthoffset/
---
**Inheritance:**
...
يحدد الإزاحة المتعامدة مع اتجاه تغذية الورق. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidthoffset
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageMediaSizePSWidthOffset(int value)](#PageMediaSizePSWidthOffset-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
