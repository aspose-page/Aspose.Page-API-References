...
description: "يحدد الإزاحة المتوازية مع اتجاه تغذية الورق."
type: docs
weight: 106
url: /ar/java/com.aspose.xps.metadata/pagemediasizepsheightoffset/
---
**Inheritance:**
...
يحدد الإزاحة، المتوازية مع اتجاه تغذية الورق. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheightoffset
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageMediaSizePSHeightOffset(int value)](#PageMediaSizePSHeightOffset-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
