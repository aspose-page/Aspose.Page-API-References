...
description: "يصف خيارات ميزة ErrorSheetWhen."
type: docs
weight: 10
url: /ar/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
يصف خيارات الميزة ErrorSheetWhen.
## الحقول

| حقل | الوصف |
| --- | --- |
| [Always](#Always) | يحدد أنه سيتم إخراج ورقة خطأ لكل وظيفة. |
| [OnError](#OnError) | يحدد أنه سيتم إخراج ورقة خطأ فقط عند حدوث خطأ. |
## الطرق
...
يحدد أنه سيتم إخراج ورقة خطأ لكل وظيفة.
...
يحدد أنه سيتم إخراج ورقة خطأ فقط عند حدوث خطأ.
