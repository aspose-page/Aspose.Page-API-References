...
description: "الفئة الأساسية لفئات ميزات JobStapleAllDocuments و DocumentStaple."
type: docs
weight: 148
url: /ar/java/com.aspose.xps.metadata/staple/
---
**Inheritance:**
...
الفئة الأساسية لفئات ميزات **JobStapleAllDocuments** و **DocumentStaple**.
## الطرق
