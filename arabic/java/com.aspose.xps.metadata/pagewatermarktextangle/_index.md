...
description: "يحدد زاوية نص العلامة المائية بالنسبة لاتجاه PageImageableSizeWidth."
type: docs
weight: 134
...
يحدد زاوية نص العلامة المائية بالنسبة لاتجاه PageImageableSizeWidth. الزاوية تُقاس في الاتجاه العكسي لعقارب الساعة. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
## المنشئات

| منشئ | الوصف |
| --- | --- |
| [PageWatermarkTextAngle(int value)](#PageWatermarkTextAngle-int-) | ينشئ نسخة جديدة. |
## الطرق
