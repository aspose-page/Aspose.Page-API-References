...
description: "يحدد زاوية نص العلامة المائية بالنسبة إلى اتجاه PageImageableSizeWidth."
type: docs
weight: 134
url: /ar/java/com.aspose.xps.metadata/pagewatermarktextangle/
---
**Inheritance:**
...
يحدد زاوية نص العلامة المائية بالنسبة إلى اتجاه PageImageableSizeWidth. تُقاس الزاوية في الاتجاه العكسي لعقارب الساعة. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PageWatermarkTextAngle(int value)](#PageWatermarkTextAngle-int-) | ينشئ مثيلًا جديدًا. |
## الطرق
