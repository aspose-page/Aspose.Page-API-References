...
| حقل | الوصف |
| --- | --- |
| [FitToBox](#FitToBox) | الصورة تتناسب مع الصندوق. |
| [FitToHeight](#FitToHeight) | الصورة تتناسب مع الارتفاع. |
| [FitToWidth](#FitToWidth) | الصورة تتناسب مع العرض. |
## الطرق
