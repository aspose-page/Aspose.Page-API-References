...
description: "فئة تُغلف ميزات عنصر ArcSegment."
type: docs
weight: 13
...
فئة تُغلف ميزات عنصر ArcSegment. يصف هذا العنصر قوسًا إهليلجيًا.
## الطرق
...
| [getRotationAngle()](#getRotationAngle--) | يعيد القيمة التي تشير إلى كيفية دوران الإهليلج بالنسبة لنظام الإحداثيات الحالي. |
...
| [hashCode()](#hashCode--) |  |
| [isLargeArc()](#isLargeArc--) | يعيد القيمة التي تحدد ما إذا كان القوس يُرسم بزاوية انقضاء 180 درجة أو أكثر. |
...
| [setPoint(Point2D value)](#setPoint-java.awt.geom.Point2D-) | يضبط نقطة النهاية للقوس البيضاوي. |
| [setRotationAngle(float value)](#setRotationAngle-float-) | يضبط القيمة التي تشير إلى كيفية دوران الشكل البيضاوي بالنسبة لنظام الإحداثيات الحالي. |
| [setSize(Dimension2D value)](#setSize-java.awt.geom.Dimension2D-) | يضبط نصفَي x و y للقوس البيضاوي كزوج x,y. |
...
**Returns:**
java.awt.geom.Point2D - نقطة النهاية للقوس البيضاوي.
...
يعيد القيمة التي تشير إلى كيفية دوران الإهليلج بالنسبة لنظام الإحداثيات الحالي.

**Returns:**
float - القيمة التي تشير إلى كيفية دوران الشكل البيضاوي بالنسبة لنظام الإحداثيات الحالي.
### getSize() {#getSize--}
```
...
**Returns:**
java.awt.geom.Dimension2D - نصفَي x و y للقوس البيضاوي كزوج x,y.
...
يعيد القيمة التي تحدد ما إذا كان القوس يُرسم بزاوية انقضاء 180 درجة أو أكثر.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | boolean | القيمة التي تحدد ما إذا كان القوس يُرسم بزاوية 180 درجة أو أكثر. |
...
يضبط نقطة النهاية للقوس البيضاوي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | java.awt.geom.Point2D | نقطة النهاية للقوس البيضاوي. |
...
يضبط القيمة التي تشير إلى كيفية دوران الشكل البيضاوي بالنسبة لنظام الإحداثيات الحالي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | float | القيمة التي تشير إلى كيفية دوران الشكل البيضاوي بالنسبة لنظام الإحداثيات الحالي. |
...
يضبط نصفَي x و y للقوس البيضاوي كزوج x,y.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | java.awt.geom.Dimension2D | نصفا القطر x و y للقوس البيضاوي كزوج x,y. |
