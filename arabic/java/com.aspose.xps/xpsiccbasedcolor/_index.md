...
| [getClass()](#getClass--) |  |
| [getIccProfile()](#getIccProfile--) | يعيد مورد ملف تعريف ICC الذي يُستند إليه اللون. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toColor()](#toColor--) | طريقة مريحة للحصول على تمثيل .NET الأصلي للون المستند إلى ICC. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يعيد مورد ملف تعريف ICC الذي يُستند إليه اللون.
