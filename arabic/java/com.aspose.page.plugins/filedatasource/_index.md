...
type: docs
weight: 13
url: /ar/java/com.aspose.page.plugins/filedatasource/
---
**Inheritance:**
java.lang.Object
...
| [getClass()](#getClass--) |  |
| [getDataType()](#getDataType--) | نوع مصدر البيانات (ملف). |
| [getPath()](#getPath--) | يحصل على المسار إلى ملف مصدر البيانات الحالي. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
...
يُهيئ مصدر بيانات ملف جديد بالمسار المحدد.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| path | java.lang.String | سلسلة تمثل المسار إلى ملف المصدر. |
