...
| حقل | الوصف |
| --- | --- |
| [EPS](#EPS) | هذا الخيار يشير إلى أن المستند الناتج يجب أن يكون ملف Encapsulated PostScript (EPS). |
| [PS](#PS) | هذا الخيار يشير إلى أن المستند الناتج يجب أن يكون ملف PostScript (PS) أو Encapsulated PostScript (EPS). |
## الطرق
...
هذا الخيار يشير إلى أن المستند الناتج يجب أن يكون ملف PostScript (PS) أو Encapsulated PostScript (EPS).
