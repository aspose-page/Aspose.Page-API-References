...
description: Aspose.Page.SaveOptions فصل. تحتوي هذه الفئة على الخيارات الضرورية لإدارة عملية التحويل.
type: docs
weight: 300
...
| اسم | وصف |
| --- | --- |
| [SaveOptions](saveoptions/#constructor)() | يقوم بتهيئة مثيل جديد لملف`SaveOptions` فئة ذات القيم الافتراضية للأعلام!:SuppressErrors (صحيح) و[`Debug`](./debug/) (خطأ) . |
| [SaveOptions](saveoptions/#constructor_1)(bool) | يقوم بتهيئة مثيل جديد لملف`SaveOptions` فئة ذات قيمة افتراضية للعلم[`Debug`](./debug/) (خطأ) . |
...
| virtual [SupressErrors](../../aspose.page/saveoptions/supresserrors/) { get; set; } | تحديد ما إذا كان يجب منع الأخطاء أم لا. إذا تمت إضافة الأخطاء الملغاة "true" إلى[`Exceptions`](./exceptions/) list. إذا كان خطأ سينهي الخطأ الأول البرنامج. |
