...
description: هذه الفئة تغلف تقديم المستند إلى جهاز مجردة. يتم تنفيذ عرض المستند صفحة بصفحة.
type: docs
weight: 20
...
| اسم | وصف |
| --- | --- |
| [Device](device)(Size) | يتم التهيئة[`Device`](../device) بحجم الصفحة . |
...
| virtual [ReNew](../../aspose.page/device/renew)() | إعادة تعيين الجهاز إلى الحالة الأولية للمستند بأكمله. تستخدم لإعادة تعيين دفق الإخراج. |
