...
description: Aspose.Page.EPS.Device.PdfDevice فصل. تضم هذه الفئة تحويل المستند إلى PDF .
type: docs
weight: 60
...
| اسم | وصف |
| --- | --- |
| [PdfDevice](pdfdevice/#constructor)(Stream) | تهيئة مثيل جديد لـ`PdfDevice` مع تيار الإخراج. |
| [PdfDevice](pdfdevice/#constructor_1)(Stream, Size) | تهيئة مثيل جديد لـ`PdfDevice`مع تدفق الإخراج والحجم المحدد للصفحة. |
...
| override [ReNew](../../aspose.page.eps.device/pdfdevice/renew/)() | إعادة تعيين الجهاز إلى الحالة الأولية للمستند بأكمله. تستخدم لإعادة تعيين تيار الإخراج. |
