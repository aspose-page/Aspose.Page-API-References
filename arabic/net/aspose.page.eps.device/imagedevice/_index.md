...
description: تضم هذه الفئة تحويل المستند إلى صورة.
type: docs
weight: 40
...
| اسم | وصف |
| --- | --- |
| [ImageDevice](imagedevice#constructor)() | تهيئة مثيل جديد لـ[`ImageDevice`](../imagedevice) . |
| [ImageDevice](imagedevice#constructor_1)(ImageFormat) | تهيئة مثيل جديد لـ[`ImageDevice`](../imagedevice) بتنسيق الصورة المحدد. |
| [ImageDevice](imagedevice#constructor_2)(Size) | تهيئة مثيل جديد لـ[`ImageDevice`](../imagedevice) بحجم الصفحة المحدد. |
| [ImageDevice](imagedevice#constructor_3)(Size, ImageFormat) | تهيئة مثيل جديد لـ[`ImageDevice`](../imagedevice)بالحجم المحدد للصفحة وتنسيق الصورة. |
...
| [GetPropertyRectangle](../../aspose.page.eps.device/imagedevice/getpropertyrectangle#getpropertyrectangle)(string) | الحصول على قيمة خاصية المستطيل . (2 methods) |
