...
description: تحتوي هذه الفئة على تدفقات الإدخال والإخراج وخيارات أخرى ضرورية لإدارة عملية التحويل.
type: docs
weight: 70
...
| اسم | وصف |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions#constructor)() | يقوم بتهيئة مثيل جديد لملف[`PdfSaveOptions`](../pdfsaveoptions) فئة ذات القيم الافتراضية للأعلام!:SuppressErrors (صحيح) و!:Debug (خطأ) . |
| [PdfSaveOptions](pdfsaveoptions#constructor_1)(bool) | يقوم بتهيئة مثيل جديد لملف[`PdfSaveOptions`](../pdfsaveoptions) فئة مع القيم الافتراضية للعلم!:Debug (خطأ) . |
