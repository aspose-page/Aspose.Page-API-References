...
| اسم | وصف |
| --- | --- |
| class [ErrorSheetOption](joberrorsheet.errorsheetoption/) | يصف ملف`JobErrorSheet` خيارات الميزة. |
| class [ErrorSheetWhen](joberrorsheet.errorsheetwhen/) | يصف الداخلية ميزة . |
| interface [IJobErrorSheetItem](joberrorsheet.ijoberrorsheetitem/) | واجهة أي ملف`JobErrorSheet` عنصر الميزة. |
