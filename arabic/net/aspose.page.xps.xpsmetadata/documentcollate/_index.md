...
description: يصف خصائص المقارنة للإخراج. يتم ترتيب كافة الصفحات في كل مستند على حدة. يتم ترك سلوك وتنفيذ ما إذا كان يتم تنفيذ كل من هذه الكلمات الرئيسية أو واحدة فقط من هذه الكلمات الرئيسية للسائق.
type: docs
weight: 550
