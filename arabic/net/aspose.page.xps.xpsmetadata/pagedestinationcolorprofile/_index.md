...
| اسم | وصف |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | يصف ملف`PageDestinationColorProfile` خيارات الميزة. |
