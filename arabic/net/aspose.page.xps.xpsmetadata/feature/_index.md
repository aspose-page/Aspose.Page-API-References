...
description: الفئة التي تتضمن ميزة مخطط الطباعة الشائعة. الفئة الأساسية لجميع الميزات المعرفة من قبل المخطط . A يحتوي العنصر على قائمة كاملة بـOption./option وProperty./property العناصر التي تصف بشكل كامل سمة الجهاز أو إعداد تنسيق الوظيفة أو أي خصائص أخرى ذات صلة . https//docs.microsoft.com/enus/windows/win32/printdocs/feature
type: docs
weight: 810
