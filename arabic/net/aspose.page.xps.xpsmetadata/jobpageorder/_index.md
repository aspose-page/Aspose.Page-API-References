...
| اسم | وصف |
| --- | --- |
| [JobPageOrder](jobpageorder/)(params JobPageOrderOption[]) | إنشاء مثيل جديد . |
...
| اسم | وصف |
| --- | --- |
| class [JobPageOrderOption](jobpageorder.jobpageorderoption/) | يصف ملف`JobPageOrder` خيارات الميزة. |
