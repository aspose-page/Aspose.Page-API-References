...
| اسم | وصف |
| --- | --- |
| [ErrorSheetWhen](errorsheetwhen/)(params ErrorSheetWhenOption[]) | إنشاء مثيل جديد . |
...
| اسم | وصف |
| --- | --- |
| class [ErrorSheetWhenOption](joberrorsheet.errorsheetwhen.errorsheetwhenoption/) | يصف ملف`ErrorSheetWhen` خيارات الميزة. |
