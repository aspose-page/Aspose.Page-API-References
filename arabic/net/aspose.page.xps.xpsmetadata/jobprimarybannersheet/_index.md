...
يصف ورقة الشعارات ليتم إخراجها للمهمة. يجب إخراج ورقة الشعار على default [`PageMediaSize`](../pagemediasize/) واستخدام الافتراضي[`PageMediaType`](../pagemediatype/) . يجب عزل ورقة الشعار عن باقي المهمة. هذا يعني أن أي خيارات إنهاء أو معالجة (مثل [`JobDuplexAllDocumentsContiguously`](../jobduplexalldocumentscontiguously/) و[`JobStapleAllDocuments`](../jobstaplealldocuments/) ، أو[`JobBindAllDocuments`](../jobbindalldocuments/) ) يجب ألا تتضمن ورقة الشعار. يجب أن تظهر ورقة الشعار كالورقة الأولى من الوظيفة.
...
| اسم | وصف |
| --- | --- |
| class [BannerSheetOption](jobprimarybannersheet.bannersheetoption/) | يمثل خيارات`JobPrimaryBannerSheet` ميزة . |
