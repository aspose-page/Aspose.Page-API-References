...
يصف متى يجب طباعة محتوى الصورة إلى الحواف المادية للوسائط. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
...
| اسم | وصف |
| --- | --- |
| [PageBorderless](pageborderless/)(params PageBorderlessOption[]) | إنشاء مثيل جديد . |
...
| اسم | وصف |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption/) | يصف ملف`PageBorderless` خيارات الميزة. |
