...
description: يصف متى يجب طباعة محتوى الصورة إلى الحواف المادية للوسائط. https//docs.microsoft.com/enus/windows/win32/printdocs/pageborderless
type: docs
weight: 1770
...
| اسم | وصف |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption) | يصف ملف[`PageBorderless`](../pageborderless) خيارات الميزة. |
