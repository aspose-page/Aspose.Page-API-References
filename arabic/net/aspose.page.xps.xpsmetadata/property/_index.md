...
الفئة التي تقوم بتنفيذ PrintTicket مشترك . الفئة الأساسية لجميع الخصائص المعرفة من قبل المخطط . A يصرح عنصر عن جهاز أو تنسيق وظيفة أو خاصية أخرى ذات صلة يتم إعطاء اسمه من خلال سمة اسمه. أ[`Value`](../value/) يستخدم العنصر لتعيين قيمة إلى. أ يمكن أن يكون معقدًا ، وربما يحتوي على خصائص فرعية متعددة. يتم أيضًا تمثيل الخصائص الفرعية بواسطة العناصر . https://docs.microsoft.com/en-us/windows/win32/printdocs/property
