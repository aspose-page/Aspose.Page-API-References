...
يصف طريقة الربط. جميع المستندات في الوظيفة مرتبطة ببعضها البعض.`JobBindAllDocuments` و[`DocumentBinding`](../documentbinding/) بشكل متبادل. الأمر متروك للسائق لتحديد معالجة القيد بين هذه الكلمات الرئيسية.
...
| class [BindingOption](jobbindalldocuments.bindingoption/) | يصف ملف`JobBindAllDocuments` خيارات الميزة. |
