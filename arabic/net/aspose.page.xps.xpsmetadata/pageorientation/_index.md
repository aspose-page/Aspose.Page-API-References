...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation فصل. يصف اتجاه ورقة الوسائط الفعلية. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
...
| اسم | وصف |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | يصف ملف`PageOrientation` خيارات الميزة. |
