...
description: الفئة التي تقوم بتنفيذ PrintTicket مشترك . الفئة الأساسية لجميع الخصائص التي تم تسجيلها من قبل المخطط . A يعلن عنصر عن خاصية جوهرية لـ an Option./option تعريف. يجب مقارنة هذه الخصائص عند تقييم مدى قرب طلبOption./option يطابق الجهاز المدعومOption./option . https//docs.microsoft.com/enus/windows/win32/printdocs/scoredproperty
type: docs
weight: 2790
