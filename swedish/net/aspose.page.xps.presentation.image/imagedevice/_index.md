...
| override [Create](../../aspose.page.xps.presentation.image/imagedevice/create)() | Skapar en ny instans av enheten baserat på denna enhetsinstans. Skriver enhetens grafiktillstånd, dvs.ApsCanvas instans(er) med motsvarande egenskaper för RenderTransform och Clip. |
