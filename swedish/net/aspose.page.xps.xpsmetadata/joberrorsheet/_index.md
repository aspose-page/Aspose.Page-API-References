...
| namn | Beskrivning |
| --- | --- |
| class [ErrorSheetOption](joberrorsheet.errorsheetoption) | Beskriver[`JobErrorSheet`](../joberrorsheet) funktionsalternativ. |
| class [ErrorSheetWhen](joberrorsheet.errorsheetwhen) | Beskriver inre feature. |
| interface [IJobErrorSheetItem](joberrorsheet.ijoberrorsheetitem) | Gränssnittet för någon[`JobErrorSheet`](../joberrorsheet) feature item. |
