...
Anger källan för ett anpassat primärt omslagsark för jobbet. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
...
| namn | Beskrivning |
| --- | --- |
| [JobPrimaryCoverFrontSource](jobprimarycoverfrontsource/)(string) | Skapar en ny instans. |
