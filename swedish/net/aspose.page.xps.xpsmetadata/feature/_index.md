...
description: Klassen som inkapslar en gemensam Print Schemafunktion. Basklassen för alla schemadefinierade funktioner. A elementet innehåller en komplett lista överOption./option ochProperty./property element som fullständigt beskriver ett enhetsattribut jobbformateringsinställning eller annan relevant egenskap. https//docs.microsoft.com/enus/windows/win32/printdocs/feature
type: docs
weight: 810
