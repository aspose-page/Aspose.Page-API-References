...
| namn | Beskrivning |
| --- | --- |
| interface [IPageWatermarkItem](pagewatermark.ipagewatermarkitem/) | Gränssnittet för någon`PageWatermark` feature item. |
...
| class [PageWatermarkOption](pagewatermark.pagewatermarkoption/) | Beskriver`PageWatermark` funktioner alternativ. |
