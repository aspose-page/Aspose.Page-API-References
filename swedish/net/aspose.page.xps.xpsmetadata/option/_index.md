...
description: Klassen som implementerar en gemensam PrintTicket . Basklassen för alla schemadefinierade alternativ. Ett Optionelement innehåller allaProperty./property och ScoredProperty./scoredproperty element associerade med detta alternativ. https//docs.microsoft.com/enus/windows/win32/printdocs/option
type: docs
weight: 1590
