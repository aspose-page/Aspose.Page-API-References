...
| namn | Beskrivning |
| --- | --- |
| interface [IPageResolutionItem](pageresolution.ipageresolutionitem/) | Gränssnittet för någon`PageResolution` feature item. |
...
| class [PageResolutionOption](pageresolution.pageresolutionoption/) | Beskriver`PageResolution` funktioner alternativ. |
