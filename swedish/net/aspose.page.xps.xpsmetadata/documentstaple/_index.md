...
description: Beskriver utdatas häftningsegenskaper. Varje dokument häftas separat. DenJobStapleAllDocuments./jobstaplealldocuments ochDocumentStaple./documentstaplenyckelord är ömsesidigt uteslutande. Det är upp till föraren att bestämma hantering av restriktioner mellan dessa nyckelord. https//docs.microsoft.com/enus/windows/win32/printdocs/documentstaple
type: docs
weight: 760
