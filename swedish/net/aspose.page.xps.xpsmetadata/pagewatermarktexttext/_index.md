...
Anger texten för vattenstämpeln. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktexttext
...
| namn | Beskrivning |
| --- | --- |
| [PageWatermarkTextText](pagewatermarktexttext/)(string) | Skapar en ny instans. |
