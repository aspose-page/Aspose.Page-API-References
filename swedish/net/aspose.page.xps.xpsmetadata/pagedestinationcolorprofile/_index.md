...
| namn | Beskrivning |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | Beskriver`PageDestinationColorProfile` funktionsalternativ. |
