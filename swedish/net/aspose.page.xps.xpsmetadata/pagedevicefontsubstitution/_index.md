...
Beskriver det aktiverade/avaktiverade tillståndet för enhetstypsnittsersättning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicefontsubstitution
...
| namn | Beskrivning |
| --- | --- |
| [PageDeviceFontSubstitution](pagedevicefontsubstitution/)(params PageDeviceFontSubstitutionOption[]) | Skapar en ny instans. |
...
| namn | Beskrivning |
| --- | --- |
| class [PageDeviceFontSubstitutionOption](pagedevicefontsubstitution.pagedevicefontsubstitutionoption/) | Beskriver`PageDeviceFontSubstitution` funktionsalternativ. |
