...
description: Aspose.Page.EPS.Device.ImageSaveOptions klass. Den här klassen innehåller nödvändiga alternativ för att hantera bildsparprocessen.
type: docs
weight: 50
...
| namn | Beskrivning |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/#constructor)() | Initierar en ny instans av`ImageSaveOptions` klass med standardvärden för flaggor!:SuppressErrors (sant) och!:Debug (falskt). |
| [ImageSaveOptions](imagesaveoptions/#constructor_1)(bool) | Initierar en ny instans av`ImageSaveOptions` with standardvärde för flagga!:Debug (falskt). |
...
| [SmoothingMode](../../aspose.page.eps.device/imagesaveoptions/smoothingmode/) { get; set; } | Hämtar/ställer in utjämningsläget för rendering av bild. |
