...
description: Klassinkapslande vägelementfunktioner. Detta element är det enda sättet att lägga till vektorgrafik och bilder på en fast sida. Det definierar en enda vektorgrafik som ska renderas på en sida.
type: docs
weight: 3190
