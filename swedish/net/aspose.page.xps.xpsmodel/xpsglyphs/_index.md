...
description: Klassinkapslande Glyphs elementfunktioner. Detta element representerar en serie enhetligt formaterad text från ett enda teckensnitt. Det ger information som är nödvändig för korrekt rendering och stöder search och urvalsfunktioner för att titta på konsumenter.
type: docs
weight: 3030
