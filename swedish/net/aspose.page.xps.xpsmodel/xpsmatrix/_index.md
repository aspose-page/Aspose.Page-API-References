...
description: Klass inkapslande MatrixTransform egenskapselement egenskaper. Detta element definierar en godtycklig affin matristransformation som används för att manipulera koordinat system av element.
type: docs
weight: 3150
...
| override [ToString](../../aspose.page.xps.xpsmodel/xpsmatrix/tostring)() | Returnerar strängrepresentationen av detta[`XpsMatrix`](../xpsmatrix) instans. |
