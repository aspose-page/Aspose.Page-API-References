...
description: Aspose.Page.SaveOptions klass. Den här klassen innehåller alternativ som är nödvändiga för att hantera konverteringsprocessen.
type: docs
weight: 300
...
| namn | Beskrivning |
| --- | --- |
| [SaveOptions](saveoptions/#constructor)() | Initierar en ny instans av`SaveOptions` klass med standardvärden för flaggor!:SuppressErrors (sant) och[`Debug`](./debug/) (falskt). |
| [SaveOptions](saveoptions/#constructor_1)(bool) | Initierar en ny instans av`SaveOptions` klass med standardvärde för flagga[`Debug`](./debug/) (falskt). |
