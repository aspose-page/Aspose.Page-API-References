...
description: Denna klass kapslar in rendering av dokument till abstrakt enhet. Rendering av dokumentet utförs sida för sida.
type: docs
weight: 20
...
| namn | Beskrivning |
| --- | --- |
| [Device](device)(Size) | Initialiserar[`Device`](../device) med storleken på en sida. |
