...
description: Får färgegenskapsvärde.
type: docs
weight: 40
url: /sv/net/aspose.page/userproperties/getpropertycolor/
---
## GetPropertyColor(string) {#getpropertycolor}

Får färgegenskapsvärde.
...
Får färgegenskapsvärde. Om den begärda egenskapen saknas, returnerar det angivna standardvärdet.
...
| --- | --- | --- |
| key | String | Egendomens namn. |
| def | Color | Standardvärde för egendom. |
