...
description: "Klass för XPS-as-TIFF sparalternativ."
type: docs
weight: 16
url: /sv/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Klass för XPS-as-TIFF sparalternativ.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Skapar en ny instans av alternativ. |
## Metoder
...
| [multipage()](#multipage--) | Hämtar flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil. |
| [multipage(boolean value)](#multipage-boolean-) | Ställer in flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Hämtar flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil.

**Returns:**
boolean - Flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil.
...
Ställer in flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| value | boolean | Flaggan som definierar om flera bilder ska sparas i en enda flersidig TIFF-fil. |
