...
description: "Anger en typ av kompression som tillämpas på allt innehåll i PDF‑filen förutom bilder."
type: docs
weight: 23
url: /sv/java/com.aspose.xps.rendering/pdftextcompression/
---
**Inheritance:**
...
Anger en typ av kompression som tillämpas på allt innehåll i PDF‑filen förutom bilder.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Flate](#Flate) | Flate-kompressionstyp |
| [Lzw](#Lzw) | Lzw-kompressionstyp |
| [None](#None) | Ingen kompressionstyp |
| [Rle](#Rle) | Rle-kompressionstyp |
## Metoder
