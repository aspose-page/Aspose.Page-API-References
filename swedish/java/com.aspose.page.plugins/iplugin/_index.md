...
description: "Allmänt plugin‑gränssnitt som definierar gemensamma metoder som konkreta plugin‑moduler ska implementera."
type: docs
weight: 23
url: /sv/java/com.aspose.page.plugins/iplugin/
---```
