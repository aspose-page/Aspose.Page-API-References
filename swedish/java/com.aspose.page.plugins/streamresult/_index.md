...
description: "Representerar operationsresultat i form av en ström."
type: docs
weight: 18
url: /sv/java/com.aspose.page.plugins/streamresult/
---
**Inheritance:**
java.lang.Object
...
Representerar operationsresultat i form av en ström.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [StreamResult(OutputStream stream)](#StreamResult-java.io.OutputStream-) | Initierar en ny instans med det angivna strömobjektet. |
## Metoder
...
Initierar en ny instans med det angivna strömobjektet.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| ström | java.io.OutputStream | Strömobjekt |
