...
description: "Klass som kapslar in PolyBezierSegment-elementfunktioner."
type: docs
weight: 45
url: /sv/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
Klass som kapslar in funktioner för PolyBezierSegment‑elementet. Detta element beskriver en uppsättning kubiska B‑zier‑kurvor.
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [deepClone()](#deepClone--) | Klonar denna uppsättning kubiska B‑zier‑kurvor. |
...
Klonar denna uppsättning kubiska B‑zier‑kurvor.
