...
description: "Klass som kapslar in gemensamma funktioner för tiling‑borstelementen VisualBrush och ImageBrush."
type: docs
weight: 51
url: /sv/java/com.aspose.xps/xpstilingbrush/
---
**Inheritance:**
...
Klass som kapslar in gemensamma egenskaper för tiling‑penselselement (VisualBrush och ImageBrush).
## Metoder
