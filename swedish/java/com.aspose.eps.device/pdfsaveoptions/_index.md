...
type: docs
weight: 11
url: /sv/java/com.aspose.eps.device/pdfsaveoptions/
---
**Inheritance:**
...
| --- | --- |
| [PdfSaveOptions()](#PdfSaveOptions--) | Initiera en ny instans av PdfSaveOptions-klassen med standardvärden för flaggorna suppressErrors (true) och debug (false). |
| [PdfSaveOptions(boolean supressErrors)](#PdfSaveOptions-boolean-) | Initiera en ny instans av PdfSaveOptions-klassen med standardvärde för flaggan debug (false). |
| [PdfSaveOptions(Dimension size)](#PdfSaveOptions-java.awt.Dimension-) | Initiera en ny instans av PdfSaveOptions-klassen med sidans storlek. |
| [PdfSaveOptions(boolean supressErrors, Dimension size)](#PdfSaveOptions-boolean-java.awt.Dimension-) | Initiera en ny instans av PdfSaveOptions-klassen med standardvärde för flaggan debug (false) och sidans storlek. |
## Metoder
...
Initiera en ny instans av PdfSaveOptions-klassen med sidans storlek.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| size | java.awt.Dimension | Sidans storlek. |
...
Initiera en ny instans av PdfSaveOptions-klassen med standardvärde för flaggan debug (false) och sidans storlek.
