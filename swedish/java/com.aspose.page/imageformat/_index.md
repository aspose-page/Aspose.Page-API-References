...
description: "Denna enumeration innehåller möjliga namn på bildformat som stöds av PS/EPS till bildkonvertering."
type: docs
weight: 23
url: /sv/java/com.aspose.page/imageformat/
---
**Inheritance:**
...
Denna enumeration innehåller möjliga namn på bildformat som stöds av PS/EPS till bildkonvertering.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [BMP](#BMP) | BMP-bildformat. |
| [GIF](#GIF) | GIF-bildformat. |
