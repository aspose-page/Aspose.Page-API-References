...
description: "Beskriver alternativ för JobDuplexAllDocumentsContiguously och DocumentDuplex-funktioner."
type: docs
weight: 11
url: /sv/java/com.aspose.xps.metadata/duplex.duplexoption/
---
**Inheritance:**
...
Beskriver alternativ för funktionerna JobDuplexAllDocumentsContiguously och DocumentDuplex.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [OneSided](#OneSided) | Anger enkeltsidig utskrift. |
## Metoder
...
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
| [twoSidedLongEdge(Duplex.DuplexMode duplexMode)](#twoSidedLongEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Anger dubbelsidig utskrift så att sidan vänds parallellt med  MediaSizeHeight  riktning. |
| [twoSidedShortEdge(Duplex.DuplexMode duplexMode)](#twoSidedShortEdge-com.aspose.xps.metadata.Duplex.DuplexMode-) | Anger dubbelsidig utskrift så att sidan vänds parallellt med  MediaSizeWidth  riktning. |
| [wait()](#wait--) |  |
...
Anger dubbelsidig utskrift så att sidan vänds parallellt med  MediaSizeHeight  riktning.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| duplexMode | [DuplexMode](../../com.aspose.xps.metadata/duplexmode) | Den  DuplexMode |
...
Anger dubbelsidig utskrift så att sidan vänds parallellt med  MediaSizeWidth  riktning.
