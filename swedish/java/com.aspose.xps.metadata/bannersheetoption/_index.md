...
description: "Representerar alternativ för JobPrimaryBannerSheet‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/jobprimarybannersheet.bannersheetoption/
---
**Inheritance:**
...
Representerar alternativ för  JobPrimaryBannerSheet  funktionen.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Custom](#Custom) | Anger att ett anpassat bannerblad ska skrivas ut. |
| [None](#None) | Anger att inget bannerblad ska skrivas ut. |
| [Standard](#Standard) | Anger att standard‑ (enhetsdefinierat) bannerblad ska skrivas ut. |
## Metoder
...
Anger att ett anpassat bannerblad ska skrivas ut. Om ett  JobPrimaryBannerSheetSource   ParameterInit  element inte anges, bör detta alternativ ignoreras.
...
Anger att inget bannerblad ska skrivas ut.
...
Anger att standard‑ (enhetsdefinierat) bannerblad ska skrivas ut.
