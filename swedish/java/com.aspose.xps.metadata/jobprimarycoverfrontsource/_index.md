...
description: "Anger källan för ett anpassat primärt framsidesblad för jobbet."
type: docs
weight: 69
url: /sv/java/com.aspose.xps.metadata/jobprimarycoverfrontsource/
---
**Inheritance:**
...
Anger källan för ett anpassat framsidesprimärblad för jobbet. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobPrimaryCoverFrontSource(String value)](#JobPrimaryCoverFrontSource-java.lang.String-) | Skapar en ny instans. |
## Metoder
