...
description: "Beskriver enhetsspråken som stöds för att skicka data från drivrutin till fysisk enhet."
type: docs
weight: 50
url: /sv/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
Beskriver de enhetsspråk som stöds för att skicka data från drivrutin till fysisk enhet. Detta kallas ofta \"Page Description Language\". Detta nyckelord definierar vilket sidbeskrivningsspråk som stöds av drivrutinen och den fysiska enheten. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdevicelanguage
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | En matris av alternativ specifika för funktionen. |
