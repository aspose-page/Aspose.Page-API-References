...
description: "Beskriver utdata från en enda sida till flera fysiska medieark."
type: docs
weight: 118
url: /sv/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Beskriver utskriften av en enskild sida till flera fysiska medieark. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Konstruktörer
...
Lägger till ett alternativ med ett  PagesPerSheet  poängsatt egenskapsvärde. Anger antalet fysiska ark per logisk sida.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| value | int | Ett  PagesPerSheet  poängsatt egenskapsvärde. |
