...
description: "Anger den inbäddade mål‑färgprofilen."
type: docs
weight: 92
url: /sv/java/com.aspose.xps.metadata/pagedestinationcolorprofileembedded/
---
**Inheritance:**
...
Anger den inbäddade destinationsfärgprofilen. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileembedded
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageDestinationColorProfileEmbedded(String value)](#PageDestinationColorProfileEmbedded-java.lang.String-) | Skapar en ny instans. |
## Metoder
