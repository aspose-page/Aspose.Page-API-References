...
type: docs
weight: 57
url: /sv/java/com.aspose.xps.metadata/jobinputbin/
---
**Inheritance:**
...
Beskriver den installerade inmatningsbehållaren i en enhet eller den fullständiga listan över stödjade behållare för en enhet. Tillåter specifikation av inmatningsbehållare per jobb. Nyckelorden JobInputBin, DocumentInputBin och PageInputBin är ömsesidigt uteslutande. Båda bör inte anges samtidigt i ett PrintTicket‑ eller Print Capabilities‑dokument. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobinputbin
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobInputBin(InputBin.IInputBinItem[] items)](#JobInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Skapar en ny instans. |
## Metoder
