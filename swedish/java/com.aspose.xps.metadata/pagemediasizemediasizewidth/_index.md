...
description: "Anger dimensionen MediaSizeHeight-riktning för alternativet Custom MediaSize."
type: docs
weight: 104
url: /sv/java/com.aspose.xps.metadata/pagemediasizemediasizewidth/
---
**Inheritance:**
...
Anger dimensionen  MediaSizeHeight  riktning för alternativet  Custom  MediaSize . https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizewidth
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizeMediaSizeWidth(int value)](#PageMediaSizeMediaSizeWidth-int-) | Skapar en ny instans. |
## Metoder
