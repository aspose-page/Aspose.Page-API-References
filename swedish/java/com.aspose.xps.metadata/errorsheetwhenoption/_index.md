...
description: "Beskriver alternativen för funktionen ErrorSheetWhen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/joberrorsheet.errorsheetwhen.errorsheetwhenoption/
---
**Inheritance:**
...
Beskriver  ErrorSheetWhen  alternativ för funktionen.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Always](#Always) | Anger att ett felblad kommer att skrivas ut för varje jobb. |
| [OnError](#OnError) | Anger att ett felblad endast kommer att skrivas ut vid fel. |
## Metoder
...
Anger att ett felblad kommer att skrivas ut för varje jobb.
...
Anger att ett felblad endast kommer att skrivas ut vid fel.
