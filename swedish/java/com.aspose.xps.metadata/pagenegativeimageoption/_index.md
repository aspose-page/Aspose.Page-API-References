...
description: "Definierar alternativ för PageNegativeImage‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pagenegativeimage.pagenegativeimageoption/
---
**Inheritance:**
...
Definierar  PageNegativeImage  funktionsalternativ.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Negative](#Negative) | Anger att utskriften ska vara den negativa bilden. |
| [None](#None) | Anger att utskriften ska vara den icke‑negativa bilden. |
## Metoder
...
Anger att utskriften ska vara den negativa bilden.
...
Anger att utskriften ska vara den icke‑negativa bilden.
