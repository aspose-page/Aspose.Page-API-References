...
description: "Definierar konstanter för det poängsatta egenskapsvärdet PrePunched."
type: docs
weight: 15
url: /sv/java/com.aspose.xps.metadata/pagemediatype.prepunched/
---
**Inheritance:**
...
Definierar konstanter för det  PrePunched  poängsatta egenskapsvärdet.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [None](#None) | Inget värde. |
| [PrePunchedValue](#PrePunchedValue) | PrePunched‑värde. |
## Metoder
