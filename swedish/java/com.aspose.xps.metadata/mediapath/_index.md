...
description: "Definierar konstanter för MediaPath-egenskapens poängsatta värde."
type: docs
weight: 16
url: /sv/java/com.aspose.xps.metadata/inputbin.mediapath/
---
**Inheritance:**
...
Definierar konstanter för  MediaPath  poängsatta egenskapsvärdet.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Serpentine](#Serpentine) | Slingrande värde. |
| [Straight](#Straight) | Rakt värde. |
## Metoder
