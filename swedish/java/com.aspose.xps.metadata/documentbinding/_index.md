...
type: docs
weight: 15
url: /sv/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Beskriver bindningsmetoden. Varje dokument bindas separat. DocumentBinding och JobBindAllDocuments är ömsesidigt uteslutande. Det är upp till drivrutinen att bestämma hur begränsningar hanteras mellan nyckelorden. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Skapar en ny instans. |
## Metoder
