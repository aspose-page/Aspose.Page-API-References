...
description: "Anger en relativ URI‑referens till en ICC‑profil som finns i ett XPS‑dokument."
type: docs
weight: 93
url: /sv/java/com.aspose.xps.metadata/pagedestinationcolorprofileuri/
---
**Inheritance:**
...
Anger en relativ URI-referens till en ICC-profil som finns i ett XPS-dokument. Bearbetningen av detta alternativ beror på inställningen av funktionen PageDeviceColorSpaceUsage. Alla element som använder den profilen antas redan vara i rätt enhetsfärgrymd och kommer inte att färghanteras i drivrutinen eller enheten. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofileuri
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageDestinationColorProfileURI(String value)](#PageDestinationColorProfileURI-java.lang.String-) | Skapar en ny instans. |
## Metoder
