...
type: docs
weight: 133
url: /sv/java/com.aspose.xps.metadata/pagewatermarkoriginwidth/
---
**Inheritance:**
...
Anger ursprunget för ett vattenstämpel relativt ursprunget för  PageImageableSize . https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginwidth
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageWatermarkOriginWidth(int value)](#PageWatermarkOriginWidth-int-) | Skapar en ny instans. |
## Metoder
