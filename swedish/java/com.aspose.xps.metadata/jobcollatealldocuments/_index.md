...
description: "Beskriver sorteringsegenskaperna för utdata."
type: docs
weight: 47
url: /sv/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Beskriver samlingskarakteristiken för utskriften. Alla dokument i varje enskilt jobb samlas.  DocumentCollate  och  JobCollateAllDocuments  är ömsesidigt uteslutande. Hur beteendet och implementeringen av om båda eller endast ett av dessa nyckelord implementeras lämnas åt drivrutinen. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | En matris av alternativ specifika för funktionen. |
