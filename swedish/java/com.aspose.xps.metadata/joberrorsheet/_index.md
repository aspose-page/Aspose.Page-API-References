...
description: "Beskriver felbladets utdata."
type: docs
weight: 53
url: /sv/java/com.aspose.xps.metadata/joberrorsheet/
---
**Inheritance:**
...
Beskriver felbladets utdata. Hela jobbet kommer att ha ett enda felblad. Felbladet ska skrivas ut på standard  PageMediaSize  och med standard  PageMediaType . Felbladet bör isoleras från resten av jobbet. Detta innebär att eventuella efterbehandlings‑ eller bearbetningsalternativ (såsom  JobDuplex ,  JobStaple , eller  JobBinding ) inte bör inkludera felbladet. Felbladet ska visas som det sista bladet i jobbet. https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheet
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobErrorSheet(JobErrorSheet.IJobErrorSheetItem[] items)](#JobErrorSheet-com.aspose.xps.metadata.JobErrorSheet.IJobErrorSheetItem...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| items | [IJobErrorSheetItem\[\]](../../com.aspose.xps.metadata/ijoberrorsheetitem) | En matris av objekt specifika för funktionen. |
