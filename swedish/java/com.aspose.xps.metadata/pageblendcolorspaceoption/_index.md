...
description: "Beskriver alternativ för PageBlendColorSpace‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pageblendcolorspace.pageblendcolorspaceoption/
---
**Inheritance:**
...
Beskriver alternativ för funktionen PageBlendColorSpace.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ICCProfile](#ICCProfile) | Anger en ICC-profil som definierar färgrymden som SKALL användas för sammanslagning. |
| [sRGB](#sRGB) | sRGB-färgrymden SKALL användas för sammanslagning. |
| [scRGB](#scRGB) | scRGB-färgrymden SKALL användas för sammanslagning. |
## Metoder
...
Anger en ICC-profil som definierar färgrymden som SKALL användas för sammanslagning. Obs: Detta gäller endast XPS-dokument och bör inte användas i godtyckliga PrintTickets.
...
sRGB-färgrymden SKALL användas för sammanslagning.
...
scRGB-färgrymden SKALL användas för sammanslagning.
