...
description: "Beskriver metoden för hantering av TrueType-teckensnitt som ska användas."
type: docs
weight: 130
url: /sv/java/com.aspose.xps.metadata/pagetruetypefontmode/
---
**Inheritance:**
...
Beskriver metoden för hantering av TrueType-teckensnitt som ska användas. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagetruetypefontmode
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageTrueTypeFontMode(PageTrueTypeFontMode.PageTrueTypeFontModeOption[] options)](#PageTrueTypeFontMode-com.aspose.xps.metadata.PageTrueTypeFontMode.PageTrueTypeFontModeOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [PageTrueTypeFontModeOption\[\]](../../com.aspose.xps.metadata/pagetruetypefontmodeoption) | En matris av alternativ specifika för funktionen. |
