...
description: "Definierar konstanter för värdet på den poängsatta egenskapen MediaSizeAutoSense."
type: docs
weight: 18
url: /sv/java/com.aspose.xps.metadata/inputbin.mediasizeautosense/
---
**Inheritance:**
...
Definierar konstanter för  MediaSizeAutoSense  poängsatta egenskapsvärdet.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [None](#None) | Inget värde. |
| [Supported](#Supported) | Stödd värde. |
## Metoder
