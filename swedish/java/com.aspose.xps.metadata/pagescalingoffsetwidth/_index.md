...
type: docs
weight: 123
url: /sv/java/com.aspose.xps.metadata/pagescalingoffsetwidth/
---
**Inheritance:**
...
Anger skalningsavvikelsen i  ImageableSizeWidth ‑riktningen för anpassad skalning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetwidth
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageScalingOffsetWidth(int value)](#PageScalingOffsetWidth-int-) | Skapar en ny instans. |
## Metoder
