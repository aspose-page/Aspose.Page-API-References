...
description: "Beskriver den utökade räckvidden bortom neutrala färger till kromatiska färger som GCR tillämpar. 0  Enhetlig komponentutbyte 100  Grå komponentutbyte."
type: docs
weight: 80
url: /sv/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementextent/
---
**Inheritance:**
...
Beskriver den utökade räckvidden bortom neutrala färger (till kromatiska färger) som GCR tillämpar. 0 % = Enhetlig komponentutbyte, 100 % = Grå komponentutbyte. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementextent
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementExtent(int value)](#PageBlackGenerationProcessingGrayComponentReplacementExtent-int-) | Skapar en ny instans. |
## Metoder
