...
description: "Definierar konstanter för det poängsatta egenskapsvärdet FeedFace."
type: docs
weight: 12
url: /sv/java/com.aspose.xps.metadata/inputbin.feedface/
---
**Inheritance:**
...
Definierar konstanter för  FeedFace  poängsatta egenskapsvärdet.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [FaceDown](#FaceDown) | FaceDown‑värde. |
| [FaceUp](#FaceUp) | FaceUp‑värde. |
## Metoder
