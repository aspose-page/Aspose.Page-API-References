...
description: "Anger källan för ett primärt anpassat bannerblad för jobbet."
type: docs
weight: 65
url: /sv/java/com.aspose.xps.metadata/jobprimarybannersheetsource/
---
**Inheritance:**
...
Anger källan för ett primärt anpassat banderollark för jobbet. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobPrimaryBannerSheetSource(String value)](#JobPrimaryBannerSheetSource-java.lang.String-) | Skapar en ny instans. |
## Metoder
