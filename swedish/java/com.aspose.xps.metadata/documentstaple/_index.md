...
description: "Beskriver häftningsegenskaperna för utskriften."
type: docs
weight: 35
url: /sv/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
Beskriver häftningsegenskaperna för utskriften. Varje dokument häftas separat. Nyckelorden JobStapleAllDocuments och DocumentStaple är ömsesidigt uteslutande. Det är upp till drivrutinen att avgöra hur begränsningarna hanteras mellan dessa nyckelord. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | En matris av alternativ specifika för funktionen. |
