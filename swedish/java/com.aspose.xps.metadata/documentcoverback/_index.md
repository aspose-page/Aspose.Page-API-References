...
type: docs
weight: 19
url: /sv/java/com.aspose.xps.metadata/documentcoverback/
---
**Inheritance:**
...
Beskriver baksidan (slut) av omslagspapper. Varje dokument får ett separat blad. Omslagspappret ska skrivas ut på den  PageMediaSize  och  PageMediaType  som används för dokumentets sista sida. Omslagspappret ska integreras i bearbetningsalternativ (såsom  DocumentDuplex ,  DocumentNUp ) enligt det angivna alternativet. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentCoverBack(DocumentCoverBack.CoverBackOption[] options)](#DocumentCoverBack-com.aspose.xps.metadata.DocumentCoverBack.CoverBackOption...-) | Skapar en ny instans. |
## Metoder
