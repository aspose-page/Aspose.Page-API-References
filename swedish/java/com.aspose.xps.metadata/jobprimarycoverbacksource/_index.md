...
description: "Anger källan för ett anpassat primärt baksidesblad för jobbet."
type: docs
weight: 67
url: /sv/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Anger källan för ett anpassat baksides‑primärblad för jobbet. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Skapar en ny instans. |
## Metoder
