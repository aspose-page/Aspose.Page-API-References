...
description: "Anger dimensionen MediaSizeWidth-riktning för alternativet Custom MediaSize."
type: docs
weight: 103
url: /sv/java/com.aspose.xps.metadata/pagemediasizemediasizeheight/
---
**Inheritance:**
...
Anger dimensionen MediaSizeWidth-riktning för alternativet Custom MediaSize. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizeheight
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizeMediaSizeHeight(int value)](#PageMediaSizeMediaSizeHeight-int-) | Skapar en ny instans. |
## Metoder
