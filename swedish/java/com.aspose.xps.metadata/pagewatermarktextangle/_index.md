...
description: "Anger vinkeln på vattenstämpeltexten relativt PageImageableSizeWidth-riktningen."
type: docs
weight: 134
url: /sv/java/com.aspose.xps.metadata/pagewatermarktextangle/
---
**Inheritance:**
...
Anger vinkeln på vattenstämpeltexten relativt  PageImageableSizeWidth  -riktningen. Vinkeln mäts i moturs riktning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextangle
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageWatermarkTextAngle(int value)](#PageWatermarkTextAngle-int-) | Skapar en ny instans. |
## Metoder
