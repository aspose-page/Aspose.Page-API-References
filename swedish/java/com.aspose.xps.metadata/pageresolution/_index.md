...
description: "Definierar sidupplösningen för utskrivet resultat antingen som ett kvalitativt värde, som punkter per tum eller båda."
type: docs
weight: 120
url: /sv/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
Definierar sidupplösningen för utskrivet resultat antingen som ett kvalitativt värde, som punkter per tum, eller båda. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | En matris av objekt specifika för funktionen. |
