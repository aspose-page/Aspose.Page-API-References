...
description: "Anger offseten parallellt med matningsorienteringens riktning."
type: docs
weight: 106
url: /sv/java/com.aspose.xps.metadata/pagemediasizepsheightoffset/
---
**Inheritance:**
...
Anger offseten, parallellt med matningsorienteringens riktning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheightoffset
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizePSHeightOffset(int value)](#PageMediaSizePSHeightOffset-int-) | Skapar en ny instans. |
## Metoder
