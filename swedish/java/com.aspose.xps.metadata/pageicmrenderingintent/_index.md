...
description: "Beskriver renderingsintentionen enligt ICC v2-specifikationen."
type: docs
weight: 98
url: /sv/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
Beskriver återgivningsintentionen enligt ICC v2-specifikationen. Detta värde bör ignoreras om en bild eller ett grafiskt element har en inbäddad profil som specificerar återgivningsintentionen. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageicmrenderingintent
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | En matris av alternativ specifika för funktionen. |
