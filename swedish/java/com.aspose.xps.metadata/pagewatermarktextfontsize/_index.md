...
description: "Definierar de tillgängliga teckenstorlekarna för vattenstämpeltexten."
type: docs
weight: 136
url: /sv/java/com.aspose.xps.metadata/pagewatermarktextfontsize/
---
**Inheritance:**
...
Definierar de tillgängliga teckenstorlekarna för vattenstämpeltexten. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextfontsize
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageWatermarkTextFontSize(int value)](#PageWatermarkTextFontSize-int-) | Skapar en ny instans. |
## Metoder
