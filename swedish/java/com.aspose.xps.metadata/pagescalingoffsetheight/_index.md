...
description: "Anger skalningsavvikelsen i ImageableSizeWidth‑riktningen för anpassad skalning."
type: docs
weight: 122
url: /sv/java/com.aspose.xps.metadata/pagescalingoffsetheight/
---
**Inheritance:**
...
Anger skalningsoffseten i ImageableSizeWidth-riktningen för anpassad skalning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetheight
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageScalingOffsetHeight(int value)](#PageScalingOffsetHeight-int-) | Skapar en ny instans. |
## Metoder
