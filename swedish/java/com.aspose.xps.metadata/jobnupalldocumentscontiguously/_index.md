...
description: "Beskriver utskriften av flera logiska sidor till ett enda fysiskt blad."
type: docs
weight: 58
url: /sv/java/com.aspose.xps.metadata/jobnupalldocumentscontiguously/
---
**Inheritance:**
...
Beskriver utskriften av flera logiska sidor på ett enda fysiskt blad. Alla dokument i jobbet sammanställs kontinuerligt. JobNUpAllDocumentsContiguously och DocumentNUp är ömsesidigt uteslutande. Det är upp till drivrutinen att avgöra hur begränsningar hanteras mellan dessa nyckelord. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobnupalldocumentscontiguously
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobNUpAllDocumentsContiguously(NUp.INUpItem[] items)](#JobNUpAllDocumentsContiguously-com.aspose.xps.metadata.NUp.INUpItem...-) | Skapar en ny instans. |
## Metoder
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| value | int | Ett PagesPerSheet scorerat egenskapsvärde. Stödd uppsättning kan vara vilken mängd heltal som helst, t.ex. \{1,2,4,6,8,9,16\}. |
