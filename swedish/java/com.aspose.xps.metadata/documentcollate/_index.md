...
type: docs
weight: 17
url: /sv/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Beskriver samlingskarakteristiken för utskriften. Alla sidor i varje enskilt dokument samlas. DocumentCollate och JobCollateAlldocuments är ömsesidigt uteslutande. Beteendet och implementeringen av huruvida båda eller endast ett av dessa nyckelord implementeras lämnas åt drivrutinen. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Skapar en ny instans. |
## Metoder
