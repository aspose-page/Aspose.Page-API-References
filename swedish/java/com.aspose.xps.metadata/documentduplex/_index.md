...
type: docs
weight: 23
url: /sv/java/com.aspose.xps.metadata/documentduplex/
---
**Inheritance:**
...
Beskriver duplex‑egenskaperna för utskriften. Duplex‑funktionen möjliggör utskrift på båda sidor av mediet. Varje dokument duplexas separat. DocumentDuplex och JobDuplexAllDocumentsContiguously är ömsesidigt uteslutande. Det är upp till drivrutinen att avgöra hur begränsningar hanteras mellan dessa nyckelord. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentduplex
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentDuplex(Duplex.DuplexOption[] options)](#DocumentDuplex-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Skapar en ny instans. |
## Metoder
