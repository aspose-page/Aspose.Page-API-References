...
description: "Beskriver alternativen för JobRollCutAtEndOfJob och DocumentRollCut‑funktionerna."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Beskriver alternativ för  JobRollCutAtEndOfJob  och  DocumentRollCut  funktionerna .
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Banner](#Banner) | Anger skärningsmetod för banner (endast DocumentRollCut). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Anger skärning vid bildens kant. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Anger skärning för standardmediestorlek. |
| [None](#None) | Anger ingen jobb‑rollskärning. |
## Metoder
...
Anger skärningsmetod för banner (endast DocumentRollCut).
...
Anger skärning vid bildens kant.
...
Anger skärning för standardmediestorlek.
