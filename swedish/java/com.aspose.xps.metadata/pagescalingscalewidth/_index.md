...
description: "Anger skalningsfaktorn i ImageableSizeWidth-riktningen för anpassad skalning."
type: docs
weight: 126
url: /sv/java/com.aspose.xps.metadata/pagescalingscalewidth/
---
**Inheritance:**
...
Anger skalningsfaktorn i  ImageableSizeWidth-riktningen för anpassad skalning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageScalingScaleWidth(int value)](#PageScalingScaleWidth-int-) | Skapar en ny instans. |
## Metoder
