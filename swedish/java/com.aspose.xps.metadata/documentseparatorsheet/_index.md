...
description: "Beskriver användningen av separatorblad för ett dokument."
type: docs
weight: 34
url: /sv/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Beskriver användningen av separatorblad för ett dokument. Separatorblad ska visas i utdata enligt det alternativ som anges nedan. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | En matris av alternativ specifika för funktionen. |
