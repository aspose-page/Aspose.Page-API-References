...
description: "Definierar konstanter för FrontCoating‑värdet för den poängsatta egenskapen."
type: docs
weight: 11
url: /sv/java/com.aspose.xps.metadata/pagemediatype.frontcoating/
---
**Inheritance:**
...
Definierar konstanter för värdet på den poängsatta egenskapen  FrontCoating .
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Glossy](#Glossy) | Glansigt värde. |
| [HighGloss](#HighGloss) | HighGloss värde. |
| [Matte](#Matte) | Matt värde. |
| [None](#None) | Inget värde. |
| [Satin](#Satin) | Satin värde. |
| [SemiGloss](#SemiGloss) | SemiGloss värde. |
## Metoder
