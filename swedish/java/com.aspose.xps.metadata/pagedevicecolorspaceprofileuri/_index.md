...
description: "Anger en relativ URI till paketroten för en ICC‑profil som finns i ett XPS‑dokument."
type: docs
weight: 94
url: /sv/java/com.aspose.xps.metadata/pagedevicecolorspaceprofileuri/
---
**Inheritance:**
...
Anger en relativ URI till paketroten för en ICC-profil som finns i ett XPS-dokument. Bearbetningen av detta alternativ beror på inställningen av funktionen PageDeviceColorSpaceUsage. Alla element som använder den profilen antas redan vara i rätt enhetsfärgrymd och kommer inte att färgstyras i drivrutinen eller enheten. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedevicecolorspaceprofileuri
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageDeviceColorSpaceProfileURI(String value)](#PageDeviceColorSpaceProfileURI-java.lang.String-) | Skapar en ny instans. |
## Metoder
