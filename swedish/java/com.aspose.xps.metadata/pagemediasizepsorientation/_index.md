...
description: "Anger orienteringen i förhållande till matningsorienteringsriktningen https//docs.microsoft.com/en-us/windows/win32rintdocsagemediasizepsorientation"
type: docs
weight: 107
url: /sv/java/com.aspose.xps.metadata/pagemediasizepsorientation/
---
**Inheritance:**
...
Anger orienteringen relativt matningsorienteringsriktningen https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsorientation
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizePSOrientation(int value)](#PageMediaSizePSOrientation-int-) | Skapar en ny instans. |
## Metoder
