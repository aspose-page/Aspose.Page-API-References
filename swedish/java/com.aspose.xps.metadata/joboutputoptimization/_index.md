...
description: "Beskriver jobbbehandlingen som är avsedd att optimera utdata för specifika användningsscenarier enligt det angivna alternativet."
type: docs
weight: 62
url: /sv/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
Beskriver jobbbehandlingen, avsedd att optimera utdata för specifika användningsscenarier enligt det angivna alternativet. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | En matris av alternativ specifika för funktionen. |
