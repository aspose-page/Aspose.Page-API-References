...
description: "Beskriver alternativ för JobOutputOptimization‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/joboutputoptimization.joboutputoptimizationoption/
---
**Inheritance:**
...
Beskriver  JobOutputOptimization  alternativ för funktionen.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ArchiveFormat](#ArchiveFormat) | anger att jobbbehandlingen ska optimeras för arkivutdata. |
| [None](#None) | Anger att jobbbehandlingen inte ska optimeras för ett specifikt scenario. |
| [OptimizeForPortability](#OptimizeForPortability) | Anger att jobbbehandlingen ska optimeras för portabilitet (tvärgående enheter) av utdata. |
| [OptimizeForQuality](#OptimizeForQuality) | Anger att jobbbehandlingen ska optimeras för kvalitet på utdata. |
| [OptimizeForSpeed](#OptimizeForSpeed) | Anger att jobbbehandlingen ska optimeras för hastighet på utdata. |
## Metoder
...
anger att jobbbehandlingen ska optimeras för arkivutdata.
...
Anger att jobbbehandlingen inte ska optimeras för ett specifikt scenario.
...
Anger att jobbbehandlingen ska optimeras för portabilitet (tvärgående enheter) av utdata.
...
Anger att jobbbehandlingen ska optimeras för kvalitet på utdata.
...
Anger att jobbbehandlingen ska optimeras för hastighet på utdata.
