...
description: "Beskriver bindningsmetoden."
type: docs
weight: 45
url: /sv/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Beskriver bindningsmetoden. Alla dokument i jobbet bindas ihop.  JobBindAllDocuments  och  DocumentBinding  är ömsesidigt uteslutande. Det är upp till drivrutinen att avgöra hur begränsningar hanteras mellan dessa nyckelord. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | En matris av alternativ specifika för funktionen. |
