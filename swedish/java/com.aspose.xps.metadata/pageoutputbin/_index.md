...
description: "Beskriver den fullständiga listan över stödjade behållare för enheten."
type: docs
weight: 114
url: /sv/java/com.aspose.xps.metadata/pageoutputbin/
---
**Inheritance:**
...
Beskriver den fullständiga listan över stödda fack för enheten. Tillåter specifikation av utmatningsfack per sida. Nyckelorden  JobOutputBin ,  DocumentOutputBin  och  PageOutputBin  är ömsesidigt uteslutande; endast ett bör anges i ett PrintTicket‑ eller Print Capabilities‑dokument. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageoutputbin
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageOutputBin(OutputBin.IOutputBinItem[] items)](#PageOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Skapar en ny instans. |
## Metoder
