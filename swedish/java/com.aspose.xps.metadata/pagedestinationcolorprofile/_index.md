...
description: "Definierar egenskaperna för mål‑färgprofilen."
type: docs
weight: 91
url: /sv/java/com.aspose.xps.metadata/pagedestinationcolorprofile/
---
**Inheritance:**
...
Definierar egenskaperna för destinationsfärgprofilen. Beskriver huruvida applikationen eller drivrutinen väljer den destinationsfärgprofil som ska användas. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofile
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageDestinationColorProfile(PageDestinationColorProfile.PageDestinationColorProfileOption[] options)](#PageDestinationColorProfile-com.aspose.xps.metadata.PageDestinationColorProfile.PageDestinationColorProfileOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [PageDestinationColorProfileOption\[\]](../../com.aspose.xps.metadata/pagedestinationcolorprofileoption) | En matris av alternativ specifika för funktionen. |
