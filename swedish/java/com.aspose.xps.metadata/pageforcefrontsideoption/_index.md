...
description: "Beskriver alternativ för funktionen PageForceFrontSide."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Beskriver  PageForceFrontSide  funktionens alternativ.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Anger att utskriften är begränsad till framsidan av arket. |
| [None](#None) | Anger att det inte finns några utskriftsbegränsningar. |
## Metoder
...
Anger att utskriften är begränsad till framsidan av arket.
...
Anger att det inte finns några utskriftsbegränsningar.
