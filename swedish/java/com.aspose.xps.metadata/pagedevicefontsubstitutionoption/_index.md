...
description: "Beskriver alternativ för PageDeviceFontSubstitution-funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Beskriver  PageDeviceFontSubstitution  funktionens alternativ.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Off](#Off) | Page device font substitution är avstängd. |
| [On](#On) | Page device font substitution är på. |
## Metoder
...
Page device font substitution är avstängd.
...
Page device font substitution är på.
