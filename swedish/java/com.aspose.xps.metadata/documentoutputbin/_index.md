...
type: docs
weight: 30
url: /sv/java/com.aspose.xps.metadata/documentoutputbin/
---
**Inheritance:**
...
Beskriver den fullständiga listan över stödjade fack för enheten. Tillåter specifikation av utmatningsfack per dokument. Nyckelorden  JobOutputBin ,  DocumentOutputBin  och  PageOutputBin  är ömsesidigt uteslutande; endast en bör specificeras i ett PrintTicket- eller Print Capabilities-dokument. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentoutputbin
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentOutputBin(OutputBin.IOutputBinItem[] items)](#DocumentOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Skapar en ny instans. |
## Metoder
