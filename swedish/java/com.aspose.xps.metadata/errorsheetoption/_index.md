...
description: "Beskriver alternativen för JobErrorSheet‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/joberrorsheet.errorsheetoption/
---
**Inheritance:**
...
Beskriver  JobErrorSheet  alternativ för funktionen.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Custom](#Custom) | Anger att ett anpassat felark ska skrivas ut. |
| [None](#None) | Anger att inget felark ska skrivas ut. |
| [Standard](#Standard) | Anger att det standard (enhetsspecificerade) felarket ska skrivas ut. |
## Metoder
...
Anger att ett anpassat felark ska skrivas ut. Om ett  JobErrorSheetSource   ParameterInit‑element inte anges, ska detta alternativ ignoreras.
...
Anger att inget felark ska skrivas ut.
...
Anger att det standard (enhetsspecificerade) felarket ska skrivas ut.
