...
description: "Anger skalningsfaktorn i ImageableSizeHeight‑riktningen för anpassad skalning."
type: docs
weight: 125
url: /sv/java/com.aspose.xps.metadata/pagescalingscaleheight/
---
**Inheritance:**
...
Anger skalningsfaktorn i  ImageableSizeHeight  riktningen för anpassad skalning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageScalingScaleHeight(int value)](#PageScalingScaleHeight-int-) | Skapar en ny instans. |
## Metoder
