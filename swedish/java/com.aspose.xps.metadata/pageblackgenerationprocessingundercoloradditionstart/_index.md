...
description: "Beskriver skuggnivån under vilken UCA kommer att tillämpas."
type: docs
weight: 85
url: /sv/java/com.aspose.xps.metadata/pageblackgenerationprocessingundercoloradditionstart/
---
**Inheritance:**
...
Beskriver skuggnivån under vilken UCA kommer att tillämpas. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingundercoloradditionstart
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageBlackGenerationProcessingUnderColorAdditionStart(int value)](#PageBlackGenerationProcessingUnderColorAdditionStart-int-) | Skapar en ny instans. |
## Metoder
