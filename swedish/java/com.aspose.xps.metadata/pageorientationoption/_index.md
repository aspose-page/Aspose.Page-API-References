...
description: "Beskriver alternativ för funktionen PageOrientation."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pageorientation.pageorientationoption/
---
**Inheritance:**
...
Beskriver  PageOrientation  funktionsalternativ.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Landscape](#Landscape) | Innehållet är roterat på sidan 90 grader moturs i förhållande till standard (stående) orientering. |
| [Portrait](#Portrait) | Standardorientering. |
| [ReverseLandscape](#ReverseLandscape) | Innehållet är roterat på sidan 270 grader moturs i förhållande till standard (stående) orientering. |
| [ReversePortrait](#ReversePortrait) | Innehållet är roterat på sidan 180 grader i förhållande till standard (stående) orientering. |
## Metoder
...
Innehållet är roterat på sidan 90 grader moturs i förhållande till standard (stående) orientering.
...
Innehållet är roterat på sidan 270 grader moturs i förhållande till standard (stående) orientering.
...
Innehållet är roterat på sidan 180 grader i förhållande till standard (stående) orientering.
