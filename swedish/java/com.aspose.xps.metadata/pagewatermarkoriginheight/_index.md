...
description: "Anger ursprunget för ett vattenstämpel relativt ursprunget för PageImageableSize."
type: docs
weight: 132
url: /sv/java/com.aspose.xps.metadata/pagewatermarkoriginheight/
---
**Inheritance:**
...
Anger ursprunget för ett vattenmärke relativt ursprunget för  PageImageableSize . https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageWatermarkOriginHeight(int value)](#PageWatermarkOriginHeight-int-) | Skapar en ny instans. |
## Metoder
