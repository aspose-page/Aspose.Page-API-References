...
description: "Beskriver bannerbladet som ska skrivas ut för jobbet."
type: docs
weight: 64
url: /sv/java/com.aspose.xps.metadata/jobprimarybannersheet/
---
**Inheritance:**
...
Beskriver bannerbladet som ska skrivas ut för jobbet. Bannerbladet ska skrivas ut med standard‑PageMediaSize och med standard‑PageMediaType. Bannerbladet ska vara isolerat från resten av jobbet. Detta innebär att eventuella efterbehandlings‑ eller bearbetningsalternativ (såsom JobDuplexAllDocumentsContiguously, JobStapleAllDocuments eller JobBindAllDocuments) inte ska inkludera bannerbladet. Bannerbladet ska vara det första bladet i jobbet.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobPrimaryBannerSheet(JobPrimaryBannerSheet.BannerSheetOption[] options)](#JobPrimaryBannerSheet-com.aspose.xps.metadata.JobPrimaryBannerSheet.BannerSheetOption...-) | Skapar en ny instans. |
## Metoder
