...
description: "Tvingar utdata att visas på framsidan av ett medieark."
type: docs
weight: 97
url: /sv/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Tvingar utskriften att visas på framsidan av ett medieark. Relevant för medieark med olika ytor på varje sida. I fall där denna funktion stör bearbetningsalternativ (såsom  DocumentDuplex ), har  PageForceFrontSide  företräde för den specifika sidan som funktionen gäller för.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | En matris av alternativ specifika för funktionen. |
