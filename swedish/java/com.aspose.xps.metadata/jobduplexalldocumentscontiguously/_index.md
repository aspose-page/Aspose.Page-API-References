...
description: "Beskriver duplexegenskaperna för utskriften."
type: docs
weight: 52
url: /sv/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Beskriver duplex‑egenskaperna för utskriften. Duplex‑funktionen möjliggör utskrift på båda sidor av mediet. Alla Dokument i jobbet duplexas tillsammans i följd.  JobDuplexAllDocumentsContiguously  och  DocumentDuplex  är ömsesidigt uteslutande. Det är upp till drivrutinen att avgöra hur begränsningar hanteras mellan dessa nyckelord. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [DuplexOption\[\]](../../com.aspose.xps.metadata/duplexoption) | En matris av alternativ specifika för funktionen. |
