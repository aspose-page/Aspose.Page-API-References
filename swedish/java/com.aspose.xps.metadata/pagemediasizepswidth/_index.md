...
description: "Anger sidans bredd vinkelrätt mot matningsorienteringsriktningen."
type: docs
weight: 108
url: /sv/java/com.aspose.xps.metadata/pagemediasizepswidth/
---
**Inheritance:**
...
Anger sidans bredd vinkelrätt mot matningsorienteringsriktningen. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidth
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizePSWidth(int value)](#PageMediaSizePSWidth-int-) | Skapar en ny instans. |
## Metoder
