...
description: "Anger förskjutningen vinkelrätt mot matningsorienteringsriktningen."
type: docs
weight: 109
url: /sv/java/com.aspose.xps.metadata/pagemediasizepswidthoffset/
---
**Inheritance:**
...
Anger förskjutningen vinkelrätt mot matningsorienteringens riktning. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidthoffset
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageMediaSizePSWidthOffset(int value)](#PageMediaSizePSWidthOffset-int-) | Skapar en ny instans. |
## Metoder
