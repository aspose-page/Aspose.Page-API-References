...
description: "Beskriver punkten i intervallet från högdagrar till skuggor där GCR ska börja 100% mörkaste skugga."
type: docs
weight: 82
url: /sv/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementstart/
---
**Inheritance:**
...
Beskriver punkten i intervallet \"highlight to shadow\" där GCR ska börja (100 % mörkaste skugga). https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementstart
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementStart(int value)](#PageBlackGenerationProcessingGrayComponentReplacementStart-int-) | Skapar en ny instans. |
## Metoder
