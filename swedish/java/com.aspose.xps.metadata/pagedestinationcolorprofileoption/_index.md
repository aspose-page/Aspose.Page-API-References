...
description: "Beskriver alternativ för PageDestinationColorProfile-funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Beskriver alternativ för funktionen PageDestinationColorProfile.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Application](#Application) | Applikationen anger den destinationsprofil som ska användas. |
| [DriverConfiguration](#DriverConfiguration) | Destinationsprofil som används för färghantering. |
## Metoder
...
Applikationen anger den destinationsprofil som ska användas.
...
Destinationsprofil som används för färghantering.
