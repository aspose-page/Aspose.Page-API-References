...
description: "Beskriver alternativ för Layering-funktionen."
type: docs
weight: 11
url: /sv/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Beskriver alternativ för  Layering  funktionen .
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Overlay](#Overlay) | Vattenstämpel visas ovanför sidinnehållet. |
| [Underlay](#Underlay) | Vattenstämpel visas under sidinnehållet. |
## Metoder
...
Vattenstämpel visas ovanför sidinnehållet.
...
Vattenstämpel visas under sidinnehållet.
