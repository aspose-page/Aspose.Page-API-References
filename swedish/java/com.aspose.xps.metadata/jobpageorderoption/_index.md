...
description: "Beskriver alternativen för JobPageOrder-funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Beskriver  JobPageOrder  alternativ för funktionen.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Reverse](#Reverse) | Anger sidordning bakifrån till framifrån. |
| [Standard](#Standard) | Anger sidordning framifrån till bakifrån. |
## Metoder
...
Anger sidordning bakifrån till framifrån.
...
Anger sidordning framifrån till bakifrån.
