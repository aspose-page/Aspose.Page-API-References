...
description: "Anger den procentandel av gråkomponentutbyte som ska utföras."
type: docs
weight: 81
url: /sv/java/com.aspose.xps.metadata/pageblackgenerationprocessinggraycomponentreplacementlevel/
---
**Inheritance:**
...
Anger den procentandel av gråkomponentsersättning som ska utföras. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessinggraycomponentreplacementlevel
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PageBlackGenerationProcessingGrayComponentReplacementLevel(int value)](#PageBlackGenerationProcessingGrayComponentReplacementLevel-int-) | Skapar en ny instans. |
## Metoder
