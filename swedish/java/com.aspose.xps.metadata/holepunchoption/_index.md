...
description: "Beskriver alternativ för HolePunch‑funktionen."
type: docs
weight: 10
url: /sv/java/com.aspose.xps.metadata/holepunch.holepunchoption/
---
**Inheritance:**
...
Beskriver  HolePunch  funktionens alternativ.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [BottomEdge](#BottomEdge) | Anger hål längs den nedre kanten. |
| [LeftEdge](#LeftEdge) | Anger hål längs den vänstra kanten. |
| [None](#None) | Anger att ingen håltagning sker. |
| [RightEdge](#RightEdge) | Anger hål längs den högra kanten. |
| [TopEdge](#TopEdge) | Anger hål längs den övre kanten. |
## Metoder
...
Anger att ingen håltagning sker.
