...
description: "Beskriver skärningsmetoden för rullpapper."
type: docs
weight: 33
url: /sv/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Beskriver skärningsmetoden för rullpapper. Varje dokument hanteras separat. De angivna alternativen beskriver de olika metoderna för rullskärning. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Skapar en ny instans. |
## Metoder
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | En matris av alternativ specifika för funktionen. |
