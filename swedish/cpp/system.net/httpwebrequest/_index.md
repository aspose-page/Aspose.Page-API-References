...
| Metod | Beskrivning |
| --- | --- |
| [Abort](./abort/)() override | Avbryter den aktuella begäran. |
| virtual [AddRange](./addrange/)(int32_t) | Lägger till 'Range'-huvudet i den aktuella begäran. |
| virtual [AddRange](./addrange/)(System::String, int32_t, int32_t) | Lägger till 'Range'-huvudet i den aktuella begäran. |
...
| [BeginGetResponse](./begingetresponse/)(AsyncCallback, System::SharedPtr\<Object\>) override | Initierar en asynkron begäran om resursen. |
...
| [EndGetResponse](./endgetresponse/)(System::SharedPtr\<IAsyncResult\>) override | Väntar tills den angivna asynkrona begäran om resursen är klar. |
...
| [get_ContentLength](./get_contentlength/)() override | Hämtar antalet byte av begärans data som ska skickas. |
...
| virtual [get_CookieContainer](./get_cookiecontainer/)() | Hämtar en cookiebehållare som är associerad med den aktuella webb‑begäran. |
...
| virtual [get_Referer](./get_referer/)() | Hämtar ett värde för 'Referer'-huvudet. |
...
| virtual [get_SupportsCookieContainer](./get_supportscookiecontainer/)() | Returnerar ett värde som indikerar om den aktuella begäran kan använda en cookie-behållare. |
| [get_Timeout](./get_timeout/)() override | Hämtar en tid i millisekunder efter vilken begäran tidsöverskrids. |
...
| virtual [get_UserAgent](./get_useragent/)() | Hämtar ett värde för headern 'User-Agent'. |
...
| [set_Accept](./set_accept/)(String) | Ställer in värdet för HTTP-headern 'Accept'. |
...
| virtual [set_CookieContainer](./set_cookiecontainer/)(System::SharedPtr\<System::Net::CookieContainer\>) | Ställer in en cookie-behållare som är associerad med den aktuella webbförfrågan. |
...
| [set_Headers](./set_headers/)(System::SharedPtr\<WebHeaderCollection\>) override | Ställer in samlingen av HTTP-headern. |
| virtual [set_KeepAlive](./set_keepalive/)(bool) | Ställer in ett värde som indikerar om den aktuella begäran måste innehålla headern 'Keep-Alive'. |
...
| [set_Timeout](./set_timeout/)(int) override | Ställer in en tidsmängd i millisekunder efter vilken begäran får timeout. |
