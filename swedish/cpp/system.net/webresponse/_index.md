...
| virtual [get_ContentType](./get_contenttype/)() | Returnerar resursens MIME-typ. |
| virtual [get_Headers](./get_headers/)() | Returnerar samlingen av headers som är associerade med det aktuella svaret. |
| virtual [get_ResponseUri](./get_responseuri/)() | Returnerar resursens URI. |
| virtual [get_SupportsHeaders](./get_supportsheaders/)() | Returnerar ett värde som indikerar om det aktuella svaret stöder rubriker. |
