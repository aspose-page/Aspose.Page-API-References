---
title: "System::Net::WebProxy::WebProxy konstruktor"
linktitle: "WebProxy"
second_title: "Aspose.Page för C++"
description: "System::Net::WebProxy::WebProxy konstruktor. Skapar en ny instans i C++."
type: docs
weight: 100
url: /sv/cpp/system.net/webproxy/webproxy/
---
...
| --- | --- | --- |
| Adress | String | Proxyserverns adress. |
...
| --- | --- | --- |
| Adress | String | Proxyserverns adress. |
| BypassOnLocal | bool | Ett värde som indikerar om proxyservern måste användas för lokala adresser. |
...
| Adress | String | Proxyserverns adress. |
| BypassOnLocal | bool | Ett värde som indikerar om proxyservern måste användas för lokala adresser. |
| BypassList | System::ArrayPtr\<String\> | Listan över adresser som inte använder proxyservern. |
...
| BypassOnLocal | bool | Ett värde som indikerar om proxyservern måste användas för lokala adresser. |
| BypassList | System::ArrayPtr\<String\> | Listan över adresser som inte använder proxyservern. |
| Referenser | System::SharedPtr\<ICredentials\> | Referenserna som skickas till proxyservern för autentisering. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| Adress | System::SharedPtr\<Uri\> | Proxyserverns adress. |
