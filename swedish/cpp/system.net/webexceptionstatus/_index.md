...
Enumererar statuskoderna för klassen [WebException](../webexception/).
...
| NameResolutionFailure | 1 | Namnlösningstjänsten kunde inte lösa upp värdnamnet. |
...
| PipelineFailure | 5 | Begäran var en pipelined‑begäran och anslutningen stängdes innan svaret mottogs. |
...
| Väntande | 13 | En intern asynkron begäran är pågående. |
| Tidsgräns | 14 | Inget svar mottogs under tidsgränsen för en begäran. |
| ProxyNameResolutionFailure | 15 | Namnlösningstjänsten kunde inte lösa proxyvärdens namn. |
