...
| [idx_get](./idx_get/)(int32_t) | Returnerar en kaka från kakssamlingen på det angivna indexet. |
| [idx_get](./idx_get/)(String) | Returnerar en kaka från kakssamlingen enligt angivet namn. |
| [IndexOf](./indexof/)(System::SharedPtr\<Cookie\>) | Returnerar ett index för den angivna cookien. |
| [InternalAdd](./internaladd/)(System::SharedPtr\<Cookie\>, bool) | Lägger till den angivna cookien i samlingen. |
| [Remove](./remove/)(const System::SharedPtr\<Cookie\>\&) override | Tar bort den angivna cookien från samlingen. |
| [RemoveAt](./removeat/)(int32_t) | Tar bort en cookie på det angivna indexet. |
