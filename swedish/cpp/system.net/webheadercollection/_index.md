...
| [idx_get](./idx_get/)(HttpRequestHeader) | Hämtar rubrikvärdet med den angivna förfrågningens rubrik. |
...
| [idx_set](./idx_set/)(HttpRequestHeader, String) | Sätter rubrikvärdet för den angivna rubriken. |
| [idx_set](./idx_set/)(HttpResponseHeader, String) | Sätter rubrikvärdet med den angivna svarsrubriken. |
| [idx_set](./idx_set/)(String, String) | Sätter rubrikvärdet med det angivna rubriknamnet. |
| static [IsRestricted](./isrestricted/)(const String\&) | Testar om den angivna HTTP-rubriken kan sättas för förfrågan. |
| [Remove](./remove/)(String) | Tar bort headern med det angivna headernamnet. |
| [Remove](./remove/)(HttpResponseHeader) | Tar bort den angivna response-headern. |
| [Remove](./remove/)(HttpRequestHeader) | Tar bort den angivna request-headern. |
