...
description: "System::Xml::Xsl::IXsltContextFunction-klass. Tillhandahåller ett gränssnitt till en given funktion som definierats i Extensible Stylesheet Language for Transformations (XSLT)-stilmallen under körning i C++."
type: docs
weight: 100
...
| virtual [Invoke](./invoke/)(SharedPtr\<XsltContext\>, ArrayPtr\<SharedPtr\<Object\>\>, SharedPtr\<System::Xml::XPath::XPathNavigator\>) | Tillhandahåller metoden för att anropa funktionen med de givna argumenten i den givna kontexten. |
## Se även
