...
description: "System::Xml::Xsl::XsltArgumentList::GetParam metod. Returnerar parametern som är associerad med det namn som är kvalificerat med namnutrymmet i C++."
type: docs
weight: 600
...
| --- | --- | --- |
| name | const String\& | Namnet på parametern. [XsltArgumentList](../) kontrollerar inte att namnet som skickas är ett giltigt lokalt namn; dock kan inte namnet vara **nullptr**. |
