...
description: "System::Collections::BitArray klass. En array av bitar som kan adresseras med index. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Wrappa alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 100
...
| [And](./and/)(const BitArrayPtr\&) | Beräknar bitvis 'and' mellan två BitSet. |
...
| [Remove](./remove/)(const bool\&) override | Returnerar första förekomsten av angivet värde. Inte implementerad. |
| [Set](./set/)(int, bool) | Sätter [BitArray](./) element. |
| [SetAll](./setall/)(bool) | Sätter alla element till ett specifikt värde. |
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Formell implementering av svag mallargumentmekanism; ej tillämplig på denna klass. |
