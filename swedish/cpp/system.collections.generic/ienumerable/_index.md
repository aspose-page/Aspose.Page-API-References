...
| [LINQ_Count](./linq_count/)() | Returnerar antalet element i sekvensen (beräknat genom direkt uppräkning). |
...
| virtual [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const | Hämtar implementationen av begin const iterator för den aktuella behållaren. |
| virtual [virtualizeBeginIterator](./virtualizebeginiterator/)() | Hämtar implementationen av begin iterator för den aktuella behållaren. |
...
| [ValueType](./valuetype/) |  |
| [virtualized_iterator](./virtualized_iterator/) | Inre iteratorbas-typ. |
| [virtualized_iterator_element](./virtualized_iterator_element/) | Inre iteratorns elementtyp. |
