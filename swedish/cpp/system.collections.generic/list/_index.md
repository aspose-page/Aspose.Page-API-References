...
description: "System::Collections::Generic::List klass. Framåtriktad deklaration av List i C++."
type: docs
weight: 3300
...
| [Add](./add/)(const T\&) override | Lägger till ett element i slutet av listan. |
| [AddInitializer](./addinitializer/)(int, const T *) | Lägger till element i listan; används vid översättning av initierare. |
| [AddRange](./addrange/)(IEnumerablePtr) | Lägger till alla element från samling (eller sig själv) i slutet av den aktuella listan. |
...
| [begin](./begin/)() const | Hämtar iterator till det första elementet i den const‑kvalificerade samlingen. |
...
| [cend](./cend/)() const | Hämtar iterator för ett icke‑existerande const‑kvalificerat element bakom slutet av samlingen. |
...
| [data](./data/)() | Underliggande datastruktur‑åtkomstfunktion. |
| [data](./data/)() const | Underliggande datastruktur‑åtkomstfunktion. |
| [end](./end/)() | Hämtar iterator för ett icke‑existerande element bakom slutet av samlingen. |
...
| [Find](./find/)(System::Predicate\<T\>) | Söker efter ett element som uppfyller ett specifikt predikat. |
| [FindAll](./findall/)(System::Predicate\<T\>) | Söker efter element som uppfyller ett specifikt predikat. |
| [FindIndex](./findindex/)(System::Predicate\<T\>) | Söker efter ett element som uppfyller ett specifikt predikat. |
| [FindIndex](./findindex/)(int, System::Predicate\<T\>) | Söker efter ett element som uppfyller ett specifikt predikat. |
| [FindIndex](./findindex/)(int, int, System::Predicate\<T\>) | Söker efter ett element som uppfyller ett specifikt predikat. |
| [FindLast](./findlast/)(System::Predicate\<T\>) | Söker efter det sista elementet som uppfyller ett specifikt predikat. |
| [ForEach](./foreach/)(System::Action\<T\>) | Applicerar åtgärd på alla element i listan. |
...
| [GetRange](./getrange/)(int, int) | Skapar en del av listan. |
| [idx_get](./idx_get/)(int) const override | Hämtar element på en specifik position. |
| [idx_set](./idx_set/)(int, T) override | Sätter elementet på en specifik position. |
...
| [Remove](./remove/)(const T\&) override | Tar bort den första förekomsten av ett specifikt objekt från listan. |
| [RemoveAll](./removeall/)(Predicate\<T\>) | Tar bort alla element som matchar ett specifikt villkor. |
...
| [ToArray](./toarray/)() const | Konverterar listan till en array. |
...
int main()
{
  ...
  // Den första listans element kommer att vara: {-5, 1, 3, 8}
  list1->Sort();

  // Ta bort elementet vid index 2.
  // Den första listans element kommer att vara: {-5, 1, 8}
  list1->RemoveAt(2);

  // Infoga elementet på index 1.
  // Den första listans element kommer att vara: {-5, 15, 1, 8}
  list1->Insert(1, 15);
  ...
  // Skriv ut objekten i den första listan.
