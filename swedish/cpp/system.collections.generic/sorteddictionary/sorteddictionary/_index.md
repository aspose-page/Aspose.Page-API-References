...
description: "System::Collections::Generic::SortedDictionary::SortedDictionary konstruktor. Skapar en tom dictionary i C++."
type: docs
weight: 200
url: /sv/cpp/system.collections.generic/sorteddictionary/sorteddictionary/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<typename BasePointerType\<TKey\>::type\>\>\& | [Comparer](../../comparer/) att använda. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Källdictionary att kopiera data från. |
