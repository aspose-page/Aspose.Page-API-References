...
| [Dictionary](./dictionary/)(const map_t\&) | Kopierar data från map. |
| [Dictionary](./dictionary/)(int) | Överlagring som motsvarar att skapa en förallokerad dictionary; allokerar faktiskt inget. |
