...
description: "Hur man använder System::Collections::Generic::BaseSet klass i C++."
type: docs
weight: 800
...
| [Add](./add/)(const T\&) override | Lägger till element i mängden. |
...
| [Clear](./clear/)() override | Raderar alla element i mängden. |
| [Contains](./contains/)(const T\&) const override | Kontrollerar om elementet finns i mängden. |
...
| [GetEnumerator](./getenumerator/)() override | Skapar enumerator. |
| [Remove](./remove/)(const T\&) override | Tar bort elementet från mängden. |
| [TryAdd](./tryadd/)(const T\&) | Lägger till element i mängden. |
