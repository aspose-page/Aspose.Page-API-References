...
description: "System::Collections::Generic::Stack-klass. Framåtriktad deklaration av Stack-klass i C++."
type: docs
weight: 4600
...
| virtual [Clear](./clear/)() | Tar bort alla element från stacken. |
...
| [GetEnumerator](./getenumerator/)() override | Hämtar enumerator för att iterera genom aktuell stack. |
| [Peek](./peek/)() | Hämtar element från stackens topp, men behåller det i stacken. |
| [Pop](./pop/)() | Hämtar elementet från toppen av stacken. |
| [Push](./push/)(const T\&) | Lägger elementet på toppen av stacken. |
