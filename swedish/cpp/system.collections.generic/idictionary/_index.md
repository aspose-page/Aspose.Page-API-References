...
description: "System::Collections::Generic::IDictionary klass. Gränssnitt för dictionary‑liknande behållare. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr‑pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 2100
...
Gränssnitt för dictionary‑liknande behållare. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)‑pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [CopyTo](./copyto/)(ArrayPtr\<KeyValuePair\<TKey, TValue\>\>, int) override | Kopierar dictionary‑innehåll till befintliga array‑element. |
...
| virtual [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Returnerar värde om det hittas; eller **null** annars, meningsfullt endast för referenstyper. |
