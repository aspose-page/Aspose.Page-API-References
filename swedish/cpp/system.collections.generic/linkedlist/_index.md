...
| [Find](./find/)(const T\&) const | Utför sökning i framåtriktning efter ett **element** i listan. |
| [FindLast](./findlast/)(const T\&) const | Utför sökning i omvänd riktning efter ett **element** i listan. |
...
| [Remove](./remove/)(const T\&) override | Tar bort den första förekomsten av det angivna **element** från listan. |
| [Remove](./remove/)(const SharedPtr\<LinkedListNode\<T\>\>\&) | Tar bort nod från listan. |
...
Länkad listbehållare. Implementerar ett omslag över std::list. Objekt av denna klass bör endast allokeras med hjälp av [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
