...
| [Clear](./clear/)() override | Raderar alla element från behållaren. |
...
| [IndexOf](./indexof/)(const T\&) const override | Hämtar index för objekt i behållaren. |
| [Insert](./insert/)(int, const T\&) override | Infogar objekt på angiven position. |
| [Remove](./remove/)(const T\&) override | Tar bort objekt från behållaren. |
