...
description: "System::Collections::Generic::ReverseEnumerator-klass. Enumerator som itererar baklänges genom behållaren. Objekt av denna klass bör endast allokeras med System::MakeObject() funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 3800
...
| --- | --- |
| Behållare | Behållare för att iterera igenom. |
| Element | Elementtyp. |
## Metoder
...
| [MoveNext](./movenext/)() override | Enumerator-stilökning. |
