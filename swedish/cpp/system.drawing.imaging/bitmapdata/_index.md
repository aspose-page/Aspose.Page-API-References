...
| [get_Stride](./get_stride/)() const | Returnerar radbredden för bilden i byte. |
...
| [set_Stride](./set_stride/)(int) | Ställer in radbredden för bilden i byte. |
