...
| Format32bppRgb | n/a | Anger att pixelformatet är 32 bitar per pixel med 8 bitar för varje av de röda, gröna och blå komponenterna och de återstående 8 bitarna används inte. |
| Format32bppArgb | n/a | Anger att pixelformatet är 32 bitar per pixel med 8 bitar för varje av de röda, gröna och blå komponenterna och 8 bitar för alfa. |
| Format32bppPArgb | n/a | Anger att pixelformatet är 32 bitar per pixel med 8 bitar för varje av de röda, gröna och blå komponenterna och 8 bitar för alfa. De röda, gröna och blå komponenterna är förmultiplicerade enligt värdet på alfakomponenten. |
| Format48bppRgb | n/a | Anger att pixelformatet är 48 bitar per pixel med 16 bitar för varje av de röda, gröna och blå komponenterna. |
| Format64bppArgb | n/a | Anger att pixelformatet är 64 bitar per pixel med 16 bitar för varje av de röda, gröna och blå komponenterna och 16 bitar för alfa. |
| Format64bppPArgb | n/a | Anger att pixelformatet är 64 bitar per pixel med 16 bitar för varje av de röda, gröna och blå komponenterna och 16 bitar för alfa. De röda, gröna och blå komponenterna är förmultiplicerade enligt värdet på alfakomponenten. |
...
| Max | 16 | Det maximala värdet för detta uppräkning. |
