---
title: "System::Drawing::Imaging::ColorMatrix klass"
linktitle: "ColorMatrix"
second_title: "Aspose.Page för C++"
description: "System::Drawing::Imaging::ColorMatrix klass. Representerar en 5x5-matris som innehåller koordinaterna för färgrymden RGBAW. Objekt av denna klass bör endast allokeras med hjälp av System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 300
...
Representerar en 5x5-matris som innehåller koordinaterna för färgrymden RGBAW. Objekt av denna klass bör endast allokeras med hjälp av [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [set_Matrix11](./set_matrix11/)(float) | Sätter ett värde i den 1:a raden och den 1:a kolumnen. |
| [set_Matrix12](./set_matrix12/)(float) | Sätter ett värde i den 1:a raden och den 2:a kolumnen. |
| [set_Matrix13](./set_matrix13/)(float) | Sätter ett värde i den 1:a raden och den 3:e kolumnen. |
| [set_Matrix14](./set_matrix14/)(float) | Sätter ett värde i den 1:a raden och den 4:e kolumnen. |
| [set_Matrix20](./set_matrix20/)(float) | Sätter ett värde i den 2:a raden och den 0:e kolumnen. |
| [set_Matrix21](./set_matrix21/)(float) | Sätter ett värde i den 2:a raden och den 1:a kolumnen. |
| [set_Matrix22](./set_matrix22/)(float) | Sätter ett värde i den 2:a raden och den 2:a kolumnen. |
| [set_Matrix23](./set_matrix23/)(float) | Sätter ett värde i den 2:a raden och den 3:e kolumnen. |
| [set_Matrix24](./set_matrix24/)(float) | Sätter ett värde i den 2:a raden och den 4:e kolumnen. |
| [set_Matrix30](./set_matrix30/)(float) | Sätter ett värde i den 3:e raden och den 0:e kolumnen. |
| [set_Matrix31](./set_matrix31/)(float) | Sätter ett värde i den 3:e raden och den 1:a kolumnen. |
| [set_Matrix32](./set_matrix32/)(float) | Sätter ett värde i den 3:e raden och den 2:a kolumnen. |
| [set_Matrix33](./set_matrix33/)(float) | Sätter ett värde i den 3:e raden och den 3:e kolumnen. |
| [set_Matrix34](./set_matrix34/)(float) | Sätter ett värde i den 3:e raden och den 4:e kolumnen. |
| [set_Matrix40](./set_matrix40/)(float) | Sätter ett värde i den 4:e raden och den 0:e kolumnen. |
| [set_Matrix41](./set_matrix41/)(float) | Sätter ett värde i den 4:e raden och den 1:a kolumnen. |
| [set_Matrix42](./set_matrix42/)(float) | Sätter ett värde i den 4:e raden och den 2:a kolumnen. |
| [set_Matrix43](./set_matrix43/)(float) | Sätter ett värde i den 4:e raden och den 3:e kolumnen. |
| [set_Matrix44](./set_matrix44/)(float) | Sätter ett värde i den 4:e raden och den 4:e kolumnen. |
## Se även
