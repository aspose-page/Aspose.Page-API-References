...
| [GetHenhmetafile](./gethenhmetafile/)() | INTE IMPLEMENTERAT. |
| [GetMetafileHeader](./getmetafileheader/)() | Returnerar ett header som är associerat med det aktuella objektet. |
| [Metafile](./metafile/)(const System::String\&) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(const SharedPtr\<System::IO::Stream\>\&) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(const SharedPtr\<System::IO::Stream\>\&, IntPtr, EmfType) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(const SharedPtr\<System::IO::Stream\>\&, IntPtr) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(const SharedPtr\<System::IO::Stream\>\&, IntPtr, Rectangle, MetafileFrameUnit, EmfType) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(const SharedPtr\<System::IO::Stream\>\&, IntPtr, RectangleF, MetafileFrameUnit, EmfType) | INTE IMPLEMENTERAT. |
| [Metafile](./metafile/)(IntPtr, EmfType) | INTE IMPLEMENTERAT. |
| [PlayRecord](./playrecord/)(EmfPlusRecordType, int32_t, int32_t, System::ByteArrayPtr) | INTE IMPLEMENTERAT. |
