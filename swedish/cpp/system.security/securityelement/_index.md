...
| [SearchForTextOfTag](./searchfortextoftag/)(const String\&) | Hämtar underordnad tags inre text efter taggnamn. |
...
| [set_Attributes](./set_attributes/)(System::Collections::Generic::Dictionary\<String, String\>) | Ställer in taggattribut. |
| [set_Children](./set_children/)(System::Collections::Generic::List\<SecurityElement\>) | Ställer in taggens underobjekt. |
