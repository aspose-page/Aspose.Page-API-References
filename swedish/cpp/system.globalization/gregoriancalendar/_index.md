---
title: "System::Globalization::GregorianCalendar-klass"
linktitle: "GregorianCalendar"
second_title: "Aspose.Page för C++"
description: "System::Globalization::GregorianCalendar-klass. Gregoriansk kalender. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 1000
url: /sv/cpp/system.globalization/gregoriancalendar/
---
## GregorianCalendar class


Gregoriansk kalender. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| virtual [get_CalendarType](./get_calendartype/)() const | Hämtar typ av gregoriansk kalender. |
...
| static [GetDefaultInstance](./getdefaultinstance/)() | Hämtar standardinstans av gregoriansk kalender. |
...
| [GregorianCalendar](./gregoriancalendar/)(GregorianCalendarTypes) | Skapar specifik gregoriansk kalender. |
...
| [IsLeapMonth](./isleapmonth/)(int, int, int) const override | Kontrollerar om månaden är skottår. |
...
| virtual [set_CalendarType](./set_calendartype/)(GregorianCalendarTypes) | Ställer in typ av gregoriansk kalender. |
