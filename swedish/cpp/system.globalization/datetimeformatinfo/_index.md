...
description: "System::Globalization::DateTimeFormatInfo klass. Uppsättning av datum- och tidsformateringsparametrar. Objekt av denna klass bör endast allokeras med System::MakeObject()‑funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr‑pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 600
...
Uppsättning av datum- och tidsformateringsparametrar. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)‑funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)‑pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [get_CalendarWeekRule](./get_calendarweekrule/)() const | Hämtar kalenderveckoregler associerade med formateraren. |
| static [get_CurrentInfo](./get_currentinfo/)() | Hämtar aktuell tråds datum- och tidsformaterare. |
| [get_DateSeparator](./get_dateseparator/)() const | Hämtar datumseparator. |
| [get_DayNames](./get_daynames/)() const | Hämtar dagnamn. |
| [get_FirstDayOfWeek](./get_firstdayofweek/)() const | Hämtar den första dagen i veckan. |
| [get_FullDateTimePattern](./get_fulldatetimepattern/)() const | Hämtar fullständigt datum- och tidsformat. |
| static [get_InvariantInfo](./get_invariantinfo/)() | Hämtar invariant datum- och tidsformatterare. |
| [get_IsReadOnly](./get_isreadonly/)() const | Kontrollerar om formatteraren är skrivskyddad. |
...
| [get_MonthDayPattern](./get_monthdaypattern/)() const | Hämtar månad‑dag‑format. |
...
| [get_NativeCalendarName](./get_nativecalendarname/)() const | Hämtar inbyggt kalendernamn om tillgängligt. |
| [get_PMDesignator](./get_pmdesignator/)() const | Hämtar PM designator. |
| [get_RFC1123Pattern](./get_rfc1123pattern/)() const | Hämtar RFC1123‑format. |
| [get_ShortDatePattern](./get_shortdatepattern/)() const | Hämtar kort datumformat. |
| [get_ShortestDayNames](./get_shortestdaynames/)() const | Hämtar kortaste möjliga dagnamn. |
...
| [GetAllDateTimePatterns](./getalldatetimepatterns/)() const | Hämtar alla mönster som datum‑ och tidsvärden kan formateras med. |
| [GetAllDateTimePatterns](./getalldatetimepatterns/)(char16_t) const | Hämtar alla mönster som datum‑ och tidsvärden kan formateras med med angiven formatsträng. |
| [GetDayName](./getdayname/)(DayOfWeek) const | Hämtar veckodagens namn. |
| [GetEra](./getera/)(const String\&) const | Hämtar era efter namn. |
| [GetEraName](./geteraname/)(int) const | Hämtar erans namn. |
...
| [GetMonthGenitiveName](./getmonthgenitivename/)(int) const | Hämtar genitiv månadsnamn. |
| [GetMonthName](./getmonthname/)(int) const | Hämtar månadsnamn. |
| [GetShortestDayName](./getshortestdayname/)(DayOfWeek) const | Hämtar kortaste namn för den angivna veckodagen. |
...
| [set_AMDesignator](./set_amdesignator/)(const String\&) | Ställer in AM-designator. |
...
| [set_FirstDayOfWeek](./set_firstdayofweek/)(DayOfWeek) | Ställer in första veckodagen. |
...
| [set_MonthDayPattern](./set_monthdaypattern/)(const String\&) | Ställer in månads-dag-format. |
...
| [set_PMDesignator](./set_pmdesignator/)(const String\&) | Ställer in PM-designator. |
