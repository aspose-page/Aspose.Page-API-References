---
title: "System::Globalization::CultureInfo::CultureInfo konstruktor"
linktitle: "CultureInfo"
second_title: "Aspose.Page för C++"
description: "System::Globalization::CultureInfo::CultureInfo konstruktor. Konstruktor i C++."
type: docs
weight: 100
url: /sv/cpp/system.globalization/cultureinfo/cultureinfo/
---
...
| --- | --- | --- |
| namn | const String\& | Kulturnamn. |
| use_user_override | bool | Om sant, använd användardefinierade värden istället för system; PARAMETERN IGNORERAS. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| kultur | int | Kulturidentifierare. |
## Anmärkningar
