...
description: "System::Globalization::RegionInfo klass. Tillhandahåller information om regionen. Objekt av denna klass bör endast allokeras med System::MakeObject()‑funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr‑pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 2100
...
Tillhandahåller information om regionen. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)‑funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)‑pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| virtual [get_CurrencySymbol](./get_currencysymbol/)() const | Hämtar valutasymbolen. |
...
| virtual [get_IsMetric](./get_ismetric/)() const | Kontrollerar om regionen använder metriskt system. |
