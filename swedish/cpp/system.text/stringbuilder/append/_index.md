...
description: "System::Text::StringBuilder::Append-metod. Lägger till tecken i byggaren i C++."
type: docs
weight: 300
...
| --- | --- | --- |
| arr | const ArrayPtr\<char_t\>\& | Tecken att lägga till. |
| startIndex | int | Slice startindex. |
...
Lägger till enumvärdets strängrepresentation till byggaren.
