...
description: "System::Text::StringBuilder::Replace method. Ersätter tecken genom byggaren i C++."
type: docs
weight: 1500
url: /sv/cpp/system.text/stringbuilder/replace/
---
## StringBuilder::Replace(char_t, char_t) method


Ersätter tecken genom byggaren.
...
| --- | --- | --- |
| oldChar | char_t | Tecken att ersätta. |
| newChar | char_t | Ersättningstecken. |
...
Ersätter tecken genom byggarens intervall.
...
| oldChar | char_t | Tecken att ersätta. |
| newChar | char_t | Ersättningstecken. |
| startIndex | int | Byggarens ersättningsintervalls startposition. |
| count | int | Byggarens ersättningsintervall längd. |
...
Ersätter delsträng genom byggaren.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| oldString | const String\& | [String](../../../system/string/) att ersätta. |
| newString | const String\& | Ersättningssträng. |
...
Ersätter delsträng genom byggarens intervall.
...
| oldString | const String\& | [String](../../../system/string/) att ersätta. |
| newString | const String\& | Ersättningssträng. |
| position | int | Byggarens ersättningsintervalls startposition. |
| count | int | Byggarens ersättningsintervall längd. |
