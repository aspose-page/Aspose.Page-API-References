...
| --- | --- | --- |
| name | const String\& | [Encoding](../) namn. |
| encoder_fallback | const EncoderFallbackPtr\& | Reservlösning att använda för kodning. |
| decoder_fallback | const DecoderFallbackPtr\& | Reservlösning att använda för avkodning. |
