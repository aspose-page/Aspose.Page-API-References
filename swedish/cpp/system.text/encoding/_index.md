...
| virtual [get_BodyName](./get_bodyname/)() | Hämtar kodningsnamnet som är kompatibelt med e-postagentens meddelandetext. |
| virtual [get_CodePage](./get_codepage/)() | Hämtar [Windows](../../system.windows/)-kodsidans ID. |
| [get_DecoderFallback](./get_decoderfallback/)() const | Hämtar avkodningsfallback. |
| static [get_Default](./get_default/)() | Hämtar standardkodning. |
| [get_EncoderFallback](./get_encoderfallback/)() const | Hämtar kodningsfallback. |
...
| virtual [get_IsBrowserDisplay](./get_isbrowserdisplay/)() | Kontrollerar om kodning kan användas i webbläsaren för att visa innehåll. |
...
| virtual [get_IsSingleByte](./get_issinglebyte/)() | Kontrollerar om kodning är enbyte. |
| static [get_Latin1](./get_latin1/)() | Hämtar Latin1‑kodning. FÖR INTERNT BRUK. |
...
| static [get_UTF8Unmarked](./get_utf8unmarked/)() | Endast internt, för användning av klassbiblioteken: Omarkerad och utan inmatningsvalidering. |
...
| virtual [GetBytes](./getbytes/)(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) | Hämta de byte som erhålls genom att koda en teckenbuffert. |
...
| virtual [GetBytes](./getbytes/)(const String\&, int, int, ArrayPtr\<uint8_t\>, int) | Hämta de byte som erhålls genom att koda en teckenbuffert. |
...
| virtual [GetBytes](./getbytes/)(const char_t *, int, uint8_t *, int) | Hämta de byte som erhålls genom att koda en teckenbuffert. |
...
| virtual [GetChars](./getchars/)(ArrayPtr\<uint8_t\>, int, int, ArrayPtr\<char_t\>, int) | Hämta de tecken som erhålls genom att avkoda en bytebuffert. |
...
| virtual [GetChars](./getchars/)(const uint8_t *, int, char_t *, int) | Hämta de tecken som erhålls genom att avkoda en bytebuffert. |
...
| virtual [GetString](./getstring/)(ArrayPtr\<uint8_t\>, int, int) | Avkodar en buffert med bytes till en sträng. |
