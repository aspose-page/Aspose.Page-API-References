...
description: "System::Net::Sockets::TcpClient klass. Representerar en klient för TCP‑nätverkstjänsterna. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körningsfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr‑pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 500
...
Representerar en klient för TCP‑nätverkstjänsterna. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körningsfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [get_Available](./get_available/)() | Returnerar antalet byte som har mottagits och är redo att läsas. |
...
| [get_ReceiveBufferSize](./get_receivebuffersize/)() | Hämtar storleken på bufferten som används för mottagning av data. |
| [get_ReceiveTimeout](./get_receivetimeout/)() | Hämtar ett värde som indikerar en tidsperiod efter vilken mottagning av data tidsöverskrider. |
| [get_SendBufferSize](./get_sendbuffersize/)() | Hämtar storleken på bufferten som används för sändning av data. |
| [get_SendTimeout](./get_sendtimeout/)() | Hämtar ett värde som indikerar en tidsperiod efter vilken sändning av data tidsöverskrider. |
| [GetStream](./getstream/)() | Returnerar strömmen som används för sändning och mottagning av data. |
| [set_Client](./set_client/)(System::SharedPtr\<Socket\>) | Ställer in socketen. |
| [set_ExclusiveAddressUse](./set_exclusiveaddressuse/)(bool) | Sätter ett värde som indikerar om den aktuella instansen tillåter endast en klient att använda en port. |
...
| [set_ReceiveBufferSize](./set_receivebuffersize/)(int32_t) | Ställer in storleken på bufferten som används för mottagning av data. |
| [set_ReceiveTimeout](./set_receivetimeout/)(int32_t) | Ställer in ett värde som indikerar en tidsperiod efter vilken mottagning av data tidsöverskrider. |
| [set_SendBufferSize](./set_sendbuffersize/)(int32_t) | Ställer in storleken på bufferten som används för sändning av data. |
| [set_SendTimeout](./set_sendtimeout/)(int32_t) | Ställer in ett värde som indikerar en tidsperiod efter vilken sändning av data tidsöverskrider. |
