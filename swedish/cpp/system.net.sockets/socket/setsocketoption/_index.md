---
title: "System::Net::Sockets::Socket::SetSocketOption metod"
linktitle: "SetSocketOption"
second_title: "Aspose.Page för C++"
description: "System::Net::Sockets::Socket::SetSocketOption metod. Ställer in det angivna socket-alternativet till det angivna värdet i C++."
type: docs
weight: 6200
url: /sv/cpp/system.net.sockets/socket/setsocketoption/
---
## Socket::SetSocketOption(SocketOptionLevel, SocketOptionName, bool) method


Ställer in det angivna socket‑alternativet till det angivna värdet.
...
| optionName | SocketOptionName | Namnet på alternativet som måste uppdateras. |
| optionValue | bool | Värdet som måste sättas till det angivna alternativet. |
...
| optionLevel | SocketOptionLevel | Socketalternativnivån. |
| optionName | SocketOptionName | Namnet på alternativet som måste uppdateras. |
| optionValue | int32_t | Värdet som måste sättas till det angivna alternativet. |
...
| optionLevel | SocketOptionLevel | Socketalternativnivån. |
| optionName | SocketOptionName | Namnet på alternativet som måste uppdateras. |
| optionValue | System::ArrayPtr\<uint8_t\> | Värdet som måste sättas till det angivna alternativet. |
...
| optionLevel | SocketOptionLevel | Socketalternativnivån. |
| optionName | SocketOptionName | Namnet på alternativet som måste uppdateras. |
| optionValue | System::SharedPtr\<Object\> | Värdet som måste sättas till det angivna alternativet. |
