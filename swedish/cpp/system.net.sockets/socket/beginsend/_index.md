...
| --- | --- | --- |
| buffert | System::ArrayPtr\<uint8_t\> | En buffert att läsa data från. |
...
| tillstånd | System::SharedPtr\<Object\> | Användarlevererade data som används för att unikt identifiera varje asynkron sändningsoperation. |
