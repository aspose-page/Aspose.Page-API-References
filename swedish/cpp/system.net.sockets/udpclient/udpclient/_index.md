...
description: "System::Net::Sockets::UdpClient::UdpClient konstruktor. Initierar en ny instans av UdpClient‑klassen i C++."
type: docs
weight: 100
url: /sv/cpp/system.net.sockets/udpclient/udpclient/
---
...
| --- | --- | --- |
| familj | AddressFamily | värde som specificerar adressschemat för socketen. |
...
Skapar en ny instans av [UdpClient](../)-klassen och ansluter till den angivna fjärrvärden på den angivna porten.
