...
description: "System::Net::Sockets::TcpListener::TcpListener‑konstruktor. Skapar en ny instans i C++."
type: docs
weight: 100
url: /sv/cpp/system.net.sockets/tcplistener/tcplistener/
---
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| localaddr | System::SharedPtr\<IPAddress\> | Den lokala IP-adressen. |
| port | int32_t | Ett portnummer att lyssna på. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| localEP | System::SharedPtr\<IPEndPoint\> | Den lokala slutpunkten som lyssnarsocketen måste bindas till. |
