...
description: "System::IO::BasicSystemIOStreamBuf class. Representerar en buffert som omsluter System::IO::Stream-liknande strömmar och tillåter dem att användas som en intern buffert för std::iostream-liknande strömmar i C++."
type: docs
weight: 400
...
| [operator=](./operator=/)(const BasicSystemIOStreamBuf\&) | Kopieringstilldelningsoperator. Borttagen. |
