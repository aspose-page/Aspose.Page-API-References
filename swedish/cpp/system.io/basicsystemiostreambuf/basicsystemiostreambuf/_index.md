...
description: "System::IO::BasicSystemIOStreamBuf::BasicSystemIOStreamBuf konstruktor. Skapar en ny instans av BasicSystemIOStreamBuf i C++."
type: docs
weight: 100
url: /sv/cpp/system.io/basicsystemiostreambuf/basicsystemiostreambuf/
---
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| str | const SharedPtr\<Stream\>\& | Smartpekare till strömmen |
| mode | SystemIOStreamWrappingMode | Inslagningsläge |
| locale | const std::locale\& | [Stream](../../stream/)'s lokal |
