...
description: "System::IO::Directory::EnumerateFiles metod. Söker efter filerna som uppfyller de angivna sökkriterierna antingen i den angivna katalogen eller i hela katalogträdet med den angivna katalogen som rot i C++."
type: docs
weight: 400
...
Söker efter filerna som uppfyller de angivna sökkriterierna antingen i den angivna katalogen eller i hela katalogträdet som har den angivna katalogen som rot.
...
Den enumererbara samlingen av fullständiga sökvägar till de hittade filerna vars namn matchar **searchPattern**
