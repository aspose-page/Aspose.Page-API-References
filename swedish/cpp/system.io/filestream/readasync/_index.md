...
En uppgift som representerar den asynkrona läsoperationen. Värdet på TResult‑parametern innehåller det totala antalet byte som lästs in i bufferten. Resultatvärdet kan vara mindre än det begärda antalet byte om antalet för närvarande tillgängliga byte är färre än det begärda, eller det kan vara 0 (noll) om slutet på strömmen har nåtts.
