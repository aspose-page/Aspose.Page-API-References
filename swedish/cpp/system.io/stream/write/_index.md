...
description: "System::IO::Stream::Write metod. Skriver det angivna delintervallet av byte från den angivna bytearrayen till strömmen i C++."
type: docs
weight: 2600
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| buffert | const System::Details::StackArray\<uint8_t, N\>\& | Stackarrayen som innehåller byten att skriva |
| offset | int32_t | Ett 0-baserat index för elementet i **buffer** där delintervallet som ska skrivas börjar |
| count | int32_t | Antalet element i delintervallet som ska skrivas |
