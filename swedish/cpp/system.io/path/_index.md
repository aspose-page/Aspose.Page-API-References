...
description: "System::IO::Path‑klass. Tillhandahåller metoder för att manipulera sökvägar. Detta är en statisk typ utan instansmetoder. Du bör aldrig skapa instanser av den på något sätt i C++."
type: docs
weight: 1900
...
| static [Combine](./combine/)(const ArrayPtr\<String\>\&) | Kombinerar de angivna sökvägssegmenten till en enda sökväg och infogar katalogseparatorer mellan segmenten om det behövs. |
| static [Combine](./combine/)(const String\&, const String\&) | Kombinerar två angivna sökvägssegment till en enda sökväg och infogar en katalogseparator mellan segmenten om det behövs. |
| static [Combine](./combine/)(const String\&, const String\&, const String\&) | Kombinerar tre angivna sökvägssegment till en enda sökväg och infogar katalogseparatorer mellan segmenten om det behövs. |
| static [Combine](./combine/)(const String\&, const String\&, const String\&, const String\&) | Kombinerar fyra angivna sökvägssegment till en enda sökväg och infogar katalogseparatorer mellan segmenten om det behövs. |
...
| static [GetExtension](./getextension/)(const String\&) | Returnerar filändelsen för filen som refereras av den angivna sökvägen. |
| static [GetFileName](./getfilename/)(const String\&) | Returnerar namnet på filen som refereras av den angivna sökvägen. |
| static [GetFileNameWithoutExtension](./getfilenamewithoutextension/)(const String\&) | Returnerar namnet utan filändelse för filen som refereras av den angivna sökvägen. |
...
| static [GetTempFileNameSafe](./gettempfilenamesafe/)() | Skapar en ny fil med ett unikt namn och returnerar en fullständig sökväg till den. Är ett synonym till metoden [GetTempFileName_()](./gettempfilename_/). |
...
| static [ToString](./tostring/)(const boost::filesystem::path\&) | Returnerar en strängrepresentation av det angivna Boost's sökvägsobjektet. |
## Fält
