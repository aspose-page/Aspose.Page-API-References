...
| [CopyTo](./copyto/)(const String\&) | Kopierar filen som representeras av det aktuella objektet till den angivna platsen. Om destinationsfilen redan finns, misslyckas kopieringen. |
| [CopyTo](./copyto/)(const String\&, bool) | Kopierar filen som representeras av det aktuella objektet till den angivna platsen. En parameter anger om befintlig destinationsfil ska skrivas över. |
| [Create](./create/)() | Skapar en fil på den plats som anges av sökvägen som representeras av det aktuella objektet och öppnar den för läsning och skrivning, i trunkeringsläge och utan delning. |
...
| [Decrypt](./decrypt/)() | INTE IMPLEMENTERAT. |
| [Delete](./delete/)() override | Tar bort filen som representeras av det aktuella objektet. |
| [Encrypt](./encrypt/)() | INTE IMPLEMENTERAT. |
| [FileInfo](./fileinfo/)(const String\&) | Skapar en ny instans av [FileInfo](./)-klassen som representerar den angivna filen. |
...
| [get_IsReadOnly](./get_isreadonly/)() | Returnerar ett värde som indikerar om ReadOnly-attributet är satt. |
...
| [OpenRead](./openread/)() | Öppnar en fil som representeras av det aktuella objektet enbart för läsning, i 'Open'-läge med delad åtkomst för läsning. |
...
| [OpenWrite](./openwrite/)() | Öppnar en fil som representeras av det aktuella objektet enbart för skrivning, i 'OpenOrCreate'-läge utan delning. |
...
| [set_IsReadOnly](./set_isreadonly/)(bool) | Sätter eller tar bort ReadOnly-attributet på filen. |
