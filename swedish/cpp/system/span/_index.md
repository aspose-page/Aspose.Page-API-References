...
| --- | --- |
| T | Typen av element i spanen. Denna klass tillhandahåller ett typsäkert sätt att arbeta med sammanhängande sekvenser av objekt. Den kan användas för att omsluta arrayer, stackarrayer eller råpekare samtidigt som gränskontroller upprätthålls. [Span](./) äger inte minnet den pekar på – den är bara en vy över befintligt minne. |
## Metoder
