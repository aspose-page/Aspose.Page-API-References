...
description: "System::Byte‑klass. Innehåller metoder för att arbeta med det osignerade 8-bit heltalet i C++."
type: docs
weight: 1100
...
| static [Parse](./parse/)(const String\&, const SharedPtr\<IFormatProvider\>\&) | Konverterar den angivna strängen som innehåller en strängrepresentation av ett tal till motsvarande 8-bit osignerade heltal med den angivna formateringsinformationen. |
...
| static [Parse](./parse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) | Konverterar den angivna strängen som innehåller en strängrepresentation av ett tal till motsvarande 8-bit osignerade heltal med den angivna formateringsinformationen och talstilen. |
...
| static [TryParse](./tryparse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&, uint8_t\&) | Konverterar den angivna strängen som innehåller en strängrepresentation av ett tal till motsvarande 8-bit osignerade heltal med den angivna formateringsinformationen och talstilen. |
