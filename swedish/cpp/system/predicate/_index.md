...
int main()
{
  ...
  // Skapa predikatet som returnerar ett arrayelement som är större än 3.
  const auto predicate = static_cast<System::Predicate<int>>([](int a) -> bool
  {
      return a > 3;
  });

  // Hitta det första elementet i arrayen med hjälp av det skapade predikatet och skriv ut det.
