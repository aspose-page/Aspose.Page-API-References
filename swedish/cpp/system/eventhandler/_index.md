...
Representerar en metod som reagerar på och bearbetar en händelse. Denna typ bör allokeras på stacken och skickas till funktioner som värde eller referens. Använd aldrig klassen [System::SmartPtr](../smartptr/) för att hantera objekt av denna typ.
