...
description: "System::operator+ method. Strängkonkatenering i C++."
type: docs
weight: 27500
...
| --- | --- | --- |
| vänster | const char_t | Tecken att konkatenera till sträng. |
...
Returnerar en ny instans av [Decimal](../decimal/) klassen som representerar ett värde som är summan av det angivna värdet och värdet som representeras av det angivna [Decimal](../decimal/) objektet.
...
En ny instans av [Decimal](../decimal/) klassen som representerar ett värde som är summan av **x** och värdet som representeras av **d**.
...
Summerar icke-nullbara och nullbara värden.
