...
| standard_display_name | const String\& | Standardtidsnamn. |
...
| daylight_display_name | const String\& | Sommartidsnamn. |
| adjustment_rules | const ArrayPtr\<AdjustmentRulePtr\>\& | [Array](../../array/) av justeringsregler. |
| disable_daylight_saving_time | bool | Sant för att kasta bort all sommartidsinformation som finns i adjustment_rules. |
