...
description: "System::TimeZoneInfo::TransitionTime::CreateTransitionTime metod. Skapar en instans av klassen TransitionTime som representerar en tidsändring beskriven med de angivna parametrarna i C++."
type: docs
weight: 1200
...
Skapar en instans av klassen [TransitionTime](../) som representerar en tidsändring beskriven med de angivna parametrarna.
...
| dag | int | Den dag då tidsändringen sker. |
