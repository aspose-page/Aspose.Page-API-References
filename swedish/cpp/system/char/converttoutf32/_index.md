...
description: "System::Char::ConvertToUtf32 metod. Konverterar det angivna UTF-16 surrogatparet till en UTF-32 kodenhet i C++."
type: docs
weight: 200
...
| --- | --- | --- |
| highSurrogate | char_t | Den högre surrogaten i UTF-16-surrogatparet som ska konverteras |
| lowSurrogate | char_t | Den lägre surrogaten i UTF-16-surrogatparet som ska konverteras |

### ReturnValue

En UTF-32 kodenhet som resultat av konverteringen
...
Konverterar värdet av ett UTF-16‑kodad tecken eller surrogatpar på en specificerad position i en sträng till en UTF-32‑kodenhet.
