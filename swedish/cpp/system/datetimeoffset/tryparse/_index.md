...
description: "System::DateTimeOffset::TryParse metod. Försöker konvertera den angivna strängen till ett DateTimeOffset-objekt med den angivna formatleverantören och formateringsstilen i C++."
type: docs
weight: 5700
...
Försöker konvertera den angivna strängen till ett [DateTimeOffset](../)-objekt med den angivna formatleverantören och formateringsstilen.
...
Försöker konvertera den angivna strängen till ett [DateTimeOffset](../)-objekt.
