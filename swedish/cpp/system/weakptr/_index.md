...
description: "System::WeakPtr-klass. Underklass till System::SmartPtr som sätter sig i svagt läge vid konstruktion. Observera att denna klass inte garanterar att dess instans alltid förblir i svagt läge eftersom set_Mode() fortfarande är åtkomlig. Denna typ är en pekare för att hantera raderingen av andra objekt. Den bör allokeras på stacken och skickas till funktioner antingen som värde eller som konstant referens i C++."
type: docs
weight: 7500
...
Underklass till [System::SmartPtr](../smartptr/) som sätter sig i svagt läge vid konstruktion. Observera att denna klass inte garanterar att dess instans alltid förblir i svagt läge eftersom [set_Mode()](../smartptr/set_mode/) fortfarande är åtkomlig. Denna typ är en pekare för att hantera raderingen av andra objekt. Den bör allokeras på stacken och skickas till funktioner antingen som värde eller som konstant referens.
...
| [WeakPtr](./weakptr/)(Pointee_ *) | Skapar svag pekare till givet objekt. |
