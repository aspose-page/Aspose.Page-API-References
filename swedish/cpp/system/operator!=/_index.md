...
falskt om strängarna matchar, sant annars.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| left | const SharedPtr\<Object\>\& | [Object](../object/) för att konvertera till sträng och jämföra. |
| right | const String\& | [String](../string/) att jämföra. |

### ReturnValue

falskt om objektets strängrepresentation är lika med strängen, sant annars.
...
Sant om URI:er inte är lika, annars - falskt
...
Icke-lika jämför två smarta pekare.
...
Sant om operanderna inte är lika, annars - falskt
