...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| obj | const double\& | Vänster sida flyttalvärde. |
| annan | const double\& | Höger sida flyttalvärde. |

### ReturnValue

Sant om **obj** och **another** båda är NaN eller lika, falskt annars.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| obj | const float\& | Vänster sida flyttalvärde. |
| annan | const float\& | Höger sida flyttalvärde. |
...
Sant om objekten anses lika, falskt annars.
