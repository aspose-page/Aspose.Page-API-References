...
Representerar en pseudo-slumpgenerator. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| virtual [Next](./next/)() | Returnerar ett icke-negativt slumpmässigt tal som är mindre än int32:s maxvärde. |
...
| [Random](./random/)() | Initierar en ny instans med ett tidsberoende standardfrövärde. |
