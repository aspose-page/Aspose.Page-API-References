...
description: "System::setter_post_decrement_wrap‑metod. Översättaren översätter C#''s post‑dekrement‑uttryck som riktar sig mot en instans''s egenskap som har setter och getter definierade, till ett anrop av denna funktion (överladdning för konstant getter) i C++."
type: docs
weight: 37600
...
Översättaren översätter C#'s post‑dekrement‑uttryck som riktar sig mot en instans''s egenskap som har setter och getter definierade, till ett anrop av denna funktion (överladdning för konstant getter).
...
Översättaren översätter C#'s post‑dekrement‑uttryck som riktar sig mot en instans''s egenskap som har setter och getter definierade, till ett anrop av denna funktion (överladdning för icke‑konstant getter).
...
Översättaren översätter C#'s post‑dekrement‑uttryck som riktar sig mot en klass''s egenskap som har setter och getter definierade, till ett anrop av denna funktion.
