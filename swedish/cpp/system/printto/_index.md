...
description: "System::PrintTo metod. Skriver värdet som representeras av det angivna objektet till den angivna utdataströmmen i C++."
type: docs
weight: 35300
...
Skriver värdet som representeras av det angivna objektet till den angivna utdataströmmen.
...
| --- | --- | --- |
| d | const Decimal\& | Det [Decimal](../decimal/) objektet att skriva till strömmen |
| os | ::std::ostream * | Strömmen att skriva det angivna objektet till |
...
Skriver värde till ostream. Vanligtvis används för felsökning.
...
Skriver sträng till ostream. Vanligtvis används för felsökning.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| value | const System::String\& | att skriva. |
