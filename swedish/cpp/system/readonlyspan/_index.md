...
description: "System::ReadOnlySpan klass. Framåtriktad användning inom Span-klass i C++."
type: docs
weight: 5300
...
Framåtriktad användning inom [Span](../span/) klass.
...
| --- | --- |
| T | Typen av element i spannen. Denna klass tillhandahåller ett typ‑säkert sätt att arbeta med sammanhängande sekvenser av objekt i skrivskyddat läge. Den kan användas för att omsluta arrayer, stack‑arrayer eller råpekare samtidigt som gränskontroll upprätthålls. [ReadOnlySpan](./) äger inte minnet den pekar på – det är bara en vy över befintligt minne. |
## Metoder
