...
description: "System::Decimal klass. Representerar ett decimaltal. Denna typ bör allokeras på stacken och passeras till funktioner som värde eller referens. Använd aldrig System::SmartPtr-klassen för att hantera objekt av denna typ i C++."
type: docs
weight: 1900
...
Representerar ett decimaltal. Denna typ bör allokeras på stacken och passeras till funktioner som värde eller referens. Använd aldrig [System::SmartPtr](../smartptr/)-klassen för att hantera objekt av denna typ.
...
| Metod | Beskrivning |
| --- | --- |
| static [Add](./add/)(const Decimal\&, const Decimal\&) | Lägger till två angivna [Decimal](./)-värden. |
| static [Ceiling](./ceiling/)(const Decimal\&) | Returnerar det minsta heltalsvärdet som är större än eller lika med det angivna värdet. |
...
| [CompareTo](./compareto/)(const Decimal\&) const | Bestämmer om värdet som representeras av det aktuella objektet är mindre än, lika med eller större än värdet som representeras av det angivna objektet. |
...
| explicit [Decimal](./decimal/)(const std::string\&) | Skapar en instans som representerar ett värde vars strängrepresentation är angiven som en instans av std::string-klassen. |
...
| [Equals](./equals/)(const Decimal\&) const | Bestämmer om värdena som representeras av det aktuella objektet och det angivna objektet är lika. |
| [Equals](./equals/)(const SharedPtr\<Object\>\&) const | Bestämmer om värdena som representeras av det aktuella objektet och det angivna objektet är lika. |
| static [Equals](./equals/)(const Decimal\&, const Decimal\&) | Bestämmer om värdena som representeras av de angivna objekten är lika. |
...
| static [GetBytes](./getbytes/)(const Decimal\&, const System::ArrayPtr\<uint8_t\>\&) | [Convert](../convert/) det angivna [Decimal](./)-värdet till en byte-array. |
...
| explicit [operator double](./operatordouble/)() const | Konverterar värdet som representeras av det aktuella objektet till ett dubbelprecision flyttal. |
| explicit [operator float](./operatorfloat/)() const | Konverterar värdet som representeras av det aktuella objektet till ett enkelprecision flyttal. |
| [operator!=](./operator!=/)(const Decimal\&) const | Bestämmer om värdena som representeras av det aktuella objektet och det angivna objektet inte är lika. |
| [operator!=](./operator!=/)(std::nullptr_t) const | Bestämmer om värdet som representeras av det aktuella objektet är annorlunda än 0. |
| [operator%](./operator%/)(const Decimal\&) const | Returnerar en ny instans av klassen [Decimal](./) som representerar ett värde som är resultatet av en modulooperation med värdena som representeras av det aktuella och det angivna objektet. |
| [operator%=](./operator%=/)(const Decimal\&) | Tilldelar det aktuella objektet ett nytt värde som är resultatet av en modulooperation med värdena som representeras av det aktuella och det angivna objektet. |
| [operator*](./operator_/)(const Decimal\&) const | Returnerar en ny instans av klassen [Decimal](./) som representerar ett värde som är resultatet av multiplikation av värdena som representeras av det aktuella och angivna objektet. |
| [operator*=](./operator_=/)(const Decimal\&) | Tilldelar det aktuella objektet ett nytt värde som är resultatet av multiplikation av värdena som representeras av det aktuella och angivna objektet. |
| [operator+](./operator+/)(const Decimal\&) const | Returnerar en ny instans av klassen [Decimal](./) som representerar ett värde som är summan av värdena som representeras av det aktuella och angivna objektet. |
| [operator++](./operator++/)() | Ökar värdet som representeras av det aktuella objektet. |
| [operator+=](./operator+=/)(const Decimal\&) | Tilldelar det aktuella objektet ett nytt värde som är summan av värdena som representeras av det aktuella och angivna objektet. |
...
| [operator-](./operator-/)() const | Returnerar en ny instans av klassen [Decimal](./) som representerar ett värde som resultat av negationen av värdet som representeras av det aktuella objektet. |
...
| [operator==](./operator==/)(const Decimal\&) const | Bestämmer om värdena som representeras av det aktuella objektet och det angivna objektet är lika. |
...
| static [ToByte](./tobyte/)(Decimal) | Konverterar [Decimal](./)-värdet till ett osignerat 8-bitars heltal. |
| static [ToDouble](./todouble/)(Decimal) | Konverterar [Decimal](./)-värdet till ett dubbelprecisions flyttal. |
| static [ToInt16](./toint16/)(Decimal) | Konverterar [Decimal](./)-värdet till ett signerat 16-bitars heltal. |
| static [ToInt32](./toint32/)(Decimal) | Konverterar [Decimal](./)-värdet till ett signerat 32-bitars heltal. |
| static [ToInt64](./toint64/)(Decimal) | Konverterar [Decimal](./)-värdet till ett signerat 64-bitars heltal. |
...
| static [ToSByte](./tosbyte/)(Decimal) | Konverterar [Decimal](./)-värdet till ett signerat 8-bitars heltalvärde. |
| static [ToSingle](./tosingle/)(Decimal) | Konverterar [Decimal](./)-värdet till ett enkelprecisionsflyttal. |
...
| [ToString](./tostring/)(const SharedPtr\<IFormatProvider\>\&) const | Konverterar det aktuella objektet till en sträng med hjälp av kulturspecifik formatinformation. |
...
| [ToString](./tostring/)(const String\&, const SharedPtr\<IFormatProvider\>\&) const | Konverterar det aktuella objektet till dess strängrepresentation med den angivna strängformaten och kulturspecifik formatinformation som tillhandahålls av det angivna [IFormatProvider](../iformatprovider/)-objektet. |
...
| static [ToUInt16](./touint16/)(Decimal) | Konverterar [Decimal](./)-värdet till ett icke‑signerat 16-bitars heltalvärde. |
| static [ToUInt32](./touint32/)(Decimal) | Konverterar [Decimal](./)-värdet till ett icke‑signerat 32-bitars heltalvärde. |
| static [ToUInt64](./touint64/)(Decimal) | Konverterar [Decimal](./)-värdet till ett icke‑signerat 64-bitars heltalvärde. |
| static [Truncate](./truncate/)(const Decimal\&) | Returnerar [Decimal](./)-objektet som representerar ett värde vars heltalsdel är lika med den som representeras av det angivna [Decimal](./)-objektet, med alla bråkdelsciffror borttagna. |
| static [TryParse](./tryparse/)(const String\&, Decimal\&) | Konverterar den angivna strängen som innehåller ett talets strängrepresentation till motsvarande [Decimal](./)-värde. |
| static [TryParse](./tryparse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&, Decimal\&) | Konverterar den angivna strängen som innehåller ett talets strängrepresentation till motsvarande [Decimal](./)-värde med den medföljande formatinformationen och talstilen. |
