...
description: "System::operator<<-metod. Skriver ut en sträng till utmatningsströmmen med UTF-8-kodning i C++."
type: docs
weight: 29100
url: /sv/cpp/system/operator__/
---
## System::operator<<(std::ostream\&, const String\&) method


Skriver ut en sträng till utmatningsströmmen med UTF-8-kodning.
...
| --- | --- | --- |
| os | std::ostream\& | Ett utmatningsströmobjekt (instansiering av **basic_ostream** med **char**). |
| str | const String\& | En sträng som ska skickas till utmatningsströmmen. |

### ReturnValue

En utmatningsström som strängen lades till.
...
| decimal | const Decimal\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| exception | const Exception\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| guid | const Guid\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| os | const OperatingSystem\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| object | const System::Object\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| type_info | const TypeInfo\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| version | const Version\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| date_time | DateTime | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| value | DateTimeOffset | [Data](../../system.data/) att infoga. |
...
| --- | --- | --- |
| ström | std::ostream\& | Utdatastream att infoga data i. |
| time_span | TimeSpan | [Data](../../system.data/) att infoga. |
...
Skriver ut en sträng till utmatningsströmmen.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| os | std::wostream\& | Ett utmatningsströmobjekt (instansiering av **basic_ostream** med **wchar_t**). |
| str | const String\& | En sträng som ska skickas till utmatningsströmmen. |
...
description: 'System::operator>>-metod. Hämtar en sträng från inmatningsströmmen med UTF-8-kodning i C++.'
typ: docs
weight: 35100
...
| str | String\& | En sträng att läsa från inmatningsströmmen. |

### ReturnValue

En inmatningsström som strängen extraherades från.
