...
| --- | --- | --- |
| tryBlock | T\&& | Funktionsobjektet vars kropp innehåller implementeringen av try[-catch]-delen av den try[-catch]-finally-sats som emuleras |
| finallyBlock | F\&& | Funktionsobjektet vars kropp innehåller implementeringen av finally-delen av den try[-catch]-finally-sats som emuleras |
...
Den enda funktionen som emulerar beteendet hos C#'s try[-catch]-finally-sats. Vid översättning av C#'s try[-catch]-finally-sats med översättarens alternativ finally_statement_as_lambda satt till true, översätts satsen till ett anrop av denna metod. Denna överlagring hanterar fallet där returvärdet för funktionsobjektet som implementerar try[-catch]-delen av try[-catch]-finally-satsen är bool&.
