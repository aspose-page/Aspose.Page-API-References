...
description: "System::Nullable::operator+= metod. Tillämpas operator+=() på värdet som representeras av det aktuella objektet med värdet som representeras av det angivna Nullable-objektet som ett högersidigt argument i C++."
type: docs
weight: 1300
...
| --- | --- | --- |
| other | const Nullable\<T1\>\& | En konstant referens till ett [Nullable](../)-objekt vars värde som representeras används som ett högersidigt argument för [operator+=()](./) som tillämpas på värdet som representeras av det aktuella objektet. |
