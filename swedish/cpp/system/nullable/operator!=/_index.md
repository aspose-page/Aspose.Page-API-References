...
description: "System::Nullable::operator!= metod. Avgör om värdet som representeras av det aktuella objektet inte är lika med värdet som representeras av det specificerade Nullable‑objektet i C++."
type: docs
weight: 1000
...
Avgör om värdet som representeras av det aktuella objektet är icke‑null.
