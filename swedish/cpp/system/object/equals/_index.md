...
description: "System::Object::Equals method. Jämför objekt med C# Object.Equals-semantik i C++."
type: docs
weight: 300
...
Sant om objekten anses vara lika och falskt annars.
...
Emulerar C#-stil flyttalsjämförelse där två NaN-värden betraktas som lika även om NaN enligt IEC 60559:1989 inte är lika med något värde, inklusive NaN.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| objA | double const\& | Vänster sida flyttalvärde. |
| objB | double const\& | Höger sida flyttalvärde. |

### ReturnValue

Sant om **objA** och **objB** båda är NaN eller lika, annars falskt.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| objA | float const\& | Vänster sida flyttalvärde. |
| objB | float const\& | Höger sida flyttalvärde. |
...
| --- | --- |
| T1 | Typ av det första objektet att jämföra. |
| T2 | Typ av det andra objektet att jämföra. |
...
Sant om objekten matchar antingen genom referens eller semantiskt (genom en [Object.Equals](./)-liknande jämförelse), falskt annars.
