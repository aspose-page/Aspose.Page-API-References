---
title: "System::String::Compare‑metod"
linktitle: "Compare"
second_title: "Aspose.Page för C++"
description: "System::String::Compare‑metod. Mindre‑lika‑större‑jämför två strängar i C++."
type: docs
weight: 6200
url: /sv/cpp/system/string/compare/
---
## String::Compare(const String\&, const String\&, bool, const SharedPtr\<System::Globalization::CultureInfo\>\&) method


Less-equal-greater-jämför två strängar.
...
| ci | const SharedPtr\<System::Globalization::CultureInfo\>\& | Kultur att använda för jämförelse. |
...
Less-equal-greater-jämför två delsträngar.
...
| --- | --- | --- |
| strA | const String\& | Första strängen att jämföra. |
| indexA | int | Början av den första strängens delsträng. |
| strB | const String\& | Andra strängen att jämföra. |
| indexB | int | Början av den andra strängens delsträng. |
| längd | int | Antal tecken att jämföra. |
| ignoreCase | bool | Anger om jämförelsen är skiftlägesokänslig. |
| ci | const SharedPtr\<System::Globalization::CultureInfo\>\& | Kultur att använda för jämförelse. |
