...
| --- | --- | --- |
| str | codeporting_icu::UnicodeString\&& | UnicodeString för att omslutas i [String](../). |
...
Konverterar ett delintervall av teckenarrayen till en sträng. Om parametrarna ligger utanför arrayens gränser konstrueras en tom sträng.
...
Konstruerar en sträng från en teckensträngspekare och en explicit längd.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| str | const char16_t * | [String](../) pekare, kan vara bokstavlig eller en array. |
| längd | int | Explicit stränglängd |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| str | const codeporting_icu::UnicodeString\& | UnicodeString för att omslutas i [String](../). |
...
Konstruerar en sträng baserat på en teckensträngspekare. Behandlar den pekade strängen som nullterminerad i UTF‑8 och beräknar målsträngens längd baserat på nulltecknet.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| value | const T\& | Pekare till teckensträng. |
...
Konstruerar en sträng baserat på en teckensträngspekare. Behandlar den pekade strängen som nullterminerad och beräknar målsträngens längd baserat på nulltecknet.
...
Konstruerar en sträng baserat på en widecharacter‑strängpekare. Behandlar den pekade strängen som nullterminerad och beräknar målsträngens längd baserat på nulltecknet. Konvertering från wchar_t är tidskrävande på vissa plattformar, så inga implicita konverteringar tillåts.
...
Konstruerar en sträng från en widecharacter‑strängpekare och en explicit längd. Konvertering från wchar_t är tidskrävande på vissa plattformar, så inga implicita konverteringar tillåts.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| str | const wchar_t * | [String](../) pekare, kan vara bokstavlig eller en array. |
| längd | int | Explicit stränglängd |
...
Konstruerar en sträng baserat på en strängliteral. Betraktar litteralen som en nullterminerad sträng i UTF‑8 och beräknar målsträngens längd baserat på litteralens storlek.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| value | T\& | [String](../) bokstavlig pekare. |
...
Konstruerar en sträng baserat på en strängliteral. Betraktar litteralen som en nullterminerad sträng och beräknar målsträngens längd baserat på litteralens storlek.
...
Konstruerar en sträng baserat på en widestring‑literal. Betraktar litteralen som en nullterminerad sträng och beräknar målsträngens längd baserat på litteralens storlek. Konvertering från wchar_t är tidskrävande på vissa plattformar, så inga implicita konverteringar tillåts.
