...
| [Equals](./equals/)(const Version\&) const | Bestämmer om versionsnumren som representeras av det aktuella och det angivna objektet är lika. |
| [get_Build](./get_build/)() const | Returnerar byggnumret. |
| [get_Major](./get_major/)() const | Returnerar huvudversionen. |
| [get_MajorRevision](./get_majorrevision/)() const | Returnerar det högsta 16‑bitsvärdet av revisionsnumret. |
| [get_Minor](./get_minor/)() const | Returnerar underversionen. |
| [get_MinorRevision](./get_minorrevision/)() const | Returnerar det lägsta 16‑bitsvärdet av revisionsnumret. |
...
| static [Parse](./parse/)(const String\&) | Konverterar strängrepresentationen av ett versionsnummer till en motsvarande instans av [Version](./) klass. |
...
| [Version](./version/)(int, int, int, int) | Skapar en instans som representerar de angivna huvud-, under-, bygg- och revsion‑värdena. |
