...
description: "System::Array::Clear-metoden. Stöds inte eftersom arrayen som representeras av det aktuella objektet är skrivskyddad i C++."
type: docs
weight: 600
url: /sv/cpp/system/array/clear/
---
## Array::Clear() method
...
Ersätter **count** värden med start vid index **startIndex** i den angivna arrayen med standardvärden.
...
| startIndex | int | Index där ersättningen av objekten ska börja |
