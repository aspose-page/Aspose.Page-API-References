...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| init | std::initializer_list\<bool\> | Initializer-lista som innehåller element för att fylla arrayen med |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| init | std::initializer_list\<UnderlyingType\> | Initializer-lista som innehåller element för att fylla arrayen med |
...
| Parameter | Beskrivning |
| --- | --- |
| Q | Typen på elementen i std::vector-objektet som elementen ska flyttas från |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| value | vector_t\&& | std::vector, vars element erhålls av arrayen |
