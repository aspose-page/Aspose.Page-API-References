...
description: "System::Tuple klass. Klass som representerar en tuple-datastruktur. Maximalt antal element är 8 i C++."
type: docs
weight: 6400
...
| --- | --- |
| Argument | Tuple-elementens typer. |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [Equals](./equals/)(SharedPtr\<Object\>) override | Avgör om det aktuella och det angivna objektet är identiska. |
| [get_Item](./get_item/)() const | Hämtar värdet för [Tuple](./)-objektets komponent. |
| [Tuple](./tuple/)(Args...) | Skapar ett tuple-objekt. |
## Anmärkningar
