---
title: "System::Drawing::Drawing2D::GraphicsPath::AddString-metod"
linktitle: "AddString"
second_title: "Aspose.Page för C++"
description: "System::Drawing::Drawing2D::GraphicsPath::AddString-metod. Lägger till en textsträng till den bana som representeras av det aktuella objektet i C++."
type: docs
weight: 1600
url: /sv/cpp/system.drawing.drawing2d/graphicspath/addstring/
---
## GraphicsPath::AddString(const String\&, const SharedPtr\<FontFamily\>\&, int, float, Point, const SharedPtr\<StringFormat\>\&) method


Lägger till en textsträng till den bana som representeras av det aktuella objektet.
...
| --- | --- | --- |
| text | const String\& | Texten att lägga till |
| familj | const SharedPtr\<FontFamily\>\& | Teckensnittsfamiljen som används för att rita texten |
| style | int | Ett [FontStyle](../../../system.drawing/fontstyle/) enumerationsvärde som anger teckensnittsstilen att använda |
| emSize | float | Höjden på em‑kvadraten som omger varje tecken i strängen |
| origin | Punkt | Anger platsen där texten börjar |
| stringFormat | const SharedPtr\<StringFormat\>\& | Formatet för strängen |
...
| style | int | Ett [FontStyle](../../../system.drawing/fontstyle/) enumerationsvärde som anger teckensnittsstilen att använda |
| emSize | float | Höjden på em‑kvadraten som omger varje tecken i strängen |
| origin | PointF | Anger platsen där texten börjar |
| stringFormat | const SharedPtr\<StringFormat\>\& | Formatet för strängen |
...
| style | int | Ett [FontStyle](../../../system.drawing/fontstyle/) enumerationsvärde som anger teckensnittsstilen att använda |
| emSize | float | Höjden på em‑kvadraten som omger varje tecken i strängen |
| layoutRect | Rektangel | En rektangel som omger texten |
| stringFormat | const SharedPtr\<StringFormat\>\& | Formatet för strängen |
...
| style | int | Ett [FontStyle](../../../system.drawing/fontstyle/) enumerationsvärde som anger teckensnittsstilen att använda |
| emSize | float | Höjden på em‑kvadraten som omger varje tecken i strängen |
| layoutRect | RectangleF | En rektangel som omger texten |
| stringFormat | const SharedPtr\<StringFormat\>\& | Formatet för strängen |
