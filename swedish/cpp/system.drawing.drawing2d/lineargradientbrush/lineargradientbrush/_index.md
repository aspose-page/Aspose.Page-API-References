...
description: "System::Drawing::Drawing2D::LinearGradientBrush::LinearGradientBrush-konstruktor. Skapar en ny instans av LinearGradientBrush i C++."
type: docs
weight: 100
url: /sv/cpp/system.drawing.drawing2d/lineargradientbrush/lineargradientbrush/
---
## LinearGradientBrush::LinearGradientBrush(const Point\&, const Point\&, const Color\&, const Color\&) constructor


Skapar en ny instans av [LinearGradientBrush](../).
...
| --- | --- | --- |
| point1 | const Point\& | Startpunkten för gradienten |
| point2 | const Point\& | Slutpunkten för gradienten |
| color1 | const Color\& | Startfärgen för gradienten |
| color2 | const Color\& | Slutfärgen för gradienten |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| point1 | const PointF\& | Startpunkten för gradienten |
| point2 | const PointF\& | Slutpunkten för gradienten |
| color1 | const Color\& | Startfärgen för gradienten |
| color2 | const Color\& | Slutfärgen för gradienten |
## Anmärkningar
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| rect | const Rectangle\& | En avgränsande rektangel för gradienten |
| color1 | const Color\& | Startfärgen för gradienten |
| color2 | const Color\& | Slutfärgen för gradienten |
| vinkel | float | Vinkeln på gradientens orienteringslinje; mätt i grader medurs från x-axeln |
| isAngleScaleable | bool | Anger om gradientens vinkel påverkas av den transformation som är associerad med penseln |
...
| color1 | const Color\& | Startfärgen för gradienten |
| color2 | const Color\& | Slutfärgen för gradienten |
| linearGradientMode | LinearGradientMode | Gradientens riktning |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| rect | const RectangleF\& | En avgränsande rektangel för gradienten |
| color1 | const Color\& | Startfärgen för gradienten |
| color2 | const Color\& | Slutfärgen för gradienten |
| vinkel | float | Vinkeln på gradientens orienteringslinje; mätt i grader medurs från x-axeln |
| isAngleScaleable | bool | Anger om gradientens vinkel påverkas av den transformation som är associerad med penseln |
