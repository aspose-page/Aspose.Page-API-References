...
description: "System::Net::Http::HttpRequestMessage::HttpRequestMessage konstruktor. Skapar en ny instans i C++."
type: docs
weight: 100
url: /sv/cpp/system.net.http/httprequestmessage/httprequestmessage/
---
...
| --- | --- | --- |
| metod | System::SharedPtr\<HttpMethod\> | HTTP-metoden. |
| requestUri | String | URI:n för den begärda resursen. |
...
| --- | --- | --- |
| metod | System::SharedPtr\<HttpMethod\> | HTTP-metoden. |
| requestUri | System::SharedPtr\<Uri\> | URI:n för den begärda resursen. |
