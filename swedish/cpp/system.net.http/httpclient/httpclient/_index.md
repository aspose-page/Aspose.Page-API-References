---
title: "System::Net::Http::HttpClient::HttpClient konstruktor"
linktitle: "HttpClient"
second_title: "Aspose.Page för C++"
description: "System::Net::Http::HttpClient::HttpClient konstruktor. Skapar en ny instans i C++."
type: docs
weight: 100
url: /sv/cpp/system.net.http/httpclient/httpclient/
---
...
| --- | --- | --- |
| hanterare | System::SharedPtr\<HttpMessageHandler\> | HTTP-hanteraren som används för att skicka förfrågningar. |
...
| --- | --- | --- |
| hanterare | System::SharedPtr\<HttpMessageHandler\> | HTTP-hanteraren som används för att skicka förfrågningar. |
| disposeHandler | bool | Värdet som anger om hanteraren måste frigöras när denna instans frigörs. |
