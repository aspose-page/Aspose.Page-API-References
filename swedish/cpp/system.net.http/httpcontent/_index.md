...
| Metod | Beskrivning |
| --- | --- |
| [Dispose](./dispose/)() override | Frigör den aktuella instansen. Denna metod frigör också strömmen som returneras av 'ReadAsStream' och minnesbufferten om den har skapats. |
| [get_Headers](./get_headers/)() | Returnerar HTTP‑innehållshuvudena. |
| [LoadIntoBuffer](./loadintobuffer/)() | Serialiserar innehåll till en minnesbuffert. |
| [LoadIntoBuffer](./loadintobuffer/)(int64_t) | Serialiserar innehåll till en minnesbuffert. |
| [ReadAsByteArray](./readasbytearray/)() | Serialiserar innehåll och returnerar en byte‑array. |
| [ReadAsStream](./readasstream/)() | Serialiserar innehåll och returnerar en ström. |
| [ReadAsString](./readasstring/)() | Serialiserar innehåll och returnerar en sträng. |
