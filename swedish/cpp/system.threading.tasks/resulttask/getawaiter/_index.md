...
description: "System::Threading::Tasks::ResultTask::GetAwaiter metod. Hämtar en awaiter för denna resultatuppgift för användning med Await i C++."
type: docs
weight: 500
...
Hämtar en awaiter för denna resultattask för användning med Await.
