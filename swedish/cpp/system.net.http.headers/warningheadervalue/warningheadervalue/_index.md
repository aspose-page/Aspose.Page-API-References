...
description: "System::Net::Http::Headers::WarningHeaderValue::WarningHeaderValue konstruktor. Skapar en ny instans i C++."
type: docs
weight: 100
url: /sv/cpp/system.net.http.headers/warningheadervalue/warningheadervalue/
---
...
| --- | --- | --- |
| kod | int32_t | Varningskoden. |
| agent | String | Värdinformationen. |
| text | String | Varningstexten. |
...
| agent | String | Värdinformationen. |
| text | String | Varningstexten. |
| datum | DateTimeOffset | Datum och tid för varningen. |
