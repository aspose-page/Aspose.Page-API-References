...
description: "System::Net::Http::Headers::CacheControlHeaderValue klass. Representerar ett värde för ''Cache-Control''-rubriken. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr‑pekare och använd pekaren för att skicka den till funktioner som argument i C++."
type: docs
weight: 200
...
Representerar ett värde för 'Cache-Control'-rubriken. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| [get_MaxAge](./get_maxage/)() | Hämtar det maximala åldervärdet i sekunder som bestämmer en tidsperiod då klienten kommer att acceptera ett svar. |
| [get_MaxStale](./get_maxstale/)() | Hämtar värdet som bestämmer om klienten kommer att acceptera utgångna svar. |
| [get_MaxStaleLimit](./get_maxstalelimit/)() | Hämtar värdet i sekunder som bestämmer den tidsperiod då klienten kommer att acceptera utgångna svar. |
| [get_MinFresh](./get_minfresh/)() | Hämtar värdet som bestämmer färskhetens livslängd. |
...
| [get_NoTransform](./get_notransform/)() | Hämtar värdet som bestämmer om en cache eller proxy inte får ändra någon del av entitetskroppen. |
| [get_OnlyIfCached](./get_onlyifcached/)() | Hämtar värdet som bestämmer om klienten endast får använda cachade poster. |
...
| [get_PrivateHeaders](./get_privateheaders/)() | Hämtar samlingen av fältnamn i 'private'-direktivet i 'Cache-Control'-huvudet. |
...
| [get_SharedMaxAge](./get_sharedmaxage/)() | Hämtar det delade maximala åldervärdet i sekunder som åsidosätter 'max-age'-direktivet i 'Cache-Control'-huvudet eller 'Expires'-huvudet för en delad cache. |
...
| [set_MaxStale](./set_maxstale/)(bool) | Ställer in värdet som bestämmer om klienten kommer att acceptera de utgångna svaren. |
| [set_MaxStaleLimit](./set_maxstalelimit/)(Nullable\<TimeSpan\>) | Ställer in värdet i sekunder som bestämmer den tid då klienten kommer att acceptera de utgångna svaren. |
| [set_MinFresh](./set_minfresh/)(Nullable\<TimeSpan\>) | Ställer in värdet som bestämmer färskhetens livslängd. |
...
| [set_NoStore](./set_nostore/)(bool) | Ställer in värdet som bestämmer om en cache inte får lagra någon del av en HTTP-förfrågan eller -svar. |
...
| [set_OnlyIfCached](./set_onlyifcached/)(bool) | Ställer in värdet som bestämmer om klienten endast får använda cachade poster. |
