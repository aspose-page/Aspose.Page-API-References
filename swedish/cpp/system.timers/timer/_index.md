...
description: "System::Timers::Timer class. Timer som anropar delegat i en slinga i C++."
type: docs
weight: 200
...
| Metod | Beskrivning |
| --- | --- |
| [Close](./close/)() | Stoppar timern, frigör allokerade resurser. |
| [Dispose](./dispose/)() | Stoppar timern, frigör allokerade resurser. |
| [get_AutoReset](./get_autoreset/)() const | Kontrollerar om timern är i auto‑reset‑läge. |
...
| [set_Enabled](./set_enabled/)(bool) | Startar eller stoppar timern. Att starta timern återstartar inte tidräkningen om timern redan körs. |
| [set_Interval](./set_interval/)(double) | Ställer in timerintervallet. |
| [Start](./start/)() | Startar timern. Återstartar inte tidräkningen om timern redan körs. |
