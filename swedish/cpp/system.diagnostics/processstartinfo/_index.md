...
| [set_RedirectStandardError](./set_redirectstandarderror/)(bool) | Ställer in egenskapen RedirectStandardError. |
| [set_RedirectStandardInput](./set_redirectstandardinput/)(bool) | Ställer in egenskapen RedirectStandardInput. |
| [set_RedirectStandardOutput](./set_redirectstandardoutput/)(bool) | Ställer in egenskapen RedirectStandardOutput. |
| [set_UseShellExecute](./set_useshellexecute/)(bool) | Ställer in egenskapen UseShellExecute. |
