...
Ett inbäddat objekt av den mest lämpliga typen. Värdet från [XmlReader::get_ValueType](../get_valuetype/) bestämmer den lämpliga typen. Om innehållet är typat som en listtyp returnerar denna metod en array av inbäddade objekt av den lämpliga typen.
...
Kontrollerar att det angivna lokala namnet och namnrymds-URI:n matchar den för det aktuella elementet, och läser sedan det aktuella elementet och returnerar innehållet som ett [Object](../../../system/object/).
