...
Värdet för det angivna attributet. Denna metod flyttar inte läsaren.
...
När den åsidosätts i en avledd klass hämtar den värdet för attributet med det angivna [XmlReader::get_Name](../get_name/)‑värdet.
...
Värdet för det angivna attributet. Om attributet inte hittas eller värdet är [String::Empty](../../../system/string/empty/), returneras **nullptr**.
...
När den åsidosätts i en avledd klass hämtar den värdet för attributet med de angivna [XmlReader::get_LocalName](../get_localname/)‑ och [XmlReader::get_NamespaceURI](../get_namespaceuri/)‑värdena.
...
Värdet för det angivna attributet. Om attributet inte hittas eller värdet är [String::Empty](../../../system/string/empty/), returneras **nullptr**. Denna metod flyttar inte läsaren.
