...
| --- | --- | --- |
| djup | bool | **true** för att rekursivt klona underträdet under den angivna noden; **false** för att bara klona själva noden. Eftersom kommentarsnoder inte har barn, inkluderar den klonade noden alltid textinnehållet, oavsett parameterinställning. |
