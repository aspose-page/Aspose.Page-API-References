...
Hjälper till att säkra en annan implementation av [XmlResolver](../xmlresolver/) genom att omsluta [XmlResolver](../xmlresolver/)-objektet och begränsa de resurser som den underliggande [XmlResolver](../xmlresolver/) har åtkomst till.
...
| [XmlSecureResolver](./xmlsecureresolver/)(const SharedPtr\<XmlResolver\>\&, const String\&) | Initierar en ny instans av [XmlSecureResolver](./)-klassen med den angivna [XmlResolver](../xmlresolver/) och URL:en. |
## Typedefs
