...
description: "System::Xml::ValidationType enum. Anger typen av validering som ska utföras i C++."
type: docs
weight: 5500
...
| XDR | 3 | Validera enligt XML‑Data Reduced (XDR)‑scheman, inklusive inbäddade XDR‑scheman. XDR‑scheman identifieras med namnrymdsprefixet **x-schema** eller värdet från [XmlValidatingReader::get_Schemas](../xmlvalidatingreader/get_schemas/). |
