...
| strVersion | const String\& | Det här är versionsnumret för paketnamnet som ska testas. Om versionen inte är angiven (**nullptr**), innebär stöd för någon version av funktionen att metoden returnerar **true**. |
