...
Väljer den första [XmlNode](../) som matchar [XPath](../../../system.xml.xpath/) uttrycket. Alla prefix som hittas i [XPath](../../../system.xml.xpath/) uttrycket löses med den medföljande [XmlNamespaceManager](../../xmlnamespacemanager/).
