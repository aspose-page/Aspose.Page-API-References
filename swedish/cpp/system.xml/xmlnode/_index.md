...
Representerar en enda nod i XML-dokumentet.
...
| virtual [get_FirstChild](./get_firstchild/)() | Returnerar den första barnnoden till noden. |
...
| virtual [get_LastChild](./get_lastchild/)() | Returnerar den sista barnnoden till noden. |
| virtual [get_LocalName](./get_localname/)() | Returnerar det lokala namnet på noden, när det åsidosätts i en avledd klass. |
| virtual [get_Name](./get_name/)() | Returnerar det kvalificerade namnet på noden, när det åsidosätts i en avledd klass. |
...
| virtual [get_Prefix](./get_prefix/)() | Returnerar namnrymdsprefixet för denna nod. |
...
| virtual [get_SchemaInfo](./get_schemainfo/)() | Returnerar post‑schemavaliderings‑infosettet som har tilldelats denna nod som ett resultat av schemavalidering. |
...
| virtual [GetNamespaceOfPrefix](./getnamespaceofprefix/)(String) | Söker upp den närmaste **xmlns**-deklarationen för det givna prefixet som är i räckvidd för den aktuella noden och returnerar namnrymdens URI i deklarationen. |
| virtual [GetPrefixOfNamespace](./getprefixofnamespace/)(String) | Söker upp den närmaste **xmlns**-deklarationen för den givna namnrymdens URI som är i räckvidd för den aktuella noden och returnerar prefixet som definieras i den deklarationen. |
| virtual [idx_get](./idx_get/)(String) | Returnerar det första barnelementet med det angivna [XmlNode::get_Name](./get_name/). |
...
| virtual [PrependChild](./prependchild/)(SharedPtr\<XmlNode\>) | Lägger till den angivna noden i början av listan med barnnoder för denna nod. |
...
| virtual [set_Prefix](./set_prefix/)(String) | Ställer in namnrymdspräfixet för denna nod. |
| virtual [set_Value](./set_value/)(String) | Ställer in värdet på noden. |
| virtual [Supports](./supports/)(String, String) | Testar om DOM‑implementationen implementerar en specifik funktion. |
