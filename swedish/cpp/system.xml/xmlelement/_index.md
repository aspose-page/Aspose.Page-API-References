...
| [get_InnerXml](./get_innerxml/)() override | Returnerar markup som endast representerar barnen till denna nod. |
...
| [get_Prefix](./get_prefix/)() override | Returnerar namnrymdsprefixet för denna nod. |
| [get_SchemaInfo](./get_schemainfo/)() override | Returnerar post‑schemavaliderings‑infosettet som har tilldelats denna nod som ett resultat av schemavalidering. |
...
| virtual [RemoveAttribute](./removeattribute/)(String, String) | Tar bort ett attribut med det angivna lokala namnet och namnrymds-URI:n. (Om det borttagna attributet har ett standardvärde ersätts det omedelbart). |
...
| virtual [RemoveAttributeNode](./removeattributenode/)(String, String) | Tar bort den [XmlAttribute](../xmlattribute/) som anges av det lokala namnet och namnrymds-URI:n. (Om det borttagna attributet har ett standardvärde ersätts det omedelbart). |
| [set_InnerText](./set_innertext/)(String) override | Ställer in de sammanslagna värdena för noden och alla dess barn. |
| [set_InnerXml](./set_innerxml/)(String) override | Ställer in markupen som endast representerar barnen till denna nod. |
| [set_IsEmpty](./set_isempty/)(bool) | Ställer in taggformatet för elementet. |
| [set_Prefix](./set_prefix/)(String) override | Ställer in namnrymdspräfixet för denna nod. |
| virtual [SetAttribute](./setattribute/)(String, String) | Ställer in värdet för attributet med det angivna namnet. |
| virtual [SetAttribute](./setattribute/)(String, String, String) | Ställer in värdet för attributet med det angivna lokala namnet och namnrymds-URI:n. |
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Sparar alla barn till noden till den angivna [XmlWriter](../xmlwriter/). |
