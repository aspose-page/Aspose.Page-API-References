...
description: "System::Xml::XmlNodeReader‑klass. Representerar en läsare som ger snabb, icke‑cachad, endast framåtriktad åtkomst till XML‑data i en XmlNode i C++."
type: docs
weight: 2800
...
| [get_CanReadBinaryContent](./get_canreadbinarycontent/)() override | Returnerar ett värde som indikerar om [XmlNodeReader](./) implementerar metoderna för läsning av binärt innehåll. |
