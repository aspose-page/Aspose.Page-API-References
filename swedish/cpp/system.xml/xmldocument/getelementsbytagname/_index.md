...
description: "System::Xml::XmlDocument::GetElementsByTagName‑metod. Returnerar en XmlNodeList som innehåller en lista över alla underordnade element som matchar det angivna XmlDocument::get_LocalName och XmlNode::get_NamespaceURI i C++."
type: docs
weight: 3200
...
Returnerar en [XmlNodeList](../../xmlnodelist/) som innehåller en lista över alla underordnade element som matchar det angivna [XmlDocument::get_LocalName](../get_localname/) och [XmlNode::get_NamespaceURI](../../xmlnode/get_namespaceuri/).
...
| --- | --- | --- |
| localName | String | Det lokala namnet att matcha. Det speciella värdet **\"*\"** matchar alla taggar. |
| namespaceURI | String | NamespaceURI att matcha. |

### ReturnValue

En [XmlNodeList](../../xmlnodelist/) som innehåller en lista över alla matchande noder. Om inga noder matchar det angivna **localName** och **namespaceURI**, blir den returnerade samlingen tom.
