...
Den nya [XmlDeclaration](../../xmldeclaration/)‑nod.
## Anmärkningar



Obs: Om [XmlDocument](../) sparas till antingen en TextWriter eller en [XmlTextWriter](../../xmltextwriter/), kastas detta kodningsvärde bort. Istället används kodningen från TextWriter eller [XmlTextWriter](../../xmltextwriter/). Detta säkerställer att den skrivna XML‑en kan läsas tillbaka med rätt kodning.
## Se även
