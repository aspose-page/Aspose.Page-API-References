...
description: "System::Xml::XmlConvert‑klass. Kodar och avkodar XML‑namn, och tillhandahåller metoder för att konvertera mellan körningstyper och XML‑Schema‑definitionsspråk (XSD)-typer. Vid konvertering av datatyper är de returnerade värdena oberoende av lokala inställningar i C++."
type: docs
weight: 1200
...
Kodar och avkodar XML‑namn, och tillhandahåller metoder för att konvertera mellan körningstyper och XML‑[Schema](../../system.xml.schema/)-definitionsspråk (XSD)-typer. Vid konvertering av datatyper är de returnerade värdena oberoende av lokala inställningar.
...
| static [EncodeLocalName](./encodelocalname/)(const String\&) | Konverterar namnet till ett giltigt lokalt XML‑namn. |
...
| static [IsNCNameChar](./isncnamechar/)(char16_t) | Kontrollerar om det angivna tecknet är av en giltig icke‑kolon‑teckentyp. |
| static [IsPublicIdChar](./ispublicidchar/)(char16_t) | Returnerar den angivna teckeninstansen om tecknet i argumentet är ett giltigt offentligt id‑tecken, annars **nullptr**. |
| static [IsStartNCNameChar](./isstartncnamechar/)(char16_t) | Kontrollerar om det angivna tecknet är av en giltig startnamn‑teckentyp. |
| static [IsWhitespaceChar](./iswhitespacechar/)(char16_t) | Kontrollerar om det angivna tecknet är ett giltigt XML-mellanslagstecken. |
...
| static [ToString](./tostring/)(DateTime, XmlDateTimeSerializationMode) | Konverterar [DateTime](../../system/datetime/) till en [String](../../system/string/) med den angivna [XmlDateTimeSerializationMode](../xmldatetimeserializationmode/). |
...
| static [ToString](./tostring/)(DateTimeOffset, const String\&) | Konverterar den angivna [DateTimeOffset](../../system/datetimeoffset/) till en [String](../../system/string/) i det angivna formatet. |
| static [ToString](./tostring/)(Guid) | Konverterar [Guid](../../system/guid/) till en [String](../../system/string/). |
| static [ToTimeSpan](./totimespan/)(const String\&) | Konverterar [String](../../system/string/) till en motsvarande [TimeSpan](../../system/timespan/). |
| static [ToUInt16](./touint16/)(const String\&) | Konverterar [String](../../system/string/) till en motsvarande [UInt16](../../system/uint16/). |
| static [ToUInt32](./touint32/)(const String\&) | Konverterar [String](../../system/string/) till en motsvarande [UInt32](../../system/uint32/). |
| static [ToUInt64](./touint64/)(const String\&) | Konverterar [String](../../system/string/) till en motsvarande [UInt64](../../system/uint64/). |
