...
| [get_BaseURI](./get_baseuri/)() override | Returnerar nodens bas Uniform Resource Identifier (URI). |
...
| virtual [get_Specified](./get_specified/)() | Returnerar ett värde som indikerar om attributvärdet har satts explicit. |
...
| [PrependChild](./prependchild/)(SharedPtr\<XmlNode\>) override | Lägger till den angivna noden i början av listan med barnnoder för denna nod. |
...
| [set_InnerXml](./set_innerxml/)(String) override | Sätter värdet på attributet. |
...
| [WriteTo](./writeto/)(const SharedPtr\<XmlWriter\>\&) override | Sparar noden till den angivna [XmlWriter](../xmlwriter/). |
## Typedefs
