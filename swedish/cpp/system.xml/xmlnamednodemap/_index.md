...
Representerar en samling av noder som kan nås via namn eller index.
...
| virtual [GetNamedItem](./getnameditem/)(String) | Hämtar en [XmlNode](../xmlnode/) som anges av namn. |
...
| virtual [SetNamedItem](./setnameditem/)(SharedPtr\<XmlNode\>) | Lägger till en [XmlNode](../xmlnode/) med dess [XmlNode::get_Name](../xmlnode/get_name/) värde. |
## Typedefs
