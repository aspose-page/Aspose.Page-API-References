...
description: "System::Xml::XmlNameTable::Add‑metod. När den åsidosätts i en avledd klass atomiseras den angivna strängen och läggs till i XmlNameTable i C++."
type: docs
weight: 100
...
När den åsidosätts i en avledd klass atomiseras den angivna strängen och läggs till i [XmlNameTable](../).
...
Den nya atomiserade strängen eller den befintliga om den redan finns. Om length är noll returneras [String::Empty](../../../system/string/empty/).
