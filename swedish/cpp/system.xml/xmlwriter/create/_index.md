...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| output | const SharedPtr\<IO::TextWriter\>\& | TextWritern som du vill skriva till. [XmlWriter](../) skriver XML 1.0‑textsyntax och lägger till den i den angivna TextWriter. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| output | const SharedPtr\<XmlWriter\>\& | [XmlWriter](../)-objektet som du vill använda som underliggande skrivare. |

### ReturnValue

Ett [XmlWriter](../)-objekt som är inlindat runt det angivna [XmlWriter](../)-objektet.
