...
| ProcessingInstruction | 7 | En processinstruktion (till exempel **<?pi test?>**). |
...
| Blanksteg | 13 | Blanksteg mellan markup. |
| SignificantWhitespace | 14 | Blanksteg mellan markup i en blandad innehållsmodell eller blanksteg inom **xml:space=\"preserve\"**-området. |
