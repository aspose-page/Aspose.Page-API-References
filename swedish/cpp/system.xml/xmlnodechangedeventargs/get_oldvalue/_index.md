...
Returnerar nodens ursprungliga värde.
...
Det ursprungliga värdet på noden. Denna metod returnerar **nullptr** om noden varken är ett attribut eller ett text‑nod, eller om noden infogas. Om den anropas i ett **XmlDocument::NodeChanging**‑event, returnerar **get_OldValue** det aktuella värdet på noden som kommer att ersättas om ändringen lyckas. Om den anropas i ett **XmlDocument::NodeChanged**‑event, returnerar **get_OldValue** värdet på noden före ändringen.
