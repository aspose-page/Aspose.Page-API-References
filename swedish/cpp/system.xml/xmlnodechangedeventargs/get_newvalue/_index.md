...
Det nya värdet på noden. Denna metod returnerar **nullptr** om noden varken är ett attribut eller ett text‑nod, eller om noden tas bort. Om den anropas i ett **XmlDocument::NodeChanging**‑event, returnerar **get_NewValue** nodens värde om ändringen lyckas. Om den anropas i ett **XmlDocument::NodeChanged**‑event, returnerar **get_NewValue** det aktuella värdet på noden.
