...
description: "System::Xml::XmlNodeChangedEventArgs klass. Tillhandahåller data för XmlDocument::NodeChanged, XmlDocument::NodeChanging, XmlDocument::NodeInserted, XmlDocument::NodeInserting, XmlDocument::NodeRemoved och XmlDocument::NodeRemoving‑händelser i C++."
type: docs
weight: 2600
...
| [get_NewParent](./get_newparent/)() | Returnerar värdet av [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) efter att operationen slutförs. |
...
| [get_OldValue](./get_oldvalue/)() | Returnerar nodens ursprungliga värde. |
| [XmlNodeChangedEventArgs](./xmlnodechangedeventargs/)(const SharedPtr\<XmlNode\>\&, const SharedPtr\<XmlNode\>\&, const SharedPtr\<XmlNode\>\&, const String\&, const String\&, XmlNodeChangedAction) | Initierar en ny instans av [XmlNodeChangedEventArgs](./) klass. |
## Fält
