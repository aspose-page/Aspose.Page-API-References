...
Värdet av **ParentNode** innan operationen påbörjades. Den här metoden returnerar **nullptr** om noden inte hade någon förälder. För attributnoder returnerar metoden värdet från [XmlAttribute::get_OwnerElement](../../xmlattribute/get_ownerelement/).
