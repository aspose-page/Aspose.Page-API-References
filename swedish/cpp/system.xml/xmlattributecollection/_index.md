...
description: "System::Xml::XmlAttributeCollection class. Representerar en samling av attribut som kan nås via namn eller index i C++."
type: docs
weight: 700
...
Representerar en samling av attribut som kan nås via namn eller index.
...
| [SetNamedItem](./setnameditem/)(SharedPtr\<XmlNode\>) override | Lägger till en [XmlNode](../xmlnode/) med hjälp av dess [XmlNode::get_Name](../xmlnode/get_name/) resultat. |
## Typedefs
