...
Löser externa XML-resurser som namnges av en Uniform Resource Identifier (URI).
...
| virtual [ResolveUri](./resolveuri/)(SharedPtr\<Uri\>, String) | När den åsidosätts i en avledd klass, löser den absoluta URI:n från bas- och relativa URI:er. |
| virtual [set_Credentials](./set_credentials/)(SharedPtr\<Net::ICredentials\>) | När den åsidosätts i en avledd klass, anger den de autentiseringsuppgifter som används för att autentisera webbförfrågningar. |
