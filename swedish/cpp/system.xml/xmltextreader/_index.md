...
| [get_CanReadBinaryContent](./get_canreadbinarycontent/)() override | Returnerar ett värde som indikerar om [XmlTextReader](./) implementerar metoderna för läsning av binärt innehåll. |
...
| [get_IsDefault](./get_isdefault/)() override | Returnerar ett värde som indikerar om den aktuella noden är ett attribut som genererades från standardvärdet som definierats i DTD:n eller schemat. |
...
| [get_NamespaceURI](./get_namespaceuri/)() override | Returnerar namnrymdens URI (som definierad i W3C:s namnrymdsspecifikation) för noden som läsaren är placerad på. |
...
| [get_WhitespaceHandling](./get_whitespacehandling/)() | Returnerar ett värde som specificerar hur blanksteg hanteras. |
...
| [ReadBase64](./readbase64/)(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) | Avkodar Base64 och returnerar de avkodade binära bytena. |
| [ReadBinHex](./readbinhex/)(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) | Avkodar **BinHex** och returnerar de avkodade binära bytena. |
...
| [ReadContentAsBase64](./readcontentasbase64/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Läser innehållet och returnerar de **Base64**‑avkodade binära bytena. |
| [ReadContentAsBinHex](./readcontentasbinhex/)(ArrayPtr\<uint8_t\>, int32_t, int32_t) override | Läser innehållet och returnerar de **BinHex**‑avkodade binära bytena. |
...
| [set_DtdProcessing](./set_dtdprocessing/)(System::Xml::DtdProcessing) | Ställer in [DtdProcessing](../dtdprocessing/) uppräkningen. |
...
| [set_WhitespaceHandling](./set_whitespacehandling/)(System::Xml::WhitespaceHandling) | Ställer in ett värde som specificerar hur blanksteg hanteras. |
