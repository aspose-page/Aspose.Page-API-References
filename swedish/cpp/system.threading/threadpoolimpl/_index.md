...
| static [GetInitialized](./getinitialized/)() | Hämtar initierings-tillståndets singleton. |
...
| [JoinAll](./joinall/)() | Förenar alla ägda trådar. Väntar oändligt. |
| [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback, const System::SharedPtr\<System::Object\>\&) | Lägger till arbetsobjekt i kö. |
...
| [~ThreadPoolImpl](./~threadpoolimpl/)() | Destruktor. Ansluter alla trådar om de ännu inte har avslutats. |
## Se även
