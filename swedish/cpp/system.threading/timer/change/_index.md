...
Schemalägger om eller avbryter timer.
...
| --- | --- | --- |
| dueTime | int64_t | [Timeout](../../timeout/) före nästa anrop av återuppringningsfunktion, i millisekunder; negativa värden avbryter timer även om den var schemalagd. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| dueTime | System::TimeSpan | [Timeout](../../timeout/) före nästa anrop av återuppringningsfunktion; negativa värden avbryter timer även om den var schemalagd. |
