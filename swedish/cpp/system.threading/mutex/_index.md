...
description: "System::Threading::Mutex-klass. Mutex-implementation. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertionsfel. Wrappa alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 900
...
| virtual [Set](./set/)() | Sätt mutex till signalerat tillstånd. Ej implementerat. |
| [WaitOne](./waitone/)() override | Låser mutex. Utför obegränsad väntan om nödvändigt. |
| [WaitOne](./waitone/)(int) override | Låser mutex. Utför väntan om nödvändigt. |
| [WaitOne](./waitone/)(TimeSpan) override | Låser mutex. Utför väntan om nödvändigt. |
## Fält
