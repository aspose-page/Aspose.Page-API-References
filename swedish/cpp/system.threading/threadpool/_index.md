...
| static [JoinAllThreads](./joinallthreads/)() | Förenar alla ägda trådar. Väntar oändligt. |
| [operator=](./operator=/)(const ThreadPool\&) | Ingen kopiering. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback) | Lägger till arbetsobjekt i kö som finns med en callback utan parametrar. |
| static [QueueUserWorkItem](./queueuserworkitem/)(WaitCallback, const System::SharedPtr\<System::Object\>\&) | Lägger till arbetsobjekt i kö som finns med en callback utan parametrar. |
