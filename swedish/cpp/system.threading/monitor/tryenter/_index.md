---
title: "System::Threading::Monitor::TryEnter-metod"
linktitle: "TryEnter"
second_title: "Aspose.Page för C++"
description: "System::Threading::Monitor::TryEnter-metod. Försöker erhålla ett exklusivt lås på det angivna objektet. Ej implementerad i C++."
type: docs
weight: 600
url: /sv/cpp/system.threading/monitor/tryenter/
---
## Monitor::TryEnter(const SharedPtr\<Object\>\&) method


Försöker erhålla ett exklusivt lås på det specificerade objektet. Inte implementerat.
...
Försöker, under det specificerade antalet millisekunder, erhålla ett exklusivt lås på det specificerade objektet. Inte implementerat.
...
Försöker, under den specificerade tidsperioden, erhålla ett exklusivt lås på det specificerade objektet. Inte implementerat.
...
Försöker erhålla ett exklusivt lås på det specificerade objektet och sätter atomärt ett värde som indikerar om låset togs.
...
Försöker, under den angivna tidsperioden, att erhålla ett exklusivt lås på det angivna objektet och sätter atomiskt ett värde som indikerar om låset togs.
