...
| virtual [GetBytes](./getbytes/)(ArrayPtr\<uint8_t\>, int, int) | Fyller befintlig array‑del med slumpmässiga byte. |
| virtual [GetBytes](./getbytes/)(System::Details::ArrayView\<uint8_t\>) | Fyller befintliga array‑vy‑element med slumpmässiga byte. |
| virtual [GetBytes](./getbytes/)(System::Details::ArrayView\<uint8_t\>, int, int) | Fyller befintlig array‑vy‑del med slumpmässiga byte. |
| [GetBytes](./getbytes/)(System::Details::StackArray\<uint8_t, N\>\&) | Fyller befintliga stack‑array‑element med slumpmässiga byte. |
| [GetBytes](./getbytes/)(System::Details::StackArray\<uint8_t, N\>\&, int, int) | Fyller befintlig stack‑array‑del med slumpmässiga byte. |
