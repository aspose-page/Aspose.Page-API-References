...
| [CopyTo](./copyto/)(System::ArrayPtr\<System::SharedPtr\<Control\>\>, int) override | Kopierar samlingens innehåll till befintliga array-element. |
| [Find](./find/)(const System::String\&, bool) const | Söker efter den namngivna kontrollen i samlingen. Kontrollerar eventuellt innehållna kontrollers samlingar rekursivt. |
...
| [idx_get](./idx_get/)(int) const override | Indexbaserad åtkomst. |
| virtual [idx_get](./idx_get/)(System::String) const | Åtkomst efter namn. |
| [idx_set](./idx_set/)(int, System::SharedPtr\<Control\>) override | Indexbaserad åtkomst. |
| virtual [idx_set](./idx_set/)(System::String, System::SharedPtr\<Control\>) | Åtkomst efter namn. |
