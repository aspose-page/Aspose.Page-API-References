...
Kontrollerar om typen är en [System::Collections::Generic::List](../../system.collections.generic/list/)-specialisering. Om så är fallet sätts värdemedlemmen till true, annars sätts den till false.
