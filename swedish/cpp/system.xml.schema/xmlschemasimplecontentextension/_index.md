...
| [get_BaseTypeName](./get_basetypename/)() | Returnerar namnet på en inbyggd datatyp eller enkel typ som denna typ utökas från. |
...
| [set_BaseTypeName](./set_basetypename/)(const SharedPtr\<XmlQualifiedName\>\&) | Ställer in namnet på en inbyggd datatyp eller enkel typ som denna typ utökas från. |
