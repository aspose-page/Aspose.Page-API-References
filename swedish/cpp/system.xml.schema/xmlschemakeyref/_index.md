...
description: "System::Xml::Schema::XmlSchemaKeyref class. Denna klass representerar keyref‑elementet från XMLSchema enligt World Wide Web Consortium (W3C) i C++."
type: docs
weight: 4000
...
| Metod | Beskrivning |
| --- | --- |
| [get_Refer](./get_refer/)() | Returnerar namnet på nyckeln som detta villkor refererar till i en annan enkel eller komplex typ. |
| [set_Refer](./set_refer/)(const SharedPtr\<XmlQualifiedName\>\&) | Ställer in namnet på nyckeln som detta villkor refererar till i en annan enkel eller komplex typ. |
