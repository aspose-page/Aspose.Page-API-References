...
description: "System::Xml::Schema::XmlSchemaInfo klass. Representerar post-schema-valideringsinfosettet för en validerad XML-nod i C++."
type: docs
weight: 3800
...
| [get_Validity](./get_validity/)() override | Returnerar [XmlSchemaValidity](../xmlschemavalidity/) värdet för denna validerade XML-nod. |
...
| [set_SchemaElement](./set_schemaelement/)(const SharedPtr\<XmlSchemaElement\>\&) | Ställer in det kompilerade objektet [XmlSchemaElement](../xmlschemaelement/) som motsvarar denna validerade XML-nod. |
| [set_SchemaType](./set_schematype/)(const SharedPtr\<XmlSchemaType\>\&) | Ställer in den statiska XML [Schema](../) Definition Language (XSD) schematypen för denna validerade XML-nod. |
| [set_Validity](./set_validity/)(XmlSchemaValidity) | Ställer in [XmlSchemaValidity](../xmlschemavalidity/) värdet för denna validerade XML-nod. |
