...
| --- | --- | --- |
| schema | const SharedPtr\<XmlSchema\>\& | [XmlSchema](../../xmlschema/) att lägga till i samlingen. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| ns | const String\& | Namnutrymmet URI som är associerat med schemat. För XML‑scheman är detta vanligtvis **targetNamespace**. |
...
| --- | --- | --- |
| ns | const String\& | Namnutrymmet URI som är associerat med schemat. För XML‑scheman är detta vanligtvis **targetNamespace**. |
| uri | const String\& | URL-en som anger schemat som ska laddas. |
