...
description: "System::Xml::Schema::XmlSchemaAttribute klass. Representerar attribut‑elementet från XML‑schemat enligt World Wide Web Consortium (W3C). Attribut ger ytterligare information för andra dokumentelement. Attributtaggen är inbäddad mellan taggarna för ett dokuments element för schemat. XML‑dokumentet visar attribut som namngivna objekt i öppningstaggen för ett element i C++."
type: docs
weight: 1100
...
Representerar **attribute**‑elementet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Attribut ger ytterligare information för andra dokumentelement. Attributtaggen är inbäddad mellan taggarna för ett dokuments element för schemat. XML‑dokumentet visar attribut som namngivna objekt i öppningstaggen för ett element.
...
| Metod | Beskrivning |
| --- | --- |
| [get_AttributeSchemaType](./get_attributeschematype/)() | Returnerar ett [XmlSchemaSimpleType](../xmlschemasimpletype/)‑objekt som representerar typen av attributet baserat på värdet från [XmlSchemaAttribute::get_SchemaType](./get_schematype/) eller [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/). |
