...
description: "System::Xml::Schema::XmlSchemaChoice klass. Representerar **choice**‑elementet (kompositör) från XML‑schemat enligt World Wide Web Consortium (W3C). **choice** tillåter endast ett av sina barn att förekomma i en instans i C++."
type: docs
weight: 1400
...
Representerar **choice**‑elementet (kompositör) från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). **choice** tillåter endast ett av sina barn att förekomma i en instans.
