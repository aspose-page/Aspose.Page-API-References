...
description: "System::Xml::Schema::XmlSchemaSet::Contains‑metod. Anger om det angivna XML Schema‑definitionsspråk (XSD) XmlSchema‑objektet finns i XmlSchemaSet i C++."
type: docs
weight: 400
...
Anger om det angivna XML [Schema](../../) definitionsspråk (XSD) [XmlSchema](../../xmlschema/)‑objektet finns i [XmlSchemaSet](../).
