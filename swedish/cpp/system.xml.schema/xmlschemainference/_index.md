...
| Metod | Beskrivning |
| --- | --- |
| [get_Occurrence](./get_occurrence/)() | Returnerar värdet [XmlSchemaInference::InferenceOption](./inferenceoption/) som påverkar schemats förekomstdeklarationer som härleds från XML-dokumentet. |
| [get_TypeInference](./get_typeinference/)() | Returnerar värdet [XmlSchemaInference::InferenceOption](./inferenceoption/) som påverkar typer som härleds från XML-dokumentet. |
...
| [set_Occurrence](./set_occurrence/)(XmlSchemaInference::InferenceOption) | Ställer in värdet [XmlSchemaInference::InferenceOption](./inferenceoption/) som påverkar schemats förekomstdeklarationer som härleds från XML-dokumentet. |
| [set_TypeInference](./set_typeinference/)(XmlSchemaInference::InferenceOption) | Ställer in värdet för [XmlSchemaInference::InferenceOption](./inferenceoption/) som påverkar typer som härleds från XML-dokumentet. |
