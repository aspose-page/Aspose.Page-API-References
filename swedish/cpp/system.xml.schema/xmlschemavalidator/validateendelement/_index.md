...
description: "System::Xml::Schema::XmlSchemaValidator::ValidateEndElement-metoden. Verifierar om elementets textinnehåll är giltigt enligt dess datatyp för element med enkelt innehåll, och verifierar om innehållet i det aktuella elementet är komplett för element med komplext innehåll i C++."
type: docs
weight: 1800
