...
Klassen [XmlSchemaDatatype](./) är en abstrakt klass för att mappa XML [Schema](../) definition language (XSD)-typer till körningstyper.
...
| virtual [get_TokenizedType](./get_tokenizedtype/)() | När den åsidosätts i en avledd klass, hämtar den typen för **string** enligt World Wide [Web](../../system.web/) Consortium (W3C) XML 1.0-specifikationen. |
...
| virtual [ParseValue](./parsevalue/)(String, SharedPtr\<XmlNameTable\>, SharedPtr\<IXmlNamespaceResolver\>) | När den åsidosätts i en avledd klass, validerar den angivna **string** mot en inbyggd eller användardefinierad enkel typ. |
## Typedefs
