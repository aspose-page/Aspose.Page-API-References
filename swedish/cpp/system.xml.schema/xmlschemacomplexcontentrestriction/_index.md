...
description: "System::Xml::Schema::XmlSchemaComplexContentRestriction klass. Representerar **restriction**-elementet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass är för komplexa typer med en komplex innehållsmodell som härleds genom restriction. Den begränsar innehållet i den komplexa typen till en delmängd av den ärvda komplexa typen i C++."
type: docs
weight: 2000
...
Representerar **restriction**-elementet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass är för komplexa typer med en komplex innehållsmodell som härleds genom restriction. Den begränsar innehållet i den komplexa typen till en delmängd av den ärvda komplexa typen.
...
| [XmlSchemaComplexContentRestriction](./xmlschemacomplexcontentrestriction/)() | Initierar en ny instans av klassen [XmlSchemaComplexContentRestriction](./) klass. |
## Typedefs
