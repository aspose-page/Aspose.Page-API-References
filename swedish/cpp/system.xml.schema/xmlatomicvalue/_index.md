...
| [get_TypedValue](./get_typedvalue/)() override | Returnerar det aktuella validerade XML-elementet eller attributet som ett inramat objekt av den mest lämpliga typen enligt dess schematyp. |
