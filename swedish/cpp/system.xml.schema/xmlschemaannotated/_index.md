...
| [get_UnhandledAttributes](./get_unhandledattributes/)() | Returnerar de kvalificerade attributen som inte tillhör det aktuella schemats mål‑namnrymd. |
...
| [set_UnhandledAttributes](./set_unhandledattributes/)(const ArrayPtr\<SharedPtr\<XmlAttribute\>\>\&) | Ställer in de kvalificerade attributen som inte tillhör det aktuella schemats mål‑namnrymd. |
## Typedefs
