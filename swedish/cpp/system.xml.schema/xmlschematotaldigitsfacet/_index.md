---
title: "System::Xml::Schema::XmlSchemaTotalDigitsFacet klass"
linktitle: "XmlSchemaTotalDigitsFacet"
second_title: "Aspose.Page för C++"
description: "System::Xml::Schema::XmlSchemaTotalDigitsFacet klass. Representerar **totalDigits**-facet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass kan användas för att ange en begränsning på antalet siffror som kan anges för värdet av ett **simpleType**-element. Det värdet för **totalDigits** måste vara ett positivt heltal i C++."
type: docs
weight: 6700
url: /sv/cpp/system.xml.schema/xmlschematotaldigitsfacet/
---
