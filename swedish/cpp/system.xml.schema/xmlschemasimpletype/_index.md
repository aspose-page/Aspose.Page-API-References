...
description: "System::Xml::Schema::XmlSchemaSimpleType klass. Representerar simpleType‑elementet för enkelt innehåll från XML Schema enligt World Wide Web Consortium (W3C). Denna klass definierar en enkel typ. Enkla typer kan ange information och begränsningar för värdet på attribut eller element med enbart textinnehåll i C++."
type: docs
weight: 6200
