...
description: "System::Xml::Schema::XmlSchemaParticle klass. En basklass för detta är basklassen för alla partikeltyper (t.ex. XmlSchemaAny) i C++."
type: docs
weight: 5400
...
En basklass för detta är basklassen för alla partikeltyper (t.ex. [XmlSchemaAny](../xmlschemaany/)).
