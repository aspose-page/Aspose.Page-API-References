---
title: "System::Xml::XPath::XPathDocument::XPathDocument konstruktor"
linktitle: "XPathDocument"
second_title: "Aspose.Page för C++"
description: "System::Xml::XPath::XPathDocument::XPathDocument konstruktor. Initierar en ny instans av XPathDocument-klassen från XML-data i det angivna Stream-objektet i C++."
type: docs
weight: 100
url: /sv/cpp/system.xml.xpath/xpathdocument/xpathdocument/
---
...
| --- | --- | --- |
| ström | const SharedPtr\<IO::Stream\>\& | Stream-objektet som innehåller XML-data. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| textReader | const SharedPtr\<IO::TextReader\>\& | TextReader-objektet som innehåller XML-data. |
...
Initierar en ny instans av [XPathDocument](../)-klassen från XML-data som finns i det angivna [XmlReader](../../../system.xml/xmlreader/)-objektet.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | [XmlReader](../../../system.xml/xmlreader/)-objektet som innehåller XML-data. |
...
Initierar en ny instans av [XPathDocument](../)-klassen från XML-data som finns i det angivna [XmlReader](../../../system.xml/xmlreader/)-objektet med den angivna hanteringen av blanksteg.
...
| --- | --- | --- |
| reader | const SharedPtr\<XmlReader\>\& | [XmlReader](../../../system.xml/xmlreader/)-objektet som innehåller XML-data. |
| space | XmlSpace | Ett [XmlSpace](../../../system.xml/xmlspace/)-objekt. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| uri | const String\& | Sökvägen till filen som innehåller XML-data. |
...
Initierar en ny instans av [XPathDocument](../)-klassen från XML-data i den fil som anges med den specificerade blankstegshanteringen.
