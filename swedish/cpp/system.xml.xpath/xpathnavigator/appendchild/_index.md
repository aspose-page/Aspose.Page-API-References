...
Skapar en ny barnnod i slutet av listan över barnnoder för den aktuella noden med hjälp av XML-innehållet i det angivna [XmlReader](../../../system.xml/xmlreader/)‑objektet.
...
Skapar en ny barnnod i slutet av listan över barnnoder för den aktuella noden med hjälp av noderna i den angivna [XPathNavigator](../).
