...
| Metod | Beskrivning |
| --- | --- |
| virtual [AppendChild](./appendchild/)() | Returnerar ett [XmlWriter](../../system.xml/xmlwriter/)-objekt som används för att skapa ett eller flera nya underordnade noder i slutet av listan med underordnade noder för den aktuella noden. |
...
| virtual [AppendChildElement](./appendchildelement/)(String, String, String, String) | Skapar en ny barn‑elementnod i slutet av listan med barnnoder för den aktuella noden med det angivna namnrymdspr-prefixet, det lokala namnet och namnrymds‑URI:n samt det angivna värdet. |
| virtual [CheckValidity](./checkvalidity/)(SharedPtr\<System::Xml::Schema::XmlSchemaSet\>, System::Xml::Schema::ValidationEventHandler) | Verifierar att XML‑data i [XPathNavigator](./) följer det medföljande XML‑[Schema](../../system.xml.schema/)-definitionsspråket (XSD). |
| virtual [Clone](./clone/)() | När den åsidosätts i en avledd klass skapar den en ny [XPathNavigator](./) placerad på samma nod som denna [XPathNavigator](./). |
...
| virtual [CreateAttribute](./createattribute/)(String, String, String, String) | Skapar en attributnod på den aktuella elementnoden med det angivna namnrymdspr-prefixet, det lokala namnet och namnrymds‑URI:n samt det angivna värdet. |
...
| virtual [Evaluate](./evaluate/)(String, SharedPtr\<IXmlNamespaceResolver\>) | Utvärderar det angivna [XPath](../)-uttrycket och returnerar det typade resultatet, med hjälp av det angivna [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)-objektet för att lösa namnrymdspr-prefix i [XPath](../)-uttrycket. |
...
| virtual [Evaluate](./evaluate/)(SharedPtr\<XPathExpression\>, SharedPtr\<XPathNodeIterator\>) | Använder den medföljande kontexten för att utvärdera [XPathExpression](../xpathexpression/) och returnerar det typade resultatet. |
...
| virtual [get_InnerXml](./get_innerxml/)() | Returnerar markup‑en som representerar barnnoderna för den aktuella noden. |
| virtual [get_IsEmptyElement](./get_isemptyelement/)() | När den åsidosätts i en avledd klass hämtas ett värde som indikerar om den aktuella noden är ett tomt element utan ett avslutningselement‑tagg. |
| [get_IsNode](./get_isnode/)() override | Returnerar ett värde som indikerar om den aktuella noden representerar en [XPath](../)-nod. |
| virtual [get_LocalName](./get_localname/)() | När den åsidosätts i en avledd klass hämtas [XPathNavigator::get_Name](./get_name/) för den aktuella noden utan något namnrymdspr-prefix. |
| virtual [get_Name](./get_name/)() | När den åsidosätts i en avledd klass, hämtar det kvalificerade namnet på den aktuella noden. |
| virtual [get_NamespaceURI](./get_namespaceuri/)() | När den åsidosätts i en avledd klass, hämtar namnrymdens URI för den aktuella noden. |
| virtual [get_NameTable](./get_nametable/)() | När den åsidosätts i en avledd klass, hämtar [XmlNameTable](../../system.xml/xmlnametable/) för [XPathNavigator](./). |
...
| virtual [get_NodeType](./get_nodetype/)() | När den åsidosätts i en avledd klass, hämtar [XPathNodeType](../xpathnodetype/) för den aktuella noden. |
...
| [get_TypedValue](./get_typedvalue/)() override | Returnerar den aktuella noden som ett boxed‑objekt av den mest lämpliga typen. |
...
| [get_ValueType](./get_valuetype/)() override | Returnerar typen för den aktuella noden. |
...
| virtual [GetNamespace](./getnamespace/)(String) | Returnerar värdet för namnrymdsnoden som motsvarar det angivna lokala namnet. |
...
| virtual [InsertAfter](./insertafter/)(SharedPtr\<XmlReader\>) | Skapar en ny syskonnod efter den för närvarande valda noden med XML‑innehållet från det angivna [XmlReader](../../system.xml/xmlreader/)-objektet. |
...
| virtual [InsertBefore](./insertbefore/)(SharedPtr\<XmlReader\>) | Skapar en ny syskonnod före den för närvarande valda noden med XML‑innehållet från det angivna [XmlReader](../../system.xml/xmlreader/)-objektet. |
...
| virtual [InsertElementAfter](./insertelementafter/)(String, String, String, String) | Skapar ett nytt syskon‑element efter den aktuella noden med det angivna namnrymdspr‑prefixet, lokala namnet och namnrymdens URI, samt det angivna värdet. |
| virtual [InsertElementBefore](./insertelementbefore/)(String, String, String, String) | Skapar ett nytt syskonelement före den aktuella noden med det angivna namnrymdspr-prefixet, lokala namnet och den angivna namnrymds-URI:n, med det angivna värdet. |
...
| [LookupPrefix](./lookupprefix/)(const String\&) override | Returnerar prefixet som deklarerats för den angivna namnrymds-URI:n. |
...
| virtual [MoveToAttribute](./movetoattribute/)(String, String) | Flyttar [XPathNavigator](./) till attributet med matchande lokalt namn och namnrymds-URI. |
| virtual [MoveToChild](./movetochild/)(String, String) | Flyttar [XPathNavigator](./) till barnnoden med det angivna lokala namnet och namnrymds-URI:n. |
...
| [MoveToFirstNamespace](./movetofirstnamespace/)() | Flyttar [XPathNavigator](./) till den första namnrymdsnoden på den aktuella noden. |
| virtual [MoveToFollowing](./movetofollowing/)(String, String) | Flyttar [XPathNavigator](./) till elementet med det angivna lokala namnet och namnrymds-URI:n i dokumentordning. |
| virtual [MoveToFollowing](./movetofollowing/)(String, String, SharedPtr\<XPathNavigator\>) | Flyttar [XPathNavigator](./) till elementet med det angivna lokala namnet och namnrymds-URI:n, till den angivna gränsen, i dokumentordning. |
| virtual [MoveToFollowing](./movetofollowing/)(XPathNodeType) | Flyttar [XPathNavigator](./) till nästa element av den angivna [XPathNodeType](../xpathnodetype/) i dokumentordning. |
| virtual [MoveToFollowing](./movetofollowing/)(XPathNodeType, SharedPtr\<XPathNavigator\>) | Flyttar [XPathNavigator](./) till nästa element av den angivna [XPathNodeType](../xpathnodetype/), till den angivna gränsen, i dokumentordning. |
...
| virtual [MoveToNamespace](./movetonamespace/)(String) | Flyttar [XPathNavigator](./) till namnrymdsnoden med det angivna namnrymdspr-prefixet. |
...
| virtual [MoveToNext](./movetonext/)(String, String) | Flyttar [XPathNavigator](./) till nästa syskonnod med det angivna lokala namnet och namnrymds-URI:n. |
...
| virtual [MoveToRoot](./movetoroot/)() | Flyttar [XPathNavigator](./) till rotknoden som den aktuella noden tillhör. |
...
| virtual [PrependChildElement](./prependchildelement/)(String, String, String, String) | Skapar ett nytt barn‑element i början av listan över barnnoder för den aktuella noden med det angivna namnrymdspr‑prefixet, lokala namnet och namnrymds‑URI:n samt det angivna värdet. |
...
| virtual [Select](./select/)(String) | Väljer en noduppsättning med den angivna [XPath](../)-uttrycket. |
...
| virtual [SelectAncestors](./selectancestors/)(XPathNodeType, bool) | Väljer alla föräldranoder till den aktuella noden som har en matchande [XPathNodeType](../xpathnodetype/). |
| virtual [SelectAncestors](./selectancestors/)(String, String, bool) | Väljer alla föräldranoder till den aktuella noden som har det angivna lokala namnet och namnrymds‑URI:n. |
...
| virtual [SelectChildren](./selectchildren/)(String, String) | Väljer alla barnnoder till den aktuella noden som har det angivna lokala namnet och namnrymds‑URI:n. |
| virtual [SelectDescendants](./selectdescendants/)(XPathNodeType, bool) | Väljer alla ättlingnoder till den aktuella noden som har en matchande [XPathNodeType](../xpathnodetype/). |
| virtual [SelectDescendants](./selectdescendants/)(String, String, bool) | Väljer alla ättlingnoder till den aktuella noden med det angivna lokala namnet och namnrymds‑URI:n. |
...
| virtual [set_InnerXml](./set_innerxml/)(String) | Ställer in markup som representerar barnnoderna för den aktuella noden. |
| virtual [set_OuterXml](./set_outerxml/)(String) | Ställer in markup som representerar öppnings- och stängningstaggarna för den aktuella noden och dess barnnoder. |
...
| virtual [WriteSubtree](./writesubtree/)(SharedPtr\<XmlWriter\>) | Strömmar den aktuella noden och dess barnnoder till det angivna [XmlWriter](../../system.xml/xmlwriter/)-objektet. |
## Typedefs
