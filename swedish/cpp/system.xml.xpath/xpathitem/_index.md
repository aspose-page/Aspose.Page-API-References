...
Representerar ett objekt i XQuery 1.0 och [XPath](../) 2.0 [Data](../../system.data/)-modellen.
...
| virtual [get_TypedValue](./get_typedvalue/)() | När den åsidosätts i en avledd klass, hämtar det aktuella objektet som ett inramat objekt av den mest lämpliga typen enligt dess schematyp. |
