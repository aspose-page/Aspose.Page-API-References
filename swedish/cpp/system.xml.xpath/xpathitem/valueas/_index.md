...
När den åsidosätts i en avledd klass returneras objektets värde som den typ som anges med hjälp av [IXmlNamespaceResolver](../../../system.xml/ixmlnamespaceresolver/)-objektet som specificeras för att lösa namnrymdsprefix.
