...
description: "System::Xml::XPath::XPathNodeType-enum. Definierar de XPath-nodtyper som kan returneras från XPathNavigator-klassen i C++."
type: docs
weight: 1100
...
Definierar de [XPath](../)-nodtyper som kan returneras från [XPathNavigator](../xpathnavigator/)-klassen.
...
| Text | 4 | Textinnehållet i en nod. Motsvarar Document [Object](../../system/object/)-modellen (DOM) [Text](../../system.text/)- och CDATA-nodtyper. Innehåller minst ett tecken. |
| SignificantWhitespace | 5 | En nod med blankstegstecken och **xml:space** satt till **preserve**. |
| Blanksteg | 6 | En nod med endast blankstegstecken och ingen betydande blanksteg. Blankstegstecken är **'\\x20'**, **'\\x0d'**, **'\\x0a'**, **'\\x09'**. |
...
| All | 9 | Någon av [XPathNodeType](./) nodtyper. |
