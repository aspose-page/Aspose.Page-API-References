...
description: "System::Net::Cache::RequestCacheLevel enum. Enumen beskriver cache-inställningar som gäller för alla WebRequest i C++."
type: docs
weight: 500
...
Enumen beskriver cache-inställningar som gäller för alla [WebRequest](../../system.net/webrequest/).
...
| BypassCache | 1 | Tillfredsställer en begäran genom att använda servern. Inga poster tas från cachen. |
| CacheOnly | 2 | Tillfredsställer en begäran om en resurs endast från cachen. [WebException](../../system.net/webexception/) kommer att kastas när en resurs inte finns i klientcachen. |
