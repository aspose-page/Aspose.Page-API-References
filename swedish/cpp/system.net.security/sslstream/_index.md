...
description: "System::Net::Security::SslStream-klass. En ström som använder SSL-protokollet för att autentisera servern och valfritt klienten i C++."
type: docs
weight: 200
...
| virtual [get_CipherStrength](./get_cipherstrength/)() | Returnerar styrkan hos den använda krypteringsalgoritmen. |
| virtual [get_HashAlgorithm](./get_hashalgorithm/)() | Returnerar hash-algoritmen. |
| virtual [get_HashStrength](./get_hashstrength/)() | Returnerar styrkan hos den använda hash-algoritmen. |
...
| virtual [get_KeyExchangeStrength](./get_keyexchangestrength/)() | Returnerar styrkan hos den använda nyckelutbytesalgoritmen. |
