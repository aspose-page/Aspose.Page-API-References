...
description: "System::Drawing::TextureBrush::TextureBrush konstruktor. Skapar en ny instans av klassen TextureBrush som använder den angivna bilden i C++."
type: docs
weight: 100
url: /sv/cpp/system.drawing/texturebrush/texturebrush/
---
## TextureBrush::TextureBrush(const SharedPtr\<Image\>\&, Drawing2D::WrapMode, Rectangle) constructor


Skapar en ny instans av klassen [TextureBrush](../) som använder den angivna bilden.
...
| --- | --- | --- |
| bild | const SharedPtr\<Image\>\& | En bild som används av penseln för att fylla insidan av en form |
| wrap_mode | Drawing2D::WrapMode | Specificerar hur penselobjektet tileas |
| dst_rect | Rektangel | Specificerar den avgränsande rektangeln för penseln |
...
| bild | const SharedPtr\<Image\>\& | En bild som används av penseln för att fylla insidan av en form |
| wrap_mode | Drawing2D::WrapMode | Specificerar hur penselobjektet tileas |
| dst_rect | RectangleF | Specificerar den avgränsande rektangeln för penseln |
...
| bild | const SharedPtr\<Image\>\& | En bild som används av penseln för att fylla insidan av en form |
| dst_rect | Rektangel | Specificerar den avgränsande rektangeln för penseln |
| image_attrs | const SharedPtr\<Imaging::ImageAttributes\>\& | Bildattributen |
