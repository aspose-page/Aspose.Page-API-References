...
| [get_Transform](./get_transform/)() | Returnerar en kopia av ett Matrix-objekt som specificerar de geometriska transformationerna för den pensel som representeras av det aktuella objektet. |
| [get_WrapMode](./get_wrapmode/)() | Returnerar ett värde som specificerar hur penseln som representeras av det aktuella objektet upprepas. |
...
| [set_Transform](./set_transform/)(const System::SharedPtr\<Drawing2D::Matrix\>\&) | Ställer in ett Matrix-objekt som specificerar de geometriska transformationerna för den pensel som representeras av det aktuella objektet. |
| [set_WrapMode](./set_wrapmode/)(Drawing2D::WrapMode) | Ställer in ett värde som specificerar hur penseln som representeras av det aktuella objektet upprepas. |
