...
description: "System::Drawing::Pen class. Representerar egenskaper såsom färg, bredd osv. för de linjer och kurvor som ritas. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 1500
...
Representerar egenskaper såsom färg, bredd osv. för de linjer och kurvor som ritas. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [get_Brush](./get_brush/)() | Returnerar detta Pens [Brush](../brush/)-objekt. |
| [get_Color](./get_color/)() const | Returnerar detta Pens färg. |
| [get_CompoundArray](./get_compoundarray/)() const | Returnerar en array av värden som specificerar en sammansatt penna. |
| [get_DashCap](./get_dashcap/)() const | Returnerar ett värde som indikerar den spets som används i båda ändarna av en streckad linje. |
...
| [get_EndCap](./get_endcap/)() const | Returnerar ett värde som indikerar slutspetsen för det aktuella [Pen](./)-objektet. |
| [get_LineJoin](./get_linejoin/)() const | Returnerar ett värde som indikerar hur linjerna som ritas av detta [Pen](./)-objekt sammanfogas. |
| [get_MiterLimit](./get_miterlimit/)() const | Returnerar gränsen för tjockleken på fogen i ett snedkant. |
| [get_PenType](./get_pentype/)() const | INTE IMPLEMENTERAT. |
| [get_StartCap](./get_startcap/)() const | Returnerar ett värde som indikerar startspetsen för det aktuella [Pen](./)-objektet. |
...
| [MultiplyTransform](./multiplytransform/)(const SharedPtr\<Drawing2D::Matrix\>\&, Drawing2D::MatrixOrder) | Multiplicerar det aktuella objektets transformationsmatris med den angivna matrisen. |
...
| [ResetTransform](./resettransform/)() | Återställer det aktuella objektets transformationsmatris så att den blir en identitetsmatris. |
...
| [set_Alignment](./set_alignment/)(Drawing2D::PenAlignment) | Ställer in justeringen för det aktuella [Pen](./)-objektet. |
...
| [set_CustomEndCap](./set_customendcap/)(const SharedPtr\<Drawing2D::CustomLineCap\>\&) | Ställer in den anpassade slutspetsen. |
| [set_CustomStartCap](./set_customstartcap/)(const SharedPtr\<Drawing2D::CustomLineCap\>\&) | Ställer in den anpassade startspetsen. |
| [set_DashCap](./set_dashcap/)(Drawing2D::DashCap) | Ställer in ett värde som specificerar den spets som används i båda ändarna av en streckad linje. |
...
| [set_EndCap](./set_endcap/)(Drawing2D::LineCap) | Ställer in slutspetsen för det aktuella [Pen](./)-objektet. |
| [set_LineJoin](./set_linejoin/)(Drawing2D::LineJoin) | Ställer in ett värde som specificerar hur linjerna som ritas av detta [Pen](./)-objekt förenas. |
| [set_MiterLimit](./set_miterlimit/)(float) | Ställer in gränsen för tjockleken på föreningen i ett snedkantat hörn. |
| [set_StartCap](./set_startcap/)(Drawing2D::LineCap) | Ställer in startlinjekappen för det aktuella [Pen](./)-objektet. |
...
| [SetLineCap](./setlinecap/)(Drawing2D::LineCap, Drawing2D::LineCap, Drawing2D::DashCap) | INTE IMPLEMENTERAT. |
| [TranslateTransform](./translatetransform/)(float, float, Drawing2D::MatrixOrder) | Förflyttar den lokala geometriska transformationen med de angivna dimensionerna i den angivna ordningen. |
## Se även
