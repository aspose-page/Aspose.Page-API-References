...
description: "System::Drawing::Rectangle::Rectangle‑konstruktor. Skapar en ny instans av ett Rectangle‑objekt som representerar en rektangel med X‑ och Y‑koordinater samt bredd‑ och höjdvärden satta till 0 i C++."
type: docs
weight: 100
url: /sv/cpp/system.drawing/rectangle/rectangle/
---
## Rectangle::Rectangle() constructor


Skapar en ny instans av ett [Rectangle](../)-objekt som representerar en rektangel med X‑ och Y‑koordinater samt bredd‑ och höjdvärden satta till 0.
...
| --- | --- | --- |
| location | const Point\& | Anger platsen för rektangelns övre vänstra hörn |
| size | const Size\& | Anger rektangelns bredd och höjd |
...
Skapar en ny instans av [Rectangle](../)-objektet som representerar den rektangel som är ekvivalent med den angivna.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| rect | const System::Windows::Forms::Screen::Rectangle_\& | En instans av klassen [System::Windows::Forms::Screen::Rectangle_](../../../system.windows.forms/screen/rectangle_/) som specificerar positionen och storleken på den rektangel som ska representeras av objektet som konstrueras. |
