...
description: "System::Drawing::Bitmap::Bitmap constructor. Skapar ett nytt Bitmap-objekt från den angivna befintliga bilden i C++."
type: docs
weight: 100
...
Skapar ett nytt [Bitmap](../)-objekt från den angivna befintliga bilden, skalat till den angivna storleken.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| filnamn | const String\& | Namnet på filen som innehåller bilddata |
