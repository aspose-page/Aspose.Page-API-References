...
| [IsMultiImage](./ismultiimage/)() const override | Returnerar om det ursprungliga formatet är en multi‑image. |
...
| [PremultipleColors](./premultiplecolors/)() | Förmultiplicerar färgerna på bildens pixlar som representeras av det aktuella objektet. |
