...
| Metod | Beskrivning |
| --- | --- |
| [Clone](./clone/)() | Returnerar en kopia av det aktuella teckensnittet. |
...
| [Font](./font/)(const SharedPtr\<Font\>\&, FontStyle) | Skapar en ny instans av [Font](./)-klassen som representerar det angivna befintliga teckensnittet med den angivna teckensnittsstilen. |
...
| static [FromLogFont](./fromlogfont/)(const SharedPtr\<Object\>\&) | INTE IMPLEMENTERAT. |
| [get_Bold](./get_bold/)() | Avgör om teckensnittet som representeras av det aktuella objektet har den fetstilta stilen tillämpad. |
| [get_FontFamily](./get_fontfamily/)() | Returnerar teckensnittsfamiljen för teckensnittet som representeras av det aktuella objektet. |
...
| [get_Italic](./get_italic/)() | Avgör om teckensnittet som representeras av det aktuella objektet har den kursiva stilen tillämpad. |
...
| [get_Strikeout](./get_strikeout/)() | Avgör om teckensnittet som representeras av det aktuella objektet har genomstruken stil tillämpad. |
| [get_Style](./get_style/)() | Returnerar teckensnittsstilen för teckensnittet som representeras av det aktuella objektet. |
| [get_Underline](./get_underline/)() | Avgör om teckensnittet som representeras av det aktuella objektet har understruken stil tillämpad. |
