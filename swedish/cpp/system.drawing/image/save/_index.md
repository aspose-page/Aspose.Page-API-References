---
title: "System::Drawing::Image::Save‑metoden"
linktitle: "Save"
second_title: "Aspose.Page för C++"
description: "System::Drawing::Image::Save‑metoden. Sparar bilden som representeras av det aktuella objektet till den angivna strömmen med den angivna kodaren och kodarparametrarna i C++."
type: docs
weight: 2200
...
| kodare | const Imaging::ImageCodecInfoPtr\& | Kodaren att använda |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| filnamn | const String\& | Namnet på filen att spara bilden i |
...
| filnamn | const String\& | Namnet på filen att spara bilden i |
| kodare | const Imaging::ImageCodecInfoPtr\& | Kodaren att använda |
| encoder_params | const Imaging::EncoderParametersPtr\& | Parametrarna för kodaren att använda |
