...
description: "System::Drawing::Color klass. Representerar en färg. Denna typ bör allokeras på stacken och skickas till funktioner som värde eller referens. Använd aldrig System::SmartPtr-klass för att hantera objekt av denna typ i C++."
type: docs
weight: 500
...
Representerar en färg. Denna typ bör allokeras på stacken och skickas till funktioner som värde eller referens. Använd aldrig [System::SmartPtr](../../system/smartptr/) klass för att hantera objekt av denna typ.
...
| Metod | Beskrivning |
| --- | --- |
| [Color](./color/)() | Skapar en "tom" instans av [Color](./)-klassen som inte representerar någon färg. |
| [Equals](./equals/)(const Color\&) const | Bestämmer om det aktuella och det angivna [Color](./)-objekten representerar samma färg. |
| static [FromArgb](./fromargb/)(int) | Skapar en instans av [Color](./)-klassen som representerar den angivna färgen. |
| static [FromArgb](./fromargb/)(int, int, int, int) | Skapar en instans av [Color](./)-klassen som representerar den angivna färgen. |
| static [FromArgb](./fromargb/)(int, int, int) | Skapar en instans av [Color](./)-klassen som representerar den angivna färgen med alfakomponenten satt till 0xFF. |
| static [FromArgb](./fromargb/)(int, Color) | Skapar en instans av [Color](./)-klassen som representerar den angivna färgen. |
| static [FromKnownColor](./fromknowncolor/)(KnownColor) | Skapar en instans av [Color](./)-klassen som representerar den angivna kända färgen. |
| static [FromName](./fromname/)(const String\&) | Skapar en instans av [Color](./)-klassen som representerar en färg med det angivna namnet. |
| [get_A](./get_a/)() const | Returnerar värdet av alfakomponenten för färgen som representeras av det aktuella objektet. |
...
| [get_B](./get_b/)() const | Returnerar värdet av den blå komponenten i färgen som representeras av det aktuella objektet. |
...
| static [get_DarkGreen](./get_darkgreen/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF006400. |
| static [get_DarkKhaki](./get_darkkhaki/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFBDB76B. |
| static [get_DarkMagenta](./get_darkmagenta/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF8B008B. |
| static [get_DarkOliveGreen](./get_darkolivegreen/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF556B2F. |
| static [get_DarkOrange](./get_darkorange/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFF8C00. |
| static [get_DarkOrchid](./get_darkorchid/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF9932CC. |
| static [get_DarkRed](./get_darkred/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF8B0000. |
| static [get_DarkSalmon](./get_darksalmon/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFE9967A. |
| static [get_DarkSeaGreen](./get_darkseagreen/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF8FBC8F. |
| static [get_DarkSlateBlue](./get_darkslateblue/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF483D8B. |
| static [get_DarkSlateGray](./get_darkslategray/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF2F4F4F. |
| static [get_DarkTurquoise](./get_darkturquoise/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF00CED1. |
| static [get_DarkViolet](./get_darkviolet/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF9400D3. |
| static [get_DeepPink](./get_deeppink/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFF1493. |
| static [get_DeepSkyBlue](./get_deepskyblue/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF00BFFF. |
| static [get_DimGray](./get_dimgray/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF696969. |
| static [get_DodgerBlue](./get_dodgerblue/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF1E90FF. |
| static [get_Firebrick](./get_firebrick/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFB22222. |
| static [get_FloralWhite](./get_floralwhite/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFFFAF0. |
| static [get_ForestGreen](./get_forestgreen/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FF228B22. |
| static [get_Fuchsia](./get_fuchsia/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFF00FF. |
| [get_G](./get_g/)() const | Returnerar värdet av den gröna komponenten i färgen som representeras av det aktuella objektet. |
| static [get_Gainsboro](./get_gainsboro/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFDCDCDC. |
| static [get_GhostWhite](./get_ghostwhite/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFF8F8FF. |
| static [get_Gold](./get_gold/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFFD700. |
...
| static [get_Magenta](./get_magenta/)() | Returnerar en färg vars ARGB-värde i hexadecimalt notation är #FFFF00FF. |
...
| static [get_Olive](./get_olive/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF808000. |
| static [get_OliveDrab](./get_olivedrab/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF6B8E23. |
| static [get_Orange](./get_orange/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFFA500. |
| static [get_OrangeRed](./get_orangered/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFF4500. |
| static [get_Orchid](./get_orchid/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFDA70D6. |
| static [get_PaleGoldenrod](./get_palegoldenrod/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFEEE8AA. |
| static [get_PaleGreen](./get_palegreen/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF98FB98. |
| static [get_PaleTurquoise](./get_paleturquoise/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFAFEEEE. |
| static [get_PaleVioletRed](./get_palevioletred/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFDB7093. |
| static [get_PapayaWhip](./get_papayawhip/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFFEFD5. |
| static [get_PeachPuff](./get_peachpuff/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFFDAB9. |
| static [get_Peru](./get_peru/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFCD853F. |
| static [get_Pink](./get_pink/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFFC0CB. |
| static [get_Plum](./get_plum/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFDDA0DD. |
| static [get_PowderBlue](./get_powderblue/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFB0E0E6. |
| static [get_Purple](./get_purple/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF800080. |
| [get_R](./get_r/)() const | Returnerar värdet på den röda komponenten i färgen som representeras av det aktuella objektet. |
| static [get_Red](./get_red/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFF0000. |
| static [get_RosyBrown](./get_rosybrown/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFBC8F8F. |
| static [get_RoyalBlue](./get_royalblue/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF4169E1. |
| static [get_SaddleBrown](./get_saddlebrown/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF8B4513. |
| static [get_Salmon](./get_salmon/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFA8072. |
| static [get_SandyBrown](./get_sandybrown/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFF4A460. |
| static [get_SeaGreen](./get_seagreen/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FF2E8B57. |
| static [get_SeaShell](./get_seashell/)() | Returnerar en färg vars ARGB‑värde i hexadecimalt notation är #FFFFF5EE. |
...
| [GetHue](./gethue/)() | Returnerar Hue‑Saturation‑Brightness‑ (HSB) nyansvärdet, i grader, för färgen som representeras av det aktuella objektet. |
| [GetSaturation](./getsaturation/)() | Returnerar Hue‑Saturation‑Brightness‑ (HSB) mättnad för färgen som representeras av det aktuella objektet. |
| [IsNull](./isnull/)() const | Returnerar alltid falskt. |
| [operator!=](./operator!=/)(const std::nullptr_t\&) const | Returnerar alltid true. |
| [operator!=](./operator!=/)(const Color\&) const | Bestämmer om det aktuella och det angivna [Color](./)‑objekten representerar olika färger. |
| [operator==](./operator==/)(const std::nullptr_t\&) const | Returnerar alltid falskt. |
| [operator==](./operator==/)(const Color\&) const | Bestämmer om det aktuella och det angivna [Color](./)-objekten representerar samma färg. |
...
| Fält | Beskrivning |
| --- | --- |
| static [Empty](./empty/) | En "tom" instans av klassen [Color](./), dvs. en instans som inte representerar någon färg. |
## Se även
