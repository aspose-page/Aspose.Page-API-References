...
| [get_Extensions](./get_extensions/)() const | Hämtar samling av tilläggsobjekt som är associerade med certifikatet. |
...
| [get_Version](./get_version/)() const | Hämtar certifikatformatets version. |
...
| [GetDSAPrivateKey](./getdsaprivatekey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) privata nyckeln;. |
| [GetDSAPublicKey](./getdsapublickey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) offentlig nyckel. |
| [GetECDsaPrivateKey](./getecdsaprivatekey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) privata nyckeln;. |
| [GetECDsaPublicKey](./getecdsapublickey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) offentlig nyckel. |
| [GetNameInfo](./getnameinfo/)(X509NameType, bool) const | Hämtar ämnes- eller utfärdarens namn från certifikatet. |
| [GetRSAPrivateKey](./getrsaprivatekey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) privata nyckeln;. |
| [GetRSAPublicKey](./getrsapublickey/)() const | Hämtar [RSA](../../system.security.cryptography/rsa/) offentlig nyckel. |
...
| [X509Certificate2](./x509certificate2/)() | Skapar ett tomt [X509Certificate2](./). |
