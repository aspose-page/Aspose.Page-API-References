...
description: "System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName konstruktor. Konstruktor i C++."
type: docs
weight: 100
url: /sv/cpp/system.security.cryptography.x509certificates/x500distinguishedname/x500distinguishedname/
---
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Kodat distinkt namn. |
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) som representerar distinkt namn. |
## Anmärkningar
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Distinguished name att kopiera data från. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Distinguished name. |
| flags | X500DistinguishedNameFlags | Bitvis kombinerade flaggor som specificerar egenskaper för namnbyggnad. |
