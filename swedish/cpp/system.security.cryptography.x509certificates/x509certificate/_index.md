...
X.509 v.3-certifikat. Krypterade certifikat stöds inte. Endast [X509KeyStorageFlags::DefaultKeySet](../x509keystorageflags/) flagga stöds. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att resultera i körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [get_Handle](./get_handle/)() const | Hämtar en referens till Microsoft Cryptographic API:s certifikatkontext. |
| [get_Issuer](./get_issuer/)() const | Hämtar namnet på certifikatutfärdaren som utfärdade X.509v3-certifikatet. |
| [get_Subject](./get_subject/)() const | Hämtar ämnets distinkta namn från certifikatet. |
...
| virtual [GetFormat](./getformat/)() const | Hämtar namnet på certifikatformatet. |
| [GetHashCode](./gethashcode/)() const override | Hämtar certifikatets hashkod. |
| virtual [GetIssuerName](./getissuername/)() const | Hämtar namnet på certifieringsmyndigheten som utfärdade det aktuella certifikatet. |
...
| virtual [GetName](./getname/)() const | Hämtar namnet på den principal som det aktuella certifikatet utfärdades till. |
...
| virtual [GetSerialNumber](./getserialnumber/)() const | Hämtar serienumret från certifikatet som en bytearray. |
| virtual [GetSerialNumberString](./getserialnumberstring/)() const | Hämtar serienumret från certifikatet som en hexadecimal sträng. |
...
| virtual [Import](./import/)(const ByteArrayPtr\&, const SecureStringPtr\&, X509KeyStorageFlags) | Importerar information från de angivna certifikatdata. INTE IMPLEMENTERAD. |
| virtual [Import](./import/)(const ByteArrayPtr\&, const String\&, X509KeyStorageFlags) | Importerar information från de angivna certifikatdata. INTE IMPLEMENTERAD. |
| virtual [Import](./import/)(const String\&) | Importerar information från den angivna certifikatfilen. INTE IMPLEMENTERAD. |
| virtual [Import](./import/)(const ByteArrayPtr\&) | Importerar information från de angivna certifikatdata. INTE IMPLEMENTERAD. |
