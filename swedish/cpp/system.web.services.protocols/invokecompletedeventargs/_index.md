...
description: "System::Web::Services::Protocols::InvokeCompletedEventArgs class. En instans av denna klass skickas som argument till InvokeCompletedEventHandler-delegaten. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument i C++."
type: docs
weight: 200
...
| Metod | Beskrivning |
| --- | --- |
| [get_Results](./get_results/)() | Returnerar en samling av asynkrona operationresultat. |
