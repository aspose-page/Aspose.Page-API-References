...
description: "System::Collections::Specialized::NameValueCollection::NameValueCollection‑konstruktor. Initierar en ny instans av NameValueCollection‑klassen som är tom i C++."
type: docs
weight: 100
url: /sv/cpp/system.collections.specialized/namevaluecollection/namevaluecollection/
---
## NameValueCollection::NameValueCollection() constructor


Initierar en ny instans av [NameValueCollection](../)-klassen som är tom.
...
Kopierar posterna från den angivna [NameValueCollection](../) till en ny [NameValueCollection](../).
