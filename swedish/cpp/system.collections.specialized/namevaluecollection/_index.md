...
| [idx_get](./idx_get/)(const String\&) | Hämtar värdet på angivet index. |
| [idx_set](./idx_set/)(const String\&, const String\&) | Ställer in värdet för ett element. |
| [NameValueCollection](./namevaluecollection/)() | Initierar en ny instans av klassen [NameValueCollection](./) som är tom. |
...
| [Remove](./remove/)(const String\&) override | Tar bort ett specifikt objekt. |
| virtual [Set](./set/)(const String\&, const String\&) | Ställer in värdet för ett element. |
