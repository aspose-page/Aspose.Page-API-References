...
description: "System::Collections::Specialized::BitVector32 klass. Tillhandahåller en enkel lätt bitvektor med enkel heltals- eller Boolean‑åtkomst till ett 32‑bits lagringsutrymme i C++."
type: docs
weight: 100
...
Tillhandahåller en enkel lätt bitvektor med enkel heltals- eller [Boolean](../../system/boolean/) åtkomst till ett 32‑bits lagringsutrymme.
...
| [Equals](./equals/)(const BitVector32\&) | Bestämmer om det angivna objektet är samma som det aktuella. |
| [get_Data](./get_data/)() | returns de råa data som lagras i denna bitvektor... |
