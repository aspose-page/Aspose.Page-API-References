...
description: Clase para opciones de guardado de XPS como PDF.
type: docs
weight: 380
...
| [OutlineTreeHeight](../../aspose.page.xps.presentation.pdf/pdfsaveoptions/outlinetreeheight) { get; set; } | Especifica la altura del árbol de esquema del documento para guardar. 0: el árbol de esquema no se convertirá, 1: solo se convertirán los elementos de esquema de primer nivel, y así sucesivamente. |
