...
description: Describe las características de perforación de agujeros de la salida. Todos los documentos se perforan juntos. ElJobHolePunch./jobholepunch yDocumentHolePunch./documentholepunchlas palabras clave son mutuamente excluyentes. Ambas no deben especificarse simultáneamente en un documento PrintTicket o Print Capabilities. https//docs.microsoft.com/enus/windows/win32/printdocs/jobholepunch
type: docs
weight: 1290
...
Describe las características de perforación de agujeros de la salida. Todos los documentos se perforan juntos. El[`JobHolePunch`](../jobholepunch) y[`DocumentHolePunch`](../documentholepunch)las palabras clave son mutuamente excluyentes. Ambas no deben especificarse simultáneamente en un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
