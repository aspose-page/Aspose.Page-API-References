...
description: Describe las características de clasificación de la salida. Se intercalan todas las páginas de cada documento individual. DocumentCollate y JobCollateAlldocuments se excluyen mutuamente. El comportamiento y la implementación de si se implementan ambas o solo una de estas palabras clave se deja al controlador. https//docs.microsoft.com/enus/windows/win32/printdocs/documentcollate
type: docs
weight: 550
