...
description: Especifica una referencia de URI relativa a un perfil ICC que define el espacio de color que DEBE usarse para la combinación. El ltUrigt es un nombre de pieza absoluto relativo a la raíz del paquete. https//docs.microsoft.com/enus /windows/win32/printdocs/pageblendcolorspaceiccprofileuri
type: docs
weight: 1760
