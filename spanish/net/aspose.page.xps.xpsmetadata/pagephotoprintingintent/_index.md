...
| Nombre | Descripción |
| --- | --- |
| class [PagePhotoPrintingIntentOption](pagephotoprintingintent.pagephotoprintingintentoption) | Define[`PagePhotoPrintingIntent`](../pagephotoprintingintent) opciones de funciones. |
