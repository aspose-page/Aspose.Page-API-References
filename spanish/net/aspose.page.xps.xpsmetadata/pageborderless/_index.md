...
description: Describe cuándo se debe imprimir el contenido de la imagen en los bordes físicos del medio. https//docs.microsoft.com/enus/windows/win32/printdocs/pageborderless
type: docs
weight: 1770
...
| Nombre | Descripción |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption) | Describe el[`PageBorderless`](../pageborderless) opciones de funciones. |
