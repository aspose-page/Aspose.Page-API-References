...
Describe la portada (principio) delantera. Cada documento tendrá una hoja separada. La portada debe estar impresa en el[`PageMediaSize`](../pagemediasize/) y[`PageMediaType`](../pagemediatype/) utilizado para la primera página del documento. La portada debe integrarse en las opciones de procesamiento (como[`DocumentDuplex`](../documentduplex/) ,[`DocumentNUp`](../documentnup/) ) como lo indica la opción especificada. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
...
| Nombre | Descripción |
| --- | --- |
| [DocumentCoverFront](documentcoverfront/)(params CoverFrontOption[]) | Crea una nueva instancia. |
...
| Nombre | Descripción |
| --- | --- |
| class [CoverFrontOption](documentcoverfront.coverfrontoption/) | Describe el`DocumentCoverFront` opciones de funciones. |
