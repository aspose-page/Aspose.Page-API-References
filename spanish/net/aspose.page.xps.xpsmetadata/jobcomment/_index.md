...
description: Aspose.Page.XPS.XpsMetadata.JobComment clase. Especifica un comentario asociado con el trabajo. Ejemplo Entregue en la habitación 1234 cuando haya terminado. https//docs.microsoft.com/enus/windows/win32/printdocs/jobcomment
type: docs
weight: 1210
url: /es/net/aspose.page.xps.xpsmetadata/jobcomment/
---
## JobComment class

Especifica un comentario asociado con el trabajo. Ejemplo: "Entregue en la habitación 1234 cuando haya terminado". https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
...
| Nombre | Descripción |
| --- | --- |
| [JobComment](jobcomment/)(string) | Crea una nueva instancia. |
