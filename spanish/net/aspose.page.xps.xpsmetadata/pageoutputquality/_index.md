...
description: Aspose.Page.XPS.XpsMetadata.PageOutputQuality clase. Describe la configuración negativa de la salida. https//docs.microsoft.com/enus/windows/win32/printdocs/pageoutputquality
type: docs
weight: 2370
url: /es/net/aspose.page.xps.xpsmetadata/pageoutputquality/
---
...
| Nombre | Descripción |
| --- | --- |
| [PageOutputQuality](pageoutputquality/)(params PageOutputQualityOption[]) | Crea una nueva instancia. |
...
| Nombre | Descripción |
| --- | --- |
| class [PageOutputQualityOption](pageoutputquality.pageoutputqualityoption/) | Define`PageOutputQuality` opciones de funciones. |
