...
description: Describe la configuración negativa de la salida. https//docs.microsoft.com/enus/windows/win32/printdocs/pageoutputquality
type: docs
weight: 2310
...
| Nombre | Descripción |
| --- | --- |
| class [PageOutputQualityOption](pageoutputquality.pageoutputqualityoption) | Define[`PageOutputQuality`](../pageoutputquality) opciones de funciones. |
