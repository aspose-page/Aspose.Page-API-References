...
description: El contenido de la aplicación etiquetado con el color especificado DEBE aparecer en todas las separaciones de color. https//docs.microsoft.com/enus/windows/win32/printdocs/documentimpositioncolor
type: docs
weight: 660
