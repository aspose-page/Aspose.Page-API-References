...
description: Describe la orientación de la hoja de medios físicos. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2240
...
| Nombre | Descripción |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption) | Describe el[`PageOrientation`](../pageorientation) opciones de funciones. |
