...
description: Aspose.Page.XPS.XpsMetadata.PageOrientation clase. Describe la orientación de la hoja de medios físicos. https//docs.microsoft.com/enus/windows/win32/printdocs/pageorientation
type: docs
weight: 2300
url: /es/net/aspose.page.xps.xpsmetadata/pageorientation/
---
## PageOrientation class

Describe la orientación de la hoja de medios físicos. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageorientation
...
| Nombre | Descripción |
| --- | --- |
| [PageOrientation](pageorientation/)(params PageOrientationOption[]) | Crea una nueva instancia. |
...
| Nombre | Descripción |
| --- | --- |
| class [PageOrientationOption](pageorientation.pageorientationoption/) | Describe el`PageOrientation` opciones de funciones. |
