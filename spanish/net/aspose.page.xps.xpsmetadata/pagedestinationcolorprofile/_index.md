...
| Nombre | Descripción |
| --- | --- |
| [PageDestinationColorProfile](pagedestinationcolorprofile/)(params PageDestinationColorProfileOption[]) | Crea una nueva instancia. |
...
| Nombre | Descripción |
| --- | --- |
| class [PageDestinationColorProfileOption](pagedestinationcolorprofile.pagedestinationcolorprofileoption/) | Describe el`PageDestinationColorProfile` opciones de funciones. |
