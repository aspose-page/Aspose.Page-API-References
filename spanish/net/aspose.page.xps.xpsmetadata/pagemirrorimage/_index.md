...
Describe la configuración de duplicación de la salida. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemirrorimage
...
| Nombre | Descripción |
| --- | --- |
| [PageMirrorImage](pagemirrorimage/)(params PageMirrorImageOption[]) | Crea una nueva instancia. |
...
| Nombre | Descripción |
| --- | --- |
| class [PageMirrorImageOption](pagemirrorimage.pagemirrorimageoption/) | Define`PageMirrorImage` opciones de funciones. |
