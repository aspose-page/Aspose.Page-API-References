...
description: Describe la configuración de duplicación de la salida. https//docs.microsoft.com/enus/windows/win32/printdocs/pagemirrorimage
type: docs
weight: 2200
...
| Nombre | Descripción |
| --- | --- |
| class [PageMirrorImageOption](pagemirrorimage.pagemirrorimageoption) | Define[`PageMirrorImage`](../pagemirrorimage) opciones de funciones. |
