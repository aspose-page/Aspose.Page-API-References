...
| Nombre | Descripción |
| --- | --- |
| class [ErrorSheetWhenOption](joberrorsheet.errorsheetwhen.errorsheetwhenoption) | Describe el[`ErrorSheetWhen`](../joberrorsheet.errorsheetwhen) opciones de funciones. |
