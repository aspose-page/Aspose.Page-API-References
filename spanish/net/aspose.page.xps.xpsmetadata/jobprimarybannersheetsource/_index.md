...
Especifica el origen de una portada principal personalizada para el trabajo. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
...
| Nombre | Descripción |
| --- | --- |
| [JobPrimaryBannerSheetSource](jobprimarybannersheetsource/)(string) | Crea una nueva instancia. |
