...
description: La clase que encapsula una función de esquema de impresión común. La clase base para todas las funciones definidas por el esquema. A El elemento contiene una lista completa de losOption./option yProperty./property elementos que describen completamente un atributo de dispositivo una configuración de formato de trabajo u otra característica relevante. https//docs.microsoft.com/enus/windows/win32/printdocs/feature
type: docs
weight: 810
