...
Especifica el origen de una portada personalizada. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbannersheetsource
...
| Nombre | Descripción |
| --- | --- |
| [DocumentBannerSheetSource](documentbannersheetsource/)(string) | Crea una nueva instancia. |
