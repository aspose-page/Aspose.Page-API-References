...
description: Describe la salida de la hoja de errores. Todo el trabajo tendrá una sola hoja de error. El error sheet debería salir por defectoPageMediaSize./pagemediasize y usando el valor predeterminadoPageMediaType./pagemediatype . La hoja de errores debe aislarse del resto del trabajo. Esto significa que cualquier opción de procesamiento de acabado o como   o  no debe incluir la hoja de error. La hoja de error debe aparecer como hoja final del trabajo. https//docs.microsoft.com/enus/windows/win32/printdocs/joberrorsheet
type: docs
weight: 1230
...
| Nombre | Descripción |
| --- | --- |
| class [ErrorSheetOption](joberrorsheet.errorsheetoption) | Describe el[`JobErrorSheet`](../joberrorsheet) opciones de funciones. |
| class [ErrorSheetWhen](joberrorsheet.errorsheetwhen) | Describe interior característica. |
| interface [IJobErrorSheetItem](joberrorsheet.ijoberrorsheetitem) | La interfaz de cualquier[`JobErrorSheet`](../joberrorsheet) característica artículo. |
