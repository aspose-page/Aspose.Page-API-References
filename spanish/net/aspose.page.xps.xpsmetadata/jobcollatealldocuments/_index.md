...
description: Describe las características de clasificación de la salida. Se cotejan todos los documentos de cada trabajo individual. DocumentCollate./documentcollate yJobCollateAllDocuments./jobcollatealldocumentsson mutuamente excluyentes. El comportamiento y la implementación de si se implementan ambas o solo una de estas palabras clave se deja al controlador. https//docs.microsoft.com/enus/windows/win32/printdocs/jobcollatealldocuments
type: docs
weight: 1140
