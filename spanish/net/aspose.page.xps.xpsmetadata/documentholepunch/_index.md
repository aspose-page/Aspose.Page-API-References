...
description: Describe las características de perforación de agujeros de la salida. Cada documento se perfora por separado. ElJobHolePunch./jobholepunch yDocumentHolePunch./documentholepunch las palabras clave se excluyen mutuamente. Ambas no deben especificarse simultáneamente en un documento PrintTicket o Print Capabilities. https//docs.microsoft.com/enus/windows/win32/printdocs/documentholepunch
type: docs
weight: 640
...
Describe las características de perforación de agujeros de la salida. Cada documento se perfora por separado. El[`JobHolePunch`](../jobholepunch) y[`DocumentHolePunch`](../documentholepunch) las palabras clave se excluyen mutuamente. Ambas no deben especificarse simultáneamente en un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
