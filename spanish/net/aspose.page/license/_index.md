...
description: Aspose.Page.License clase. Proporciona métodos para licenciar el componente.
type: docs
weight: 270
url: /es/net/aspose.page/license/
---
## License class
...
| Nombre | Descripción |
| --- | --- |
| [Embedded](../../aspose.page/license/embedded/) { get; set; } | El número de licencia se agregó como recurso incrustado. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [SetLicense](../../aspose.page/license/setlicense/#setlicense)(Stream) | Licencia el componente. |
| [SetLicense](../../aspose.page/license/setlicense/#setlicense_1)(string) | Licencia el componente. |
