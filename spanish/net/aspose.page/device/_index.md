...
description: Aspose.Page.Device clase. Esta clase encapsula la representación del documento en un dispositivo abstracto. La representación del documento se realiza página por página.
type: docs
weight: 20
...
| Nombre | Descripción |
| --- | --- |
| [Device](device/)(Size) | Inicializa`Device` con un tamaño de una página. |
