...
description: Esta clase contiene las opciones necesarias para administrar el proceso de conversión.
type: docs
weight: 240
...
| Nombre | Descripción |
| --- | --- |
| [SaveOptions](saveoptions#constructor)() | Inicializa una nueva instancia del[`SaveOptions`](../saveoptions) clase con valores predeterminados para banderas!:SuppressErrors (verdadero) y[`Debug`](./debug) (falso). |
| [SaveOptions](saveoptions#constructor_1)(bool) | Inicializa una nueva instancia del[`SaveOptions`](../saveoptions) clase con valor predeterminado para la bandera[`Debug`](./debug) (falso). |
