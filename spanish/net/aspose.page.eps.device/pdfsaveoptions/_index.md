...
description: Esta clase contiene flujos de entrada y salida y otras opciones necesarias para administrar el proceso de conversión.
type: docs
weight: 70
...
| Nombre | Descripción |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions#constructor)() | Inicializa una nueva instancia del[`PdfSaveOptions`](../pdfsaveoptions) clase con valores predeterminados para banderas!:SuppressErrors (verdadero) y!:Debug (falso). |
| [PdfSaveOptions](pdfsaveoptions#constructor_1)(bool) | Inicializa una nueva instancia del[`PdfSaveOptions`](../pdfsaveoptions) clase con valores predeterminados para la bandera!:Debug (falso). |
