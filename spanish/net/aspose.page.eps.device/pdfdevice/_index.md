...
description: Esta clase encapsula la representación del documento en PDF.
type: docs
weight: 60
...
| Nombre | Descripción |
| --- | --- |
| [PdfDevice](pdfdevice#constructor)(Stream) | Inicializa una nueva instancia de[`PdfDevice`](../pdfdevice) con flujo de salida. |
| [PdfDevice](pdfdevice#constructor_1)(Stream, Size) | Inicializa una nueva instancia de[`PdfDevice`](../pdfdevice) con flujo de salida y tamaño especificado de una página. |
