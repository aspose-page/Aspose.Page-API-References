...
description: Aspose.Page.EPS.Device.ImageDevice clase. Esta clase encapsula la representación del documento en imagen.
type: docs
weight: 40
...
| Nombre | Descripción |
| --- | --- |
| [ImageDevice](imagedevice/#constructor)() | Inicializa una nueva instancia de`ImageDevice` . |
| [ImageDevice](imagedevice/#constructor_1)(ImageFormat) | Inicializa una nueva instancia de`ImageDevice` con formato de imagen especificado. |
| [ImageDevice](imagedevice/#constructor_2)(Size) | Inicializa una nueva instancia de`ImageDevice` con el tamaño especificado de una página. |
| [ImageDevice](imagedevice/#constructor_3)(Size, ImageFormat) | Inicializa una nueva instancia de`ImageDevice` con el tamaño especificado de una página y formato de imagen. |
