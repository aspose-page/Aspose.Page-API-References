...
description: Clase que encapsula características del elemento Glyphs. Este elemento representa una ejecución de texto con formato uniforme de una sola fuente. Proporciona la información necesaria para una representación precisa y admite funciones de búsqueda y selección en los consumidores de visualización.
type: docs
weight: 3030
