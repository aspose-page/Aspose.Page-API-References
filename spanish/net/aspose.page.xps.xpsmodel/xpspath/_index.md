...
description: Clase que encapsula características del elemento Path. Este elemento es el único medio para agregar gráficos vectoriales e imágenes a una página fija. Define un único gráfico vectorial que se representará en una página.
type: docs
weight: 3190
