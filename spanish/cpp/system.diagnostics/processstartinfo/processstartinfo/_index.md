...
description: "System::Diagnostics::ProcessStartInfo::ProcessStartInfo constructor. Crea un objeto de información de inicio vacío en C++."
type: docs
weight: 100
url: /es/cpp/system.diagnostics/processstartinfo/processstartinfo/
---
## ProcessStartInfo::ProcessStartInfo() constructor


Crea un objeto de información de inicio vacío.
...
Crea un objeto de información de inicio.
...
| --- | --- | --- |
| fileName | const String\& | Nombre de archivo o ruta. |
...
| --- | --- | --- |
| fileName | const String\& | Nombre de archivo o ruta. |
| arguments | const String\& | [Process](../../process/) argumentos. |
