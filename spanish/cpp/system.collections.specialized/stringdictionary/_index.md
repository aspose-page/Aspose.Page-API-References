...
| Método | Descripción |
| --- | --- |
| [idx_get](./idx_get/)(const String\&) const override | Obtiene el valor en una clave específica. |
## Ver también
