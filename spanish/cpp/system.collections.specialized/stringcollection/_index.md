...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const System::String\&) | Añade el valor al final de la lista. |
...
| [CopyTo](./copyto/)(const ArrayPtr\<System::String\>\&, const int32_t) const | Copiar elementos a los elementos existentes del arreglo. |
