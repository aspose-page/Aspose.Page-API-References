...
description: "System::Collections::Specialized::NameValueCollection::NameValueCollection constructor. Inicializa una nueva instancia de la clase NameValueCollection que está vacía en C++."
type: docs
weight: 100
url: /es/cpp/system.collections.specialized/namevaluecollection/namevaluecollection/
---
## NameValueCollection::NameValueCollection() constructor


Inicializa una nueva instancia de la clase [NameValueCollection](../) que está vacía.
...
Copia las entradas del [NameValueCollection](../) especificado a un nuevo [NameValueCollection](../).
