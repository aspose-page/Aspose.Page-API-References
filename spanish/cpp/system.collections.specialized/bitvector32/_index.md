...
description: "System::Collections::Specialized::BitVector32 clase. Proporciona un vector de bits ligero y sencillo con acceso fácil a enteros o Boolean a un almacenamiento de 32 bits en C++."
type: docs
weight: 100
...
Proporciona un vector de bits ligero y sencillo con acceso fácil a enteros o [Boolean](../../system/boolean/) a un almacenamiento de 32 bits.
...
| static [CreateMask](./createmask/)() | Crea la primera máscara en una serie. |
| static [CreateMask](./createmask/)(int32_t) | Crea la siguiente máscara en una serie. |
| static [CreateSection](./createsection/)(int16_t) | Crea la primera sección en una serie, con el valor máximo especificado. |
| static [CreateSection](./createsection/)(int16_t, BitVector32::Section) | Crea la siguiente sección en una serie, con el valor máximo especificado. |
...
| [idx_set](./idx_set/)(BitVector32::Section, int32_t) | Establece el valor para la sección especificada. |
