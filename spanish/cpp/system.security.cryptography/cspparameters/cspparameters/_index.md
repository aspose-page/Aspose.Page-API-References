...
description: "System::Security::Cryptography::CspParameters::CspParameters constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography/cspparameters/cspparameters/
---
...
| --- | --- | --- |
| dwTypeIn | int | Código del tipo de proveedor; ignorado. |
...
| --- | --- | --- |
| dwTypeIn | int | Código del tipo de proveedor; ignorado. |
| strProviderNameIn | const System::String\& | Nombre del proveedor; ignorado. |
...
| dwTypeIn | int | Código del tipo de proveedor; ignorado. |
| strProviderNameIn | const System::String\& | Nombre del proveedor; ignorado. |
| strContainerNameIn | const System::String\& | Nombre del contenedor; ignorado. |
