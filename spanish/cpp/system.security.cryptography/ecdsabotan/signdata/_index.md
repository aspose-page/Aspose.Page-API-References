---
title: "System::Security::Cryptography::ECDsaBotan::SignData método"
linktitle: "SignData"
second_title: "Aspose.Page para C++"
description: "System::Security::Cryptography::ECDsaBotan::SignData método. Calcula el valor hash del arreglo de datos especificado y firma el resultado en C++."
type: docs
weight: 1100
url: /es/cpp/system.security.cryptography/ecdsabotan/signdata/
---
...
| --- | --- | --- |
| datos | const ByteArrayPtr\& | Arreglo de datos de entrada. devuelve la firma ECDSA para los datos de entrada. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| flujo | const StreamPtr\& | Secuencia binaria. devuelve la firma ECDSA para los datos de entrada. |
