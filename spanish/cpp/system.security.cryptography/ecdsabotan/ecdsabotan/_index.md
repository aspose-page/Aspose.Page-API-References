...
description: "System::Security::Cryptography::ECDsaBotan::ECDsaBotan constructor. Constructor. Utiliza parámetros predeterminados en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography/ecdsabotan/ecdsabotan/
---
## ECDsaBotan::ECDsaBotan() constructor


Constructor. Usa parámetros predeterminados.
...
| --- | --- | --- |
| clave | const Botan::ECDSA_PrivateKey\& | Clave privada de Botan. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| clave | const Botan::ECDSA_PublicKey\& | Clave pública de Botan. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| curve | const ECCurve\& | Curva utilizada para crear el par de claves pública/privada. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| parámetros | const ECParameters\& | Parámetros del algoritmo. |
