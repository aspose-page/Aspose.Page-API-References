...
description: "System::Security::Cryptography::DSACryptoServiceProvider::DSACryptoServiceProvider constructor. Constructor. Usa parámetros predeterminados en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography/dsacryptoserviceprovider/dsacryptoserviceprovider/
---
...
| --- | --- | --- |
| parámetros | const DSAParameters\& | Parámetros del algoritmo. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| parámetros | const SharedPtr\<CspParameters\>\& | Parámetros del algoritmo. |
