...
| Método | Descripción |
| --- | --- |
| static [CreateOaep](./createoaep/)(const HashAlgorithmName\&) | Crea [RSAEncryptionPadding](./) con modo OAEP y el algoritmo hash especificado. |
...
| static [get_OaepSHA256](./get_oaepsha256/)() | Obtiene el modo OAEP con el algoritmo hash [SHA256](../sha256/). |
| static [get_OaepSHA384](./get_oaepsha384/)() | Obtiene el modo OAEP con el algoritmo hash [SHA384](../sha384/). |
| static [get_OaepSHA512](./get_oaepsha512/)() | Obtiene el modo OAEP con el algoritmo hash [SHA512](../sha512/). |
