...
| Método | Descripción |
| --- | --- |
| static [Create](./create/)() | Crea el algoritmo [MD5](./). |
| static [Create](./create/)(const String\&) | Crea el algoritmo [MD5](./). |
## Typedefs
