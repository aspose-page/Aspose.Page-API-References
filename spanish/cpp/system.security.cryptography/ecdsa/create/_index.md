---
title: "System::Security::Cryptography::ECDsa::Create método"
linktitle: "Crear"
second_title: "Aspose.Page para C++"
description: "Método System::Security::Cryptography::ECDsa::Create. Crea la implementación predeterminada del algoritmo ECDSA en C++."
type: docs
weight: 1100
url: /es/cpp/system.security.cryptography/ecdsa/create/
---
## ECDsa::Create() method
...
| --- | --- | --- |
| curve | const ECCurve\& | Curva a usar para la creación de la clave. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| parámetros | const ECParameters\& | Parámetros que representan la clave. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| algoritmo | const String\& | Nombre del algoritmo. |
