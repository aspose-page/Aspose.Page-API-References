---
title: "Método System::Security::Cryptography::DSA::Create"
linktitle: "Crear"
second_title: "Aspose.Page para C++"
description: "Método System::Security::Cryptography::DSA::Create. Crea la implementación predeterminada del algoritmo DSA en C++."
type: docs
weight: 900
url: /es/cpp/system.security.cryptography/dsa/create/
---
## DSA::Create() method
...
Crea la implementación predeterminada del algoritmo [DSA](../) con parámetros especificados.
...
| --- | --- | --- |
| parameters | const DSAParameters\& | Los parámetros para el algoritmo [DSA](../). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| alg_name | const String\& | Debe ser "System.Security.Cryptography.DSACryptoServiceProvider". |
