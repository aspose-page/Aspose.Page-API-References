...
| static [CreateFromXmlString](./createfromxmlstring/)(const String\&) | Crea una implementación predeterminada del algoritmo [DSA](./) con parámetros codificados en XML especificados. |
...
| virtual [VerifySignature](./verifysignature/)(ByteArrayPtr, ByteArrayPtr) | Verifica la firma [DSA](./) para los datos especificados. |
## Ver también
