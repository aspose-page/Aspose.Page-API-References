...
Representa un búfer que envuelve flujos similares a [System::IO::Stream](../stream/) y permite que se usen como un búfer interno de flujos similar a std::iostream.
...
| [swap](./swap/)(BasicSystemIOStreamBuf\&) | Llamada a intercambiar *this y right*, si no son iguales. |
