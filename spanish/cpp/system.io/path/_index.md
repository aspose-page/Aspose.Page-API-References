...
| static [GetInvalidPathChars](./getinvalidpathchars/)() | Devuelve una matriz que contiene caracteres que no están permitidos en los nombres de ruta. |
...
| static [ToString](./tostring/)(const boost::filesystem::path\&) | Devuelve una representación en cadena del objeto de ruta de Boost especificado. |
## Campos
...
int main()
{
  ...
  // Imprime información sobre el nombre de archivo.
  std::cout <<
