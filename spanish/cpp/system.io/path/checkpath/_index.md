...
description: "System::IO::Path::CheckPath método. Determina si la ruta especificada es válida comprobando si contiene caracteres no válidos. Se lanza una excepción si la ruta contiene caracteres no válidos en C++."
type: docs
weight: 200
