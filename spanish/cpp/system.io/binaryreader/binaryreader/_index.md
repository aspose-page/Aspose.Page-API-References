...
description: "System::IO::BinaryReader::BinaryReader constructor. Construye una instancia de la clase BinaryReader que lee datos del flujo especificado usando codificación UTF-8 en C++."
type: docs
weight: 100
url: /es/cpp/system.io/binaryreader/binaryreader/
---
...
| --- | --- | --- |
| entrada | const SharedPtr\<Stream\>\& | El flujo de entrada |
...
| --- | --- | --- |
| entrada | const SharedPtr\<Stream\>\& | El flujo de entrada |
| encoding | const SharedPtr\<Text::Encoding\>\& | La codificación a usar |
