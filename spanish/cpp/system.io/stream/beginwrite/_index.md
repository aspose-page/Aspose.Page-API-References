...
| --- | --- | --- |
| búfer | System::ArrayPtr\<uint8_t\> | Un búfer que contiene datos a escribir |
| desplazamiento | int | Un desplazamiento basado en 0 en **buffer** que indica la posición desde la cual comienzan los datos a escribir |
...
| estado | System::SharedPtr\<System::Object\> | Datos proporcionados por el usuario utilizados para identificar de forma única cada operación de escritura asíncrona |
