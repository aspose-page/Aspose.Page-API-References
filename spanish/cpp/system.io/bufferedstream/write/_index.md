---
title: "System::IO::BufferedStream::Write método"
linktitle: "Write"
second_title: "Aspose.Page para C++"
description: "System::IO::BufferedStream::Write método. Escribe el subrango especificado de bytes del arreglo de bytes especificado al flujo subyacente en C++."
type: docs
weight: 1400
url: /es/cpp/system.io/bufferedstream/write/
---
## BufferedStream::Write(const ArrayPtr\<uint8_t\>\&, int32_t, int32_t) method


Escribe el subrango especificado de bytes del arreglo de bytes especificado al flujo subyacente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| búfer | const System::Details::ArrayView\<uint8_t\>\& | El array que contiene los bytes a escribir. |
| desplazamiento | int32_t | Un índice basado en cero del elemento en **buffer** en el que comienza el subrango a escribir |
| count | int32_t | El número de elementos en el subrango a escribir |
