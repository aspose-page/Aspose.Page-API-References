...
description: "System::IO::File::Copy method. Copia el archivo especificado a la ubicación especificada. Si el archivo de destino ya existe, un parámetro indica si debe sobrescribirse en C++."
type: docs
weight: 400
url: /es/cpp/system.io/file/copy/
---
## File::Copy method
...
| --- | --- | --- |
| sourceFileName | const String\& | Una ruta del archivo a copiar |
| destFileName | const String\& | Una ruta de la nueva ubicación del archivo a copiar |
