...
Lee el contenido del archivo de texto especificado línea por línea a un arreglo de cadenas usando la codificación de caracteres especificada.
...
Una matriz de cadenas donde cada elemento representa una única línea del archivo especificado
