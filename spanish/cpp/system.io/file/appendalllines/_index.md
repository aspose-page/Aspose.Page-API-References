...
description: "System::IO::File::AppendAllLines método. Añade cadenas de la colección de cadenas especificada al archivo especificado usando la codificación especificada, escribiendo cada cadena en una nueva línea. Si el archivo especificado no existe, se crea. El archivo se cierra después de escribir todas las cadenas en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| ruta | const String\& | La ruta del archivo al que se añadirán las cadenas |
