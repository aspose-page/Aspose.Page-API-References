...
description: "System::IO::File::WriteAllLines method. Crea un nuevo archivo de texto o sobrescribe el existente y escribe todas las cadenas del arreglo de cadenas especificado en él, cada cadena en una nueva línea, usando la codificación especificada en C++."
type: docs
weight: 3600
...
| contenido | const ArrayPtr\<String\>\& | Un arreglo de cadenas |
