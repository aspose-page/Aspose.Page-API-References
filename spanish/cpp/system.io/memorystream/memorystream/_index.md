...
description: "System::IO::MemoryStream::MemoryStream constructor. Construye una nueva instancia de la clase MemoryStream con capacidad inicial igual a 0 en C++."
type: docs
weight: 100
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| capacity_ | int | El tamaño en bytes de un búfer de memoria asociado con el flujo representado por el objeto que se está creando |
