---
title: "System::IO::Directory::GetFileSystemEntries método"
linktitle: "GetFileSystemEntries"
second_title: "Aspose.Page para C++"
description: "System::IO::Directory::GetFileSystemEntries método. Busca los archivos y directorios que cumplen con los criterios de búsqueda especificados, ya sea en el directorio especificado o en todo el árbol de directorios cuya raíz es el directorio especificado en C++."
type: docs
weight: 1300
url: /es/cpp/system.io/directory/getfilesystementries/
---
## Directory::GetFileSystemEntries method


Busca los archivos y directorios que cumplen con los criterios de búsqueda especificados, ya sea en el directorio especificado o en todo el árbol de directorios con raíz en el directorio especificado.
