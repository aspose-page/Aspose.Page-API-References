...
description: "Método System::Data::DataRow::GetChildRows. Obtiene filas que se consideran hijas a través de la relación especificada en C++."
type: docs
weight: 200
...
| --- | --- | --- |
| relación | const System::SharedPtr\<System::Data::DataRelation\>\& | Objeto de relación para especificar la relación fila padre - fila hija. |
