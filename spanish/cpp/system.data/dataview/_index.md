...
| Método | Descripción |
| --- | --- |
| [get_Count](./get_count/)() | Información RTTI. |
| [get_Table](./get_table/)() | Obtiene la tabla a la que pertenece la vista. |
| [idx_get](./idx_get/)(const int32_t) | Obtiene vistas de filas. |
## Ver también
