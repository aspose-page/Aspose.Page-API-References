...
description: "System::Net::Security::EncryptionPolicy enum. Enumera las políticas de cifrado en C++."
type: docs
weight: 400
...
| NoEncryption | 2 | Permite no usar cifrado y solicita que se use un cifrado 'Null' si el otro extremo puede manejar un cifrado 'Null'. |
