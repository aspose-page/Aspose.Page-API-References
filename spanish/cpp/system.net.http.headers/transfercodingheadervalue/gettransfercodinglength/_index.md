...
| transferCodingCreator | System::SharedPtr\<TransferCodingHeaderValue\>\& | El delegado que se utiliza para crear instancias de la clase [TransferCodingHeaderValue](../). |
