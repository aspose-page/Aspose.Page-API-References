...
description: "System::Net::Http::Headers::RangeConditionHeaderValue::RangeConditionHeaderValue constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http.headers/rangeconditionheadervalue/rangeconditionheadervalue/
---
...
| --- | --- | --- |
| fecha | DateTimeOffset | El valor de fecha. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entityTag | String | La representación en cadena del valor de encabezado 'ETag'. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entityTag | System::SharedPtr\<EntityTagHeaderValue\> | El valor de la cabecera 'ETag'. |
