...
description: "System::Net::Http::Headers::ProductHeaderValue::ProductHeaderValue constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http.headers/productheadervalue/productheadervalue/
---
...
| --- | --- | --- |
| name | String | El nombre del token del producto. |
...
| --- | --- | --- |
| name | String | El nombre del token del producto. |
| versión | String | La versión del token del producto. |
