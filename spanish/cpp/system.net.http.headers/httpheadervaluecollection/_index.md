...
| --- | --- |
| El | tipo de los valores de los encabezados representados en la colección. |
## Métodos
...
| [ParseAdd](./parseadd/)(String) | Analiza una representación de cadena de encabezado y la agrega a la colección actual. |
...
| [TryParseAdd](./tryparseadd/)(String) | Intenta analizar una representación de cadena de encabezado y agregarla a la colección actual. |
