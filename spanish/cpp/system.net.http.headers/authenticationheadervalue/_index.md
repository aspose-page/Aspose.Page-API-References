...
| static [Parse](./parse/)(String) | Convierte una cadena pasada a una instancia de la clase [AuthenticationHeaderValue](./). |
...
| static [TryParse](./tryparse/)(String, System::SharedPtr\<AuthenticationHeaderValue\>\&) | Intentando convertir una cadena pasada a una instancia de la clase [AuthenticationHeaderValue](./). |
## Ver también
