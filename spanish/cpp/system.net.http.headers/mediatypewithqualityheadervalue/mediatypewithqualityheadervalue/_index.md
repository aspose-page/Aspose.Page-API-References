...
description: "System::Net::Http::Headers::MediaTypeWithQualityHeaderValue::MediaTypeWithQualityHeaderValue constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http.headers/mediatypewithqualityheadervalue/mediatypewithqualityheadervalue/
---
...
| --- | --- | --- |
| mediaType | String | Una representación en cadena del valor del encabezado de tipo de medio. |
...
| --- | --- | --- |
| mediaType | String | Una representación en cadena del valor del encabezado de tipo de medio. |
| calidad | double | Un valor de calidad. |
