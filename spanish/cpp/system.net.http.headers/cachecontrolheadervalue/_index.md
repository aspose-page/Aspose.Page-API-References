...
| [get_MaxAge](./get_maxage/)() | Obtiene el valor de edad máxima en segundos que determina un período durante el cual el cliente aceptará una respuesta. |
...
| [get_MustRevalidate](./get_mustrevalidate/)() | Obtiene el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta. |
...
| [get_ProxyRevalidate](./get_proxyrevalidate/)() | Obtiene el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta para las cachés de agentes de usuario compartidos. |
...
| [set_MaxAge](./set_maxage/)(Nullable\<TimeSpan\>) | Establece el valor de edad máxima en segundos que determina un período durante el cual el cliente aceptará una respuesta. |
...
| [set_MustRevalidate](./set_mustrevalidate/)(bool) | Establece el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta. |
...
| [set_ProxyRevalidate](./set_proxyrevalidate/)(bool) | Establece el valor que determina si el servidor requiere revalidación de una entrada de caché cuando se vuelve obsoleta para las cachés de agentes de usuario compartidos. |
...
| static [TryParse](./tryparse/)(String, System::SharedPtr\<CacheControlHeaderValue\>\&) | Intenta convertir una cadena proporcionada en una instancia de la clase [CacheControlHeaderValue](./). |
## Ver también
