...
| virtual [AddHeaders](./addheaders/)(System::SharedPtr\<HttpHeaders\>) | Concatena la instancia de la clase HttpHeaders especificada con la actual. |
...
| static [ParsedValuesAsList](./parsedvaluesaslist/)(const System::SharedPtr\<Object\>) | Convierte los valores analizados en una lista. |
...
| [TryParseAndAddValue](./tryparseandaddvalue/)(String, String) | Intenta analizar el valor especificado y agregarlo a los valores del encabezado. |
## Ver también
