...
| Método | Descripción |
| --- | --- |
| [AddHeaders](./addheaders/)(System::SharedPtr\<HttpHeaders\>) override | Concatena la instancia de la clase HttpHeaders especificada con la actual. |
...
| [get_Expect](./get_expect/)() | Devuelve un valor del encabezado 'Expect'. |
...
| [get_Range](./get_range/)() | Obtiene un valor del encabezado 'Range'. |
...
| [set_Range](./set_range/)(System::SharedPtr\<RangeHeaderValue\>) | Establece un valor del encabezado 'Range'. |
