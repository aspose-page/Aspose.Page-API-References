...
description: "Cómo usar el método LINQ_OrderBy de la clase System::Collections::Generic::IEnumerable en C++."
type: docs
weight: 2300
url: /es/cpp/system.collections.generic/ienumerable/linq_orderby/
---
...
Ordena los elementos de una secuencia en orden ascendente según los valores clave seleccionados por keySelector.
