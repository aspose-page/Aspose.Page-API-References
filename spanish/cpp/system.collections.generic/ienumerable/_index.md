...
description: "Clase System::Collections::Generic::IEnumerable. Interfaz del objeto que proporciona un enumerador sobre los elementos contenidos en C++."
type: docs
weight: 2200
...
| Método | Descripción |
| --- | --- |
| [begin](./begin/)() | Obtiene el iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar un objeto referenciado porque [GetEnumerator()](./getenumerator/) devuelve una copia del objeto T. |
...
| [end](./end/)() | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar un objeto referenciado porque [GetEnumerator()](./getenumerator/) devuelve una copia del objeto T. |
...
| [LINQ_First](./linq_first/)(const Func\<T, bool\>\&) | Devuelve el primer elemento de una secuencia que cumple la condición especificada. |
...
| [LINQ_FirstOrDefault](./linq_firstordefault/)(std::function\<bool(T)>) | Devuelve el primer elemento de la secuencia que cumple una condición o un valor predeterminado si no se encuentra tal elemento. |
...
| [LINQ_ToList](./linq_tolist/)() | Crea un [List<T>](../list/) a partir de una secuencia. |
...
| virtual [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const | Obtiene la implementación del iterador const end para el contenedor actual. |
| virtual [virtualizeEndIterator](./virtualizeenditerator/)() | Obtiene la implementación del iterador end para el contenedor actual. |
## Typedefs
