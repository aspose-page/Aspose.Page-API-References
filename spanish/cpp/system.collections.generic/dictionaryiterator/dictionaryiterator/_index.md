...
description: "System::Collections::Generic::DictionaryIterator::DictionaryIterator constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.collections.generic/dictionaryiterator/dictionaryiterator/
---
...
| --- | --- | --- |
| iterador | const typename Dict::map_t::const_iterator\& | Iterador para mantener. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| otro | DictionaryIterator\&& | Iterador para mover datos desde. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| iterador | typename Dict::map_t::const_iterator\&& | Iterador para mantener. |
