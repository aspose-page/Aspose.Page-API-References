...
| virtual [SymmetricExceptWith](./symmetricexceptwith/)(IEnumerablePtr) | Calcula la diferencia simétrica de dos contenedores. Elimina todos los elementos que están presentes en ambos contenedores, pero al mismo tiempo agrega todos los elementos presentes en **other**, pero no en el conjunto actual. |
