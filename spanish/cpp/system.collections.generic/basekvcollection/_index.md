---
title: "System::Collections::Generic::BaseKVCollection clase"
linktitle: "BaseKVCollection"
second_title: "Aspose.Page para C++"
description: "System::Collections::Generic::BaseKVCollection clase. Contiene código común para colecciones de claves o valores. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando operator new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento en C++."
type: docs
weight: 700
...
| KV | Tipo de clave o valor, según la interfaz que se utilice. |
## Métodos
