---
title: "Clase System::Collections::Generic::KeyValuePair"
linktitle: "KeyValuePair"
second_title: "Aspose.Page para C++"
description: "System::Collections::Generic::KeyValuePair clase. Par de clave y valor. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 2900
...
Par de clave y valor. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](../../system/smartptr/) para gestionar objetos de este tipo.
