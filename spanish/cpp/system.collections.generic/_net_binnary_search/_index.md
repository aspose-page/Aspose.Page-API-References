---
title: "System::Collections::Generic::_net_binnary_search método"
...
| --- | --- |
| containerT | Tipo de plantilla de contenedor estilo STL con dos argumentos de plantilla: tipo de elemento y tipo de asignador. |
| T | Tipo de elemento. |
...
| value | T | Valor a buscar. |

### ReturnValue

Si se encuentra, índice del siguiente elemento; de lo contrario, complementos del índice en el que se detuvo la búsqueda.
...
Implementa búsqueda binaria en un contenedor de acceso aleatorio. Especialización para tipos escalares. Compara los elementos usando los operadores mayor y menor.
