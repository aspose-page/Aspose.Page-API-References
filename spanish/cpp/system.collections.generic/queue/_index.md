...
description: "System::Collections::Generic::Queue class. Declaración adelantada de la clase Queue en C++."
type: docs
weight: 3600
...
| [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través de la cola. |
...
int main()
{
  // Cree la instancia de la clase Queue.
  ...
  // Imprima el primer elemento de la cola. El método Peek no elimina un elemento de la cola.
  std::cout << queue->Peek() << std::endl;
  // Imprima los elementos de la cola.
  PrintItems(queue);

  // Imprima el primer elemento de la cola. El método Dequeue elimina un elemento de la cola.
