...
| [AddRange](./addrange/)(IEnumerablePtr) | Añade todos los elementos de la colección (o de sí misma) al final de la lista actual. |
...
| [GetEnumerator](./getenumerator/)() override | Obtiene el enumerador para iterar a través de los elementos de la lista. |
...
| [Reverse](./reverse/)() | Invierte el orden de los elementos de la lista completa. |
...
| [IEnumeratorPtr](./ienumeratorptr/) | Tipo [Enumerator](./enumerator/). |
