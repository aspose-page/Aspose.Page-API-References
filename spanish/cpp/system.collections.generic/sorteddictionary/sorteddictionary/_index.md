...
description: "System::Collections::Generic::SortedDictionary::SortedDictionary constructor. Construye un diccionario vacío en C++."
type: docs
weight: 200
url: /es/cpp/system.collections.generic/sorteddictionary/sorteddictionary/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<typename BasePointerType\<TKey\>::type\>\>\& | [Comparer](../../comparer/) para usar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| src | const SharedPtr\<IDictionary\<TKey, TValue\>\>\& | Diccionario fuente del cual copiar datos. |
