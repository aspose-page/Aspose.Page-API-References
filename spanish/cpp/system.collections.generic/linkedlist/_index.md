---
title: "Clase System::Collections::Generic::LinkedList"
linktitle: "LinkedList"
second_title: "Aspose.Page para C++"
description: "Clase System::Collections::Generic::LinkedList. Declaración adelantada de LinkedList en C++."
type: docs
weight: 3100
...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const T\&) override | Añade **element** al final de la lista. |
| [AddAfter](./addafter/)(const SharedPtr\<LinkedListNode\<T\>\>\&, const T\&) | Añade **element** después de **node** de la lista. |
| [AddAfter](./addafter/)(const SharedPtr\<LinkedListNode\<T\>\>\&, const SharedPtr\<LinkedListNode\<T\>\>\&) | Añade **newNode** después de **node** de la lista. |
| [AddBefore](./addbefore/)(const SharedPtr\<LinkedListNode\<T\>\>\&, const T\&) | Añade **element** antes de **node** de la lista. |
| [AddBefore](./addbefore/)(const SharedPtr\<LinkedListNode\<T\>\>\&, const SharedPtr\<LinkedListNode\<T\>\>\&) | Añade **newNode** antes de **node** de la lista. |
| [AddFirst](./addfirst/)(const T\&) | Añade **element** al principio de la lista. |
| [AddFirst](./addfirst/)(const SharedPtr\<LinkedListNode\<T\>\>\&) | Añade **newNode** al principio de la lista. |
| [AddLast](./addlast/)(const T\&) | Añade **element** al final de la lista. |
...
| [crbegin](./crbegin/)() const | Obtiene un iterador inverso al último elemento const de la colección (el primero en reversa). |
| [crend](./crend/)() const | Obtiene un iterador inverso para un elemento const inexistente antes del inicio de la colección. |
| [end](./end/)() | Obtiene el iterador para un elemento que no existe detrás del final de la colección. |
...
| [get_Count](./get_count/)() const override | Obtiene el número de elementos en la lista. |
...
| [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través de la [LinkedList](./) actual. |
| [LinkedList](./linkedlist/)() | Crea una [LinkedList](./) vacía. |
