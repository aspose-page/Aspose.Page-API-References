...
description: "System::Collections::Generic::SortedSet::SortedSet constructor. Información RTTI en C++."
type: docs
weight: 100
url: /es/cpp/system.collections.generic/sortedset/sortedset/
---
...
| --- | --- | --- |
| comparer | const SharedPtr\<IComparer\<T\>\>\& | [Comparer](../../comparer/) objeto para asociar con [SortedSet](../). |
...
Crea [SortedSet](../) basado en valores enumerables.
