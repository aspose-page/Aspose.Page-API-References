---
title: "Clase System::Collections::Generic::Stack"
linktitle: "Pila"
...
| virtual [Contains](./contains/)(const T\&) const | Comprueba si un elemento específico está presente en el contenedor; usa el operador == para la comparación. |
...
| [Push](./push/)(const T\&) | Coloca el elemento en la parte superior de la pila. |
...
int main()
{
  ...
  // Imprime el último elemento de la pila. El método Peek no elimina ningún elemento de la pila.
