...
| [get_NoDelay](./get_nodelay/)() | Obtiene un valor que indica si la instancia actual está usando el algoritmo de Nagle. |
| [get_ReceiveBufferSize](./get_receivebuffersize/)() | Obtiene el tamaño del búfer que se usa para recibir datos. |
| [get_ReceiveTimeout](./get_receivetimeout/)() | Obtiene un valor que indica una cantidad de tiempo después de la cual la recepción de datos expirará. |
| [get_SendBufferSize](./get_sendbuffersize/)() | Obtiene el tamaño del búfer que se usa para enviar datos. |
| [get_SendTimeout](./get_sendtimeout/)() | Obtiene un valor que indica una cantidad de tiempo después de la cual el envío de datos expirará. |
| [GetStream](./getstream/)() | Devuelve el flujo que se usa para enviar y recibir datos. |
...
| [set_NoDelay](./set_nodelay/)(bool) | Establece un valor que indica si la instancia actual está usando el algoritmo de Nagle. |
| [set_ReceiveBufferSize](./set_receivebuffersize/)(int32_t) | Establece el tamaño del búfer que se usa para recibir datos. |
| [set_ReceiveTimeout](./set_receivetimeout/)(int32_t) | Establece un valor que indica una cantidad de tiempo después de la cual la recepción de datos expirará. |
| [set_SendBufferSize](./set_sendbuffersize/)(int32_t) | Establece el tamaño del búfer que se usa para enviar datos. |
| [set_SendTimeout](./set_sendtimeout/)(int32_t) | Establece un valor que indica una cantidad de tiempo después de la cual el envío de datos expirará. |
