...
description: "System::Net::Sockets::SocketError enum. Enumera los tipos de error de socket en C++."
type: docs
weight: 1300
...
| Interrupted | 10004 | Una llamada de socket bloqueante se canceló. |
...
| InProgress | 10036 | Una operación de bloqueo está en curso. |
| AlreadyInProgress | 10037 | Un socket no bloqueante ya tiene una operación en ejecución. |
| NotSocket | 10038 | Un intento de llamar a una operación de socket en un no-socket. |
| DestinationAddressRequired | 10039 | Una dirección requerida se omite en una operación de socket. |
| MessageSize | 10040 | Un datagrama es demasiado largo. |
| ProtocolType | 10041 | Este socket no admite un tipo de protocolo. |
| ProtocolOption | 10042 | Se utiliza una opción o nivel desconocido, inválido o no compatible. |
...
| AddressFamilyNotSupported | 10047 | La familia de direcciones especificada no está soportada. |
...
| Shutdown | 10058 | Una solicitud para enviar o recibir datos está prohibida porque el socket ya ha sido cerrado. |
...
| TryAgain | 11002 | No se puede resolver un nombre de host. |
| NoRecovery | 11003 | Un error es irrecuperable o la base de datos solicitada no se puede localizar. |
| NoData | 11004 | No se encontró un nombre o dirección IP solicitada en el servidor de nombres. |
