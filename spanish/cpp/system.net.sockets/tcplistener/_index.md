...
| Método | Descripción |
| --- | --- |
| [AcceptSocket](./acceptsocket/)() | Acepta la solicitud de conexión pendiente y devuelve el socket que se utiliza para enviar y recibir datos. |
| [AcceptTcpClient](./accepttcpclient/)() | Acepta la solicitud de conexión pendiente y devuelve la instancia de la clase TcpClient que se utiliza para enviar y recibir datos. |
...
| [Start](./start/)() | Comienza a escuchar las conexiones entrantes. |
| [Start](./start/)(int32_t) | Comienza a escuchar las conexiones entrantes. |
