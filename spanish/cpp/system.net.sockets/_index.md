---
title: "Espacio de nombres System::Net::Sockets"
linktitle: "System::Net::Sockets"
second_title: "Aspose.Page para C++"
description: "Cómo usar el espacio de nombres System::Net::Sockets en C++."
type: docs
weight: 4800
url: /es/cpp/system.net.sockets/
---
...
| [TcpListener](./tcplistener/) | Representa un escuchador para los servicios de red TCP. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../system/makeobject/). Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. |
...
| [IOControlCode](./iocontrolcode/) | Enumera los códigos de control de [IO](../system.io/). |
...
| [SocketError](./socketerror/) | Enumera los tipos de error del socket. |
| [SocketFlags](./socketflags/) | Proporciona valores constantes para los mensajes del socket. |
| [SocketOptionLevel](./socketoptionlevel/) | Define los niveles de opciones de socket para la clase '[Socket](./socket/)'. |
| [SocketOptionName](./socketoptionname/) | Define los nombres de opciones de socket para la clase [Socket](./socket/). |
