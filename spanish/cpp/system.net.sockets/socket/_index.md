...
description: "System::Net::Sockets::Socket class. La clase Socket implementa la interfaz de sockets Berkeley en C++."
type: docs
weight: 400
...
| [Bind](./bind/)(System::SharedPtr\<EndPoint\>) | Vincula el socket al punto final local especificado. |
...
| [EndConnect](./endconnect/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asíncrona de conexión especificada se complete. |
| [EndReceive](./endreceive/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asíncrona de recepción especificada se complete. |
| [EndReceive](./endreceive/)(System::SharedPtr\<IAsyncResult\>, SocketError\&) | Espera hasta que la operación asíncrona de recepción especificada se complete. |
| [EndSend](./endsend/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asíncrona de envío especificada se complete. |
| [EndSend](./endsend/)(System::SharedPtr\<IAsyncResult\>, SocketError\&) | Espera hasta que la operación asíncrona de envío especificada se complete. |
...
| [get_Blocking](./get_blocking/)() | Obtiene un valor que indica si el socket está en modo de bloqueo. |
...
| [get_ExclusiveAddressUse](./get_exclusiveaddressuse/)() | Obtiene un valor que indica si solo un proceso puede enlazar el socket a un puerto. |
| [get_IsBound](./get_isbound/)() | Devuelve un valor que indica si el socket está enlazado a un puerto local específico. |
...
| [get_NoDelay](./get_nodelay/)() | Obtiene un valor que indica si el socket está usando el algoritmo de Nagle. |
| static [get_OSSupportsIPv4](./get_ossupportsipv4/)() | Devuelve un valor que indica si el sistema operativo y los adaptadores de red soportan IPv4. |
| static [get_OSSupportsIPv6](./get_ossupportsipv6/)() | Devuelve un valor que indica si el sistema operativo y los adaptadores de red soportan IPv6. |
...
| [set_Blocking](./set_blocking/)(bool) | Establece un valor que indica si el socket está en modo bloqueante. |
...
| [set_NoDelay](./set_nodelay/)(bool) | Establece un valor que indica si el socket está usando el algoritmo de Nagle. |
