...
| [UdpClient](./udpclient/)(System::SharedPtr\<IPEndPoint\>) | Inicializa una nueva instancia de la clase [UdpClient](./). param local EP el punto final local al que enlazas la conexión UDP. |
