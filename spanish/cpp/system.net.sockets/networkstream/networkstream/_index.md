...
description: "System::Net::Sockets::NetworkStream::NetworkStream constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.sockets/networkstream/networkstream/
---
...
| --- | --- | --- |
| socket | System::SharedPtr\<System::Net::Sockets::Socket\> | El socket que se usa para enviar y recibir datos. |
...
| --- | --- | --- |
| socket | System::SharedPtr\<System::Net::Sockets::Socket\> | El socket que se usa para enviar y recibir datos. |
| acceso | System::IO::FileAccess | Especifica el tipo de acceso otorgado a la instancia sobre el socket especificado. |
| ownsSocket | bool | Un valor que indica si la instancia actual toma posesión del socket especificado cuando el valor es verdadero. |
