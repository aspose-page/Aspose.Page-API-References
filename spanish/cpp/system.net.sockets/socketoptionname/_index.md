...
description: "System::Net::Sockets::SocketOptionName enum. Define nombres de opciones de socket para la clase Socket en C++."
type: docs
weight: 1600
...
Define nombres de opciones de socket para la clase [Socket](../socket/).
...
| UseLoopback | 64 | Omitir el hardware cuando sea posible. |
...
| DontLinger | n/a | Indica si un socket se cerrará sin permanecer abierto. |
| ExclusiveAddressUse | n/a | Un socket usará la dirección vinculada de forma exclusiva. |
...
| MaxConnections | 2147483647 | Esta opción no es compatible. Se utilizaba para especificar la longitud máxima de la cola de escucha. |
...
| MulticastTimeToLive | 10 | El tiempo de vida (TTL) multicast IP. |
| MulticastLoopback | 11 | El bucle de IP Multicast. |
...
| NoDelay | 1 | Desactiva el algoritmo de Nagle para la coalescencia de los paquetes enviados. |
...
| UpdateAcceptContext | 28683 | Actualiza un socket cliente con las mismas propiedades que un socket de escucha. |
| UpdateConnectContext | 28688 | Actualiza un socket cliente con las mismas propiedades que un socket de escucha. |
