---
title: "Método System::Delegate< ReturnType(ArgumentTypes...)>::Delegate"
linktitle: "Delegate"
second_title: "Aspose.Page para C++"
description: "Método System::Delegate< ReturnType(ArgumentTypes...)>::Delegate. Constructor predeterminado. Construye el objeto delegate que no apunta a nada en C++."
type: docs
weight: 100
...
Constructor de copia con movimiento. Toma la propiedad de una entidad apuntada por el delegate especificado.
...
| functor | T\& | Un objeto función al que apuntará el delegate recién construido |
...
| obj | const SharedPtr\<ClassType\>\& | Un puntero compartido a un método miembro de objeto al que apuntará el delegado recién creado |
...
| Argumentos | La lista de argumentos del objeto función aceptado por el constructor como argumento |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| f | std::function\<R(Args...)> | Un objeto función al que apuntará el objeto delegado recién creado |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| función | T | Puntero a una "expresión bind" - un puntero a función generado por std::bind() - al que apuntará la instancia Delegate recién creada |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| función | T | Puntero a una función o a un método estático al que apuntará la instancia Delegate recién creada |
