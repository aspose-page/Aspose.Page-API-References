...
Escribe el valor representado por el objeto especificado al flujo de salida especificado.
...
| --- | --- | --- |
| d | const Decimal\& | El objeto [Decimal](../decimal/) para imprimir en el flujo |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | const System::String\& | para imprimir. |
