...
description: "System::TimeZoneInfo::ConvertTimeToUtc method. Convierte el tiempo a hora UTC en C++."
type: docs
weight: 500
url: /es/cpp/system/timezoneinfo/converttimetoutc/
---
## TimeZoneInfo::ConvertTimeToUtc(DateTime) method


Convierte la hora a hora UTC.
...
| --- | --- | --- |
| date_time | DateTime | Fecha y hora a convertir. |
| source_time_zone | const TimeZoneInfoPtr\& | Zona horaria de origen. |
