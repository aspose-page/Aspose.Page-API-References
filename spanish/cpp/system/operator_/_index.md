...
second_title: Aspose.Page para C++
description: 'System::operator< method. Determina si el valor especificado es menor que el valor representado por el objeto Nullable especificado al aplicar operator<() a estos valores en C++.'
type: docs
peso: 28600
...
* Library [Aspose.Page for C++](../../)
---
título: System::operator> method
título del enlace: operator>
second_title: Aspose.Page para C++
description: 'System::operator> method. Determina si el valor especificado es mayor que el valor representado por el objeto Nullable especificado al aplicar operator>() a estos valores en C++.'
type: docs
peso: 34100
url: /cpp/system/operator_/
---
