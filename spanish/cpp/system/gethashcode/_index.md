...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| obj | const T\& | El [SmartPtr](../smartptr/) que apunta al objeto para el cual generar el código hash |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| obj | const T\& | El [Exception](../exception/) Wrapper que contiene el objeto para generar el código hash |
