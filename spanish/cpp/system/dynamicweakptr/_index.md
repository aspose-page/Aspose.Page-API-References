---
title: "Clase System::DynamicWeakPtr"
linktitle: "DynamicWeakPtr"
second_title: "Aspose.Page para C++"
description: "Clase System::DynamicWeakPtr. Clase de puntero inteligente que rastrea los modos de puntero de los argumentos de plantilla del objeto almacenado y los actualiza después de cada asignación. Este tipo es un puntero para gestionar la eliminación de otros objetos''. Debe asignarse en la pila y pasarse a funciones ya sea por valor o por referencia constante en C++."
type: docs
weight: 2200
...
| weakLeafs | Índices de los argumentos de plantilla del tipo almacenado que deben establecerse en modo de puntero débil. |
## Nested classes
