---
title: "Método operator= de System::DynamicWeakPtr"
linktitle: "operator="
second_title: "Aspose.Page para C++"
description: "Método System::DynamicWeakPtr::operator=. Asigna por copia el puntero inteligente en C++."
type: docs
weight: 200
url: /es/cpp/system/dynamicweakptr/operator=/
---
...
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Puntero del cual copiar el valor asignado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const SmartPtr_\& | Puntero del cual copiar el valor asignado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | SmartPtr_\&& | Puntero del cual mover el valor asignado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| p | typename SmartPtr_::Pointee_ * | Valor del puntero. |
