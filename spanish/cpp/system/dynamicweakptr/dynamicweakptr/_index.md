---
title: "Constructor System::DynamicWeakPtr::DynamicWeakPtr"
linktitle: "DynamicWeakPtr"
second_title: "Aspose.Page para C++"
description: "Constructor System::DynamicWeakPtr::DynamicWeakPtr. Construye por copia el puntero inteligente en C++."
type: docs
weight: 100
url: /es/cpp/system/dynamicweakptr/dynamicweakptr/
---
## DynamicWeakPtr::DynamicWeakPtr(const DynamicWeakPtr_\&) constructor


Construye por copia el puntero inteligente.
...
| --- | --- | --- |
| ptr | const DynamicWeakPtr_\& | Puntero inteligente del cual copiar la información del apuntado. |
...
| --- | --- |
| Q | Tipo del objeto apuntado por el puntero fuente. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Puntero inteligente del cual copiar la información del apuntado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ptr | const SmartPtr_\& | Puntero inteligente del cual copiar la información del apuntado. |
...
Construye por movimiento el puntero inteligente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | SmartPtr_\&& | Puntero inteligente del cual mover la información del apuntado. Se vuelve inutilizable después de la llamada. |
