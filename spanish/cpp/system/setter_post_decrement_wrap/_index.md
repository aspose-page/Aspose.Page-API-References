---
title: "Método System::setter_post_decrement_wrap"
linktitle: "setter_post_decrement_wrap"
second_title: "Aspose.Page para C++"
description: "Método System::setter_post_decrement_wrap. El traductor traduce las expresiones de post‑decremento de C#''s que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en la invocación de esta función (sobrecarga para getter const) en C++."
type: docs
weight: 37600
url: /es/cpp/system/setter_post_decrement_wrap/
---
## System::setter_post_decrement_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


El traductor traduce las expresiones de post‑decremento de C#'s que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en la invocación de esta función (sobrecarga para getter const).
...
El traductor traduce las expresiones de post‑decremento de C#'s que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en la invocación de esta función (sobrecarga para getter no const).
...
El traductor traduce las expresiones de post‑decremento de C#'s que apuntan a la propiedad de la clase que tiene setter y getter definidos, en la invocación de esta función.
