...
description: "System::Int64::Parse method. Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 64 bits equivalente en C++."
type: docs
weight: 100
url: /es/cpp/system/int64/parse/
---
...
Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 64 bits equivalente usando la información de formato proporcionada.
