...
description: "Clase System::Buffer. Contiene métodos que manipulan matrices de bytes sin procesar. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 1000
...
Contiene métodos que manipulan matrices de bytes sin procesar. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio.
...
int main()
{
  ...
  // Cree una matriz que contenga una parte de la primera.
  auto second = MakeObject<Array<uint8_t>>(SIZE / 2);
  Buffer::BlockCopy(first, SIZE / 2, second, 0, SIZE / 2);

  // Imprima los elementos de la segunda matriz.
  Print(second, SIZE / 2);

  // Establezca el valor del elemento en el índice 0 e imprima los elementos de la matriz.
