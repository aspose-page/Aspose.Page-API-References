...
description: "Clase System::EnumValues. Proporciona información meta sobre las constantes de enumeración del tipo de enumeración E en C++."
type: docs
weight: 2300
...
Proporciona información meta sobre los constantes de enumeración del tipo enum **E**.
...
| [GetValueOf](./getvalueof/)(long) const override | Devuelve el valor empaquetado del constante de enumeración con el valor especificado. |
...
| static [Parse](../enumvaluesbase/parse/)(const TypeInfo\&, const String\&, bool) | Devuelve un objeto que representa un valor de constante de enumeración del tipo de enumeración especificado con el nombre especificado. |
