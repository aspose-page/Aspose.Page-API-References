...
description: "System::Int16::Parse method. Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 16 bits equivalente en C++."
type: docs
weight: 100
url: /es/cpp/system/int16/parse/
---
## Int16::Parse(const String\&) method


Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 16 bits equivalente.
...
Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 16 bits equivalente utilizando la información de formato proporcionada.
...
Convierte la cadena especificada que contiene la representación textual de un número al entero con signo de 16 bits equivalente utilizando la información de formato y el estilo numérico proporcionados.
