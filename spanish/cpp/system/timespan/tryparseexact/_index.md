---
title: "System::TimeSpan::TryParseExact método"
linktitle: "TryParseExact"
second_title: "Aspose.Page para C++"
description: "Cómo usar el método TryParseExact de la clase System::TimeSpan en C++."
type: docs
weight: 4500
url: /es/cpp/system/timespan/tryparseexact/
---
...
Convierte una cadena al objeto [TimeSpan](../) equivalente usando los formatos especificados, el proveedor de formato y los estilos, y devuelve el resultado de la conversión.
...
| resultado | TimeSpan\& | Intervalo de tiempo que corresponde a la cadena. |
...
Convierte una cadena al objeto [TimeSpan](../) equivalente usando los formatos especificados y el proveedor de formato, y devuelve el resultado de la conversión.
...
Convierte una cadena al objeto [TimeSpan](../) equivalente usando el formato especificado, el proveedor de formato y los estilos, y devuelve el resultado de la conversión.
...
Convierte una cadena al objeto [TimeSpan](../) equivalente usando el formato especificado y el proveedor de formato, y devuelve el resultado de la conversión.
