---
title: "System::TimeSpan::ToString método"
linktitle: "ToString"
second_title: "Aspose.Page para C++"
description: "System::TimeSpan::ToString método. Devuelve la representación en cadena del intervalo de tiempo representado por el objeto actual en C++."
type: docs
weight: 3400
url: /es/cpp/system/timespan/tostring/
---
## TimeSpan::ToString() const method


Devuelve la representación en cadena del intervalo de tiempo representado por el objeto actual.
...
Convierte el valor del objeto actual a una representación en cadena equivalente, usando el formato especificado.
...
Convierte el valor del objeto actual a una representación en cadena equivalente, usando el formato y el proveedor de formato especificados.
