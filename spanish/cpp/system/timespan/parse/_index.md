---
title: "System::TimeSpan::Parse método"
linktitle: "Analizar"
second_title: "Aspose.Page para C++"
description: "System::TimeSpan::Parse método. Convierte una cadena al objeto TimeSpan equivalente en C++."
type: docs
weight: 4200
url: /es/cpp/system/timespan/parse/
---
## TimeSpan::Parse(const String\&) method


Convierte una cadena al objeto [TimeSpan](../) equivalente.
...
Convierte una cadena al objeto [TimeSpan](../) equivalente usando el proveedor de formato especificado.
