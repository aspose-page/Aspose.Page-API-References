...
description: "System::setter_decrement_wrap method. El traductor traduce las expresiones de predecremento de C#''s que apuntan a la propiedad de la instancia''s que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter const) en C++."
type: docs
weight: 37100
...
El traductor traduce las expresiones de predecremento de C#'s que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter const).
...
El traductor traduce las expresiones de predecremento de C#'s que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter no const).
...
El traductor traduce las expresiones de predecremento de C#'s que apuntan a la propiedad de la clase que tiene setter y getter definidos, en una invocación de esta función.
