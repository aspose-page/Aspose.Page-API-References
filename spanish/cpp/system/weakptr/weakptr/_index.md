...
| --- | --- |
| Q | Tipo apuntado del puntero origen. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const SmartPtr\<Q\>\& | Puntero del cual copiar el valor del apuntado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ptr | const SmartPtr_\& | Puntero del cual copiar el valor del apuntado. |
...
Construye por copia un puntero débil.
...
| Parámetro | Descripción |
| --- | --- |
| Q | Tipo de puntero de origen. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const WeakPtr\<Q\>\& | Puntero del cual copiar el valor del apuntado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ptr | const WeakPtr_\& | Puntero del cual copiar el valor del apuntado. |
...
Construye por movimiento un puntero débil.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | SmartPtr_\&& | Puntero del cual mover el valor del apuntado. |
