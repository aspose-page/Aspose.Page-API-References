...
| ClassType | El tipo del método de objeto que se va a añadir al delegado |
...
| --- | --- |
| MemberType | El tipo del método no estático que se va a añadir a la colección de delegados |
| ClassType | El tipo del método de objeto que se va a añadir a la colección de delegados |
...
| Argumentos | La lista de argumentos del objeto función que se va a añadir a la colección |
