...
description: "System::MulticastDelegate< ReturnType(ArgumentTypes...)>::operator() método. Invoca todos los delegados presentes actualmente en la colección de delegados. Los delegados se invocan en el mismo orden en que fueron añadidos a la colección. El operador se bloquea mientras los delegados se ejecutan en C++."
type: docs
weight: 1400
...
| --- | --- | --- |
| args | ArgumentTypes... | Argumentos para pasar a los delegados que serán invocados |
