---
title: "Clase System::MulticastDelegate< ReturnType(ArgumentTypes...)>"
linktitle: "MulticastDelegate< ReturnType(ArgumentTypes...)>"
second_title: "Aspose.Page para C++"
description: "Clase System::MulticastDelegate< ReturnType(ArgumentTypes...)>. Representa una colección de delegados. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 4500
...
| [connect](./connect/)(std::function\<R(Args...)>) | Agrega el objeto de función especificado a la colección de delegados. El objeto de función se convierte al tipo de delegado [Callback](./callback/) antes de ser agregado a la colección. |
