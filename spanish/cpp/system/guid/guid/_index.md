...
description: "Constructor System::Guid::Guid. Construye un objeto que representa un GUID compuesto de ceros en C++."
type: docs
weight: 100
...
Construye un objeto que representa un GUID compuesto únicamente por ceros.
...
| --- | --- | --- |
| b | const ArrayPtr\<uint8_t\>\& | Una matriz de bytes que contiene los bytes individuales del GUID |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| g | const String\& | La representación en cadena de un GUID que será representada por el objeto que se está construyendo |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| b | const System::Details::ArrayView\<uint8_t\>\& | Una matriz de bytes que contiene los bytes individuales del GUID |
...
Construye una instancia de la clase [Guid](../) a partir de los componentes especificados del GUID.
