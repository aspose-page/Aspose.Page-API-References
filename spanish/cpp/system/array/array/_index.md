---
title: "Constructor System::Array::Array"
linktitle: "Array"
second_title: "Aspose.Page para C++"
description: "Constructor System::Array::Array. Construye un array vacío en C++."
type: docs
weight: 100
...
| Parámetro | Descripción |
| --- | --- |
| Q | El tipo de los elementos del objeto std::vector del cual copiar los elementos |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | const std::vector\<Q\>\& | std::vector del cual copiar los valores |
...
| init | const T\& | El valor inicial usado para rellenar el array |
...
Construye un objeto [Array](../) y lo rellena con valores de la lista de inicialización especificada que contiene elementos de tipo bool.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| init | std::initializer_list\<bool\> | Lista de inicialización que contiene elementos para rellenar el array |
...
Construye un objeto [Array](../) y lo rellena con valores de la lista de inicialización especificada que contiene elementos del tipo **[UnderlyingType](../underlyingtype/)**.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| init | std::initializer_list\<UnderlyingType\> | Lista de inicialización que contiene elementos para rellenar el array |
...
Construye un objeto [Array](../) y lo rellena con valores trasladados de un objeto std::vector cuyo tipo de valores es el mismo que **T** pero diferente de **[UnderlyingType](../underlyingtype/)**.
...
| Parámetro | Descripción |
| --- | --- |
| Q | El tipo de los elementos del objeto std::vector del cual mover los elementos |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | std::vector\<Q\>\&& | std::vector del cual copiar los valores |
...
| init | ValueType | El valor inicial usado para rellenar el array |
