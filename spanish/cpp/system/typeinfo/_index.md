---
title: "System::TypeInfo clase"
linktitle: "TypeInfo"
second_title: "Aspose.Page para C++"
description: "System::TypeInfo clase. Representa un tipo particular y proporciona información sobre él en C++."
type: docs
weight: 6600
...
| [AddDefaultConstructor](./adddefaultconstructor/)(DefaultConstructor) | Establece el constructor predeterminado mediante el functor que crea una instancia de clase. |
...
| [get_IsAbstract](./get_isabstract/)() const | Obtiene un valor que indica si el Tipo es abstracto y debe ser sobrescrito. |
| [get_IsArray](./get_isarray/)() const | Obtiene un valor que indica si el tipo es una matriz. |
| [get_IsClass](./get_isclass/)() const | Obtiene un valor que indica si el Tipo es una clase o un delegado; es decir, no es un tipo de valor ni una interfaz. |
| [get_IsEnum](./get_isenum/)() const | Obtiene un valor que indica si el Tipo actual representa una enumeración. |
| [get_IsGenericType](./get_isgenerictype/)() const |  |
| [get_IsGenericTypeDefinition](./get_isgenerictypedefinition/)() const | Obtiene un valor que indica si el Tipo actual representa una definición de tipo genérico, a partir de la cual se pueden construir otros tipos genéricos. |
| [get_IsInterface](./get_isinterface/)() const | Obtiene un valor que indica si el Tipo es una interfaz; es decir, no es una clase ni un tipo de valor. |
| [get_IsSealed](./get_issealed/)() const | Obtiene un valor que indica si el Tipo está declarado sellado. |
| [get_IsValueType](./get_isvaluetype/)() const | Obtiene un valor que indica si el Tipo es un tipo de valor. |
| [get_IsVisible](./get_isvisible/)() const | Obtiene un valor que indica si el Tipo puede ser accedido por código fuera del ensamblado. |
| [get_Name](./get_name/)() const | Devuelve el nombre del tipo representado por el objeto actual. |
| [get_Namespace](./get_namespace/)() const | Obtiene el espacio de nombres del Tipo. |
...
| [GetConstructors](./getconstructors/)(System::Reflection::BindingFlags) const | busca los constructores definidos para el Tipo actual, usando los BindingFlags especificados. |
| [GetConstructors](./getconstructors/)() const | Devuelve todos los constructores públicos definidos para el Tipo actual. |
...
| [GetFields](./getfields/)(System::Reflection::BindingFlags) const | Busca los campos definidos para el Tipo actual, usando las restricciones de enlace especificadas. |
| [GetGenericArguments](./getgenericarguments/)() const | Obtiene una matriz de los argumentos de tipo genérico para este tipo. |
| [GetHashCode](./gethashcode/)() const | Devuelve un código hash asociado con esta instancia. |
...
| [operator!=](./operator!=/)(const TypeInfo\&) const | Determina si los objetos [TypeInfo](./) actuales y especificados no son iguales. |
...
| [operator==](./operator==/)(const TypeInfo\&) const | Determina si los objetos [TypeInfo](./) actuales y especificados son iguales. |
...
| [TypeInfo](./typeinfo/)() | Constructor predeterminado (no se ha establecido ningún tipo). |
| [TypeInfo](./typeinfo/)(std::nullptr_t) | Constructor de objeto nulo (no se ha establecido ningún tipo). |
