...
description: "System::TypeInfo::TypeInfo constructor. Constructor predeterminado (no se establece ningún tipo) en C++."
type: docs
weight: 400
url: /es/cpp/system/typeinfo/typeinfo/
---
## TypeInfo::TypeInfo() constructor


Constructor predeterminado (no se ha establecido ningún tipo).
...
| --- | --- | --- |
| name | const char_t * | Nombre del tipo. |
...
| --- | --- | --- |
| name | const char_t * | Nombre del tipo. |
| hash | uint32_t | Hash del nombre del tipo. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| info | const std::type_info\& | Información sobre un tipo. |
...
Constructor de objeto nulo (no se ha establecido ningún tipo).
