---
title: "System::ExceptionWrapper clase"
linktitle: "ExceptionWrapper"
second_title: "Aspose.Page para C++"
description: "Clase System::ExceptionWrapper. Plantilla que representa un contenedor de excepciones que se derivan de la clase Exception en C++."
type: docs
weight: 2600
...
Plantilla que representa un contenedor de excepciones derivadas de la clase [Exception](../exception/).
...
| static [Type](./type/)() | Atajo para obtener el objeto [System::TypeInfo](../typeinfo/) del tipo [Exception](../exception/). |
## Typedefs
