...
| [Equals](./equals/)(SharedPtr\<Object\>) override | Determina si los URI representados por los objetos actual y especificado son iguales. |
...
| [get_Fragment](./get_fragment/)() const | Devuelve el fragmento de URI escapado. |
| [get_Host](./get_host/)() const | Devuelve el nombre del host. |
| [get_HostNameType](./get_hostnametype/)() const | Devuelve el tipo de nombre del host. |
...
| [get_UserInfo](./get_userinfo/)() const | Devuelve un nombre de usuario, contraseña y otra información de usuario asociada con el URI representado por el objeto actual. |
...
| [IsBaseOf](./isbaseof/)(const SharedPtr\<Uri\>\&) const | Determina si el URI representado por el objeto actual [Uri](./) es una base del URI representado por el objeto [Uri](./) especificado. |
...
| [IsWellFormedOriginalString](./iswellformedoriginalstring/)() const | Indica si la cadena utilizada para construir este [Uri](./) estaba bien formada y no es necesario escaparla más. |
| static [IsWellFormedUriString](./iswellformeduristring/)(const String\&, UriKind) | Determina si la cadena especificada es una URI bien formada. |
| [MakeRelative](./makerelative/)(const SharedPtr\<Uri\>\&) | Determina la diferencia entre dos instancias de [Uri](./). |
| [MakeRelativeUri](./makerelativeuri/)(const SharedPtr\<Uri\>\&) | Determina la diferencia entre las URIs representadas por los objetos [Uri](./) actuales y los especificados. |
| [ToString](./tostring/)() const override | Devuelve la representación en cadena de la URI representada por el objeto actual. |
| static [TryCreate](./trycreate/)(const String\&, UriKind, SharedPtr\<Uri\>\&) | Construye un objeto [Uri](./) que representa la URI especificada; un argumento indica el tipo de URI. |
| static [TryCreate](./trycreate/)(const SharedPtr\<Uri\>\&, const String\&, SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir del objeto [Uri](./) especificado que representa la URI base y la representación en cadena de la URI relativa. |
| static [TryCreate](./trycreate/)(const SharedPtr\<Uri\>\&, const SharedPtr\<Uri\>\&, SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir de la base y las URIs relativas especificadas. |
| static [UnescapeDataString](./unescapedatastring/)(const String\&) | Desescapa la cadena escapada especificada. |
| [Uri](./uri/)(const String\&) | Construye un objeto [Uri](./) que representa la URI especificada. |
| [Uri](./uri/)(const String\&, bool) | Construye un objeto [Uri](./) que representa la URI especificada; un argumento indica si la URI debe escaparse. |
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const String\&, bool) | Construye un [Uri](./) abject a partir del objeto [Uri](./) especificado que representa la URI base y la representación en cadena de la URI relativa; un argumento indica si la URI debe escaparse. |
| [Uri](./uri/)(const String\&, UriKind) | Construye un objeto [Uri](./) que representa la URI especificada; un argumento indica el tipo de URI. |
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const String\&) | Construye un [Uri](./) abject a partir de la base y las URIs relativas especificadas. |
| [Uri](./uri/)(const SharedPtr\<Uri\>\&, const SharedPtr\<Uri\>\&) | Construye un [Uri](./) abject a partir de la base y las URIs relativas especificadas. |
## Campos
...
| static [UriSchemeNetPipe](./urischemenetpipe/) | Especifica que el [Uri](./) se accede a través del esquema NetPipe utilizado por la Fundación de Comunicación de [Windows](../../system.windows/). |
| static [UriSchemeNetTcp](./urischemenettcp/) | Especifica que el [Uri](./) se accede a través del esquema NetTcp utilizado por la Fundación de Comunicación de [Windows](../../system.windows/). |
