---
title: "Método System::Uri::TryCreate"
linktitle: "TryCreate"
second_title: "Aspose.Page para C++"
description: "Método System::Uri::TryCreate. Construye un objeto Uri a partir de la base y los URIs relativos especificados en C++."
type: docs
weight: 4400
...
| result | SharedPtr\<Uri\>\& | El argumento de salida que, si la construcción tiene éxito, apunta al nuevo objeto [Uri](../) creado al retornar el método |

### ReturnValue

Verdadero si la construcción tuvo éxito, de lo contrario - falso
