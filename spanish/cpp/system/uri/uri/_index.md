---
title: "Constructor System::Uri::Uri"
linktitle: "Uri"
second_title: "Aspose.Page para C++"
description: "Constructor System::Uri::Uri. Construye un objeto Uri a partir de los URI base y relativos especificados en C++."
type: docs
weight: 100
url: /es/cpp/system/uri/uri/
---
...
Construye un [Uri](../) objeto a partir del [Uri](../) especificado que representa el URI base y la representación en cadena del URI relativo; un argumento indica si el URI debe escaparse.
...
| baseUri | const SharedPtr\<Uri\>\& | El URI base |
| relativeUri | const String\& | El URI relativo que se agrega al URI base |
| dontEscape | bool | Especifica si el URI no debe escaparse |
