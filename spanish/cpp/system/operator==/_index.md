...
Determina si los URI representados por los objetos actual y especificado son iguales.
...
True si los URI son iguales, de lo contrario - false
...
| Parámetro | Descripción |
| --- | --- |
| X | Tipo apuntado del primer puntero. |
| Y | Tipo apuntado del segundo puntero. |
...
| y | const Y * | puntero para comparar (derecho). |
...
| Parámetro | Descripción |
| --- | --- |
| T1 | El tipo del primer operando |
| T2 | El tipo subyacente del objeto [Nullable](../nullable/) que representa el segundo valor operando |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| alguno | const T1\& | Una referencia constante al valor que se usará como el primer operando |
| other | const Nullable\<T2\>\& | Una referencia constante al objeto [Nullable](../nullable/) cuyo valor representado se usará como el segundo operando |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | const X * | puntero para comparar (derecho). |
...
True si el objeto especificado representa un valor null, false de lo contrario
...
True si el puntero es null, false de lo contrario.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | std::nullptr_t | [Object](../object/) para comprobar. |

### ReturnValue

True si el objeto es null, false de lo contrario.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| left | T\& | [String](../string/) puntero para comparar. |
| right | const String\& | [String](../string/) para comparar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| x | T const\& | [Object](../object/) para comprobar. |
