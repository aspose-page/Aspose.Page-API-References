...
description: "Constructor System::String::String. Constructor predeterminado. Crea un objeto de cadena que se considera nulo en C++."
type: docs
weight: 100
...
Constructor por defecto. Crea un objeto de cadena que se considera nulo.
...
Convierte un subrango de matriz de caracteres a cadena. Si los parámetros están fuera de los límites de la matriz, se construye una cadena vacía.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| arr | const ArrayPtr\<char16_t\>\& | Matriz de caracteres. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const char * | Puntero [String](../) a los datos UTF8, puede ser literal o una matriz. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const char16_t * | Puntero a [String](../), puede ser literal o una matriz. |
| longitud | int | Longitud explícita de la cadena |
...
Crea [String](../) a partir de una cadena ancha.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const std::wstring\& | Cadena ancha para convertir en [String](../). |
...
Construye una cadena a partir de un puntero a cadena de caracteres. Trata la cadena apuntada como terminada en nulo en UTF8, calcula la longitud de la cadena objetivo en función del carácter nulo.
...
Construye una cadena a partir de un puntero a cadena de caracteres. Trata la cadena apuntada como terminada en nulo, calcula la longitud de la cadena objetivo en función del carácter nulo.
...
Construye una cadena basada en un puntero a cadena de caracteres anchos. Trata la cadena apuntada como terminada en nulo, calcula la longitud de la cadena objetivo basándose en el carácter nulo. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
...
Constructor nullptr. Declarado como plantilla para resolver prioridades con otros constructores de plantilla.
...
Construye una cadena a partir de un puntero a cadena de caracteres anchos y una longitud explícita. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const wchar_t * | Puntero a [String](../), puede ser literal o una matriz. |
| longitud | int | Longitud explícita de la cadena |
...
Constructor de llenado. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
...
Construye una cadena a partir de un literal de cadena. Considera el literal como una cadena terminada en nulo en UTF8, calcula la longitud de la cadena objetivo en función del tamaño del literal.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | T\& | Puntero literal a [String](../). |
...
Construye una cadena a partir de un literal de cadena. Considera el literal como una cadena terminada en nulo, calcula la longitud de la cadena objetivo en función del tamaño del literal.
...
Construye una cadena basada en un literal widestring. Considera el literal como una cadena terminada en nulo, calcula la longitud de la cadena objetivo basándose en el tamaño del literal. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas.
