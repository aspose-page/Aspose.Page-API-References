...
description: "Clase System::String. Clase de cadena utilizada en toda la biblioteca. Es un sustituto de C# System.String al traducir código. Por razones de optimización, no se considera una subclase de Object. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 5800
...
| static [CompareOrdinal](./compareordinal/)(const String\&, const String\&) | Less-equal-greater-compara dos cadenas usando modo ordinal. |
| static [CompareOrdinal](./compareordinal/)(const String\&, int, const String\&, int, int) | Less-equal-greater-compara dos cadenas usando modo ordinal. |
...
| [CopyTo](./copyto/)(int, const ArrayPtr\<char_t\>\&, int, int) const | Copia los caracteres de la cadena en los elementos existentes del arreglo. No se realiza redimensionamiento. |
...
| [Equals](./equals/)(const String\&, System::StringComparison) const | Comparación de igualdad de [String](./). Se admiten varios modos proporcionados por la enumeración [StringComparison](../stringcomparison/). |
| [Equals](./equals/)(const String\&) const | Comparación de igualdad de [String](./). Usa el modo de comparación [System::StringComparison::Ordinal](../stringcomparison/). |
...
| static [FromAscii](./fromascii/)(const char *) | Crea un [String](./) a partir de una cadena ASCII. |
| static [FromAscii](./fromascii/)(const char *, int) | Crea un [String](./) a partir de una cadena ASCII. |
| static [FromAscii](./fromascii/)(const std::string\&) | Crea un [String](./) a partir de una cadena ASCII. |
| static [FromUtf16](./fromutf16/)(const std::u16string\&) | Crea un [String](./) a partir de una cadena utf16. |
| static [FromUtf32](./fromutf32/)(const uint32_t *, int32_t) | Crea un [String](./) a partir de una cadena utf32. |
| static [FromUtf8](./fromutf8/)(const char *) | Crea un [String](./) a partir de una cadena utf8. |
| static [FromUtf8](./fromutf8/)(const char *, int) | Crea un [String](./) a partir de una cadena utf8. |
| static [FromUtf8](./fromutf8/)(const uint8_t *) | Crea un [String](./) a partir de una cadena utf8. |
| static [FromUtf8](./fromutf8/)(const std::string\&) | Crea un [String](./) a partir de una cadena utf8. |
| static [FromWCS](./fromwcs/)(const std::wstring\&) | Crea un [String](./) a partir de una cadena widestring. |
| [get_Length](./get_length/)() const | Obtiene la longitud de la cadena. |
| [GetHashCode](./gethashcode/)() const | Los hashes contenían la cadena. Implementado en ICU, no coincide con los hashes en C#. |
...
| [IndexOfAny](./indexofany/)(const String\&, int) const | Consecuentemente busca todos los caracteres de str en esto. Si se encuentra el primer carácter, se devuelve su posición; de lo contrario, busca el segundo y así sucesivamente. |
...
| [Insert](./insert/)(int, const String\&) const | Inserta la subcadena en la posición especificada. |
...
| [IsEmpty](./isempty/)() const | Comprueba si la cadena es tanto no nula como vacía. |
...
| [IsNull](./isnull/)() const | Comprueba si la cadena se considera nula. [String](./) es nula solo si se construye mediante el constructor [String()](./string/), se mueve, se copia o se asigna desde una cadena nula o se llamó al método [reset()](./reset/). |
...
| static [Join](./join/)(const String\&, const ArrayPtr\<String\>\&, int, int) | Une una matriz usando una cadena como separador. |
| static [Join](./join/)(const String\&, const System::Details::ArrayView\<String\>\&, int, int) | Une una matriz usando una cadena como separador. |
| static [Join](./join/)(const String\&, const SharedPtr\<System::Collections::Generic::IEnumerable\<String\>\>\&) | Une una matriz usando una cadena como separador. |
| static [Join](./join/)(const String\&, const ArrayPtr\<SharedPtr\<Object\>\>\&) | Une una matriz usando una cadena como separador. |
| [LastIndexOf](./lastindexof/)(const String\&, int) const | Búsqueda inversa de subcadena. |
| [LastIndexOf](./lastindexof/)(const String\&, System::StringComparison) const | Búsqueda inversa de subcadena. |
| [LastIndexOf](./lastindexof/)(const String\&, int, System::StringComparison) const | Búsqueda inversa de subcadena. |
| [LastIndexOf](./lastindexof/)(const String\&, int, int, StringComparison) const | Búsqueda inversa de subcadena. |
| [LastIndexOf](./lastindexof/)(char_t) const | Búsqueda inversa de carácter. |
| [LastIndexOf](./lastindexof/)(char_t, int32_t) const | Búsqueda inversa de carácter. |
| [LastIndexOf](./lastindexof/)(char_t, int32_t, int32_t) const | Búsqueda inversa de carácter. |
| [LastIndexOfAny](./lastindexofany/)(const ArrayPtr\<char_t\>\&) const | Busca cualquiera de los caracteres pasados en toda la cadena de forma inversa. Compara el último carácter de la cadena con todos los caracteres de anyOf, luego compara el anterior y así sucesivamente. Devuelve el índice de la primera coincidencia encontrada. |
| [LastIndexOfAny](./lastindexofany/)(const ArrayPtr\<char_t\>\&, int32_t) const | Busca cualquiera de los caracteres pasados en la subcadena de forma inversa. Compara el último carácter de la cadena con todos los caracteres de anyOf, luego compara el anterior y así sucesivamente. Devuelve el índice de la primera coincidencia encontrada. |
...
| [Normalize](./normalize/)(System::Text::NormalizationForm) const | Normaliza una cadena Unicode usando la forma de normalización especificada. |
...
| [operator+](./operator+/)(const String\&) const | [String](./) operador de concatenación. |
| [operator+](./operator+/)(const T\&) const | Concatenación de [String](./) con literal de cadena o puntero a cadena de caracteres. |
| [operator+](./operator+/)(char_t) const | Agrega un carácter al final de la cadena. |
...
| [operator<](./operator_/)(const String\&) const | Compara el orden de las cadenas. |
...
| [operator==](./operator==/)(std::nullptr_t) const | Comprueba si la cadena es nula. Aplica la misma lógica que la llamada a [IsNull()](./isnull/). |
| [operator>](./operator_/)(const String\&) const | Compara el orden de las cadenas. |
...
| [rbegin](./rbegin/)() const | Devuelve un iterador inverso al último carácter (si lo hay) del búfer de cadena actual. |
| [Remove](./remove/)(int32_t, int32_t) const | Extrae todo excepto la subcadena de la cadena actual. |
| [rend](./rend/)() const | Devuelve un iterador inverso al carácter anterior al primero (si lo hay) del búfer de cadena actual. |
| [Replace](./replace/)(char_t, char_t) const | Reemplaza todas las ocurrencias del carácter en la cadena. |
| [Replace](./replace/)(const String\&, const String\&) const | Reemplaza todas las ocurrencias de la búsqueda en esta cadena. |
...
| [String](./string/)() | Constructor por defecto. Crea un objeto de cadena que se considera nulo. |
| [String](./string/)(T\&, typename std::enable_if\<IsStringLiteral\<T, char16_t\>::value\>::type *) | Construye una cadena a partir de un literal de cadena. Considera el literal como una cadena terminada en nulo, calcula la longitud de la cadena objetivo en función del tamaño del literal. |
| [String](./string/)(const T\&, typename std::enable_if\<IsStringPointer\<T, char16_t\>::value\>::type *) | Construye una cadena a partir de un puntero a cadena de caracteres. Trata la cadena apuntada como terminada en nulo, calcula la longitud de la cadena objetivo en función del carácter nulo. |
| explicit [String](./string/)(T\&, typename std::enable_if\<IsStringLiteral\<T, char\>::value\>::type *) | Construye una cadena a partir de un literal de cadena. Considera el literal como una cadena terminada en nulo en UTF8, calcula la longitud de la cadena objetivo en función del tamaño del literal. |
| explicit [String](./string/)(const T\&, typename std::enable_if\<IsStringPointer\<T, char\>::value\>::type *) | Construye una cadena a partir de un puntero a cadena de caracteres. Trata la cadena apuntada como terminada en nulo en UTF8, calcula la longitud de la cadena objetivo en función del carácter nulo. |
...
| [String](./string/)(const T\&, typename std::enable_if\<std::is_same\<T, std::nullptr_t\>::value\>::type *) | Constructor nullptr. Declarado como plantilla para resolver prioridades con otros constructores de plantilla. |
| explicit [String](./string/)(T\&, typename std::enable_if\<IsStringLiteral\<T, wchar_t\>::value\>::type *) | Construye una cadena basada en un literal widestring. Considera el literal como una cadena terminada en nulo, calcula la longitud de la cadena objetivo basándose en el tamaño del literal. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
| explicit [String](./string/)(const T\&, typename std::enable_if\<IsStringPointer\<T, wchar_t\>::value\>::type *) | Construye una cadena basada en un puntero a cadena de caracteres anchos. Trata la cadena apuntada como terminada en nulo, calcula la longitud de la cadena objetivo basándose en el carácter nulo. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
| explicit [String](./string/)(const wchar_t *, int) | Construye una cadena a partir de un puntero a cadena de caracteres anchos y una longitud explícita. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
| explicit [String](./string/)(const wchar_t, int) | Constructor de llenado. La conversión desde wchar_t consume tiempo en algunas plataformas, por lo que no se permiten conversiones implícitas. |
...
| [String](./string/)(const ArrayPtr\<char16_t\>\&, int, int) | Convierte un subrango de matriz de caracteres a cadena. Si los parámetros están fuera de los límites de la matriz, se construye una cadena vacía. |
...
| explicit [String](./string/)(const std::wstring\&) | Crea un [String](./) a partir de una cadena widestring. |
| explicit [String](./string/)(const std::u16string\&) | Crea un [String](./) a partir de una cadena utf16. |
...
| [ToByteArray](./tobytearray/)(int32_t, int32_t, bool) const | Convierte la cadena o subcadena a una matriz de bytes. |
| [ToCharArray](./tochararray/)(int32_t, int32_t) const | Convierte una cadena o subcadena en una matriz de caracteres. |
...
| [ToString](./tostring/)() const | Wrapper para manejar la clase [String](./) en contextos donde se llama a [ToString()](./tostring/) en objetos de tipo valor. |
| [ToString](./tostring/)(const SharedPtr\<IFormatProvider\>\&) const | Wrapper para manejar la clase [String](./) en contextos donde se llama a [ToString()](./tostring/) en objetos de tipo valor. |
| [ToU16Str](./tou16str/)() const | Convierte una cadena a std::u16string. |
| [ToU32Str](./tou32str/)() const | Convierte una cadena a std::u32string. |
...
| [ToUtf8String](./toutf8string/)() const | Convierte una cadena a std::string. Utiliza codificación UTF-8. |
| [ToWCS](./towcs/)() const | Convierte una cadena a std::wstring. |
...
int main()
{
  // Construye una cadena a partir de la matriz de caracteres y la imprime.
  const auto chars = {u'h', u'e', u'l', u'l', u'o'};
  const System::String string1(chars);
  std::cout << string1 << std::endl;

  // Construye una cadena a partir del arreglo de bytes y imprímela.
  const uint8_t bytes[] = {0x77, 0x6f, 0x72, 0x6c, 0x64, 0x0};
  const auto string2 = System::String::FromUtf8(bytes);
  std::cout << string2 << std::endl;

  // Recorta la cadena a continuación y imprímela.
