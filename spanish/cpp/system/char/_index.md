...
description: "Clase System::Char. Proporciona métodos para la manipulación de caracteres representados como unidades de código UTF-16. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 1200
...
| static [GetUnicodeCategory](./getunicodecategory/)(char_t) | Devuelve un valor que representa una categoría Unicode del carácter especificado. |
| static [IsAsciiWhiteSpace](./isasciiwhitespace/)(char_t) | Determina si el carácter especificado se clasifica como un carácter de espacio en blanco ASCII. |
| static [IsControl](./iscontrol/)(const char_t *, int) | Determina si el carácter en el índice especificado del búfer de caracteres especificado se clasifica como un carácter de control Unicode. |
| static [IsControl](./iscontrol/)(char_t) | Determina si el carácter especificado se clasifica como un carácter de control Unicode. |
| static [IsDigit](./isdigit/)(const char_t *, int) | Determina si el carácter en el índice especificado del búfer de caracteres especificado se clasifica como un dígito decimal. |
| static [IsDigit](./isdigit/)(const String\&, const int32_t) | Determina si el carácter en el índice especificado de la cadena especificada se clasifica como un dígito decimal. |
| static [IsDigit](./isdigit/)(char_t) | Determina si el carácter especificado se clasifica como un dígito decimal. |
| static [IsHighSurrogate](./ishighsurrogate/)(const String\&, int) | Determina si el carácter en el índice especificado de la cadena especificada es una unidad de código de sustituto alto UTF-16. |
...
| static [IsLetter](./isletter/)(const char_t *, int) | Determina si el carácter en el índice especificado del búfer de caracteres especificado está clasificado como letra Unicode. |
| static [IsLetter](./isletter/)(char_t) | Determina si el carácter especificado está clasificado como letra Unicode. |
| static [IsLetterOrDigit](./isletterordigit/)(const char_t *, int) | Determina si el carácter en el índice especificado del búfer de caracteres especificado está clasificado como letra Unicode o como dígito decimal. |
...
| static [IsLowSurrogate](./islowsurrogate/)(const char_t *, int) | Determina si el carácter en el índice especificado del búfer de caracteres especificado es un sustituto bajo. |
| static [IsLowSurrogate](./islowsurrogate/)(char_t) | Determina si el carácter especificado es un sustituto bajo. |
| static [IsNumber](./isnumber/)(const char_t *, int) | Determina si el carácter en el índice especificado en el búfer de caracteres especificado está clasificado como un número. |
| static [IsNumber](./isnumber/)(char_t) | Determina si el carácter especificado está clasificado como un número. |
| static [IsPunctuation](./ispunctuation/)(const char_t *, int) | Determina si el carácter en el índice especificado en el búfer de caracteres especificado está clasificado como un carácter de puntuación. |
...
| static [IsSurrogate](./issurrogate/)(char_t) | Determina si el carácter especificado es una unidad de código sustituta UTF-16. |
| static [IsSurrogate](./issurrogate/)(const String\&, int) | Determina si el carácter en el índice especificado de la cadena especificada es una unidad de código sustituta UTF-16. |
...
| static [TryParse](./tryparse/)(const System::String\&, char_t\&) | Intenta convertir una cadena que consiste en un solo carácter a un carácter UTF-16. La función solo tiene éxito cuando la cadena de entrada no es nula y tiene una longitud de exactamente un carácter. |
## Ver también
