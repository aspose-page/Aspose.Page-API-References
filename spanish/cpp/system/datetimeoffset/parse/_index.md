---
title: "System::DateTimeOffset::Parse método"
linktitle: "Analizar"
second_title: "Aspose.Page para C++"
description: "System::DateTimeOffset::Parse método. Convierte la cadena especificada al equivalente DateTimeOffset en C++."
type: docs
weight: 5500
url: /es/cpp/system/datetimeoffset/parse/
---
## DateTimeOffset::Parse(const String\&) method


Convierte la cadena especificada a su equivalente [DateTimeOffset](../).
...
Convierte la cadena especificada a un objeto [DateTimeOffset](../) usando el proveedor de formato y el estilo de formato especificados.
