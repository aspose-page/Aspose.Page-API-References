...
description: "Constructor de System::DateTimeOffset::DateTimeOffset. Constructor predeterminado en C++."
type: docs
weight: 100
url: /es/cpp/system/datetimeoffset/datetimeoffset/
---
...
| --- | --- | --- |
| date_time | DateTime | Fecha y hora. |
...
| --- | --- | --- |
| date_time | DateTime | Fecha y hora. |
| desplazamiento | TimeSpan | Desplazamiento de tiempo respecto a UTC. |
...
| año | int | Año. |
| mes | int | Mes (1 a 12). |
| día | int | Día (1 al número de días del mes). |
| hora | int | Hora (0 a 23). |
| minuto | int | Minuto (0 a 59). |
| segundo | int | Segundo (0 a 59). |
| milisegundo | int | Milisegundo (0 a 999). |
| calendario | const SharedPtr\<Globalization::Calendar\>\& | Calendario utilizado para interpretar el año, mes y día. |
| desplazamiento | TimeSpan | Desplazamiento de tiempo respecto a UTC. |
