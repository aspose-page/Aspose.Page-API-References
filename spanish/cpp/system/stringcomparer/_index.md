...
| static [get_CurrentCultureIgnoreCase](./get_currentcultureignorecase/)() | Singleton del comparador de cultura actual que ignora mayúsculas. |
| static [get_InvariantCulture](./get_invariantculture/)() | Singleton del comparador de cultura invariante. |
| static [get_InvariantCultureIgnoreCase](./get_invariantcultureignorecase/)() | Singleton del comparador de cultura invariante que ignora mayúsculas. |
| static [get_Ordinal](./get_ordinal/)() | Singleton del comparador ordinal. |
| static [get_OrdinalIgnoreCase](./get_ordinalignorecase/)() | Singleton del comparador ordinal que ignora mayúsculas. |
