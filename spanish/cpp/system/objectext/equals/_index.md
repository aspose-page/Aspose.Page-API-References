---
title: "System::ObjectExt::Equals método"
linktitle: "Igual"
second_title: "Aspose.Page para C++"
description: "System::ObjectExt::Equals método. Sustitución de llamadas a C# Object.Equals que funciona para cualquier tipo en C++. Sobrecarga para literal de cadena con comparación de cadenas en C++."
type: docs
weight: 700
...
Sustitución de llamadas a C# [Object.Equals](../../object/equals/) que funciona para cualquier tipo en C++. Sobrecarga para literal de cadena con comparación de cadenas.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| obj | const double\& | Valor de punto flotante del operando izquierdo (LHS). |
| otro | const double\& | Valor de punto flotante del operando derecho (RHS). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| obj | const float\& | Valor de punto flotante del operando izquierdo (LHS). |
| otro | const float\& | Valor de punto flotante del operando derecho (RHS). |
...
Sustitución para llamadas de C# [Object.Equals](../../object/equals/) que funcionan para cualquier tipo en C++. Sobrecarga para tipos de puntero inteligente.
...
| Parámetro | Descripción |
| --- | --- |
| T | Primer tipo de objeto. |
| T2 | Segundo tipo de objeto. |
...
Sustitución para llamadas de C# [Object.Equals](../../object/equals/) que funcionan para cualquier tipo en C++. Sobrecarga para tipos escalares.
...
Sustitución para llamadas de C# [Object.Equals](../../object/equals/) que funcionan para cualquier tipo en C++. Sobrecarga para tipos de estructura.
