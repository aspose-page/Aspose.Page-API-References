---
title: "Método System::setter_post_increment_wrap"
linktitle: "setter_post_increment_wrap"
second_title: "Aspose.Page para C++"
description: "Método System::setter_post_increment_wrap. El traductor traduce las expresiones de post‑incremento de C# que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter const) en C++."
type: docs
weight: 37900
...
El traductor traduce las expresiones de post‑incremento de C# que apuntan a la propiedad de la instancia que tiene setter y getter definidos, en una invocación de esta función (sobrecarga para getter const).
...
El traductor traduce las expresiones de post‑incremento de C# que apuntan a la propiedad de una instancia que tiene definido setter y getter, en la invocación de esta función (sobrecarga para getter no const).
...
El traductor traduce las expresiones de post‑incremento de C# que apuntan a la propiedad de una clase que tiene definido setter y getter, en la invocación de esta función.
