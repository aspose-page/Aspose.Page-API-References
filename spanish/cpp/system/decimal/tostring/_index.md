---
title: "System::Decimal::ToString método"
linktitle: "ToString"
second_title: "Aspose.Page para C++"
description: "System::Decimal::ToString método. Devuelve la representación en cadena del valor representado por el objeto en C++."
type: docs
weight: 3000
url: /es/cpp/system/decimal/tostring/
---
...
| --- | --- | --- |
| provider | const SharedPtr\<IFormatProvider\>\& | El objeto [IFormatProvider](../../iformatprovider/) que proporciona la información de formato específica de la cultura. |
...
Convierte el objeto actual a su representación en cadena usando el formato de cadena especificado y la información de formato específica de cultura proporcionada por el objeto [IFormatProvider](../../iformatprovider/) especificado.
