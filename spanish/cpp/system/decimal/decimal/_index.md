...
description: "System::Decimal::Decimal constructor. Construye una instancia que representa 0 en C++."
type: docs
weight: 100
url: /es/cpp/system/decimal/decimal/
---
...
| --- | --- | --- |
| bits | const ArrayPtr\<int32_t\>\& | Una matriz de enteros que contiene una representación binaria. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | const number_type\& | Una referencia constante al valor que será representado por el objeto que se está construyendo |
...
| hola | int32_t | Los 32 bits más altos del valor |
| isNegative | bool | Especifica si el valor es negativo |
| escala | uint8_t | Una potencia de 10 que varía de 0 a 28 |
