...
description: "Método System::operator<<. Envía una cadena al flujo de salida usando codificación UTF-8 en C++."
type: docs
weight: 29100
url: /es/cpp/system/operator__/
---
## System::operator<<(std::ostream\&, const String\&) method


Envía una cadena al flujo de salida usando codificación UTF-8.
...
| --- | --- | --- |
| os | std::ostream\& | Un objeto de flujo de salida (instanciación de **basic_ostream** con **char**). |
| str | const String\& | Una cadena para ser enviada al flujo de salida. |

### ReturnValue

Un flujo de salida al que se añadió la cadena.
...
| decimal | const Decimal\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| exception | const Exception\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| guid | const Guid\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| value | const Nullable\<T\>\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| os | const OperatingSystem\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| object_ptr | const SharedPtr\<T\>\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| object | const System::Object\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| type_info | const TypeInfo\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| version | const Version\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| object_ptr | const WeakPtr\<T\>\& | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| date_time | DateTime | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| value | DateTimeOffset | [Data](../../system.data/) para insertar. |
...
| --- | --- | --- |
| flujo | std::ostream\& | Flujo de salida donde insertar datos. |
| time_span | TimeSpan | [Data](../../system.data/) para insertar. |
...
Envía una cadena al flujo de salida.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| os | std::wostream\& | Un objeto de flujo de salida (instanciación de **basic_ostream** con **wchar_t**). |
| str | const String\& | Una cadena para ser enviada al flujo de salida. |
...
linktitle: operator>>
second_title: Aspose.Page para C++
description: 'Método System::operator>>. Obtiene una cadena del streamusing de entrada usando codificación UTF-8 en C++.'
type: docs
weight: 35100
...
Obtiene una cadena del streamusing de entrada usando codificación UTF-8.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| in | std::istream\& | Un objeto de flujo de entrada (instanciación de **basic_ostream** con **char**). |
| str | String\& | Una cadena para leer del flujo de entrada. |

### ReturnValue

Un flujo de entrada del que se extrajo la cadena.
...
Obtiene una cadena del flujo de entrada.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| in | std::wistream\& | Un objeto de flujo de entrada (instanciación de **basic_ostream** con **wchar_t**). |
| str | String\& | Una cadena para leer del flujo de entrada. |
