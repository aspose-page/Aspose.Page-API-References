---
title: "Clase System::Byte"
linktitle: "Byte"
second_title: "Aspose.Page para C++"
description: "Clase System::Byte. Contiene métodos para trabajar con el entero sin signo de 8 bits en C++."
type: docs
weight: 1100
...
| static [Parse](./parse/)(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) | Convierte la cadena especificada que contiene la representación en cadena de un número al entero sin signo de 8 bits equivalente usando la información de formato y el estilo numérico proporcionados. |
