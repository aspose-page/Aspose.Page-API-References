...
description: "System::Nullable::operator== method. Determina si el valor representado por el objeto actual es igual al valor representado por el objeto Nullable especificado en C++."
type: docs
weight: 1900
...
Verdadero si el valor representado por el objeto actual es igual al valor especificado, de lo contrario - falso
...
Verdadero si el valor representado por el objeto actual es nulo, de lo contrario - falso
