...
description: "System::Nullable class. Declaración adelantada en C++."
type: docs
weight: 4600
...
| [Nullable](./nullable/)(const Nullable\<T1\>\&) | Construye una instancia que representa un valor representado por el objeto [Nullable](./) especificado. El objeto nullable especificado puede representar un valor de tipo diferente al tipo subyacente de la instancia construida, en cuyo caso el valor representado se convierte a un valor de tipo T. |
...
| [operator+](./operator+/)(const T1\&) const | Suma valores nullable y no nullable. |
| [operator+](./operator+/)(const Nullable\<T1\>\&) const | Suma valores nullable. |
...
| [operator-](./operator-/)(T1) const | Resta valores nullable y valores apuntados a nulo. |
| [operator-](./operator-/)(const T1\&) const | Resta valores nullable y no nullable. |
| [operator-](./operator-/)(const Nullable\<T1\>\&) const | Resta valores nullable. |
...
| [operator=](./operator=/)(const T1\&) | Reemplaza el valor actualmente representado del objeto con el especificado. |
| [operator=](./operator=/)(const Nullable\<T1\>\&) | Reemplaza el valor actualmente representado del objeto con el especificado. |
...
| [reset](./reset/)() | Establece el valor representado actualmente a nulo. |
