...
description: "System::Nullable::operator<= método. Determina si el valor representado por el objeto actual es menor o igual al valor representado por el objeto Nullable especificado aplicando operator<=() a estos valores en C++."
type: docs
weight: 1700
...
Determina si el valor representado por el objeto actual es mayor o igual al valor representado por el objeto especificado al aplicar [operator>=()](./) a estos valores.
