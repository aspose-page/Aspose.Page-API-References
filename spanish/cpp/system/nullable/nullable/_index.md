...
description: "System::Nullable::Nullable constructor. Construye una instancia que representa un valor nulo en C++."
type: docs
weight: 100
url: /es/cpp/system/nullable/nullable/
---
...
| --- | --- | --- |
| value | const T1\& | Una referencia constante al valor que será representado por el objeto [Nullable](../) recién construido |
...
Construye una instancia que representa nulo.
