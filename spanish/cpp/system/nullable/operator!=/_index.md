...
description: "System::Nullable::operator!= método. Determina si el valor representado por el objeto actual no es igual al valor representado por el objeto Nullable especificado en C++."
type: docs
weight: 1000
...
True si el valor representado por el objeto actual no es igual al valor representado por el objeto [Nullable](../) especificado, de lo contrario - false
...
True si el valor representado por el objeto actual no es igual al valor especificado, de lo contrario - false
...
True si el valor representado por el objeto actual no es nulo, de lo contrario - false
