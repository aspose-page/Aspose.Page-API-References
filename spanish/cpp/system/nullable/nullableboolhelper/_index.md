---
title: "System::Nullable::NullableBoolHelper método"
linktitle: "NullableBoolHelper"
second_title: "Aspose.Page para C++"
description: "System::Nullable::NullableBoolHelper método. Función auxiliar para comprobar si **this** y **other** no son nulos y llamar a una lambda en ese caso. Usada en implementaciones en C++."
type: docs
weight: 800
...
| f | const std::function\<bool()>\& | Lambda a llamar si **this** y **other** no son nulos. |
