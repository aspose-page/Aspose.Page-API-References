...
True si el valor representado por el objeto actual es menor que el valor representado por el objeto [Nullable](../) especificado, de lo contrario - false
...
True si el valor representado por el objeto actual es menor que el valor especificado, de lo contrario - false
...
second_title: Aspose.Page para C++
description: 'System::Nullable::operator> método. Determina si el valor representado por el objeto actual es mayor que el valor representado por el objeto Nullable especificado al aplicar operator>() a estos valores en C++.'
type: docs
weight: 2000
...
True si el valor representado por el objeto actual es mayor que el objeto [Nullable](../) especificado, de lo contrario - false
