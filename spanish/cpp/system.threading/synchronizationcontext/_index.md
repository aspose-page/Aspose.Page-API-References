...
Esta clase permite la propagación del contexto de sincronización entre hilos y se usa para marshalar devoluciones de llamada o invocaciones al hilo o contexto de sincronización apropiado.
