...
description: "System::Threading::ThreadPool class. API de pool de hilos que permite enviar trabajos a la cola para que sean leídos por un conjunto de hilos de trabajo. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio en C++."
type: docs
weight: 1300
