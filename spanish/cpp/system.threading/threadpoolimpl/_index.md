...
description: "Clase System::Threading::ThreadPoolImpl. Datos internos del pool de hilos. Este es un tipo singleton con la gestión de memoria realizada mediante función(es) de acceso. Nunca debe crear instancias de él directamente en C++."
type: docs
weight: 1400
...
| [~ThreadPoolImpl](./~threadpoolimpl/)() | Destructor. Une todos los hilos si no se habían terminado aún. |
## Ver también
