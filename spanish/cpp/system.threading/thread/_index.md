...
| Método | Descripción |
| --- | --- |
| [Abort](./abort/)() | Abortar hilo. No implementado. |
...
| [get_IsThreadPoolThread](./get_isthreadpoolthread/)() | Comprueba si el hilo pertenece a un grupo de hilos. |
...
| [Interrupt](./interrupt/)() | Interrumpir hilo. No implementado. |
| [Join](./join/)() | Une el hilo administrado. Realiza una espera ilimitada si es necesario. |
| [Join](./join/)(int) | Une el hilo administrado. Realiza una espera limitada. |
| [Join](./join/)(TimeSpan) | Une el hilo administrado. Realiza una espera limitada. |
...
| [set_IsBackground](./set_isbackground/)(bool) | Establece el hilo en segundo plano o en primer plano. |
