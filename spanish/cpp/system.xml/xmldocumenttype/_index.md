...
description: "Clase System::Xml::XmlDocumentType. Representa la declaración del tipo de documento en C++."
type: docs
weight: 1600
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Para los nodos [XmlDocumentType](./), este método no tiene efecto. |
