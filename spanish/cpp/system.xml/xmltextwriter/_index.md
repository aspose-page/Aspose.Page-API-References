---
title: "Clase System::Xml::XmlTextWriter"
linktitle: "XmlTextWriter"
second_title: "Aspose.Page para C++"
description: "Clase System::Xml::XmlTextWriter. Representa un escritor que ofrece una manera rápida, sin caché y solo de avance para generar flujos o archivos que contienen datos XML que cumplen con el Extensible Markup Language (XML) 1.0 de W3C y las recomendaciones de Namespaces in XML en C++."
type: docs
weight: 4000
...
Representa un escritor que proporciona una forma rápida, sin caché y solo de avance para generar flujos o archivos que contienen datos XML que cumplen con el Extensible Markup Language (XML) 1.0 del W3C y las recomendaciones de Namespaces in XML.
...
| [Flush](./flush/)() override | Vuelca lo que haya en el búfer a los flujos subyacentes y también vacía el flujo subyacente. |
| [get_BaseStream](./get_basestream/)() | Devuelve el objeto de flujo subyacente. |
| [get_Formatting](./get_formatting/)() | Indica cómo se formatea la salida. |
...
| [LookupPrefix](./lookupprefix/)(String) override | Devuelve el prefijo más cercano definido en el alcance de espacio de nombres actual para el URI del espacio de nombres. |
| [set_Formatting](./set_formatting/)(System::Xml::Formatting) | Indica cómo se formatea la salida. |
...
| [WriteCharEntity](./writecharentity/)(char16_t) override | Forza la generación de una entidad de carácter para el valor de carácter Unicode especificado. |
...
| [WriteEndElement](./writeendelement/)() override | Cierra un elemento y elimina el ámbito de espacio de nombres correspondiente. |
| [WriteEntityRef](./writeentityref/)(const String\&) override | Escribe una referencia de entidad como **&name**;. |
| [WriteFullEndElement](./writefullendelement/)() override | Cierra un elemento y elimina el ámbito de espacio de nombres correspondiente. |
...
| [WriteQualifiedName](./writequalifiedname/)(const String\&, const String\&) override | Escribe el nombre calificado con espacio de nombres. Este método busca el prefijo que está en alcance para el espacio de nombres dado. |
...
| [WriteWhitespace](./writewhitespace/)(String) override | Escribe el espacio en blanco dado. |
