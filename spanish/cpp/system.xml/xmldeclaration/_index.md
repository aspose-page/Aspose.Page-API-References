...
| [get_InnerText](./get_innertext/)() override | Devuelve los valores concatenados del [XmlDeclaration](./). |
...
| [get_Value](./get_value/)() override | Devuelve el valor del [XmlDeclaration](./). |
...
| [set_InnerText](./set_innertext/)(String) override | Establece los valores concatenados del [XmlDeclaration](./). |
| [set_Standalone](./set_standalone/)(const String\&) | Establece el valor del atributo standalone. |
| [set_Value](./set_value/)(String) override | Establece el valor del [XmlDeclaration](./). |
