...
description: "System::Xml::XmlParserContext::XmlParserContext constructor. Inicializa una nueva instancia de la clase XmlParserContext con los valores especificados de XmlNameTable, XmlNamespaceManager, URI base, xml:lang, xml:space y tipo de documento en C++."
type: docs
weight: 100
...
Inicializa una nueva instancia de la clase [XmlParserContext](../) con los [XmlNameTable](../../xmlnametable/), [XmlNamespaceManager](../../xmlnamespacemanager/), URI base, **xml:lang**, **xml:space** y valores de tipo de documento especificados.
...
| --- | --- | --- |
| nt | const SharedPtr\<XmlNameTable\>\& | El [XmlNameTable](../../xmlnametable/) a usar para atomizar cadenas. Si esto es **nullptr**, se utiliza la tabla de nombres usada para construir el **nsMgr**. Para obtener más información sobre cadenas atomizadas, consulte [XmlNameTable](../../xmlnametable/). |
...
| xmlLang | const String\& | El alcance **xml:lang**. |
...
Inicializa una nueva instancia de la clase [XmlParserContext](../) con la [XmlNameTable](../../xmlnametable/) especificada, la [XmlNamespaceManager](../../xmlnamespacemanager/) especificada, el URI base, **xml:lang**, **xml:space**, la codificación y los valores del tipo de documento.
...
Inicializa una nueva instancia de la clase [XmlParserContext](../) con la [XmlNameTable](../../xmlnametable/) especificada, la [XmlNamespaceManager](../../xmlnamespacemanager/) especificada, los valores **xml:lang** y **xml:space**.
...
Inicializa una nueva instancia de la clase [XmlParserContext](../) con la [XmlNameTable](../../xmlnametable/) especificada, la [XmlNamespaceManager](../../xmlnamespacemanager/) especificada, **xml:lang**, **xml:space** y la codificación.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nt | const SharedPtr\<XmlNameTable\>\& | La [XmlNameTable](../../xmlnametable/) a usar para atomizar cadenas. Si esto es **nullptr**, se utiliza la tabla de nombres usada para construir el **nsMgr**. Para obtener más información sobre las cadenas atomizadas, consulte [XmlNameTable](../../xmlnametable/). |
| nsMgr | const SharedPtr\<XmlNamespaceManager\>\& | El [XmlNamespaceManager](../../xmlnamespacemanager/) a usar para buscar información de espacios de nombres, o **nullptr**. |
| xmlLang | const String\& | El alcance **xml:lang**. |
| xmlSpace | System::Xml::XmlSpace | Un valor [XmlSpace](../../xmlspace/) que indica el ámbito **xml:space**. |
| enc | const SharedPtr\<System::Text::Encoding\>\& | Un objeto Encoding que indica la configuración de codificación. |
