...
description: "Clase System::Xml::NameTable. Implementa un XmlNameTable de un solo subproceso en C++."
type: docs
weight: 500
...
Implementa un [XmlNameTable](../xmlnametable/) de un solo subproceso.
