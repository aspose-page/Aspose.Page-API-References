---
title: "System::Xml::XmlReader::GetAttribute método"
linktitle: "GetAttribute"
second_title: "Aspose.Page para C++"
description: "System::Xml::XmlReader::GetAttribute método. Cuando se sobrescribe en una clase derivada, obtiene el valor del atributo con el índice especificado en C++."
type: docs
weight: 2800
...
El valor del atributo especificado. Si el atributo no se encuentra o el valor es [String::Empty](../../../system/string/empty/), se devuelve **nullptr**. Este método no mueve al lector.
