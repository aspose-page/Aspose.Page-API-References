...
| virtual [CreateElement](./createelement/)(const String\&, const String\&, const String\&) | Crea un elemento con el [XmlNode::get_Prefix](../xmlnode/get_prefix/) especificado, [XmlDocument::get_LocalName](./get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) especificados. |
| virtual [CreateEntityReference](./createentityreference/)(const String\&) | Crea una [XmlEntityReference](../xmlentityreference/) con el nombre especificado. |
| [CreateNavigator](./createnavigator/)() override | Crea un nuevo objeto XPathNavigator para navegar por este documento. |
| virtual [CreateNode](./createnode/)(XmlNodeType, const String\&, const String\&, const String\&) | Crea un [XmlNode](../xmlnode/) con el [XmlNodeType](../xmlnodetype/) especificado, [XmlNode::get_Prefix](../xmlnode/get_prefix/), [XmlDocument::get_Name](./get_name/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [CreateNode](./createnode/)(const String\&, const String\&, const String\&) | Crea un [XmlNode](../xmlnode/) con el tipo de nodo especificado, [XmlDocument::get_Name](./get_name/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [CreateNode](./createnode/)(XmlNodeType, const String\&, const String\&) | Crea un [XmlNode](../xmlnode/) con el [XmlNodeType](../xmlnodetype/) especificado, [XmlDocument::get_Name](./get_name/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [CreateProcessingInstruction](./createprocessinginstruction/)(const String\&, const String\&) | Crea una [XmlProcessingInstruction](../xmlprocessinginstruction/) con el nombre y los datos especificados. |
...
| [get_Implementation](./get_implementation/)() | Devuelve el objeto [XmlImplementation](../xmlimplementation/) del documento actual. |
...
| [get_Schemas](./get_schemas/)() | Devuelve el objeto XmlSchemaSet asociado a este [XmlDocument](./). |
...
| [set_InnerXml](./set_innerxml/)(String) override | Establece el marcado que representa los hijos del nodo actual. |
...
| virtual [set_XmlResolver](./set_xmlresolver/)(SharedPtr\<System::Xml::XmlResolver\>) | Establece el [XmlResolver](../xmlresolver/) a usar para resolver recursos externos. |
...
| [XmlDocument](./xmldocument/)(const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlDocument](./) con el [XmlNameTable](../xmlnametable/) especificado. |
## Typedefs
