...
description: "System::Xml::XmlDocument::Validate method. Valida el XmlDocument contra los esquemas del Lenguaje de Definición de Esquemas XML (XSD) contenidos en la lista XmlDocument::get_Schemas en C++."
type: docs
weight: 4300
...
Valida el [XmlDocument](../) contra los esquemas del Lenguaje de Definición de [Schema](../../../system.xml.schema/) XML (XSD) contenidos en la lista [XmlDocument::get_Schemas](../get_schemas/).
...
Valida el objeto [XmlNode](../../xmlnode/) especificado contra los esquemas del Lenguaje de Definición de [Schema](../../../system.xml.schema/) XML (XSD) en la lista [XmlDocument::get_Schemas](../get_schemas/).
