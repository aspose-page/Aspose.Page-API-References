...
| virtual [get_NameTable](./get_nametable/)() | Devuelve el [XmlNameTable](../xmlnametable/) asociado con este objeto. |
...
| virtual [HasNamespace](./hasnamespace/)(String) | Devuelve un valor que indica si el prefijo suministrado tiene un espacio de nombres definido para el alcance actual apilado. |
...
| [LookupPrefix](./lookupprefix/)(const String\&) override | Encuentra el prefijo declarado para el URI del espacio de nombres dado. |
| virtual [PopScope](./popscope/)() | Quita un alcance de espacio de nombres de la pila. |
| virtual [PushScope](./pushscope/)() | Inserta un alcance de espacio de nombres en la pila. |
| virtual [RemoveNamespace](./removenamespace/)(String, String) | Elimina el espacio de nombres dado para el prefijo especificado. |
| [XmlNamespaceManager](./xmlnamespacemanager/)(const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlNamespaceManager](./) con el [XmlNameTable](../xmlnametable/) especificado. |
## Typedefs
