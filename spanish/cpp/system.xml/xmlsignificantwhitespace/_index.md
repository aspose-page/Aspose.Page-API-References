---
title: "Clase System::Xml::XmlSignificantWhitespace"
linktitle: "XmlSignificantWhitespace"
second_title: "Aspose.Page para C++"
description: "Clase System::Xml::XmlSignificantWhitespace. Representa el espacio en blanco entre marcas en un nodo de contenido mixto o el espacio en blanco dentro de un ámbito xml:space=''preserve''. También se le llama espacio en blanco significativo en C++."
type: docs
weight: 3700
url: /es/cpp/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace class


Representa espacio en blanco entre marcas en un nodo de contenido mixto o espacio en blanco dentro de un ámbito **xml:space='preserve'**. También se conoce como espacio en blanco significativo.
