...
| --- | --- | --- |
| None | 0 | No se realiza ninguna validación, y no se lanzan errores de validación. Esta configuración crea un analizador no validante compatible con XML 1.0. |
| Automático | 1 | Valida si se encuentra información DTD o de esquema. |
