...
description: "System::Xml::XmlEntity class. Representa una declaración de entidad, como <!ENTITY... > en C++."
type: docs
weight: 1800
...
| [get_BaseURI](./get_baseuri/)() override | Devuelve el Identificador Uniforme de Recurso (URI) base del nodo actual. |
...
| [get_NotationName](./get_notationname/)() | Devuelve el nombre del atributo opcional NDATA en la declaración de entidad. |
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Para nodos [XmlEntity](./), este método no tiene efecto. |
| [WriteTo](./writeto/)(const SharedPtr\<XmlWriter\>\&) override | Guarda el nodo en el [XmlWriter](../xmlwriter/) especificado. Para nodos [XmlEntity](./), este método no tiene efecto. |
## Typedefs
