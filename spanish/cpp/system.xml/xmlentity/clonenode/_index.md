...
description: "System::Xml::XmlEntity::CloneNode método. Crea una duplicación de este nodo. Los nodos de entidad no pueden ser clonados. Llamar a este método sobre un objeto XmlEntity lanza una excepción en C++."
type: docs
weight: 100
...
Crea una duplicación de este nodo. Los nodos de entidad no pueden ser clonados. Llamar a este método sobre un objeto [XmlEntity](../) lanza una excepción.
