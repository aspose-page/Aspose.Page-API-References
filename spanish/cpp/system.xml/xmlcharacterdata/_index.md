...
description: "Clase System::Xml::XmlCharacterData. Proporciona métodos de manipulación de texto que son usados por varias clases en C++."
type: docs
weight: 900
...
| [get_InnerText](./get_innertext/)() override | Devuelve los valores concatenados del nodo y de todos los hijos del nodo. |
...
| [set_InnerText](./set_innertext/)(String) override | Establece los valores concatenados del nodo y de todos los hijos del nodo. |
