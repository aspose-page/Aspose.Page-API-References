---
title: "System::Xml::XmlWriterSettings clase"
linktitle: "XmlWriterSettings"
second_title: "Aspose.Page para C++"
description: "Clase System::Xml::XmlWriterSettings. Especifica un conjunto de características para admitir en el objeto XmlWriter creado por el método XmlWriter::Create en C++."
type: docs
weight: 4500
...
| [set_CheckCharacters](./set_checkcharacters/)(bool) | Establece un valor que indica si el escritor XML debe comprobar que todos los caracteres del documento cumplen con la sección "2.2 Characters" de la [Recomendación XML 1.0](https://www.w3.org/TR/REC-xml/#charsets) de la W3C. |
| [set_CloseOutput](./set_closeoutput/)(bool) | Establece un valor que indica si el [XmlWriter](../xmlwriter/) también debe cerrar el flujo subyacente o TextWriter cuando se llama al método [XmlWriter::Close](../xmlwriter/close/). |
