...
| Método | Descripción |
| --- | --- |
| [CloneNode](./clonenode/)(bool) override | Crea un duplicado de este nodo. Los nodos de notación no pueden clonarse. Llamar a este método en un objeto [XmlNotation](./) lanza una excepción. |
