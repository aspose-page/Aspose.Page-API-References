---
title: "Clase System::Xml::XmlElement"
linktitle: "XmlElement"
second_title: "Aspose.Page para C++"
description: "Clase System::Xml::XmlElement. Representa un elemento en C++."
type: docs
weight: 1700
...
| [get_InnerText](./get_innertext/)() override | Devuelve los valores concatenados del nodo y todos sus hijos. |
...
| [get_Prefix](./get_prefix/)() override | Devuelve el prefijo del espacio de nombres de este nodo. |
| [get_SchemaInfo](./get_schemainfo/)() override | Devuelve el conjunto de información posterior a la validación de esquema que se ha asignado a este nodo como resultado de la validación de esquema. |
...
| [RemoveAll](./removeall/)() override | Elimina todos los atributos y hijos especificados del nodo actual. Los atributos predeterminados no se eliminan. |
...
| virtual [RemoveAttribute](./removeattribute/)(String, String) | Elimina un atributo con el nombre local y el URI de espacio de nombres especificados. (Si el atributo eliminado tiene un valor predeterminado, se reemplaza inmediatamente). |
...
| virtual [RemoveAttributeNode](./removeattributenode/)(String, String) | Elimina el [XmlAttribute](../xmlattribute/) especificado por el nombre local y el URI de espacio de nombres. (Si el atributo eliminado tiene un valor predeterminado, se reemplaza inmediatamente). |
...
| virtual [SetAttribute](./setattribute/)(String, String, String) | Establece el valor del atributo con el nombre local y el URI de espacio de nombres especificados. |
