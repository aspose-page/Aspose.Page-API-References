...
Selecciona el primer [XmlNode](../) que coincide con la expresión [XPath](../../../system.xml.xpath/). Cualquier prefijo encontrado en la expresión [XPath](../../../system.xml.xpath/) se resuelve usando el [XmlNamespaceManager](../../xmlnamespacemanager/) suministrado.
