...
description: "Clase System::Xml::XmlNode. Representa un nodo único en el documento XML en C++."
type: docs
weight: 2500
...
Representa un solo nodo en el documento XML.
...
| virtual [get_BaseURI](./get_baseuri/)() | Devuelve el URI base del nodo actual. |
...
| virtual [get_InnerText](./get_innertext/)() | Devuelve los valores concatenados del nodo y de todos sus nodos hijos. |
...
| virtual [get_Prefix](./get_prefix/)() | Devuelve el prefijo del espacio de nombres de este nodo. |
...
| virtual [get_SchemaInfo](./get_schemainfo/)() | Devuelve el conjunto de información posterior a la validación de esquema que se ha asignado a este nodo como resultado de la validación de esquema. |
| virtual [get_Value](./get_value/)() | Devuelve el valor del nodo. |
| [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de los nodos hijos en el nodo actual. |
| virtual [GetNamespaceOfPrefix](./getnamespaceofprefix/)(String) | Busca la declaración **xmlns** más cercana para el prefijo dado que está en alcance del nodo actual y devuelve el URI del espacio de nombres en la declaración. |
| virtual [GetPrefixOfNamespace](./getprefixofnamespace/)(String) | Busca la declaración **xmlns** más cercana para el URI de espacio de nombres dado que está en alcance del nodo actual y devuelve el prefijo definido en esa declaración. |
...
| [SelectNodes](./selectnodes/)(const String\&, const SharedPtr\<XmlNamespaceManager\>\&) | Selecciona una lista de nodos que coinciden con la expresión [XPath](../../system.xml.xpath/). Cualquier prefijo encontrado en la expresión [XPath](../../system.xml.xpath/) se resuelve usando el [XmlNamespaceManager](../xmlnamespacemanager/) proporcionado. |
...
| [SelectSingleNode](./selectsinglenode/)(const String\&, const SharedPtr\<XmlNamespaceManager\>\&) | Selecciona el primer [XmlNode](./) que coincide con la expresión [XPath](../../system.xml.xpath/). Cualquier prefijo encontrado en la expresión [XPath](../../system.xml.xpath/) se resuelve usando el [XmlNamespaceManager](../xmlnamespacemanager/) proporcionado. |
...
| virtual [Supports](./supports/)(String, String) | Prueba si la implementación del DOM implementa una característica específica. |
