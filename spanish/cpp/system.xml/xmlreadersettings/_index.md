...
| [Clone](./clone/)() | Crea una copia de la instancia [XmlReaderSettings](./). |
...
| [get_DtdProcessing](./get_dtdprocessing/)() | Devuelve un valor que determina el procesamiento de DTDs. |
...
| [get_MaxCharactersFromEntities](./get_maxcharactersfromentities/)() | Devuelve un valor que indica el número máximo permitido de caracteres en un documento que resultan de expandir entidades. |
...
| [get_NameTable](./get_nametable/)() | Devuelve la [XmlNameTable](../xmlnametable/) utilizada para comparaciones de cadenas atomizadas. |
| [get_ProhibitDtd](./get_prohibitdtd/)() | Devuelve un valor que indica si se debe prohibir el procesamiento de definiciones de tipo de documento (DTD). |
| [get_Schemas](./get_schemas/)() | Devuelve el XmlSchemaSet que se debe usar al realizar la validación de esquemas. |
...
| [get_ValidationType](./get_validationtype/)() | Devuelve un valor que indica si el [XmlReader](../xmlreader/) realizará validación o asignación de tipo al leer. |
...
| [set_ConformanceLevel](./set_conformancelevel/)(System::Xml::ConformanceLevel) | Establece el nivel de conformidad al que el [XmlReader](../xmlreader/) se ajustará. |
| [set_DtdProcessing](./set_dtdprocessing/)(System::Xml::DtdProcessing) | Establece un valor que determina el procesamiento de DTDs. |
...
| [set_LinePositionOffset](./set_linepositionoffset/)(int32_t) | Establece el desplazamiento de la posición de línea del objeto [XmlReader](../xmlreader/). |
...
| [set_Schemas](./set_schemas/)(const SharedPtr\<Schema::XmlSchemaSet\>\&) | Establece el XmlSchemaSet que se debe usar al realizar la validación de esquemas. |
