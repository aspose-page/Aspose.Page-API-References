...
description: "System::Xml::XmlComment class. Representa el contenido de un comentario XML en C++."
type: docs
weight: 1100
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Debido a que los nodos de comentario no tienen hijos, este método no tiene efecto. |
