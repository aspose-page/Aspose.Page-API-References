---
title: "Clase System::Xml::XmlNamedNodeMap"
linktitle: "XmlNamedNodeMap"
second_title: "Aspose.Page para C++"
description: "Clase System::Xml::XmlNamedNodeMap. Representa una colección de nodos que pueden ser accedidos por nombre o índice en C++."
type: docs
weight: 2200
...
| virtual [get_Count](./get_count/)() | Devuelve el número de nodos en [XmlNamedNodeMap](./). |
| [GetEnumerator](./getenumerator/)() override | Proporciona soporte para la iteración sobre la colección de nodos en [XmlNamedNodeMap](./). |
...
| virtual [SetNamedItem](./setnameditem/)(SharedPtr\<XmlNode\>) | Añade un [XmlNode](../xmlnode/) usando su valor de [XmlNode::get_Name](../xmlnode/get_name/). |
## Typedefs
