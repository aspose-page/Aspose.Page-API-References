---
title: "System::Xml::XmlWriter::WriteRaw método"
linktitle: "WriteRaw"
second_title: "Aspose.Page para C++"
description: "System::Xml::XmlWriter::WriteRaw método. Cuando se sobrescribe en una clase derivada, escribe marcado sin procesar manualmente desde un búfer de caracteres en C++."
type: docs
weight: 2900
...
Cuando se sobrescribe en una clase derivada, escribe marcado sin procesar manualmente desde un buffer de caracteres.
...
| --- | --- | --- |
| búfer | ArrayPtr\<char16_t\> | Matriz de caracteres que contiene el texto a escribir. |
