...
description: "Clase System::Xml::XmlTextReader. Representa un lector que proporciona acceso rápido, sin caché y solo de avance a datos XML en C++."
type: docs
weight: 3900
...
| [get_NamespaceURI](./get_namespaceuri/)() override | Devuelve el URI del espacio de nombres (según lo definido en la especificación de espacios de nombres de W3C) del nodo en el que está posicionado el lector. |
...
| [get_Normalization](./get_normalization/)() | Devuelve un valor que indica si se debe normalizar los espacios en blanco y los valores de los atributos. |
...
| [get_WhitespaceHandling](./get_whitespacehandling/)() | Devuelve un valor que especifica cómo se manejan los espacios en blanco. |
...
| [ReadChars](./readchars/)(const ArrayPtr\<char16_t\>\&, int32_t, int32_t) | Lee el contenido de texto de un elemento en un búfer de caracteres. Este método está diseñado para leer flujos grandes de texto incrustado llamándolo sucesivamente. |
...
| [set_Normalization](./set_normalization/)(bool) | Establece un valor que indica si se normaliza el espacio en blanco y los valores de los atributos. |
...
| [XmlTextReader](./xmltextreader/)(const SharedPtr\<IO::Stream\>\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con el flujo y el [XmlNameTable](../xmlnametable/) especificados. |
| [XmlTextReader](./xmltextreader/)(const String\&, const SharedPtr\<IO::Stream\>\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con la URL, el flujo y el [XmlNameTable](../xmlnametable/) especificados. |
...
| [XmlTextReader](./xmltextreader/)(const SharedPtr\<IO::TextReader\>\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con el TextReader y el [XmlNameTable](../xmlnametable/) especificados. |
| [XmlTextReader](./xmltextreader/)(const String\&, const SharedPtr\<IO::TextReader\>\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con la URL, el TextReader y el [XmlNameTable](../xmlnametable/) especificados. |
| [XmlTextReader](./xmltextreader/)(const SharedPtr\<IO::Stream\>\&, XmlNodeType, const SharedPtr\<XmlParserContext\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con el flujo, el [XmlNodeType](../xmlnodetype/) y el [XmlParserContext](../xmlparsercontext/) especificados. |
| [XmlTextReader](./xmltextreader/)(const String\&, XmlNodeType, const SharedPtr\<XmlParserContext\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con la cadena, el [XmlNodeType](../xmlnodetype/) y el [XmlParserContext](../xmlparsercontext/) especificados. |
...
| [XmlTextReader](./xmltextreader/)(const String\&, const SharedPtr\<XmlNameTable\>\&) | Inicializa una nueva instancia de la clase [XmlTextReader](./) con el archivo y el [XmlNameTable](../xmlnametable/) especificados. |
## Typedefs
