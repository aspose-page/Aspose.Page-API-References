...
| --- | --- | --- |
| array | const ArrayPtr\<char16_t\>\& | La matriz de caracteres que contiene el nombre a buscar. |
...
La cadena atomizada o **nullptr** si la cadena aún no ha sido atomizada. Si **length** es cero, se devuelve [String::Empty](../../../system/string/empty/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| array | const String\& | El nombre a buscar. |
