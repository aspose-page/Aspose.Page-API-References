---
title: "System::Xml::XmlNameTable::Add método"
linktitle: "Add"
second_title: "Aspose.Page para C++"
description: "System::Xml::XmlNameTable::Add método. Cuando se sobrescribe en una clase derivada, atomiza la cadena especificada y la agrega a XmlNameTable en C++."
type: docs
weight: 100
...
Cuando se sobrescribe en una clase derivada, atomiza la cadena especificada y la agrega a la [XmlNameTable](../).
...
| --- | --- | --- |
| array | const ArrayPtr\<char16_t\>\& | La matriz de caracteres que contiene el nombre a agregar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| array | const String\& | El nombre a agregar. |
