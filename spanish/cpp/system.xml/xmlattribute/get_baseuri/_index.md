...
La ubicación desde la cual se cargó el nodo o [String::Empty](../../../system/string/empty/) si el nodo no tiene URI base. Los nodos [Attribute](../../../system/attribute/) tienen el mismo URI base que su elemento propietario. Si un nodo de atributo no tiene un elemento propietario, get_BaseURI devuelve [String::Empty](../../../system/string/empty/).
