...
| [get_SchemaInfo](./get_schemainfo/)() override | Devuelve el post-schema-validation-infoset que ha sido asignado a este nodo como resultado de la validación de esquema. |
