...
description: "System::Collections::BitArray::Enumerator clase. Tipo de enumerador para propósitos de iteración en C++."
type: docs
weight: 2900
...
| Método | Descripción |
| --- | --- |
| [Enumerator](./enumerator/)(const SharedPtr\<BitArray\>\&) | Crea enumerador. |
