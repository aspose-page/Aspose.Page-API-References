...
| static [BoxValue](./boxvalue/)(System::SharedPtr\<T\>) | Convirtiendo referencia de tipo en valor de objeto en objeto. |
...
| [get_Count](./get_count/)() const override | Implementación de los métodos [ICollection.get_Count()](../icollection/get_count/) Obtiene el número de elementos en la colección. |
...
| [Insert](./insert/)(int, System::SharedPtr\<System::Object\>) override | Inserta un elemento en la posición especificada, desplazando los demás elementos. |
