...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const TKey\&, const TValue\&) override | Agrega valor al diccionario. |
| [Clear](./clear/)() override | Elimina todos los elementos del contenedor. |
| [CopyTo](./copyto/)(ArrayPtr\<System::Collections::Generic::KeyValuePair\<TKey, TValue\>\>, int) override | Copia los elementos del contenedor a elementos existentes de una matriz. |
...
int main()
{
  ...
  // Cree la instancia de la clase ConcurrentDictionary.
