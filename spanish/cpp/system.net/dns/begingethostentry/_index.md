...
description: "System::Net::Dns::BeginGetHostEntry método. Inicia una operación asíncrona para crear una nueva instancia de la clase IPHostEntry usando la cadena especificada que contiene un nombre de host o una dirección IP en C++."
type: docs
weight: 300
...
| --- | --- | --- |
| hostNameOrAddress | String | La cadena que contiene un nombre de host o dirección IP. |
