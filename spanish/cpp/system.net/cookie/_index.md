---
title: "System::Net::Cookie clase"
linktitle: "Cookie"
second_title: "Aspose.Page para C++"
description: "System::Net::Cookie clase. Representa una cookie HTTP. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject() . Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento en C++."
type: docs
weight: 100
...
| [get_PortList](./get_portlist/)() const | Devuelve la colección de los valores del atributo 'Port'. |
| [get_Secure](./get_secure/)() const | Obtiene el valor del atributo 'Secure'. |
| [get_TimeStamp](./get_timestamp/)() const | Devuelve el momento en que se creó la cookie. |
...
| [ToServerString](./toserverstring/)() | Serializa la instancia actual a la representación de cadena. |
...
| [VerifySetDefaults](./verifysetdefaults/)(CookieVariant, System::SharedPtr\<Uri\>, bool, String, bool, bool) | Verifica y establece los valores del atributo predeterminado. |
## Campos
...
| static [MaxSupportedVersionString](./maxsupportedversionstring/) | La representación en cadena de la versión máxima admitida. |
...
| static [PortSplitDelimiters](./portsplitdelimiters/) | La matriz que contiene delimitadores para los valores del atributo 'Port'. |
