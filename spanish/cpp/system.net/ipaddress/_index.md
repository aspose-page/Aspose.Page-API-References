...
| static [TryParse](./tryparse/)(String, System::SharedPtr\<IPAddress\>\&) | Intenta convertir una cadena proporcionada a una instancia de la clase [IPAddress](./). |
## Campos

| Campo | Descripción |
| --- | --- |
| static [Any](./any/) | Información RTTI. |
| static [Broadcast](./broadcast/) | La dirección de difusión IPv4. |
| static [IPv6Any](./ipv6any/) | La dirección IPv6 que indica si el servidor debe escuchar todas las interfaces de red. |
| static [IPv6Loopback](./ipv6loopback/) | La dirección de loopback IPv6. |
| static [IPv6None](./ipv6none/) | La dirección IPv6 que indica si el servidor no debe escuchar ninguna interfaz de red. |
| static [Loopback](./loopback/) | La dirección de loopback IPv4. |
