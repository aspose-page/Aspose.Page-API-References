...
| [Remove](./remove/)(System::SharedPtr\<Uri\>, String) | Elimina las credenciales de red para el prefijo URI especificado y el tipo de autenticación. |
| [Remove](./remove/)(String, int32_t, String) | Elimina las credenciales de red para el nombre de host, puerto y tipo de autenticación especificados. |
## Ver también
