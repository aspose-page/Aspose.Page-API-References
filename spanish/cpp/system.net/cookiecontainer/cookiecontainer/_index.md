...
description: "System::Net::CookieContainer::CookieContainer constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net/cookiecontainer/cookiecontainer/
---
...
| --- | --- | --- |
| capacidad | int32_t | La capacidad de la colección. |
...
| --- | --- | --- |
| capacidad | int32_t | La capacidad de la colección. |
| perDomainCapacity | int32_t | La capacidad de la colección por dominio. |
| maxCookieSize | int32_t | El tamaño máximo de la cookie. |
