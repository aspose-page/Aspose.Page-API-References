...
| Método | Descripción |
| --- | --- |
| virtual [Abort](./abort/)() | Cancela la solicitud actual. |
| virtual [BeginGetRequestStream](./begingetrequeststream/)(AsyncCallback, System::SharedPtr\<Object\>) | Inicia una operación asincrónica para obtener un flujo para escribir datos en el recurso. |
| virtual [BeginGetResponse](./begingetresponse/)(AsyncCallback, System::SharedPtr\<Object\>) | Inicia una solicitud asincrónica para el recurso. |
...
| virtual [EndGetRequestStream](./endgetrequeststream/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la operación asincrónica especificada para obtener un flujo se complete. |
| virtual [EndGetResponse](./endgetresponse/)(System::SharedPtr\<IAsyncResult\>) | Espera hasta que la solicitud asincrónica especificada para el recurso se complete. |
...
| virtual [get_ContentLength](./get_contentlength/)() | Obtiene el número de bytes de los datos de la solicitud a enviar. |
...
| virtual [set_Headers](./set_headers/)(System::SharedPtr\<WebHeaderCollection\>) | Establece la colección de los encabezados HTTP. |
