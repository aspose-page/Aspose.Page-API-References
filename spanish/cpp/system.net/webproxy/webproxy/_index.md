---
title: "Constructor System::Net::WebProxy::WebProxy"
linktitle: "WebProxy"
second_title: "Aspose.Page para C++"
description: "Constructor System::Net::WebProxy::WebProxy. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net/webproxy/webproxy/
---
...
| --- | --- | --- |
| Dirección | String | La dirección del servidor proxy. |
...
| Dirección | String | La dirección del servidor proxy. |
| BypassOnLocal | bool | Un valor que indica si el servidor proxy debe usarse para direcciones locales. |
| BypassList | System::ArrayPtr\<String\> | La lista de direcciones que no utilizan el servidor proxy. |
...
| BypassOnLocal | bool | Un valor que indica si el servidor proxy debe usarse para direcciones locales. |
| BypassList | System::ArrayPtr\<String\> | La lista de direcciones que no utilizan el servidor proxy. |
| Credenciales | System::SharedPtr\<ICredentials\> | Las credenciales que se envían al servidor proxy para autenticación. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| Dirección | System::SharedPtr\<Uri\> | La dirección del servidor proxy. |
