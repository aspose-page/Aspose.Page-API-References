...
| virtual [set_Credentials](./set_credentials/)(System::SharedPtr\<ICredentials\>) | Establece las credenciales que se envían al servidor proxy para la autenticación. |
