---
title: "Constructor System::Drawing::Font::Font"
linktitle: "Fuente"
second_title: "Aspose.Page para C++"
description: "Constructor System::Drawing::Font::Font. Construye una nueva instancia de la clase Font que representa la fuente existente especificada con el estilo de fuente especificado en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| prototipo | const SharedPtr\<Font\>\& | La fuente existente de la cual crear la nueva |
...
| unidad | GraphicsUnit | Las unidades de medida de la nueva fuente |
| gdi_charset | uint8_t | Un conjunto de caracteres GDI que se utilizará para la nueva fuente |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| family_name | const String\& | El nombre de la familia tipográfica de la nueva fuente |
| em_size | float | El tamaño em de la nueva fuente en las unidades especificadas por el parámetro **unit** |
| estilo | FontStyle | El estilo de la nueva fuente |
| unidad | GraphicsUnit | Las unidades de medida de la nueva fuente |
| gdi_charset | uint8_t | Un conjunto de caracteres GDI que se utilizará para la nueva fuente |
