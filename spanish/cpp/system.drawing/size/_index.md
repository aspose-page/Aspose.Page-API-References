...
description: "Clase System::Drawing::Size. Representa un par de valores enteros que representan el ancho y la altura de una imagen. Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 2200
...
| static [Truncate](./truncate/)(const SizeF\&) | Construye un objeto [Size](./) a partir del objeto [SizeF](../sizef/) especificado truncando los valores de ancho y altura del objeto [SizeF](../sizef/) al siguiente entero inferior. |
## Campos

| Campo | Descripción |
| --- | --- |
| static [Empty](./empty/) | Una instancia vacía de la clase [Size](./) cuyos valores de ancho y altura son 0. |
## Ver también
