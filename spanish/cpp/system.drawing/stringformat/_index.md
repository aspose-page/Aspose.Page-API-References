...
| [get_DigitSubstitutionLanguage](./get_digitsubstitutionlanguage/)() const | Devuelve un valor que indica el idioma que se usa cuando los dígitos locales se sustituyen por dígitos occidentales. |
...
| [GetTabStops](./gettabstops/)(float\&) const | Devuelve los tabuladores para el objeto [StringFormat](./) actual. |
