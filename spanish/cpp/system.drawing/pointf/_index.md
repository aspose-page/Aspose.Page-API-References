...
description: "Clase System::Drawing::PointF. Representa un par de coordenadas X e Y de punto de precisión simple en un plano bidimensional. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca utilice la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 1800
...
Representa un par de coordenadas X e Y de punto de precisión simple en un plano bidimensional. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca utilice la clase [System::SmartPtr](../../system/smartptr/) para gestionar objetos de este tipo.
...
| Método | Descripción |
| --- | --- |
| static [Add](./add/)(const PointF\&, const SizeF\&) | Añade los valores de ancho y alto del objeto [SizeF](../sizef/) especificado a los valores de coordenadas X e Y del objeto [PointF](./) especificado, respectivamente. |
| static [Add](./add/)(const PointF\&, const Size\&) | Añade los valores de ancho y alto del objeto [Size](../size/) especificado a los valores de coordenadas X e Y del objeto [PointF](./) especificado, respectivamente. |
...
| [PointF](./pointf/)(const SizeF\&) | Construye un nuevo objeto [PointF](./) y inicializa sus valores de coordenadas X e Y con los valores de ancho y alto del objeto [SizeF](../sizef/) especificado, respectivamente. |
