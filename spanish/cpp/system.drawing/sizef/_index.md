...
description: "Clase System::Drawing::SizeF. Representa un par de valores de punto flotante de precisión simple que representan el ancho y la altura de una imagen. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo en C++."
type: docs
weight: 2300
...
Representa un par de valores de punto flotante de precisión simple que representan el ancho y la altura de una imagen. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](../../system/smartptr/) para gestionar objetos de este tipo.
...
| [ToSize](./tosize/)() const | Construye un objeto [Size](../size/) a partir del objeto [SizeF](./) actual truncando los valores de ancho y altura del objeto [SizeF](./) a los valores enteros inferiores más próximos. |
