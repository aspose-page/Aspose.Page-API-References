---
title: "Constructor System::Drawing::Region::Region"
linktitle: "Region"
second_title: "Aspose.Page para C++"
description: "Constructor System::Drawing::Region::Region. Construye una nueva instancia de la clase Region en C++."
type: docs
weight: 100
url: /es/cpp/system.drawing/region/region/
---
...
| --- | --- | --- |
| rect | const Rectangle\\& | Un rectángulo que define la región |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rect | const RectangleF\& | Un rectángulo que define la región |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ruta | const SharedPtr\<Drawing2D::GraphicsPath\>\& | Una ruta que define la región |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| region_data | const SharedPtr\<Drawing2D::RegionData\>\& | Un objeto RegionData que define la región |
