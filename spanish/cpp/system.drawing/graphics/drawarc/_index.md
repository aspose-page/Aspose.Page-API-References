---
title: "Método System::Drawing::Graphics::DrawArc"
linktitle: "DrawArc"
second_title: "Aspose.Page para C++"
description: "Método System::Drawing::Graphics::DrawArc. Dibuja el arco especificado usando la pluma especificada en la superficie representada por el objeto actual en C++."
type: docs
weight: 1000
url: /es/cpp/system.drawing/graphics/drawarc/
---
## Graphics::DrawArc(const SharedPtr\<Pen\>\&, float, float, float, float, float, float) method


Dibuja el arco especificado usando la pluma especificada en la superficie representada por el objeto actual.
...
| --- | --- | --- |
| pluma | const SharedPtr\<Pen\>\& | Una pluma para usar al dibujar el arco |
...
| ancho | float | El ancho del rectángulo que define la elipse |
| alto | float | La altura del rectángulo que define la elipse |
| startAngle | float | Ángulo en grados medido en sentido horario desde el eje X hasta el punto inicial del arco |
| sweepAngle | float | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del arco |
...
| ancho | int32_t | El ancho del rectángulo que define la elipse |
| alto | int32_t | La altura del rectángulo que define la elipse |
| startAngle | int32_t | Ángulo en grados medido en sentido horario desde el eje X hasta el punto inicial del arco |
| sweepAngle | int32_t | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del arco |
...
| --- | --- | --- |
| pluma | const SharedPtr\<Pen\>\& | Una pluma para usar al dibujar el arco |
| rect | Rectángulo | El rectángulo que define la elipse |
| startAngle | float | Ángulo en grados medido en sentido horario desde el eje X hasta el punto inicial del arco |
| sweepAngle | float | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del arco |
...
| --- | --- | --- |
| pluma | const SharedPtr\<Pen\>\& | Una pluma para usar al dibujar el arco |
| rect | RectangleF | El rectángulo que define la elipse |
| startAngle | float | Ángulo en grados medido en sentido horario desde el eje X hasta el punto inicial del arco |
| sweepAngle | float | Ángulo en grados medido en sentido horario desde el **startAngle** hasta el punto final del arco |
