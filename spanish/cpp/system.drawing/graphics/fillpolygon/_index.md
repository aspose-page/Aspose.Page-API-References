---
title: "Método System::Drawing::Graphics::FillPolygon"
linktitle: "FillPolygon"
second_title: "Aspose.Page para C++"
description: "System::Drawing::Graphics::FillPolygon method. Rellena los interiores del polígono especificado usando el pincel especificado en C++."
type: docs
weight: 3600
url: /es/cpp/system.drawing/graphics/fillpolygon/
---
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Un objeto [Brush](../../brush/) que especifica los parámetros del relleno |
| puntos | const ArrayPtr\<Point\>\& | Una matriz que contiene los puntos que definen el polígono |
| fillMode | Drawing2D::FillMode | El modo de relleno |
...
| --- | --- | --- |
| brush | const SharedPtr\<Brush\>\& | Un objeto [Brush](../../brush/) que especifica los parámetros del relleno |
| puntos | const ArrayPtr\<PointF\>\& | Una matriz que contiene los puntos que definen el polígono |
| fillMode | Drawing2D::FillMode | El modo de relleno |
