...
| [BeginContainer](./begincontainer/)() | Guarda un contenedor con el estado actual de este objeto, abre y utiliza un nuevo contenedor y devuelve el contenedor guardado. |
| [BeginContainer](./begincontainer/)(Rectangle, Rectangle, GraphicsUnit) | Guarda un contenedor con el estado actual de este objeto, abre y utiliza un nuevo contenedor y devuelve el contenedor guardado. |
| [BeginContainer](./begincontainer/)(RectangleF, RectangleF, GraphicsUnit) | Guarda un contenedor con el estado actual de este objeto, abre y utiliza un nuevo contenedor y devuelve el contenedor guardado. |
...
| [get_SmoothingMode](./get_smoothingmode/)() | Devuelve un valor que indica un modo suavizante utilizado durante el renderizado en la superficie representada por el objeto actual. |
...
| [Restore](./restore/)(const SharedPtr\<Drawing2D::GraphicsState\>\&) | Restaura el estado de este objeto a partir del estado guardado. |
...
| [set_PageUnit](./set_pageunit/)(GraphicsUnit) | Establece las unidades de medida utilizadas para las coordenadas de página en la superficie representada por el objeto actual. |
| [set_PixelOffsetMode](./set_pixeloffsetmode/)(Drawing2D::PixelOffsetMode) | Establece un valor que especifica cómo deben desplazarse los píxeles durante el renderizado en la superficie representada por el objeto actual. |
| [set_RenderingOrigin](./set_renderingorigin/)(Point) | Establece un objeto [Point](../point/) que especifica el origen de renderizado del objeto [Graphics](./) actual para tramado y para pinceles de trama. |
