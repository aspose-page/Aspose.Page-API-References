---
title: "Método System::Drawing::Graphics::DrawImageUnscaled"
linktitle: "DrawImageUnscaled"
second_title: "Aspose.Page para C++"
description: "Método System::Drawing::Graphics::DrawImageUnscaled. Dibuja una imagen especificada usando su tamaño físico original en una ubicación especificada en C++."
type: docs
weight: 1900
url: /es/cpp/system.drawing/graphics/drawimageunscaled/
---
...
| point | const Point\& | La estructura [Point](../../point/) que especifica la esquina superior izquierda de la imagen dibujada. |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| rect | const Rectangle\\& | El rectángulo que especifica la esquina superior izquierda de la imagen dibujada. Las propiedades X y Y del rectángulo especifican la esquina superior izquierda. Los valores de ancho y alto se ignoran. |
