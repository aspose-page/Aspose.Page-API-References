---
title: "Método System::Drawing::Graphics::DrawImage"
linktitle: "DrawImage"
second_title: "Aspose.Page para C++"
description: "Método System::Drawing::Graphics::DrawImage. NO IMPLEMENTADO en C++."
type: docs
weight: 1800
url: /es/cpp/system.drawing/graphics/drawimage/
---
...
Dibuja la región especificada de la imagen especificada en la ubicación especificada.
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const ArrayPtr\<Point\>\& | Una matriz que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde se dibujará la imagen |
| srcRect | Rectángulo | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imageAttr | const SharedPtr\<Imaging::ImageAttributes\>\& | Especifica la información de color y gamma para la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| rect | const Rectangle\\& | Un rectángulo donde dibujar la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| rect | const RectangleF\& | Un rectángulo donde dibujar la imagen |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | IGNORED |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const System::ArrayPtr\<PointF\>\& | Una matriz que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde se dibujará la imagen |
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Especifica la información de color y gamma para la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const System::Details::ArrayView\<PointF\>\& | Una vista de matriz que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde dibujar la imagen |
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Especifica la información de color y gamma para la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destPoints | const System::Details::StackArray\<PointF, N\>\& | Una matriz de pila que contiene tres puntos que definen un paralelogramo en la superficie de dibujo donde dibujar la imagen |
| srcRect | const RectangleF\& | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
| imgAttributes | const Imaging::ImageAttributesPtr\& | Especifica la información de color y gamma para la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| x | float | La coordenada X de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| y | float | La coordenada Y de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| ancho | float | El ancho de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| alto | float | La altura de la esquina superior izquierda del rectángulo donde dibujar la imagen |
...
| x | float | La coordenada X de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| y | float | La coordenada Y de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| srcRect | RectangleF | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| x | int | La coordenada X de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| y | int | La coordenada Y de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| ancho | int | El ancho de la esquina superior izquierda del rectángulo donde dibujar la imagen |
| alto | int | La altura de la esquina superior izquierda del rectángulo donde dibujar la imagen |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| pt | Punto | La ubicación de la esquina superior izquierda de la imagen dibujada |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| pt | PointF | La ubicación de la esquina superior izquierda de la imagen dibujada |
...
Dibuja la región especificada de la imagen especificada en el rectángulo especificado.
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destRect | Rectángulo | Un rectángulo donde dibujar la imagen |
...
| srcUnit | GraphicsUnit | Las unidades de medida en las que se especifican los parámetros **srcX**, **srcY**, **srcWidth** y **srcHeight** |
...
| --- | --- | --- |
| imagen | const SharedPtr\<Image\>\& | La imagen a dibujar |
| destRect | RectangleF | Un rectángulo donde dibujar la imagen |
| srcRect | RectangleF | Un rectángulo que define la región de la imagen especificada para dibujar |
| srcUnit | GraphicsUnit | Las unidades de medida utilizadas por el parámetro **srcRect** |
