---
title: "Método System::Drawing::Image::Save"
linktitle: "Save"
second_title: "Aspose.Page para C++"
description: "Método System::Drawing::Image::Save. Guarda la imagen representada por el objeto actual en el flujo especificado usando el codificador y los parámetros del codificador especificados en C++."
type: docs
weight: 2200
...
Guarda la imagen representada por el objeto actual en el flujo especificado utilizando el codificador y los parámetros del codificador especificados.
...
| --- | --- | --- |
| flujo | const SharedPtr\<System::IO::Stream\>\& | Un flujo donde guardar la imagen |
| codificador | const Imaging::ImageCodecInfoPtr\& | El codificador a usar |
...
Guarda la imagen representada por el objeto actual en el archivo especificado utilizando el codificador y los parámetros del codificador especificados.
