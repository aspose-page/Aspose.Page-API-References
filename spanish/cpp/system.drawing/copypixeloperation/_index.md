...
| SourceErase | 4457256 | Los colores invertidos de la región de destino están ANDed con los colores de la región de origen. |
| DestinationInvert | 5570569 | La región de destino está invertida. |
| PatInvert | 5898313 | Los colores del pincel actualmente seleccionado en el contexto de dispositivo de destino se XORed con los colores del destino. |
| SourceInvert | 6684742 | Los colores de las regiones de origen y destino se XORed. |
| SourceAnd | 8913094 | Los colores de las regiones de origen y destino se ANDed. |
| MergePaint | 12255782 | Los colores de la región de origen invertida se ORed con los colores de la región de destino. |
| MergeCopy | 12583114 | Los colores de la región de origen se ANDed con los colores del pincel seleccionado del contexto de dispositivo de destino. |
| SourceCopy | 13369376 | La región de origen se copia directamente a la región de destino. |
| SourcePaint | 15597702 | Los colores de las regiones de origen y destino se combinan con OR. |
...
| PatPaint | 16452105 | Los colores del pincel actualmente seleccionado en el contexto de dispositivo de destino se combinan con OR con los colores de la región de origen invertida. El resultado de esta operación se combina con OR con los colores de la región de destino. |
| Blancura | 16711778 | La región de destino se rellena usando el color con índice 1 en la paleta física. |
