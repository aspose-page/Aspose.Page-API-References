...
description: "System::Drawing::Bitmap::Bitmap constructor. Construye un nuevo objeto Bitmap a partir de la imagen existente especificada en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| original | const SharedPtr\<Image\>\& | La imagen existente a partir de la cual crear la imagen bitmap |
...
| alto | int | Altura de la nueva imagen |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filename | const String\& | El nombre del archivo que contiene datos de imagen |
