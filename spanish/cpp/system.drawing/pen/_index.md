...
| [get_Brush](./get_brush/)() | Devuelve el objeto [Brush](../brush/) de esta pluma. |
| [get_Color](./get_color/)() const | Devuelve el color de esta pluma. |
...
| [get_MiterLimit](./get_miterlimit/)() const | Devuelve el límite del grosor de la unión en una esquina en ángulo. |
