---
title: "Clase System::Globalization::Calendar"
linktitle: "Calendario"
second_title: "Aspose.Page para C++"
description: "Clase System::Globalization::Calendar. Calendario que define cómo se manejan, calculan, formatean, etc., las fechas. Las operaciones de establecimiento solo están habilitadas en objetos que no son de solo lectura. Los objetos de esta clase deben asignarse únicamente mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento en C++."
type: docs
weight: 100
...
| Método | Descripción |
| --- | --- |
| virtual [AddDays](./adddays/)(DateTime, int) const | Añade días al punto de tiempo. |
| virtual [AddHours](./addhours/)(DateTime, int) const | Añade horas al punto de tiempo. |
| virtual [AddMilliseconds](./addmilliseconds/)(DateTime, double) const | Añade milisegundos al punto de tiempo. |
| virtual [AddMinutes](./addminutes/)(DateTime, int) const | Añade minutos al punto de tiempo. |
| virtual [AddMonths](./addmonths/)(DateTime, int) const | Añade meses al punto de tiempo. |
| virtual [AddSeconds](./addseconds/)(DateTime, int) const | Añade segundos al punto de tiempo. |
| virtual [AddWeeks](./addweeks/)(DateTime, int) const | Añade semanas al punto de tiempo. |
| virtual [AddYears](./addyears/)(DateTime, int) const | Añade años al punto de tiempo. |
...
| [get_IsReadOnly](./get_isreadonly/)() const | Comprueba si el calendario es de solo lectura. |
| virtual [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const | Punto máximo en el tiempo que admite el calendario. |
| virtual [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const | Punto mínimo en el tiempo que admite el calendario. |
...
| virtual [GetLeapMonth](./getleapmonth/)(int, int) const | Obtiene el mes bisiesto para el año especificado. |
...
| virtual [IsLeapMonth](./isleapmonth/)(int, int, int) const | Comprueba si el mes es bisiesto. |
...
| [IsValidDay](./isvalidday/)(int, int, int, int) const | Comprueba los valores de año, mes, día y era. |
...
| virtual [ToDateTime](./todatetime/)(int, int, int, int, int, int, int, int) const | Construye el objeto [DateTime](../../system/datetime/) a partir de los componentes. |
