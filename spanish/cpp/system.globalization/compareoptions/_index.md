...
| IgnoreNonSpace | 2 | Ignorar caracteres combinantes sin espacio, p. ej. diacríticos. |
| IgnoreSymbols | 4 | Incluir espacios en blanco, signos de puntuación, etc. |
| IgnoreKanaType | 8 | Ignorar tipo kana (japonés). |
| IgnoreWidth | 16 | Ignorar la anchura de los caracteres al comparar cadenas. |
...
| Ordinal | 1073741824 | Compare los códigos UTF directamente para la primera comparación. |
