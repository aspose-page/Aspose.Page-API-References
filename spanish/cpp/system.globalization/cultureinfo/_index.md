...
| [get_CultureTypes](./get_culturetypes/)() const | Obtiene la unión bit a bit de los tipos de cultura que describen la cultura actual. |
...
| virtual [get_LCID](./get_lcid/)() const | Obtiene el identificador de cultura. |
...
| virtual [get_NumberFormat](./get_numberformat/)() const | Obtiene la información de formato numérico. |
...
| static [GetCultureInfo](./getcultureinfo/)(int32_t) | Obtiene la cultura por su ID. |
...
| [IsInherited](./isinherited/)() const | Obtiene la bandera de herencia. PARA USO INTERNO. |
...
| virtual [set_DateTimeFormat](./set_datetimeformat/)(DateTimeFormatInfoPtr) | Establece la información del formato de fecha. |
...
| static [set_DefaultThreadCurrentUICulture](./set_defaultthreadcurrentuiculture/)(const CultureInfoPtr\&) | Establece la cultura de UI predeterminada en el dominio de aplicación actual. |
| virtual [set_NumberFormat](./set_numberformat/)(NumberFormatInfoPtr) | Obtiene la información de formato numérico. |
