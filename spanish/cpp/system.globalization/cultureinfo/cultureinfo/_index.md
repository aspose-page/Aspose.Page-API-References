...
description: "System::Globalization::CultureInfo::CultureInfo constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.globalization/cultureinfo/cultureinfo/
---
...
| --- | --- | --- |
| name | const String\& | Nombre de la cultura. |
| use_user_override | bool | Si true, use valores definidos por el usuario en lugar de los del sistema; PARAMETER IGNORED. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cultura | int | Identificador de cultura. |
## Observaciones
