...
| --- | --- | --- |
| fallbackResolver | const SharedPtr\<XmlResolver\>\& | El [XmlResolver](../../../system.xml/xmlresolver/) o tu propio resolvedor. |
| preloadedDtds | XmlKnownDtds | Los DTD bien conocidos que deben precargarse en la caché. |
...
Inicializa una nueva instancia de la clase [XmlPreloadedResolver](../) con el resolvedor de respaldo especificado, los DTD bien conocidos precargados y el comparador de igualdad de URI.
...
| fallbackResolver | const SharedPtr\<XmlResolver\>\& | El [XmlResolver](../../../system.xml/xmlresolver/) o tu propio resolvedor. |
| preloadedDtds | XmlKnownDtds | Los DTD bien conocidos que deben precargarse en la caché. |
| uriComparer | const SharedPtr\<Collections::Generic::IEqualityComparer\<SharedPtr\<Uri\>\>\>\& | La implementación de la interfaz IEqualityComparer que se usa al comparar URIs. |
