...
description: "System::Xml::Schema::XmlSchemaSimpleContentRestriction::get_BaseType método. Devuelve el valor base del tipo simple en C++."
type: docs
weight: 400
url: /es/cpp/system.xml.schema/xmlschemasimplecontentrestriction/get_basetype/
---
## XmlSchemaSimpleContentRestriction::get_BaseType method


Devuelve el valor base del tipo simple.
