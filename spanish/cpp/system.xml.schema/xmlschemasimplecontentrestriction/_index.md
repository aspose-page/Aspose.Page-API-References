...
| Método | Descripción |
| --- | --- |
| [get_AnyAttribute](./get_anyattribute/)() | Devuelve un [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) que se utilizará para el valor del atributo. |
