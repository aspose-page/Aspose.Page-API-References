...
description: "Clase System::Xml::Schema::XmlSchemaSimpleTypeRestriction. Representa el elemento restriction para tipos simples de XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Esta clase puede usarse para restringir el elemento simpleType en C++."
type: docs
weight: 6500
...
Representa el elemento **restriction** para tipos simples de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para restringir el elemento **simpleType**.
