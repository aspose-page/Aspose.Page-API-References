...
Compila el Modelo [Schema](../../)[Object](../../../system/object/) XML (SOM) en información de esquema para validación. Se utiliza para comprobar la estructura sintáctica y semántica del SOM construido programáticamente. La verificación de validación semántica se realiza durante la compilación.
