...
description: "System::Xml::Schema::XmlSchemaValidator clase. Representa un motor de validación de esquemas de XML Schema Definition Language (XSD). La clase XmlSchemaValidator no puede heredarse en C++."
type: docs
weight: 7000
...
Representa un motor de validación de XML [Schema](../) Definition Language (XSD) [Schema](../). La clase [XmlSchemaValidator](./) no puede heredarse.
...
| Método | Descripción |
| --- | --- |
| [AddSchema](./addschema/)(const SharedPtr\<XmlSchema\>\&) | Añade un esquema XML [Schema](../) Definition Language (XSD) al conjunto de esquemas utilizados para la validación. |
...
| [GetUnspecifiedDefaultAttributes](./getunspecifieddefaultattributes/)(const SharedPtr\<Collections::Generic::List\<SharedPtr\<Object\>\>\>\&) | Valida las restricciones de identidad en los atributos predeterminados y rellena la lista especificada con objetos [XmlSchemaAttribute](../xmlschemaattribute/) para cualquier atributo con valores predeterminados que no haya sido validado previamente mediante el método [XmlSchemaValidator::ValidateAttribute](./validateattribute/) en el contexto del elemento. |
| [Initialize](./initialize/)() | Inicializa el estado del objeto [XmlSchemaValidator](./). |
| [Initialize](./initialize/)(const SharedPtr\<XmlSchemaObject\>\&) | Inicializa el estado del objeto [XmlSchemaValidator](./) usando el [XmlSchemaObject](../xmlschemaobject/) especificado para la validación parcial. |
...
| [SkipToEndElement](./skiptoendelement/)(const SharedPtr\<XmlSchemaInfo\>\&) | Omite la validación del contenido del elemento actual y prepara el objeto [XmlSchemaValidator](./) para validar el contenido en el contexto del elemento padre. |
...
| [ValidateText](./validatetext/)(const String\&) | Valida si el texto **string** especificado está permitido en el contexto del elemento actual, y acumula el texto para su validación si el elemento actual tiene contenido simple. |
| [ValidateText](./validatetext/)(XmlValueGetter) | Valida si el texto devuelto por el objeto [XmlValueGetter](../xmlvaluegetter/) especificado está permitido en el contexto del elemento actual, y acumula el texto para su validación si el elemento actual tiene contenido simple. |
| [ValidateWhitespace](./validatewhitespace/)(const String\&) | Valida si el espacio en blanco en la **string** especificada está permitido en el contexto del elemento actual, y acumula el espacio en blanco para su validación si el elemento actual tiene contenido simple. |
| [ValidateWhitespace](./validatewhitespace/)(XmlValueGetter) | Valida si el espacio en blanco devuelto por el objeto [XmlValueGetter](../xmlvaluegetter/) especificado está permitido en el contexto del elemento actual, y acumula el espacio en blanco para su validación si el elemento actual tiene contenido simple. |
