...
description: "System::Xml::Schema::XmlSchemaValidator::GetUnspecifiedDefaultAttributes método. Valida las restricciones de identidad en los atributos predeterminados y rellena la List especificada con objetos XmlSchemaAttribute para cualquier atributo con valores predeterminados que no haya sido previamente validado usando el método XmlSchemaValidator::ValidateAttribute en el contexto del elemento en C++."
type: docs
weight: 900
...
| --- | --- | --- |
| defaultAttributes | const SharedPtr\<Collections::Generic::List\<SharedPtr\<Object\>\>\>\& | Una List para rellenar con objetos [XmlSchemaAttribute](../../xmlschemaattribute/) para cualquier atributo que aún no se haya encontrado durante la validación en el contexto del elemento. |
