---
title: "Método System::Xml::Schema::XmlSchemaSet::Add"
linktitle: "Add"
second_title: "Aspose.Page para C++"
description: "Método System::Xml::Schema::XmlSchemaSet::Add. Añade el XmlSchema proporcionado al XmlSchemaSet en C++."
type: docs
weight: 200
...
Añade todos los esquemas del lenguaje de definición XML [Schema](../../) (XSD) en el [XmlSchemaSet](../) proporcionado al [XmlSchemaSet](../).
...
Añade el esquema del lenguaje de definición XML [Schema](../../) (XSD) contenido en el [XmlReader](../../../system.xml/xmlreader/) al [XmlSchemaSet](../).
...
Añade el esquema del lenguaje de definición XML [Schema](../../) (XSD) en la URL especificada al [XmlSchemaSet](../).
