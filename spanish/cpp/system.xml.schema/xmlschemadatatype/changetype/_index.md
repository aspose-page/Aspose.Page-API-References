---
title: "Método System::Xml::Schema::XmlSchemaDatatype::ChangeType"
linktitle: "ChangeType"
second_title: "Aspose.Page para C++"
description: "Método System::Xml::Schema::XmlSchemaDatatype::ChangeType. Convierte el valor especificado, cuyo tipo es una de las representaciones válidas del tipo de esquema XML representado por el XmlSchemaDatatype, al tipo de tiempo de ejecución especificado en C++."
type: docs
weight: 100
...
| --- | --- | --- |
| value | SharedPtr\<Object\> | El valor de entrada a convertir al tipo especificado. |
...
| value | SharedPtr\<Object\> | El valor de entrada a convertir al tipo especificado. |
| targetType | const TypeInfo\& | El tipo de destino al que convertir el valor de entrada. |
| namespaceResolver | SharedPtr\<IXmlNamespaceResolver\> | Un [IXmlNamespaceResolver](../../../system.xml/ixmlnamespaceresolver/) utilizado para resolver prefijos de espacio de nombres. Sólo es útil si el [XmlSchemaDatatype](../) representa el tipo **xs:QName** o un tipo derivado de él. |
