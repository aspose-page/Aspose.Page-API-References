...
description: "System::Xml::Schema::XmlSchemaAttribute class. Representa el elemento attribute del XML Schema según lo especificado por el World Wide Web Consortium (W3C). Los atributos proporcionan información adicional para otros elementos del documento. La etiqueta attribute se anida entre las etiquetas del elemento de un documento para el esquema. El documento XML muestra los atributos como elementos nombrados en la etiqueta de apertura de un elemento en C++."
type: docs
weight: 1100
...
Representa el elemento **attribute** del XML [Schema](../) según lo especificado por el World Wide [Web](../../system.web/) Consortium (W3C). Los atributos proporcionan información adicional para otros elementos del documento. La etiqueta attribute se anida entre las etiquetas del elemento de un documento para el esquema. El documento XML muestra los atributos como elementos nombrados en la etiqueta de apertura de un elemento.
