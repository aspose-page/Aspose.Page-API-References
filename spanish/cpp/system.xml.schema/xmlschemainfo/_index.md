---
title: "System::Xml::Schema::XmlSchemaInfo clase"
linktitle: "XmlSchemaInfo"
second_title: "Aspose.Page para C++"
description: "System::Xml::Schema::XmlSchemaInfo clase. Representa el conjunto de información posterior a la validación de esquema de un nodo XML validado en C++."
type: docs
weight: 3800
...
| [get_IsDefault](./get_isdefault/)() override | Devuelve un valor que indica si este nodo XML validado se estableció como resultado de la aplicación de un valor predeterminado durante la validación del esquema XML [Schema](../) Definition Language (XSD). |
...
| [get_SchemaType](./get_schematype/)() override | Devuelve el tipo de esquema estático XML [Schema](../) Definition Language (XSD) de este nodo XML validado. |
...
| [set_IsDefault](./set_isdefault/)(bool) | Establece un valor que indica si este nodo XML validado se estableció como resultado de una configuración predeterminada aplicada durante la validación del esquema XML [Schema](../) Definition Language (XSD). |
...
| [set_SchemaType](./set_schematype/)(const SharedPtr\<XmlSchemaType\>\&) | Establece el tipo de esquema estático XML [Schema](../) Definition Language (XSD) de este nodo XML validado. |
