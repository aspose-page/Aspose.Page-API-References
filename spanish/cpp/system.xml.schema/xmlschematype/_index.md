---
title: "System::Xml::Schema::XmlSchemaType clase"
linktitle: "XmlSchemaType"
second_title: "Aspose.Page para C++"
description: "System::Xml::Schema::XmlSchemaType clase. La clase base para todos los tipos simples y tipos complejos en C++."
type: docs
weight: 6800
...
| Método | Descripción |
| --- | --- |
| [get_BaseSchemaType](./get_baseschematype/)() | Devuelve el tipo de objeto post-compilación o el tipo de datos incorporado XML [Schema](../) Lenguaje de Definición (XSD), elemento simpleType o elemento complexType. Este es un valor de conjunto de información post-compilación de esquema. |
| [get_BaseXmlSchemaType](./get_basexmlschematype/)() | Devuelve el valor post-compilación para el tipo base de este tipo de esquema. |
| [get_Datatype](./get_datatype/)() | Devuelve el valor post-compilación para el tipo de datos del tipo complejo. |
| [get_DerivedBy](./get_derivedby/)() | Devuelve la información post-compilación sobre cómo se derivó este elemento de su tipo base. |
| [get_Final](./get_final/)() | Devuelve el atributo final de la derivación de tipo que indica si se permiten más derivaciones. |
| [get_FinalResolved](./get_finalresolved/)() | Devuelve la interpretación post-compilación del valor [XmlSchemaType::get_Final](./get_final/). |
