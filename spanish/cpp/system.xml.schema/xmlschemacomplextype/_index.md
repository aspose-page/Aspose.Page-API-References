...
description: "Clase System::Xml::Schema::XmlSchemaComplexType. Representa el elemento **complexType** de XML Schema según lo especificado por el Consorcio de la World Wide Web (W3C). Esta clase define un tipo complejo que determina el conjunto de atributos y el contenido de un elemento en C++."
type: docs
weight: 2100
...
Representa el elemento **complexType** de XML [Schema](../) según lo especificado por el Consorcio de la World Wide [Web](../../system.web/) (W3C). Esta clase define un tipo complejo que determina el conjunto de atributos y el contenido de un elemento.
...
| [get_BlockResolved](./get_blockresolved/)() | Devuelve el valor después de que el tipo haya sido compilado al conjunto de información posterior a la validación del esquema (infoset). Este valor indica cómo se aplica el tipo cuando se usa **xsi:type** en el documento de instancia. |
...
| [get_IsMixed](./get_ismixed/)() override | Devuelve la información que determina si el tipo complejo tiene un modelo de contenido mixto (marcado dentro del contenido). |
...
| [set_AnyAttribute](./set_anyattribute/)(const SharedPtr\<XmlSchemaAnyAttribute\>\&) | Establece el valor del componente [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) del tipo complejo. |
...
| [set_IsMixed](./set_ismixed/)(bool) override | Establece la información que determina si el tipo complejo tiene un modelo de contenido mixto (marcado dentro del contenido). |
