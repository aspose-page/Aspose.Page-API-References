...
description: "Clase System::Xml::Schema::XmlSchemaSequence. Representa el elemento de secuencia (compositor) del XML Schema según lo especificado por el World Wide Web Consortium (W3C). La secuencia requiere que los elementos del grupo aparezcan en el orden especificado dentro del elemento contenedor en C++."
type: docs
weight: 5700
...
Representa el elemento **sequence** (compositor) del XML [Schema](../) según lo especificado por el World Wide [Web](../../system.web/) Consortium (W3C). El **sequence** requiere que los elementos del grupo aparezcan en la secuencia especificada dentro del elemento contenedor.
