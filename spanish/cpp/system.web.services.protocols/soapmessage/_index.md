...
| Método | Descripción |
| --- | --- |
| [CollectHeaders](./collectheaders/)(System::SharedPtr\<Object\>, System::ArrayPtr\<System::SharedPtr\<SoapHeaderMapping\>\>, SoapHeaderDirection) | Establece la colección interna de los encabezados SOAP. |
| [FindHeader](./findheader/)(System::ArrayPtr\<System::SharedPtr\<SoapHeaderMapping\>\>, const TypeInfo\&) | Encuentra el mapeo del encabezado por el tipo de encabezado especificado. |
...
| [get_Exception](./get_exception/)() | Obtiene la excepción que lanza el método del servicio XML [Web](../../system.web/). |
...
| [get_IsSoap12](./get_issoap12/)() | Devuelve un valor que indica si se utiliza la versión 1.2 de SOAP. |
...
| [SetException](./setexception/)(SoapException) | Establece la excepción que lanza el método del servicio XML [Web](../../system.web/). |
