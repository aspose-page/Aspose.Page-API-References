...
description: "System::Web::Services::Protocols::SoapDocumentServiceAttribute::SoapDocumentServiceAttribute constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.web.services.protocols/soapdocumentserviceattribute/soapdocumentserviceattribute/
---
...
| --- | --- | --- |
| uso | Description::SoapBindingUse | El formato de los parámetros. |
...
| --- | --- | --- |
| uso | Description::SoapBindingUse | El formato de los parámetros. |
| paramStyle | SoapParameterStyle | Un valor que indica si los parámetros están encapsulados dentro de un único elemento XML bajo el elemento 'Body'. |
