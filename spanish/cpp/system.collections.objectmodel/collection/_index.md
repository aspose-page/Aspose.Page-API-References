...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const T\&) override | Agrega un valor al contenedor. |
...
| [SetTemplateWeakPtr](./settemplateweakptr/)(uint32_t) override | Convierte los punteros almacenados en débiles (si corresponde). |
