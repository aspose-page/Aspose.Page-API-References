...
| [get_Encrypt](./get_encrypt/)() const | Verifica si el cifrado está habilitado en la línea. |
...
| [get_TrustServerCertificate](./get_trustservercertificate/)() const | Verifica si la conexión está protegida usando un certificado de servidor de confianza. |
...
| [set_Encrypt](./set_encrypt/)(bool) | Alterna el cifrado activado o desactivado. |
...
| [set_TrustServerCertificate](./set_trustservercertificate/)(bool) | Determina si la conexión está protegida usando un certificado de confianza del servidor. |
