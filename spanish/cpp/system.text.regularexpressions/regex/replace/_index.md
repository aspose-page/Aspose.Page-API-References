...
description: "System::Text::RegularExpressions::Regex::Replace method. Reemplaza todas las coincidencias de la expresión regular en la cadena con la cadena de reemplazo en C++."
type: docs
weight: 800
...
Reemplaza todas las coincidencias en la cadena con cadenas de reemplazo generadas por delegados.
...
| entrada | const String\& | Cadena de entrada. |
| evaluador | const MatchEvaluator\& | Delegado para generar cadenas de reemplazo basadas en coincidencias. |
| count | int | Límite de número de reemplazos. |
...
| evaluador | const MatchEvaluator\& | Delegado para generar cadenas de reemplazo basadas en coincidencias. |
| count | int | Límite de número de reemplazos. |
| startat | int | Índice en la cadena de entrada donde comenzar el reemplazo. |
...
Reemplaza coincidencias de expresiones regulares.
...
Reemplaza todas las coincidencias en la cadena con cadenas de reemplazo generadas por delegados (función estática).
