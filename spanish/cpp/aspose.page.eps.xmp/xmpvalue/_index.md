...
description: "Aspose::Page::EPS::XMP::XmpValue class. Representa el valor XMP en C++."
type: docs
weight: 300
url: /es/cpp/aspose.page.eps.xmp/xmpvalue/
---
## XmpValue class
...
| [get_IsNamedValue](./get_isnamedvalue/)() const | Devuelve true si [XmpValue](./) es un valor con nombre. |
| [get_IsNamedValues](./get_isnamedvalues/)() | Devuelve true si [XmpValue](./) representa valores con nombre. |
...
| static [to_KeyValuePair](./to_keyvaluepair/)(System::SharedPtr\<XmpValue\>) | Convierte [XmpValue](./) a un valor con nombre. |
| static [to_KeyValuePairArray](./to_keyvaluepairarray/)(System::SharedPtr\<XmpValue\>) | Convierte XmlValue a un valor de colección con nombre. |
| static [to_String](./to_string/)(System::SharedPtr\<XmpValue\>) | Convierte [XmpValue](./) en una cadena. |
| static [to_XmpValue](./to_xmpvalue/)(System::String) | Convierte una cadena a [XmpValue](./). |
...
| static [to_XmpValue](./to_xmpvalue/)(System::ArrayPtr\<System::SharedPtr\<System::Object\>\>) | Convierte una matriz a [XmpValue](./). |
| static [to_XmpValueArray](./to_xmpvaluearray/)(System::SharedPtr\<XmpValue\>) | Convierte [XmpValue](./) a una matriz. |
| [ToArray](./toarray/)() | Devuelve una matriz. |
| [ToDateTime](./todatetime/)() | Convierte a fecha y hora. |
| [ToDictionary](./todictionary/)() | Devuelve un diccionario que contiene valores con nombre. |
...
| [ToNamedValue](./tonamedvalue/)() | Devuelve el valor [XMP](../) como valor con nombre. |
| [ToNamedValues](./tonamedvalues/)() | Devuelve el valor [XMP](../) como colección de valores con nombre. |
| [ToRaw](./toraw/)() | Código XML sin procesar para valores desconocidos/no compatibles. |
| [ToString](./tostring/)(System::SharedPtr\<System::IFormatProvider\>) | Devuelve la representación en cadena. |
...
| [XmpValue](./xmpvalue/)(System::String) | Constructor para valor de cadena. |
...
| [XmpValue](./xmpvalue/)(System::ArrayPtr\<System::SharedPtr\<XmpValue\>\>) | Constructor para valor de matriz. |
## Ver también
