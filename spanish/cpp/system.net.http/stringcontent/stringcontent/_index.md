...
description: "System::Net::Http::StringContent::StringContent constructor. Información RTTI en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http/stringcontent/stringcontent/
---
...
| --- | --- | --- |
| contenido | String | Contenido HTTP. |
## Observaciones
...
| --- | --- | --- |
| contenido | String | Contenido HTTP. |
| encoding | System::SharedPtr\<Text::Encoding\> | La codificación del contenido HTTP. |
