...
description: "System::Net::Http::HttpResponseMessage::HttpResponseMessage constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http/httpresponsemessage/httpresponsemessage/
---
...
| --- | --- | --- |
| statusCode | HttpStatusCode | El código de estado HTTP. |
