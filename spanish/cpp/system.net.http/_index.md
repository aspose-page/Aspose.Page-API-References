---
title: "Espacio de nombres System::Net::Http"
linktitle: "System::Net::Http"
second_title: "Aspose.Page para C++"
description: "Cómo usar el espacio de nombres System::Net::Http en C++."
type: docs
weight: 4400
url: /es/cpp/system.net.http/
---
...
| Clase | Descripción |
| --- | --- |
| [ByteArrayContent](./bytearraycontent/) | Representa el contenido HTTP como una matriz de bytes. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../system/smartptr/) y use este puntero para pasarlo a funciones como argumento. |
...
| [HttpUtilities](./httputilities/) | Contiene los métodos utilitarios. |
| [StringContent](./stringcontent/) | Representa el contenido HTTP como una cadena. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../system/smartptr/) y use este puntero para pasarlo a funciones como argumento. |
## Enums

| Enumeración | Descripción |
| --- | --- |
| [HttpCompletionOption](./httpcompletionoption/) | Indica cuándo debe completarse una operación de [HttpClient](./httpclient/). |
