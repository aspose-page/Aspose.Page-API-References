...
description: "System::Net::Http::HttpRequestMessage::HttpRequestMessage constructor. Construye una nueva instancia en C++."
type: docs
weight: 100
url: /es/cpp/system.net.http/httprequestmessage/httprequestmessage/
---
...
| --- | --- | --- |
| método | System::SharedPtr\<HttpMethod\> | El método HTTP. |
| requestUri | String | El URI del recurso solicitado. |
...
| --- | --- | --- |
| método | System::SharedPtr\<HttpMethod\> | El método HTTP. |
| requestUri | System::SharedPtr\<Uri\> | El URI del recurso solicitado. |
