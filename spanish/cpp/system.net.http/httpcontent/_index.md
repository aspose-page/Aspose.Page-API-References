...
Representa el contenido de una entidad HTTP. [Object](../../system/object/) de esta clase solo debe asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use este puntero para pasarla a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
| [Dispose](./dispose/)() override | Desecha la instancia actual. Este método también desecha el flujo que devuelve 'ReadAsStream' y el búfer de memoria si se ha creado. |
