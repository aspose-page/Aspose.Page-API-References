---
title: "Clase System::Text::Encoding"
linktitle: "Encoding"
second_title: "Aspose.Page para C++"
description: "Clase System::Text::Encoding. Servicios de codificación en C++."
type: docs
weight: 1600
...
| static [get_BigEndianUnicode](./get_bigendianunicode/)() | Obtiene el objeto de codificación Unicode estándar big-endian. |
| static [get_BigEndianUTF32](./get_bigendianutf32/)() | Obtiene el objeto de codificación UTF-32 estándar big-endian. |
| virtual [get_BodyName](./get_bodyname/)() | Obtiene el nombre de codificación compatible con el cuerpo del agente de correo. |
| virtual [get_CodePage](./get_codepage/)() | Obtiene el ID de página de códigos de [Windows](../../system.windows/). |
...
| virtual [get_EncodingName](./get_encodingname/)() | Obtiene el nombre de codificación legible por humanos. |
...
| virtual [get_IsMailNewsSave](./get_ismailnewssave/)() | Comprueba si la codificación puede usarse en el cliente de correo para guardar contenido. |
...
| virtual [get_WindowsCodePage](./get_windowscodepage/)() | Obtiene el ID de página de códigos de [Windows](../../system.windows/). |
...
| virtual [GetByteCount](./getbytecount/)(const char_t *, int) | Obtenga el número de caracteres necesarios para codificar un búfer de caracteres. |
| virtual [GetBytes](./getbytes/)(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) | Obtenga los bytes que resultan de codificar un búfer de caracteres. |
...
| virtual [GetBytes](./getbytes/)(const String\&, int, int, ArrayPtr\<uint8_t\>, int) | Obtenga los bytes que resultan de codificar un búfer de caracteres. |
...
| virtual [GetBytes](./getbytes/)(const char_t *, int, uint8_t *, int) | Obtenga los bytes que resultan de codificar un búfer de caracteres. |
| virtual [GetCharCount](./getcharcount/)(ArrayPtr\<uint8_t\>, int, int) | Obtenga el número de caracteres necesarios para decodificar un búfer de bytes. |
...
| virtual [GetCharCount](./getcharcount/)(const uint8_t *, int) | Obtenga el número de caracteres necesarios para decodificar un búfer de bytes. |
| virtual [GetChars](./getchars/)(ArrayPtr\<uint8_t\>, int, int, ArrayPtr\<char_t\>, int) | Obtenga los caracteres que resultan de decodificar un búfer de bytes. |
...
| virtual [GetChars](./getchars/)(const uint8_t *, int, char_t *, int) | Obtenga los caracteres que resultan de decodificar un búfer de bytes. |
| virtual [GetDecoder](./getdecoder/)() | Obtenga un decodificador que reenvíe solicitudes a este objeto. |
| virtual [GetEncoder](./getencoder/)() | Obtenga un codificador que reenvíe solicitudes a este objeto. |
...
| virtual [GetPreamble](./getpreamble/)() | Devuelve una secuencia de bytes que denota la codificación (p. ej. BOM). |
