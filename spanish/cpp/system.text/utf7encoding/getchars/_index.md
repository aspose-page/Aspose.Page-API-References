---
title: "Método System::Text::UTF7Encoding::GetChars"
linktitle: "GetChars"
second_title: "Aspose.Page para C++"
description: "Método System::Text::UTF7Encoding::GetChars. Obtiene los caracteres que resultan de decodificar un búfer de bytes en C++."
type: docs
weight: 700
url: /es/cpp/system.text/utf7encoding/getchars/
---
## UTF7Encoding::GetChars(ArrayPtr\<uint8_t\>) method


Obtenga los caracteres que resultan de decodificar un búfer de bytes.
...
| --- | --- | --- |
| bytes | ArrayPtr\<uint8_t\> | [Buffer](../../../system/buffer/) para leer bytes. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| bytes | const uint8_t * | [Buffer](../../../system/buffer/) para leer bytes. |
| byte_count | int | Tamaño del búfer de entrada. |
