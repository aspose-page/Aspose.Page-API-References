...
| startIndex | int | [Array](../../../system/array/) índice inicial de la porción. |
...
| --- | --- | --- |
| startIndex | int | Posición donde insertar los caracteres. |
| str | const String\& | [String](../../../system/string/) para insertar. |
...
| --- | --- | --- |
| startIndex | int | Posición donde insertar los caracteres. |
| value | T | Valor para formatear e insertar. |
...
| value | const String\& | [String](../../../system/string/) para insertar. |
