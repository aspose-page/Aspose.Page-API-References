...
description: "Método System::Text::StringBuilder::Append. Añade un carácter al constructor en C++."
type: docs
weight: 300
...
| --- | --- | --- |
| c | char_t | Valor del carácter. |
| count | int | Cuántas veces repetir el carácter a insertar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| str | const String\& | [String](../../../system/string/) para añadir. |
...
Agrega la representación en cadena del valor enum al constructor.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | T | Valor para serializar y añadir. |
