---
title: "System::Runtime::InteropServices::Marshal::Copy método"
linktitle: "Copiar"
second_title: "Aspose.Page para C++"
description: "System::Runtime::InteropServices::Marshal::Copy método. Implementa public static void Copy(char[] source, int startIndex, IntPtr destination, int length) en C++."
type: docs
weight: 200
url: /es/cpp/system.runtime.interopservices/marshal/copy/
---
...
| --- | --- |
| contenedor | Tipo de contenedor de origen. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fuente | const container\& | Puntero de datos de origen. |
| startIndex | int | Índice de inicio de origen. |
| destination | IntPtr | Puntero de datos de destino. |
| longitud | int | Número de elementos a copiar. |
...
| fuente | const container\& | Puntero de datos de origen. |
| startIndex | int | Índice de inicio de origen. |
| destination | void * | Puntero de datos de destino. |
| longitud | int | Número de elementos a copiar. |
...
Implementa la semántica de public static void Copy(IntPtr source, byte[] destination, int startIndex, int length).
...
| Parámetro | Descripción |
| --- | --- |
| contenedor | Tipo de contenedor de destino. |

| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fuente | const IntPtr | Puntero de datos de origen. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fuente | const void * | Puntero de datos de origen. |
| destination | container\&& | Contenedor donde copiar los datos. |
| startIndex | int | Índice de inicio de origen. |
| longitud | int | Número de elementos a copiar. |
