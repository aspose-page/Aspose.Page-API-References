...
description: "System::Drawing::Imaging::ImageFlags enum. Representa atributos de los datos de píxel representados por un objeto Image en C++."
type: docs
weight: 2200
...
Representa atributos de los datos de píxel representados por un objeto [Image](../../system.drawing/image/).
...
| ColorSpaceGray | 64 | Los datos de píxel están en escala de grises. |
