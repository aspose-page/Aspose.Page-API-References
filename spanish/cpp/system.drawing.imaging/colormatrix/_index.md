...
| [idx_get](./idx_get/)(int, int) | Devuelve un valor en la fila y columna especificadas. |
| [idx_set](./idx_set/)(int, int, float) | Establece el valor especificado en la ubicación especificada en la matriz. |
