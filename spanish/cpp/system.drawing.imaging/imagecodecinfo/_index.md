...
| Método | Descripción |
| --- | --- |
| [get_FormatID](./get_formatid/)() const | Devuelve un GUID asociado al formato del códec representado por el objeto actual. |
...
| [set_FormatID](./set_formatid/)(const Guid\&) | Establece un GUID asociado al formato del códec representado por el objeto actual. |
## Ver también
