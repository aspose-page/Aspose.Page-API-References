...
| static [RenderMethod](./rendermethod/) | Una instancia de la clase [Encoder](./) que representa la categoría de parámetro del método de renderizado. |
...
| static [ScanMethod](./scanmethod/) | Una instancia de la clase [Encoder](./) que representa la categoría de parámetro del método de escaneo. |
