...
description: "System::Drawing::Imaging::ColorChannelFlag enum. Especifica un canal de color en el espacio de color CMYK en C++."
type: docs
weight: 1600
url: /es/cpp/system.drawing.imaging/colorchannelflag/
---
## ColorChannelFlag enum


Especifica un canal de color en el espacio de color CMYK.
