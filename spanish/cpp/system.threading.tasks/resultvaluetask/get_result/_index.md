...
Si la tarea está respaldada por un [ResultTask<T>](../../resulttask/), este método esperará el resultado y lo almacenará en caché. Las llamadas subsecuentes devolverán el valor en caché sin esperar.
