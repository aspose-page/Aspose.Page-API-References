...
description: "System::Threading::Tasks::ResultValueTask::AsTask método. Convierte este ResultValueTask a un puntero compartido a ResultTask<T> en C++."
type: docs
weight: 200
...
Convierte este [ResultValueTask](../) a un puntero compartido a [ResultTask<T>](../../resulttask/).
