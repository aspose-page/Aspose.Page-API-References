---
title: "System::Threading::Tasks::Task clase"
linktitle: "Task"
second_title: "Aspose.Page para C++"
description: "System::Threading::Tasks::Task clase. Representa una operación asincrónica que puede esperarse y componerse con otras tareas en C++."
type: docs
weight: 300
...
| Método | Descripción |
| --- | --- |
| [Activate](./activate/)(TaskScheduler *) | Activa la tarea para su ejecución en un planificador. |
| [AddContinuation](./addcontinuation/)(const Action<>\&) | Agrega una acción de continuación que se ejecutará al completarse. |
| [Complete](./complete/)() | Marca la tarea como completada y finaliza la tarea. |
| [ConfigureAwait](./configureawait/)(bool) const | Configura cómo deben comportarse los await en esta tarea respecto a la captura del contexto. |
...
| [get_Id](./get_id/)() const | Obtiene el ID de la tarea. |
...
| [RunSynchronously](./runsynchronously/)() | Ejecuta la tarea de forma síncrona en el hilo actual. |
| [RunSynchronously](./runsynchronously/)(const SharedPtr\<TaskScheduler\>\&) | Ejecuta la tarea de forma síncrona usando el planificador especificado. |
| [set_Function](./set_function/)(const FunctionT\&) | Establece la función interna a ejecutar. |
| [set_Scheduler](./set_scheduler/)(TaskScheduler *) | Establece el planificador asociado a esta tarea. |
...
| [Start](./start/)(const SharedPtr\<TaskScheduler\>\&) | Inicia la ejecución de la tarea usando el planificador especificado. |
...
| [Task](./task/)() | Constructor interno para crear tareas sin inicializar. |
| [Wait](./wait/)(const CancellationToken\&) const | Espera a que la tarea se complete con soporte de cancelación. |
| [Wait](./wait/)() const | Espera a que la tarea se complete. |
