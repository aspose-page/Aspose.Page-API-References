...
description: "System::Threading::Tasks::Task::Task constructor. Constructor interno para crear tareas sin inicializar en C++."
type: docs
weight: 100
...
Constructor interno para crear tareas sin inicializar.
...
| --- | --- | --- |
| acción | const Action\<SharedPtr\<Object\>\>\& | La acción a ejecutar (acepta objeto de estado) |
| estado | const SharedPtr\<Object\>\& | Objeto de estado definido por el usuario pasado a la acción |
