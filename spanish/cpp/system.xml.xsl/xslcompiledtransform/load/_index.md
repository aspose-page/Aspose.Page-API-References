---
title: "Método System::Xml::Xsl::XslCompiledTransform::Load"
linktitle: "Cargar"
second_title: "Aspose.Page para C++"
description: "Método System::Xml::Xsl::XslCompiledTransform::Load. Compila la hoja de estilo contenida en el objeto IXPathNavigable en C++."
type: docs
weight: 300
...
| stylesheetResolver | SharedPtr\<XmlResolver\> | El [XmlResolver](../../../system.xml/xmlresolver/) utilizado para resolver cualquier hoja de estilo referenciada en los elementos XSLT **import** y **include**. Si esto es **nullptr**, los recursos externos no se resuelven. |
...
Compila la hoja de estilo XSLT contenida en el [XmlReader](../../../system.xml/xmlreader/). El [XmlResolver](../../../system.xml/xmlresolver/) resuelve cualquier elemento XSLT **import** o **include** y la configuración XSLT determina los permisos para la hoja de estilo.
...
| stylesheetResolver | const SharedPtr\<XmlResolver\>\& | El [XmlResolver](../../../system.xml/xmlresolver/) utilizado para resolver cualquier hoja de estilo referenciada en los elementos XSLT **import** y **include**. Si esto es **nullptr**, los recursos externos no se resuelven. |
...
| stylesheetUri | const String\& | El URI de la hoja de estilo. |
| settings | const SharedPtr\<XsltSettings\>\& | Los [XsltSettings](../../xsltsettings/) a aplicar a la hoja de estilo. Si esto es **nullptr**, se aplica la configuración [XsltSettings::get_Default](../../xsltsettings/get_default/). |
| stylesheetResolver | const SharedPtr\<XmlResolver\>\& | El [XmlResolver](../../../system.xml/xmlresolver/) usado para resolver el URI de la hoja de estilo y cualquier hoja de estilo referenciada en los elementos **import** y **include** de XSLT. |
