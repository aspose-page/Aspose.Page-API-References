---
title: "Método System::Xml::Xsl::XslTransform::Transform"
linktitle: "Transform"
second_title: "Aspose.Page para C++"
description: "Método System::Xml::Xsl::XslTransform::Transform. Transforma los datos XML en el IXPathNavigable usando los argumentos especificados y devuelve el resultado a un XmlReader en C++."
type: docs
weight: 400
...
Transforma los datos XML en el IXPathNavigable usando los **args** especificados y devuelve el resultado a un [XmlReader](../../../system.xml/xmlreader/).
...
| input | const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\& | Un objeto que implementa la interfaz IXPathNavigable. Puede ser un [XmlNode](../../../system.xml/xmlnode/) (normalmente un [XmlDocument](../../../system.xml/xmldocument/)), o un XPathDocument que contiene los datos a transformar. |
| args | const SharedPtr\<XsltArgumentList\>\& | Una [XsltArgumentList](../../xsltargumentlist/) que contiene los argumentos calificados por espacio de nombres usados como entrada para la transformación. |
| salida | const SharedPtr\<IO::Stream\>\& | El flujo al que desea enviar la salida. |
...
| input | const SharedPtr\<System::Xml::XPath::IXPathNavigable\>\& | Un objeto que implementa la interfaz IXPathNavigable. Puede ser un [XmlNode](../../../system.xml/xmlnode/) (normalmente un [XmlDocument](../../../system.xml/xmldocument/)), o un XPathDocument que contiene los datos a transformar. |
| args | const SharedPtr\<XsltArgumentList\>\& | Una [XsltArgumentList](../../xsltargumentlist/) que contiene los argumentos calificados por espacio de nombres usados como entrada para la transformación. |
| salida | const SharedPtr\<IO::TextWriter\>\& | El TextWriter al que desea enviar la salida. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| entrada | const SharedPtr\<System::Xml::XPath::XPathNavigator\>\& | Un XPathNavigator que contiene los datos a transformar. |
| args | const SharedPtr\<XsltArgumentList\>\& | Una [XsltArgumentList](../../xsltargumentlist/) que contiene los argumentos calificados por espacio de nombres usados como entrada para la transformación. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| inputfile | const String\& | La URL del documento fuente que se va a transformar. |
| outputfile | const String\& | La URL del archivo de salida. |
