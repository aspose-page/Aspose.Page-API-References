...
description: "System::Xml::Xsl::XsltArgumentList::GetParam método. Devuelve el parámetro asociado con el nombre calificado por espacio de nombres en C++."
type: docs
weight: 600
...
| namespaceUri | const String\& | El URI del espacio de nombres asociado con el parámetro. |
