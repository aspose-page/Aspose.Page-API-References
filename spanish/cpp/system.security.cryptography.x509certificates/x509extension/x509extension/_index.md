...
description: "Constructor de System::Security::Cryptography::X509Certificates::X509Extension::X509Extension. Información RTTI en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography.x509certificates/x509extension/x509extension/
---
...
| --- | --- | --- |
| encoded_extension | const SharedPtr\<AsnEncodedData\>\& | Datos codificados asociados con el certificado. |
| crítico | bool | Indicador de criticidad. |
## Observaciones
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| oid | const SharedPtr\<Oid\>\& | [Object](../../../system/object/) identificador asociado con la extensión. |
| raw_data | const ByteArrayPtr\& | Datos sin procesar asociados con el certificado. |
| crítico | bool | Indicador de criticidad. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| oid | const String\& | [Object](../../../system/object/) identificador asociado con la extensión. |
| raw_data | const ByteArrayPtr\& | Datos sin procesar asociados con el certificado. |
| crítico | bool | Indicador de criticidad. |
