...
description: "System::Security::Cryptography::X509Certificates::X500DistinguishedName::X500DistinguishedName constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography.x509certificates/x500distinguishedname/x500distinguishedname/
---
...
| --- | --- | --- |
| encoded_distinguished_name | const ByteArrayPtr\& | Nombre distinguido codificado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| encoded_distinguished_name | const SharedPtr\<AsnEncodedData\>\& | [Object](../../../system/object/) que representa el nombre distinguido. |
## Observaciones
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| distinguishedName | const SharedPtr\<X500DistinguishedName\>\& | Nombre distinguido del cual copiar datos. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| distinguished_name | const String\& | Nombre distinguido. |
...
| --- | --- | --- |
| distinguished_name | const String\& | Nombre distinguido. |
| flags | X500DistinguishedNameFlags | Banderas combinadas mediante operaciones bit a bit que especifican propiedades de construcción del nombre. |
