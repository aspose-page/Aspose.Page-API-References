---
title: "System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate constructor"
linktitle: "X509Certificate"
second_title: "Aspose.Page para C++"
description: "System::Security::Cryptography::X509Certificates::X509Certificate::X509Certificate constructor. Constructor en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography.x509certificates/x509certificate/x509certificate/
---
...
| --- | --- | --- |
| datos | const ByteArrayPtr\& | Secuencia de bytes que representa el certificado codificado. |
...
| password | const SecureStringPtr\& | Contraseña utilizada para acceder a los datos del certificado. |
...
| --- | --- | --- |
| raw_data | const ByteArrayPtr\& | Secuencia de bytes que representa el certificado codificado. |
| password | const String\& | Contraseña utilizada para acceder a los datos del certificado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cert | const SharedPtr\<X509Certificate\>\& | Un certificado utilizado para inicializar este objeto. |
