...
description: "System::Security::Cryptography::X509Certificates::X509KeyUsageExtension::X509KeyUsageExtension constructor. Información RTTI en C++."
type: docs
weight: 100
url: /es/cpp/system.security.cryptography.x509certificates/x509keyusageextension/x509keyusageextension/
---
...
| --- | --- | --- |
| encoded_key_usage | const SharedPtr\<AsnEncodedData\>\& | Datos codificados de los usos de clave. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| key_usages | X509KeyUsageFlags | Usos de clave. |
| crítico | bool | Indicador de criticidad. |
