...
description: "System::Xml::Serialization::XmlSerializerNamespaces clase. Contiene los espacios de nombres XML y los prefijos que Serialization::XmlSerializer usa para generar nombres calificados en una instancia de documento XML en C++."
type: docs
weight: 800
...
Contiene los espacios de nombres XML y los prefijos que [Serialization::XmlSerializer](../xmlserializer/) usa para generar nombres calificados en una instancia de documento XML.
