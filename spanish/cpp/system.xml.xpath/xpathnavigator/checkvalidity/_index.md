...
description: "System::Xml::XPath::XPathNavigator::CheckValidity método. Verifica que los datos XML en el XPathNavigator cumplan con el esquema del lenguaje de definición de esquemas XML (XSD) proporcionado en C++."
type: docs
weight: 300
...
Verifica que los datos XML en el [XPathNavigator](../) cumplan con el esquema del lenguaje de definición de [Schema](../../../system.xml.schema/) XML (XSD) proporcionado.
