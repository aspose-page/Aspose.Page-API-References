---
title: "System::Xml::XPath::XPathNavigator::MoveTo método"
linktitle: "MoveTo"
second_title: "Aspose.Page para C++"
description: "System::Xml::XPath::XPathNavigator::MoveTo método. Cuando se sobrescribe en una clase derivada, mueve el XPathNavigator a la misma posición que el XPathNavigator especificado en C++."
type: docs
weight: 5000
url: /es/cpp/system.xml.xpath/xpathnavigator/moveto/
---
...
| --- | --- | --- |
| other | SharedPtr\<XPathNavigator\> | El [XPathNavigator](../) posicionado en el nodo al que desea moverse. |
