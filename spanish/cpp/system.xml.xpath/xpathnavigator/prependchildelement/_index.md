---
title: "Método System::Xml::XPath::XPathNavigator::PrependChildElement"
linktitle: "PrependChildElement"
second_title: "Aspose.Page para C++"
description: "Método System::Xml::XPath::XPathNavigator::PrependChildElement. Crea un nuevo elemento hijo al comienzo de la lista de nodos hijos del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI de espacio de nombres especificados con el valor indicado en C++."
type: docs
weight: 6700
...
Crea un nuevo elemento hijo al comienzo de la lista de nodos hijos del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI del espacio de nombres especificados con el valor especificado.
