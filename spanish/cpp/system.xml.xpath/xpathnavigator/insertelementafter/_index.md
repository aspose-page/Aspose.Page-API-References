---
title: "System::Xml::XPath::XPathNavigator::InsertElementAfter método"
linktitle: "InsertElementAfter"
second_title: "Aspose.Page para C++"
description: "System::Xml::XPath::XPathNavigator::InsertElementAfter método. Crea un nuevo elemento hermano después del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI del espacio de nombres especificados, con el valor especificado en C++."
type: docs
weight: 4300
url: /es/cpp/system.xml.xpath/xpathnavigator/insertelementafter/
---
## XPathNavigator::InsertElementAfter method


Crea un nuevo elemento hermano después del nodo actual usando el prefijo de espacio de nombres, el nombre local y el URI del espacio de nombres especificados, con el valor especificado.
