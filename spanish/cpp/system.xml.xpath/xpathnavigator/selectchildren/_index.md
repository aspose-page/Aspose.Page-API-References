---
title: "System::Xml::XPath::XPathNavigator::SelectChildren método"
linktitle: "SelectChildren"
second_title: "Aspose.Page para C++"
description: "System::Xml::XPath::XPathNavigator::SelectChildren método. Selecciona todos los nodos hijos del nodo actual que tienen el nombre local y el URI de espacio de nombres especificados en C++."
type: docs
weight: 7300
...
Selecciona todos los nodos hijos del nodo actual que tengan el nombre local y el URI de espacio de nombres especificados.
...
| --- | --- | --- |
| name | String | El nombre local de los nodos hijos. |
