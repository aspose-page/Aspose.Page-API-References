...
description: "Método System::Xml::XPath::XPathNavigator::SelectDescendants. Selecciona todos los nodos descendientes del nodo actual con el nombre local y el URI de espacio de nombres especificados en C++."
type: docs
weight: 7400
...
Selecciona todos los nodos descendientes del nodo actual con el nombre local y el URI de espacio de nombres especificados.
...
| --- | --- | --- |
| name | String | El nombre local de los nodos descendientes. |
| namespaceURI | String | El URI de espacio de nombres de los nodos descendientes. |
