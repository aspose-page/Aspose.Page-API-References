...
description: "System::Xml::XPath::XPathNavigator::SelectAncestors método. Selecciona todos los nodos ancestros del nodo actual que tengan el nombre local y el URI de espacio de nombres especificados en C++."
type: docs
weight: 7200
...
| --- | --- | --- |
| name | String | El nombre local de los nodos ancestros. |
| namespaceURI | String | El URI del espacio de nombres de los nodos ancestros. |
