...
description: "enum System::Xml::XPath::XPathNodeType. Define los tipos de nodo XPath que pueden ser devueltos por la clase XPathNavigator en C++."
type: docs
weight: 1100
...
| Text | 4 | El contenido de texto de un nodo. Equivalente al Modelo de Objetos del Documento [Object](../../system/object/) (DOM) [Text](../../system.text/) y a los tipos de nodo CDATA. Contiene al menos un carácter. |
| SignificantWhitespace | 5 | Un nodo con caracteres de espacio en blanco y **xml:space** configurado a **preserve**. |
| Espacio en blanco | 6 | Un nodo con solo caracteres de espacio en blanco y sin espacio en blanco significativo. Los caracteres de espacio en blanco son **'\\x20'**, **'\\x0d'**, **'\\x0a'**, **'\\x09'**. |
