...
| [get_SurroundColors](./get_surroundcolors/)() const | Devuelve colores que corresponden a los puntos en la ruta que esta [PathGradientBrush](./) rellena. |
...
| [set_SurroundColors](./set_surroundcolors/)(const ArrayPtr\<Color\>\&) | Establece colores que corresponden a los puntos en la ruta que esta [PathGradientBrush](./) rellena. |
