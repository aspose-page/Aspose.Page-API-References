...
| [set_WidthScale](./set_widthscale/)(float) | Establece el valor de escala de esta tapa personalizada. |
| [SetStrokeCaps](./setstrokecaps/)(LineCap, LineCap) | Establece las tapas de línea inicial y final de la tapa personalizada representada por el objeto actual. |
## Ver también
