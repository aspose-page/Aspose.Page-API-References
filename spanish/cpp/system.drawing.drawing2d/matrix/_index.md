---
title: "System::Drawing::Drawing2D::Matrix clase"
linktitle: "Matrix"
...
| [Equals](./equals/)(ptr) override | Comprueba si el objeto especificado es una [Matrix](./) y es idéntico a este objeto. |
...
| [Matrix](./matrix/)(float, float, float, float, float, float) | Construye una nueva instancia de la clase [Matrix](./) e inicializa con los valores especificados. |
...
| [Rotate](./rotate/)(float) | Rota la matriz representada por el objeto actual en sentido horario por el ángulo especificado. |
| [Rotate](./rotate/)(float, MatrixOrder) | Rota la matriz representada por el objeto actual en sentido horario alrededor del origen por el ángulo especificado. |
| [RotateAt](./rotateat/)(float, const PointF\&) | Rota la matriz representada por el objeto actual en sentido horario alrededor del punto especificado por el ángulo especificado. |
| [RotateAt](./rotateat/)(float, const PointF\&, MatrixOrder) | Rota la matriz representada por el objeto actual en sentido horario alrededor del punto especificado por el ángulo especificado. |
...
| [VectorTransformPoints](./vectortransformpoints/)(const ArrayPtr\<Point\>\&) | Multiplica cada vector de una matriz por la matriz representada por el objeto actual. |
| [VectorTransformPoints](./vectortransformpoints/)(const System::Details::ArrayView\<Point\>\&) | Multiplica cada vector de una matriz por la matriz representada por el objeto actual. |
