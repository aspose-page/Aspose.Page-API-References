---
title: "System::Drawing::Drawing2D::GraphicsPath::AddPie método"
linktitle: "AddPie"
second_title: "Aspose.Page para C++"
description: "System::Drawing::Drawing2D::GraphicsPath::AddPie método. Agrega el contorno especificado de la forma de pastel al camino representado por el objeto actual en C++."
type: docs
weight: 1200
url: /es/cpp/system.drawing.drawing2d/graphicspath/addpie/
---
...
| --- | --- | --- |
| rect | const Rectangle\\& | El rectángulo que delimita la elipse de la cual se dibuja el pastel |
...
| ancho | float | El ancho de la esquina superior izquierda del rectángulo que delimita la elipse de la cual se dibuja el pastel |
| alto | float | La altura de la esquina superior izquierda del rectángulo que delimita la elipse de la cual se dibuja el pastel |
| startAngle | float | Especifica el ángulo inicial del pastel en grados, medido en sentido horario desde el eje X |
| sweepAngle | float | Especifica el ángulo entre el ángulo inicial y el final del pastel |
...
| ancho | int | El ancho de la esquina superior izquierda del rectángulo que delimita la elipse de la cual se dibuja el pastel |
| alto | int | La altura de la esquina superior izquierda del rectángulo que delimita la elipse de la cual se dibuja el pastel |
| startAngle | float | Especifica el ángulo inicial del pastel en grados, medido en sentido horario desde el eje X |
| sweepAngle | float | Especifica el ángulo entre el ángulo inicial y el final del pastel |
