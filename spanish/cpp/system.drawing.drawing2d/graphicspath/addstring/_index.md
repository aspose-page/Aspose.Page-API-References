---
title: "System::Drawing::Drawing2D::GraphicsPath::AddString método"
linktitle: "AddString"
second_title: "Aspose.Page para C++"
description: "System::Drawing::Drawing2D::GraphicsPath::AddString método. Agrega una cadena de texto a la ruta representada por el objeto actual en C++."
type: docs
weight: 1600
url: /es/cpp/system.drawing.drawing2d/graphicspath/addstring/
---
## GraphicsPath::AddString(const String\&, const SharedPtr\<FontFamily\>\&, int, float, Point, const SharedPtr\<StringFormat\>\&) method


Agrega una cadena de texto a la ruta representada por el objeto actual.
...
| --- | --- | --- |
| text | const String\& | El texto a agregar |
| familia | const SharedPtr\<FontFamily\>\& | La familia de fuentes utilizada para dibujar el texto |
| style | int | Un valor de enumeración [FontStyle](../../../system.drawing/fontstyle/) que especifica el estilo de fuente a usar |
| emSize | float | La altura del cuadro cuadrado em que delimita cada carácter de la cadena |
| origin | Punto | Especifica la ubicación donde comienza el texto |
| stringFormat | const SharedPtr\<StringFormat\>\& | El formato de la cadena |
...
| style | int | Un valor de enumeración [FontStyle](../../../system.drawing/fontstyle/) que especifica el estilo de fuente a usar |
| emSize | float | La altura del cuadro cuadrado em que delimita cada carácter de la cadena |
| origin | PointF | Especifica la ubicación donde comienza el texto |
| stringFormat | const SharedPtr\<StringFormat\>\& | El formato de la cadena |
...
| style | int | Un valor de enumeración [FontStyle](../../../system.drawing/fontstyle/) que especifica el estilo de fuente a usar |
| emSize | float | La altura del cuadro cuadrado em que delimita cada carácter de la cadena |
| layoutRect | Rectángulo | Un rectángulo que delimita el texto |
| stringFormat | const SharedPtr\<StringFormat\>\& | El formato de la cadena |
...
| style | int | Un valor de enumeración [FontStyle](../../../system.drawing/fontstyle/) que especifica el estilo de fuente a usar |
| emSize | float | La altura del cuadro cuadrado em que delimita cada carácter de la cadena |
| layoutRect | RectangleF | Un rectángulo que delimita el texto |
| stringFormat | const SharedPtr\<StringFormat\>\& | El formato de la cadena |
