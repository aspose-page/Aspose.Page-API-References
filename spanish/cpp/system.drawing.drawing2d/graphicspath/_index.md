...
| [GetFigureFlags](./getfigureflags/)() | Devuelve un valor que es una combinación a nivel de bits de los valores Detail::FigureType que indica qué tipos de figuras están contenidos en la ruta representada por el objeto actual. |
...
| [IsOutlineVisible](./isoutlinevisible/)(const PointF\&, const SharedPtr\<Pen\>\&) | Indica si el punto especificado está contenido dentro (bajo) del contorno de este [GraphicsPath](./) cuando se dibuja con el [Pen](../../system.drawing/pen/) especificado. NO IMPLEMENTADO. |
...
| [Transform](./transform/)(const MatrixPtr\&) | Transforma la ruta representada por el objeto actual aplicándole la matriz de transformación especificada. |
