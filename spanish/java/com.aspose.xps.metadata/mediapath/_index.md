...
description: "Define constantes para el valor de propiedad puntuado MediaPath."
type: docs
weight: 16
url: /es/java/com.aspose.xps.metadata/inputbin.mediapath/
---
**Inheritance:**
...
Define constantes para el valor de la propiedad evaluada MediaPath.
## Campos

| Campo | Descripción |
| --- | --- |
| [Serpentine](#Serpentine) | Valor serpenteante. |
| [Straight](#Straight) | Valor recto. |
## Métodos
