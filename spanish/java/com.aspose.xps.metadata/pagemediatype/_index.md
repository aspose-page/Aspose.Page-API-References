...
description: "Describe las opciones de MediaType y las características de cada opción."
type: docs
weight: 110
url: /es/java/com.aspose.xps.metadata/pagemediatype/
---
**Inheritance:**
...
Describe las opciones de  MediaType  y las características de cada opción. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediatype
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageMediaType(PageMediaType.IPageMediaTypeItem[] items)](#PageMediaType-com.aspose.xps.metadata.PageMediaType.IPageMediaTypeItem...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| items | [IPageMediaTypeItem\[\]](../../com.aspose.xps.metadata/ipagemediatypeitem) | Una matriz de elementos específicos para la característica. |
