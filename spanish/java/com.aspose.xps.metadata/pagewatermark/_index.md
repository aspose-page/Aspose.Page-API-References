...
description: "Describe la configuración de marca de agua de la salida y las características de la marca de agua."
type: docs
weight: 131
url: /es/java/com.aspose.xps.metadata/pagewatermark/
---
**Inheritance:**
...
Describe la configuración de marca de agua de la salida y las características de la marca de agua. Las marcas de agua se aplican a la página lógica, no a la página física. Por ejemplo, si  DocumentDuplex  está habilitado, una marca de agua aparecerá en cada página  NUp  de cada hoja. Si  DocumentDuplex ,  PagesPerSheet =2, entonces cada hoja tendrá 2 marcas de agua. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermark
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageWatermark(PageWatermark.IPageWatermarkItem[] items)](#PageWatermark-com.aspose.xps.metadata.PageWatermark.IPageWatermarkItem...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| items | [IPageWatermarkItem\[\]](../../com.aspose.xps.metadata/ipagewatermarkitem) | Una matriz de elementos específicos para la característica. |
