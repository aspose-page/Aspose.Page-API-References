...
description: "Describe la hoja de cubierta posterior."
type: docs
weight: 66
url: /es/java/com.aspose.xps.metadata/jobprimarycoverback/
---
**Inheritance:**
...
Describe la hoja de cubierta posterior (final). Cada trabajo tendrá una hoja primaria separada. La hoja de cubierta debe imprimirse en el  PageMediaSize  y  PageMediaType  utilizados para la página final del trabajo. La hoja de cubierta debe integrarse en las opciones de procesamiento (como  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) según lo indicado por la Opción especificada. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverback
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobPrimaryCoverBack(JobPrimaryCoverBack.CoverBackOption[] options)](#JobPrimaryCoverBack-com.aspose.xps.metadata.JobPrimaryCoverBack.CoverBackOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [CoverBackOption\[\]](../../com.aspose.xps.metadata/coverbackoption) | Una matriz de opciones específicas para la característica. |
