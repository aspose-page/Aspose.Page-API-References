...
type: docs
weight: 100
url: /es/java/com.aspose.xps.metadata/pageinputbin/
---
**Inheritance:**
...
Describe la bandeja de entrada instalada en un dispositivo o la lista completa de bandejas compatibles para un dispositivo. Permite especificar la bandeja de entrada por página. Las palabras clave  JobInputBin ,  DocumentInputBin  y  PageInputBin  son mutuamente excluyentes. No deben especificarse ambas simultáneamente en un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageinputbin
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageInputBin(InputBin.IInputBinItem[] items)](#PageInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Crea una nueva instancia. |
## Métodos
