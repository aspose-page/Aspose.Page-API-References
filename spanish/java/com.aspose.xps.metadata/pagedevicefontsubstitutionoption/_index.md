...
description: "Describe las opciones de la característica PageDeviceFontSubstitution."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pagedevicefontsubstitution.pagedevicefontsubstitutionoption/
---
**Inheritance:**
...
Describe las opciones de la característica  PageDeviceFontSubstitution  .
## Campos

| Campo | Descripción |
| --- | --- |
| [Off](#Off) | La sustitución de fuentes del dispositivo de página está desactivada. |
| [On](#On) | La sustitución de fuentes del dispositivo de página está activada. |
## Métodos
...
La sustitución de fuentes del dispositivo de página está desactivada.
...
La sustitución de fuentes del dispositivo de página está activada.
