...
description: "Define constantes para el valor de la propiedad puntuado FeedFace."
type: docs
weight: 12
url: /es/java/com.aspose.xps.metadata/inputbin.feedface/
---
**Inheritance:**
...
Define constantes para el valor de la propiedad evaluada FeedFace.
## Campos

| Campo | Descripción |
| --- | --- |
| [FaceDown](#FaceDown) | Valor FaceDown. |
| [FaceUp](#FaceUp) | Valor FaceUp. |
## Métodos
