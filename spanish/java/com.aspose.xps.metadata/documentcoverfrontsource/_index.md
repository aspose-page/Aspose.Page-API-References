...
description: "Especifica la fuente para una hoja de cubierta frontal personalizada."
type: docs
weight: 22
url: /es/java/com.aspose.xps.metadata/documentcoverfrontsource/
---
**Inheritance:**
...
Especifica la fuente para una hoja de portada frontal personalizada. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfrontsource
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentCoverFrontSource(String value)](#DocumentCoverFrontSource-java.lang.String-) | Crea una nueva instancia. |
## Métodos
