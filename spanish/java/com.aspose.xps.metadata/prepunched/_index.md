...
description: "Define constantes para el valor de la propiedad puntuada PrePunched."
type: docs
weight: 15
url: /es/java/com.aspose.xps.metadata/pagemediatype.prepunched/
---
**Inheritance:**
...
Define constantes para el valor de propiedad puntuado PrePunched.
## Campos

| Campo | Descripción |
| --- | --- |
| [None](#None) | Valor None. |
| [PrePunchedValue](#PrePunchedValue) | Valor PrePunched. |
## Métodos
