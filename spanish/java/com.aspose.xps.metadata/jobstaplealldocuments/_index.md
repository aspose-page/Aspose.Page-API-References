...
description: "Describe las características de engrampado de la salida."
type: docs
weight: 72
url: /es/java/com.aspose.xps.metadata/jobstaplealldocuments/
---
**Inheritance:**
...
Describe las características de engrampado de la salida. Todos los documentos en el trabajo se engrapan juntos. Las palabras clave  JobStapleAllDocuments  y  DocumentStaple  son mutuamente exclusivas. Depende del controlador determinar el manejo de restricciones entre estas palabras clave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobstaplealldocuments
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobStapleAllDocuments(Staple.StapleOption[] options)](#JobStapleAllDocuments-com.aspose.xps.metadata.Staple.StapleOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [StapleOption\[\]](../../com.aspose.xps.metadata/stapleoption) | Una matriz de opciones específicas para la característica. |
