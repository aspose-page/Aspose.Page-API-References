...
description: "Describe la hoja de cubierta frontal inicial."
type: docs
weight: 68
url: /es/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Describe la hoja de cubierta frontal (inicial). Todo el trabajo tendrá una sola hoja primaria. La hoja de cubierta debe imprimirse en el  PageMediaSize  y  PageMediaType  utilizados para la primera página del trabajo. La hoja de cubierta debe integrarse en las opciones de procesamiento (como  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) según lo indicado por la Opción especificada. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Métodos
