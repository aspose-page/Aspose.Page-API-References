...
description: "Describe la hoja de banner que se emitirá para el trabajo."
type: docs
weight: 64
url: /es/java/com.aspose.xps.metadata/jobprimarybannersheet/
---
**Inheritance:**
...
Describe la hoja de banner que se debe generar para el trabajo. La hoja de banner debe generarse con el  PageMediaSize  predeterminado y usando el  PageMediaType  predeterminado. La hoja de banner debe estar aislada del resto del trabajo. Esto significa que cualquier opción de acabado o procesamiento (como  JobDuplexAllDocumentsContiguously ,  JobStapleAllDocuments , o  JobBindAllDocuments ) no debe incluir la hoja de banner. La hoja de banner debe aparecer como la primera hoja del trabajo.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobPrimaryBannerSheet(JobPrimaryBannerSheet.BannerSheetOption[] options)](#JobPrimaryBannerSheet-com.aspose.xps.metadata.JobPrimaryBannerSheet.BannerSheetOption...-) | Crea una nueva instancia. |
## Métodos
