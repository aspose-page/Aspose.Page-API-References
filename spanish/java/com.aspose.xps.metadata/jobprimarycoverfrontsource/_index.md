...
description: "Especifica la fuente para una hoja primaria de portada personalizada para el trabajo."
type: docs
weight: 69
url: /es/java/com.aspose.xps.metadata/jobprimarycoverfrontsource/
---
**Inheritance:**
...
Especifica la fuente para una hoja principal de portada personalizada para el trabajo. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfrontsource
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobPrimaryCoverFrontSource(String value)](#JobPrimaryCoverFrontSource-java.lang.String-) | Crea una nueva instancia. |
## Métodos
