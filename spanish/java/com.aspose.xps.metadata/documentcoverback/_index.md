...
type: docs
weight: 19
url: /es/java/com.aspose.xps.metadata/documentcoverback/
---
**Inheritance:**
...
Describe la hoja de cubierta trasera (final). Cada documento tendrá una hoja separada. La hoja de cubierta debe imprimirse en el PageMediaSize y PageMediaType utilizados para la página final del documento. La hoja de cubierta debe integrarse en las opciones de procesamiento (como DocumentDuplex, DocumentNUp) según lo indique la Opción especificada. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentCoverBack(DocumentCoverBack.CoverBackOption[] options)](#DocumentCoverBack-com.aspose.xps.metadata.DocumentCoverBack.CoverBackOption...-) | Crea una nueva instancia. |
## Métodos
