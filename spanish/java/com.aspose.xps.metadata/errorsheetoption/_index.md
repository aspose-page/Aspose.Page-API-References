...
description: "Describe las opciones de la característica JobErrorSheet."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/joberrorsheet.errorsheetoption/
---
**Inheritance:**
...
Describe las opciones de la función JobErrorSheet.
## Campos

| Campo | Descripción |
| --- | --- |
| [Custom](#Custom) | Especifica que se debe generar una hoja de error personalizada. |
| [None](#None) | Especifica que no se debe generar ninguna hoja de error. |
| [Standard](#Standard) | Especifica que se debe generar la hoja de error estándar (definida por el dispositivo). |
## Métodos
...
Especifica que se debe generar una hoja de error personalizada. Si no se especifica un elemento  JobErrorSheetSource   ParameterInit , esta Opción debe ser ignorada.
