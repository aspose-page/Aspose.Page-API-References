...
description: "Describe las opciones de la característica DocumentSeparatorSheet."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/documentseparatorsheet.documentseparatorsheetoption/
---
**Inheritance:**
...
Describe las opciones de la característica **DocumentSeparatorSheet**.
## Campos

| Campo | Descripción |
| --- | --- |
| [BothSheets](#BothSheets) | Especifica una hoja separadora al inicio y al final del documento. |
| [EndSheet](#EndSheet) | Especifica una hoja separadora al final del documento. |
| [None](#None) | Especifica que no hay hoja(s) separadora(s). |
| [StartSheet](#StartSheet) | Especifica una hoja separadora al inicio del documento. |
## Métodos
