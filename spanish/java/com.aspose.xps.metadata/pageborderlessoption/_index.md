...
description: "Describe las opciones de la característica PageBorderless."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pageborderless.pageborderlessoption/
---
**Inheritance:**
...
Describe las opciones de la característica PageBorderless.
## Campos

| Campo | Descripción |
| --- | --- |
| [Borderless](#Borderless) | Especifica impresión sin bordes. |
| [None](#None) | Especifica que no hay impresión sin bordes. |
## Métodos
...
Especifica impresión sin bordes.
...
Especifica que no hay impresión sin bordes.
