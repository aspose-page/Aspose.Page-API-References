...
description: "La clase base para las clases de propiedades JobName y DocumentName."
type: docs
weight: 75
url: /es/java/com.aspose.xps.metadata/nameproperty/
---
**Inheritance:**
...
La clase base para las clases de propiedades JobName y DocumentName.
## Métodos
