...
description: "Define constantes para el valor de la propiedad puntuada BackCoating."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pagemediatype.backcoating/
---
**Inheritance:**
...
Define constantes para el valor de la propiedad puntuado  BackCoating  .
## Campos

| Campo | Descripción |
| --- | --- |
| [Glossy](#Glossy) | Valor brillante. |
| [HighGloss](#HighGloss) | Valor de alto brillo. |
| [Matte](#Matte) | Valor mate. |
| [None](#None) | Valor None. |
| [Satin](#Satin) | Valor satinado. |
| [SemiGloss](#SemiGloss) | Valor semibrillante. |
## Métodos
