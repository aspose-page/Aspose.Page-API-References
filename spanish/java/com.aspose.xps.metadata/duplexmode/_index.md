...
description: "Define los valores posibles de la propiedad puntuado DuplexMode de DuplexOptions."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/duplex.duplexmode/
---
**Inheritance:**
...
Define los valores posibles de la propiedad **DuplexMode** de **DuplexOption**.
## Campos

| Campo | Descripción |
| --- | --- |
| [Automatic](#Automatic) | Valor automático. |
