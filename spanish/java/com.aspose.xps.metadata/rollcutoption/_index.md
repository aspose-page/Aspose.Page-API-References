...
description: "Describe las opciones de características JobRollCutAtEndOfJob y DocumentRollCut."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Describe las opciones de las características JobRollCutAtEndOfJob y DocumentRollCut.
## Campos

| Campo | Descripción |
| --- | --- |
| [Banner](#Banner) | Especifica el método de corte para el banner (solo DocumentRollCut). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Especifica el corte en el borde de la imagen. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Especifica el corte para tamaño de medio estándar. |
| [None](#None) | Especifica que no hay corte de rollo de trabajo. |
## Métodos
...
Especifica el método de corte para el banner (solo DocumentRollCut).
...
Especifica el corte para tamaño de medio estándar.
...
Especifica que no hay corte de rollo de trabajo.
