...
description: "Describe las características de ordenación de la salida."
type: docs
weight: 47
url: /es/java/com.aspose.xps.metadata/jobcollatealldocuments/
---
**Inheritance:**
...
Describe las características de encuadernación de la salida. Todos los documentos en cada trabajo individual se encuadernan.  DocumentCollate  y  JobCollateAllDocuments  son mutuamente excluyentes. El comportamiento e implementación de si se implementan ambos o solo uno de estas palabras clave queda a cargo del controlador. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcollatealldocuments
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobCollateAllDocuments(Collate.CollateOption[] options)](#JobCollateAllDocuments-com.aspose.xps.metadata.Collate.CollateOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [CollateOption\[\]](../../com.aspose.xps.metadata/collateoption) | Una matriz de opciones específicas para la característica. |
