...
description: "Describe las características dúplex de la salida."
type: docs
weight: 52
url: /es/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Describe las características de dúplex de la salida. La función dúplex permite imprimir en ambas caras del medio. Todos los Documentos en el trabajo se imprimen en dúplex de forma contigua. JobDuplexAllDocumentsContiguously y DocumentDuplex son mutuamente excluyentes. Depende del controlador determinar el manejo de restricciones entre estas palabras clave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [DuplexOption\[\]](../../com.aspose.xps.metadata/duplexoption) | Una matriz de opciones específicas para la característica. |
