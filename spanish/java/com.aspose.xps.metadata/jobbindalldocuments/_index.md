...
type: docs
weight: 45
url: /es/java/com.aspose.xps.metadata/jobbindalldocuments/
---
**Inheritance:**
...
Describe el método de encuadernación. Todos los documentos del trabajo se encuadernan juntos. JobBindAllDocuments y DocumentBinding son mutuamente excluyentes. Depende del controlador determinar el manejo de restricciones entre estas palabras clave. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobbindalldocuments
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobBindAllDocuments(JobBindAllDocuments.BindingOption[] options)](#JobBindAllDocuments-com.aspose.xps.metadata.JobBindAllDocuments.BindingOption...-) | Crea una nueva instancia. |
## Métodos
