...
description: "Define constantes para el valor de la propiedad puntuado FeedDirection."
type: docs
weight: 11
url: /es/java/com.aspose.xps.metadata/inputbin.feeddirection/
---
**Inheritance:**
...
Define constantes para el valor de la propiedad evaluada FeedDirection.
## Campos

| Campo | Descripción |
| --- | --- |
| [LongEdgeFirst](#LongEdgeFirst) | Valor LongEdgeFirst. |
| [ShortEdgeFirst](#ShortEdgeFirst) | Valor LongEdgeFirst. |
## Métodos
