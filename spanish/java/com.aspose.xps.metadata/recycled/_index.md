...
description: "Define constantes para el valor de la propiedad Recycled scored."
type: docs
weight: 16
url: /es/java/com.aspose.xps.metadata/pagemediatype.recycled/
---
**Inheritance:**
...
Define constantes para el valor de propiedad puntuado Recycled.
## Campos

| Campo | Descripción |
| --- | --- |
| [None](#None) | Valor None. |
| [Standard](#Standard) | Valor estándar. |
## Métodos
