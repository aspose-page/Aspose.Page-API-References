...
description: "Describe los idiomas del dispositivo compatibles para enviar datos del controlador al dispositivo físico."
type: docs
weight: 50
url: /es/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
Describe los lenguajes de dispositivo compatibles para enviar datos del controlador al dispositivo físico. A menudo se llama "Lenguaje de Descripción de Página". Esta palabra clave define qué lenguaje de descripción de página es compatible con el controlador y el dispositivo físico. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdevicelanguage
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | Una matriz de opciones específicas para la característica. |
