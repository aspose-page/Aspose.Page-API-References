...
description: "Describe el uso de la hoja separadora para un documento."
type: docs
weight: 34
url: /es/java/com.aspose.xps.metadata/documentseparatorsheet/
---
**Inheritance:**
...
Describe el uso de la hoja separadora para un documento. Las hojas separadoras deben aparecer en la salida según lo indicado por la Opción especificada a continuación. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentSeparatorSheet(DocumentSeparatorSheet.DocumentSeparatorSheetOption[] options)](#DocumentSeparatorSheet-com.aspose.xps.metadata.DocumentSeparatorSheet.DocumentSeparatorSheetOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [DocumentSeparatorSheetOption\[\]](../../com.aspose.xps.metadata/documentseparatorsheetoption) | Una matriz de opciones específicas para la característica. |
