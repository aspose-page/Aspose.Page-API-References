...
description: "La clase base para las clases de características JobDuplexAllDocumentsContiguously y DocumentDuplex."
type: docs
weight: 37
url: /es/java/com.aspose.xps.metadata/duplex/
---
**Inheritance:**
...
La clase base para las clases de características **JobDuplexAllDocumentsContiguously** y **DocumentDuplex**.
## Métodos
