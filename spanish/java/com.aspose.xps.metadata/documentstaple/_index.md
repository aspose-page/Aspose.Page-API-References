...
type: docs
weight: 35
url: /es/java/com.aspose.xps.metadata/documentstaple/
---
**Inheritance:**
...
Describe las características de engrampado de la salida. Cada documento se engrapa por separado. Las palabras clave  JobStapleAllDocuments  y  DocumentStaple  son mutuamente exclusivas. Depende del controlador determinar el manejo de restricciones entre estas palabras clave. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentstaple
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentStaple(Staple.StapleOption[] options)](#DocumentStaple-com.aspose.xps.metadata.Staple.StapleOption...-) | Crea una nueva instancia. |
## Métodos
