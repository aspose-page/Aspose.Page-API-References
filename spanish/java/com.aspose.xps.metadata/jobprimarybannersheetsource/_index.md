...
description: "Especifica la fuente para una hoja de banner personalizada primaria para el trabajo."
type: docs
weight: 65
url: /es/java/com.aspose.xps.metadata/jobprimarybannersheetsource/
---
**Inheritance:**
...
Especifica la fuente para una hoja de banner personalizada primaria para el trabajo. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarybannersheetsource
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobPrimaryBannerSheetSource(String value)](#JobPrimaryBannerSheetSource-java.lang.String-) | Crea una nueva instancia. |
## Métodos
