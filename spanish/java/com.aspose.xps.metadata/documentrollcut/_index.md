...
description: "Describe el método de corte para papel continuo."
type: docs
weight: 33
url: /es/java/com.aspose.xps.metadata/documentrollcut/
---
**Inheritance:**
...
Describe el método de corte para papel continuo. Cada documento se maneja por separado. Las opciones especificadas describen los diferentes métodos para el corte de rollo. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentrollcut
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentRollCut(RollCut.RollCutOption[] options)](#DocumentRollCut-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [RollCutOption\[\]](../../com.aspose.xps.metadata/rollcutoption) | Una matriz de opciones específicas para la característica. |
