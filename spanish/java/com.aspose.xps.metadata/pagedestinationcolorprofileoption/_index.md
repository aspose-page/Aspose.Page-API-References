...
description: "Describe las opciones de la característica PageDestinationColorProfile."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Describe las opciones de la característica PageDestinationColorProfile.
## Campos

| Campo | Descripción |
| --- | --- |
| [Application](#Application) | La aplicación especifica el perfil de destino que se utilizará. |
| [DriverConfiguration](#DriverConfiguration) | Perfil de destino utilizado para realizar la gestión del color. |
## Métodos
