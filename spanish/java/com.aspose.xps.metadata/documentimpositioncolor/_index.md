...
type: docs
weight: 26
url: /es/java/com.aspose.xps.metadata/documentimpositioncolor/
---
**Inheritance:**
...
El contenido de la aplicación etiquetado con el color nombrado especificado DEBE aparecer en todas las separaciones de color. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentimpositioncolor
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentImpositionColor(String value)](#DocumentImpositionColor-java.lang.String-) | Crea una nueva instancia. |
## Métodos
