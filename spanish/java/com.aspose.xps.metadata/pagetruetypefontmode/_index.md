...
description: "Describe el método de manejo de fuentes TrueType que se utilizará."
type: docs
weight: 130
url: /es/java/com.aspose.xps.metadata/pagetruetypefontmode/
---
**Inheritance:**
...
Describe el método de manejo de fuentes TrueType que se usará. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagetruetypefontmode
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageTrueTypeFontMode(PageTrueTypeFontMode.PageTrueTypeFontModeOption[] options)](#PageTrueTypeFontMode-com.aspose.xps.metadata.PageTrueTypeFontMode.PageTrueTypeFontModeOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [PageTrueTypeFontModeOption\[\]](../../com.aspose.xps.metadata/pagetruetypefontmodeoption) | Una matriz de opciones específicas para la característica. |
