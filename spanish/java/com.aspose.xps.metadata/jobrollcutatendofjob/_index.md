...
type: docs
weight: 71
url: /es/java/com.aspose.xps.metadata/jobrollcutatendofjob/
---
**Inheritance:**
...
Describe el método de corte para papel en rollo. El rollo debe cortarse al final del trabajo. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobrollcutatendofjob
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobRollCutAtEndOfJob(RollCut.RollCutOption[] options)](#JobRollCutAtEndOfJob-com.aspose.xps.metadata.RollCut.RollCutOption...-) | Crea una nueva instancia. |
## Métodos
