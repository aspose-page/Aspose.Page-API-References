...
description: "Describe las características de perforado de la salida."
type: docs
weight: 55
url: /es/java/com.aspose.xps.metadata/jobholepunch/
---
**Inheritance:**
...
Describe las características de perforación del resultado. Todos los documentos se perforan juntos. Las palabras clave  JobHolePunch  y  DocumentHolePunch  son mutuamente exclusivas. No deben especificarse simultáneamente en un documento PrintTicket o Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobholepunch
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobHolePunch(HolePunch.HolePunchOption[] options)](#JobHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [HolePunchOption\[\]](../../com.aspose.xps.metadata/holepunchoption) | Una matriz de opciones específicas para la característica. |
