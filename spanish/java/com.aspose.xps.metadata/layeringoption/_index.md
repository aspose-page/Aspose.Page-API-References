...
description: "Describe las opciones de la característica Layering."
type: docs
weight: 11
url: /es/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Describe las opciones de la característica Layering.
## Campos

| Campo | Descripción |
| --- | --- |
| [Overlay](#Overlay) | La marca de agua aparece sobre el contenido de la página. |
| [Underlay](#Underlay) | La marca de agua aparece bajo el contenido de la página. |
## Métodos
...
La marca de agua aparece bajo el contenido de la página.
