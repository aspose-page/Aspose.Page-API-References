...
description: "Define constantes para el valor de la propiedad puntuado MediaTypeAutoSense."
type: docs
weight: 19
url: /es/java/com.aspose.xps.metadata/inputbin.mediatypeautosense/
---
**Inheritance:**
...
Define constantes para el valor de la propiedad evaluada MediaTypeAutoSense.
## Campos

| Campo | Descripción |
| --- | --- |
| [None](#None) | Valor None. |
| [Supported](#Supported) | Valor compatible. |
## Métodos
