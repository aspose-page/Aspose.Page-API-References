...
description: "Especifica la fuente para una hoja primaria de contraportada personalizada para el trabajo."
type: docs
weight: 67
url: /es/java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Especifica la fuente para una hoja principal de contraportada personalizada para el trabajo. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Crea una nueva instancia. |
## Métodos
