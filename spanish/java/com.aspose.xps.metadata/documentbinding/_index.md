...
description: "Describe el método de encuadernación."
type: docs
weight: 15
url: /es/java/com.aspose.xps.metadata/documentbinding/
---
**Inheritance:**
...
Describe el método de encuadernación. Cada documento se encuaderna por separado. DocumentBinding y JobBindAllDocuments son mutuamente excluyentes. Depende del controlador determinar el manejo de restricciones entre palabras clave. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentbinding
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentBinding(DocumentBinding.BindingOption[] options)](#DocumentBinding-com.aspose.xps.metadata.DocumentBinding.BindingOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [BindingOption\[\]](../../com.aspose.xps.metadata/bindingoption) | Una matriz de opciones específicas para la característica. |
