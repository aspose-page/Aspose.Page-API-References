...
description: "Define las características del perfil de color de destino."
type: docs
weight: 91
url: /es/java/com.aspose.xps.metadata/pagedestinationcolorprofile/
---
**Inheritance:**
...
Define las características del perfil de color de destino. Describe si la aplicación o el controlador seleccionan el perfil de color de destino que se utilizará. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagedestinationcolorprofile
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageDestinationColorProfile(PageDestinationColorProfile.PageDestinationColorProfileOption[] options)](#PageDestinationColorProfile-com.aspose.xps.metadata.PageDestinationColorProfile.PageDestinationColorProfileOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [PageDestinationColorProfileOption\[\]](../../com.aspose.xps.metadata/pagedestinationcolorprofileoption) | Una matriz de opciones específicas para la característica. |
