...
description: "Especifica la fuente para una hoja de error personalizada."
type: docs
weight: 54
url: /es/java/com.aspose.xps.metadata/joberrorsheetsource/
---
**Inheritance:**
...
Especifica la fuente para una hoja de error personalizada. https://docs.microsoft.com/en-us/windows/win32/printdocs/joberrorsheetsource
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobErrorSheetSource(String value)](#JobErrorSheetSource-java.lang.String-) | Crea una nueva instancia. |
## Métodos
