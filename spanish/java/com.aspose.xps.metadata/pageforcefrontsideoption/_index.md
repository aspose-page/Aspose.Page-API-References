...
description: "Describe las opciones de la característica PageForceFrontSide."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pageforcefrontside.pageforcefrontsideoption/
---
**Inheritance:**
...
Describe las opciones de la característica  PageForceFrontSide  .
## Campos

| Campo | Descripción |
| --- | --- |
| [ForceFrontSide](#ForceFrontSide) | Especifica que la salida está restringida al lado frontal de la hoja. |
| [None](#None) | Especifica que no hay restricciones de salida. |
## Métodos
...
Especifica que la salida está restringida al lado frontal de la hoja.
...
Especifica que no hay restricciones de salida.
