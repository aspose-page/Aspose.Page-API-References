...
description: "Describe el procesamiento del trabajo destinado a optimizar la salida para escenarios de uso particulares según la opción especificada."
type: docs
weight: 62
url: /es/java/com.aspose.xps.metadata/joboutputoptimization/
---
**Inheritance:**
...
Describe el procesamiento del trabajo, destinado a optimizar la salida para escenarios de uso particulares según la opción especificada. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputoptimization
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobOutputOptimization(JobOutputOptimization.JobOutputOptimizationOption[] options)](#JobOutputOptimization-com.aspose.xps.metadata.JobOutputOptimization.JobOutputOptimizationOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [JobOutputOptimizationOption\[\]](../../com.aspose.xps.metadata/joboutputoptimizationoption) | Una matriz de opciones específicas para la característica. |
