...
description: "La clase de conveniencia para la propiedad SelectionType del PrintTicket."
type: docs
weight: 147
url: /es/java/com.aspose.xps.metadata/selectiontype/
---
**Inheritance:**
...
La clase de conveniencia para la propiedad SelectionType del PrintTicket.
## Campos

| Campo | Descripción |
| --- | --- |
| [PickMany](#PickMany) | Valor PickMany. |
| [PickOne](#PickOne) | Valor PickOne. |
## Métodos
