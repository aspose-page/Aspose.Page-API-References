...
description: "Especifica un comentario asociado al trabajo."
type: docs
weight: 48
url: /es/java/com.aspose.xps.metadata/jobcomment/
---
**Inheritance:**
...
Especifica un comentario asociado al trabajo. Ejemplo: "Por favor entregue en la habitación 1234 cuando esté completado". https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JobComment(String value)](#JobComment-java.lang.String-) | Crea una nueva instancia. |
## Métodos
