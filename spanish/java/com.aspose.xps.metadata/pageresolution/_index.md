...
description: "Define la resolución de página de la salida impresa como un valor cualitativo o como puntos por pulgada o ambos."
type: docs
weight: 120
url: /es/java/com.aspose.xps.metadata/pageresolution/
---
**Inheritance:**
...
Define la resolución de página de la salida impresa como un valor cualitativo o como puntos por pulgada, o ambos. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageresolution
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageResolution(PageResolution.IPageResolutionItem[] items)](#PageResolution-com.aspose.xps.metadata.PageResolution.IPageResolutionItem...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| items | [IPageResolutionItem\[\]](../../com.aspose.xps.metadata/ipageresolutionitem) | Una matriz de elementos específicos para la característica. |
