...
description: "Describe el espacio de color que debe usarse para operaciones de mezcla."
type: docs
weight: 86
url: /es/java/com.aspose.xps.metadata/pageblendcolorspace/
---
**Inheritance:**
...
Describe el espacio de color que debe usarse para operaciones de mezcla. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspace
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageBlendColorSpace(PageBlendColorSpace.PageBlendColorSpaceOption[] options)](#PageBlendColorSpace-com.aspose.xps.metadata.PageBlendColorSpace.PageBlendColorSpaceOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [PageBlendColorSpaceOption\[\]](../../com.aspose.xps.metadata/pageblendcolorspaceoption) | Una matriz de opciones específicas para la característica. |
