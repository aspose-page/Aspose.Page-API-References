...
description: "Describe las opciones de la característica PageBlendColorSpace."
type: docs
weight: 10
url: /es/java/com.aspose.xps.metadata/pageblendcolorspace.pageblendcolorspaceoption/
---
**Inheritance:**
...
Describe las opciones de la característica PageBlendColorSpace.
## Campos

| Campo | Descripción |
| --- | --- |
| [ICCProfile](#ICCProfile) | Especifica un perfil ICC que define el espacio de color que DEBE usarse para la fusión. |
| [sRGB](#sRGB) | El espacio de color sRGB DEBE usarse para la fusión. |
| [scRGB](#scRGB) | El espacio de color scRGB DEBE usarse para la fusión. |
## Métodos
...
Especifica un perfil ICC que define el espacio de color que DEBE usarse para la fusión. Nota: Esto se aplica solo a documentos XPS y no debe usarse en PrintTickets arbitrarios.
...
El espacio de color sRGB DEBE usarse para la fusión.
...
El espacio de color scRGB DEBE usarse para la fusión.
