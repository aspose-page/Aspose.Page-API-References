...
description: "Especifica una referencia URI relativa a un perfil ICC que define el espacio de color que DEBE usarse para la mezcla."
type: docs
weight: 87
url: /es/java/com.aspose.xps.metadata/pageblendcolorspaceiccprofileuri/
---
**Inheritance:**
...
Especifica una referencia URI relativa a un perfil ICC que define el espacio de color que DEBE usarse para la fusión. El <Uri> es una parte\_name absoluta relativa a la raíz del paquete. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspaceiccprofileuri
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI(String value)](#PageBlendColorSpaceICCProfileURI-java.lang.String-) | Crea una nueva instancia. |
## Métodos
