...
description: "Describe las opciones de Color de Medio y las características de cada opción."
type: docs
weight: 101
url: /es/java/com.aspose.xps.metadata/pagemediacolor/
---
**Inheritance:**
...
Describe las opciones de Color de Medio y las características de cada opción. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediacolor
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageMediaColor(PageMediaColor.PageMediaColorOption[] options)](#PageMediaColor-com.aspose.xps.metadata.PageMediaColor.PageMediaColorOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [PageMediaColorOption\[\]](../../com.aspose.xps.metadata/pagemediacoloroption) | Una matriz de opciones específicas para la característica. |
