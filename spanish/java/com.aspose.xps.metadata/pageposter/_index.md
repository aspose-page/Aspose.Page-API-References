...
description: "Describe la salida de una sola página a múltiples hojas de medio físico."
type: docs
weight: 118
url: /es/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Describe la salida de una sola página a múltiples hojas de medio físico. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Constructores
...
Agrega una opción con un valor de propiedad puntuada PagesPerSheet. Especifica el número de hojas físicas por página lógica.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | Un valor de propiedad puntuada PagesPerSheet. |
