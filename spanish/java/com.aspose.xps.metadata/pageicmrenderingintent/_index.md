...
description: "Describe la intención de renderizado según lo definido por la especificación ICC v2."
type: docs
weight: 98
url: /es/java/com.aspose.xps.metadata/pageicmrenderingintent/
---
**Inheritance:**
...
Describe la intención de renderizado según lo definido por la Especificación ICC v2. Este valor debe ser ignorado si una imagen o elemento gráfico tiene un perfil incrustado que especifica la intención de renderizado. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageicmrenderingintent
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PageICMRenderingIntent(PageICMRenderingIntent.PageICMRenderingIntentOption[] options)](#PageICMRenderingIntent-com.aspose.xps.metadata.PageICMRenderingIntent.PageICMRenderingIntentOption...-) | Crea una nueva instancia. |
## Métodos
...
| --- | --- | --- |
| options | [PageICMRenderingIntentOption\[\]](../../com.aspose.xps.metadata/pageicmrenderingintentoption) | Una matriz de opciones específicas para la característica. |
