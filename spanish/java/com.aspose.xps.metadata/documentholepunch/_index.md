...
type: docs
weight: 24
url: /es/java/com.aspose.xps.metadata/documentholepunch/
---
**Inheritance:**
...
Describe las características de perforación del documento de salida. Cada documento se perfora por separado. Las palabras clave  JobHolePunch  y  DocumentHolePunch  son mutuamente exclusivas. No deben especificarse simultáneamente en un documento de PrintTicket o de Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentholepunch
## Constructores

| Constructor | Descripción |
| --- | --- |
| [DocumentHolePunch(HolePunch.HolePunchOption[] options)](#DocumentHolePunch-com.aspose.xps.metadata.HolePunch.HolePunchOption...-) | Crea una nueva instancia. |
## Métodos
