...
type: docs
weight: 16
url: /es/java/com.aspose.page/saveoptions/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [SaveOptions()](#SaveOptions--) | Inicializar una nueva instancia de SaveOptions con valores predeterminados para las banderas  suppressErrors  (true) y  debug  (false). |
| [SaveOptions(boolean supressErrors)](#SaveOptions-boolean-) | Inicializar una nueva instancia de SaveOptions con el valor predeterminado para la bandera  debug  (false). |
| [SaveOptions(Dimension size)](#SaveOptions-java.awt.Dimension-) | Inicializa una nueva instancia de  SaveOptions  con el tamaño especificado. |
| [SaveOptions(boolean supressErrors, Dimension size)](#SaveOptions-boolean-java.awt.Dimension-) | Inicializar una nueva instancia de SaveOptions con el valor predeterminado para la bandera  debug  (false) y con el tamaño especificado. |
## Métodos
...
Inicializar una nueva instancia de SaveOptions con valores predeterminados para las banderas  suppressErrors  (true) y  debug  (false).
...
Inicializar una nueva instancia de SaveOptions con el valor predeterminado para la bandera  debug  (false).
...
Inicializa una nueva instancia de  SaveOptions  con el tamaño especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| size | java.awt.Dimension | El tamaño. |
...
Inicializar una nueva instancia de SaveOptions con el valor predeterminado para la bandera  debug  (false) y con el tamaño especificado.
