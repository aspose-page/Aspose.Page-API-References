...
description: "Representa opciones del convertidor de PS/EPS a PDF para el complemento."
type: docs
weight: 13
url: /es/java/com.aspose.eps.plugins/psconvertertopdfoptions/
---
**Inheritance:**
...
Representa opciones del convertidor de PS/EPS a PDF para el complemento [PsConverter](../../com.aspose.eps.plugins/psconverter).
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PsConverterToPdfOptions()](#PsConverterToPdfOptions--) | Inicializa una nueva instancia del objeto [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions). |
## Métodos
...
Inicializa una nueva instancia del objeto [PsConverterToPdfOptions](../../com.aspose.eps.plugins/psconvertertopdfoptions).
