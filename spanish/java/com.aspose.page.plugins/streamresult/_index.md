...
description: "Representa el resultado de la operación en forma de flujo."
type: docs
weight: 18
url: /es/java/com.aspose.page.plugins/streamresult/
---
**Inheritance:**
java.lang.Object
...
Representa el resultado de la operación en forma de flujo.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [StreamResult(OutputStream stream)](#StreamResult-java.io.OutputStream-) | Inicializa una nueva instancia con el objeto de flujo especificado. |
## Métodos
...
Inicializa una nueva instancia con el objeto de flujo especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| flujo | java.io.OutputStream | Objeto de flujo |
