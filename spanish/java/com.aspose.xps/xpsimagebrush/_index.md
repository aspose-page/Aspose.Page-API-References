...
description: "Clase que encapsula características del elemento de propiedad ImageBrush."
type: docs
weight: 33
url: /es/java/com.aspose.xps/xpsimagebrush/
---
**Inheritance:**
...
Clase que encapsula características del elemento de propiedad ImageBrush. Este elemento se utiliza para rellenar una región con una imagen.
## Métodos

| Método | Descripción |
| --- | --- |
| [deepClone()](#deepClone--) | Clona este pincel de imagen. |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getClass()](#getClass--) |  |
| [getImage()](#getImage--) | Devuelve el recurso de imagen utilizado para el pincel. |
| [getImageSource()](#getImageSource--) | Devuelve el URI de un recurso de imagen. |
...
Devuelve el URI de un recurso de imagen.

**Returns:**
java.lang.String - El URI de un recurso de imagen.
