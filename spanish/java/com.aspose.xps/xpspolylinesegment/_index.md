...
description: "Clase que encapsula características del elemento PolyLineSegment."
type: docs
weight: 46
url: /es/java/com.aspose.xps/xpspolylinesegment/
---
**Inheritance:**
...
Clase que encapsula características del elemento PolyLineSegment. Este elemento describe un dibujo polygonal que contiene un número arbitrario de vértices individuales.
## Métodos

| Método | Descripción |
| --- | --- |
| [deepClone()](#deepClone--) | Clona este polígono. |
