...
description: "Clase que encapsula características del elemento PolyBezierSegment."
type: docs
weight: 45
url: /es/java/com.aspose.xps/xpspolybeziersegment/
---
**Inheritance:**
...
Clase que encapsula las características del elemento PolyBezierSegment. Este elemento describe un conjunto de curvas cúbicas B?zier.
## Métodos

| Método | Descripción |
| --- | --- |
| [deepClone()](#deepClone--) | Clona este conjunto de curvas cúbicas B?bezier. |
...
Clona este conjunto de curvas cúbicas B?bezier.
