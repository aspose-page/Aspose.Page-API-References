...
description: "La clase Size2D describe dimensiones w x h."
type: docs
weight: 12
url: /es/java/com.aspose.xps/size2d/
---
**Inheritance:**
...
La clase `Size2D` describe dimensiones (w x h).

Esta clase es solo la superclase abstracta para todos los objetos que almacenan dimensiones 2D. La representación de almacenamiento real de las dimensiones se deja a la subclase.
## Constructores
