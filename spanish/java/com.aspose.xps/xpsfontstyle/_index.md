...
description: "Valores válidos para los estilos de fuente."
type: docs
weight: 60
url: /es/java/com.aspose.xps/xpsfontstyle/
---
**Inheritance:**
...
Valores válidos para los estilos de fuente.
## Campos

| Campo | Descripción |
| --- | --- |
| [Bold](#Bold) | Texto en negrita. |
| [BoldItalic](#BoldItalic) | Texto en negrita cursiva. |
