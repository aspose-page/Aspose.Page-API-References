...
description: "Clase para opciones de guardado XPS-as-JPEG."
type: docs
weight: 12
url: /es/java/com.aspose.xps.rendering/jpegsaveoptions/
---
**Inheritance:**
...
Clase para opciones de guardado XPS-as-JPEG.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [JpegSaveOptions()](#JpegSaveOptions--) | Crea una nueva instancia de opciones. |
## Métodos
