...
description: "Clase para opciones de guardado XPS-as-PNG."
type: docs
weight: 15
url: /es/java/com.aspose.xps.rendering/pngsaveoptions/
---
**Inheritance:**
...
Clase para opciones de guardado XPS-as-PNG.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PngSaveOptions()](#PngSaveOptions--) | Crea una nueva instancia de opciones. |
## Métodos
