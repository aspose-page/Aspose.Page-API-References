...
description: "Clase para opciones de guardado XPS-as-TIFF."
type: docs
weight: 16
url: /es/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Clase para opciones de guardado XPS-as-TIFF.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Crea una nueva instancia de opciones. |
## Métodos
...
| [multipage()](#multipage--) | Obtiene la bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina. |
| [multipage(boolean value)](#multipage-boolean-) | Establece la bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Obtiene la bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina.

**Returns:**
boolean - La bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina.
...
Establece la bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | boolean | La bandera que define si varias imágenes deben guardarse en un solo archivo TIFF multipágina. |
