...
description: "Clase para opciones de guardado XPS-as-BMP."
type: docs
weight: 10
url: /es/java/com.aspose.xps.rendering/bmpsaveoptions/
---
**Inheritance:**
...
Clase para opciones de guardado XPS-as-BMP.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [BmpSaveOptions()](#BmpSaveOptions--) | Crea una nueva instancia de opciones. |
## Métodos
