...
| Nama | Keterangan |
| --- | --- |
| [PageMediaSizePSOrientation](pagemediasizepsorientation/)(int) | Membuat instance baru. |

## Properti

| Nama | Keterangan |
| --- | --- |
| override [MaxValue](../../aspose.page.xps.xpsmetadata/pagemediasizepsorientation/maxvalue/) { get; } | Untuk parameter bernilai bilangan bulat atau desimal, tentukan nilai terbesar yang diperbolehkan. |
| override [MinValue](../../aspose.page.xps.xpsmetadata/pagemediasizepsorientation/minvalue/) { get; } | Untuk parameter bernilai bilangan bulat atau desimal, tentukan nilai terkecil yang diperbolehkan. |
