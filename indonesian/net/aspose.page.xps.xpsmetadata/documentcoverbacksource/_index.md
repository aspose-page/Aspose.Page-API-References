...
Menentukan sumber untuk lembar sampul belakang khusus. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverbacksource
...
| Nama | Keterangan |
| --- | --- |
| [DocumentCoverBackSource](documentcoverbacksource/)(string) | Membuat instance baru. |
