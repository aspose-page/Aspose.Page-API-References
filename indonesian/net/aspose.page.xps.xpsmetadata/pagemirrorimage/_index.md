...
Menjelaskan pengaturan pencerminan keluaran. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemirrorimage
...
| Nama | Keterangan |
| --- | --- |
| [PageMirrorImage](pagemirrorimage/)(params PageMirrorImageOption[]) | Membuat instance baru. |
...
| Nama | Keterangan |
| --- | --- |
| class [PageMirrorImageOption](pagemirrorimage.pagemirrorimageoption/) | Mendefinisikan`PageMirrorImage` opsi fitur. |
