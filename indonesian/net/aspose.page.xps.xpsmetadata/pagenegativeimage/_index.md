...
Menjelaskan pengaturan negatif dari keluaran. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagenegativeimage
...
| Nama | Keterangan |
| --- | --- |
| [PageNegativeImage](pagenegativeimage/)(params PageNegativeImageOption[]) | Membuat instance baru. |
...
| Nama | Keterangan |
| --- | --- |
| class [PageNegativeImageOption](pagenegativeimage.pagenegativeimageoption/) | Mendefinisikan`PageNegativeImage` opsi fitur. |
