...
Menjelaskan penggunaan lembar pemisah untuk dokumen. Lembar pemisah akan muncul di keluaran seperti yang ditunjukkan oleh Opsi yang ditentukan di bawah. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentseparatorsheet
...
| Nama | Keterangan |
| --- | --- |
| [DocumentSeparatorSheet](documentseparatorsheet/)(params DocumentSeparatorSheetOption[]) | Membuat instance baru. |
...
| Nama | Keterangan |
| --- | --- |
| class [DocumentSeparatorSheetOption](documentseparatorsheet.documentseparatorsheetoption/) | Menjelaskan`DocumentSeparatorSheet` opsi fitur. |
