...
Menjelaskan kapan konten gambar harus dicetak ke tepi fisik media. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageborderless
...
| Nama | Keterangan |
| --- | --- |
| [PageBorderless](pageborderless/)(params PageBorderlessOption[]) | Membuat instance baru. |
...
| Nama | Keterangan |
| --- | --- |
| class [PageBorderlessOption](pageborderless.pageborderlessoption/) | Menjelaskan`PageBorderless` opsi fitur. |
