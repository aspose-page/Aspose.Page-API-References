...
Menentukan komentar yang terkait dengan pekerjaan. Contoh: "Harap antar ke kamar 1234 jika sudah selesai". https://docs.microsoft.com/en-us/windows/win32/printdocs/jobcomment
...
| Nama | Keterangan |
| --- | --- |
| [JobComment](jobcomment/)(string) | Membuat instance baru. |
