...
description: "System::setter_post_increment_wrap method. Translator menerjemahkan ekspresi post‑increment C#''s yang menargetkan properti instance''s yang memiliki setter dan getter yang didefinisikan, menjadi pemanggilan fungsi ini (overload untuk const getter) dalam C++."
type: docs
weight: 37900
url: /id/cpp/system/setter_post_increment_wrap/
---
## System::setter_post_increment_wrap(Host *const, T(HostConstGet::*)() const, void(HostSet::*)(T)) method


Translator menerjemahkan ekspresi post‑increment C#'s yang menargetkan properti instance's yang memiliki setter dan getter yang didefinisikan, menjadi pemanggilan fungsi ini (overload untuk const getter).
...
Penerjemah menerjemahkan ekspresi post-inkrement C# yang menargetkan properti instance yang memiliki setter dan getter yang didefinisikan, menjadi pemanggilan fungsi ini (overload untuk non-const getter).
...
Penerjemah menerjemahkan ekspresi post-inkrement C# yang menargetkan properti kelas yang memiliki setter dan getter yang didefinisikan, menjadi pemanggilan fungsi ini.
