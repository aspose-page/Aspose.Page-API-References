...
description: "Menjelaskan lembar penutup belakang."
type: docs
weight: 66
url: /id/java/com.aspose.xps.metadata/jobprimarycoverback/
---
**Inheritance:**
...
Menjelaskan lembar penutup belakang (ending). Setiap pekerjaan akan memiliki lembar utama terpisah. Lembar penutup harus dicetak pada  PageMediaSize  dan  PageMediaType  yang digunakan untuk halaman akhir pekerjaan. Lembar penutup harus diintegrasikan ke dalam opsi pemrosesan (seperti  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) sebagaimana ditunjukkan oleh Opsi yang ditentukan. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverback
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobPrimaryCoverBack(JobPrimaryCoverBack.CoverBackOption[] options)](#JobPrimaryCoverBack-com.aspose.xps.metadata.JobPrimaryCoverBack.CoverBackOption...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| options | [CoverBackOption\[\]](../../com.aspose.xps.metadata/coverbackoption) | Sebuah array opsi yang spesifik untuk fitur. |
