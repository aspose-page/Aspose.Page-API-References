...
type: docs
weight: 17
url: /id/java/com.aspose.xps.metadata/documentcollate/
---
**Inheritance:**
...
Menjelaskan karakteristik penggabungan output. Semua halaman dalam setiap dokumen individu digabungkan. DocumentCollate dan JobCollateAlldocuments saling eksklusif. Perilaku dan implementasi apakah kedua kata kunci ini atau hanya salah satunya yang diimplementasikan diserahkan kepada driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcollate
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [DocumentCollate(Collate.CollateOption[] options)](#DocumentCollate-com.aspose.xps.metadata.Collate.CollateOption...-) | Membuat sebuah instance baru. |
## Metode
