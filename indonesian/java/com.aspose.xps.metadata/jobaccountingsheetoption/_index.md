...
description: "Menjelaskan opsi fitur JobAccountingSheet."
type: docs
weight: 10
url: /id/java/com.aspose.xps.metadata/jobaccountingsheet.jobaccountingsheetoption/
---
**Inheritance:**
...
Menjelaskan opsi fitur  JobAccountingSheet .
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [None](#None) | Menentukan tidak ada lembar akuntansi yang akan dihasilkan. |
| [Standard](#Standard) | Menentukan lembar akuntansi standar (ditentukan perangkat) harus dihasilkan. |
## Metode
...
Menentukan tidak ada lembar akuntansi yang akan dihasilkan.
...
Menentukan lembar akuntansi standar (ditentukan perangkat) harus dihasilkan.
