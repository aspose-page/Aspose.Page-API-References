...
description: "Menjelaskan output satu halaman ke beberapa lembar media fisik."
type: docs
weight: 118
url: /id/java/com.aspose.xps.metadata/pageposter/
---
**Inheritance:**
...
Menjelaskan output satu halaman ke beberapa lembar media fisik. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageposter
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [PagePoster()](#PagePoster--) | Membuat sebuah instance baru. |
## Metode
...
Menambahkan opsi dengan nilai properti  PagesPerSheet  yang diukur. Menentukan jumlah lembar fisik per halaman logis.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | int | Nilai properti  PagesPerSheet  yang diukur. |
