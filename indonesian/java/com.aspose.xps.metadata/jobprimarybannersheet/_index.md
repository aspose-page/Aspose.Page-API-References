...
description: "Menjelaskan lembar spanduk yang akan dikeluarkan untuk pekerjaan."
type: docs
weight: 64
url: /id/java/com.aspose.xps.metadata/jobprimarybannersheet/
---
**Inheritance:**
...
Menjelaskan lembar spanduk yang akan dikeluarkan untuk pekerjaan. Lembar spanduk harus dikeluarkan dengan  PageMediaSize  default dan menggunakan  PageMediaType  default. Lembar spanduk harus terisolasi dari sisa pekerjaan. Ini berarti bahwa opsi penyelesaian atau pemrosesan apa pun (seperti  JobDuplexAllDocumentsContiguously ,  JobStapleAllDocuments , atau  JobBindAllDocuments ) tidak boleh menyertakan lembar spanduk. Lembar spanduk harus muncul sebagai lembar pertama dalam pekerjaan.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobPrimaryBannerSheet(JobPrimaryBannerSheet.BannerSheetOption[] options)](#JobPrimaryBannerSheet-com.aspose.xps.metadata.JobPrimaryBannerSheet.BannerSheetOption...-) | Membuat sebuah instance baru. |
## Metode
