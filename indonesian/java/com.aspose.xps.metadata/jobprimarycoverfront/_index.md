...
type: docs
weight: 68
url: /id/java/com.aspose.xps.metadata/jobprimarycoverfront/
---
**Inheritance:**
...
Menjelaskan lembar penutup depan (beginning). Seluruh pekerjaan akan memiliki satu lembar utama. Lembar penutup harus dicetak pada  PageMediaSize  dan  PageMediaType  yang digunakan untuk halaman pertama pekerjaan. Lembar penutup harus diintegrasikan ke dalam opsi pemrosesan (seperti  JobDuplexAllDocumentsContiguously ,  JobNUpAllDocumentsContiguously ) sebagaimana ditunjukkan oleh Opsi yang ditentukan. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverfront
## Metode
