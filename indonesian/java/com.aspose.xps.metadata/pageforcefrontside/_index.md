...
description: "Memaksa output muncul di sisi depan lembar media."
type: docs
weight: 97
url: /id/java/com.aspose.xps.metadata/pageforcefrontside/
---
**Inheritance:**
...
Memaksa output muncul pada sisi depan lembar media. Relevan untuk lembar media dengan permukaan berbeda di setiap sisi. Dalam kasus di mana fitur ini mengganggu opsi pemrosesan (seperti  DocumentDuplex ),  PageForceFrontSide  memiliki prioritas untuk halaman spesifik yang diterapkan fitur ini.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [PageForceFrontSide(PageForceFrontSide.PageForceFrontSideOption[] options)](#PageForceFrontSide-com.aspose.xps.metadata.PageForceFrontSide.PageForceFrontSideOption...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| options | [PageForceFrontSideOption\[\]](../../com.aspose.xps.metadata/pageforcefrontsideoption) | Sebuah array opsi yang spesifik untuk fitur. |
