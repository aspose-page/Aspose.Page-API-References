...
description: "Menjelaskan kotak masuk yang terpasang pada perangkat atau daftar lengkap kotak yang didukung untuk sebuah perangkat."
type: docs
weight: 57
url: /id/java/com.aspose.xps.metadata/jobinputbin/
---
**Inheritance:**
...
Menjelaskan kotak masuk (input bin) yang terpasang pada perangkat atau daftar lengkap kotak yang didukung untuk sebuah perangkat. Memungkinkan spesifikasi kotak masuk per pekerjaan. Kata kunci  JobInputBin ,  DocumentInputBin , dan  PageInputBin  bersifat saling eksklusif. Keduaannya tidak boleh ditentukan secara bersamaan dalam dokumen PrintTicket atau Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobinputbin
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobInputBin(InputBin.IInputBinItem[] items)](#JobInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| items | [IInputBinItem\[\]](../../com.aspose.xps.metadata/iinputbinitem) | Sebuah array berisi item yang spesifik untuk fitur tersebut. |
