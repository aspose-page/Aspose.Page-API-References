...
description: "Menjelaskan opsi fitur JobRollCutAtEndOfJob dan DocumentRollCut."
type: docs
weight: 10
url: /id/java/com.aspose.xps.metadata/rollcut.rollcutoption/
---
**Inheritance:**
...
Menjelaskan opsi fitur JobRollCutAtEndOfJob dan DocumentRollCut.
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Banner](#Banner) | Menentukan metode pemotongan untuk banner ( hanya DocumentRollCut ). |
| [CutSheetAtImageEdge](#CutSheetAtImageEdge) | Menentukan pemotongan di tepi gambar. |
| [CutSheetAtStandardMediaSize](#CutSheetAtStandardMediaSize) | Menentukan pemotongan untuk ukuran media standar. |
| [None](#None) | Menentukan tidak ada pemotongan roll pekerjaan. |
## Metode
...
Menentukan metode pemotongan untuk banner ( hanya DocumentRollCut ).
...
Menentukan pemotongan di tepi gambar.
...
Menentukan pemotongan untuk ukuran media standar.
...
Menentukan tidak ada pemotongan roll pekerjaan.
