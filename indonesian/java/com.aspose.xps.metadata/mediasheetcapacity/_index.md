...
description: "Mendefinisikan nilai properti terukur MediaSheetCapacity yang menentukan kapasitas Media dalam jumlah halaman pada level penuh bin."
type: docs
weight: 11
url: /id/java/com.aspose.xps.metadata/outputbin.mediasheetcapacity/
---
**Inheritance:**
...
Menentukan nilai properti yang dinilai MediaSheetCapacity yang menunjukkan kapasitas Media dalam jumlah halaman (tingkat penuh) pada bin.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [MediaSheetCapacity(int mediaSheetCapacity)](#MediaSheetCapacity-int-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| mediaSheetCapacity | int | Nilai properti terukur  MediaSheetCapacity . |
