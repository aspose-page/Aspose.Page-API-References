...
type: docs
weight: 19
url: /id/java/com.aspose.xps.metadata/documentcoverback/
---
**Inheritance:**
...
Menjelaskan lembar penutup belakang (akhir). Setiap dokumen akan memiliki lembar terpisah. Lembar penutup harus dicetak pada  PageMediaSize  dan  PageMediaType  yang digunakan untuk halaman akhir dokumen. Lembar penutup harus diintegrasikan ke dalam opsi pemrosesan (seperti  DocumentDuplex ,  DocumentNUp ) sebagaimana ditunjukkan oleh Option yang ditentukan. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverback
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [DocumentCoverBack(DocumentCoverBack.CoverBackOption[] options)](#DocumentCoverBack-com.aspose.xps.metadata.DocumentCoverBack.CoverBackOption...-) | Membuat sebuah instance baru. |
## Metode
