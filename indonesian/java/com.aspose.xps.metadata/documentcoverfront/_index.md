...
description: "Menjelaskan lembar penutup depan (beginning)."
type: docs
weight: 21
url: /id/java/com.aspose.xps.metadata/documentcoverfront/
---
**Inheritance:**
...
Menjelaskan lembar sampul depan (awal). Setiap dokumen akan memiliki lembar terpisah. Lembar sampul harus dicetak pada  PageMediaSize  dan  PageMediaType  yang digunakan untuk halaman pertama dokumen. Lembar sampul harus diintegrasikan ke dalam opsi pemrosesan (seperti  DocumentDuplex ,  DocumentNUp ) sebagaimana ditunjukkan oleh Opsi yang ditentukan. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentcoverfront
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [DocumentCoverFront(DocumentCoverFront.CoverFrontOption[] options)](#DocumentCoverFront-com.aspose.xps.metadata.DocumentCoverFront.CoverFrontOption...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| options | [CoverFrontOption\[\]](../../com.aspose.xps.metadata/coverfrontoption) | Sebuah array opsi yang spesifik untuk fitur. |
