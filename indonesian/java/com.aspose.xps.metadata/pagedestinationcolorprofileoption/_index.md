...
description: "Menggambarkan opsi fitur PageDestinationColorProfile."
type: docs
weight: 10
url: /id/java/com.aspose.xps.metadata/pagedestinationcolorprofile.pagedestinationcolorprofileoption/
---
**Inheritance:**
...
Menjelaskan opsi fitur  PageDestinationColorProfile .
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Application](#Application) | Aplikasi menentukan profil tujuan yang akan digunakan. |
| [DriverConfiguration](#DriverConfiguration) | Profil tujuan yang digunakan untuk melakukan manajemen warna. |
## Metode
...
Aplikasi menentukan profil tujuan yang akan digunakan.
...
Profil tujuan yang digunakan untuk melakukan manajemen warna.
