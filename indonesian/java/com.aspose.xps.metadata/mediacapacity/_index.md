...
description: "Mendefinisikan konstanta untuk nilai properti MediaCapacity yang terukur yang menentukan apakah bin tersebut merupakan bin berkapasitas tinggi secara kualitatif."
type: docs
weight: 15
url: /id/java/com.aspose.xps.metadata/inputbin.mediacapacity/
---
**Inheritance:**
...
Menentukan konstanta untuk nilai properti yang dinilai MediaCapacity yang menunjukkan apakah bin adalah bin berkapasitas tinggi (kualitatif).
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [High](#High) | Nilai tinggi. |
| [Standard](#Standard) | Nilai standar. |
## Metode
