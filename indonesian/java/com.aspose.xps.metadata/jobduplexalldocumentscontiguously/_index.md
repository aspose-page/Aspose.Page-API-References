...
description: "Menjelaskan karakteristik dupleks output."
type: docs
weight: 52
url: /id/java/com.aspose.xps.metadata/jobduplexalldocumentscontiguously/
---
**Inheritance:**
...
Menjelaskan karakteristik duplex output. Fitur duplex memungkinkan pencetakan pada kedua sisi media. Semua Document dalam pekerjaan diproses duplex secara berurutan.  JobDuplexAllDocumentsContiguously  dan  DocumentDuplex  saling eksklusif. Penentuan penanganan batasan antara kata kunci ini menjadi tanggung jawab driver. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobduplexalldocumentscontiguously
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobDuplexAllDocumentsContiguously(Duplex.DuplexOption[] options)](#JobDuplexAllDocumentsContiguously-com.aspose.xps.metadata.Duplex.DuplexOption...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| options | [DuplexOption\[\]](../../com.aspose.xps.metadata/duplexoption) | Sebuah array opsi yang spesifik untuk fitur. |
