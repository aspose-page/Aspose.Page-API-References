...
description: "Menjelaskan opsi fitur Layering."
type: docs
weight: 11
url: /id/java/com.aspose.xps.metadata/pagewatermark.layeringoption/
---
**Inheritance:**
...
Menjelaskan opsi fitur  Layering .
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Overlay](#Overlay) | Watermark muncul di atas konten halaman. |
| [Underlay](#Underlay) | Watermark muncul di bawah konten halaman. |
## Metode
...
Watermark muncul di atas konten halaman.
...
Watermark muncul di bawah konten halaman.
