...
type: docs
weight: 27
url: /id/java/com.aspose.xps.metadata/documentinputbin/
---
**Inheritance:**
...
Menjelaskan kotak masukan yang terpasang pada perangkat atau daftar lengkap kotak yang didukung untuk perangkat. Kata kunci  JobInputBin ,  DocumentInputBin , dan  PageInputBin  saling eksklusif. Keduanya tidak boleh ditentukan secara bersamaan dalam dokumen PrintTicket atau Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/documentinputbin
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [DocumentInputBin(InputBin.IInputBinItem[] items)](#DocumentInputBin-com.aspose.xps.metadata.InputBin.IInputBinItem...-) | Membuat sebuah instance baru. |
## Metode
