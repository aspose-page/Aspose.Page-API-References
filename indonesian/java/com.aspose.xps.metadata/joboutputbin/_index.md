...
description: "Menjelaskan kotak keluaran yang terpasang pada perangkat atau daftar lengkap kotak yang didukung untuk sebuah perangkat."
type: docs
weight: 61
url: /id/java/com.aspose.xps.metadata/joboutputbin/
---
**Inheritance:**
...
Menjelaskan output bin yang terpasang pada perangkat atau daftar lengkap bin yang didukung untuk perangkat. Kata kunci  JobOutputBin ,  DocumentOutputBin  dan  PageOutputBin  saling eksklusif; hanya satu yang harus ditentukan dalam dokumen PrintTicket atau Print Capabilities. https://docs.microsoft.com/en-us/windows/win32/printdocs/joboutputbin
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobOutputBin(OutputBin.IOutputBinItem[] items)](#JobOutputBin-com.aspose.xps.metadata.OutputBin.IOutputBinItem...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| items | [IOutputBinItem\[\]](../../com.aspose.xps.metadata/ioutputbinitem) | Sebuah array berisi item yang spesifik untuk fitur tersebut. |
