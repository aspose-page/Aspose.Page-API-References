...
description: "Menjelaskan bahasa perangkat yang didukung untuk mengirim data dari driver ke perangkat fisik."
type: docs
weight: 50
url: /id/java/com.aspose.xps.metadata/jobdevicelanguage/
---
**Inheritance:**
...
Menjelaskan bahasa perangkat yang didukung untuk mengirim data dari driver ke perangkat fisik. Ini sering disebut "Page Description Language". Kata kunci ini mendefinisikan bahasa deskripsi halaman yang didukung oleh driver dan perangkat fisik. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobdevicelanguage
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [JobDeviceLanguage(JobDeviceLanguage.JobDeviceLanguageOption[] options)](#JobDeviceLanguage-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption...-) | Membuat sebuah instance baru. |
## Metode
...
| --- | --- | --- |
| options | [JobDeviceLanguageOption\[\]](../../com.aspose.xps.metadata/jobdevicelanguageoption) | Sebuah array opsi yang spesifik untuk fitur. |
