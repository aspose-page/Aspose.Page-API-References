...
description: "Menjelaskan opsi fitur JobPageOrder."
type: docs
weight: 10
url: /id/java/com.aspose.xps.metadata/jobpageorder.jobpageorderoption/
---
**Inheritance:**
...
Menjelaskan opsi fitur  JobPageOrder  .
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Reverse](#Reverse) | Menentukan urutan halaman dari belakang ke depan. |
| [Standard](#Standard) | Menentukan urutan halaman dari depan ke belakang. |
## Metode
...
Menentukan urutan halaman dari belakang ke depan.
...
Menentukan urutan halaman dari depan ke belakang.
