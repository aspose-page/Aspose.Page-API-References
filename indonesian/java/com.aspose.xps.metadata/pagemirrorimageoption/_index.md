...
description: "Mendefinisikan opsi fitur PageMirrorImage."
type: docs
weight: 10
url: /id/java/com.aspose.xps.metadata/pagemirrorimage.pagemirrorimageoption/
---
**Inheritance:**
...
Mendefinisikan opsi fitur  PageMirrorImage .
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [MirrorImageHeight](#MirrorImageHeight) | Menentukan output harus dicerminkan paralel dengan arah MediaSizeHeight. |
| [MirrorImageWidth](#MirrorImageWidth) | Menentukan output harus dicerminkan paralel dengan arah MediaSizeWidth. |
| [None](#None) | Menentukan output tidak boleh dicerminkan. |
## Metode
...
Menentukan output harus dicerminkan paralel dengan arah MediaSizeHeight.
...
Menentukan output harus dicerminkan paralel dengan arah MediaSizeWidth.
...
Menentukan output tidak boleh dicerminkan.
