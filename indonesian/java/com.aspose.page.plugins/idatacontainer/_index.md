...
description: "Antarmuka kontainer data umum yang mendefinisikan metode umum yang harus diimplementasikan oleh opsi plugin kontainer data konkret."
type: docs
weight: 20
url: /id/java/com.aspose.page.plugins/idatacontainer/
---```
