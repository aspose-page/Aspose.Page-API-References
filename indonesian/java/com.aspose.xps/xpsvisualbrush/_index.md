...
description: "Kelas yang mengenkapsulasi fitur elemen properti VisualBrush."
type: docs
weight: 54
url: /id/java/com.aspose.xps/xpsvisualbrush/
---
**Inheritance:**
...
Kelas yang mengenkapsulasi fitur elemen properti VisualBrush. Elemen ini digunakan untuk mengisi sebuah wilayah dengan gambar.
## Metode

| Metode | Deskripsi |
| --- | --- |
| [deepClone()](#deepClone--) | Menggandakan visual brush ini. |
...
| [getVisual()](#getVisual--) | Mengembalikan elemen Path, Glyphs, atau Canvas yang digunakan untuk menggambar konten sumber brush\u2019s. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setVisual(XpsContentElement visual)](#setVisual-com.aspose.xps.XpsContentElement-) | Menetapkan visual sebagai elemen Visual dari visual brush. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Mengembalikan elemen Path, Glyphs, atau Canvas yang digunakan untuk menggambar konten sumber brush\u2019s.
...
Menetapkan visual sebagai elemen Visual dari visual brush.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| visual | [XpsContentElement](../../com.aspose.xps/xpscontentelement) | Elemen tersebut. |
