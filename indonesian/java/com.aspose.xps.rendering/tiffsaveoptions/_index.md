...
description: "Kelas untuk opsi penyimpanan XPS-as-TIFF."
type: docs
weight: 16
url: /id/java/com.aspose.xps.rendering/tiffsaveoptions/
---
**Inheritance:**
...
Kelas untuk opsi penyimpanan XPS-as-TIFF.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [TiffSaveOptions()](#TiffSaveOptions--) | Membuat instance baru dari opsi. |
## Metode
...
| [multipage()](#multipage--) | Mendapatkan flag yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage. |
| [multipage(boolean value)](#multipage-boolean-) | Mengatur flag yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Mendapatkan flag yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage.

**Returns:**
boolean - Bendera yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage.
...
Mengatur flag yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | boolean | Bendera yang menentukan apakah beberapa gambar harus disimpan dalam satu file TIFF multipage. |
