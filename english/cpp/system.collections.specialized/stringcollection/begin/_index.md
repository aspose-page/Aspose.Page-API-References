...
description: 'System::Collections::Specialized::StringCollection::begin method. Returns an iterator to the first element of the const-qualified container. If the container is empty, the returned iterator will be equal to end() in C++.'
type: docs
weight: 400
