---
title: System::Net::Sockets::TcpClient::set_ExclusiveAddressUse method
linktitle: set_ExclusiveAddressUse
second_title: Aspose.Page for C++
description: 'System::Net::Sockets::TcpClient::set_ExclusiveAddressUse method. Sets a value that indicates if the current instance allows only one client to use a port in C++.'
type: docs
weight: 600
