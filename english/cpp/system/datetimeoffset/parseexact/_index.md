...
description: 'System::DateTimeOffset::ParseExact method. Converts the specified string to DateTimeOffset object using the specified format, format provider and formatting style in C++.'
type: docs
weight: 5600
