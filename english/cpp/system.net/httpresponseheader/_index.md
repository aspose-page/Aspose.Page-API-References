...
description: 'System::Net::HttpResponseHeader enum. Enumerates the http response headers in C++.'
type: docs
weight: 4500
url: /cpp/system.net/httpresponseheader/
---
...
| AcceptRanges | 20 | The 'Accept-Ranges' header. |
| Age | 21 | The 'Age' header. |
| ETag | 22 | The 'ETag' header. |
| Location | 23 | The 'Location' header. |
| ProxyAuthenticate | 24 | The 'Proxy-Authenticate' header. |
| RetryAfter | 25 | The 'Retry-After' header. |
| Server | 26 | The 'Server' header. |
| SetCookie | 27 | The 'Set-Cookie' header. |
| Vary | 28 | The 'Vary' header. |
| WwwAuthenticate | 29 | The 'WWW-Authenticate' header. |
