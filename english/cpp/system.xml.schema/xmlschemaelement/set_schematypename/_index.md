...
description: 'System::Xml::Schema::XmlSchemaElement::set_SchemaTypeName method. Sets the name of a built-in data type defined in this schema or another schema indicated by the specified namespace in C++.'
type: docs
weight: 2200
