...
description: 'System::Xml::XmlComment class. Represents the content of an XML comment in C++.'
type: docs
weight: 1100
url: /cpp/system.xml/xmlcomment/
---
## XmlComment class
...
| [WriteContentTo](./writecontentto/)(const SharedPtr\<XmlWriter\>\&) override | Saves all the children of the node to the specified [XmlWriter](../xmlwriter/). Because comment nodes do not have children, this method has no effect. |
