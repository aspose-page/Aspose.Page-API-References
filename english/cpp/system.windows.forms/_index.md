...
| Enum | Description |
| --- | --- |
| [Appearance](./appearance/) | Defines how the control looks. |
| [AutoSizeMode](./autosizemode/) | Defines how autosize works. |
| [CheckState](./checkstate/) | State of checkable control (e. g. checkbox). |
| [DialogResult](./dialogresult/) | Result of dialog interaction with user. |
| [FlatStyle](./flatstyle/) | Defines whether the control is drawn flat or three-dimentional. |
| [FormBorderStyle](./formborderstyle/) | Defines how the border is drawn. |
