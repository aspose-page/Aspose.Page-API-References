---
title: Aspose::Page::XPS::XpsMetadata::PageBlackGenerationProcessingBlackInkLimit class
...
Application content labeled with the specified named color MUST appear on all color separations. [https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingblackinklimit](https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblackgenerationprocessingblackinklimit).
...
| [PageBlackGenerationProcessingBlackInkLimit](./pageblackgenerationprocessingblackinklimit/)(int32_t) | Creates a new instance. |
## See Also
