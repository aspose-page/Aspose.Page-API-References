...
| [WriteByte](./writebyte/)(uint8_t) override | If wrapping mode is binary, writes to the stream the specified unsigned 8-bit integer value, otherwise convert it to [char_type](./char_type/) type and then write the result to the stream. Not supported! |
## Fields
