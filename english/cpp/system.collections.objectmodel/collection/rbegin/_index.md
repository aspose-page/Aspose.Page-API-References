...
description: 'System::Collections::ObjectModel::Collection::rbegin method. Gets a reverse iterator to the last element of the const-qualified collection (first in reverse) in C++.'
type: docs
weight: 1600
url: /cpp/system.collections.objectmodel/collection/rbegin/
---
