---
title: PsConverterToPdfOptions class
second_title: Aspose.Page for Python via .NET API Reference
description: 
type: docs
weight: 120
url: /python-net/aspose.page.plugins/psconvertertopdfoptions/
---

## PsConverterToPdfOptions class

Represents PS/EPS to PDF converter options for [PsConverter](/page/python-net/aspose.page.plugins/psconverter/) plugin.

**Inheritance:** `PsConverterToPdfOptions` → [`PsConverterOptions`](/page/python-net/aspose.page.plugins/psconverteroptions)

The PsConverterToPdfOptions type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
| `PsConverterToPdfOptions()` | Initializes new instance of the [PsConverterToPdfOptions](/page/python-net/aspose.page.plugins/psconvertertopdfoptions/) object with default options. |
## Properties
| Name | Description |
| :- | :- |
