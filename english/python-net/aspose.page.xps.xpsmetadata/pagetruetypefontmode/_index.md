---
title: PageTrueTypeFontMode class
second_title: Aspose.Page for Python via .NET API References
description: 
type: docs
weight: 1300
url: /python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode/
is_root: false
---
...
**Inheritance:** [`PageTrueTypeFontMode`](/page/python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode) → 
...
The PageTrueTypeFontMode type exposes the following members:

### Constructors
| Constructor | Description |
| :- | :- |
| [__init__](/page/python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode/__init__/#list) | Constructs a new instance of PageTrueTypeFontMode |


### Properties
| Property | Description |
| :- | :- |
| [name](/page/python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode/name) | Gets the element name. |


### Methods
| Method | Description |
| :- | :- |
| [add](/page/python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode/add/#list) | Adds a list of items to the end of this feature's item list. <br/>Each one must be a [`Feature`](/page/python-net/aspose.page.xps.xpsmetadata/feature), an [`Option`](/page/python-net/aspose.page.xps.xpsmetadata/option) or a [`Property`](/page/python-net/aspose.page.xps.xpsmetadata/property) instance. |
...
* class [`PageTrueTypeFontMode`](/page/python-net/aspose.page.xps.xpsmetadata/pagetruetypefontmode)
