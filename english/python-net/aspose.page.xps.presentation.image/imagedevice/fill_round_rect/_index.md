---
title: fill_round_rect method
second_title: Aspose.Page for Python via .NET API References
description: 
type: docs
weight: 220
url: /python-net/aspose.page.xps.presentation.image/imagedevice/fill_round_rect/
is_root: false
---

## fill_round_rect {#float-float-float-float-float-float}
