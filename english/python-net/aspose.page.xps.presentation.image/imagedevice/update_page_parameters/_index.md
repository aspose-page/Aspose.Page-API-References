...
type: docs
weight: 460
url: /python-net/aspose.page.xps.presentation.image/imagedevice/update_page_parameters/
is_root: false
---
...
| :- | :- | :- |
| device | [`IMultiPageDevice`](/page/python-net/aspose.page/imultipagedevice) | The multipage device. |
