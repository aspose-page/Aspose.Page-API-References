...
**Inheritance:** `BmpSaveOptions` → [`ImageSaveOptions`](/page/python-net/aspose.page.xps.presentation.image/imagesaveoptions) → [`SaveOptions`](/page/python-net/aspose.page/saveoptions)
