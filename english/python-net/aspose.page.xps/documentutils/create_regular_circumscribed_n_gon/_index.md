---
title: create_regular_circumscribed_n_gon method
...
## create_regular_circumscribed_n_gon {#int-aspose.pydrawing.PointF-float}
...
```python
def create_regular_circumscribed_n_gon(self, n, center, radius):
    ...
```
