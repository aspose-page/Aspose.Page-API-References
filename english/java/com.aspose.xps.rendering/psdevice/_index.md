...
description: Class incapsulating PostScript composing device.
type: docs
weight: 19
url: /java/com.aspose.xps.rendering/psdevice/
---
**Inheritance:**
...
```
public class PsDevice extends DeviceXps implements IMultiPartitionDevice
```
...
| --- | --- |
| [PsDevice(OutputStream stream)](#PsDevice-java.io.OutputStream-) | Creates the new instance. |
## Fields
...
### PsDevice(OutputStream stream) {#PsDevice-java.io.OutputStream-}
```
public PsDevice(OutputStream stream)
```
...
| --- | --- | --- |
| stream | java.io.OutputStream | The output stream containing PostScript. |
