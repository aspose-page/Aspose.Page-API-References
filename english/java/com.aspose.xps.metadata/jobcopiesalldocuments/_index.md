...
description: Specifies the number of copies of a job.
type: docs
weight: 49
url: /java/com.aspose.xps.metadata/jobcopiesalldocuments/
---
**Inheritance:**
...
| --- | --- |
| [JobCopiesAllDocuments(int value)](#JobCopiesAllDocuments-int-) | Creates a new instance. |
