...
description: Specifies the offset perpendicular to the feed-orientation direction.
type: docs
weight: 109
url: /java/com.aspose.xps.metadata/pagemediasizepswidthoffset/
---
**Inheritance:**
...
Specifies the offset perpendicular to the feed-orientation direction. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepswidthoffset
## Constructors

| Constructor | Description |
| --- | --- |
| [PageMediaSizePSWidthOffset(int value)](#PageMediaSizePSWidthOffset-int-) | Creates a new instance. |
## Methods
