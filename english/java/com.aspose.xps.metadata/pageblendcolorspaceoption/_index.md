...
| Field | Description |
| --- | --- |
| [sRGB](#sRGB) | sRGB color space SHOULD be used for blending. |
| [scRGB](#scRGB) | scRGB color space SHOULD be used for blending. |
| [ICCProfile](#ICCProfile) | Specifies an ICC profile defining the color space that SHOULD be used for blending. |
### sRGB {#sRGB}
```
