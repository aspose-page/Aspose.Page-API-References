...
| Field | Description |
| --- | --- |
| [BottomEdge](#BottomEdge) | Specifies hole(s) along the bottom edge. |
| [LeftEdge](#LeftEdge) | Specifies hole(s) along the left edge. |
| [None](#None) | Specifies no hole punching. |
| [RightEdge](#RightEdge) | Specifies hole(s) along the right edge. |
| [TopEdge](#TopEdge) | Specifies hole(s) along the top edge. |
