...
description: Specifies the height of the page parallel to the feed-orientation direction.
type: docs
weight: 105
url: /java/com.aspose.xps.metadata/pagemediasizepsheight/
---
**Inheritance:**
...
| --- | --- |
| [PageMediaSizePSHeight(int value)](#PageMediaSizePSHeight-int-) | Creates a new instance. |
## Methods
