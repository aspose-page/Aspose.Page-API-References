...
| Field | Description |
| --- | --- |
| [RGB](#RGB) | Source profile used to perform color management for untagged RGB data. |
| [CMYK](#CMYK) | Source profile used to perform color management for untagged CMYK data. |
| [None](#None) | No source profile. |
### RGB {#RGB}
```
