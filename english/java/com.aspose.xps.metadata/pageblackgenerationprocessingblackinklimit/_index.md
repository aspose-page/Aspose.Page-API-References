...
description: Application content labeled with the specified named color MUST appear on all color separations.
type: docs
weight: 79
url: /java/com.aspose.xps.metadata/pageblackgenerationprocessingblackinklimit/
---
**Inheritance:**
...
| --- | --- |
| [PageBlackGenerationProcessingBlackInkLimit(int value)](#PageBlackGenerationProcessingBlackInkLimit-int-) | Creates a new instance. |
## Methods
