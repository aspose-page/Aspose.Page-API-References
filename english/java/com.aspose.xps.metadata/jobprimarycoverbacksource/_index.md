...
description: Specifies the source for a custom back-cover primary sheet for the job.
type: docs
weight: 67
url: /java/com.aspose.xps.metadata/jobprimarycoverbacksource/
---
**Inheritance:**
...
Specifies the source for a custom back-cover primary sheet for the job. https://docs.microsoft.com/en-us/windows/win32/printdocs/jobprimarycoverbacksource
## Constructors

| Constructor | Description |
| --- | --- |
| [JobPrimaryCoverBackSource(String value)](#JobPrimaryCoverBackSource-java.lang.String-) | Creates a new instance. |
## Methods
