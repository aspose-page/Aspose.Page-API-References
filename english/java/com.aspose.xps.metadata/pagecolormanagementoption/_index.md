...
| Field | Description |
| --- | --- |
| [Device](#Device) | Application has not performed color management and the device determines color management. |
| [Driver](#Driver) | Application has not performed color management and the driver determines color management. |
| [None](#None) | Application has performed color management to the destination profile. |
| [System](#System) | Color management is performed by the system. |
## Methods
