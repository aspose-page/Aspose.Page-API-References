...
description: Specifies the maximum allowed sum of the four ink coverage anywhere in an image.
type: docs
weight: 83
url: /java/com.aspose.xps.metadata/pageblackgenerationprocessingtotalinkcoveragelimit/
---
**Inheritance:**
...
| --- | --- |
| [PageBlackGenerationProcessingTotalInkCoverageLimit(int value)](#PageBlackGenerationProcessingTotalInkCoverageLimit-int-) | Creates a new instance. |
## Methods
