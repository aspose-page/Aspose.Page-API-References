...
description: Specifies the width of the page perpendicular to the feed-orientation direction.
type: docs
weight: 108
url: /java/com.aspose.xps.metadata/pagemediasizepswidth/
---
**Inheritance:**
...
| --- | --- |
| [PageMediaSizePSWidth(int value)](#PageMediaSizePSWidth-int-) | Creates a new instance. |
## Methods
