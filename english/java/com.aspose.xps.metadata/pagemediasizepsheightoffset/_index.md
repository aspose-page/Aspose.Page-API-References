...
description: Specifies the offset parallel to the feed-orientation direction.
type: docs
weight: 106
url: /java/com.aspose.xps.metadata/pagemediasizepsheightoffset/
---
**Inheritance:**
...
| --- | --- |
| [PageMediaSizePSHeightOffset(int value)](#PageMediaSizePSHeightOffset-int-) | Creates a new instance. |
## Methods
