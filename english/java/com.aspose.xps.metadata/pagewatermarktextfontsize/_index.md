...
description: Defines the available font sizes for the watermark text.
type: docs
weight: 136
url: /java/com.aspose.xps.metadata/pagewatermarktextfontsize/
---
**Inheritance:**
...
| --- | --- |
| [PageWatermarkTextFontSize(int value)](#PageWatermarkTextFontSize-int-) | Creates a new instance. |
## Methods
