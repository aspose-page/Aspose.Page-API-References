...
| --- | --- |
| [JobDeviceLanguageOption(String name, JobDeviceLanguage.IJobDeviceLanguageOptionItem[] items)](#JobDeviceLanguageOption-java.lang.String-com.aspose.xps.metadata.JobDeviceLanguage.IJobDeviceLanguageOptionItem...-) | Creates a new instance. |
| [JobDeviceLanguageOption(JobDeviceLanguage.JobDeviceLanguageOption option)](#JobDeviceLanguageOption-com.aspose.xps.metadata.JobDeviceLanguage.JobDeviceLanguageOption-) | Clones this option instance. |
## Fields
...
| [ESCP2](#ESCP2) | Specified device language is ESC/P2. |
| [ESCPage](#ESCPage) | Specified device language is ESC/Page. |
| [HPGL2](#HPGL2) | Specified device language is HP-GL/2. |
| [KPDL](#KPDL) | Specified device language is KPDL. |
| [KS](#KS) | Specified device language is KS. |
| [KSSM](#KSSM) | Specified device language is KSSM. |
| [PCL](#PCL) | Specified device language is PCL. |
