...
description: Specifies a relative URI reference to an ICC profile defining the color space that SHOULD be used for blending.
type: docs
weight: 87
url: /java/com.aspose.xps.metadata/pageblendcolorspaceiccprofileuri/
---
**Inheritance:**
...
Specifies a relative URI reference to an ICC profile defining the color space that SHOULD be used for blending. The <Uri> is an absolute part\_name relative to the package root. https://docs.microsoft.com/en-us/windows/win32/printdocs/pageblendcolorspaceiccprofileuri
## Constructors

| Constructor | Description |
| --- | --- |
| [PageBlendColorSpaceICCProfileURI(String value)](#PageBlendColorSpaceICCProfileURI-java.lang.String-) | Creates a new instance. |
## Methods
