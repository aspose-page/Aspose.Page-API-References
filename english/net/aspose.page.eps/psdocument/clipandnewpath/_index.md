---
title: ClipAndNewPath
second_title: Aspose.Page for .NET API Reference
description: Adds clip to current graphics state and than writes newpath operator. It is necessary to do to escape of confluence of this clipping path and some subsequent pathes such as glyphs outlined with charpath operator.
type: docs
weight: 40
