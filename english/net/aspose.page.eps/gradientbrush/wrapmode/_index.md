...
description: Returns or specifies wrap mode for this gradient brush. It can be WrapMode.Clamp that results in throwing exception in native gradient brushes.
type: docs
weight: 40
