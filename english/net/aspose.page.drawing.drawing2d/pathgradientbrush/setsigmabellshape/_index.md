...
description: PathGradientBrush method. Creates a gradient brush that changes color starting from the center of the path outward to the paths boundary. The transition from one color to another is based on a bellshaped curve
type: docs
weight: 180
url: /net/aspose.page.drawing.drawing2d/pathgradientbrush/setsigmabellshape/
---
