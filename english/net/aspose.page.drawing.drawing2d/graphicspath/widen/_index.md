...
type: docs
weight: 350
url: /net/aspose.page.drawing.drawing2d/graphicspath/widen/
---
## Widen(Pen) {#widen}
...
| --- | --- | --- |
| pen | Pen | A [`Pen`](../../../aspose.page.drawing/pen/) that specifies the width between the original outline of the path and the new outline this method creates. |
