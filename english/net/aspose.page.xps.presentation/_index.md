...
| Class | Description |
| --- | --- |
| class [WdpNet20NotSupportedException](./wdpnet20notsupportedexception) | The exception that is thrown whenever an XPS document containing WDP images is being converted in library version for .NET 2.0. |
