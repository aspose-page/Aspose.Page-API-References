...
description: Describes the Media Color options and the characteristics of each option. https//docs.microsoft.com/enus/windows/win32/printdocs/pagemediacolor
type: docs
weight: 2030
...
| Name | Description |
| --- | --- |
| class [PageMediaColorOption](pagemediacolor.pagemediacoloroption) | Describes the [`PageMediaColor`](../pagemediacolor) feature options. |
