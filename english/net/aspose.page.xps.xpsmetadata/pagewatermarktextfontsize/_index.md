...
description: Aspose.Page.XPS.XpsMetadata.PageWatermarkTextFontSize class. Defines the available font sizes for the watermark text. https//docs.microsoft.com/enus/windows/win32/printdocs/pagewatermarktextfontsize
type: docs
weight: 2960
...
Defines the available font sizes for the watermark text. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarktextfontsize
...
| Name | Description |
| --- | --- |
| [PageWatermarkTextFontSize](pagewatermarktextfontsize/)(int) | Creates a new instance. |
