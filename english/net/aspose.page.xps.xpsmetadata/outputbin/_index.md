...
| Name | Description |
| --- | --- |
| class [BinType](outputbin.bintype) | Defines constants for the |
| interface [IOutputBinItem](outputbin.ioutputbinitem) | The interface of any [`JobOutputBin`](../joboutputbin), [`DocumentOutputBin`](../documentoutputbin) and [`PageOutputBin`](../pageoutputbin) feature item. |
| interface [IOutputBinOptionItem](outputbin.ioutputbinoptionitem) | The interface of any [`OutputBinOption`](../outputbin.outputbinoption) item. |
| class [OutputBinOption](outputbin.outputbinoption) | Describes the [`JobOutputBin`](../joboutputbin), [`DocumentOutputBin`](../documentoutputbin) and [`PageOutputBin`](../pageoutputbin) features options. |
