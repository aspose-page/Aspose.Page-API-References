...
| Name | Description |
| --- | --- |
| [DocumentSeparatorSheet](documentseparatorsheet/)(params DocumentSeparatorSheetOption[]) | Creates a new instance. |
...
| Name | Description |
| --- | --- |
| class [DocumentSeparatorSheetOption](../../aspose.page.xps.xpsmetadata/documentseparatorsheet.documentseparatorsheetoption) | Describes the `DocumentSeparatorSheet` feature options. |
