...
| Name | Description |
| --- | --- |
| interface [INUpItem](../../aspose.page.xps.xpsmetadata/nup.inupitem) | The interface of any [`JobNUpAllDocumentsContiguously`](../jobnupalldocumentscontiguously/) or [`DocumentNUp`](../documentnup/) feature item. |
| class [PresentationDirection](../../aspose.page.xps.xpsmetadata/nup.presentationdirection) | Describes inner |
