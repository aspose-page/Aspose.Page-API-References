...
| Name | Description |
| --- | --- |
| [PageBorderless](pageborderless/)(params PageBorderlessOption[]) | Creates a new instance. |
...
| Name | Description |
| --- | --- |
| class [PageBorderlessOption](../../aspose.page.xps.xpsmetadata/pageborderless.pageborderlessoption) | Describes the `PageBorderless` feature options. |
