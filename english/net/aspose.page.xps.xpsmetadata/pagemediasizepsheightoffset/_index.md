...
description: Aspose.Page.XPS.XpsMetadata.PageMediaSizePSHeightOffset class. Specifies the offset parallel to the feedorientation direction. https//docs.microsoft.com/enus/windows/win32/printdocs/pagemediasizepsheightoffset
type: docs
weight: 2770
...
Specifies the offset, parallel to the feed-orientation direction. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheightoffset
...
| Name | Description |
| --- | --- |
| [PageMediaSizePSHeightOffset](pagemediasizepsheightoffset/)(int) | Creates a new instance. |
