...
| Name | Description |
| --- | --- |
| [JobDeviceLanguage](jobdevicelanguage/)(params JobDeviceLanguageOption[]) | Creates a new instance. |
...
| Name | Description |
| --- | --- |
| interface [IJobDeviceLanguageOptionItem](../../aspose.page.xps.xpsmetadata/jobdevicelanguage.ijobdevicelanguageoptionitem) | The interface of any [`JobDeviceLanguageOption`](../jobdevicelanguage.jobdevicelanguageoption/) item. |
| class [JobDeviceLanguageOption](../../aspose.page.xps.xpsmetadata/jobdevicelanguage.jobdevicelanguageoption) | Describes the `JobDeviceLanguage` feature options. |
