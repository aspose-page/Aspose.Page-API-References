...
description: Aspose.Page.XPS.XpsMetadata.PageMediaSizePSHeight class. Specifies the height of the page parallel to the feedorientation direction. https//docs.microsoft.com/enus/windows/win32/printdocs/pagemediasizepsheight
type: docs
weight: 2330
...
Specifies the height of the page, parallel to the feed-orientation direction. https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizepsheight
...
| Name | Description |
| --- | --- |
| [PageMediaSizePSHeight](pagemediasizepsheight/)(int) | Creates a new instance. |
