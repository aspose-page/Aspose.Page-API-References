...
description: This class contains options necessary for managing process of converting document to PostScript PS or Encapsulated PostScript EPS file.
type: docs
weight: 80
...
| Name | Description |
| --- | --- |
| [PsSaveOptions](pssaveoptions#constructor)() | Initializes a new instance of the [`PsSaveOptions`](../pssaveoptions) class with default values for flags !:SuppressErrors (true) and !:Debug (false). |
| [PsSaveOptions](pssaveoptions#constructor_1)(bool) | Initializes a new instance of the [`PsSaveOptions`](../pssaveoptions) class with default values for flag !:Debug (false). |
