...
| Name | Description |
| --- | --- |
| [FetchDrFont](fetchdrfont)(string, float, FontStyle, string) | Fetches [`DrFont`](../../aspose.page.font/drfont) by font family name, size, style and alternative font family name. |
| static [FetchDrFont](fetchdrfont)(string, float, FontStyle) | Fetches [`DrFont`](../../aspose.page.font/drfont) by font family name, size and style. |
